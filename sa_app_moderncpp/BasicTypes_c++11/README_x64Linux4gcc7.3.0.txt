...
data type Quaternion from Quaternion.idl.
This example builds two applications, named Quaternion_publisher and
...
> make -f makefile_Quaternion_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_Quaternion_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the Quaternion_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/Quaternion_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/Quaternion_subscriber -d <domain_id> -s <sample_count>
