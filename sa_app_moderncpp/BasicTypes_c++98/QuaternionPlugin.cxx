...
namespace BasicTypes {
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        try {
            ...
            if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                serializedSampleMaxSize = BasicTypes::QuaternionPlugin_get_serialized_sample_max_size(
                ...
                if (PRESTypePluginDefaultEndpointData_createWriterPool(
                    ...
                    BasicTypes::QuaternionPlugin_get_serialized_sample_max_size, epd,
    ...
    QuaternionPlugin_copy_sample(
        ...
        const Quaternion *src)
    {
        return BasicTypes::QuaternionPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        BasicTypes::QuaternionPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        BasicTypes::QuaternionPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        BasicTypes::QuaternionPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        BasicTypes::QuaternionPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        BasicTypes::QuaternionPlugin_copy_sample;
        ...
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        BasicTypes::QuaternionPlugin_get_serialized_sample_max_size;
        ...
        BasicTypes::QuaternionPlugin_get_key_kind;
        ...
        */
        ...
        #else
        plugin->typeCode = (struct RTICdrTypeCode *) 
        &::rti::topic::dynamic_type< BasicTypes::Quaternion >::get().native();
        #endif
        ...
        static const char * TYPE_NAME = "BasicTypes::Quaternion";
