...
data type MissionPlanAssignmentReportType from MissionPlanAssignmentReportType.idl.
This example builds two applications, named MissionPlanAssignmentReportType_publisher and
MissionPlanAssignmentReportType_subscriber.
...
> make -f makefile_MissionPlanAssignmentReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_MissionPlanAssignmentReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the MissionPlanAssignmentReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/MissionPlanAssignmentReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/MissionPlanAssignmentReportType_subscriber -d <domain_id> -s <sample_count>
