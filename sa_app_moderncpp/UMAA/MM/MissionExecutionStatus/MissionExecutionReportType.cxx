...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace MissionExecutionStatus {
            ...
            MissionExecutionReportType::MissionExecutionReportType (const ::rti::core::bounded_sequence< UMAA::MM::MissionExecutionStatus::MissionStatusType, 100L >& missionStatuses,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_missionStatuses_( missionStatuses ),
                m_source_( source ),
            ...
            MissionExecutionReportType::MissionExecutionReportType(MissionExecutionReportType&& other_) OMG_NOEXCEPT  :m_missionStatuses_ (std::move(other_.m_missionStatuses_))
            ,
            ...
            MissionExecutionReportType& MissionExecutionReportType::operator=(MissionExecutionReportType&&  other_) OMG_NOEXCEPT {
                MissionExecutionReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MissionExecutionReportType::swap(MissionExecutionReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
