...
namespace UMAA {
    namespace MM {
        namespace ControlTransfer {
            ...
            static const std::string ClientControlReport_TOPIC = "UMAA::MM::ControlTransfer::ClientControlReport";

            class NDDSUSERDllExport ClientControlReportType {
              public:
                ClientControlReportType();

                ClientControlReportType(int32_t authorityLevel,const UMAA::Common::Measurement::NumericGUID& clientID,const UMAA::Common::Enumeration::ResourceAllocationStatusEnumType::ResourceAllocationStatusEnumType& status,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                ClientControlReportType (ClientControlReportType&&) = default;
                ClientControlReportType& operator=(ClientControlReportType&&) = default;
                ClientControlReportType& operator=(const ClientControlReportType&) = default;
                ClientControlReportType(const ClientControlReportType&) = default;
                #else
                ClientControlReportType(ClientControlReportType&& other_) OMG_NOEXCEPT;  
                ClientControlReportType& operator=(ClientControlReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                UMAA::Common::Measurement::NumericGUID& clientID() OMG_NOEXCEPT {
                    return m_clientID_;
                }

                const UMAA::Common::Measurement::NumericGUID& clientID() const OMG_NOEXCEPT {
                    return m_clientID_;
                }
                ...
                void swap(ClientControlReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ClientControlReportType& a, ClientControlReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
