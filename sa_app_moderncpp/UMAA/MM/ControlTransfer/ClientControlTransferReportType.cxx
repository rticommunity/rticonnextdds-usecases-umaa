...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ControlTransfer {
            ...
            ClientControlTransferReportType::ClientControlTransferReportType (int32_t authorityLevel,const UMAA::Common::MaritimeEnumeration::HandoverResultEnumType::HandoverResultEnumType& result,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            ClientControlTransferReportType::ClientControlTransferReportType(ClientControlTransferReportType&& other_) OMG_NOEXCEPT  :m_authorityLevel_ (std::move(other_.m_authorityLevel_))
            ,
            ...
            ClientControlTransferReportType& ClientControlTransferReportType::operator=(ClientControlTransferReportType&&  other_) OMG_NOEXCEPT {
                ClientControlTransferReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ClientControlTransferReportType::swap(ClientControlTransferReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::MM::ControlTransfer::ClientControlTransferReportType > {
            static DDS_TypeCode * get()
            {
                ...
                ClientControlTransferReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::HandoverResultEnumType::HandoverResultEnumType>::get().native();
                ClientControlTransferReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ClientControlTransferReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                ClientControlTransferReportType_g_tc_members[0]._annotations._minValue._u.long_value = -2147483648L;
                ClientControlTransferReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                ClientControlTransferReportType_g_tc_members[0]._annotations._maxValue._u.long_value = 2147483647L;
