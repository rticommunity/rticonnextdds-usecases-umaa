    ...
    namespace MM {
        ...
        namespace ControlTransfer {
            ...
            ControlSystemTransferReportType::ControlSystemTransferReportType() :
                m_authorityLevel_ (0) ,
                m_result_(UMAA::Common::MaritimeEnumeration::HandoverResultEnumType::HandoverResultEnumType::DEFERRED)  {
                    ::rti::core::fill_array( 
                        m_source_, 
                        ::rti::topic::cdr::alias_helper< UMAA::Common::Measurement::NumericGUID::value_type >::default_value());
            }   

            ControlSystemTransferReportType::ControlSystemTransferReportType (int32_t authorityLevel,const UMAA::Common::MaritimeEnumeration::HandoverResultEnumType::HandoverResultEnumType& result,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            ControlSystemTransferReportType::ControlSystemTransferReportType(ControlSystemTransferReportType&& other_) OMG_NOEXCEPT  :m_authorityLevel_ (std::move(other_.m_authorityLevel_))
            ,
            ...
            ControlSystemTransferReportType& ControlSystemTransferReportType::operator=(ControlSystemTransferReportType&&  other_) OMG_NOEXCEPT {
                ControlSystemTransferReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ControlSystemTransferReportType::swap(ControlSystemTransferReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::MM::ControlTransfer::ControlSystemTransferReportType > {
            static DDS_TypeCode * get()
            {
                ...
                ControlSystemTransferReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::HandoverResultEnumType::HandoverResultEnumType>::get().native();
                ControlSystemTransferReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ControlSystemTransferReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                ControlSystemTransferReportType_g_tc_members[0]._annotations._minValue._u.long_value = -2147483648L;
                ControlSystemTransferReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                ControlSystemTransferReportType_g_tc_members[0]._annotations._maxValue._u.long_value = 2147483647L;
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< UMAA::MM::ControlTransfer::ControlSystemTransferReportType >::reset_sample(UMAA::MM::ControlTransfer::ControlSystemTransferReportType& sample) 
        {
            ...
            sample.result(UMAA::Common::MaritimeEnumeration::HandoverResultEnumType::HandoverResultEnumType::DEFERRED);
