...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ControlTransfer {
            ...
            ClientControlReportType::ClientControlReportType (int32_t authorityLevel,const UMAA::Common::Measurement::NumericGUID& clientID,const UMAA::Common::Enumeration::ResourceAllocationStatusEnumType::ResourceAllocationStatusEnumType& status,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_authorityLevel_( authorityLevel ),
                m_clientID_( clientID ),
                m_status_( status ),
                m_source_( source ),
            ...
            ClientControlReportType::ClientControlReportType(ClientControlReportType&& other_) OMG_NOEXCEPT  :m_authorityLevel_ (std::move(other_.m_authorityLevel_))
            ,
            m_clientID_ (std::move(other_.m_clientID_))
            ,
            ...
            ClientControlReportType& ClientControlReportType::operator=(ClientControlReportType&&  other_) OMG_NOEXCEPT {
                ClientControlReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ClientControlReportType::swap(ClientControlReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
