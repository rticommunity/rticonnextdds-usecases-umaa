...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace WaterspacePlanStatus {
            ...
            WaterspacePlanReportType::WaterspacePlanReportType (const std::string& waterspacePlanName,const ::rti::core::bounded_sequence< UMAA::MM::BaseType::PlanningZoneType, 100L >& zones,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& waterspacePlanID):
                m_waterspacePlanName_( waterspacePlanName ),
                m_zones_( zones ),
                m_source_( source ),
            ...
            WaterspacePlanReportType::WaterspacePlanReportType(WaterspacePlanReportType&& other_) OMG_NOEXCEPT  :m_waterspacePlanName_ (std::move(other_.m_waterspacePlanName_))
            ,
            m_zones_ (std::move(other_.m_zones_))
            ,
            ...
            WaterspacePlanReportType& WaterspacePlanReportType::operator=(WaterspacePlanReportType&&  other_) OMG_NOEXCEPT {
                WaterspacePlanReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WaterspacePlanReportType::swap(WaterspacePlanReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
