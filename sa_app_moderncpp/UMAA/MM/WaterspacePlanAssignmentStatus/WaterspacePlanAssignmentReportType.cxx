...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace WaterspacePlanAssignmentStatus {
            ...
            WaterspacePlanAssignmentReportType::WaterspacePlanAssignmentReportType (const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& missionID,const UMAA::Common::Measurement::NumericGUID& objectiveID,const UMAA::Common::Measurement::NumericGUID& taskID,const UMAA::Common::Measurement::NumericGUID& waterspacePlanID):
                m_source_( source ),
                m_timeStamp_( timeStamp ),
                m_missionID_( missionID ),
                m_objectiveID_( objectiveID ),
                m_taskID_( taskID ),
                m_waterspacePlanID_( waterspacePlanID ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            WaterspacePlanAssignmentReportType::WaterspacePlanAssignmentReportType(WaterspacePlanAssignmentReportType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            ,
            m_waterspacePlanID_ (std::move(other_.m_waterspacePlanID_))
            {
            } 

            WaterspacePlanAssignmentReportType& WaterspacePlanAssignmentReportType::operator=(WaterspacePlanAssignmentReportType&&  other_) OMG_NOEXCEPT {
                WaterspacePlanAssignmentReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WaterspacePlanAssignmentReportType::swap(WaterspacePlanAssignmentReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
