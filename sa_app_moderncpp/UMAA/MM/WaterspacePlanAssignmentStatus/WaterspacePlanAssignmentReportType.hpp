...
namespace UMAA {
    namespace MM {
        namespace WaterspacePlanAssignmentStatus {
            ...
            static const std::string WaterspacePlanAssignmentReport_TOPIC = "UMAA::MM::WaterspacePlanAssignmentStatus::WaterspacePlanAssignmentReport";

            class NDDSUSERDllExport WaterspacePlanAssignmentReportType {
              public:
                WaterspacePlanAssignmentReportType();

                WaterspacePlanAssignmentReportType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& missionID,const UMAA::Common::Measurement::NumericGUID& objectiveID,const UMAA::Common::Measurement::NumericGUID& taskID,const UMAA::Common::Measurement::NumericGUID& waterspacePlanID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                WaterspacePlanAssignmentReportType (WaterspacePlanAssignmentReportType&&) = default;
                WaterspacePlanAssignmentReportType& operator=(WaterspacePlanAssignmentReportType&&) = default;
                WaterspacePlanAssignmentReportType& operator=(const WaterspacePlanAssignmentReportType&) = default;
                WaterspacePlanAssignmentReportType(const WaterspacePlanAssignmentReportType&) = default;
                #else
                WaterspacePlanAssignmentReportType(WaterspacePlanAssignmentReportType&& other_) OMG_NOEXCEPT;  
                WaterspacePlanAssignmentReportType& operator=(WaterspacePlanAssignmentReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(WaterspacePlanAssignmentReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(WaterspacePlanAssignmentReportType& a, WaterspacePlanAssignmentReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
