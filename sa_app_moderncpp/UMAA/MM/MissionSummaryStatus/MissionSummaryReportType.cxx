...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace MissionSummaryStatus {
            ...
            MissionSummaryReportType::MissionSummaryReportType (const ::rti::core::bounded_sequence< UMAA::MM::BaseType::MissionSummaryType, 100L >& missionSummaries,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_missionSummaries_( missionSummaries ),
                m_source_( source ),
            ...
            MissionSummaryReportType::MissionSummaryReportType(MissionSummaryReportType&& other_) OMG_NOEXCEPT  :m_missionSummaries_ (std::move(other_.m_missionSummaries_))
            ,
            ...
            MissionSummaryReportType& MissionSummaryReportType::operator=(MissionSummaryReportType&&  other_) OMG_NOEXCEPT {
                MissionSummaryReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MissionSummaryReportType::swap(MissionSummaryReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
