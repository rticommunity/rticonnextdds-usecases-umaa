        ...
        namespace TaskExecutionStatus {
            ...
            class NDDSUSERDllExport TaskStatusType {
              public:
                ...
                TaskStatusType(const UMAA::Common::Measurement::DateTime& endTime,const UMAA::Common::Measurement::DateTime& startTime,const UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& missionID,const UMAA::Common::Measurement::NumericGUID& taskID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                TaskStatusType (TaskStatusType&&) = default;
                TaskStatusType& operator=(TaskStatusType&&) = default;
                TaskStatusType& operator=(const TaskStatusType&) = default;
                TaskStatusType(const TaskStatusType&) = default;
                #else
                TaskStatusType(TaskStatusType&& other_) OMG_NOEXCEPT;  
                TaskStatusType& operator=(TaskStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(TaskStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(TaskStatusType& a, TaskStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
