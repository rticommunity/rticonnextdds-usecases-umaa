...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace MissionPlanCatalogControl {
            ...
            MissionPlanCatalogCommandStatusType::MissionPlanCatalogCommandStatusType(MissionPlanCatalogCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            MissionPlanCatalogCommandStatusType& MissionPlanCatalogCommandStatusType::operator=(MissionPlanCatalogCommandStatusType&&  other_) OMG_NOEXCEPT {
                MissionPlanCatalogCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MissionPlanCatalogCommandStatusType::swap(MissionPlanCatalogCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
