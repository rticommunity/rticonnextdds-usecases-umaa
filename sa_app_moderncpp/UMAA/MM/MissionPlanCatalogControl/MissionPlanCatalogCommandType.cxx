...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace MissionPlanCatalogControl {
            ...
            MissionPlanCatalogCommandType::MissionPlanCatalogCommandType (const UMAA::Common::Enumeration::PlanActionEnumType::PlanActionEnumType& action,bool allocationStatus,const UMAA::Common::Measurement::NumericGUID& assignedResource,const UMAA::Common::MaritimeEnumeration::DomainEnumType::DomainEnumType& domain,const std::string& format,const std::string& name,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& missionID):
                m_action_( action ),
            ...
            MissionPlanCatalogCommandType::MissionPlanCatalogCommandType(MissionPlanCatalogCommandType&& other_) OMG_NOEXCEPT  :m_action_ (std::move(other_.m_action_))
            ,
            ...
            MissionPlanCatalogCommandType& MissionPlanCatalogCommandType::operator=(MissionPlanCatalogCommandType&&  other_) OMG_NOEXCEPT {
                MissionPlanCatalogCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MissionPlanCatalogCommandType::swap(MissionPlanCatalogCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
