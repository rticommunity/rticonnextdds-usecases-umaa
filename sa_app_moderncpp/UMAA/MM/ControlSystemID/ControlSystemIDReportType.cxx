...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ControlSystemID {
            ...
            ControlSystemIDReportType::ControlSystemIDReportType (const std::string& name,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_name_( name ),
                m_source_( source ),
            ...
            ControlSystemIDReportType::ControlSystemIDReportType(ControlSystemIDReportType&& other_) OMG_NOEXCEPT  :m_name_ (std::move(other_.m_name_))
            ,
            ...
            ControlSystemIDReportType& ControlSystemIDReportType::operator=(ControlSystemIDReportType&&  other_) OMG_NOEXCEPT {
                ControlSystemIDReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ControlSystemIDReportType::swap(ControlSystemIDReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct native_type_code< UMAA::MM::ControlSystemID::ControlSystemIDReportType > {
            static DDS_TypeCode * get()
            {
                ...
                ControlSystemIDReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ControlSystemIDReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                UMAA::MM::ControlSystemID::ControlSystemIDReportType *sample;
                ...
                RTIXCdrHeap_allocateStruct(
                    &sample, 
                    UMAA::MM::ControlSystemID::ControlSystemIDReportType);
                if (sample == NULL) {
                    return NULL;
                }
                ...
                {
                    size_t candidateTypeSize = sizeof(UMAA::MM::ControlSystemID::ControlSystemIDReportType);
                ...
                interpreter::get_aggregation_value_pointer< UMAA::MM::ControlSystemID::ControlSystemIDReportType >;
        ...
        const ::dds::core::xtypes::StructType& dynamic_type< UMAA::MM::ControlSystemID::ControlSystemIDReportType >::get()
        {
            return static_cast<const ::dds::core::xtypes::StructType&>(
                ::rti::core::native_conversions::cast_from_native< ::dds::core::xtypes::DynamicType >(
                    *(native_type_code< UMAA::MM::ControlSystemID::ControlSystemIDReportType >::get())));
        }
...
namespace dds { 
    namespace topic {
        void topic_type_support< UMAA::MM::ControlSystemID::ControlSystemIDReportType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                UMAA::MM::ControlSystemID::ControlSystemIDReportTypePlugin_new,
                UMAA::MM::ControlSystemID::ControlSystemIDReportTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< UMAA::MM::ControlSystemID::ControlSystemIDReportType >::to_cdr_buffer(
            std::vector<char>& buffer, 
            const UMAA::MM::ControlSystemID::ControlSystemIDReportType& sample,
        ...
        void topic_type_support< UMAA::MM::ControlSystemID::ControlSystemIDReportType >::from_cdr_buffer(UMAA::MM::ControlSystemID::ControlSystemIDReportType& sample, 
        const std::vector<char>& buffer)
        {
            ...
            "Failed to create UMAA::MM::ControlSystemID::ControlSystemIDReportType from cdr buffer");
        }

        void topic_type_support< UMAA::MM::ControlSystemID::ControlSystemIDReportType >::reset_sample(UMAA::MM::ControlSystemID::ControlSystemIDReportType& sample) 
        {
            sample.name("");
        ...
        void topic_type_support< UMAA::MM::ControlSystemID::ControlSystemIDReportType >::allocate_sample(UMAA::MM::ControlSystemID::ControlSystemIDReportType& sample, int, int) 
        {
