...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ControlSystemID {
            ...
            ClientIDReportType::ClientIDReportType (const std::string& name,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_name_( name ),
                m_source_( source ),
            ...
            ClientIDReportType::ClientIDReportType(ClientIDReportType&& other_) OMG_NOEXCEPT  :m_name_ (std::move(other_.m_name_))
            ,
            ...
            ClientIDReportType& ClientIDReportType::operator=(ClientIDReportType&&  other_) OMG_NOEXCEPT {
                ClientIDReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ClientIDReportType::swap(ClientIDReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
