...
#ifndef ControlSystemIDCommandStatusType_741794046_hpp
#define ControlSystemIDCommandStatusType_741794046_hpp
...
namespace UMAA {
    namespace MM {
        namespace ControlSystemID {
            ...
            static const std::string ControlSystemIDCommandStatus_TOPIC = "UMAA::MM::ControlSystemID::ControlSystemIDCommandStatus";

            class NDDSUSERDllExport ControlSystemIDCommandStatusType {
              public:
                ControlSystemIDCommandStatusType();

                ControlSystemIDCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                ControlSystemIDCommandStatusType (ControlSystemIDCommandStatusType&&) = default;
                ControlSystemIDCommandStatusType& operator=(ControlSystemIDCommandStatusType&&) = default;
                ControlSystemIDCommandStatusType& operator=(const ControlSystemIDCommandStatusType&) = default;
                ControlSystemIDCommandStatusType(const ControlSystemIDCommandStatusType&) = default;
                #else
                ControlSystemIDCommandStatusType(ControlSystemIDCommandStatusType&& other_) OMG_NOEXCEPT;  
                ControlSystemIDCommandStatusType& operator=(ControlSystemIDCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(ControlSystemIDCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ControlSystemIDCommandStatusType& a, ControlSystemIDCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::MM::ControlSystemID::ControlSystemIDCommandStatusType > {
...
#endif // ControlSystemIDCommandStatusType_741794046_hpp
