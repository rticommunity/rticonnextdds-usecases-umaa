...
namespace UMAA {
    namespace MM {
        namespace MissionExecutionControl {
            ...
            static const std::string MissionExecutionCommandStatus_TOPIC = "UMAA::MM::MissionExecutionControl::MissionExecutionCommandStatus";

            class NDDSUSERDllExport MissionExecutionCommandStatusType {
              public:
                MissionExecutionCommandStatusType();

                MissionExecutionCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                MissionExecutionCommandStatusType (MissionExecutionCommandStatusType&&) = default;
                MissionExecutionCommandStatusType& operator=(MissionExecutionCommandStatusType&&) = default;
                MissionExecutionCommandStatusType& operator=(const MissionExecutionCommandStatusType&) = default;
                MissionExecutionCommandStatusType(const MissionExecutionCommandStatusType&) = default;
                #else
                MissionExecutionCommandStatusType(MissionExecutionCommandStatusType&& other_) OMG_NOEXCEPT;  
                MissionExecutionCommandStatusType& operator=(MissionExecutionCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(MissionExecutionCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(MissionExecutionCommandStatusType& a, MissionExecutionCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
