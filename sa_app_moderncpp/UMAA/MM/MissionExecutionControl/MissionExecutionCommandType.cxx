...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace MissionExecutionControl {
            ...
            MissionExecutionCommandType::MissionExecutionCommandType (const UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& missionID):
                m_state_( state ),
                m_source_( source ),
            ...
            MissionExecutionCommandType::MissionExecutionCommandType(MissionExecutionCommandType&& other_) OMG_NOEXCEPT  :m_state_ (std::move(other_.m_state_))
            ,
            ...
            MissionExecutionCommandType& MissionExecutionCommandType::operator=(MissionExecutionCommandType&&  other_) OMG_NOEXCEPT {
                MissionExecutionCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MissionExecutionCommandType::swap(MissionExecutionCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
