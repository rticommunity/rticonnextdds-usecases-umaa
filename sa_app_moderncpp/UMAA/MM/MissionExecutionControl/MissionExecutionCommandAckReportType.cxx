...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace MissionExecutionControl {
            ...
            MissionExecutionCommandAckReportType::MissionExecutionCommandAckReportType (const UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::NumericGUID& missionID):
                m_state_( state ),
                m_source_( source ),
            ...
            MissionExecutionCommandAckReportType::MissionExecutionCommandAckReportType(MissionExecutionCommandAckReportType&& other_) OMG_NOEXCEPT  :m_state_ (std::move(other_.m_state_))
            ,
            ...
            MissionExecutionCommandAckReportType& MissionExecutionCommandAckReportType::operator=(MissionExecutionCommandAckReportType&&  other_) OMG_NOEXCEPT {
                MissionExecutionCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MissionExecutionCommandAckReportType::swap(MissionExecutionCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
