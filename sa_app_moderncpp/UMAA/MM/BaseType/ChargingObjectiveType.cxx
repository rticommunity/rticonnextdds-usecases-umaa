...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            ChargingObjectiveType::ChargingObjectiveType (double chargeLevel):
                m_chargeLevel_( chargeLevel ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ChargingObjectiveType::ChargingObjectiveType(ChargingObjectiveType&& other_) OMG_NOEXCEPT  :m_chargeLevel_ (std::move(other_.m_chargeLevel_))
            {
            } 

            ChargingObjectiveType& ChargingObjectiveType::operator=(ChargingObjectiveType&&  other_) OMG_NOEXCEPT {
                ChargingObjectiveType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ChargingObjectiveType::swap(ChargingObjectiveType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool ChargingObjectiveType::operator == (const ChargingObjectiveType& other_) const {
                if (m_chargeLevel_ != other_.m_chargeLevel_) {
                    return false;
                }
                return true;
            }
