        ...
        namespace BaseType {
            ...
            class NDDSUSERDllExport MissionSummaryType {
              public:
                ...
                MissionSummaryType(const std::string& missionDescription,const std::string& missionName,const UMAA::Common::Measurement::DateTime& startTime,const UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& missionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                MissionSummaryType (MissionSummaryType&&) = default;
                MissionSummaryType& operator=(MissionSummaryType&&) = default;
                MissionSummaryType& operator=(const MissionSummaryType&) = default;
                MissionSummaryType(const MissionSummaryType&) = default;
                #else
                MissionSummaryType(MissionSummaryType&& other_) OMG_NOEXCEPT;  
                MissionSummaryType& operator=(MissionSummaryType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(MissionSummaryType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(MissionSummaryType& a, MissionSummaryType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
