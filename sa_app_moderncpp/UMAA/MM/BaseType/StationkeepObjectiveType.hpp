...
#ifndef StationkeepObjectiveType_353585166_hpp
#define StationkeepObjectiveType_353585166_hpp
        ...
        namespace BaseType {
            ...
            class NDDSUSERDllExport StationkeepObjectiveType {
              public:
                ...
                StationkeepObjectiveType(const UMAA::Common::MaritimeEnumeration::BearingAngleEnumType::BearingAngleEnumType& angleType,double bearing,double closingSpeed,const UMAA::Common::Measurement::NumericGUID& contactTrackID,double distance,const ::dds::core::optional< double >& duration);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                StationkeepObjectiveType (StationkeepObjectiveType&&) = default;
                StationkeepObjectiveType& operator=(StationkeepObjectiveType&&) = default;
                StationkeepObjectiveType& operator=(const StationkeepObjectiveType&) = default;
                StationkeepObjectiveType(const StationkeepObjectiveType&) = default;
                #else
                StationkeepObjectiveType(StationkeepObjectiveType&& other_) OMG_NOEXCEPT;  
                StationkeepObjectiveType& operator=(StationkeepObjectiveType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(StationkeepObjectiveType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(StationkeepObjectiveType& a, StationkeepObjectiveType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
...
#endif // StationkeepObjectiveType_353585166_hpp
