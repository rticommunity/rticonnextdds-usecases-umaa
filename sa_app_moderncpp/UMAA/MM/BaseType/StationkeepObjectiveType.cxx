...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            StationkeepObjectiveType::StationkeepObjectiveType (const UMAA::Common::MaritimeEnumeration::BearingAngleEnumType::BearingAngleEnumType& angleType,double bearing,double closingSpeed,const UMAA::Common::Measurement::NumericGUID& contactTrackID,double distance,const ::dds::core::optional< double >& duration):
            ...
            StationkeepObjectiveType::StationkeepObjectiveType(StationkeepObjectiveType&& other_) OMG_NOEXCEPT  :m_angleType_ (std::move(other_.m_angleType_))
            ,
            ...
            StationkeepObjectiveType& StationkeepObjectiveType::operator=(StationkeepObjectiveType&&  other_) OMG_NOEXCEPT {
                StationkeepObjectiveType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StationkeepObjectiveType::swap(StationkeepObjectiveType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
