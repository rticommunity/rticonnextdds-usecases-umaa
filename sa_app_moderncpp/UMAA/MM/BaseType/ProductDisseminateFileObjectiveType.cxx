...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            ProductDisseminateFileObjectiveType::ProductDisseminateFileObjectiveType (const UMAA::Common::Measurement::NumericGUID& destinationID,const std::string& sourceURI):
                m_destinationID_( destinationID ),
                m_sourceURI_( sourceURI ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ProductDisseminateFileObjectiveType::ProductDisseminateFileObjectiveType(ProductDisseminateFileObjectiveType&& other_) OMG_NOEXCEPT  :m_destinationID_ (std::move(other_.m_destinationID_))
            ,
            m_sourceURI_ (std::move(other_.m_sourceURI_))
            {
            } 

            ProductDisseminateFileObjectiveType& ProductDisseminateFileObjectiveType::operator=(ProductDisseminateFileObjectiveType&&  other_) OMG_NOEXCEPT {
                ProductDisseminateFileObjectiveType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ProductDisseminateFileObjectiveType::swap(ProductDisseminateFileObjectiveType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
