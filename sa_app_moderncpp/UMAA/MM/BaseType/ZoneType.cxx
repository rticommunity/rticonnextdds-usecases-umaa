    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            namespace ZoneType_Specializations {
                ...
                ZoneType_Union::ZoneType_Union(ZoneType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::MM::BaseType::ZoneType_Specializations::ZoneType_Selectors::PLANNINGZONETYPE_SELECT):
                            {  
                                PlanningZoneType_data( std::move(other_.PlanningZoneType_data()));
                        } break;
                ...
                ZoneType_Union& ZoneType_Union::operator=(ZoneType_Union&&  other_) OMG_NOEXCEPT {
                    ZoneType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                ZoneType_Union::Union_::Union_(const UMAA::MM::BaseType::PlanningZoneType& PlanningZoneType_data):
                    m_PlanningZoneType_data_( PlanningZoneType_data ) {
                }
                ...
                void ZoneType_Union::swap(ZoneType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const ZoneType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        case (UMAA::MM::BaseType::ZoneType_Specializations::ZoneType_Selectors::PLANNINGZONETYPE_SELECT):
                            {  
                                o << "PlanningZoneType_data: " << sample.PlanningZoneType_data() ;        } break ;
            ...
            ZoneType::ZoneType (const UMAA::Common::Measurement::Polygon_Volume& zone,const UMAA::Common::MaritimeEnumeration::ZoneKindEnumType::ZoneKindEnumType& zoneKind,const UMAA::MM::BaseType::ZoneType_Specializations::ZoneType_Union& ZoneType_subtypes,const UMAA::Common::Measurement::NumericGUID& zoneID):
                m_zone_( zone ),
                m_zoneKind_( zoneKind ),
                m_ZoneType_subtypes_( ZoneType_subtypes ),
                m_zoneID_( zoneID ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ZoneType::ZoneType(ZoneType&& other_) OMG_NOEXCEPT  :m_zone_ (std::move(other_.m_zone_))
            ,
            m_zoneKind_ (std::move(other_.m_zoneKind_))
            ,
            m_ZoneType_subtypes_ (std::move(other_.m_ZoneType_subtypes_))
            ,
            m_zoneID_ (std::move(other_.m_zoneID_))
            {
            } 

            ZoneType& ZoneType::operator=(ZoneType&&  other_) OMG_NOEXCEPT {
                ZoneType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ZoneType::swap(ZoneType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
