...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            TaskPlanType::TaskPlanType(TaskPlanType&& other_) OMG_NOEXCEPT  :m_dependentTaskIDs_ (std::move(other_.m_dependentTaskIDs_))
            ,
            ...
            ,
            m_objectives_ (std::move(other_.m_objectives_))
            ,
            ...
            TaskPlanType& TaskPlanType::operator=(TaskPlanType&&  other_) OMG_NOEXCEPT {
                TaskPlanType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void TaskPlanType::swap(TaskPlanType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
