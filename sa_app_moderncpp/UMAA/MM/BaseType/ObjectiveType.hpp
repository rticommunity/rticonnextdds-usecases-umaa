        ...
        namespace BaseType {
            namespace ObjectiveType_Specializations {
                ...
                class NDDSUSERDllExport ObjectiveType_Union {
                  public:
                    ...
                    ObjectiveType_Union (ObjectiveType_Union&&) = default;
                    ObjectiveType_Union& operator=(ObjectiveType_Union&&) = default;
                    ObjectiveType_Union& operator=(const ObjectiveType_Union&) = default;
                    ObjectiveType_Union(const ObjectiveType_Union&) = default;
                    #else
                    ObjectiveType_Union(ObjectiveType_Union&& other_) OMG_NOEXCEPT;  
                    ObjectiveType_Union& operator=(ObjectiveType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::MM::BaseType::ObjectiveType_Specializations::ObjectiveType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(ObjectiveType_Union& other_) OMG_NOEXCEPT ;
            ...
            class NDDSUSERDllExport ObjectiveType {
              public:
                ...
                ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& childObjectiveIDs() OMG_NOEXCEPT {
                    return m_childObjectiveIDs_;
                }

                const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& childObjectiveIDs() const OMG_NOEXCEPT {
                    return m_childObjectiveIDs_;
                }
                ...
                ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& dependentObjectiveIDs() OMG_NOEXCEPT {
                    return m_dependentObjectiveIDs_;
                }

                const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& dependentObjectiveIDs() const OMG_NOEXCEPT {
                    return m_dependentObjectiveIDs_;
                }
                ...
                ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& preferredResourceIDs() OMG_NOEXCEPT {
                    return m_preferredResourceIDs_;
                }

                const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& preferredResourceIDs() const OMG_NOEXCEPT {
                    return m_preferredResourceIDs_;
                }
                ...
                UMAA::MM::BaseType::ObjectiveType_Specializations::ObjectiveType_Union& ObjectiveType_subtypes() OMG_NOEXCEPT {
                    return m_ObjectiveType_subtypes_;
                }

                const UMAA::MM::BaseType::ObjectiveType_Specializations::ObjectiveType_Union& ObjectiveType_subtypes() const OMG_NOEXCEPT {
                    return m_ObjectiveType_subtypes_;
                }
                ...
                UMAA::Common::Measurement::NumericGUID& parentObjectiveID() OMG_NOEXCEPT {
                    return m_parentObjectiveID_;
                }

                const UMAA::Common::Measurement::NumericGUID& parentObjectiveID() const OMG_NOEXCEPT {
                    return m_parentObjectiveID_;
                }
                ...
                void swap(ObjectiveType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ObjectiveType& a, ObjectiveType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
