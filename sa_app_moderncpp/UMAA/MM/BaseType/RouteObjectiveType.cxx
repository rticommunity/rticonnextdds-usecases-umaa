...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            RouteObjectiveType::RouteObjectiveType (const UMAA::Common::MaritimeEnumeration::HeightModeEnumType::HeightModeEnumType& mode,const std::string& routeDescription,const ::rti::core::bounded_sequence< UMAA::MM::BaseType::WaypointType, 100L >& waypoints):
                m_mode_( mode ),
                m_routeDescription_( routeDescription ),
                m_waypoints_( waypoints ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            RouteObjectiveType::RouteObjectiveType(RouteObjectiveType&& other_) OMG_NOEXCEPT  :m_mode_ (std::move(other_.m_mode_))
            ,
            m_routeDescription_ (std::move(other_.m_routeDescription_))
            ,
            m_waypoints_ (std::move(other_.m_waypoints_))
            {
            } 

            RouteObjectiveType& RouteObjectiveType::operator=(RouteObjectiveType&&  other_) OMG_NOEXCEPT {
                RouteObjectiveType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void RouteObjectiveType::swap(RouteObjectiveType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
