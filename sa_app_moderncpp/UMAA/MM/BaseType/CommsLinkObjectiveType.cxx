...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            CommsLinkObjectiveType::CommsLinkObjectiveType(CommsLinkObjectiveType&& other_) OMG_NOEXCEPT   {
            } 

            CommsLinkObjectiveType& CommsLinkObjectiveType::operator=(CommsLinkObjectiveType&&  other_) OMG_NOEXCEPT {
                CommsLinkObjectiveType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CommsLinkObjectiveType::swap(CommsLinkObjectiveType& )  OMG_NOEXCEPT 
            {
                using std::swap;
            }  
