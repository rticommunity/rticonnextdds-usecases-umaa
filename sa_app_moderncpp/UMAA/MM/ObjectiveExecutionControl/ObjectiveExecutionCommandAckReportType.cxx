...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ObjectiveExecutionControl {
            ...
            ObjectiveExecutionCommandAckReportType::ObjectiveExecutionCommandAckReportType (const UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::NumericGUID& missionID,const UMAA::Common::Measurement::NumericGUID& objectiveID,const UMAA::Common::Measurement::NumericGUID& taskID):
                m_state_( state ),
                m_source_( source ),
            ...
            ObjectiveExecutionCommandAckReportType::ObjectiveExecutionCommandAckReportType(ObjectiveExecutionCommandAckReportType&& other_) OMG_NOEXCEPT  :m_state_ (std::move(other_.m_state_))
            ,
            ...
            ObjectiveExecutionCommandAckReportType& ObjectiveExecutionCommandAckReportType::operator=(ObjectiveExecutionCommandAckReportType&&  other_) OMG_NOEXCEPT {
                ObjectiveExecutionCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ObjectiveExecutionCommandAckReportType::swap(ObjectiveExecutionCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
