...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ObjectiveExecutionStatus {
            ...
            ObjectiveExecutionReportType::ObjectiveExecutionReportType (const ::rti::core::bounded_sequence< UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType, 100L >& objectiveStatuses,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_objectiveStatuses_( objectiveStatuses ),
                m_source_( source ),
            ...
            ObjectiveExecutionReportType::ObjectiveExecutionReportType(ObjectiveExecutionReportType&& other_) OMG_NOEXCEPT  :m_objectiveStatuses_ (std::move(other_.m_objectiveStatuses_))
            ,
            ...
            ObjectiveExecutionReportType& ObjectiveExecutionReportType::operator=(ObjectiveExecutionReportType&&  other_) OMG_NOEXCEPT {
                ObjectiveExecutionReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ObjectiveExecutionReportType::swap(ObjectiveExecutionReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
