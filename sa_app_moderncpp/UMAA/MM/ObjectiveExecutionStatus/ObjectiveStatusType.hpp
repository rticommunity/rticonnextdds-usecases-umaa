...
#ifndef ObjectiveStatusType_400146106_hpp
#define ObjectiveStatusType_400146106_hpp
        ...
        namespace ObjectiveExecutionStatus {
            ...
            class NDDSUSERDllExport ObjectiveStatusType {
              public:
                ...
                bool operator == (const ObjectiveStatusType& other_) const;
                bool operator != (const ObjectiveStatusType& other_) const;

                void swap(ObjectiveStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ObjectiveStatusType& a, ObjectiveStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ObjectiveStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType > {
        ...
        template <>
        struct extensibility< UMAA::MM::ObjectiveExecutionStatus::ObjectiveStatusType > {
...
#endif // ObjectiveStatusType_400146106_hpp
