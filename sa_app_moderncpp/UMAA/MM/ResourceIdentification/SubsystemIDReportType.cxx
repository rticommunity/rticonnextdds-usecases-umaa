...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ResourceIdentification {
            ...
            SubsystemIDReportType::SubsystemIDReportType (bool isControlTransferCapable,const std::string& name,const std::string& type,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            SubsystemIDReportType::SubsystemIDReportType(SubsystemIDReportType&& other_) OMG_NOEXCEPT  :m_isControlTransferCapable_ (std::move(other_.m_isControlTransferCapable_))
            ,
            ...
            SubsystemIDReportType& SubsystemIDReportType::operator=(SubsystemIDReportType&&  other_) OMG_NOEXCEPT {
                SubsystemIDReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SubsystemIDReportType::swap(SubsystemIDReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
