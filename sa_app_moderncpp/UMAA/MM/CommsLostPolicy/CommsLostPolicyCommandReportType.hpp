...
#ifndef CommsLostPolicyCommandReportType_510865992_hpp
#define CommsLostPolicyCommandReportType_510865992_hpp
...
namespace UMAA {
    namespace MM {
        namespace CommsLostPolicy {
            ...
            static const std::string CommsLostPolicyCommandReport_TOPIC = "UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReport";

            class NDDSUSERDllExport CommsLostPolicyCommandReportType {
              public:
                CommsLostPolicyCommandReportType();

                CommsLostPolicyCommandReportType(double commsLostTimeOut,bool commsRegainedStop,double commsRegainedTimeOut,const ::dds::core::optional< bool >& continueMission,const ::dds::core::optional< UMAA::MM::CommsLostPolicy::MoveToPosPolicyType >& moveToPos,const ::dds::core::optional< UMAA::MM::CommsLostPolicy::RetrotraversePolicyType >& retrotraverse,const ::dds::core::optional< bool >& stopMotion,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                CommsLostPolicyCommandReportType (CommsLostPolicyCommandReportType&&) = default;
                CommsLostPolicyCommandReportType& operator=(CommsLostPolicyCommandReportType&&) = default;
                CommsLostPolicyCommandReportType& operator=(const CommsLostPolicyCommandReportType&) = default;
                CommsLostPolicyCommandReportType(const CommsLostPolicyCommandReportType&) = default;
                #else
                CommsLostPolicyCommandReportType(CommsLostPolicyCommandReportType&& other_) OMG_NOEXCEPT;  
                CommsLostPolicyCommandReportType& operator=(CommsLostPolicyCommandReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const CommsLostPolicyCommandReportType& other_) const;
                bool operator != (const CommsLostPolicyCommandReportType& other_) const;

                void swap(CommsLostPolicyCommandReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(CommsLostPolicyCommandReportType& a, CommsLostPolicyCommandReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CommsLostPolicyCommandReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType > {
        ...
        template <>
        struct extensibility< UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReportType > {
...
#endif // CommsLostPolicyCommandReportType_510865992_hpp
