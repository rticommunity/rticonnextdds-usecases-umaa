...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace CommsLostPolicy {
            ...
            RetrotraversePolicyType::RetrotraversePolicyType (const UMAA::MM::Retrotraverse::RetrotraverseType& retrotraversePolicy,const ::dds::core::optional< UMAA::MM::BaseType::WaypointType >& waypointPolicy):
                m_retrotraversePolicy_( retrotraversePolicy ),
                m_waypointPolicy_( waypointPolicy ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            RetrotraversePolicyType::RetrotraversePolicyType(RetrotraversePolicyType&& other_) OMG_NOEXCEPT  :m_retrotraversePolicy_ (std::move(other_.m_retrotraversePolicy_))
            ,
            m_waypointPolicy_ (std::move(other_.m_waypointPolicy_))
            {
            } 

            RetrotraversePolicyType& RetrotraversePolicyType::operator=(RetrotraversePolicyType&&  other_) OMG_NOEXCEPT {
                RetrotraversePolicyType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void RetrotraversePolicyType::swap(RetrotraversePolicyType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
