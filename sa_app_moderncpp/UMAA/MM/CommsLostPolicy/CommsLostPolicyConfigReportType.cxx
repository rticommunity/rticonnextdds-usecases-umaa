...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace CommsLostPolicy {
            ...
            CommsLostPolicyConfigReportType::CommsLostPolicyConfigReportType(CommsLostPolicyConfigReportType&& other_) OMG_NOEXCEPT  :m_commsLostTimeOut_ (std::move(other_.m_commsLostTimeOut_))
            ,
            ...
            CommsLostPolicyConfigReportType& CommsLostPolicyConfigReportType::operator=(CommsLostPolicyConfigReportType&&  other_) OMG_NOEXCEPT {
                CommsLostPolicyConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CommsLostPolicyConfigReportType::swap(CommsLostPolicyConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
