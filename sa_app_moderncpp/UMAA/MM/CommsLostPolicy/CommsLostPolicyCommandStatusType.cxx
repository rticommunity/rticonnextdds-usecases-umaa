...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace CommsLostPolicy {
            ...
            CommsLostPolicyCommandStatusType::CommsLostPolicyCommandStatusType(CommsLostPolicyCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            CommsLostPolicyCommandStatusType& CommsLostPolicyCommandStatusType::operator=(CommsLostPolicyCommandStatusType&&  other_) OMG_NOEXCEPT {
                CommsLostPolicyCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CommsLostPolicyCommandStatusType::swap(CommsLostPolicyCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
