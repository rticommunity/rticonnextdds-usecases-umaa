...
namespace UMAA {
    namespace MM {
        namespace CommsLostPolicy {
            ...
            static const std::string CommsLostPolicyConfigReport_TOPIC = "UMAA::MM::CommsLostPolicy::CommsLostPolicyConfigReport";

            class NDDSUSERDllExport CommsLostPolicyConfigReportType {
              public:
                CommsLostPolicyConfigReportType();

                CommsLostPolicyConfigReportType(double commsLostTimeOut,bool commsRegainedStop,double commsRegainedTimeOut,const ::dds::core::optional< bool >& continueMission,const ::dds::core::optional< UMAA::MM::CommsLostPolicy::MoveToPosPolicyType >& moveToPos,const ::dds::core::optional< UMAA::MM::CommsLostPolicy::RetrotraversePolicyType >& retrotraverse,const ::dds::core::optional< bool >& stopMotion,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                CommsLostPolicyConfigReportType (CommsLostPolicyConfigReportType&&) = default;
                CommsLostPolicyConfigReportType& operator=(CommsLostPolicyConfigReportType&&) = default;
                CommsLostPolicyConfigReportType& operator=(const CommsLostPolicyConfigReportType&) = default;
                CommsLostPolicyConfigReportType(const CommsLostPolicyConfigReportType&) = default;
                #else
                CommsLostPolicyConfigReportType(CommsLostPolicyConfigReportType&& other_) OMG_NOEXCEPT;  
                CommsLostPolicyConfigReportType& operator=(CommsLostPolicyConfigReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(CommsLostPolicyConfigReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(CommsLostPolicyConfigReportType& a, CommsLostPolicyConfigReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
