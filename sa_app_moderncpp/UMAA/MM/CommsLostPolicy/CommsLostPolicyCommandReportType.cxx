...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace CommsLostPolicy {
            ...
            CommsLostPolicyCommandReportType::CommsLostPolicyCommandReportType(CommsLostPolicyCommandReportType&& other_) OMG_NOEXCEPT  :m_commsLostTimeOut_ (std::move(other_.m_commsLostTimeOut_))
            ,
            ...
            CommsLostPolicyCommandReportType& CommsLostPolicyCommandReportType::operator=(CommsLostPolicyCommandReportType&&  other_) OMG_NOEXCEPT {
                CommsLostPolicyCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CommsLostPolicyCommandReportType::swap(CommsLostPolicyCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
