...
namespace UMAA {
    namespace MO {
        namespace LocalRegularPolygonControl {
            ...
            static const std::string LocalRegularPolygonExecutionStatusReport_TOPIC = "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonExecutionStatusReport";

            class NDDSUSERDllExport LocalRegularPolygonExecutionStatusReportType {
              public:
                LocalRegularPolygonExecutionStatusReportType();

                LocalRegularPolygonExecutionStatusReportType(const UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType& localRegularPolygonState,const UMAA::Common::Measurement::DateTime& timePatternAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timePatternCompleted,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalRegularPolygonExecutionStatusReportType (LocalRegularPolygonExecutionStatusReportType&&) = default;
                LocalRegularPolygonExecutionStatusReportType& operator=(LocalRegularPolygonExecutionStatusReportType&&) = default;
                LocalRegularPolygonExecutionStatusReportType& operator=(const LocalRegularPolygonExecutionStatusReportType&) = default;
                LocalRegularPolygonExecutionStatusReportType(const LocalRegularPolygonExecutionStatusReportType&) = default;
                #else
                LocalRegularPolygonExecutionStatusReportType(LocalRegularPolygonExecutionStatusReportType&& other_) OMG_NOEXCEPT;  
                LocalRegularPolygonExecutionStatusReportType& operator=(LocalRegularPolygonExecutionStatusReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType& localRegularPolygonState() OMG_NOEXCEPT {
                    return m_localRegularPolygonState_;
                }

                const UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType& localRegularPolygonState() const OMG_NOEXCEPT {
                    return m_localRegularPolygonState_;
                }
                ...
                void swap(LocalRegularPolygonExecutionStatusReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalRegularPolygonExecutionStatusReportType& a, LocalRegularPolygonExecutionStatusReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
