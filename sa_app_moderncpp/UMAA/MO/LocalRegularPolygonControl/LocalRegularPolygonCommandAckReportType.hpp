...
#ifndef LocalRegularPolygonCommandAckReportType_756167515_hpp
#define LocalRegularPolygonCommandAckReportType_756167515_hpp
...
namespace UMAA {
    namespace MO {
        namespace LocalRegularPolygonControl {
            ...
            static const std::string LocalRegularPolygonCommandAckReport_TOPIC = "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReport";

            class NDDSUSERDllExport LocalRegularPolygonCommandAckReportType {
              public:
                LocalRegularPolygonCommandAckReportType();

                LocalRegularPolygonCommandAckReportType(double crossTrackTolerance,double diameter,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,int32_t numberSides,const UMAA::Common::Orientation::HeadingType& orientation,const ::dds::core::optional< UMAA::Common::Measurement::Position2D_PlatformXYZ >& position,double speedTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::MaritimeEnumeration::WaterTurnDirectionEnumType::WaterTurnDirectionEnumType& turnDirection,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalRegularPolygonCommandAckReportType (LocalRegularPolygonCommandAckReportType&&) = default;
                LocalRegularPolygonCommandAckReportType& operator=(LocalRegularPolygonCommandAckReportType&&) = default;
                LocalRegularPolygonCommandAckReportType& operator=(const LocalRegularPolygonCommandAckReportType&) = default;
                LocalRegularPolygonCommandAckReportType(const LocalRegularPolygonCommandAckReportType&) = default;
                #else
                LocalRegularPolygonCommandAckReportType(LocalRegularPolygonCommandAckReportType&& other_) OMG_NOEXCEPT;  
                LocalRegularPolygonCommandAckReportType& operator=(LocalRegularPolygonCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalRegularPolygonCommandAckReportType& other_) const;
                bool operator != (const LocalRegularPolygonCommandAckReportType& other_) const;

                void swap(LocalRegularPolygonCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalRegularPolygonCommandAckReportType& a, LocalRegularPolygonCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalRegularPolygonCommandAckReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReportType > {
...
#endif // LocalRegularPolygonCommandAckReportType_756167515_hpp
