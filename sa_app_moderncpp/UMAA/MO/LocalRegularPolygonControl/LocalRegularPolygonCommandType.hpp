...
#ifndef LocalRegularPolygonCommandType_501434250_hpp
#define LocalRegularPolygonCommandType_501434250_hpp
...
namespace UMAA {
    namespace MO {
        namespace LocalRegularPolygonControl {
            ...
            static const std::string LocalRegularPolygonCommand_TOPIC = "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommand";

            class NDDSUSERDllExport LocalRegularPolygonCommandType {
              public:
                LocalRegularPolygonCommandType();

                LocalRegularPolygonCommandType(double crossTrackTolerance,double diameter,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,int32_t numberSides,const UMAA::Common::Orientation::HeadingType& orientation,const ::dds::core::optional< UMAA::Common::Measurement::Position2D_PlatformXYZ >& position,double speedTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::MaritimeEnumeration::WaterTurnDirectionEnumType::WaterTurnDirectionEnumType& turnDirection,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalRegularPolygonCommandType (LocalRegularPolygonCommandType&&) = default;
                LocalRegularPolygonCommandType& operator=(LocalRegularPolygonCommandType&&) = default;
                LocalRegularPolygonCommandType& operator=(const LocalRegularPolygonCommandType&) = default;
                LocalRegularPolygonCommandType(const LocalRegularPolygonCommandType&) = default;
                #else
                LocalRegularPolygonCommandType(LocalRegularPolygonCommandType&& other_) OMG_NOEXCEPT;  
                LocalRegularPolygonCommandType& operator=(LocalRegularPolygonCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalRegularPolygonCommandType& other_) const;
                bool operator != (const LocalRegularPolygonCommandType& other_) const;

                void swap(LocalRegularPolygonCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalRegularPolygonCommandType& a, LocalRegularPolygonCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalRegularPolygonCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandType > {
...
#endif // LocalRegularPolygonCommandType_501434250_hpp
