...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalRegularPolygonControl {
            ...
            LocalRegularPolygonExecutionStatusReportType::LocalRegularPolygonExecutionStatusReportType(LocalRegularPolygonExecutionStatusReportType&& other_) OMG_NOEXCEPT  :m_localRegularPolygonState_ (std::move(other_.m_localRegularPolygonState_))
            ,
            ...
            LocalRegularPolygonExecutionStatusReportType& LocalRegularPolygonExecutionStatusReportType::operator=(LocalRegularPolygonExecutionStatusReportType&&  other_) OMG_NOEXCEPT {
                LocalRegularPolygonExecutionStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalRegularPolygonExecutionStatusReportType::swap(LocalRegularPolygonExecutionStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
