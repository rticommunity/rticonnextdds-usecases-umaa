        ...
        namespace LocalFigure8State {
            namespace LocalFigure8StateType_Specializations {
                ...
                class NDDSUSERDllExport LocalFigure8StateType_Union {
                  public:
                    ...
                    LocalFigure8StateType_Union (LocalFigure8StateType_Union&&) = default;
                    LocalFigure8StateType_Union& operator=(LocalFigure8StateType_Union&&) = default;
                    LocalFigure8StateType_Union& operator=(const LocalFigure8StateType_Union&) = default;
                    LocalFigure8StateType_Union(const LocalFigure8StateType_Union&) = default;
                    #else
                    LocalFigure8StateType_Union(LocalFigure8StateType_Union&& other_) OMG_NOEXCEPT;  
                    LocalFigure8StateType_Union& operator=(LocalFigure8StateType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(LocalFigure8StateType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::MO::LocalFigure8State::LocalFigure8PatternType& LocalFigure8PatternType_data,const UMAA::MO::LocalFigure8State::LocalFigure8TransitType& LocalFigure8TransitType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(LocalFigure8StateType_Union& a, LocalFigure8StateType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport LocalFigure8StateType {
              public:
                ...
                explicit LocalFigure8StateType(const UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Union& LocalFigure8StateType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalFigure8StateType (LocalFigure8StateType&&) = default;
                LocalFigure8StateType& operator=(LocalFigure8StateType&&) = default;
                LocalFigure8StateType& operator=(const LocalFigure8StateType&) = default;
                LocalFigure8StateType(const LocalFigure8StateType&) = default;
                #else
                LocalFigure8StateType(LocalFigure8StateType&& other_) OMG_NOEXCEPT;  
                LocalFigure8StateType& operator=(LocalFigure8StateType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Union& LocalFigure8StateType_subtypes() OMG_NOEXCEPT {
                    return m_LocalFigure8StateType_subtypes_;
                }

                const UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Union& LocalFigure8StateType_subtypes() const OMG_NOEXCEPT {
                    return m_LocalFigure8StateType_subtypes_;
                }
                ...
                void swap(LocalFigure8StateType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalFigure8StateType& a, LocalFigure8StateType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
