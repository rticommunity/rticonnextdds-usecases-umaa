    ...
    namespace MO {
        ...
        namespace LocalFigure8State {
            ...
            namespace LocalFigure8StateType_Specializations {
                ...
                LocalFigure8StateType_Union::LocalFigure8StateType_Union(LocalFigure8StateType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Selectors::LOCALFIGURE8PATTERNTYPE_SELECT):
                            {  
                                LocalFigure8PatternType_data( std::move(other_.LocalFigure8PatternType_data()));
                        } break;
                        case (UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Selectors::LOCALFIGURE8TRANSITTYPE_SELECT):
                            {  
                                LocalFigure8TransitType_data( std::move(other_.LocalFigure8TransitType_data()));
                        } break;
                ...
                LocalFigure8StateType_Union& LocalFigure8StateType_Union::operator=(LocalFigure8StateType_Union&&  other_) OMG_NOEXCEPT {
                    LocalFigure8StateType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                LocalFigure8StateType_Union::Union_::Union_(const UMAA::MO::LocalFigure8State::LocalFigure8PatternType& LocalFigure8PatternType_data,const UMAA::MO::LocalFigure8State::LocalFigure8TransitType& LocalFigure8TransitType_data):
                    m_LocalFigure8PatternType_data_( LocalFigure8PatternType_data ),
                    m_LocalFigure8TransitType_data_( LocalFigure8TransitType_data ) {
                }
                ...
                void LocalFigure8StateType_Union::swap(LocalFigure8StateType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const LocalFigure8StateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Selectors::LOCALFIGURE8TRANSITTYPE_SELECT):
                            {  
                                o << "LocalFigure8TransitType_data: " << sample.LocalFigure8TransitType_data() ;        } break ;
            ...
            LocalFigure8StateType::LocalFigure8StateType (const UMAA::MO::LocalFigure8State::LocalFigure8StateType_Specializations::LocalFigure8StateType_Union& LocalFigure8StateType_subtypes):
                m_LocalFigure8StateType_subtypes_( LocalFigure8StateType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            LocalFigure8StateType::LocalFigure8StateType(LocalFigure8StateType&& other_) OMG_NOEXCEPT  :m_LocalFigure8StateType_subtypes_ (std::move(other_.m_LocalFigure8StateType_subtypes_))
            {
            } 

            LocalFigure8StateType& LocalFigure8StateType::operator=(LocalFigure8StateType&&  other_) OMG_NOEXCEPT {
                LocalFigure8StateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalFigure8StateType::swap(LocalFigure8StateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
