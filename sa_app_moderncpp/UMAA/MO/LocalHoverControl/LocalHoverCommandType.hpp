...
#ifndef LocalHoverCommandType_561059918_hpp
#define LocalHoverCommandType_561059918_hpp
...
namespace UMAA {
    namespace MO {
        namespace LocalHoverControl {
            ...
            static const std::string LocalHoverCommand_TOPIC = "UMAA::MO::LocalHoverControl::LocalHoverCommand";

            class NDDSUSERDllExport LocalHoverCommandType {
              public:
                ...
                LocalHoverCommandType (LocalHoverCommandType&&) = default;
                LocalHoverCommandType& operator=(LocalHoverCommandType&&) = default;
                LocalHoverCommandType& operator=(const LocalHoverCommandType&) = default;
                LocalHoverCommandType(const LocalHoverCommandType&) = default;
                #else
                LocalHoverCommandType(LocalHoverCommandType&& other_) OMG_NOEXCEPT;  
                LocalHoverCommandType& operator=(LocalHoverCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalHoverCommandType& other_) const;
                bool operator != (const LocalHoverCommandType& other_) const;

                void swap(LocalHoverCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalHoverCommandType& a, LocalHoverCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalHoverCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalHoverControl::LocalHoverCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalHoverControl::LocalHoverCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalHoverControl::LocalHoverCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalHoverControl::LocalHoverCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalHoverControl::LocalHoverCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalHoverControl::LocalHoverCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalHoverControl::LocalHoverCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalHoverControl::LocalHoverCommandType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalHoverControl::LocalHoverCommandType > {
...
#endif // LocalHoverCommandType_561059918_hpp
