...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalHoverControl {
            ...
            LocalHoverExecutionStatusReport::LocalHoverExecutionStatusReport (const UMAA::MO::LocalHoverState::LocalHoverStateType& localHoverState,const UMAA::Common::Measurement::DateTime& timeHoverAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timeHoverCompleted):
                m_localHoverState_( localHoverState ),
            ...
            LocalHoverExecutionStatusReport::LocalHoverExecutionStatusReport(LocalHoverExecutionStatusReport&& other_) OMG_NOEXCEPT  :m_localHoverState_ (std::move(other_.m_localHoverState_))
            ,
            ...
            LocalHoverExecutionStatusReport& LocalHoverExecutionStatusReport::operator=(LocalHoverExecutionStatusReport&&  other_) OMG_NOEXCEPT {
                LocalHoverExecutionStatusReport tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalHoverExecutionStatusReport::swap(LocalHoverExecutionStatusReport& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
