...
#ifndef LocalHoverCommandAckReportType_890053681_hpp
#define LocalHoverCommandAckReportType_890053681_hpp
...
namespace UMAA {
    namespace MO {
        namespace LocalHoverControl {
            ...
            static const std::string LocalHoverCommandAckReport_TOPIC = "UMAA::MO::LocalHoverControl::LocalHoverCommandAckReport";

            class NDDSUSERDllExport LocalHoverCommandAckReportType {
              public:
                LocalHoverCommandAckReportType();

                LocalHoverCommandAckReportType(const UMAA::Common::MaritimeEnumeration::HoverKindEnumType::HoverKindEnumType& controlPriority,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,const ::dds::core::optional< UMAA::Common::Orientation::HeadingType >& heading,double headingTolerance,const ::dds::core::optional< UMAA::Common::Measurement::Position2D_PlatformXYZ >& position,double positionTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalHoverCommandAckReportType (LocalHoverCommandAckReportType&&) = default;
                LocalHoverCommandAckReportType& operator=(LocalHoverCommandAckReportType&&) = default;
                LocalHoverCommandAckReportType& operator=(const LocalHoverCommandAckReportType&) = default;
                LocalHoverCommandAckReportType(const LocalHoverCommandAckReportType&) = default;
                #else
                LocalHoverCommandAckReportType(LocalHoverCommandAckReportType&& other_) OMG_NOEXCEPT;  
                LocalHoverCommandAckReportType& operator=(LocalHoverCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalHoverCommandAckReportType& other_) const;
                bool operator != (const LocalHoverCommandAckReportType& other_) const;

                void swap(LocalHoverCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalHoverCommandAckReportType& a, LocalHoverCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalHoverCommandAckReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalHoverControl::LocalHoverCommandAckReportType > {
...
#endif // LocalHoverCommandAckReportType_890053681_hpp
