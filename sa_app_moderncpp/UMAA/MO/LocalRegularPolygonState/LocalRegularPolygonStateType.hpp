        ...
        namespace LocalRegularPolygonState {
            namespace LocalRegularPolygonStateType_Specializations {
                ...
                class NDDSUSERDllExport LocalRegularPolygonStateType_Union {
                  public:
                    ...
                    LocalRegularPolygonStateType_Union (LocalRegularPolygonStateType_Union&&) = default;
                    LocalRegularPolygonStateType_Union& operator=(LocalRegularPolygonStateType_Union&&) = default;
                    LocalRegularPolygonStateType_Union& operator=(const LocalRegularPolygonStateType_Union&) = default;
                    LocalRegularPolygonStateType_Union(const LocalRegularPolygonStateType_Union&) = default;
                    #else
                    LocalRegularPolygonStateType_Union(LocalRegularPolygonStateType_Union&& other_) OMG_NOEXCEPT;  
                    LocalRegularPolygonStateType_Union& operator=(LocalRegularPolygonStateType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType_Specializations::LocalRegularPolygonStateType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(LocalRegularPolygonStateType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonPatternType& LocalRegularPolygonPatternType_data,const UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonTransitTypeType& LocalRegularPolygonTransitTypeType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(LocalRegularPolygonStateType_Union& a, LocalRegularPolygonStateType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport LocalRegularPolygonStateType {
              public:
                ...
                explicit LocalRegularPolygonStateType(const UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType_Specializations::LocalRegularPolygonStateType_Union& LocalRegularPolygonStateType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalRegularPolygonStateType (LocalRegularPolygonStateType&&) = default;
                LocalRegularPolygonStateType& operator=(LocalRegularPolygonStateType&&) = default;
                LocalRegularPolygonStateType& operator=(const LocalRegularPolygonStateType&) = default;
                LocalRegularPolygonStateType(const LocalRegularPolygonStateType&) = default;
                #else
                LocalRegularPolygonStateType(LocalRegularPolygonStateType&& other_) OMG_NOEXCEPT;  
                LocalRegularPolygonStateType& operator=(LocalRegularPolygonStateType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType_Specializations::LocalRegularPolygonStateType_Union& LocalRegularPolygonStateType_subtypes() OMG_NOEXCEPT {
                    return m_LocalRegularPolygonStateType_subtypes_;
                }

                const UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType_Specializations::LocalRegularPolygonStateType_Union& LocalRegularPolygonStateType_subtypes() const OMG_NOEXCEPT {
                    return m_LocalRegularPolygonStateType_subtypes_;
                }
                ...
                void swap(LocalRegularPolygonStateType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalRegularPolygonStateType& a, LocalRegularPolygonStateType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
