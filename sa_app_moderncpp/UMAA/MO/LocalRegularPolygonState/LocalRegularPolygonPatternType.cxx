...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalRegularPolygonState {
            ...
            LocalRegularPolygonPatternType::LocalRegularPolygonPatternType (bool elevationAchieved,bool positionAchieved,bool speedAchieved):
            ...
            LocalRegularPolygonPatternType::LocalRegularPolygonPatternType(LocalRegularPolygonPatternType&& other_) OMG_NOEXCEPT  :m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            ...
            LocalRegularPolygonPatternType& LocalRegularPolygonPatternType::operator=(LocalRegularPolygonPatternType&&  other_) OMG_NOEXCEPT {
                LocalRegularPolygonPatternType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalRegularPolygonPatternType::swap(LocalRegularPolygonPatternType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
