...
#ifndef GlobalRegularPolygonCommandType_2080232851_hpp
#define GlobalRegularPolygonCommandType_2080232851_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalRegularPolygonControl {
            ...
            static const std::string GlobalRegularPolygonCommand_TOPIC = "UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommand";

            class NDDSUSERDllExport GlobalRegularPolygonCommandType {
              public:
                GlobalRegularPolygonCommandType();

                GlobalRegularPolygonCommandType(double crossTrackTolerance,double diameter,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,int32_t numberSides,const UMAA::Common::Orientation::HeadingType& orientation,const ::dds::core::optional< UMAA::Common::Measurement::Position2D >& position,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::MaritimeEnumeration::WaterTurnDirectionEnumType::WaterTurnDirectionEnumType& turnDirection,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalRegularPolygonCommandType (GlobalRegularPolygonCommandType&&) = default;
                GlobalRegularPolygonCommandType& operator=(GlobalRegularPolygonCommandType&&) = default;
                GlobalRegularPolygonCommandType& operator=(const GlobalRegularPolygonCommandType&) = default;
                GlobalRegularPolygonCommandType(const GlobalRegularPolygonCommandType&) = default;
                #else
                GlobalRegularPolygonCommandType(GlobalRegularPolygonCommandType&& other_) OMG_NOEXCEPT;  
                GlobalRegularPolygonCommandType& operator=(GlobalRegularPolygonCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GlobalRegularPolygonCommandType& other_) const;
                bool operator != (const GlobalRegularPolygonCommandType& other_) const;

                void swap(GlobalRegularPolygonCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalRegularPolygonCommandType& a, GlobalRegularPolygonCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalRegularPolygonCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType > {
        ...
        template <>
        struct extensibility< UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandType > {
...
#endif // GlobalRegularPolygonCommandType_2080232851_hpp
