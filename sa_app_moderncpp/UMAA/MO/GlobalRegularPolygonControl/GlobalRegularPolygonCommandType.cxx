...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRegularPolygonControl {
            ...
            GlobalRegularPolygonCommandType::GlobalRegularPolygonCommandType(GlobalRegularPolygonCommandType&& other_) OMG_NOEXCEPT  :m_crossTrackTolerance_ (std::move(other_.m_crossTrackTolerance_))
            ,
            ...
            GlobalRegularPolygonCommandType& GlobalRegularPolygonCommandType::operator=(GlobalRegularPolygonCommandType&&  other_) OMG_NOEXCEPT {
                GlobalRegularPolygonCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRegularPolygonCommandType::swap(GlobalRegularPolygonCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
