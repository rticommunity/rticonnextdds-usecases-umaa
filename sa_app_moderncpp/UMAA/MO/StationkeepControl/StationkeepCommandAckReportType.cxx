...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace StationkeepControl {
            ...
            StationkeepCommandAckReportType::StationkeepCommandAckReportType (const UMAA::Common::MaritimeEnumeration::BearingAngleEnumType::BearingAngleEnumType& angleType,double bearing,double bearingTolerance,double closingSpeed,const UMAA::Common::Measurement::NumericGUID& contactTrackID,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,double range,double rangeTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            StationkeepCommandAckReportType::StationkeepCommandAckReportType(StationkeepCommandAckReportType&& other_) OMG_NOEXCEPT  :m_angleType_ (std::move(other_.m_angleType_))
            ,
            ...
            StationkeepCommandAckReportType& StationkeepCommandAckReportType::operator=(StationkeepCommandAckReportType&&  other_) OMG_NOEXCEPT {
                StationkeepCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StationkeepCommandAckReportType::swap(StationkeepCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
