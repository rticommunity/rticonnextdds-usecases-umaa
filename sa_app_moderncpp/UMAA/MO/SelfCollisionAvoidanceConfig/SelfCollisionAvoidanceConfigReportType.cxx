...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace SelfCollisionAvoidanceConfig {
            ...
            SelfCollisionAvoidanceConfigReportType::SelfCollisionAvoidanceConfigReportType (int32_t priority,const UMAA::Common::MaritimeEnumeration::CollisionAvoidStateEnumType::CollisionAvoidStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            SelfCollisionAvoidanceConfigReportType::SelfCollisionAvoidanceConfigReportType(SelfCollisionAvoidanceConfigReportType&& other_) OMG_NOEXCEPT  :m_priority_ (std::move(other_.m_priority_))
            ,
            ...
            SelfCollisionAvoidanceConfigReportType& SelfCollisionAvoidanceConfigReportType::operator=(SelfCollisionAvoidanceConfigReportType&&  other_) OMG_NOEXCEPT {
                SelfCollisionAvoidanceConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SelfCollisionAvoidanceConfigReportType::swap(SelfCollisionAvoidanceConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
