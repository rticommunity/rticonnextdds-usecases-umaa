...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalFigure8Control {
            ...
            GlobalFigure8ExecutionStatusReportType::GlobalFigure8ExecutionStatusReportType (const UMAA::MO::GlobalFigure8State::GlobalFigure8StateType& globalFigure8State,const UMAA::Common::Measurement::DateTime& timePatternAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timePatternCompleted,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_globalFigure8State_( globalFigure8State ),
            ...
            GlobalFigure8ExecutionStatusReportType::GlobalFigure8ExecutionStatusReportType(GlobalFigure8ExecutionStatusReportType&& other_) OMG_NOEXCEPT  :m_globalFigure8State_ (std::move(other_.m_globalFigure8State_))
            ,
            ...
            GlobalFigure8ExecutionStatusReportType& GlobalFigure8ExecutionStatusReportType::operator=(GlobalFigure8ExecutionStatusReportType&&  other_) OMG_NOEXCEPT {
                GlobalFigure8ExecutionStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalFigure8ExecutionStatusReportType::swap(GlobalFigure8ExecutionStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
