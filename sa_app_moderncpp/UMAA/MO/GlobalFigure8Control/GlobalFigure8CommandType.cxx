...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalFigure8Control {
            ...
            GlobalFigure8CommandType::GlobalFigure8CommandType(GlobalFigure8CommandType&& other_) OMG_NOEXCEPT  :m_crossTrackTolerance_ (std::move(other_.m_crossTrackTolerance_))
            ,
            ...
            GlobalFigure8CommandType& GlobalFigure8CommandType::operator=(GlobalFigure8CommandType&&  other_) OMG_NOEXCEPT {
                GlobalFigure8CommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalFigure8CommandType::swap(GlobalFigure8CommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
