...
#ifndef GlobalFigure8CommandStatusType_1727478690_hpp
#define GlobalFigure8CommandStatusType_1727478690_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalFigure8Control {
            ...
            static const std::string GlobalFigure8CommandStatus_TOPIC = "UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatus";

            class NDDSUSERDllExport GlobalFigure8CommandStatusType {
              public:
                ...
                GlobalFigure8CommandStatusType (GlobalFigure8CommandStatusType&&) = default;
                GlobalFigure8CommandStatusType& operator=(GlobalFigure8CommandStatusType&&) = default;
                GlobalFigure8CommandStatusType& operator=(const GlobalFigure8CommandStatusType&) = default;
                GlobalFigure8CommandStatusType(const GlobalFigure8CommandStatusType&) = default;
                #else
                GlobalFigure8CommandStatusType(GlobalFigure8CommandStatusType&& other_) OMG_NOEXCEPT;  
                GlobalFigure8CommandStatusType& operator=(GlobalFigure8CommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GlobalFigure8CommandStatusType& other_) const;
                bool operator != (const GlobalFigure8CommandStatusType& other_) const;

                void swap(GlobalFigure8CommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalFigure8CommandStatusType& a, GlobalFigure8CommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalFigure8CommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatusType > {
...
#endif // GlobalFigure8CommandStatusType_1727478690_hpp
