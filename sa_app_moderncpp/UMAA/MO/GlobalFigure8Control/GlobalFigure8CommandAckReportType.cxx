...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalFigure8Control {
            ...
            GlobalFigure8CommandAckReportType::GlobalFigure8CommandAckReportType(GlobalFigure8CommandAckReportType&& other_) OMG_NOEXCEPT  :m_crossTrackTolerance_ (std::move(other_.m_crossTrackTolerance_))
            ,
            ...
            GlobalFigure8CommandAckReportType& GlobalFigure8CommandAckReportType::operator=(GlobalFigure8CommandAckReportType&&  other_) OMG_NOEXCEPT {
                GlobalFigure8CommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalFigure8CommandAckReportType::swap(GlobalFigure8CommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
