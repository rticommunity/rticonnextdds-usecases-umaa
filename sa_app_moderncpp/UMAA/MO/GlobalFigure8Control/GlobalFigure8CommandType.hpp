...
#ifndef GlobalFigure8CommandType_1912952531_hpp
#define GlobalFigure8CommandType_1912952531_hpp
        ...
        namespace GlobalFigure8Control {
            ...
            class NDDSUSERDllExport GlobalFigure8CommandType {
              public:
                ...
                bool operator == (const GlobalFigure8CommandType& other_) const;
                bool operator != (const GlobalFigure8CommandType& other_) const;

                void swap(GlobalFigure8CommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalFigure8CommandType& a, GlobalFigure8CommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalFigure8CommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType > {
        ...
        template <>
        struct extensibility< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandType > {
...
#endif // GlobalFigure8CommandType_1912952531_hpp
