...
#ifndef GlobalFigure8CommandAckReportType_1601158838_hpp
#define GlobalFigure8CommandAckReportType_1601158838_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalFigure8Control {
            ...
            static const std::string GlobalFigure8CommandAckReport_TOPIC = "UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReport";

            class NDDSUSERDllExport GlobalFigure8CommandAckReportType {
              public:
                ...
                GlobalFigure8CommandAckReportType (GlobalFigure8CommandAckReportType&&) = default;
                GlobalFigure8CommandAckReportType& operator=(GlobalFigure8CommandAckReportType&&) = default;
                GlobalFigure8CommandAckReportType& operator=(const GlobalFigure8CommandAckReportType&) = default;
                GlobalFigure8CommandAckReportType(const GlobalFigure8CommandAckReportType&) = default;
                #else
                GlobalFigure8CommandAckReportType(GlobalFigure8CommandAckReportType&& other_) OMG_NOEXCEPT;  
                GlobalFigure8CommandAckReportType& operator=(GlobalFigure8CommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GlobalFigure8CommandAckReportType& other_) const;
                bool operator != (const GlobalFigure8CommandAckReportType& other_) const;

                void swap(GlobalFigure8CommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalFigure8CommandAckReportType& a, GlobalFigure8CommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalFigure8CommandAckReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType > {
        ...
        template <>
        struct extensibility< UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReportType > {
...
#endif // GlobalFigure8CommandAckReportType_1601158838_hpp
