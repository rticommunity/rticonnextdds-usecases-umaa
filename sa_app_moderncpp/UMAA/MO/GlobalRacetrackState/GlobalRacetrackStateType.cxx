    ...
    namespace MO {
        ...
        namespace GlobalRacetrackState {
            ...
            namespace GlobalRacetrackStateType_Specializations {
                ...
                GlobalRacetrackStateType_Union::GlobalRacetrackStateType_Union(GlobalRacetrackStateType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Selectors::GLOBALRACETRACKPATTERNTYPE_SELECT):
                            {  
                                GlobalRacetrackPatternType_data( std::move(other_.GlobalRacetrackPatternType_data()));
                        } break;
                        case (UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Selectors::GLOBALRACETRACKTRANSITTYPE_SELECT):
                            {  
                                GlobalRacetrackTransitType_data( std::move(other_.GlobalRacetrackTransitType_data()));
                        } break;
                ...
                GlobalRacetrackStateType_Union& GlobalRacetrackStateType_Union::operator=(GlobalRacetrackStateType_Union&&  other_) OMG_NOEXCEPT {
                    GlobalRacetrackStateType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                GlobalRacetrackStateType_Union::Union_::Union_(const UMAA::MO::GlobalRacetrackState::GlobalRacetrackPatternType& GlobalRacetrackPatternType_data,const UMAA::MO::GlobalRacetrackState::GlobalRacetrackTransitType& GlobalRacetrackTransitType_data):
                    m_GlobalRacetrackPatternType_data_( GlobalRacetrackPatternType_data ),
                    m_GlobalRacetrackTransitType_data_( GlobalRacetrackTransitType_data ) {
                }
                ...
                void GlobalRacetrackStateType_Union::swap(GlobalRacetrackStateType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const GlobalRacetrackStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Selectors::GLOBALRACETRACKTRANSITTYPE_SELECT):
                            {  
                                o << "GlobalRacetrackTransitType_data: " << sample.GlobalRacetrackTransitType_data() ;        } break ;
            ...
            GlobalRacetrackStateType::GlobalRacetrackStateType (const UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Union& GlobalRacetrackStateType_subtypes):
                m_GlobalRacetrackStateType_subtypes_( GlobalRacetrackStateType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            GlobalRacetrackStateType::GlobalRacetrackStateType(GlobalRacetrackStateType&& other_) OMG_NOEXCEPT  :m_GlobalRacetrackStateType_subtypes_ (std::move(other_.m_GlobalRacetrackStateType_subtypes_))
            {
            } 

            GlobalRacetrackStateType& GlobalRacetrackStateType::operator=(GlobalRacetrackStateType&&  other_) OMG_NOEXCEPT {
                GlobalRacetrackStateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRacetrackStateType::swap(GlobalRacetrackStateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
