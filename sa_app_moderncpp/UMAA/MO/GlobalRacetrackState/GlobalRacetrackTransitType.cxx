...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRacetrackState {
            ...
            GlobalRacetrackTransitType::GlobalRacetrackTransitType (bool transitElevationAchieved,bool transitSpeedAchieved):
            ...
            GlobalRacetrackTransitType::GlobalRacetrackTransitType(GlobalRacetrackTransitType&& other_) OMG_NOEXCEPT  :m_transitElevationAchieved_ (std::move(other_.m_transitElevationAchieved_))
            ,
            m_transitSpeedAchieved_ (std::move(other_.m_transitSpeedAchieved_))
            {
            } 

            GlobalRacetrackTransitType& GlobalRacetrackTransitType::operator=(GlobalRacetrackTransitType&&  other_) OMG_NOEXCEPT {
                GlobalRacetrackTransitType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRacetrackTransitType::swap(GlobalRacetrackTransitType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
