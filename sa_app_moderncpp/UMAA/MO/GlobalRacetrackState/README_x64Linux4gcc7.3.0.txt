...
data type GlobalRacetrackTransitType from GlobalRacetrackTransitType.idl.
This example builds two applications, named GlobalRacetrackTransitType_publisher and
GlobalRacetrackTransitType_subscriber.
...
> make -f makefile_GlobalRacetrackTransitType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_GlobalRacetrackTransitType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the GlobalRacetrackTransitType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/GlobalRacetrackTransitType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/GlobalRacetrackTransitType_subscriber -d <domain_id> -s <sample_count>
