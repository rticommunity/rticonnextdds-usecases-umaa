        ...
        namespace StationkeepState {
            namespace StationkeepStateType_Specializations {
                ...
                class NDDSUSERDllExport StationkeepStateType_Union {
                  public:
                    ...
                    StationkeepStateType_Union (StationkeepStateType_Union&&) = default;
                    StationkeepStateType_Union& operator=(StationkeepStateType_Union&&) = default;
                    StationkeepStateType_Union& operator=(const StationkeepStateType_Union&) = default;
                    StationkeepStateType_Union(const StationkeepStateType_Union&) = default;
                    #else
                    StationkeepStateType_Union(StationkeepStateType_Union&& other_) OMG_NOEXCEPT;  
                    StationkeepStateType_Union& operator=(StationkeepStateType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(StationkeepStateType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::MO::StationkeepState::TransitStationkeepType& TransitStationkeepType_data,const UMAA::MO::StationkeepState::StationkeepingStationkeepType& StationkeepingStationkeepType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(StationkeepStateType_Union& a, StationkeepStateType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport StationkeepStateType {
              public:
                ...
                explicit StationkeepStateType(const UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Union& StationkeepStateType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                StationkeepStateType (StationkeepStateType&&) = default;
                StationkeepStateType& operator=(StationkeepStateType&&) = default;
                StationkeepStateType& operator=(const StationkeepStateType&) = default;
                StationkeepStateType(const StationkeepStateType&) = default;
                #else
                StationkeepStateType(StationkeepStateType&& other_) OMG_NOEXCEPT;  
                StationkeepStateType& operator=(StationkeepStateType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Union& StationkeepStateType_subtypes() OMG_NOEXCEPT {
                    return m_StationkeepStateType_subtypes_;
                }

                const UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Union& StationkeepStateType_subtypes() const OMG_NOEXCEPT {
                    return m_StationkeepStateType_subtypes_;
                }
                ...
                void swap(StationkeepStateType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(StationkeepStateType& a, StationkeepStateType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
