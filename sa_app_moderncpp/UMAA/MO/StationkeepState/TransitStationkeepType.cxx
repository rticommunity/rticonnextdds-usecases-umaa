...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace StationkeepState {
            ...
            TransitStationkeepType::TransitStationkeepType (bool transitElevationAchieved,bool transitSpeedAchieved):
            ...
            TransitStationkeepType::TransitStationkeepType(TransitStationkeepType&& other_) OMG_NOEXCEPT  :m_transitElevationAchieved_ (std::move(other_.m_transitElevationAchieved_))
            ,
            m_transitSpeedAchieved_ (std::move(other_.m_transitSpeedAchieved_))
            {
            } 

            TransitStationkeepType& TransitStationkeepType::operator=(TransitStationkeepType&&  other_) OMG_NOEXCEPT {
                TransitStationkeepType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void TransitStationkeepType::swap(TransitStationkeepType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
