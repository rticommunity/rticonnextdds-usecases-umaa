...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace StationkeepState {
            ...
            StationkeepingStationkeepType::StationkeepingStationkeepType (bool bearingToContactAchieved,bool elevationAchieved,bool rangeAchieved):
                m_bearingToContactAchieved_( bearingToContactAchieved ),
                m_elevationAchieved_( elevationAchieved ),
                m_rangeAchieved_( rangeAchieved ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            StationkeepingStationkeepType::StationkeepingStationkeepType(StationkeepingStationkeepType&& other_) OMG_NOEXCEPT  :m_bearingToContactAchieved_ (std::move(other_.m_bearingToContactAchieved_))
            ,
            m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            m_rangeAchieved_ (std::move(other_.m_rangeAchieved_))
            {
            } 

            StationkeepingStationkeepType& StationkeepingStationkeepType::operator=(StationkeepingStationkeepType&&  other_) OMG_NOEXCEPT {
                StationkeepingStationkeepType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StationkeepingStationkeepType::swap(StationkeepingStationkeepType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
