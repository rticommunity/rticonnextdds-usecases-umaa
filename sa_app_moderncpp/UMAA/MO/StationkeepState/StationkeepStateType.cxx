    ...
    namespace MO {
        ...
        namespace StationkeepState {
            ...
            namespace StationkeepStateType_Specializations {
                ...
                StationkeepStateType_Union::StationkeepStateType_Union(StationkeepStateType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Selectors::TRANSITSTATIONKEEPTYPE_SELECT):
                            {  
                                TransitStationkeepType_data( std::move(other_.TransitStationkeepType_data()));
                        } break;
                        case (UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Selectors::STATIONKEEPINGSTATIONKEEPTYPE_SELECT):
                            {  
                                StationkeepingStationkeepType_data( std::move(other_.StationkeepingStationkeepType_data()));
                        } break;
                ...
                StationkeepStateType_Union& StationkeepStateType_Union::operator=(StationkeepStateType_Union&&  other_) OMG_NOEXCEPT {
                    StationkeepStateType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                StationkeepStateType_Union::Union_::Union_(const UMAA::MO::StationkeepState::TransitStationkeepType& TransitStationkeepType_data,const UMAA::MO::StationkeepState::StationkeepingStationkeepType& StationkeepingStationkeepType_data):
                    m_TransitStationkeepType_data_( TransitStationkeepType_data ),
                    m_StationkeepingStationkeepType_data_( StationkeepingStationkeepType_data ) {
                }
                ...
                void StationkeepStateType_Union::swap(StationkeepStateType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const StationkeepStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Selectors::STATIONKEEPINGSTATIONKEEPTYPE_SELECT):
                            {  
                                o << "StationkeepingStationkeepType_data: " << sample.StationkeepingStationkeepType_data() ;        } break ;
            ...
            StationkeepStateType::StationkeepStateType (const UMAA::MO::StationkeepState::StationkeepStateType_Specializations::StationkeepStateType_Union& StationkeepStateType_subtypes):
                m_StationkeepStateType_subtypes_( StationkeepStateType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            StationkeepStateType::StationkeepStateType(StationkeepStateType&& other_) OMG_NOEXCEPT  :m_StationkeepStateType_subtypes_ (std::move(other_.m_StationkeepStateType_subtypes_))
            {
            } 

            StationkeepStateType& StationkeepStateType::operator=(StationkeepStateType&&  other_) OMG_NOEXCEPT {
                StationkeepStateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StationkeepStateType::swap(StationkeepStateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
