...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GuardedTeleopControl {
            ...
            GuardedTeleopCommandAckReportType::GuardedTeleopCommandAckReportType(GuardedTeleopCommandAckReportType&& other_) OMG_NOEXCEPT  :m_obstacleAvoidance_ (std::move(other_.m_obstacleAvoidance_))
            ,
            ...
            GuardedTeleopCommandAckReportType& GuardedTeleopCommandAckReportType::operator=(GuardedTeleopCommandAckReportType&&  other_) OMG_NOEXCEPT {
                GuardedTeleopCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GuardedTeleopCommandAckReportType::swap(GuardedTeleopCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
