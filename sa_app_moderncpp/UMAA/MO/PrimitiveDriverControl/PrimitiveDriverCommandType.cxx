...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace PrimitiveDriverControl {
            ...
            PrimitiveDriverCommandType::PrimitiveDriverCommandType (const UMAA::Common::Measurement::LinearEffort& propulsiveLinearEffort,const UMAA::Common::Measurement::RotationalEffort& propulsiveRotationalEffort,const UMAA::Common::Measurement::LinearEffort& resistiveLinearEffort,const UMAA::Common::Measurement::RotationalEffort& resistiveRotationalEffort,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            PrimitiveDriverCommandType::PrimitiveDriverCommandType(PrimitiveDriverCommandType&& other_) OMG_NOEXCEPT  :m_propulsiveLinearEffort_ (std::move(other_.m_propulsiveLinearEffort_))
            ,
            ...
            PrimitiveDriverCommandType& PrimitiveDriverCommandType::operator=(PrimitiveDriverCommandType&&  other_) OMG_NOEXCEPT {
                PrimitiveDriverCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PrimitiveDriverCommandType::swap(PrimitiveDriverCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
