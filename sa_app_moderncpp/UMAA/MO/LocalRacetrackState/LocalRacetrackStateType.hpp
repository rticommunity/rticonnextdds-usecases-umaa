        ...
        namespace LocalRacetrackState {
            namespace LocalRacetrackStateType_Specializations {
                ...
                class NDDSUSERDllExport LocalRacetrackStateType_Union {
                  public:
                    ...
                    LocalRacetrackStateType_Union (LocalRacetrackStateType_Union&&) = default;
                    LocalRacetrackStateType_Union& operator=(LocalRacetrackStateType_Union&&) = default;
                    LocalRacetrackStateType_Union& operator=(const LocalRacetrackStateType_Union&) = default;
                    LocalRacetrackStateType_Union(const LocalRacetrackStateType_Union&) = default;
                    #else
                    LocalRacetrackStateType_Union(LocalRacetrackStateType_Union&& other_) OMG_NOEXCEPT;  
                    LocalRacetrackStateType_Union& operator=(LocalRacetrackStateType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(LocalRacetrackStateType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::MO::LocalRacetrackState::LocalRacetrackTransitType& LocalRacetrackTransitType_data,const UMAA::MO::LocalRacetrackState::LocalRacetrackPatternType& LocalRacetrackPatternType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(LocalRacetrackStateType_Union& a, LocalRacetrackStateType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport LocalRacetrackStateType {
              public:
                ...
                explicit LocalRacetrackStateType(const UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Union& LocalRacetrackStateType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalRacetrackStateType (LocalRacetrackStateType&&) = default;
                LocalRacetrackStateType& operator=(LocalRacetrackStateType&&) = default;
                LocalRacetrackStateType& operator=(const LocalRacetrackStateType&) = default;
                LocalRacetrackStateType(const LocalRacetrackStateType&) = default;
                #else
                LocalRacetrackStateType(LocalRacetrackStateType&& other_) OMG_NOEXCEPT;  
                LocalRacetrackStateType& operator=(LocalRacetrackStateType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Union& LocalRacetrackStateType_subtypes() OMG_NOEXCEPT {
                    return m_LocalRacetrackStateType_subtypes_;
                }

                const UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Union& LocalRacetrackStateType_subtypes() const OMG_NOEXCEPT {
                    return m_LocalRacetrackStateType_subtypes_;
                }
                ...
                void swap(LocalRacetrackStateType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalRacetrackStateType& a, LocalRacetrackStateType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
