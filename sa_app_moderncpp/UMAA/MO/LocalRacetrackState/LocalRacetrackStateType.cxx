    ...
    namespace MO {
        ...
        namespace LocalRacetrackState {
            ...
            namespace LocalRacetrackStateType_Specializations {
                ...
                LocalRacetrackStateType_Union::LocalRacetrackStateType_Union(LocalRacetrackStateType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Selectors::LOCALRACETRACKTRANSITTYPE_SELECT):
                            {  
                                LocalRacetrackTransitType_data( std::move(other_.LocalRacetrackTransitType_data()));
                        } break;
                        case (UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Selectors::LOCALRACETRACKPATTERNTYPE_SELECT):
                            {  
                                LocalRacetrackPatternType_data( std::move(other_.LocalRacetrackPatternType_data()));
                        } break;
                ...
                LocalRacetrackStateType_Union& LocalRacetrackStateType_Union::operator=(LocalRacetrackStateType_Union&&  other_) OMG_NOEXCEPT {
                    LocalRacetrackStateType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                LocalRacetrackStateType_Union::Union_::Union_(const UMAA::MO::LocalRacetrackState::LocalRacetrackTransitType& LocalRacetrackTransitType_data,const UMAA::MO::LocalRacetrackState::LocalRacetrackPatternType& LocalRacetrackPatternType_data):
                    m_LocalRacetrackTransitType_data_( LocalRacetrackTransitType_data ),
                    m_LocalRacetrackPatternType_data_( LocalRacetrackPatternType_data ) {
                }
                ...
                void LocalRacetrackStateType_Union::swap(LocalRacetrackStateType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const LocalRacetrackStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Selectors::LOCALRACETRACKPATTERNTYPE_SELECT):
                            {  
                                o << "LocalRacetrackPatternType_data: " << sample.LocalRacetrackPatternType_data() ;        } break ;
            ...
            LocalRacetrackStateType::LocalRacetrackStateType (const UMAA::MO::LocalRacetrackState::LocalRacetrackStateType_Specializations::LocalRacetrackStateType_Union& LocalRacetrackStateType_subtypes):
                m_LocalRacetrackStateType_subtypes_( LocalRacetrackStateType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            LocalRacetrackStateType::LocalRacetrackStateType(LocalRacetrackStateType&& other_) OMG_NOEXCEPT  :m_LocalRacetrackStateType_subtypes_ (std::move(other_.m_LocalRacetrackStateType_subtypes_))
            {
            } 

            LocalRacetrackStateType& LocalRacetrackStateType::operator=(LocalRacetrackStateType&&  other_) OMG_NOEXCEPT {
                LocalRacetrackStateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalRacetrackStateType::swap(LocalRacetrackStateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
