...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalRacetrackState {
            ...
            LocalRacetrackPatternType::LocalRacetrackPatternType (bool elevationAchieved,bool positionAchieved,bool speedAchieved):
            ...
            LocalRacetrackPatternType::LocalRacetrackPatternType(LocalRacetrackPatternType&& other_) OMG_NOEXCEPT  :m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            ...
            LocalRacetrackPatternType& LocalRacetrackPatternType::operator=(LocalRacetrackPatternType&&  other_) OMG_NOEXCEPT {
                LocalRacetrackPatternType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalRacetrackPatternType::swap(LocalRacetrackPatternType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
