...
namespace UMAA {
    namespace MO {
        namespace LocalFigure8Control {
            ...
            static const std::string LocalFigure8ExecutionStatusReport_TOPIC = "UMAA::MO::LocalFigure8Control::LocalFigure8ExecutionStatusReport";
            ...
            class NDDSUSERDllExport LocalFigure8ExecutionStatusReportType {
              public:
                ...
                LocalFigure8ExecutionStatusReportType (LocalFigure8ExecutionStatusReportType&&) = default;
                LocalFigure8ExecutionStatusReportType& operator=(LocalFigure8ExecutionStatusReportType&&) = default;
                LocalFigure8ExecutionStatusReportType& operator=(const LocalFigure8ExecutionStatusReportType&) = default;
                LocalFigure8ExecutionStatusReportType(const LocalFigure8ExecutionStatusReportType&) = default;
                #else
                LocalFigure8ExecutionStatusReportType(LocalFigure8ExecutionStatusReportType&& other_) OMG_NOEXCEPT;  
                LocalFigure8ExecutionStatusReportType& operator=(LocalFigure8ExecutionStatusReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::MO::LocalFigure8State::LocalFigure8StateType& localFigure8State() OMG_NOEXCEPT {
                    return m_localFigure8State_;
                }

                const UMAA::MO::LocalFigure8State::LocalFigure8StateType& localFigure8State() const OMG_NOEXCEPT {
                    return m_localFigure8State_;
                }
                ...
                void swap(LocalFigure8ExecutionStatusReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalFigure8ExecutionStatusReportType& a, LocalFigure8ExecutionStatusReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
