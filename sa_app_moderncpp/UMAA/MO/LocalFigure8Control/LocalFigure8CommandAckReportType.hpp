...
#ifndef LocalFigure8CommandAckReportType_499298100_hpp
#define LocalFigure8CommandAckReportType_499298100_hpp
        ...
        namespace LocalFigure8Control {
            ...
            class NDDSUSERDllExport LocalFigure8CommandAckReportType {
              public:
                ...
                bool operator == (const LocalFigure8CommandAckReportType& other_) const;
                bool operator != (const LocalFigure8CommandAckReportType& other_) const;

                void swap(LocalFigure8CommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalFigure8CommandAckReportType& a, LocalFigure8CommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalFigure8CommandAckReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReportType > {
...
#endif // LocalFigure8CommandAckReportType_499298100_hpp
