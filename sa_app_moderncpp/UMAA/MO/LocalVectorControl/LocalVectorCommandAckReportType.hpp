...
#ifndef LocalVectorCommandAckReportType_1821650760_hpp
#define LocalVectorCommandAckReportType_1821650760_hpp
...
namespace UMAA {
    namespace MO {
        namespace LocalVectorControl {
            ...
            static const std::string LocalVectorCommandAckReport_TOPIC = "UMAA::MO::LocalVectorControl::LocalVectorCommandAckReport";

            class NDDSUSERDllExport LocalVectorCommandAckReportType {
              public:
                LocalVectorCommandAckReportType();

                LocalVectorCommandAckReportType(const UMAA::Common::Orientation::OrientationType& attitude,const UMAA::Common::Measurement::Orientation3D_Tolerance& attitudeTolerance,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,const UMAA::Common::Speed::SpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalVectorCommandAckReportType (LocalVectorCommandAckReportType&&) = default;
                LocalVectorCommandAckReportType& operator=(LocalVectorCommandAckReportType&&) = default;
                LocalVectorCommandAckReportType& operator=(const LocalVectorCommandAckReportType&) = default;
                LocalVectorCommandAckReportType(const LocalVectorCommandAckReportType&) = default;
                #else
                LocalVectorCommandAckReportType(LocalVectorCommandAckReportType&& other_) OMG_NOEXCEPT;  
                LocalVectorCommandAckReportType& operator=(LocalVectorCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalVectorCommandAckReportType& other_) const;
                bool operator != (const LocalVectorCommandAckReportType& other_) const;

                void swap(LocalVectorCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalVectorCommandAckReportType& a, LocalVectorCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalVectorCommandAckReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalVectorControl::LocalVectorCommandAckReportType > {
...
#endif // LocalVectorCommandAckReportType_1821650760_hpp
