...
#ifndef LocalVectorCommandStatusType_1048301381_hpp
#define LocalVectorCommandStatusType_1048301381_hpp
...
namespace UMAA {
    namespace MO {
        namespace LocalVectorControl {
            ...
            static const std::string LocalVectorCommandStatus_TOPIC = "UMAA::MO::LocalVectorControl::LocalVectorCommandStatus";

            class NDDSUSERDllExport LocalVectorCommandStatusType {
              public:
                ...
                LocalVectorCommandStatusType (LocalVectorCommandStatusType&&) = default;
                LocalVectorCommandStatusType& operator=(LocalVectorCommandStatusType&&) = default;
                LocalVectorCommandStatusType& operator=(const LocalVectorCommandStatusType&) = default;
                LocalVectorCommandStatusType(const LocalVectorCommandStatusType&) = default;
                #else
                LocalVectorCommandStatusType(LocalVectorCommandStatusType&& other_) OMG_NOEXCEPT;  
                LocalVectorCommandStatusType& operator=(LocalVectorCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalVectorCommandStatusType& other_) const;
                bool operator != (const LocalVectorCommandStatusType& other_) const;

                void swap(LocalVectorCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalVectorCommandStatusType& a, LocalVectorCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalVectorCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalVectorControl::LocalVectorCommandStatusType > {
...
#endif // LocalVectorCommandStatusType_1048301381_hpp
