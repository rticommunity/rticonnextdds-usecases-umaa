...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GuardedTeleopStatus {
            ...
            GuardedTeleopReportType::GuardedTeleopReportType (const UMAA::Common::MaritimeEnumeration::GuardedTeleoperationStatusEnumType::GuardedTeleoperationStatusEnumType& status,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_status_( status ),
                m_source_( source ),
            ...
            GuardedTeleopReportType::GuardedTeleopReportType(GuardedTeleopReportType&& other_) OMG_NOEXCEPT  :m_status_ (std::move(other_.m_status_))
            ,
            ...
            GuardedTeleopReportType& GuardedTeleopReportType::operator=(GuardedTeleopReportType&&  other_) OMG_NOEXCEPT {
                GuardedTeleopReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GuardedTeleopReportType::swap(GuardedTeleopReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
