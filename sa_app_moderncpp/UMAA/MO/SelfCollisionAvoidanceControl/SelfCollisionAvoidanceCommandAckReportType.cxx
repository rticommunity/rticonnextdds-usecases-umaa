...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace SelfCollisionAvoidanceControl {
            ...
            SelfCollisionAvoidanceCommandAckReportType::SelfCollisionAvoidanceCommandAckReportType (int32_t priority,const UMAA::Common::MaritimeEnumeration::CollisionAvoidStateEnumType::CollisionAvoidStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            SelfCollisionAvoidanceCommandAckReportType::SelfCollisionAvoidanceCommandAckReportType(SelfCollisionAvoidanceCommandAckReportType&& other_) OMG_NOEXCEPT  :m_priority_ (std::move(other_.m_priority_))
            ,
            ...
            SelfCollisionAvoidanceCommandAckReportType& SelfCollisionAvoidanceCommandAckReportType::operator=(SelfCollisionAvoidanceCommandAckReportType&&  other_) OMG_NOEXCEPT {
                SelfCollisionAvoidanceCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SelfCollisionAvoidanceCommandAckReportType::swap(SelfCollisionAvoidanceCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
