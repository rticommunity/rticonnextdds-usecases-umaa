...
namespace UMAA {
    namespace MO {
        namespace SelfCollisionAvoidanceControl {
            ...
            static const std::string SelfCollisionAvoidanceCommandAckReport_TOPIC = "UMAA::MO::SelfCollisionAvoidanceControl::SelfCollisionAvoidanceCommandAckReport";

            class NDDSUSERDllExport SelfCollisionAvoidanceCommandAckReportType {
              public:
                SelfCollisionAvoidanceCommandAckReportType();

                SelfCollisionAvoidanceCommandAckReportType(int32_t priority,const UMAA::Common::MaritimeEnumeration::CollisionAvoidStateEnumType::CollisionAvoidStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                SelfCollisionAvoidanceCommandAckReportType (SelfCollisionAvoidanceCommandAckReportType&&) = default;
                SelfCollisionAvoidanceCommandAckReportType& operator=(SelfCollisionAvoidanceCommandAckReportType&&) = default;
                SelfCollisionAvoidanceCommandAckReportType& operator=(const SelfCollisionAvoidanceCommandAckReportType&) = default;
                SelfCollisionAvoidanceCommandAckReportType(const SelfCollisionAvoidanceCommandAckReportType&) = default;
                #else
                SelfCollisionAvoidanceCommandAckReportType(SelfCollisionAvoidanceCommandAckReportType&& other_) OMG_NOEXCEPT;  
                SelfCollisionAvoidanceCommandAckReportType& operator=(SelfCollisionAvoidanceCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(SelfCollisionAvoidanceCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(SelfCollisionAvoidanceCommandAckReportType& a, SelfCollisionAvoidanceCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
