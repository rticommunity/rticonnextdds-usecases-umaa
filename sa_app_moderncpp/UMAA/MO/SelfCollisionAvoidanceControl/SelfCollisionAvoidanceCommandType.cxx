...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace SelfCollisionAvoidanceControl {
            ...
            SelfCollisionAvoidanceCommandType::SelfCollisionAvoidanceCommandType (int32_t priority,const UMAA::Common::MaritimeEnumeration::CollisionAvoidStateEnumType::CollisionAvoidStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            SelfCollisionAvoidanceCommandType::SelfCollisionAvoidanceCommandType(SelfCollisionAvoidanceCommandType&& other_) OMG_NOEXCEPT  :m_priority_ (std::move(other_.m_priority_))
            ,
            ...
            SelfCollisionAvoidanceCommandType& SelfCollisionAvoidanceCommandType::operator=(SelfCollisionAvoidanceCommandType&&  other_) OMG_NOEXCEPT {
                SelfCollisionAvoidanceCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SelfCollisionAvoidanceCommandType::swap(SelfCollisionAvoidanceCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
