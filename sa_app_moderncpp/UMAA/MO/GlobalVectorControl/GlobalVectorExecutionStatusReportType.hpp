...
namespace UMAA {
    namespace MO {
        namespace GlobalVectorControl {
            ...
            static const std::string GlobalVectorExecutionStatusReport_TOPIC = "UMAA::MO::GlobalVectorControl::GlobalVectorExecutionStatusReport";

            class NDDSUSERDllExport GlobalVectorExecutionStatusReportType {
              public:
                GlobalVectorExecutionStatusReportType();

                GlobalVectorExecutionStatusReportType(bool attitudeAchieved,bool elevationAchieved,bool speedAchieved,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalVectorExecutionStatusReportType (GlobalVectorExecutionStatusReportType&&) = default;
                GlobalVectorExecutionStatusReportType& operator=(GlobalVectorExecutionStatusReportType&&) = default;
                GlobalVectorExecutionStatusReportType& operator=(const GlobalVectorExecutionStatusReportType&) = default;
                GlobalVectorExecutionStatusReportType(const GlobalVectorExecutionStatusReportType&) = default;
                #else
                GlobalVectorExecutionStatusReportType(GlobalVectorExecutionStatusReportType&& other_) OMG_NOEXCEPT;  
                GlobalVectorExecutionStatusReportType& operator=(GlobalVectorExecutionStatusReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(GlobalVectorExecutionStatusReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalVectorExecutionStatusReportType& a, GlobalVectorExecutionStatusReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
