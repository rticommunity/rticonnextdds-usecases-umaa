...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalVectorControl {
            ...
            GlobalVectorExecutionStatusReportType::GlobalVectorExecutionStatusReportType (bool attitudeAchieved,bool elevationAchieved,bool speedAchieved,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            GlobalVectorExecutionStatusReportType::GlobalVectorExecutionStatusReportType(GlobalVectorExecutionStatusReportType&& other_) OMG_NOEXCEPT  :m_attitudeAchieved_ (std::move(other_.m_attitudeAchieved_))
            ,
            ...
            GlobalVectorExecutionStatusReportType& GlobalVectorExecutionStatusReportType::operator=(GlobalVectorExecutionStatusReportType&&  other_) OMG_NOEXCEPT {
                GlobalVectorExecutionStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalVectorExecutionStatusReportType::swap(GlobalVectorExecutionStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::MO::GlobalVectorControl::GlobalVectorExecutionStatusReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member GlobalVectorExecutionStatusReportType_g_tc_members[5]=
                {
                ...
                GlobalVectorExecutionStatusReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalVectorExecutionStatusReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo GlobalVectorExecutionStatusReportType_g_memberAccessInfos[5] =
