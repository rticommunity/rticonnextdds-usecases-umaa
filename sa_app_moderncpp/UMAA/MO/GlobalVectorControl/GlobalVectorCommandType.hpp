...
namespace UMAA {
    namespace MO {
        namespace GlobalVectorControl {
            ...
            static const std::string GlobalVectorCommand_TOPIC = "UMAA::MO::GlobalVectorControl::GlobalVectorCommand";

            class NDDSUSERDllExport GlobalVectorCommandType {
              public:
                GlobalVectorCommandType();

                GlobalVectorCommandType(const UMAA::Common::Orientation::OrientationType& attitude,const UMAA::Common::Measurement::Orientation3D_Tolerance& attitudeTolerance,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,const UMAA::Common::Speed::SpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalVectorCommandType (GlobalVectorCommandType&&) = default;
                GlobalVectorCommandType& operator=(GlobalVectorCommandType&&) = default;
                GlobalVectorCommandType& operator=(const GlobalVectorCommandType&) = default;
                GlobalVectorCommandType(const GlobalVectorCommandType&) = default;
                #else
                GlobalVectorCommandType(GlobalVectorCommandType&& other_) OMG_NOEXCEPT;  
                GlobalVectorCommandType& operator=(GlobalVectorCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(GlobalVectorCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalVectorCommandType& a, GlobalVectorCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
