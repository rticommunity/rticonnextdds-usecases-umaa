...
namespace UMAA {
    namespace MO {
        namespace GlobalVectorControl {
            ...
            static const std::string GlobalVectorCommandAckReport_TOPIC = "UMAA::MO::GlobalVectorControl::GlobalVectorCommandAckReport";

            class NDDSUSERDllExport GlobalVectorCommandAckReportType {
              public:
                GlobalVectorCommandAckReportType();

                GlobalVectorCommandAckReportType(const UMAA::Common::Orientation::OrientationType& attitude,const UMAA::Common::Measurement::Orientation3D_Tolerance& attitudeTolerance,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,const UMAA::Common::Speed::SpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalVectorCommandAckReportType (GlobalVectorCommandAckReportType&&) = default;
                GlobalVectorCommandAckReportType& operator=(GlobalVectorCommandAckReportType&&) = default;
                GlobalVectorCommandAckReportType& operator=(const GlobalVectorCommandAckReportType&) = default;
                GlobalVectorCommandAckReportType(const GlobalVectorCommandAckReportType&) = default;
                #else
                GlobalVectorCommandAckReportType(GlobalVectorCommandAckReportType&& other_) OMG_NOEXCEPT;  
                GlobalVectorCommandAckReportType& operator=(GlobalVectorCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(GlobalVectorCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalVectorCommandAckReportType& a, GlobalVectorCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
