...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalVectorControl {
            ...
            GlobalVectorCommandAckReportType::GlobalVectorCommandAckReportType(GlobalVectorCommandAckReportType&& other_) OMG_NOEXCEPT  :m_attitude_ (std::move(other_.m_attitude_))
            ,
            ...
            GlobalVectorCommandAckReportType& GlobalVectorCommandAckReportType::operator=(GlobalVectorCommandAckReportType&&  other_) OMG_NOEXCEPT {
                GlobalVectorCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalVectorCommandAckReportType::swap(GlobalVectorCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
