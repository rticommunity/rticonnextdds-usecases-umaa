...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRacetrackControl {
            ...
            GlobalRacetrackCommandType::GlobalRacetrackCommandType(GlobalRacetrackCommandType&& other_) OMG_NOEXCEPT  :m_crossTrackTolerance_ (std::move(other_.m_crossTrackTolerance_))
            ,
            ...
            GlobalRacetrackCommandType& GlobalRacetrackCommandType::operator=(GlobalRacetrackCommandType&&  other_) OMG_NOEXCEPT {
                GlobalRacetrackCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRacetrackCommandType::swap(GlobalRacetrackCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
