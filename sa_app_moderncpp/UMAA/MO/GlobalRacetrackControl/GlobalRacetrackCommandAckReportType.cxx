...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRacetrackControl {
            ...
            GlobalRacetrackCommandAckReportType::GlobalRacetrackCommandAckReportType(GlobalRacetrackCommandAckReportType&& other_) OMG_NOEXCEPT  :m_crossTrackTolerance_ (std::move(other_.m_crossTrackTolerance_))
            ,
            ...
            GlobalRacetrackCommandAckReportType& GlobalRacetrackCommandAckReportType::operator=(GlobalRacetrackCommandAckReportType&&  other_) OMG_NOEXCEPT {
                GlobalRacetrackCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRacetrackCommandAckReportType::swap(GlobalRacetrackCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
