...
#ifndef GlobalRacetrackCommandType_887739946_hpp
#define GlobalRacetrackCommandType_887739946_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalRacetrackControl {
            ...
            static const std::string GlobalRacetrackCommand_TOPIC = "UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommand";

            class NDDSUSERDllExport GlobalRacetrackCommandType {
              public:
                GlobalRacetrackCommandType();

                GlobalRacetrackCommandType(double crossTrackTolerance,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,double length,const UMAA::Common::Orientation::HeadingType& orientation,const ::dds::core::optional< UMAA::Common::Measurement::Position2D >& position,double radius,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::MaritimeEnumeration::WaterTurnDirectionEnumType::WaterTurnDirectionEnumType& turnDirection,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalRacetrackCommandType (GlobalRacetrackCommandType&&) = default;
                GlobalRacetrackCommandType& operator=(GlobalRacetrackCommandType&&) = default;
                GlobalRacetrackCommandType& operator=(const GlobalRacetrackCommandType&) = default;
                GlobalRacetrackCommandType(const GlobalRacetrackCommandType&) = default;
                #else
                GlobalRacetrackCommandType(GlobalRacetrackCommandType&& other_) OMG_NOEXCEPT;  
                GlobalRacetrackCommandType& operator=(GlobalRacetrackCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GlobalRacetrackCommandType& other_) const;
                bool operator != (const GlobalRacetrackCommandType& other_) const;

                void swap(GlobalRacetrackCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalRacetrackCommandType& a, GlobalRacetrackCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalRacetrackCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType > {
        ...
        template <>
        struct extensibility< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandType > {
...
#endif // GlobalRacetrackCommandType_887739946_hpp
