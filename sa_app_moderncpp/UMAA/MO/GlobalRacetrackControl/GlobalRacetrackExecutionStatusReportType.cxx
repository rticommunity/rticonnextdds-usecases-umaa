...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRacetrackControl {
            ...
            GlobalRacetrackExecutionStatusReportType::GlobalRacetrackExecutionStatusReportType (const UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType& globalRacetrackState,const UMAA::Common::Measurement::DateTime& timePatternAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timePatternCompleted,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_globalRacetrackState_( globalRacetrackState ),
            ...
            GlobalRacetrackExecutionStatusReportType::GlobalRacetrackExecutionStatusReportType(GlobalRacetrackExecutionStatusReportType&& other_) OMG_NOEXCEPT  :m_globalRacetrackState_ (std::move(other_.m_globalRacetrackState_))
            ,
            ...
            GlobalRacetrackExecutionStatusReportType& GlobalRacetrackExecutionStatusReportType::operator=(GlobalRacetrackExecutionStatusReportType&&  other_) OMG_NOEXCEPT {
                GlobalRacetrackExecutionStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRacetrackExecutionStatusReportType::swap(GlobalRacetrackExecutionStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
