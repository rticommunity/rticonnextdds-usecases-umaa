...
#ifndef GlobalRacetrackCommandAckReportType_1511111885_hpp
#define GlobalRacetrackCommandAckReportType_1511111885_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalRacetrackControl {
            ...
            static const std::string GlobalRacetrackCommandAckReport_TOPIC = "UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReport";

            class NDDSUSERDllExport GlobalRacetrackCommandAckReportType {
              public:
                GlobalRacetrackCommandAckReportType();

                GlobalRacetrackCommandAckReportType(double crossTrackTolerance,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,double length,const UMAA::Common::Orientation::HeadingType& orientation,const ::dds::core::optional< UMAA::Common::Measurement::Position2D >& position,double radius,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::MaritimeEnumeration::WaterTurnDirectionEnumType::WaterTurnDirectionEnumType& turnDirection,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalRacetrackCommandAckReportType (GlobalRacetrackCommandAckReportType&&) = default;
                GlobalRacetrackCommandAckReportType& operator=(GlobalRacetrackCommandAckReportType&&) = default;
                GlobalRacetrackCommandAckReportType& operator=(const GlobalRacetrackCommandAckReportType&) = default;
                GlobalRacetrackCommandAckReportType(const GlobalRacetrackCommandAckReportType&) = default;
                #else
                GlobalRacetrackCommandAckReportType(GlobalRacetrackCommandAckReportType&& other_) OMG_NOEXCEPT;  
                GlobalRacetrackCommandAckReportType& operator=(GlobalRacetrackCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GlobalRacetrackCommandAckReportType& other_) const;
                bool operator != (const GlobalRacetrackCommandAckReportType& other_) const;

                void swap(GlobalRacetrackCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalRacetrackCommandAckReportType& a, GlobalRacetrackCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalRacetrackCommandAckReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType > {
        ...
        template <>
        struct extensibility< UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReportType > {
...
#endif // GlobalRacetrackCommandAckReportType_1511111885_hpp
