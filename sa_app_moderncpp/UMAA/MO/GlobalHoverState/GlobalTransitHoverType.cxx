...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalHoverState {
            ...
            GlobalTransitHoverType::GlobalTransitHoverType (bool elevationAchieved,bool speedAchieved):
            ...
            GlobalTransitHoverType::GlobalTransitHoverType(GlobalTransitHoverType&& other_) OMG_NOEXCEPT  :m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            m_speedAchieved_ (std::move(other_.m_speedAchieved_))
            {
            } 

            GlobalTransitHoverType& GlobalTransitHoverType::operator=(GlobalTransitHoverType&&  other_) OMG_NOEXCEPT {
                GlobalTransitHoverType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalTransitHoverType::swap(GlobalTransitHoverType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
...
namespace dds { 
    namespace topic {
        void topic_type_support< UMAA::MO::GlobalHoverState::GlobalTransitHoverType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                UMAA::MO::GlobalHoverState::GlobalTransitHoverTypePlugin_new,
                UMAA::MO::GlobalHoverState::GlobalTransitHoverTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< UMAA::MO::GlobalHoverState::GlobalTransitHoverType >::to_cdr_buffer(
            ...
            ::dds::core::policy::DataRepresentationId representation)
        {
            ...
            RTIBool ok = GlobalTransitHoverTypePlugin_serialize_to_cdr_buffer(
                NULL, 
                &length,
                &sample,
                representation);
            ...
            ok = GlobalTransitHoverTypePlugin_serialize_to_cdr_buffer(
                &buffer[0], 
                &length, 
                &sample,
                representation);
        ...
        void topic_type_support< UMAA::MO::GlobalHoverState::GlobalTransitHoverType >::from_cdr_buffer(UMAA::MO::GlobalHoverState::GlobalTransitHoverType& sample, 
        const std::vector<char>& buffer)
        {

            RTIBool ok  = GlobalTransitHoverTypePlugin_deserialize_from_cdr_buffer(
                &sample, 
                &buffer[0], 
                static_cast<unsigned int>(buffer.size()));
            ::rti::core::check_return_code(ok ? DDS_RETCODE_OK : DDS_RETCODE_ERROR,
            "Failed to create UMAA::MO::GlobalHoverState::GlobalTransitHoverType from cdr buffer");
        }
