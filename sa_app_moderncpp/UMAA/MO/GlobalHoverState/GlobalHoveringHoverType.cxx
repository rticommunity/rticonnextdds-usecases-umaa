...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalHoverState {
            ...
            GlobalHoveringHoverType::GlobalHoveringHoverType (bool elevationAchieved,bool headingAchieved,bool positionAchieved):
            ...
            GlobalHoveringHoverType::GlobalHoveringHoverType(GlobalHoveringHoverType&& other_) OMG_NOEXCEPT  :m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            ...
            GlobalHoveringHoverType& GlobalHoveringHoverType::operator=(GlobalHoveringHoverType&&  other_) OMG_NOEXCEPT {
                GlobalHoveringHoverType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalHoveringHoverType::swap(GlobalHoveringHoverType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
