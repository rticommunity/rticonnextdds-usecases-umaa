...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace SelfCollisionAvoidanceSpecs {
            ...
            SelfCollisionAvoidanceSpecsReportType::SelfCollisionAvoidanceSpecsReportType (bool avoidObstacle,bool stopOnObstacle,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_avoidObstacle_( avoidObstacle ),
                m_stopOnObstacle_( stopOnObstacle ),
                m_source_( source ),
            ...
            SelfCollisionAvoidanceSpecsReportType::SelfCollisionAvoidanceSpecsReportType(SelfCollisionAvoidanceSpecsReportType&& other_) OMG_NOEXCEPT  :m_avoidObstacle_ (std::move(other_.m_avoidObstacle_))
            ,
            m_stopOnObstacle_ (std::move(other_.m_stopOnObstacle_))
            ,
            ...
            SelfCollisionAvoidanceSpecsReportType& SelfCollisionAvoidanceSpecsReportType::operator=(SelfCollisionAvoidanceSpecsReportType&&  other_) OMG_NOEXCEPT {
                SelfCollisionAvoidanceSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SelfCollisionAvoidanceSpecsReportType::swap(SelfCollisionAvoidanceSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
