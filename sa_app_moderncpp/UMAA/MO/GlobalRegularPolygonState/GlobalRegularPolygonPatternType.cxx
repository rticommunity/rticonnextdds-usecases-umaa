...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRegularPolygonState {
            ...
            GlobalRegularPolygonPatternType::GlobalRegularPolygonPatternType (bool elevationAchieved,bool positionAchieved,bool speedAchieved):
            ...
            GlobalRegularPolygonPatternType::GlobalRegularPolygonPatternType(GlobalRegularPolygonPatternType&& other_) OMG_NOEXCEPT  :m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            ...
            GlobalRegularPolygonPatternType& GlobalRegularPolygonPatternType::operator=(GlobalRegularPolygonPatternType&&  other_) OMG_NOEXCEPT {
                GlobalRegularPolygonPatternType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRegularPolygonPatternType::swap(GlobalRegularPolygonPatternType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
