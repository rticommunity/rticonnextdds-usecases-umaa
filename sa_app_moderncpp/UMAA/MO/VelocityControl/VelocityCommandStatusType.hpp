...
#ifndef VelocityCommandStatusType_279337037_hpp
#define VelocityCommandStatusType_279337037_hpp
...
namespace UMAA {
    namespace MO {
        namespace VelocityControl {
            ...
            static const std::string VelocityCommandStatus_TOPIC = "UMAA::MO::VelocityControl::VelocityCommandStatus";

            class NDDSUSERDllExport VelocityCommandStatusType {
              public:
                ...
                VelocityCommandStatusType (VelocityCommandStatusType&&) = default;
                VelocityCommandStatusType& operator=(VelocityCommandStatusType&&) = default;
                VelocityCommandStatusType& operator=(const VelocityCommandStatusType&) = default;
                VelocityCommandStatusType(const VelocityCommandStatusType&) = default;
                #else
                VelocityCommandStatusType(VelocityCommandStatusType&& other_) OMG_NOEXCEPT;  
                VelocityCommandStatusType& operator=(VelocityCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const VelocityCommandStatusType& other_) const;
                bool operator != (const VelocityCommandStatusType& other_) const;

                void swap(VelocityCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(VelocityCommandStatusType& a, VelocityCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const VelocityCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::VelocityControl::VelocityCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::VelocityControl::VelocityCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::VelocityControl::VelocityCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::VelocityControl::VelocityCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::VelocityControl::VelocityCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::VelocityControl::VelocityCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::VelocityControl::VelocityCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::VelocityControl::VelocityCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::MO::VelocityControl::VelocityCommandStatusType > {
...
#endif // VelocityCommandStatusType_279337037_hpp
