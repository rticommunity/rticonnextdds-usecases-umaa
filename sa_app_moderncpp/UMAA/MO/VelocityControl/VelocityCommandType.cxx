...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace VelocityControl {
            ...
            VelocityCommandType::VelocityCommandType (const UMAA::Common::Measurement::OrientationVelocity3D& attitudeRate,const UMAA::Common::Measurement::Velocity3D_PlatformXYZ& velocity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::MaritimeEnumeration::VelocityCommandTypeEnumType::VelocityCommandTypeEnumType& commandType):
            ...
            VelocityCommandType::VelocityCommandType(VelocityCommandType&& other_) OMG_NOEXCEPT  :m_attitudeRate_ (std::move(other_.m_attitudeRate_))
            ,
            ...
            VelocityCommandType& VelocityCommandType::operator=(VelocityCommandType&&  other_) OMG_NOEXCEPT {
                VelocityCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void VelocityCommandType::swap(VelocityCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
