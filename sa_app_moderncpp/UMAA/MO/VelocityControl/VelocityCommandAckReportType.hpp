...
namespace UMAA {
    namespace MO {
        namespace VelocityControl {
            ...
            static const std::string VelocityCommandAckReport_TOPIC = "UMAA::MO::VelocityControl::VelocityCommandAckReport";

            class NDDSUSERDllExport VelocityCommandAckReportType {
              public:
                VelocityCommandAckReportType();

                VelocityCommandAckReportType(const UMAA::Common::Measurement::OrientationVelocity3D& attitudeRate,const UMAA::Common::Measurement::Velocity3D_PlatformXYZ& velocity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::MaritimeEnumeration::VelocityCommandTypeEnumType::VelocityCommandTypeEnumType& commandType);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                VelocityCommandAckReportType (VelocityCommandAckReportType&&) = default;
                VelocityCommandAckReportType& operator=(VelocityCommandAckReportType&&) = default;
                VelocityCommandAckReportType& operator=(const VelocityCommandAckReportType&) = default;
                VelocityCommandAckReportType(const VelocityCommandAckReportType&) = default;
                #else
                VelocityCommandAckReportType(VelocityCommandAckReportType&& other_) OMG_NOEXCEPT;  
                VelocityCommandAckReportType& operator=(VelocityCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(VelocityCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(VelocityCommandAckReportType& a, VelocityCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
