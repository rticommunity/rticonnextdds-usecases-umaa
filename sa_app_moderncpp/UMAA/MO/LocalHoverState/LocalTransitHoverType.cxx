...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalHoverState {
            ...
            LocalTransitHoverType::LocalTransitHoverType (bool elevationAchieved,bool speedAchieved):
            ...
            LocalTransitHoverType::LocalTransitHoverType(LocalTransitHoverType&& other_) OMG_NOEXCEPT  :m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            m_speedAchieved_ (std::move(other_.m_speedAchieved_))
            {
            } 

            LocalTransitHoverType& LocalTransitHoverType::operator=(LocalTransitHoverType&&  other_) OMG_NOEXCEPT {
                LocalTransitHoverType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalTransitHoverType::swap(LocalTransitHoverType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
