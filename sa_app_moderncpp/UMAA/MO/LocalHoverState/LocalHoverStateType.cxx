    ...
    namespace MO {
        ...
        namespace LocalHoverState {
            ...
            namespace LocalHoverStateType_Specializations {
                ...
                LocalHoverStateType_Union::LocalHoverStateType_Union(LocalHoverStateType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Selectors::LOCALTRANSITHOVERTYPE_SELECT):
                            {  
                                LocalTransitHoverType_data( std::move(other_.LocalTransitHoverType_data()));
                        } break;
                        case (UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Selectors::LOCALHOVERINGHOVERTYPE_SELECT):
                            {  
                                LocalHoveringHoverType_data( std::move(other_.LocalHoveringHoverType_data()));
                        } break;
                ...
                LocalHoverStateType_Union& LocalHoverStateType_Union::operator=(LocalHoverStateType_Union&&  other_) OMG_NOEXCEPT {
                    LocalHoverStateType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                LocalHoverStateType_Union::Union_::Union_(const UMAA::MO::LocalHoverState::LocalTransitHoverType& LocalTransitHoverType_data,const UMAA::MO::LocalHoverState::LocalHoveringHoverType& LocalHoveringHoverType_data):
                    m_LocalTransitHoverType_data_( LocalTransitHoverType_data ),
                    m_LocalHoveringHoverType_data_( LocalHoveringHoverType_data ) {
                }
                ...
                void LocalHoverStateType_Union::swap(LocalHoverStateType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const LocalHoverStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Selectors::LOCALHOVERINGHOVERTYPE_SELECT):
                            {  
                                o << "LocalHoveringHoverType_data: " << sample.LocalHoveringHoverType_data() ;        } break ;
            ...
            LocalHoverStateType::LocalHoverStateType (const UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Union& LocalHoverStateType_subtypes):
                m_LocalHoverStateType_subtypes_( LocalHoverStateType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            LocalHoverStateType::LocalHoverStateType(LocalHoverStateType&& other_) OMG_NOEXCEPT  :m_LocalHoverStateType_subtypes_ (std::move(other_.m_LocalHoverStateType_subtypes_))
            {
            } 

            LocalHoverStateType& LocalHoverStateType::operator=(LocalHoverStateType&&  other_) OMG_NOEXCEPT {
                LocalHoverStateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalHoverStateType::swap(LocalHoverStateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
