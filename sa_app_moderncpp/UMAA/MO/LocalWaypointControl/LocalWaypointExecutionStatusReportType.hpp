...
namespace UMAA {
    namespace MO {
        namespace LocalWaypointControl {
            ...
            static const std::string LocalWaypointExecutionStatusReport_TOPIC = "UMAA::MO::LocalWaypointControl::LocalWaypointExecutionStatusReport";

            class NDDSUSERDllExport LocalWaypointExecutionStatusReportType {
              public:
                LocalWaypointExecutionStatusReportType();

                LocalWaypointExecutionStatusReportType(const UMAA::Common::Measurement::DateTime& arrivalTime,double crossTrackError,double cumulativeDistance,double distanceRemaining,double distanceToWaypoint,bool elevationAchieved,bool maintainTrack,bool speedAchieved,const UMAA::Common::Measurement::DateTime& timeToWaypoint,bool trackLineAchieved,int32_t waypointsRemaining,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::NumericGUID& waypointID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalWaypointExecutionStatusReportType (LocalWaypointExecutionStatusReportType&&) = default;
                LocalWaypointExecutionStatusReportType& operator=(LocalWaypointExecutionStatusReportType&&) = default;
                LocalWaypointExecutionStatusReportType& operator=(const LocalWaypointExecutionStatusReportType&) = default;
                LocalWaypointExecutionStatusReportType(const LocalWaypointExecutionStatusReportType&) = default;
                #else
                LocalWaypointExecutionStatusReportType(LocalWaypointExecutionStatusReportType&& other_) OMG_NOEXCEPT;  
                LocalWaypointExecutionStatusReportType& operator=(LocalWaypointExecutionStatusReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(LocalWaypointExecutionStatusReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalWaypointExecutionStatusReportType& a, LocalWaypointExecutionStatusReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
