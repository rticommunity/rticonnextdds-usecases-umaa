        ...
        namespace GlobalDriftControl {
            ...
            class NDDSUSERDllExport GlobalDriftCommandType {
              public:
                ...
                void swap(GlobalDriftCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalDriftCommandType& a, GlobalDriftCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
