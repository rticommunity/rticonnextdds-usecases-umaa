...
data type GlobalDriftExecutionStatusReportType from GlobalDriftExecutionStatusReportType.idl.
This example builds two applications, named GlobalDriftExecutionStatusReportType_publisher and
GlobalDriftExecutionStatusReportType_subscriber.
...
> make -f makefile_GlobalDriftExecutionStatusReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_GlobalDriftExecutionStatusReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the GlobalDriftExecutionStatusReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/GlobalDriftExecutionStatusReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/GlobalDriftExecutionStatusReportType_subscriber -d <domain_id> -s <sample_count>
