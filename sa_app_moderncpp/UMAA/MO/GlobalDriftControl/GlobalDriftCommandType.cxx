...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalDriftControl {
            ...
            GlobalDriftCommandType::GlobalDriftCommandType (double driftTolerance,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,const ::dds::core::optional< UMAA::Common::Measurement::Position2D >& position,double positionTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            GlobalDriftCommandType::GlobalDriftCommandType(GlobalDriftCommandType&& other_) OMG_NOEXCEPT  :m_driftTolerance_ (std::move(other_.m_driftTolerance_))
            ,
            ...
            GlobalDriftCommandType& GlobalDriftCommandType::operator=(GlobalDriftCommandType&&  other_) OMG_NOEXCEPT {
                GlobalDriftCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalDriftCommandType::swap(GlobalDriftCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::MO::GlobalDriftControl::GlobalDriftCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member GlobalDriftCommandType_g_tc_members[16]=
                {
                ...
                GlobalDriftCommandType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::ElevationType>::get().native();
                GlobalDriftCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                GlobalDriftCommandType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Position2D>::get().native();
                GlobalDriftCommandType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[6]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::VariableSpeedControl::VariableSpeedControlType>::get().native();
                GlobalDriftCommandType_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::GroundSpeed_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[8]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::ElevationType>::get().native();
                GlobalDriftCommandType_g_tc_members[9]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[10]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::VariableSpeedControl::VariableSpeedControlType>::get().native();
                GlobalDriftCommandType_g_tc_members[11]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::GroundSpeed_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[12]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[13]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[14]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalDriftCommandType_g_tc_members[15]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();

                /* Initialize the values for member annotations. */
                GlobalDriftCommandType_g_tc_members[0]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[0]._annotations._defaultValue._u.double_value = 0.0;
                GlobalDriftCommandType_g_tc_members[0]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[0]._annotations._minValue._u.double_value = 0ULL;
                GlobalDriftCommandType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[0]._annotations._maxValue._u.double_value = 401056000ULL;

                GlobalDriftCommandType_g_tc_members[2]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[2]._annotations._defaultValue._u.double_value = 0.0;
                GlobalDriftCommandType_g_tc_members[2]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[2]._annotations._minValue._u.double_value = 0ULL;
                GlobalDriftCommandType_g_tc_members[2]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[2]._annotations._maxValue._u.double_value = 401056000ULL;

                GlobalDriftCommandType_g_tc_members[5]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[5]._annotations._defaultValue._u.double_value = 0.0;
                GlobalDriftCommandType_g_tc_members[5]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[5]._annotations._minValue._u.double_value = 0ULL;
                GlobalDriftCommandType_g_tc_members[5]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[5]._annotations._maxValue._u.double_value = 401056000ULL;

                GlobalDriftCommandType_g_tc_members[7]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[7]._annotations._defaultValue._u.double_value = 0.0;
                GlobalDriftCommandType_g_tc_members[7]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[7]._annotations._minValue._u.double_value = 0ULL;
                GlobalDriftCommandType_g_tc_members[7]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[7]._annotations._maxValue._u.double_value = 200ULL;

                GlobalDriftCommandType_g_tc_members[9]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[9]._annotations._defaultValue._u.double_value = 0.0;
                GlobalDriftCommandType_g_tc_members[9]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[9]._annotations._minValue._u.double_value = 0ULL;
                GlobalDriftCommandType_g_tc_members[9]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[9]._annotations._maxValue._u.double_value = 401056000ULL;

                GlobalDriftCommandType_g_tc_members[11]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[11]._annotations._defaultValue._u.double_value = 0.0;
                GlobalDriftCommandType_g_tc_members[11]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[11]._annotations._minValue._u.double_value = 0ULL;
                GlobalDriftCommandType_g_tc_members[11]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftCommandType_g_tc_members[11]._annotations._maxValue._u.double_value = 200ULL;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo GlobalDriftCommandType_g_memberAccessInfos[16] =
                ...
                GlobalDriftCommandType_g_memberAccessInfos[11].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->transitSpeedTolerance() - (char *)sample);

                GlobalDriftCommandType_g_memberAccessInfos[12].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->source() - (char *)sample);

                GlobalDriftCommandType_g_memberAccessInfos[13].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->destination() - (char *)sample);

                GlobalDriftCommandType_g_memberAccessInfos[14].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->sessionID() - (char *)sample);

                GlobalDriftCommandType_g_memberAccessInfos[15].bindingMemberValueOffset[0] = 
