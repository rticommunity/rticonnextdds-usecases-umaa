    ...
    namespace MO {
        ...
        namespace GlobalDriftControl {
            ...
            GlobalDriftExecutionStatusReportType::GlobalDriftExecutionStatusReportType (double distanceFromReference,const UMAA::MO::GlobalDriftState::GlobalDriftStateType& globalDriftState,const UMAA::Common::Measurement::DateTime& timeDriftAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timeDriftCompleted,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                ...
                m_globalDriftState_( globalDriftState ),
            ...
            GlobalDriftExecutionStatusReportType::GlobalDriftExecutionStatusReportType(GlobalDriftExecutionStatusReportType&& other_) OMG_NOEXCEPT  :m_distanceFromReference_ (std::move(other_.m_distanceFromReference_))
            ,
            m_globalDriftState_ (std::move(other_.m_globalDriftState_))
            ,
            ...
            GlobalDriftExecutionStatusReportType& GlobalDriftExecutionStatusReportType::operator=(GlobalDriftExecutionStatusReportType&&  other_) OMG_NOEXCEPT {
                GlobalDriftExecutionStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalDriftExecutionStatusReportType::swap(GlobalDriftExecutionStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
