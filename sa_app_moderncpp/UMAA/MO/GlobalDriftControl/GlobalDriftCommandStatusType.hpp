...
#ifndef GlobalDriftCommandStatusType_1102486909_hpp
#define GlobalDriftCommandStatusType_1102486909_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalDriftControl {
            ...
            static const std::string GlobalDriftCommandStatus_TOPIC = "UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatus";

            class NDDSUSERDllExport GlobalDriftCommandStatusType {
              public:
                ...
                GlobalDriftCommandStatusType (GlobalDriftCommandStatusType&&) = default;
                GlobalDriftCommandStatusType& operator=(GlobalDriftCommandStatusType&&) = default;
                GlobalDriftCommandStatusType& operator=(const GlobalDriftCommandStatusType&) = default;
                GlobalDriftCommandStatusType(const GlobalDriftCommandStatusType&) = default;
                #else
                GlobalDriftCommandStatusType(GlobalDriftCommandStatusType&& other_) OMG_NOEXCEPT;  
                GlobalDriftCommandStatusType& operator=(GlobalDriftCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GlobalDriftCommandStatusType& other_) const;
                bool operator != (const GlobalDriftCommandStatusType& other_) const;

                void swap(GlobalDriftCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalDriftCommandStatusType& a, GlobalDriftCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalDriftCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatusType > {
...
#endif // GlobalDriftCommandStatusType_1102486909_hpp
