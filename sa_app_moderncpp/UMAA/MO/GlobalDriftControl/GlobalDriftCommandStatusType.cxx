...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalDriftControl {
            ...
            GlobalDriftCommandStatusType::GlobalDriftCommandStatusType(GlobalDriftCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            GlobalDriftCommandStatusType& GlobalDriftCommandStatusType::operator=(GlobalDriftCommandStatusType&&  other_) OMG_NOEXCEPT {
                GlobalDriftCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalDriftCommandStatusType::swap(GlobalDriftCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
