...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalWaypointControl {
            ...
            GlobalWaypointSpeedCommandType::GlobalWaypointSpeedCommandType (const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_speed_( speed ),
                m_source_( source ),
            ...
            GlobalWaypointSpeedCommandType::GlobalWaypointSpeedCommandType(GlobalWaypointSpeedCommandType&& other_) OMG_NOEXCEPT  :m_speed_ (std::move(other_.m_speed_))
            ,
            ...
            GlobalWaypointSpeedCommandType& GlobalWaypointSpeedCommandType::operator=(GlobalWaypointSpeedCommandType&&  other_) OMG_NOEXCEPT {
                GlobalWaypointSpeedCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalWaypointSpeedCommandType::swap(GlobalWaypointSpeedCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
