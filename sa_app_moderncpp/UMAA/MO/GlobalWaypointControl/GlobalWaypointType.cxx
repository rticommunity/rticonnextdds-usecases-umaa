    ...
    namespace MO {
        ...
        namespace GlobalWaypointControl {
            ...
            GlobalWaypointType::GlobalWaypointType (const ::dds::core::optional< UMAA::Common::Measurement::Orientation3D_PlatformXYZ >& attitude,const UMAA::Common::Measurement::ElevationType& elevation,bool maintainTrack,const UMAA::Common::Measurement::Position2D& position,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed,const ::dds::core::optional< double >& trackTolerance,const UMAA::Common::Measurement::NumericGUID& waypointID,double waypointTolerance):
                ...
                m_speed_( speed ),
                m_trackTolerance_( trackTolerance ),
            ...
            GlobalWaypointType::GlobalWaypointType(GlobalWaypointType&& other_) OMG_NOEXCEPT  :m_attitude_ (std::move(other_.m_attitude_))
            ,
            ...
            ,
            m_trackTolerance_ (std::move(other_.m_trackTolerance_))
            ,
            ...
            GlobalWaypointType& GlobalWaypointType::operator=(GlobalWaypointType&&  other_) OMG_NOEXCEPT {
                GlobalWaypointType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalWaypointType::swap(GlobalWaypointType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
