...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalDriftControl {
            ...
            LocalDriftExecutionStatusReportType::LocalDriftExecutionStatusReportType (double distanceFromReference,const UMAA::MO::LocalDriftState::LocalDriftStateType& localDriftState,const UMAA::Common::Measurement::DateTime& timeDriftAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timeDriftCompleted,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_distanceFromReference_( distanceFromReference ),
                m_localDriftState_( localDriftState ),
                m_timeDriftAchieved_( timeDriftAchieved ),
                m_timeDriftCompleted_( timeDriftCompleted ),
                m_source_( source ),
            ...
            LocalDriftExecutionStatusReportType::LocalDriftExecutionStatusReportType(LocalDriftExecutionStatusReportType&& other_) OMG_NOEXCEPT  :m_distanceFromReference_ (std::move(other_.m_distanceFromReference_))
            ,
            m_localDriftState_ (std::move(other_.m_localDriftState_))
            ,
            m_timeDriftAchieved_ (std::move(other_.m_timeDriftAchieved_))
            ,
            m_timeDriftCompleted_ (std::move(other_.m_timeDriftCompleted_))
            ,
            ...
            LocalDriftExecutionStatusReportType& LocalDriftExecutionStatusReportType::operator=(LocalDriftExecutionStatusReportType&&  other_) OMG_NOEXCEPT {
                LocalDriftExecutionStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalDriftExecutionStatusReportType::swap(LocalDriftExecutionStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool LocalDriftExecutionStatusReportType::operator == (const LocalDriftExecutionStatusReportType& other_) const {
                if (m_distanceFromReference_ != other_.m_distanceFromReference_) {
                    return false;
                }
