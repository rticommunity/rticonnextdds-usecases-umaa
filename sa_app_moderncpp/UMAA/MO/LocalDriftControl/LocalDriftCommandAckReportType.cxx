...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalDriftControl {
            ...
            LocalDriftCommandAckReportType::LocalDriftCommandAckReportType(LocalDriftCommandAckReportType&& other_) OMG_NOEXCEPT  :m_driftTolerance_ (std::move(other_.m_driftTolerance_))
            ,
            ...
            LocalDriftCommandAckReportType& LocalDriftCommandAckReportType::operator=(LocalDriftCommandAckReportType&&  other_) OMG_NOEXCEPT {
                LocalDriftCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalDriftCommandAckReportType::swap(LocalDriftCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
