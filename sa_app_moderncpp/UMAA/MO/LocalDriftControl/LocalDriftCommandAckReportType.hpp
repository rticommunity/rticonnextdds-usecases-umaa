...
#ifndef LocalDriftCommandAckReportType_423792506_hpp
#define LocalDriftCommandAckReportType_423792506_hpp
...
namespace UMAA {
    namespace MO {
        namespace LocalDriftControl {
            ...
            static const std::string LocalDriftCommandAckReport_TOPIC = "UMAA::MO::LocalDriftControl::LocalDriftCommandAckReport";

            class NDDSUSERDllExport LocalDriftCommandAckReportType {
              public:
                LocalDriftCommandAckReportType();

                LocalDriftCommandAckReportType(double driftTolerance,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,const ::dds::core::optional< UMAA::Common::Measurement::Position2D_PlatformXYZ >& position,double positionTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed,double speedTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalDriftCommandAckReportType (LocalDriftCommandAckReportType&&) = default;
                LocalDriftCommandAckReportType& operator=(LocalDriftCommandAckReportType&&) = default;
                LocalDriftCommandAckReportType& operator=(const LocalDriftCommandAckReportType&) = default;
                LocalDriftCommandAckReportType(const LocalDriftCommandAckReportType&) = default;
                #else
                LocalDriftCommandAckReportType(LocalDriftCommandAckReportType&& other_) OMG_NOEXCEPT;  
                LocalDriftCommandAckReportType& operator=(LocalDriftCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalDriftCommandAckReportType& other_) const;
                bool operator != (const LocalDriftCommandAckReportType& other_) const;

                void swap(LocalDriftCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalDriftCommandAckReportType& a, LocalDriftCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalDriftCommandAckReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalDriftControl::LocalDriftCommandAckReportType > {
...
#endif // LocalDriftCommandAckReportType_423792506_hpp
