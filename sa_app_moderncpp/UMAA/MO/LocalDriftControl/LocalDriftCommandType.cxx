...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalDriftControl {
            ...
            LocalDriftCommandType::LocalDriftCommandType(LocalDriftCommandType&& other_) OMG_NOEXCEPT  :m_driftTolerance_ (std::move(other_.m_driftTolerance_))
            ,
            ...
            LocalDriftCommandType& LocalDriftCommandType::operator=(LocalDriftCommandType&&  other_) OMG_NOEXCEPT {
                LocalDriftCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalDriftCommandType::swap(LocalDriftCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
