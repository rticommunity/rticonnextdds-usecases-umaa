...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalDriftState {
            ...
            LocalTransitDriftType::LocalTransitDriftType (bool transitElevationAchieved,bool transitSpeedAchieved):
            ...
            LocalTransitDriftType::LocalTransitDriftType(LocalTransitDriftType&& other_) OMG_NOEXCEPT  :m_transitElevationAchieved_ (std::move(other_.m_transitElevationAchieved_))
            ,
            m_transitSpeedAchieved_ (std::move(other_.m_transitSpeedAchieved_))
            {
            } 

            LocalTransitDriftType& LocalTransitDriftType::operator=(LocalTransitDriftType&&  other_) OMG_NOEXCEPT {
                LocalTransitDriftType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalTransitDriftType::swap(LocalTransitDriftType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
