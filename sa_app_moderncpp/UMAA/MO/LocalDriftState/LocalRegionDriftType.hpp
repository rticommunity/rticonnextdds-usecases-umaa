        ...
        namespace LocalDriftState {
            ...
            class NDDSUSERDllExport LocalRegionDriftType {
              public:
                ...
                LocalRegionDriftType(bool elevationAchieved,bool positionAchieved);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalRegionDriftType (LocalRegionDriftType&&) = default;
                LocalRegionDriftType& operator=(LocalRegionDriftType&&) = default;
                LocalRegionDriftType& operator=(const LocalRegionDriftType&) = default;
                LocalRegionDriftType(const LocalRegionDriftType&) = default;
                #else
                LocalRegionDriftType(LocalRegionDriftType&& other_) OMG_NOEXCEPT;  
                LocalRegionDriftType& operator=(LocalRegionDriftType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(LocalRegionDriftType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalRegionDriftType& a, LocalRegionDriftType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
