...
#ifndef GlobalTransitDriftType_1187295847_hpp
#define GlobalTransitDriftType_1187295847_hpp
        ...
        namespace GlobalDriftState {
            ...
            class NDDSUSERDllExport GlobalTransitDriftType {
              public:
                ...
                GlobalTransitDriftType(bool transitElevationAchieved,bool transitSpeedAchieved);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalTransitDriftType (GlobalTransitDriftType&&) = default;
                GlobalTransitDriftType& operator=(GlobalTransitDriftType&&) = default;
                GlobalTransitDriftType& operator=(const GlobalTransitDriftType&) = default;
                GlobalTransitDriftType(const GlobalTransitDriftType&) = default;
                #else
                GlobalTransitDriftType(GlobalTransitDriftType&& other_) OMG_NOEXCEPT;  
                GlobalTransitDriftType& operator=(GlobalTransitDriftType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(GlobalTransitDriftType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalTransitDriftType& a, GlobalTransitDriftType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct is_topic_type< UMAA::MO::GlobalDriftState::GlobalTransitDriftType > : public ::dds::core::true_type {};
        ...
        struct topic_type_support< UMAA::MO::GlobalDriftState::GlobalTransitDriftType > {
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::GlobalDriftState::GlobalTransitDriftType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
...
#endif // GlobalTransitDriftType_1187295847_hpp
