    ...
    namespace MO {
        ...
        namespace GlobalDriftState {
            ...
            namespace GlobalDriftStateType_Specializations {
                ...
                GlobalDriftStateType_Union::GlobalDriftStateType_Union(GlobalDriftStateType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Selectors::GLOBALTRANSITDRIFTTYPE_SELECT):
                            {  
                                GlobalTransitDriftType_data( std::move(other_.GlobalTransitDriftType_data()));
                        } break;
                        case (UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Selectors::GLOBALREGIONDRIFTTYPE_SELECT):
                            {  
                                GlobalRegionDriftType_data( std::move(other_.GlobalRegionDriftType_data()));
                        } break;
                ...
                GlobalDriftStateType_Union& GlobalDriftStateType_Union::operator=(GlobalDriftStateType_Union&&  other_) OMG_NOEXCEPT {
                    GlobalDriftStateType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                GlobalDriftStateType_Union::Union_::Union_(const UMAA::MO::GlobalDriftState::GlobalTransitDriftType& GlobalTransitDriftType_data,const UMAA::MO::GlobalDriftState::GlobalRegionDriftType& GlobalRegionDriftType_data):
                    m_GlobalTransitDriftType_data_( GlobalTransitDriftType_data ),
                    m_GlobalRegionDriftType_data_( GlobalRegionDriftType_data ) {
                }
                ...
                void GlobalDriftStateType_Union::swap(GlobalDriftStateType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const GlobalDriftStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Selectors::GLOBALREGIONDRIFTTYPE_SELECT):
                            {  
                                o << "GlobalRegionDriftType_data: " << sample.GlobalRegionDriftType_data() ;        } break ;
            ...
            GlobalDriftStateType::GlobalDriftStateType (const UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Union& GlobalDriftStateType_subtypes):
                m_GlobalDriftStateType_subtypes_( GlobalDriftStateType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            GlobalDriftStateType::GlobalDriftStateType(GlobalDriftStateType&& other_) OMG_NOEXCEPT  :m_GlobalDriftStateType_subtypes_ (std::move(other_.m_GlobalDriftStateType_subtypes_))
            {
            } 

            GlobalDriftStateType& GlobalDriftStateType::operator=(GlobalDriftStateType&&  other_) OMG_NOEXCEPT {
                GlobalDriftStateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalDriftStateType::swap(GlobalDriftStateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
