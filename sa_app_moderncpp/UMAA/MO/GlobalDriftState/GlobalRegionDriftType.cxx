...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalDriftState {
            ...
            GlobalRegionDriftType::GlobalRegionDriftType (bool elevationAchieved,bool positionAchieved):
            ...
            GlobalRegionDriftType::GlobalRegionDriftType(GlobalRegionDriftType&& other_) OMG_NOEXCEPT  :m_elevationAchieved_ (std::move(other_.m_elevationAchieved_))
            ,
            m_positionAchieved_ (std::move(other_.m_positionAchieved_))
            {
            } 

            GlobalRegionDriftType& GlobalRegionDriftType::operator=(GlobalRegionDriftType&&  other_) OMG_NOEXCEPT {
                GlobalRegionDriftType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalRegionDriftType::swap(GlobalRegionDriftType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
...
namespace dds { 
    namespace topic {
        void topic_type_support< UMAA::MO::GlobalDriftState::GlobalRegionDriftType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                UMAA::MO::GlobalDriftState::GlobalRegionDriftTypePlugin_new,
                UMAA::MO::GlobalDriftState::GlobalRegionDriftTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< UMAA::MO::GlobalDriftState::GlobalRegionDriftType >::to_cdr_buffer(
            ...
            ::dds::core::policy::DataRepresentationId representation)
        {
            ...
            RTIBool ok = GlobalRegionDriftTypePlugin_serialize_to_cdr_buffer(
                NULL, 
                &length,
                &sample,
                representation);
            ...
            ok = GlobalRegionDriftTypePlugin_serialize_to_cdr_buffer(
                &buffer[0], 
                &length, 
                &sample,
                representation);
        ...
        void topic_type_support< UMAA::MO::GlobalDriftState::GlobalRegionDriftType >::from_cdr_buffer(UMAA::MO::GlobalDriftState::GlobalRegionDriftType& sample, 
        const std::vector<char>& buffer)
        {

            RTIBool ok  = GlobalRegionDriftTypePlugin_deserialize_from_cdr_buffer(
                &sample, 
                &buffer[0], 
                static_cast<unsigned int>(buffer.size()));
            ::rti::core::check_return_code(ok ? DDS_RETCODE_OK : DDS_RETCODE_ERROR,
            "Failed to create UMAA::MO::GlobalDriftState::GlobalRegionDriftType from cdr buffer");
        }
