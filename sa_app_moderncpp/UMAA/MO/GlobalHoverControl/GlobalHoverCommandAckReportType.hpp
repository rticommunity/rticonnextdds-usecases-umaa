...
namespace UMAA {
    namespace MO {
        namespace GlobalHoverControl {
            ...
            static const std::string GlobalHoverCommandAckReport_TOPIC = "UMAA::MO::GlobalHoverControl::GlobalHoverCommandAckReport";

            class NDDSUSERDllExport GlobalHoverCommandAckReportType {
              public:
                GlobalHoverCommandAckReportType();

                GlobalHoverCommandAckReportType(const UMAA::Common::MaritimeEnumeration::HoverKindEnumType::HoverKindEnumType& controlPriority,const UMAA::Common::Measurement::ElevationType& elevation,double elevationTolerance,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& endTime,const ::dds::core::optional< UMAA::Common::Orientation::HeadingType >& heading,double headingTolerance,const ::dds::core::optional< UMAA::Common::Measurement::Position2D >& position,double positionTolerance,const UMAA::Common::Measurement::ElevationType& transitElevation,double transitElevationTolerance,const UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed,double transitSpeedTolerance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GlobalHoverCommandAckReportType (GlobalHoverCommandAckReportType&&) = default;
                GlobalHoverCommandAckReportType& operator=(GlobalHoverCommandAckReportType&&) = default;
                GlobalHoverCommandAckReportType& operator=(const GlobalHoverCommandAckReportType&) = default;
                GlobalHoverCommandAckReportType(const GlobalHoverCommandAckReportType&) = default;
                #else
                GlobalHoverCommandAckReportType(GlobalHoverCommandAckReportType&& other_) OMG_NOEXCEPT;  
                GlobalHoverCommandAckReportType& operator=(GlobalHoverCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(GlobalHoverCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalHoverCommandAckReportType& a, GlobalHoverCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
