...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalHoverControl {
            ...
            GlobalHoverExecutionStatusReport::GlobalHoverExecutionStatusReport (const UMAA::MO::GlobalHoverState::GlobalHoverStateType& globalHoverState,const UMAA::Common::Measurement::DateTime& timeHoverAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timeHoverCompleted):
                m_globalHoverState_( globalHoverState ),
                m_timeHoverAchieved_( timeHoverAchieved ),
                m_timeHoverCompleted_( timeHoverCompleted ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            GlobalHoverExecutionStatusReport::GlobalHoverExecutionStatusReport(GlobalHoverExecutionStatusReport&& other_) OMG_NOEXCEPT  :m_globalHoverState_ (std::move(other_.m_globalHoverState_))
            ,
            m_timeHoverAchieved_ (std::move(other_.m_timeHoverAchieved_))
            ,
            m_timeHoverCompleted_ (std::move(other_.m_timeHoverCompleted_))
            {
            } 

            GlobalHoverExecutionStatusReport& GlobalHoverExecutionStatusReport::operator=(GlobalHoverExecutionStatusReport&&  other_) OMG_NOEXCEPT {
                GlobalHoverExecutionStatusReport tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalHoverExecutionStatusReport::swap(GlobalHoverExecutionStatusReport& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
