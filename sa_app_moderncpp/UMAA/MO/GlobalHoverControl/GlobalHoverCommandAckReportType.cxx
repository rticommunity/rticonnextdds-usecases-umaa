...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalHoverControl {
            ...
            GlobalHoverCommandAckReportType::GlobalHoverCommandAckReportType(GlobalHoverCommandAckReportType&& other_) OMG_NOEXCEPT  :m_controlPriority_ (std::move(other_.m_controlPriority_))
            ,
            ...
            GlobalHoverCommandAckReportType& GlobalHoverCommandAckReportType::operator=(GlobalHoverCommandAckReportType&&  other_) OMG_NOEXCEPT {
                GlobalHoverCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalHoverCommandAckReportType::swap(GlobalHoverCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
