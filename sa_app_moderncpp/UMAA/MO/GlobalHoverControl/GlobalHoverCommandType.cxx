...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalHoverControl {
            ...
            GlobalHoverCommandType::GlobalHoverCommandType(GlobalHoverCommandType&& other_) OMG_NOEXCEPT  :m_controlPriority_ (std::move(other_.m_controlPriority_))
            ,
            ...
            GlobalHoverCommandType& GlobalHoverCommandType::operator=(GlobalHoverCommandType&&  other_) OMG_NOEXCEPT {
                GlobalHoverCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalHoverCommandType::swap(GlobalHoverCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::MO::GlobalHoverControl::GlobalHoverCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member GlobalHoverCommandType_g_tc_members[16]=
                {
                ...
                GlobalHoverCommandType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::HoverKindEnumType::HoverKindEnumType>::get().native();
                GlobalHoverCommandType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::ElevationType>::get().native();
                GlobalHoverCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                GlobalHoverCommandType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Orientation::HeadingType>::get().native();
                GlobalHoverCommandType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::RelativeAngle_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[6]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Position2D>::get().native();
                GlobalHoverCommandType_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[8]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::ElevationType>::get().native();
                GlobalHoverCommandType_g_tc_members[9]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[10]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::VariableSpeedControl::VariableSpeedControlType>::get().native();
                GlobalHoverCommandType_g_tc_members[11]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::GroundSpeed_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[12]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[13]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[14]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalHoverCommandType_g_tc_members[15]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                GlobalHoverCommandType_g_tc_members[2]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[2]._annotations._defaultValue._u.double_value = 0.0;
                GlobalHoverCommandType_g_tc_members[2]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[2]._annotations._minValue._u.double_value = 0ULL;
                GlobalHoverCommandType_g_tc_members[2]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[2]._annotations._maxValue._u.double_value = 401056000ULL;

                GlobalHoverCommandType_g_tc_members[5]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[5]._annotations._defaultValue._u.double_value = 0.0;
                GlobalHoverCommandType_g_tc_members[5]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[5]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                GlobalHoverCommandType_g_tc_members[5]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[5]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;

                GlobalHoverCommandType_g_tc_members[7]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[7]._annotations._defaultValue._u.double_value = 0.0;
                GlobalHoverCommandType_g_tc_members[7]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[7]._annotations._minValue._u.double_value = 0ULL;
                GlobalHoverCommandType_g_tc_members[7]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[7]._annotations._maxValue._u.double_value = 401056000ULL;

                GlobalHoverCommandType_g_tc_members[9]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[9]._annotations._defaultValue._u.double_value = 0.0;
                GlobalHoverCommandType_g_tc_members[9]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[9]._annotations._minValue._u.double_value = 0ULL;
                GlobalHoverCommandType_g_tc_members[9]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[9]._annotations._maxValue._u.double_value = 401056000ULL;

                GlobalHoverCommandType_g_tc_members[11]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[11]._annotations._defaultValue._u.double_value = 0.0;
                GlobalHoverCommandType_g_tc_members[11]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[11]._annotations._minValue._u.double_value = 0ULL;
                GlobalHoverCommandType_g_tc_members[11]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalHoverCommandType_g_tc_members[11]._annotations._maxValue._u.double_value = 200ULL;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo GlobalHoverCommandType_g_memberAccessInfos[16] =
                ...
                GlobalHoverCommandType_g_memberAccessInfos[12].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->source() - (char *)sample);

                GlobalHoverCommandType_g_memberAccessInfos[13].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->destination() - (char *)sample);

                GlobalHoverCommandType_g_memberAccessInfos[14].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->sessionID() - (char *)sample);

                GlobalHoverCommandType_g_memberAccessInfos[15].bindingMemberValueOffset[0] = 
