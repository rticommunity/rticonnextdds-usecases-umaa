...
#ifndef LocalRacetrackCommandType_341491120_hpp
#define LocalRacetrackCommandType_341491120_hpp
        ...
        namespace LocalRacetrackControl {
            ...
            class NDDSUSERDllExport LocalRacetrackCommandType {
              public:
                ...
                bool operator == (const LocalRacetrackCommandType& other_) const;
                bool operator != (const LocalRacetrackCommandType& other_) const;

                void swap(LocalRacetrackCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalRacetrackCommandType& a, LocalRacetrackCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalRacetrackCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType > {
        ...
        template <>
        struct extensibility< UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandType > {
...
#endif // LocalRacetrackCommandType_341491120_hpp
