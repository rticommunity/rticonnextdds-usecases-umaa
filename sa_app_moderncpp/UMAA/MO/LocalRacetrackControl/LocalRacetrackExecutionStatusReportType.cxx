...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalRacetrackControl {
            ...
            LocalRacetrackExecutionStatusReportType::LocalRacetrackExecutionStatusReportType (const UMAA::MO::LocalRacetrackState::LocalRacetrackStateType& localRacetrackState,const UMAA::Common::Measurement::DateTime& timePatternAchieved,const ::dds::core::optional< UMAA::Common::Measurement::DateTime >& timePatternCompleted,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_localRacetrackState_( localRacetrackState ),
            ...
            LocalRacetrackExecutionStatusReportType::LocalRacetrackExecutionStatusReportType(LocalRacetrackExecutionStatusReportType&& other_) OMG_NOEXCEPT  :m_localRacetrackState_ (std::move(other_.m_localRacetrackState_))
            ,
            ...
            LocalRacetrackExecutionStatusReportType& LocalRacetrackExecutionStatusReportType::operator=(LocalRacetrackExecutionStatusReportType&&  other_) OMG_NOEXCEPT {
                LocalRacetrackExecutionStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalRacetrackExecutionStatusReportType::swap(LocalRacetrackExecutionStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
