...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace LightStatus {
            ...
            LightReportType::LightReportType (bool allroundLight,bool flashingLight,bool mastheadLight,bool portSideLight,bool starboardSideLight,bool sternLight,bool towingLight,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            LightReportType::LightReportType(LightReportType&& other_) OMG_NOEXCEPT  :m_allroundLight_ (std::move(other_.m_allroundLight_))
            ,
            ...
            LightReportType& LightReportType::operator=(LightReportType&&  other_) OMG_NOEXCEPT {
                LightReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LightReportType::swap(LightReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
