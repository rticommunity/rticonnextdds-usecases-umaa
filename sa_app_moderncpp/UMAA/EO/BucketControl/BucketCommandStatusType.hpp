...
#ifndef BucketCommandStatusType_1370182486_hpp
#define BucketCommandStatusType_1370182486_hpp
...
namespace UMAA {
    namespace EO {
        namespace BucketControl {
            ...
            static const std::string BucketCommandStatus_TOPIC = "UMAA::EO::BucketControl::BucketCommandStatus";

            class NDDSUSERDllExport BucketCommandStatusType {
              public:
                BucketCommandStatusType();

                BucketCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BucketCommandStatusType (BucketCommandStatusType&&) = default;
                BucketCommandStatusType& operator=(BucketCommandStatusType&&) = default;
                BucketCommandStatusType& operator=(const BucketCommandStatusType&) = default;
                BucketCommandStatusType(const BucketCommandStatusType&) = default;
                #else
                BucketCommandStatusType(BucketCommandStatusType&& other_) OMG_NOEXCEPT;  
                BucketCommandStatusType& operator=(BucketCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const BucketCommandStatusType& other_) const;
                bool operator != (const BucketCommandStatusType& other_) const;

                void swap(BucketCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BucketCommandStatusType& a, BucketCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BucketCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::BucketControl::BucketCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::BucketControl::BucketCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::BucketControl::BucketCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::BucketControl::BucketCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::BucketControl::BucketCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::BucketControl::BucketCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::BucketControl::BucketCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::BucketControl::BucketCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::BucketControl::BucketCommandStatusType > {
...
#endif // BucketCommandStatusType_1370182486_hpp
