...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BucketConfig {
            ...
            BucketConfigReportType::BucketConfigReportType (const std::string& name,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_name_( name ),
                m_source_( source ),
            ...
            BucketConfigReportType::BucketConfigReportType(BucketConfigReportType&& other_) OMG_NOEXCEPT  :m_name_ (std::move(other_.m_name_))
            ,
            ...
            BucketConfigReportType& BucketConfigReportType::operator=(BucketConfigReportType&&  other_) OMG_NOEXCEPT {
                BucketConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BucketConfigReportType::swap(BucketConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
