    ...
    namespace EO {
        ...
        namespace MastStatus {
            ...
            MastReportType::MastReportType() :
                m_state_(UMAA::Common::MaritimeEnumeration::MastStateEnumType::MastStateEnumType::DOWN)  {
                    ::rti::core::fill_array( 
                        m_source_, 
                        ::rti::topic::cdr::alias_helper< UMAA::Common::Measurement::NumericGUID::value_type >::default_value());
            }   

            MastReportType::MastReportType (const UMAA::Common::MaritimeEnumeration::MastStateEnumType::MastStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_state_( state ),
                m_source_( source ),
            ...
            MastReportType::MastReportType(MastReportType&& other_) OMG_NOEXCEPT  :m_state_ (std::move(other_.m_state_))
            ,
            ...
            MastReportType& MastReportType::operator=(MastReportType&&  other_) OMG_NOEXCEPT {
                MastReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MastReportType::swap(MastReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::EO::MastStatus::MastReportType > {
            static DDS_TypeCode * get()
            {
                ...
                MastReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::MastStateEnumType::MastStateEnumType>::get().native();
                MastReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                MastReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
...
namespace dds { 
    namespace topic {
        ...
        {
            sample.state(UMAA::Common::MaritimeEnumeration::MastStateEnumType::MastStateEnumType::DOWN);
