...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PowerControl {
            ...
            PowerCommandType::PowerCommandType (const std::string& identification,const UMAA::Common::MaritimeEnumeration::IgnitionStateEnumType::IgnitionStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            PowerCommandType::PowerCommandType(PowerCommandType&& other_) OMG_NOEXCEPT  :m_identification_ (std::move(other_.m_identification_))
            ,
            ...
            PowerCommandType& PowerCommandType::operator=(PowerCommandType&&  other_) OMG_NOEXCEPT {
                PowerCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PowerCommandType::swap(PowerCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
