...
#ifndef PowerCommandStatusType_1739575108_hpp
#define PowerCommandStatusType_1739575108_hpp
...
namespace UMAA {
    namespace EO {
        namespace PowerControl {
            ...
            static const std::string PowerCommandStatus_TOPIC = "UMAA::EO::PowerControl::PowerCommandStatus";

            class NDDSUSERDllExport PowerCommandStatusType {
              public:
                PowerCommandStatusType();

                PowerCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                PowerCommandStatusType (PowerCommandStatusType&&) = default;
                PowerCommandStatusType& operator=(PowerCommandStatusType&&) = default;
                PowerCommandStatusType& operator=(const PowerCommandStatusType&) = default;
                PowerCommandStatusType(const PowerCommandStatusType&) = default;
                #else
                PowerCommandStatusType(PowerCommandStatusType&& other_) OMG_NOEXCEPT;  
                PowerCommandStatusType& operator=(PowerCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const PowerCommandStatusType& other_) const;
                bool operator != (const PowerCommandStatusType& other_) const;

                void swap(PowerCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(PowerCommandStatusType& a, PowerCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const PowerCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::PowerControl::PowerCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::PowerControl::PowerCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::PowerControl::PowerCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::PowerControl::PowerCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::PowerControl::PowerCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::PowerControl::PowerCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::PowerControl::PowerCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::PowerControl::PowerCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::PowerControl::PowerCommandStatusType > {
...
#endif // PowerCommandStatusType_1739575108_hpp
