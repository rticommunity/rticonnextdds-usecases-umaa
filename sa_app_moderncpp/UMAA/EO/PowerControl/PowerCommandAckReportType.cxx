...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PowerControl {
            ...
            PowerCommandAckReportType::PowerCommandAckReportType (const std::string& identification,const UMAA::Common::MaritimeEnumeration::IgnitionStateEnumType::IgnitionStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_identification_( identification ),
                m_state_( state ),
                m_source_( source ),
            ...
            PowerCommandAckReportType::PowerCommandAckReportType(PowerCommandAckReportType&& other_) OMG_NOEXCEPT  :m_identification_ (std::move(other_.m_identification_))
            ,
            ...
            PowerCommandAckReportType& PowerCommandAckReportType::operator=(PowerCommandAckReportType&&  other_) OMG_NOEXCEPT {
                PowerCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PowerCommandAckReportType::swap(PowerCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
