...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace GongControl {
            ...
            GongControlCommandReportType::GongControlCommandReportType(GongControlCommandReportType&& other_) OMG_NOEXCEPT  :m_blastProperties_ (std::move(other_.m_blastProperties_))
            ,
            ...
            GongControlCommandReportType& GongControlCommandReportType::operator=(GongControlCommandReportType&&  other_) OMG_NOEXCEPT {
                GongControlCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GongControlCommandReportType::swap(GongControlCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
