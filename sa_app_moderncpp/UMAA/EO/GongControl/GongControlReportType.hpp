...
#ifndef GongControlReportType_252200848_hpp
#define GongControlReportType_252200848_hpp
...
namespace UMAA {
    namespace EO {
        namespace GongControl {
            ...
            static const std::string GongControlReport_TOPIC = "UMAA::EO::GongControl::GongControlReport";

            class NDDSUSERDllExport GongControlReportType {
              public:
                GongControlReportType();

                GongControlReportType(const ::dds::core::optional< UMAA::Common::MaritimeEnumeration::BlastConditionEnumType::BlastConditionEnumType >& blastCondition,const ::dds::core::optional< double >& blastNumber,const UMAA::Common::Enumeration::OnOffStatusEnumType::OnOffStatusEnumType& status,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GongControlReportType (GongControlReportType&&) = default;
                GongControlReportType& operator=(GongControlReportType&&) = default;
                GongControlReportType& operator=(const GongControlReportType&) = default;
                GongControlReportType(const GongControlReportType&) = default;
                #else
                GongControlReportType(GongControlReportType&& other_) OMG_NOEXCEPT;  
                GongControlReportType& operator=(GongControlReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GongControlReportType& other_) const;
                bool operator != (const GongControlReportType& other_) const;

                void swap(GongControlReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GongControlReportType& a, GongControlReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GongControlReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::GongControl::GongControlReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::GongControl::GongControlReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::GongControl::GongControlReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::GongControl::GongControlReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::GongControl::GongControlReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::GongControl::GongControlReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::GongControl::GongControlReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::GongControl::GongControlReportType > {
        ...
        template <>
        struct extensibility< UMAA::EO::GongControl::GongControlReportType > {
...
#endif // GongControlReportType_252200848_hpp
