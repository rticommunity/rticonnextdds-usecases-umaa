...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace GongControl {
            ...
            GongControlReportType::GongControlReportType(GongControlReportType&& other_) OMG_NOEXCEPT  :m_blastCondition_ (std::move(other_.m_blastCondition_))
            ,
            ...
            GongControlReportType& GongControlReportType::operator=(GongControlReportType&&  other_) OMG_NOEXCEPT {
                GongControlReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GongControlReportType::swap(GongControlReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
