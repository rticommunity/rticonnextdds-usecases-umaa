...
namespace UMAA {
    namespace EO {
        namespace PropulsorControl {
            ...
            static const std::string PropulsorCommandAckReport_TOPIC = "UMAA::EO::PropulsorControl::PropulsorCommandAckReport";

            class NDDSUSERDllExport PropulsorCommandAckReportType {
              public:
                PropulsorCommandAckReportType();

                PropulsorCommandAckReportType(const UMAA::Common::Propulsion::PropulsionType& propulsion,const UMAA::Common::Propulsion::PropulsionRotationType& rotation,double thrustPitch,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                PropulsorCommandAckReportType (PropulsorCommandAckReportType&&) = default;
                PropulsorCommandAckReportType& operator=(PropulsorCommandAckReportType&&) = default;
                PropulsorCommandAckReportType& operator=(const PropulsorCommandAckReportType&) = default;
                PropulsorCommandAckReportType(const PropulsorCommandAckReportType&) = default;
                #else
                PropulsorCommandAckReportType(PropulsorCommandAckReportType&& other_) OMG_NOEXCEPT;  
                PropulsorCommandAckReportType& operator=(PropulsorCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                UMAA::Common::Propulsion::PropulsionRotationType& rotation() OMG_NOEXCEPT {
                    return m_rotation_;
                }

                const UMAA::Common::Propulsion::PropulsionRotationType& rotation() const OMG_NOEXCEPT {
                    return m_rotation_;
                }
                ...
                double& thrustPitch() OMG_NOEXCEPT {
                    return m_thrustPitch_;
                }

                const double& thrustPitch() const OMG_NOEXCEPT {
                    return m_thrustPitch_;
                }
                ...
                void swap(PropulsorCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(PropulsorCommandAckReportType& a, PropulsorCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
