...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PropulsorControl {
            ...
            PropulsorCommandAckReportType::PropulsorCommandAckReportType (const UMAA::Common::Propulsion::PropulsionType& propulsion,const UMAA::Common::Propulsion::PropulsionRotationType& rotation,double thrustPitch,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            PropulsorCommandAckReportType::PropulsorCommandAckReportType(PropulsorCommandAckReportType&& other_) OMG_NOEXCEPT  :m_propulsion_ (std::move(other_.m_propulsion_))
            ,
            ...
            PropulsorCommandAckReportType& PropulsorCommandAckReportType::operator=(PropulsorCommandAckReportType&&  other_) OMG_NOEXCEPT {
                PropulsorCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PropulsorCommandAckReportType::swap(PropulsorCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
