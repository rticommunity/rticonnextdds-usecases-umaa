...
#ifndef BellControlCommandStatusType_724486493_hpp
#define BellControlCommandStatusType_724486493_hpp
...
namespace UMAA {
    namespace EO {
        namespace BellControl {
            ...
            static const std::string BellControlCommandStatus_TOPIC = "UMAA::EO::BellControl::BellControlCommandStatus";

            class NDDSUSERDllExport BellControlCommandStatusType {
              public:
                ...
                BellControlCommandStatusType (BellControlCommandStatusType&&) = default;
                BellControlCommandStatusType& operator=(BellControlCommandStatusType&&) = default;
                BellControlCommandStatusType& operator=(const BellControlCommandStatusType&) = default;
                BellControlCommandStatusType(const BellControlCommandStatusType&) = default;
                #else
                BellControlCommandStatusType(BellControlCommandStatusType&& other_) OMG_NOEXCEPT;  
                BellControlCommandStatusType& operator=(BellControlCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const BellControlCommandStatusType& other_) const;
                bool operator != (const BellControlCommandStatusType& other_) const;

                void swap(BellControlCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BellControlCommandStatusType& a, BellControlCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BellControlCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::BellControl::BellControlCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::BellControl::BellControlCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::BellControl::BellControlCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::BellControl::BellControlCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::BellControl::BellControlCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::BellControl::BellControlCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::BellControl::BellControlCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::BellControl::BellControlCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::BellControl::BellControlCommandStatusType > {
...
#endif // BellControlCommandStatusType_724486493_hpp
