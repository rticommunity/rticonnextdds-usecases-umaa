...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BellControl {
            ...
            BellControlCommandReportType::BellControlCommandReportType(BellControlCommandReportType&& other_) OMG_NOEXCEPT  :m_blastProperties_ (std::move(other_.m_blastProperties_))
            ,
            ...
            BellControlCommandReportType& BellControlCommandReportType::operator=(BellControlCommandReportType&&  other_) OMG_NOEXCEPT {
                BellControlCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BellControlCommandReportType::swap(BellControlCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
