...
#ifndef BellControlReportType_1875897010_hpp
#define BellControlReportType_1875897010_hpp
...
namespace UMAA {
    namespace EO {
        namespace BellControl {
            ...
            static const std::string BellControlReport_TOPIC = "UMAA::EO::BellControl::BellControlReport";

            class NDDSUSERDllExport BellControlReportType {
              public:
                BellControlReportType();

                BellControlReportType(const ::dds::core::optional< UMAA::Common::MaritimeEnumeration::BlastConditionEnumType::BlastConditionEnumType >& blastCondition,const ::dds::core::optional< double >& blastNumber,const UMAA::Common::Enumeration::OnOffStatusEnumType::OnOffStatusEnumType& status,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BellControlReportType (BellControlReportType&&) = default;
                BellControlReportType& operator=(BellControlReportType&&) = default;
                BellControlReportType& operator=(const BellControlReportType&) = default;
                BellControlReportType(const BellControlReportType&) = default;
                #else
                BellControlReportType(BellControlReportType&& other_) OMG_NOEXCEPT;  
                BellControlReportType& operator=(BellControlReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const BellControlReportType& other_) const;
                bool operator != (const BellControlReportType& other_) const;

                void swap(BellControlReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BellControlReportType& a, BellControlReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BellControlReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::BellControl::BellControlReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::BellControl::BellControlReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::BellControl::BellControlReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::BellControl::BellControlReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::BellControl::BellControlReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::BellControl::BellControlReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::BellControl::BellControlReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::BellControl::BellControlReportType > {
        ...
        template <>
        struct extensibility< UMAA::EO::BellControl::BellControlReportType > {
...
#endif // BellControlReportType_1875897010_hpp
