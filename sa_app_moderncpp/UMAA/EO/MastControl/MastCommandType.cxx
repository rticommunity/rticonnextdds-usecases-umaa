...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace MastControl {
            ...
            MastCommandType::MastCommandType(MastCommandType&& other_) OMG_NOEXCEPT  :m_action_ (std::move(other_.m_action_))
            ,
            ...
            MastCommandType& MastCommandType::operator=(MastCommandType&&  other_) OMG_NOEXCEPT {
                MastCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MastCommandType::swap(MastCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::EO::MastControl::MastCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                MastCommandType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::MastActionEnumType::MastActionEnumType>::get().native();
                MastCommandType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                MastCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ...
                MastCommandType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
