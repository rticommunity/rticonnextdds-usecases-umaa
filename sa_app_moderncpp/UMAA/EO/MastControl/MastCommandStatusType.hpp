...
#ifndef MastCommandStatusType_375681895_hpp
#define MastCommandStatusType_375681895_hpp
...
namespace UMAA {
    namespace EO {
        namespace MastControl {
            ...
            static const std::string MastCommandStatus_TOPIC = "UMAA::EO::MastControl::MastCommandStatus";

            class NDDSUSERDllExport MastCommandStatusType {
              public:
                ...
                MastCommandStatusType (MastCommandStatusType&&) = default;
                MastCommandStatusType& operator=(MastCommandStatusType&&) = default;
                MastCommandStatusType& operator=(const MastCommandStatusType&) = default;
                MastCommandStatusType(const MastCommandStatusType&) = default;
                #else
                MastCommandStatusType(MastCommandStatusType&& other_) OMG_NOEXCEPT;  
                MastCommandStatusType& operator=(MastCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const MastCommandStatusType& other_) const;
                bool operator != (const MastCommandStatusType& other_) const;

                void swap(MastCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(MastCommandStatusType& a, MastCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const MastCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::MastControl::MastCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::MastControl::MastCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::MastControl::MastCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::MastControl::MastCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::MastControl::MastCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::MastControl::MastCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::MastControl::MastCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::MastControl::MastCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::MastControl::MastCommandStatusType > {
...
#endif // MastCommandStatusType_375681895_hpp
