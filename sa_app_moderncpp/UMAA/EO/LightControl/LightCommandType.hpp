...
#ifndef LightCommandType_1591096658_hpp
#define LightCommandType_1591096658_hpp
...
namespace UMAA {
    namespace EO {
        namespace LightControl {
            ...
            static const std::string LightCommand_TOPIC = "UMAA::EO::LightControl::LightCommand";

            class NDDSUSERDllExport LightCommandType {
              public:
                LightCommandType();

                LightCommandType(bool allroundLight,bool flashingLight,bool mastheadLight,bool portSideLight,bool starboardSideLight,bool sternLight,bool towingLight,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LightCommandType (LightCommandType&&) = default;
                LightCommandType& operator=(LightCommandType&&) = default;
                LightCommandType& operator=(const LightCommandType&) = default;
                LightCommandType(const LightCommandType&) = default;
                #else
                LightCommandType(LightCommandType&& other_) OMG_NOEXCEPT;  
                LightCommandType& operator=(LightCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LightCommandType& other_) const;
                bool operator != (const LightCommandType& other_) const;

                void swap(LightCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LightCommandType& a, LightCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LightCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::LightControl::LightCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::LightControl::LightCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::LightControl::LightCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::LightControl::LightCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::LightControl::LightCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::LightControl::LightCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::LightControl::LightCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::LightControl::LightCommandType > {
        ...
        template <>
        struct extensibility< UMAA::EO::LightControl::LightCommandType > {
...
#endif // LightCommandType_1591096658_hpp
