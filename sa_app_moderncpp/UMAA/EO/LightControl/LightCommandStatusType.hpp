...
#ifndef LightCommandStatusType_1555011253_hpp
#define LightCommandStatusType_1555011253_hpp
...
namespace UMAA {
    namespace EO {
        namespace LightControl {
            ...
            static const std::string LightCommandStatus_TOPIC = "UMAA::EO::LightControl::LightCommandStatus";

            class NDDSUSERDllExport LightCommandStatusType {
              public:
                LightCommandStatusType();

                LightCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LightCommandStatusType (LightCommandStatusType&&) = default;
                LightCommandStatusType& operator=(LightCommandStatusType&&) = default;
                LightCommandStatusType& operator=(const LightCommandStatusType&) = default;
                LightCommandStatusType(const LightCommandStatusType&) = default;
                #else
                LightCommandStatusType(LightCommandStatusType&& other_) OMG_NOEXCEPT;  
                LightCommandStatusType& operator=(LightCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LightCommandStatusType& other_) const;
                bool operator != (const LightCommandStatusType& other_) const;

                void swap(LightCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LightCommandStatusType& a, LightCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LightCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::LightControl::LightCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::LightControl::LightCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::LightControl::LightCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::LightControl::LightCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::LightControl::LightCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::LightControl::LightCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::LightControl::LightCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::LightControl::LightCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::LightControl::LightCommandStatusType > {
...
#endif // LightCommandStatusType_1555011253_hpp
