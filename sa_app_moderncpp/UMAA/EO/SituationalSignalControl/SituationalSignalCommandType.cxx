...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace SituationalSignalControl {
            ...
            SituationalSignalCommandType::SituationalSignalCommandType(SituationalSignalCommandType&& other_) OMG_NOEXCEPT  :m_agreeToBeOvertaken_ (std::move(other_.m_agreeToBeOvertaken_))
            ,
            ...
            SituationalSignalCommandType& SituationalSignalCommandType::operator=(SituationalSignalCommandType&&  other_) OMG_NOEXCEPT {
                SituationalSignalCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SituationalSignalCommandType::swap(SituationalSignalCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
