...
namespace UMAA {
    namespace EO {
        namespace SituationalSignalControl {
            ...
            static const std::string SituationalSignalCommandAckReport_TOPIC = "UMAA::EO::SituationalSignalControl::SituationalSignalCommandAckReport";

            class NDDSUSERDllExport SituationalSignalCommandAckReportType {
              public:
                SituationalSignalCommandAckReportType();

                SituationalSignalCommandAckReportType(bool agreeToBeOvertaken,bool alteringCourseToPort,bool alteringCourseToStarboard,bool engagedInMineClearanceOperations,bool inDistressNeedAssistance,bool inSightCollisionWarning,bool maneuverabilityRestricted,bool operatingAsternPropulsion,bool outOfSightCollisionWarning,bool toOvertakeOnPortSide,bool toOvertakeOnstarboardSide,bool towingAndPushingAlongsideOrAhead,bool towingAndPushingBehind,bool vesselAground,bool vesselAnchored,bool vesselBeingPushed,bool vesselBeingTowedAlongside,bool vesselBeingTowedBehind,bool vesselConstrainedByHerDraft,bool vesselLeavingDock,bool vesselNotUnderControl,bool vesselStopped,bool vesselUnderWay,bool visibilityRestricted,bool visibilityRestrictedStopped,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                SituationalSignalCommandAckReportType (SituationalSignalCommandAckReportType&&) = default;
                SituationalSignalCommandAckReportType& operator=(SituationalSignalCommandAckReportType&&) = default;
                SituationalSignalCommandAckReportType& operator=(const SituationalSignalCommandAckReportType&) = default;
                SituationalSignalCommandAckReportType(const SituationalSignalCommandAckReportType&) = default;
                #else
                SituationalSignalCommandAckReportType(SituationalSignalCommandAckReportType&& other_) OMG_NOEXCEPT;  
                SituationalSignalCommandAckReportType& operator=(SituationalSignalCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(SituationalSignalCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(SituationalSignalCommandAckReportType& a, SituationalSignalCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
