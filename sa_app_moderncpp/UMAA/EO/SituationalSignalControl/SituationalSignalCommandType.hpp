...
#ifndef SituationalSignalCommandType_749721745_hpp
#define SituationalSignalCommandType_749721745_hpp
...
namespace UMAA {
    namespace EO {
        namespace SituationalSignalControl {
            ...
            static const std::string SituationalSignalCommand_TOPIC = "UMAA::EO::SituationalSignalControl::SituationalSignalCommand";

            class NDDSUSERDllExport SituationalSignalCommandType {
              public:
                SituationalSignalCommandType();

                SituationalSignalCommandType(bool agreeToBeOvertaken,bool alteringCourseToPort,bool alteringCourseToStarboard,bool engagedInMineClearanceOperations,bool inDistressNeedAssistance,bool inSightCollisionWarning,bool maneuverabilityRestricted,bool operatingAsternPropulsion,bool outOfSightCollisionWarning,bool toOvertakeOnPortSide,bool toOvertakeOnstarboardSide,bool towingAndPushingAlongsideOrAhead,bool towingAndPushingBehind,bool vesselAground,bool vesselAnchored,bool vesselBeingPushed,bool vesselBeingTowedAlongside,bool vesselBeingTowedBehind,bool vesselConstrainedByHerDraft,bool vesselLeavingDock,bool vesselNotUnderControl,bool vesselStopped,bool vesselUnderWay,bool visibilityRestricted,bool visibilityRestrictedStopped,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                SituationalSignalCommandType (SituationalSignalCommandType&&) = default;
                SituationalSignalCommandType& operator=(SituationalSignalCommandType&&) = default;
                SituationalSignalCommandType& operator=(const SituationalSignalCommandType&) = default;
                SituationalSignalCommandType(const SituationalSignalCommandType&) = default;
                #else
                SituationalSignalCommandType(SituationalSignalCommandType&& other_) OMG_NOEXCEPT;  
                SituationalSignalCommandType& operator=(SituationalSignalCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const SituationalSignalCommandType& other_) const;
                bool operator != (const SituationalSignalCommandType& other_) const;

                void swap(SituationalSignalCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(SituationalSignalCommandType& a, SituationalSignalCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const SituationalSignalCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::SituationalSignalControl::SituationalSignalCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::SituationalSignalControl::SituationalSignalCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::SituationalSignalControl::SituationalSignalCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::SituationalSignalControl::SituationalSignalCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::SituationalSignalControl::SituationalSignalCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::SituationalSignalControl::SituationalSignalCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::SituationalSignalControl::SituationalSignalCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::SituationalSignalControl::SituationalSignalCommandType > {
        ...
        template <>
        struct extensibility< UMAA::EO::SituationalSignalControl::SituationalSignalCommandType > {
...
#endif // SituationalSignalCommandType_749721745_hpp
