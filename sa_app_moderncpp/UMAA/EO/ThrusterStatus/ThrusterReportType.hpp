...
namespace UMAA {
    namespace EO {
        namespace ThrusterStatus {
            ...
            static const std::string ThrusterReport_TOPIC = "UMAA::EO::ThrusterStatus::ThrusterReport";

            class NDDSUSERDllExport ThrusterReportType {
              public:
                ThrusterReportType();

                ThrusterReportType(const ::dds::core::optional< double >& effort,bool motorFault,const ::dds::core::optional< double >& RPM,const UMAA::Common::MaritimeEnumeration::PowerPlantStateEnumType::PowerPlantStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                ThrusterReportType (ThrusterReportType&&) = default;
                ThrusterReportType& operator=(ThrusterReportType&&) = default;
                ThrusterReportType& operator=(const ThrusterReportType&) = default;
                ThrusterReportType(const ThrusterReportType&) = default;
                #else
                ThrusterReportType(ThrusterReportType&& other_) OMG_NOEXCEPT;  
                ThrusterReportType& operator=(ThrusterReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                ::dds::core::optional< double >& effort() OMG_NOEXCEPT {
                    return m_effort_;
                }

                const ::dds::core::optional< double >& effort() const OMG_NOEXCEPT {
                    return m_effort_;
                }
                ...
                void swap(ThrusterReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ThrusterReportType& a, ThrusterReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
