...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PowerStatus {
            ...
            PowerReportType::PowerReportType (const std::string& name,const UMAA::Common::Measurement::NumericGUID& powerPlantID,const UMAA::Common::MaritimeEnumeration::PowerPlantStateEnumType::PowerPlantStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_name_( name ),
                m_powerPlantID_( powerPlantID ),
                m_state_( state ),
                m_source_( source ),
            ...
            PowerReportType::PowerReportType(PowerReportType&& other_) OMG_NOEXCEPT  :m_name_ (std::move(other_.m_name_))
            ,
            m_powerPlantID_ (std::move(other_.m_powerPlantID_))
            ,
            ...
            PowerReportType& PowerReportType::operator=(PowerReportType&&  other_) OMG_NOEXCEPT {
                PowerReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PowerReportType::swap(PowerReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
