...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace ThrusterControl {
            ...
            ThrusterCommandAckReportType::ThrusterCommandAckReportType (const UMAA::EO::ThrusterControl::ThrusterControlType& thruster,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            ThrusterCommandAckReportType::ThrusterCommandAckReportType(ThrusterCommandAckReportType&& other_) OMG_NOEXCEPT  :m_thruster_ (std::move(other_.m_thruster_))
            ,
            ...
            ThrusterCommandAckReportType& ThrusterCommandAckReportType::operator=(ThrusterCommandAckReportType&&  other_) OMG_NOEXCEPT {
                ThrusterCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ThrusterCommandAckReportType::swap(ThrusterCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
