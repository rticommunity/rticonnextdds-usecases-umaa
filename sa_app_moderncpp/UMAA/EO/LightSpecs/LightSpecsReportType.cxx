...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace LightSpecs {
            ...
            LightSpecsReportType::LightSpecsReportType (bool allroundLight,bool flashingLight,bool mastheadLight,bool portSideLight,bool starboardSideLight,bool sternLight,bool towingLight,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            LightSpecsReportType::LightSpecsReportType(LightSpecsReportType&& other_) OMG_NOEXCEPT  :m_allroundLight_ (std::move(other_.m_allroundLight_))
            ,
            ...
            LightSpecsReportType& LightSpecsReportType::operator=(LightSpecsReportType&&  other_) OMG_NOEXCEPT {
                LightSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LightSpecsReportType::swap(LightSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
