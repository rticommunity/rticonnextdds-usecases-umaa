...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace GeneratorSpecs {
            ...
            GeneratorSpecsReportType::GeneratorSpecsReportType (double maxCurrent,double maxPower,const std::string& name,double ratedPower,double ratedVoltage,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_maxCurrent_( maxCurrent ),
                m_maxPower_( maxPower ),
                m_name_( name ),
                m_ratedPower_( ratedPower ),
                m_ratedVoltage_( ratedVoltage ),
                m_source_( source ),
            ...
            GeneratorSpecsReportType::GeneratorSpecsReportType(GeneratorSpecsReportType&& other_) OMG_NOEXCEPT  :m_maxCurrent_ (std::move(other_.m_maxCurrent_))
            ,
            m_maxPower_ (std::move(other_.m_maxPower_))
            ,
            m_name_ (std::move(other_.m_name_))
            ,
            m_ratedPower_ (std::move(other_.m_ratedPower_))
            ,
            m_ratedVoltage_ (std::move(other_.m_ratedVoltage_))
            ,
            ...
            GeneratorSpecsReportType& GeneratorSpecsReportType::operator=(GeneratorSpecsReportType&&  other_) OMG_NOEXCEPT {
                GeneratorSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GeneratorSpecsReportType::swap(GeneratorSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool GeneratorSpecsReportType::operator == (const GeneratorSpecsReportType& other_) const {
                if (m_maxCurrent_ != other_.m_maxCurrent_) {
                    return false;
                }
                if (m_maxPower_ != other_.m_maxPower_) {
                    return false;
                }
                if (m_name_ != other_.m_name_) {
                    return false;
                }
                if (m_ratedPower_ != other_.m_ratedPower_) {
                    return false;
                }
                if (m_ratedVoltage_ != other_.m_ratedVoltage_) {
                    return false;
                }
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::EO::GeneratorSpecs::GeneratorSpecsReportType > {
            static DDS_TypeCode * get()
            {
                ...
                GeneratorSpecsReportType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GeneratorSpecsReportType_g_tc_members[6]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                GeneratorSpecsReportType_g_tc_members[0]._annotations._minValue._u.double_value = -100000LL;
                GeneratorSpecsReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GeneratorSpecsReportType_g_tc_members[0]._annotations._maxValue._u.double_value = 100000ULL;
                ...
                GeneratorSpecsReportType_g_tc_members[1]._annotations._minValue._u.double_value = 0ULL;
                GeneratorSpecsReportType_g_tc_members[1]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GeneratorSpecsReportType_g_tc_members[1]._annotations._maxValue._u.double_value = 100000000ULL;
                ...
                GeneratorSpecsReportType_g_tc_members[3]._annotations._minValue._u.double_value = 0ULL;
                GeneratorSpecsReportType_g_tc_members[3]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GeneratorSpecsReportType_g_tc_members[3]._annotations._maxValue._u.double_value = 100000000ULL;
                ...
                GeneratorSpecsReportType_g_tc_members[4]._annotations._minValue._u.double_value = -100000LL;
                GeneratorSpecsReportType_g_tc_members[4]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GeneratorSpecsReportType_g_tc_members[4]._annotations._maxValue._u.double_value = 100000ULL;
