...
#ifndef GeneratorSpecsReportType_1933929472_hpp
#define GeneratorSpecsReportType_1933929472_hpp
...
namespace UMAA {
    namespace EO {
        namespace GeneratorSpecs {
            ...
            static const std::string GeneratorSpecsReport_TOPIC = "UMAA::EO::GeneratorSpecs::GeneratorSpecsReport";

            class NDDSUSERDllExport GeneratorSpecsReportType {
              public:
                GeneratorSpecsReportType();

                GeneratorSpecsReportType(double maxCurrent,double maxPower,const std::string& name,double ratedPower,double ratedVoltage,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GeneratorSpecsReportType (GeneratorSpecsReportType&&) = default;
                GeneratorSpecsReportType& operator=(GeneratorSpecsReportType&&) = default;
                GeneratorSpecsReportType& operator=(const GeneratorSpecsReportType&) = default;
                GeneratorSpecsReportType(const GeneratorSpecsReportType&) = default;
                #else
                GeneratorSpecsReportType(GeneratorSpecsReportType&& other_) OMG_NOEXCEPT;  
                GeneratorSpecsReportType& operator=(GeneratorSpecsReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                double& maxCurrent() OMG_NOEXCEPT {
                    return m_maxCurrent_;
                }

                const double& maxCurrent() const OMG_NOEXCEPT {
                    return m_maxCurrent_;
                }
                ...
                double& maxPower() OMG_NOEXCEPT {
                    return m_maxPower_;
                }

                const double& maxPower() const OMG_NOEXCEPT {
                    return m_maxPower_;
                }
                ...
                double& ratedPower() OMG_NOEXCEPT {
                    return m_ratedPower_;
                }

                const double& ratedPower() const OMG_NOEXCEPT {
                    return m_ratedPower_;
                }
                ...
                double& ratedVoltage() OMG_NOEXCEPT {
                    return m_ratedVoltage_;
                }

                const double& ratedVoltage() const OMG_NOEXCEPT {
                    return m_ratedVoltage_;
                }
                ...
                void swap(GeneratorSpecsReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GeneratorSpecsReportType& a, GeneratorSpecsReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
...
#endif // GeneratorSpecsReportType_1933929472_hpp
