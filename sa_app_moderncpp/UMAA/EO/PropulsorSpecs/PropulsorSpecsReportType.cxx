...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PropulsorSpecs {
            ...
            PropulsorSpecsReportType::PropulsorSpecsReportType(PropulsorSpecsReportType&& other_) OMG_NOEXCEPT  :m_bearingMax_ (std::move(other_.m_bearingMax_))
            ,
            m_bearingMin_ (std::move(other_.m_bearingMin_))
            ,
            m_bearingOffset_ (std::move(other_.m_bearingOffset_))
            ,
            m_maxReverseRPM_ (std::move(other_.m_maxReverseRPM_))
            ,
            m_maxRPM_ (std::move(other_.m_maxRPM_))
            ,
            m_minReverseRPM_ (std::move(other_.m_minReverseRPM_))
            ,
            m_minRPM_ (std::move(other_.m_minRPM_))
            ,
            m_mountType_ (std::move(other_.m_mountType_))
            ,
            m_name_ (std::move(other_.m_name_))
            ,
            m_OnOffSwitchable_ (std::move(other_.m_OnOffSwitchable_))
            ,
            m_pitchMax_ (std::move(other_.m_pitchMax_))
            ,
            m_pitchMin_ (std::move(other_.m_pitchMin_))
            ,
            m_pitchOffset_ (std::move(other_.m_pitchOffset_))
            ,
            m_positionOffset_ (std::move(other_.m_positionOffset_))
            ,
            m_reversible_ (std::move(other_.m_reversible_))
            ,
            m_thrustControl_ (std::move(other_.m_thrustControl_))
            ,
            ...
            PropulsorSpecsReportType& PropulsorSpecsReportType::operator=(PropulsorSpecsReportType&&  other_) OMG_NOEXCEPT {
                PropulsorSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PropulsorSpecsReportType::swap(PropulsorSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool PropulsorSpecsReportType::operator == (const PropulsorSpecsReportType& other_) const {
                if (m_bearingMax_ != other_.m_bearingMax_) {
                    return false;
                }
                if (m_bearingMin_ != other_.m_bearingMin_) {
                    return false;
                }
                if (m_bearingOffset_ != other_.m_bearingOffset_) {
                    return false;
                }
                if (m_maxReverseRPM_ != other_.m_maxReverseRPM_) {
                    return false;
                }
                if (m_maxRPM_ != other_.m_maxRPM_) {
                    return false;
                }
                if (m_minReverseRPM_ != other_.m_minReverseRPM_) {
                    return false;
                }
                if (m_minRPM_ != other_.m_minRPM_) {
                    return false;
                }
                ...
                if (m_pitchMax_ != other_.m_pitchMax_) {
                    return false;
                }
                if (m_pitchMin_ != other_.m_pitchMin_) {
                    return false;
                }
                if (m_pitchOffset_ != other_.m_pitchOffset_) {
                    return false;
                }
