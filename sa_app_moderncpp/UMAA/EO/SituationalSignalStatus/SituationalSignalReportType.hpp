...
#ifndef SituationalSignalReportType_756700998_hpp
#define SituationalSignalReportType_756700998_hpp
...
namespace UMAA {
    namespace EO {
        namespace SituationalSignalStatus {
            ...
            static const std::string SituationalSignalReport_TOPIC = "UMAA::EO::SituationalSignalStatus::SituationalSignalReport";

            class NDDSUSERDllExport SituationalSignalReportType {
              public:
                ...
                SituationalSignalReportType (SituationalSignalReportType&&) = default;
                SituationalSignalReportType& operator=(SituationalSignalReportType&&) = default;
                SituationalSignalReportType& operator=(const SituationalSignalReportType&) = default;
                SituationalSignalReportType(const SituationalSignalReportType&) = default;
                #else
                SituationalSignalReportType(SituationalSignalReportType&& other_) OMG_NOEXCEPT;  
                SituationalSignalReportType& operator=(SituationalSignalReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const SituationalSignalReportType& other_) const;
                bool operator != (const SituationalSignalReportType& other_) const;

                void swap(SituationalSignalReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(SituationalSignalReportType& a, SituationalSignalReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const SituationalSignalReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::SituationalSignalStatus::SituationalSignalReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::SituationalSignalStatus::SituationalSignalReportType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::SituationalSignalStatus::SituationalSignalReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::SituationalSignalStatus::SituationalSignalReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::SituationalSignalStatus::SituationalSignalReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::SituationalSignalStatus::SituationalSignalReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::SituationalSignalStatus::SituationalSignalReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::SituationalSignalStatus::SituationalSignalReportType > {
        ...
        template <>
        struct extensibility< UMAA::EO::SituationalSignalStatus::SituationalSignalReportType > {
...
#endif // SituationalSignalReportType_756700998_hpp
