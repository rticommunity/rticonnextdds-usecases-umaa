...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace AnchorStatus {
            ...
            AnchorReportType::AnchorReportType (double rodeLengthPaidOut,const UMAA::Common::MaritimeEnumeration::AnchorStateEnumType::AnchorStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_rodeLengthPaidOut_( rodeLengthPaidOut ),
                m_state_( state ),
                m_source_( source ),
            ...
            AnchorReportType::AnchorReportType(AnchorReportType&& other_) OMG_NOEXCEPT  :m_rodeLengthPaidOut_ (std::move(other_.m_rodeLengthPaidOut_))
            ,
            ...
            AnchorReportType& AnchorReportType::operator=(AnchorReportType&&  other_) OMG_NOEXCEPT {
                AnchorReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AnchorReportType::swap(AnchorReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool AnchorReportType::operator == (const AnchorReportType& other_) const {
                if (m_rodeLengthPaidOut_ != other_.m_rodeLengthPaidOut_) {
                    return false;
                }
