    ...
    namespace EO {
        ...
        namespace WhistleControl {
            ...
            WhistleControlCommandType::WhistleControlCommandType (const UMAA::Common::Enumeration::OnOffStatusEnumType::OnOffStatusEnumType& status,const ::dds::core::optional< UMAA::Common::Propulsion::WhistlePropertiesType >& whistleProperties,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_status_( status ),
                m_whistleProperties_( whistleProperties ),
                m_source_( source ),
            ...
            WhistleControlCommandType::WhistleControlCommandType(WhistleControlCommandType&& other_) OMG_NOEXCEPT  :m_status_ (std::move(other_.m_status_))
            ,
            m_whistleProperties_ (std::move(other_.m_whistleProperties_))
            ,
            ...
            WhistleControlCommandType& WhistleControlCommandType::operator=(WhistleControlCommandType&&  other_) OMG_NOEXCEPT {
                WhistleControlCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WhistleControlCommandType::swap(WhistleControlCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
