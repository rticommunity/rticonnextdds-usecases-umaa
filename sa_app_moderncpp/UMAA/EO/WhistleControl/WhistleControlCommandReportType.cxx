...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace WhistleControl {
            ...
            WhistleControlCommandReportType::WhistleControlCommandReportType (const UMAA::Common::Enumeration::OnOffStatusEnumType::OnOffStatusEnumType& status,const ::dds::core::optional< UMAA::Common::Propulsion::WhistlePropertiesType >& whistleProperties,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_status_( status ),
            ...
            WhistleControlCommandReportType::WhistleControlCommandReportType(WhistleControlCommandReportType&& other_) OMG_NOEXCEPT  :m_status_ (std::move(other_.m_status_))
            ,
            ...
            WhistleControlCommandReportType& WhistleControlCommandReportType::operator=(WhistleControlCommandReportType&&  other_) OMG_NOEXCEPT {
                WhistleControlCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WhistleControlCommandReportType::swap(WhistleControlCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
