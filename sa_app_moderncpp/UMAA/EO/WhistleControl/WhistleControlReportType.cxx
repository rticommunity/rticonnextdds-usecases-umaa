...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace WhistleControl {
            ...
            WhistleControlReportType::WhistleControlReportType(WhistleControlReportType&& other_) OMG_NOEXCEPT  :m_blastCondition_ (std::move(other_.m_blastCondition_))
            ,
            ...
            WhistleControlReportType& WhistleControlReportType::operator=(WhistleControlReportType&&  other_) OMG_NOEXCEPT {
                WhistleControlReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WhistleControlReportType::swap(WhistleControlReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
