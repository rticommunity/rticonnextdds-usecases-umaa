...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace FuelTankStatus {
            ...
            FuelTankReportType::FuelTankReportType (double fuelLevel,bool waterInFuel,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_fuelLevel_( fuelLevel ),
                m_waterInFuel_( waterInFuel ),
                m_source_( source ),
            ...
            FuelTankReportType::FuelTankReportType(FuelTankReportType&& other_) OMG_NOEXCEPT  :m_fuelLevel_ (std::move(other_.m_fuelLevel_))
            ,
            m_waterInFuel_ (std::move(other_.m_waterInFuel_))
            ,
            ...
            FuelTankReportType& FuelTankReportType::operator=(FuelTankReportType&&  other_) OMG_NOEXCEPT {
                FuelTankReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void FuelTankReportType::swap(FuelTankReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool FuelTankReportType::operator == (const FuelTankReportType& other_) const {
                if (m_fuelLevel_ != other_.m_fuelLevel_) {
                    return false;
                }
