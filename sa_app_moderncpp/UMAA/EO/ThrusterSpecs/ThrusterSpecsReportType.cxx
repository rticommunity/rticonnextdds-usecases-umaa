...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace ThrusterSpecs {
            ...
            ThrusterSpecsReportType::ThrusterSpecsReportType (const UMAA::EO::ThrusterSpecs::ThrusterSpecsType& thruster,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            ThrusterSpecsReportType::ThrusterSpecsReportType(ThrusterSpecsReportType&& other_) OMG_NOEXCEPT  :m_thruster_ (std::move(other_.m_thruster_))
            ,
            ...
            ThrusterSpecsReportType& ThrusterSpecsReportType::operator=(ThrusterSpecsReportType&&  other_) OMG_NOEXCEPT {
                ThrusterSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ThrusterSpecsReportType::swap(ThrusterSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
