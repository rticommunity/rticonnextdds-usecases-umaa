...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace GeneratorStatus {
            ...
            GeneratorReportType::GeneratorReportType (double current,const UMAA::Common::MaritimeEnumeration::PowerPlantStateEnumType::PowerPlantStateEnumType& state,double voltage,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_current_( current ),
                m_state_( state ),
                m_voltage_( voltage ),
                m_source_( source ),
            ...
            GeneratorReportType::GeneratorReportType(GeneratorReportType&& other_) OMG_NOEXCEPT  :m_current_ (std::move(other_.m_current_))
            ,
            ...
            GeneratorReportType& GeneratorReportType::operator=(GeneratorReportType&&  other_) OMG_NOEXCEPT {
                GeneratorReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GeneratorReportType::swap(GeneratorReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
