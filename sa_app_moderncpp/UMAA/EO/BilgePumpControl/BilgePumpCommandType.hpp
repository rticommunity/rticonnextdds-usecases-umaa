...
namespace UMAA {
    namespace EO {
        namespace BilgePumpControl {
            ...
            static const std::string BilgePumpCommand_TOPIC = "UMAA::EO::BilgePumpControl::BilgePumpCommand";

            class NDDSUSERDllExport BilgePumpCommandType {
              public:
                BilgePumpCommandType();

                BilgePumpCommandType(const UMAA::Common::MaritimeEnumeration::BilgeControlEnumType::BilgeControlEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BilgePumpCommandType (BilgePumpCommandType&&) = default;
                BilgePumpCommandType& operator=(BilgePumpCommandType&&) = default;
                BilgePumpCommandType& operator=(const BilgePumpCommandType&) = default;
                BilgePumpCommandType(const BilgePumpCommandType&) = default;
                #else
                BilgePumpCommandType(BilgePumpCommandType&& other_) OMG_NOEXCEPT;  
                BilgePumpCommandType& operator=(BilgePumpCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(BilgePumpCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BilgePumpCommandType& a, BilgePumpCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
