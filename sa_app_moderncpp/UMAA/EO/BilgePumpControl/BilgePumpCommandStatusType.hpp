...
#ifndef BilgePumpCommandStatusType_807487582_hpp
#define BilgePumpCommandStatusType_807487582_hpp
...
namespace UMAA {
    namespace EO {
        namespace BilgePumpControl {
            ...
            static const std::string BilgePumpCommandStatus_TOPIC = "UMAA::EO::BilgePumpControl::BilgePumpCommandStatus";

            class NDDSUSERDllExport BilgePumpCommandStatusType {
              public:
                ...
                BilgePumpCommandStatusType (BilgePumpCommandStatusType&&) = default;
                BilgePumpCommandStatusType& operator=(BilgePumpCommandStatusType&&) = default;
                BilgePumpCommandStatusType& operator=(const BilgePumpCommandStatusType&) = default;
                BilgePumpCommandStatusType(const BilgePumpCommandStatusType&) = default;
                #else
                BilgePumpCommandStatusType(BilgePumpCommandStatusType&& other_) OMG_NOEXCEPT;  
                BilgePumpCommandStatusType& operator=(BilgePumpCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const BilgePumpCommandStatusType& other_) const;
                bool operator != (const BilgePumpCommandStatusType& other_) const;

                void swap(BilgePumpCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BilgePumpCommandStatusType& a, BilgePumpCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BilgePumpCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::BilgePumpControl::BilgePumpCommandStatusType > {
...
#endif // BilgePumpCommandStatusType_807487582_hpp
