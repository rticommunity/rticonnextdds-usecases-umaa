    ...
    namespace EO {
        ...
        namespace EngineSpecs {
            ...
            EngineSpecsReportType::EngineSpecsReportType (const UMAA::Common::MaritimeEnumeration::EngineKindEnumType::EngineKindEnumType& engineKind,const ::dds::core::optional< double >& glowPlugTime,double maxCoolantLevel,double maxCoolantPressure,double maxCoolantTemp,double maxEngineTemp,const ::dds::core::optional< double >& maxGlowPlugTemp,double maxManifoldAirTemp,double maxManifoldPressure,double maxOilPressure,double maxOilTemp,double minCoolantLevel,double minOilLevel,const std::string& name,double oilCapacity,double reverseRPMLowerLimit,double reverseRPMMaxLimit,double reverseRPMUpperLimit,bool reversible,double RPMLowerLimit,double RPMMaxLimit,double RPMUpperLimit,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_engineKind_( engineKind ),
                m_glowPlugTime_( glowPlugTime ),
                m_maxCoolantLevel_( maxCoolantLevel ),
                m_maxCoolantPressure_( maxCoolantPressure ),
                m_maxCoolantTemp_( maxCoolantTemp ),
                m_maxEngineTemp_( maxEngineTemp ),
                m_maxGlowPlugTemp_( maxGlowPlugTemp ),
                m_maxManifoldAirTemp_( maxManifoldAirTemp ),
                m_maxManifoldPressure_( maxManifoldPressure ),
                m_maxOilPressure_( maxOilPressure ),
                m_maxOilTemp_( maxOilTemp ),
                m_minCoolantLevel_( minCoolantLevel ),
                m_minOilLevel_( minOilLevel ),
                m_name_( name ),
                m_oilCapacity_( oilCapacity ),
                m_reverseRPMLowerLimit_( reverseRPMLowerLimit ),
                m_reverseRPMMaxLimit_( reverseRPMMaxLimit ),
                m_reverseRPMUpperLimit_( reverseRPMUpperLimit ),
                m_reversible_( reversible ),
                m_RPMLowerLimit_( RPMLowerLimit ),
                m_RPMMaxLimit_( RPMMaxLimit ),
                m_RPMUpperLimit_( RPMUpperLimit ),
                m_source_( source ),
            ...
            EngineSpecsReportType::EngineSpecsReportType(EngineSpecsReportType&& other_) OMG_NOEXCEPT  :m_engineKind_ (std::move(other_.m_engineKind_))
            ,
            m_glowPlugTime_ (std::move(other_.m_glowPlugTime_))
            ,
            m_maxCoolantLevel_ (std::move(other_.m_maxCoolantLevel_))
            ,
            m_maxCoolantPressure_ (std::move(other_.m_maxCoolantPressure_))
            ,
            m_maxCoolantTemp_ (std::move(other_.m_maxCoolantTemp_))
            ,
            m_maxEngineTemp_ (std::move(other_.m_maxEngineTemp_))
            ,
            m_maxGlowPlugTemp_ (std::move(other_.m_maxGlowPlugTemp_))
            ,
            m_maxManifoldAirTemp_ (std::move(other_.m_maxManifoldAirTemp_))
            ,
            m_maxManifoldPressure_ (std::move(other_.m_maxManifoldPressure_))
            ,
            m_maxOilPressure_ (std::move(other_.m_maxOilPressure_))
            ,
            m_maxOilTemp_ (std::move(other_.m_maxOilTemp_))
            ,
            m_minCoolantLevel_ (std::move(other_.m_minCoolantLevel_))
            ,
            m_minOilLevel_ (std::move(other_.m_minOilLevel_))
            ,
            m_name_ (std::move(other_.m_name_))
            ,
            m_oilCapacity_ (std::move(other_.m_oilCapacity_))
            ,
            m_reverseRPMLowerLimit_ (std::move(other_.m_reverseRPMLowerLimit_))
            ,
            m_reverseRPMMaxLimit_ (std::move(other_.m_reverseRPMMaxLimit_))
            ,
            m_reverseRPMUpperLimit_ (std::move(other_.m_reverseRPMUpperLimit_))
            ,
            m_reversible_ (std::move(other_.m_reversible_))
            ,
            m_RPMLowerLimit_ (std::move(other_.m_RPMLowerLimit_))
            ,
            m_RPMMaxLimit_ (std::move(other_.m_RPMMaxLimit_))
            ,
            m_RPMUpperLimit_ (std::move(other_.m_RPMUpperLimit_))
            ,
            ...
            EngineSpecsReportType& EngineSpecsReportType::operator=(EngineSpecsReportType&&  other_) OMG_NOEXCEPT {
                EngineSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void EngineSpecsReportType::swap(EngineSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool EngineSpecsReportType::operator == (const EngineSpecsReportType& other_) const {
                ...
                if (m_glowPlugTime_ != other_.m_glowPlugTime_) {
                    return false;
                }
                if (m_maxCoolantLevel_ != other_.m_maxCoolantLevel_) {
                    return false;
                }
                if (m_maxCoolantPressure_ != other_.m_maxCoolantPressure_) {
                    return false;
                }
                if (m_maxCoolantTemp_ != other_.m_maxCoolantTemp_) {
                    return false;
                }
                if (m_maxEngineTemp_ != other_.m_maxEngineTemp_) {
                    return false;
                }
                if (m_maxGlowPlugTemp_ != other_.m_maxGlowPlugTemp_) {
                    return false;
                }
                if (m_maxManifoldAirTemp_ != other_.m_maxManifoldAirTemp_) {
                    return false;
                }
                if (m_maxManifoldPressure_ != other_.m_maxManifoldPressure_) {
                    return false;
                }
                if (m_maxOilPressure_ != other_.m_maxOilPressure_) {
                    return false;
                }
                if (m_maxOilTemp_ != other_.m_maxOilTemp_) {
                    return false;
                }
                if (m_minCoolantLevel_ != other_.m_minCoolantLevel_) {
                    return false;
                }
                if (m_minOilLevel_ != other_.m_minOilLevel_) {
                    return false;
                }
                if (m_name_ != other_.m_name_) {
                    return false;
                }
                if (m_oilCapacity_ != other_.m_oilCapacity_) {
                    return false;
                }
                if (m_reverseRPMLowerLimit_ != other_.m_reverseRPMLowerLimit_) {
                    return false;
                }
                if (m_reverseRPMMaxLimit_ != other_.m_reverseRPMMaxLimit_) {
                    return false;
                }
                if (m_reverseRPMUpperLimit_ != other_.m_reverseRPMUpperLimit_) {
                    return false;
                }
                if (m_reversible_ != other_.m_reversible_) {
                    return false;
                }
                if (m_RPMLowerLimit_ != other_.m_RPMLowerLimit_) {
                    return false;
                }
                if (m_RPMMaxLimit_ != other_.m_RPMMaxLimit_) {
                    return false;
                }
                if (m_RPMUpperLimit_ != other_.m_RPMUpperLimit_) {
                    return false;
                }
