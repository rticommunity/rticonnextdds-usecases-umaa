...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BilgePumpConfig {
            ...
            BilgePumpConfigReportType::BilgePumpConfigReportType (const std::string& name,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_name_( name ),
                m_source_( source ),
            ...
            BilgePumpConfigReportType::BilgePumpConfigReportType(BilgePumpConfigReportType&& other_) OMG_NOEXCEPT  :m_name_ (std::move(other_.m_name_))
            ,
            ...
            BilgePumpConfigReportType& BilgePumpConfigReportType::operator=(BilgePumpConfigReportType&&  other_) OMG_NOEXCEPT {
                BilgePumpConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BilgePumpConfigReportType::swap(BilgePumpConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
