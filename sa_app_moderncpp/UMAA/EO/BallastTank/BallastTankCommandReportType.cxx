...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastTankCommandReportType::BallastTankCommandReportType (const UMAA::EO::BallastTank::BallastFillType& ballastFill,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_ballastFill_( ballastFill ),
                m_source_( source ),
            ...
            BallastTankCommandReportType::BallastTankCommandReportType(BallastTankCommandReportType&& other_) OMG_NOEXCEPT  :m_ballastFill_ (std::move(other_.m_ballastFill_))
            ,
            ...
            BallastTankCommandReportType& BallastTankCommandReportType::operator=(BallastTankCommandReportType&&  other_) OMG_NOEXCEPT {
                BallastTankCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastTankCommandReportType::swap(BallastTankCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
