...
#ifndef BallastPumpCommandStatusType_481018830_hpp
#define BallastPumpCommandStatusType_481018830_hpp
...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            static const std::string BallastPumpCommandStatus_TOPIC = "UMAA::EO::BallastTank::BallastPumpCommandStatus";

            class NDDSUSERDllExport BallastPumpCommandStatusType {
              public:
                BallastPumpCommandStatusType();

                BallastPumpCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BallastPumpCommandStatusType (BallastPumpCommandStatusType&&) = default;
                BallastPumpCommandStatusType& operator=(BallastPumpCommandStatusType&&) = default;
                BallastPumpCommandStatusType& operator=(const BallastPumpCommandStatusType&) = default;
                BallastPumpCommandStatusType(const BallastPumpCommandStatusType&) = default;
                #else
                BallastPumpCommandStatusType(BallastPumpCommandStatusType&& other_) OMG_NOEXCEPT;  
                BallastPumpCommandStatusType& operator=(BallastPumpCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const BallastPumpCommandStatusType& other_) const;
                bool operator != (const BallastPumpCommandStatusType& other_) const;

                void swap(BallastPumpCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BallastPumpCommandStatusType& a, BallastPumpCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BallastPumpCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::BallastTank::BallastPumpCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::BallastTank::BallastPumpCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::BallastTank::BallastPumpCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::BallastTank::BallastPumpCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::BallastTank::BallastPumpCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::BallastTank::BallastPumpCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::BallastTank::BallastPumpCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::BallastTank::BallastPumpCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::BallastTank::BallastPumpCommandStatusType > {
...
#endif // BallastPumpCommandStatusType_481018830_hpp
