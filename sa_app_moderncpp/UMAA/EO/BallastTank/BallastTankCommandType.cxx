...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastTankCommandType::BallastTankCommandType (const UMAA::EO::BallastTank::BallastFillType& ballastFill,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            BallastTankCommandType::BallastTankCommandType(BallastTankCommandType&& other_) OMG_NOEXCEPT  :m_ballastFill_ (std::move(other_.m_ballastFill_))
            ,
            ...
            BallastTankCommandType& BallastTankCommandType::operator=(BallastTankCommandType&&  other_) OMG_NOEXCEPT {
                BallastTankCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastTankCommandType::swap(BallastTankCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
