    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            namespace BallastPumpFlowRateType_Specializations {
                ...
                BallastPumpFlowRateType_Union::BallastPumpFlowRateType_Union(BallastPumpFlowRateType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Selectors::MASSBALLASTFLOWRATETYPE_SELECT):
                            {  
                                MassBallastFlowRateType_data( std::move(other_.MassBallastFlowRateType_data()));
                        } break;
                        case (UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Selectors::VOLUMEBALLASTFLOWRATETYPE_SELECT):
                            {  
                                VolumeBallastFlowRateType_data( std::move(other_.VolumeBallastFlowRateType_data()));
                        } break;
                ...
                BallastPumpFlowRateType_Union& BallastPumpFlowRateType_Union::operator=(BallastPumpFlowRateType_Union&&  other_) OMG_NOEXCEPT {
                    BallastPumpFlowRateType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                BallastPumpFlowRateType_Union::Union_::Union_(const UMAA::EO::BallastTank::MassBallastFlowRateType& MassBallastFlowRateType_data,const UMAA::EO::BallastTank::VolumeBallastFlowRateType& VolumeBallastFlowRateType_data):
                    m_MassBallastFlowRateType_data_( MassBallastFlowRateType_data ),
                    m_VolumeBallastFlowRateType_data_( VolumeBallastFlowRateType_data ) {
                }
                ...
                void BallastPumpFlowRateType_Union::swap(BallastPumpFlowRateType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const BallastPumpFlowRateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Selectors::VOLUMEBALLASTFLOWRATETYPE_SELECT):
                            {  
                                o << "VolumeBallastFlowRateType_data: " << sample.VolumeBallastFlowRateType_data() ;        } break ;
            ...
            BallastPumpFlowRateType::BallastPumpFlowRateType (const UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Union& BallastPumpFlowRateType_subtypes):
                m_BallastPumpFlowRateType_subtypes_( BallastPumpFlowRateType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            BallastPumpFlowRateType::BallastPumpFlowRateType(BallastPumpFlowRateType&& other_) OMG_NOEXCEPT  :m_BallastPumpFlowRateType_subtypes_ (std::move(other_.m_BallastPumpFlowRateType_subtypes_))
            {
            } 

            BallastPumpFlowRateType& BallastPumpFlowRateType::operator=(BallastPumpFlowRateType&&  other_) OMG_NOEXCEPT {
                BallastPumpFlowRateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastPumpFlowRateType::swap(BallastPumpFlowRateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
