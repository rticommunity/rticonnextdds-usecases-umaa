...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            MassBallastFlowRateType::MassBallastFlowRateType (double massBallastFlowRate):
                m_massBallastFlowRate_( massBallastFlowRate ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            MassBallastFlowRateType::MassBallastFlowRateType(MassBallastFlowRateType&& other_) OMG_NOEXCEPT  :m_massBallastFlowRate_ (std::move(other_.m_massBallastFlowRate_))
            {
            } 

            MassBallastFlowRateType& MassBallastFlowRateType::operator=(MassBallastFlowRateType&&  other_) OMG_NOEXCEPT {
                MassBallastFlowRateType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void MassBallastFlowRateType::swap(MassBallastFlowRateType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool MassBallastFlowRateType::operator == (const MassBallastFlowRateType& other_) const {
                if (m_massBallastFlowRate_ != other_.m_massBallastFlowRate_) {
                    return false;
                }
                return true;
            }
