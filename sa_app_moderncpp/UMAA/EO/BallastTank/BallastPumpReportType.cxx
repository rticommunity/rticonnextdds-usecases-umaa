    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastPumpReportType::BallastPumpReportType() :
                m_state_(UMAA::Common::MaritimeEnumeration::PumpStateEnumType::PumpStateEnumType::FAULT)  {
                    ::rti::core::fill_array( 
                        m_source_, 
                        ::rti::topic::cdr::alias_helper< UMAA::Common::Measurement::NumericGUID::value_type >::default_value());
            }   

            BallastPumpReportType::BallastPumpReportType (const ::dds::core::optional< double >& massFillRate,const UMAA::Common::MaritimeEnumeration::PumpStateEnumType::PumpStateEnumType& state,const ::dds::core::optional< double >& volumeFlowRate,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_massFillRate_( massFillRate ),
                m_state_( state ),
                m_volumeFlowRate_( volumeFlowRate ),
                m_source_( source ),
            ...
            BallastPumpReportType::BallastPumpReportType(BallastPumpReportType&& other_) OMG_NOEXCEPT  :m_massFillRate_ (std::move(other_.m_massFillRate_))
            ,
            m_state_ (std::move(other_.m_state_))
            ,
            m_volumeFlowRate_ (std::move(other_.m_volumeFlowRate_))
            ,
            ...
            BallastPumpReportType& BallastPumpReportType::operator=(BallastPumpReportType&&  other_) OMG_NOEXCEPT {
                BallastPumpReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastPumpReportType::swap(BallastPumpReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool BallastPumpReportType::operator == (const BallastPumpReportType& other_) const {
                if (m_massFillRate_ != other_.m_massFillRate_) {
                    return false;
                }
                if (m_state_ != other_.m_state_) {
                    return false;
                }
                if (m_volumeFlowRate_ != other_.m_volumeFlowRate_) {
                    return false;
                }
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::EO::BallastTank::BallastPumpReportType > {
            static DDS_TypeCode * get()
            {
                ...
                BallastPumpReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::PumpStateEnumType::PumpStateEnumType>::get().native();
                ...
                BallastPumpReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                BallastPumpReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< UMAA::EO::BallastTank::BallastPumpReportType >::reset_sample(UMAA::EO::BallastTank::BallastPumpReportType& sample) 
        {
            ...
            sample.state(UMAA::Common::MaritimeEnumeration::PumpStateEnumType::PumpStateEnumType::FAULT);
