...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastTankSpecsReportType::BallastTankSpecsReportType (double massCapacity,const std::string& name,bool trimTank,double volumeCapacity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_massCapacity_( massCapacity ),
                m_name_( name ),
                m_trimTank_( trimTank ),
                m_volumeCapacity_( volumeCapacity ),
                m_source_( source ),
            ...
            BallastTankSpecsReportType::BallastTankSpecsReportType(BallastTankSpecsReportType&& other_) OMG_NOEXCEPT  :m_massCapacity_ (std::move(other_.m_massCapacity_))
            ,
            m_name_ (std::move(other_.m_name_))
            ,
            m_trimTank_ (std::move(other_.m_trimTank_))
            ,
            m_volumeCapacity_ (std::move(other_.m_volumeCapacity_))
            ,
            ...
            BallastTankSpecsReportType& BallastTankSpecsReportType::operator=(BallastTankSpecsReportType&&  other_) OMG_NOEXCEPT {
                BallastTankSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastTankSpecsReportType::swap(BallastTankSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool BallastTankSpecsReportType::operator == (const BallastTankSpecsReportType& other_) const {
                if (m_massCapacity_ != other_.m_massCapacity_) {
                    return false;
                }
                ...
                if (m_volumeCapacity_ != other_.m_volumeCapacity_) {
                    return false;
                }
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::EO::BallastTank::BallastTankSpecsReportType > {
            static DDS_TypeCode * get()
            {
                ...
                BallastTankSpecsReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::Volume_CubicMeter_AliasTag_t>::get().native();
                BallastTankSpecsReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                BallastTankSpecsReportType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                BallastTankSpecsReportType_g_tc_members[0]._annotations._minValue._u.double_value = 0ULL;
                BallastTankSpecsReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                BallastTankSpecsReportType_g_tc_members[0]._annotations._maxValue._u.double_value = 100000000ULL;
                ...
                BallastTankSpecsReportType_g_tc_members[3]._annotations._minValue._u.double_value = 0ULL;
                BallastTankSpecsReportType_g_tc_members[3]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                BallastTankSpecsReportType_g_tc_members[3]._annotations._maxValue._u.double_value = 1000ULL;
