...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            static const std::string BallastTankCommand_TOPIC = "UMAA::EO::BallastTank::BallastTankCommand";

            class NDDSUSERDllExport BallastTankCommandType {
              public:
                BallastTankCommandType();

                BallastTankCommandType(const UMAA::EO::BallastTank::BallastFillType& ballastFill,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BallastTankCommandType (BallastTankCommandType&&) = default;
                BallastTankCommandType& operator=(BallastTankCommandType&&) = default;
                BallastTankCommandType& operator=(const BallastTankCommandType&) = default;
                BallastTankCommandType(const BallastTankCommandType&) = default;
                #else
                BallastTankCommandType(BallastTankCommandType&& other_) OMG_NOEXCEPT;  
                BallastTankCommandType& operator=(BallastTankCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(BallastTankCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BallastTankCommandType& a, BallastTankCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
