...
#ifndef BallastTankCommandStatusType_309642512_hpp
#define BallastTankCommandStatusType_309642512_hpp
...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            static const std::string BallastTankCommandStatus_TOPIC = "UMAA::EO::BallastTank::BallastTankCommandStatus";

            class NDDSUSERDllExport BallastTankCommandStatusType {
              public:
                ...
                BallastTankCommandStatusType (BallastTankCommandStatusType&&) = default;
                BallastTankCommandStatusType& operator=(BallastTankCommandStatusType&&) = default;
                BallastTankCommandStatusType& operator=(const BallastTankCommandStatusType&) = default;
                BallastTankCommandStatusType(const BallastTankCommandStatusType&) = default;
                #else
                BallastTankCommandStatusType(BallastTankCommandStatusType&& other_) OMG_NOEXCEPT;  
                BallastTankCommandStatusType& operator=(BallastTankCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const BallastTankCommandStatusType& other_) const;
                bool operator != (const BallastTankCommandStatusType& other_) const;

                void swap(BallastTankCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BallastTankCommandStatusType& a, BallastTankCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BallastTankCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::BallastTank::BallastTankCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::BallastTank::BallastTankCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::BallastTank::BallastTankCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::BallastTank::BallastTankCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::BallastTank::BallastTankCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::BallastTank::BallastTankCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::BallastTank::BallastTankCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::BallastTank::BallastTankCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::BallastTank::BallastTankCommandStatusType > {
...
#endif // BallastTankCommandStatusType_309642512_hpp
