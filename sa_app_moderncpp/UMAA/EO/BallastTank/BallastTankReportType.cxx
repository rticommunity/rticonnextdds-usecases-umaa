...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastTankReportType::BallastTankReportType (const ::dds::core::optional< double >& level,double lowPressureLimit,const ::dds::core::optional< double >& mass,double pressure,double pressureLimit,bool trimActive,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_level_( level ),
                m_lowPressureLimit_( lowPressureLimit ),
                m_mass_( mass ),
                m_pressure_( pressure ),
                m_pressureLimit_( pressureLimit ),
                m_trimActive_( trimActive ),
                m_source_( source ),
            ...
            BallastTankReportType::BallastTankReportType(BallastTankReportType&& other_) OMG_NOEXCEPT  :m_level_ (std::move(other_.m_level_))
            ,
            m_lowPressureLimit_ (std::move(other_.m_lowPressureLimit_))
            ,
            m_mass_ (std::move(other_.m_mass_))
            ,
            m_pressure_ (std::move(other_.m_pressure_))
            ,
            m_pressureLimit_ (std::move(other_.m_pressureLimit_))
            ,
            m_trimActive_ (std::move(other_.m_trimActive_))
            ,
            ...
            BallastTankReportType& BallastTankReportType::operator=(BallastTankReportType&&  other_) OMG_NOEXCEPT {
                BallastTankReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastTankReportType::swap(BallastTankReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool BallastTankReportType::operator == (const BallastTankReportType& other_) const {
                ...
                if (m_lowPressureLimit_ != other_.m_lowPressureLimit_) {
                    return false;
                }
                if (m_mass_ != other_.m_mass_) {
                    return false;
                }
                if (m_pressure_ != other_.m_pressure_) {
                    return false;
                }
                if (m_pressureLimit_ != other_.m_pressureLimit_) {
                    return false;
                }
