        ...
        namespace BallastTank {
            namespace BallastPumpFlowRateType_Specializations {
                ...
                class NDDSUSERDllExport BallastPumpFlowRateType_Union {
                  public:
                    ...
                    BallastPumpFlowRateType_Union (BallastPumpFlowRateType_Union&&) = default;
                    BallastPumpFlowRateType_Union& operator=(BallastPumpFlowRateType_Union&&) = default;
                    BallastPumpFlowRateType_Union& operator=(const BallastPumpFlowRateType_Union&) = default;
                    BallastPumpFlowRateType_Union(const BallastPumpFlowRateType_Union&) = default;
                    #else
                    BallastPumpFlowRateType_Union(BallastPumpFlowRateType_Union&& other_) OMG_NOEXCEPT;  
                    BallastPumpFlowRateType_Union& operator=(BallastPumpFlowRateType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(BallastPumpFlowRateType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::EO::BallastTank::MassBallastFlowRateType& MassBallastFlowRateType_data,const UMAA::EO::BallastTank::VolumeBallastFlowRateType& VolumeBallastFlowRateType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(BallastPumpFlowRateType_Union& a, BallastPumpFlowRateType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport BallastPumpFlowRateType {
              public:
                ...
                explicit BallastPumpFlowRateType(const UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Union& BallastPumpFlowRateType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BallastPumpFlowRateType (BallastPumpFlowRateType&&) = default;
                BallastPumpFlowRateType& operator=(BallastPumpFlowRateType&&) = default;
                BallastPumpFlowRateType& operator=(const BallastPumpFlowRateType&) = default;
                BallastPumpFlowRateType(const BallastPumpFlowRateType&) = default;
                #else
                BallastPumpFlowRateType(BallastPumpFlowRateType&& other_) OMG_NOEXCEPT;  
                BallastPumpFlowRateType& operator=(BallastPumpFlowRateType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Union& BallastPumpFlowRateType_subtypes() OMG_NOEXCEPT {
                    return m_BallastPumpFlowRateType_subtypes_;
                }

                const UMAA::EO::BallastTank::BallastPumpFlowRateType_Specializations::BallastPumpFlowRateType_Union& BallastPumpFlowRateType_subtypes() const OMG_NOEXCEPT {
                    return m_BallastPumpFlowRateType_subtypes_;
                }
                ...
                void swap(BallastPumpFlowRateType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BallastPumpFlowRateType& a, BallastPumpFlowRateType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
