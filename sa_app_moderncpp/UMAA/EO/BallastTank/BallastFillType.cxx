    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            namespace BallastFillType_Specializations {
                ...
                BallastFillType_Union::BallastFillType_Union(BallastFillType_Union&& other_) OMG_NOEXCEPT 
                {
                ...
                BallastFillType_Union& BallastFillType_Union::operator=(BallastFillType_Union&&  other_) OMG_NOEXCEPT {
                    BallastFillType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                BallastFillType_Union::Union_::Union_(const UMAA::Common::Measurement::LevelType& LevelType_data,const UMAA::Common::Measurement::BallastMassType& BallastMassType_data):
                    m_LevelType_data_( LevelType_data ),
                    m_BallastMassType_data_( BallastMassType_data ) {
                }
                ...
                void BallastFillType_Union::swap(BallastFillType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const BallastFillType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::EO::BallastTank::BallastFillType_Specializations::BallastFillType_Selectors::BALLASTMASSTYPE_SELECT):
                            {  
                                o << "BallastMassType_data: " << sample.BallastMassType_data() ;        } break ;
            ...
            BallastFillType::BallastFillType (const UMAA::EO::BallastTank::BallastFillType_Specializations::BallastFillType_Union& BallastFillType_subtypes):
                m_BallastFillType_subtypes_( BallastFillType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            BallastFillType::BallastFillType(BallastFillType&& other_) OMG_NOEXCEPT  :m_BallastFillType_subtypes_ (std::move(other_.m_BallastFillType_subtypes_))
            {
            } 

            BallastFillType& BallastFillType::operator=(BallastFillType&&  other_) OMG_NOEXCEPT {
                BallastFillType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastFillType::swap(BallastFillType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
