        ...
        namespace BallastTank {
            namespace BallastFillType_Specializations {
                ...
                class NDDSUSERDllExport BallastFillType_Union {
                  public:
                    ...
                    BallastFillType_Union (BallastFillType_Union&&) = default;
                    BallastFillType_Union& operator=(BallastFillType_Union&&) = default;
                    BallastFillType_Union& operator=(const BallastFillType_Union&) = default;
                    BallastFillType_Union(const BallastFillType_Union&) = default;
                    #else
                    BallastFillType_Union(BallastFillType_Union&& other_) OMG_NOEXCEPT;  
                    BallastFillType_Union& operator=(BallastFillType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::EO::BallastTank::BallastFillType_Specializations::BallastFillType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(BallastFillType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::Common::Measurement::LevelType& LevelType_data,const UMAA::Common::Measurement::BallastMassType& BallastMassType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(BallastFillType_Union& a, BallastFillType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport BallastFillType {
              public:
                ...
                explicit BallastFillType(const UMAA::EO::BallastTank::BallastFillType_Specializations::BallastFillType_Union& BallastFillType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BallastFillType (BallastFillType&&) = default;
                BallastFillType& operator=(BallastFillType&&) = default;
                BallastFillType& operator=(const BallastFillType&) = default;
                BallastFillType(const BallastFillType&) = default;
                #else
                BallastFillType(BallastFillType&& other_) OMG_NOEXCEPT;  
                BallastFillType& operator=(BallastFillType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::EO::BallastTank::BallastFillType_Specializations::BallastFillType_Union& BallastFillType_subtypes() OMG_NOEXCEPT {
                    return m_BallastFillType_subtypes_;
                }

                const UMAA::EO::BallastTank::BallastFillType_Specializations::BallastFillType_Union& BallastFillType_subtypes() const OMG_NOEXCEPT {
                    return m_BallastFillType_subtypes_;
                }
                ...
                void swap(BallastFillType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BallastFillType& a, BallastFillType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
