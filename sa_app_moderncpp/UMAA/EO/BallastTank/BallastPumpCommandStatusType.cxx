...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastPumpCommandStatusType::BallastPumpCommandStatusType(BallastPumpCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            BallastPumpCommandStatusType& BallastPumpCommandStatusType::operator=(BallastPumpCommandStatusType&&  other_) OMG_NOEXCEPT {
                BallastPumpCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BallastPumpCommandStatusType::swap(BallastPumpCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::EO::BallastTank::BallastPumpCommandStatusType > {
            static DDS_TypeCode * get()
            {
                ...
                BallastPumpCommandStatusType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                BallastPumpCommandStatusType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType>::get().native();
                BallastPumpCommandStatusType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType>::get().native();
                BallastPumpCommandStatusType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&BallastPumpCommandStatusType_g_tc_logMessage_string;
                BallastPumpCommandStatusType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                BallastPumpCommandStatusType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();

                /* Initialize the values for member annotations. */

                BallastPumpCommandStatusType_g_tc_members[1]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                BallastPumpCommandStatusType_g_tc_members[1]._annotations._defaultValue._u.enumerated_value = 0;

                BallastPumpCommandStatusType_g_tc_members[2]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                BallastPumpCommandStatusType_g_tc_members[2]._annotations._defaultValue._u.enumerated_value = 0;

                BallastPumpCommandStatusType_g_tc_members[3]._annotations._defaultValue._d = RTI_XCDR_TK_STRING;
                BallastPumpCommandStatusType_g_tc_members[3]._annotations._defaultValue._u.string_value = (DDS_Char *) "";
