...
#ifndef AnchorCommandStatusType_1290944523_hpp
#define AnchorCommandStatusType_1290944523_hpp
...
namespace UMAA {
    namespace EO {
        namespace AnchorControl {
            ...
            static const std::string AnchorCommandStatus_TOPIC = "UMAA::EO::AnchorControl::AnchorCommandStatus";

            class NDDSUSERDllExport AnchorCommandStatusType {
              public:
                ...
                AnchorCommandStatusType (AnchorCommandStatusType&&) = default;
                AnchorCommandStatusType& operator=(AnchorCommandStatusType&&) = default;
                AnchorCommandStatusType& operator=(const AnchorCommandStatusType&) = default;
                AnchorCommandStatusType(const AnchorCommandStatusType&) = default;
                #else
                AnchorCommandStatusType(AnchorCommandStatusType&& other_) OMG_NOEXCEPT;  
                AnchorCommandStatusType& operator=(AnchorCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const AnchorCommandStatusType& other_) const;
                bool operator != (const AnchorCommandStatusType& other_) const;

                void swap(AnchorCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(AnchorCommandStatusType& a, AnchorCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const AnchorCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::AnchorControl::AnchorCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::AnchorControl::AnchorCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::AnchorControl::AnchorCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::AnchorControl::AnchorCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::AnchorControl::AnchorCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::AnchorControl::AnchorCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::AnchorControl::AnchorCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::AnchorControl::AnchorCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::AnchorControl::AnchorCommandStatusType > {
...
#endif // AnchorCommandStatusType_1290944523_hpp
