...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace AnchorControl {
            ...
            AnchorCommandAckReportType::AnchorCommandAckReportType (const UMAA::Common::MaritimeEnumeration::AnchorActionEnumType::AnchorActionEnumType& action,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_action_( action ),
                m_source_( source ),
            ...
            AnchorCommandAckReportType::AnchorCommandAckReportType(AnchorCommandAckReportType&& other_) OMG_NOEXCEPT  :m_action_ (std::move(other_.m_action_))
            ,
            ...
            AnchorCommandAckReportType& AnchorCommandAckReportType::operator=(AnchorCommandAckReportType&&  other_) OMG_NOEXCEPT {
                AnchorCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AnchorCommandAckReportType::swap(AnchorCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
