...
#ifndef RudderCommandStatusType_696276892_hpp
#define RudderCommandStatusType_696276892_hpp
...
namespace UMAA {
    namespace EO {
        namespace RudderControl {
            ...
            static const std::string RudderCommandStatus_TOPIC = "UMAA::EO::RudderControl::RudderCommandStatus";

            class NDDSUSERDllExport RudderCommandStatusType {
              public:
                RudderCommandStatusType();

                RudderCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                RudderCommandStatusType (RudderCommandStatusType&&) = default;
                RudderCommandStatusType& operator=(RudderCommandStatusType&&) = default;
                RudderCommandStatusType& operator=(const RudderCommandStatusType&) = default;
                RudderCommandStatusType(const RudderCommandStatusType&) = default;
                #else
                RudderCommandStatusType(RudderCommandStatusType&& other_) OMG_NOEXCEPT;  
                RudderCommandStatusType& operator=(RudderCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const RudderCommandStatusType& other_) const;
                bool operator != (const RudderCommandStatusType& other_) const;

                void swap(RudderCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(RudderCommandStatusType& a, RudderCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const RudderCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::RudderControl::RudderCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::RudderControl::RudderCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::RudderControl::RudderCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::RudderControl::RudderCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::RudderControl::RudderCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::RudderControl::RudderCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::RudderControl::RudderCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::RudderControl::RudderCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::RudderControl::RudderCommandStatusType > {
...
#endif // RudderCommandStatusType_696276892_hpp
