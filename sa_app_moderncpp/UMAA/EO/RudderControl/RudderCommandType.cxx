...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace RudderControl {
            ...
            RudderCommandType::RudderCommandType (double angle,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_angle_( angle ),
                m_source_( source ),
            ...
            RudderCommandType::RudderCommandType(RudderCommandType&& other_) OMG_NOEXCEPT  :m_angle_ (std::move(other_.m_angle_))
            ,
            ...
            RudderCommandType& RudderCommandType::operator=(RudderCommandType&&  other_) OMG_NOEXCEPT {
                RudderCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void RudderCommandType::swap(RudderCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
