...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace FinControl {
            ...
            FinCommandType::FinCommandType (double deflection,double deflectionRate,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            FinCommandType::FinCommandType(FinCommandType&& other_) OMG_NOEXCEPT  :m_deflection_ (std::move(other_.m_deflection_))
            ,
            ...
            FinCommandType& FinCommandType::operator=(FinCommandType&&  other_) OMG_NOEXCEPT {
                FinCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void FinCommandType::swap(FinCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
