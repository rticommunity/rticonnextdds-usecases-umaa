...
#ifndef FinCommandStatusType_2049444464_hpp
#define FinCommandStatusType_2049444464_hpp
...
namespace UMAA {
    namespace EO {
        namespace FinControl {
            ...
            static const std::string FinCommandStatus_TOPIC = "UMAA::EO::FinControl::FinCommandStatus";

            class NDDSUSERDllExport FinCommandStatusType {
              public:
                FinCommandStatusType();

                FinCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                FinCommandStatusType (FinCommandStatusType&&) = default;
                FinCommandStatusType& operator=(FinCommandStatusType&&) = default;
                FinCommandStatusType& operator=(const FinCommandStatusType&) = default;
                FinCommandStatusType(const FinCommandStatusType&) = default;
                #else
                FinCommandStatusType(FinCommandStatusType&& other_) OMG_NOEXCEPT;  
                FinCommandStatusType& operator=(FinCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const FinCommandStatusType& other_) const;
                bool operator != (const FinCommandStatusType& other_) const;

                void swap(FinCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(FinCommandStatusType& a, FinCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const FinCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::FinControl::FinCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::FinControl::FinCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::FinControl::FinCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::FinControl::FinCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::FinControl::FinCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::FinControl::FinCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::FinControl::FinCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::FinControl::FinCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::FinControl::FinCommandStatusType > {
...
#endif // FinCommandStatusType_2049444464_hpp
