...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace FinControl {
            ...
            FinCommandAckReportType::FinCommandAckReportType (double deflection,double deflectionRate,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            FinCommandAckReportType::FinCommandAckReportType(FinCommandAckReportType&& other_) OMG_NOEXCEPT  :m_deflection_ (std::move(other_.m_deflection_))
            ,
            ...
            FinCommandAckReportType& FinCommandAckReportType::operator=(FinCommandAckReportType&&  other_) OMG_NOEXCEPT {
                FinCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void FinCommandAckReportType::swap(FinCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
