...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace EngineControl {
            ...
            EngineCommandType::EngineCommandType(EngineCommandType&& other_) OMG_NOEXCEPT  :m_plugState_ (std::move(other_.m_plugState_))
            ,
            ...
            EngineCommandType& EngineCommandType::operator=(EngineCommandType&&  other_) OMG_NOEXCEPT {
                EngineCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void EngineCommandType::swap(EngineCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
