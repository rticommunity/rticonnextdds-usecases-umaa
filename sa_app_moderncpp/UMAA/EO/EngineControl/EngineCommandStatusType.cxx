...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace EngineControl {
            ...
            EngineCommandStatusType::EngineCommandStatusType(EngineCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            EngineCommandStatusType& EngineCommandStatusType::operator=(EngineCommandStatusType&&  other_) OMG_NOEXCEPT {
                EngineCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void EngineCommandStatusType::swap(EngineCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::EO::EngineControl::EngineCommandStatusType > {
            static DDS_TypeCode * get()
            {
                ...
                EngineCommandStatusType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                EngineCommandStatusType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType>::get().native();
                EngineCommandStatusType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType>::get().native();
                EngineCommandStatusType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&EngineCommandStatusType_g_tc_logMessage_string;
                EngineCommandStatusType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                EngineCommandStatusType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();

                /* Initialize the values for member annotations. */

                EngineCommandStatusType_g_tc_members[1]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                EngineCommandStatusType_g_tc_members[1]._annotations._defaultValue._u.enumerated_value = 0;

                EngineCommandStatusType_g_tc_members[2]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                EngineCommandStatusType_g_tc_members[2]._annotations._defaultValue._u.enumerated_value = 0;

                EngineCommandStatusType_g_tc_members[3]._annotations._defaultValue._d = RTI_XCDR_TK_STRING;
                EngineCommandStatusType_g_tc_members[3]._annotations._defaultValue._u.string_value = (DDS_Char *) "";
