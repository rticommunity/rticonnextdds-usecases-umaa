...
#ifndef EngineCommandStatusType_536687262_hpp
#define EngineCommandStatusType_536687262_hpp
...
namespace UMAA {
    namespace EO {
        namespace EngineControl {
            ...
            static const std::string EngineCommandStatus_TOPIC = "UMAA::EO::EngineControl::EngineCommandStatus";

            class NDDSUSERDllExport EngineCommandStatusType {
              public:
                EngineCommandStatusType();

                EngineCommandStatusType(const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::MaritimeEnumeration::CommandStatusEnumType::CommandStatusEnumType& commandStatus,const UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason,const std::string& logMessage,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                EngineCommandStatusType (EngineCommandStatusType&&) = default;
                EngineCommandStatusType& operator=(EngineCommandStatusType&&) = default;
                EngineCommandStatusType& operator=(const EngineCommandStatusType&) = default;
                EngineCommandStatusType(const EngineCommandStatusType&) = default;
                #else
                EngineCommandStatusType(EngineCommandStatusType&& other_) OMG_NOEXCEPT;  
                EngineCommandStatusType& operator=(EngineCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const EngineCommandStatusType& other_) const;
                bool operator != (const EngineCommandStatusType& other_) const;

                void swap(EngineCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(EngineCommandStatusType& a, EngineCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const EngineCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::EO::EngineControl::EngineCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::EngineControl::EngineCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::EO::EngineControl::EngineCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::EO::EngineControl::EngineCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::EO::EngineControl::EngineCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::EO::EngineControl::EngineCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::EO::EngineControl::EngineCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::EO::EngineControl::EngineCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::EO::EngineControl::EngineCommandStatusType > {
...
#endif // EngineCommandStatusType_536687262_hpp
