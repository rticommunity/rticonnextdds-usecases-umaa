...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace AnchorSpecs {
            ...
            AnchorSpecsReportType::AnchorSpecsReportType(AnchorSpecsReportType&& other_) OMG_NOEXCEPT  :m_anchorHoldingPower_ (std::move(other_.m_anchorHoldingPower_))
            ,
            m_anchorHoldingPowerRatio_ (std::move(other_.m_anchorHoldingPowerRatio_))
            ,
            m_anchorKind_ (std::move(other_.m_anchorKind_))
            ,
            m_anchorLocation_ (std::move(other_.m_anchorLocation_))
            ,
            m_anchorSize_ (std::move(other_.m_anchorSize_))
            ,
            m_rodeLength_ (std::move(other_.m_rodeLength_))
            ,
            m_rodeSize_ (std::move(other_.m_rodeSize_))
            ,
            m_rodeWorkingLoadLimit_ (std::move(other_.m_rodeWorkingLoadLimit_))
            ,
            ...
            AnchorSpecsReportType& AnchorSpecsReportType::operator=(AnchorSpecsReportType&&  other_) OMG_NOEXCEPT {
                AnchorSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AnchorSpecsReportType::swap(AnchorSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool AnchorSpecsReportType::operator == (const AnchorSpecsReportType& other_) const {
                if (m_anchorHoldingPower_ != other_.m_anchorHoldingPower_) {
                    return false;
                }
                if (m_anchorHoldingPowerRatio_ != other_.m_anchorHoldingPowerRatio_) {
                    return false;
                }
                ...
                if (m_anchorSize_ != other_.m_anchorSize_) {
                    return false;
                }
                if (m_rodeLength_ != other_.m_rodeLength_) {
                    return false;
                }
                if (m_rodeSize_ != other_.m_rodeSize_) {
                    return false;
                }
                if (m_rodeWorkingLoadLimit_ != other_.m_rodeWorkingLoadLimit_) {
                    return false;
                }
