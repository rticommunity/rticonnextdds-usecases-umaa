...
namespace UMAA {
    namespace EO {
        namespace AnchorSpecs {
            ...
            static const std::string AnchorSpecsReport_TOPIC = "UMAA::EO::AnchorSpecs::AnchorSpecsReport";

            class NDDSUSERDllExport AnchorSpecsReportType {
              public:
                AnchorSpecsReportType();

                AnchorSpecsReportType(double anchorHoldingPower,double anchorHoldingPowerRatio,const UMAA::Common::MaritimeEnumeration::AnchorKindEnumType::AnchorKindEnumType& anchorKind,const UMAA::Common::MaritimeEnumeration::AnchorLocationEnumType::AnchorLocationEnumType& anchorLocation,double anchorSize,double rodeLength,double rodeSize,double rodeWorkingLoadLimit,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                AnchorSpecsReportType (AnchorSpecsReportType&&) = default;
                AnchorSpecsReportType& operator=(AnchorSpecsReportType&&) = default;
                AnchorSpecsReportType& operator=(const AnchorSpecsReportType&) = default;
                AnchorSpecsReportType(const AnchorSpecsReportType&) = default;
                #else
                AnchorSpecsReportType(AnchorSpecsReportType&& other_) OMG_NOEXCEPT;  
                AnchorSpecsReportType& operator=(AnchorSpecsReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                double& anchorHoldingPower() OMG_NOEXCEPT {
                    return m_anchorHoldingPower_;
                }

                const double& anchorHoldingPower() const OMG_NOEXCEPT {
                    return m_anchorHoldingPower_;
                }
                ...
                double& anchorHoldingPowerRatio() OMG_NOEXCEPT {
                    return m_anchorHoldingPowerRatio_;
                }

                const double& anchorHoldingPowerRatio() const OMG_NOEXCEPT {
                    return m_anchorHoldingPowerRatio_;
                }
                ...
                UMAA::Common::MaritimeEnumeration::AnchorKindEnumType::AnchorKindEnumType& anchorKind() OMG_NOEXCEPT {
                    return m_anchorKind_;
                }

                const UMAA::Common::MaritimeEnumeration::AnchorKindEnumType::AnchorKindEnumType& anchorKind() const OMG_NOEXCEPT {
                    return m_anchorKind_;
                }
                ...
                UMAA::Common::MaritimeEnumeration::AnchorLocationEnumType::AnchorLocationEnumType& anchorLocation() OMG_NOEXCEPT {
                    return m_anchorLocation_;
                }

                const UMAA::Common::MaritimeEnumeration::AnchorLocationEnumType::AnchorLocationEnumType& anchorLocation() const OMG_NOEXCEPT {
                    return m_anchorLocation_;
                }
                ...
                double& anchorSize() OMG_NOEXCEPT {
                    return m_anchorSize_;
                }

                const double& anchorSize() const OMG_NOEXCEPT {
                    return m_anchorSize_;
                }
                ...
                double& rodeLength() OMG_NOEXCEPT {
                    return m_rodeLength_;
                }

                const double& rodeLength() const OMG_NOEXCEPT {
                    return m_rodeLength_;
                }
                ...
                double& rodeSize() OMG_NOEXCEPT {
                    return m_rodeSize_;
                }

                const double& rodeSize() const OMG_NOEXCEPT {
                    return m_rodeSize_;
                }
                ...
                double& rodeWorkingLoadLimit() OMG_NOEXCEPT {
                    return m_rodeWorkingLoadLimit_;
                }

                const double& rodeWorkingLoadLimit() const OMG_NOEXCEPT {
                    return m_rodeWorkingLoadLimit_;
                }
                ...
                void swap(AnchorSpecsReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(AnchorSpecsReportType& a, AnchorSpecsReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
