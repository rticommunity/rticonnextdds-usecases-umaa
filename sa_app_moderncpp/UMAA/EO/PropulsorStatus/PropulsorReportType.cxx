    ...
    namespace EO {
        ...
        namespace PropulsorStatus {
            ...
            PropulsorReportType::PropulsorReportType (bool motorFault,double pitch,double pitchEffort,const ::dds::core::optional< double >& propulsiveEffort,const ::dds::core::optional< double >& RPM,const UMAA::Common::MaritimeEnumeration::PowerPlantStateEnumType::PowerPlantStateEnumType& state,const ::dds::core::optional< double >& yaw,const ::dds::core::optional< double >& yawEffort,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                ...
                m_propulsiveEffort_( propulsiveEffort ),
                m_RPM_( RPM ),
                m_state_( state ),
                m_yaw_( yaw ),
            ...
            PropulsorReportType::PropulsorReportType(PropulsorReportType&& other_) OMG_NOEXCEPT  :m_motorFault_ (std::move(other_.m_motorFault_))
            ,
            m_pitch_ (std::move(other_.m_pitch_))
            ,
            m_pitchEffort_ (std::move(other_.m_pitchEffort_))
            ,
            m_propulsiveEffort_ (std::move(other_.m_propulsiveEffort_))
            ,
            ...
            PropulsorReportType& PropulsorReportType::operator=(PropulsorReportType&&  other_) OMG_NOEXCEPT {
                PropulsorReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PropulsorReportType::swap(PropulsorReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool PropulsorReportType::operator == (const PropulsorReportType& other_) const {
                ...
                if (m_propulsiveEffort_ != other_.m_propulsiveEffort_) {
                    return false;
                }
