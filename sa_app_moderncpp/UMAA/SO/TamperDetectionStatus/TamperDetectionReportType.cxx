...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace TamperDetectionStatus {
            ...
            TamperDetectionReportType::TamperDetectionReportType(TamperDetectionReportType&& other_) OMG_NOEXCEPT  :m_descriptor_ (std::move(other_.m_descriptor_))
            ,
            m_electricalTamper_ (std::move(other_.m_electricalTamper_))
            ,
            m_hardwareTamper_ (std::move(other_.m_hardwareTamper_))
            ,
            m_networkInstrusion_ (std::move(other_.m_networkInstrusion_))
            ,
            m_otherTamper_ (std::move(other_.m_otherTamper_))
            ,
            ...
            TamperDetectionReportType& TamperDetectionReportType::operator=(TamperDetectionReportType&&  other_) OMG_NOEXCEPT {
                TamperDetectionReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void TamperDetectionReportType::swap(TamperDetectionReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
