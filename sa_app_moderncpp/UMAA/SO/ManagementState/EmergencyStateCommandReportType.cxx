...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ManagementState {
            ...
            EmergencyStateCommandReportType::EmergencyStateCommandReportType (bool emergencyState,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            EmergencyStateCommandReportType::EmergencyStateCommandReportType(EmergencyStateCommandReportType&& other_) OMG_NOEXCEPT  :m_emergencyState_ (std::move(other_.m_emergencyState_))
            ,
            ...
            EmergencyStateCommandReportType& EmergencyStateCommandReportType::operator=(EmergencyStateCommandReportType&&  other_) OMG_NOEXCEPT {
                EmergencyStateCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void EmergencyStateCommandReportType::swap(EmergencyStateCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
