...
namespace UMAA {
    namespace SO {
        namespace ManagementState {
            ...
            static const std::string EmergencyStateCommandReport_TOPIC = "UMAA::SO::ManagementState::EmergencyStateCommandReport";

            class NDDSUSERDllExport EmergencyStateCommandReportType {
              public:
                EmergencyStateCommandReportType();

                EmergencyStateCommandReportType(bool emergencyState,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                EmergencyStateCommandReportType (EmergencyStateCommandReportType&&) = default;
                EmergencyStateCommandReportType& operator=(EmergencyStateCommandReportType&&) = default;
                EmergencyStateCommandReportType& operator=(const EmergencyStateCommandReportType&) = default;
                EmergencyStateCommandReportType(const EmergencyStateCommandReportType&) = default;
                #else
                EmergencyStateCommandReportType(EmergencyStateCommandReportType&& other_) OMG_NOEXCEPT;  
                EmergencyStateCommandReportType& operator=(EmergencyStateCommandReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(EmergencyStateCommandReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(EmergencyStateCommandReportType& a, EmergencyStateCommandReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
