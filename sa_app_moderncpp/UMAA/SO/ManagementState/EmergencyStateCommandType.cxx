...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ManagementState {
            ...
            EmergencyStateCommandType::EmergencyStateCommandType (bool emergencyState,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_emergencyState_( emergencyState ),
                m_source_( source ),
            ...
            EmergencyStateCommandType::EmergencyStateCommandType(EmergencyStateCommandType&& other_) OMG_NOEXCEPT  :m_emergencyState_ (std::move(other_.m_emergencyState_))
            ,
            ...
            EmergencyStateCommandType& EmergencyStateCommandType::operator=(EmergencyStateCommandType&&  other_) OMG_NOEXCEPT {
                EmergencyStateCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void EmergencyStateCommandType::swap(EmergencyStateCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
