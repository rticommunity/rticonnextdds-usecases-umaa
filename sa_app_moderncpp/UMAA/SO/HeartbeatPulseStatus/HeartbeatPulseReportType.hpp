...
namespace UMAA {
    namespace SO {
        namespace HeartbeatPulseStatus {
            ...
            static const std::string HeartbeatPulseReport_TOPIC = "UMAA::SO::HeartbeatPulseStatus::HeartbeatPulseReport";

            class NDDSUSERDllExport HeartbeatPulseReportType {
              public:
                HeartbeatPulseReportType();

                HeartbeatPulseReportType(int32_t heartBeat,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                HeartbeatPulseReportType (HeartbeatPulseReportType&&) = default;
                HeartbeatPulseReportType& operator=(HeartbeatPulseReportType&&) = default;
                HeartbeatPulseReportType& operator=(const HeartbeatPulseReportType&) = default;
                HeartbeatPulseReportType(const HeartbeatPulseReportType&) = default;
                #else
                HeartbeatPulseReportType(HeartbeatPulseReportType&& other_) OMG_NOEXCEPT;  
                HeartbeatPulseReportType& operator=(HeartbeatPulseReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                int32_t& heartBeat() OMG_NOEXCEPT {
                    return m_heartBeat_;
                }

                const int32_t& heartBeat() const OMG_NOEXCEPT {
                    return m_heartBeat_;
                }
                ...
                void swap(HeartbeatPulseReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(HeartbeatPulseReportType& a, HeartbeatPulseReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
