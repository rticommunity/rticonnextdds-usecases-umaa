...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HeartbeatPulseStatus {
            ...
            HeartbeatPulseReportType::HeartbeatPulseReportType (int32_t heartBeat,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_heartBeat_( heartBeat ),
                m_source_( source ),
            ...
            HeartbeatPulseReportType::HeartbeatPulseReportType(HeartbeatPulseReportType&& other_) OMG_NOEXCEPT  :m_heartBeat_ (std::move(other_.m_heartBeat_))
            ,
            ...
            HeartbeatPulseReportType& HeartbeatPulseReportType::operator=(HeartbeatPulseReportType&&  other_) OMG_NOEXCEPT {
                HeartbeatPulseReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void HeartbeatPulseReportType::swap(HeartbeatPulseReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::SO::HeartbeatPulseStatus::HeartbeatPulseReportType > {
            static DDS_TypeCode * get()
            {
                ...
                HeartbeatPulseReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                HeartbeatPulseReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                HeartbeatPulseReportType_g_tc_members[0]._annotations._minValue._u.long_value = -2147483648L;
                HeartbeatPulseReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                HeartbeatPulseReportType_g_tc_members[0]._annotations._maxValue._u.long_value = 2147483647L;
