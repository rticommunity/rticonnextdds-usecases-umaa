...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthSummaryStatus {
            ...
            HealthSummaryReportType::HealthSummaryReportType (const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& resourceIDs,const ::rti::core::bounded_sequence< UMAA::Common::MaritimeEnumeration::ErrorConditionEnumType::ErrorConditionEnumType, 100L >& severities,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_resourceIDs_( resourceIDs ),
                m_severities_( severities ),
                m_source_( source ),
            ...
            HealthSummaryReportType::HealthSummaryReportType(HealthSummaryReportType&& other_) OMG_NOEXCEPT  :m_resourceIDs_ (std::move(other_.m_resourceIDs_))
            ,
            m_severities_ (std::move(other_.m_severities_))
            ,
            ...
            HealthSummaryReportType& HealthSummaryReportType::operator=(HealthSummaryReportType&&  other_) OMG_NOEXCEPT {
                HealthSummaryReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void HealthSummaryReportType::swap(HealthSummaryReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
