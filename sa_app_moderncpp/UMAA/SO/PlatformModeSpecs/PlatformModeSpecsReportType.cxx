...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace PlatformModeSpecs {
            ...
            PlatformModeSpecsReportType::PlatformModeSpecsReportType (bool supportedMaintenance,bool supportedStandardOperating,bool supportedTraining,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_supportedMaintenance_( supportedMaintenance ),
                m_supportedStandardOperating_( supportedStandardOperating ),
                m_supportedTraining_( supportedTraining ),
                m_source_( source ),
            ...
            PlatformModeSpecsReportType::PlatformModeSpecsReportType(PlatformModeSpecsReportType&& other_) OMG_NOEXCEPT  :m_supportedMaintenance_ (std::move(other_.m_supportedMaintenance_))
            ,
            m_supportedStandardOperating_ (std::move(other_.m_supportedStandardOperating_))
            ,
            m_supportedTraining_ (std::move(other_.m_supportedTraining_))
            ,
            ...
            PlatformModeSpecsReportType& PlatformModeSpecsReportType::operator=(PlatformModeSpecsReportType&&  other_) OMG_NOEXCEPT {
                PlatformModeSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PlatformModeSpecsReportType::swap(PlatformModeSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
