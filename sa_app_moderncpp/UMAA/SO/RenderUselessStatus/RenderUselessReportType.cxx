...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace RenderUselessStatus {
            ...
            RenderUselessReportType::RenderUselessReportType (const std::string& errorString,const UMAA::Common::MaritimeEnumeration::RenderUselessStateEnumType::RenderUselessStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_errorString_( errorString ),
                m_state_( state ),
                m_source_( source ),
            ...
            RenderUselessReportType::RenderUselessReportType(RenderUselessReportType&& other_) OMG_NOEXCEPT  :m_errorString_ (std::move(other_.m_errorString_))
            ,
            ...
            RenderUselessReportType& RenderUselessReportType::operator=(RenderUselessReportType&&  other_) OMG_NOEXCEPT {
                RenderUselessReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void RenderUselessReportType::swap(RenderUselessReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
