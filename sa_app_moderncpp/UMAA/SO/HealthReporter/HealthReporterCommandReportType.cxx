...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthReporter {
            ...
            HealthReporterCommandReportType::HealthReporterCommandReportType (const UMAA::Common::Measurement::BuiltInTestStatusType_All& builtInTest,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            HealthReporterCommandReportType::HealthReporterCommandReportType(HealthReporterCommandReportType&& other_) OMG_NOEXCEPT  :m_builtInTest_ (std::move(other_.m_builtInTest_))
            ,
            ...
            HealthReporterCommandReportType& HealthReporterCommandReportType::operator=(HealthReporterCommandReportType&&  other_) OMG_NOEXCEPT {
                HealthReporterCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void HealthReporterCommandReportType::swap(HealthReporterCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
