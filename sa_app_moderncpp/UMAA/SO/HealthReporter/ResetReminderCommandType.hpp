...
namespace UMAA {
    namespace SO {
        namespace HealthReporter {
            ...
            static const std::string ResetReminderCommand_TOPIC = "UMAA::SO::HealthReporter::ResetReminderCommand";

            class NDDSUSERDllExport ResetReminderCommandType {
              public:
                ResetReminderCommandType();

                ResetReminderCommandType(const UMAA::Common::Measurement::NumericGUID& reminderID,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                ResetReminderCommandType (ResetReminderCommandType&&) = default;
                ResetReminderCommandType& operator=(ResetReminderCommandType&&) = default;
                ResetReminderCommandType& operator=(const ResetReminderCommandType&) = default;
                ResetReminderCommandType(const ResetReminderCommandType&) = default;
                #else
                ResetReminderCommandType(ResetReminderCommandType&& other_) OMG_NOEXCEPT;  
                ResetReminderCommandType& operator=(ResetReminderCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(ResetReminderCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ResetReminderCommandType& a, ResetReminderCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
