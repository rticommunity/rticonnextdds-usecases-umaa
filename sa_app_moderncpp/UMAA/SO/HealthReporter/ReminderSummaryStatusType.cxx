...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthReporter {
            ...
            ReminderSummaryStatusType::ReminderSummaryStatusType (const ::rti::core::bounded_sequence< bool, 100L >& reminderExpireds,const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& reminderIDs,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_reminderExpireds_( reminderExpireds ),
                m_reminderIDs_( reminderIDs ),
                m_source_( source ),
            ...
            ReminderSummaryStatusType::ReminderSummaryStatusType(ReminderSummaryStatusType&& other_) OMG_NOEXCEPT  :m_reminderExpireds_ (std::move(other_.m_reminderExpireds_))
            ,
            m_reminderIDs_ (std::move(other_.m_reminderIDs_))
            ,
            ...
            ReminderSummaryStatusType& ReminderSummaryStatusType::operator=(ReminderSummaryStatusType&&  other_) OMG_NOEXCEPT {
                ReminderSummaryStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ReminderSummaryStatusType::swap(ReminderSummaryStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
