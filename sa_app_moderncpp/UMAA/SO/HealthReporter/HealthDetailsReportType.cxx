...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthReporter {
            ...
            HealthDetailsReportType::HealthDetailsReportType (const ::rti::core::bounded_sequence< UMAA::SO::HealthReporter::HealthDetailsStatusType, 100L >& healthDetails,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& resourceID):
                m_healthDetails_( healthDetails ),
                m_source_( source ),
            ...
            HealthDetailsReportType::HealthDetailsReportType(HealthDetailsReportType&& other_) OMG_NOEXCEPT  :m_healthDetails_ (std::move(other_.m_healthDetails_))
            ,
            ...
            HealthDetailsReportType& HealthDetailsReportType::operator=(HealthDetailsReportType&&  other_) OMG_NOEXCEPT {
                HealthDetailsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void HealthDetailsReportType::swap(HealthDetailsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
