...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace PlatformModeControl {
            ...
            PlatformModeCommandAckReportType::PlatformModeCommandAckReportType (const UMAA::Common::MaritimeEnumeration::PlatformModeEnumType::PlatformModeEnumType& mode,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_mode_( mode ),
                m_source_( source ),
            ...
            PlatformModeCommandAckReportType::PlatformModeCommandAckReportType(PlatformModeCommandAckReportType&& other_) OMG_NOEXCEPT  :m_mode_ (std::move(other_.m_mode_))
            ,
            ...
            PlatformModeCommandAckReportType& PlatformModeCommandAckReportType::operator=(PlatformModeCommandAckReportType&&  other_) OMG_NOEXCEPT {
                PlatformModeCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PlatformModeCommandAckReportType::swap(PlatformModeCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
