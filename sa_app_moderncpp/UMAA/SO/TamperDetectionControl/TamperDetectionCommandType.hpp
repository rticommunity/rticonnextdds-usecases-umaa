...
namespace UMAA {
    namespace SO {
        namespace TamperDetectionControl {
            ...
            static const std::string TamperDetectionCommand_TOPIC = "UMAA::SO::TamperDetectionControl::TamperDetectionCommand";

            class NDDSUSERDllExport TamperDetectionCommandType {
              public:
                TamperDetectionCommandType();

                TamperDetectionCommandType(const UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumType::TamperDetectionStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                TamperDetectionCommandType (TamperDetectionCommandType&&) = default;
                TamperDetectionCommandType& operator=(TamperDetectionCommandType&&) = default;
                TamperDetectionCommandType& operator=(const TamperDetectionCommandType&) = default;
                TamperDetectionCommandType(const TamperDetectionCommandType&) = default;
                #else
                TamperDetectionCommandType(TamperDetectionCommandType&& other_) OMG_NOEXCEPT;  
                TamperDetectionCommandType& operator=(TamperDetectionCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(TamperDetectionCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(TamperDetectionCommandType& a, TamperDetectionCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
