...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace PlatformModeStatus {
            ...
            PlatformModeReportType::PlatformModeReportType (const UMAA::Common::MaritimeEnumeration::PlatformModeEnumType::PlatformModeEnumType& mode,const UMAA::Common::MaritimeEnumeration::PlatformModeTransitionEnumType::PlatformModeTransitionEnumType& status,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_mode_( mode ),
                m_status_( status ),
                m_source_( source ),
            ...
            PlatformModeReportType::PlatformModeReportType(PlatformModeReportType&& other_) OMG_NOEXCEPT  :m_mode_ (std::move(other_.m_mode_))
            ,
            ...
            PlatformModeReportType& PlatformModeReportType::operator=(PlatformModeReportType&&  other_) OMG_NOEXCEPT {
                PlatformModeReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PlatformModeReportType::swap(PlatformModeReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
