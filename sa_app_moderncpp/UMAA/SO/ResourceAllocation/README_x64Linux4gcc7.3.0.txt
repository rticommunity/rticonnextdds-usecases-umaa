...
data type ResourceAllocationReportType_ControlinfoSet from ResourceAllocationReportType.idl.
This example builds two applications, named ResourceAllocationReportType_publisher and
ResourceAllocationReportType_subscriber.
...
> make -f makefile_ResourceAllocationReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ResourceAllocationReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the ResourceAllocationReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/ResourceAllocationReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/ResourceAllocationReportType_subscriber -d <domain_id> -s <sample_count>
