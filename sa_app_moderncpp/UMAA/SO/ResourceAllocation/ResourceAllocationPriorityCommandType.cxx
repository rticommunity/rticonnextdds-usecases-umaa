...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ResourceAllocation {
            ...
            ResourceAllocationPriorityCommandType::ResourceAllocationPriorityCommandType (const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& priorities,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& resourceId):
            ...
            ResourceAllocationPriorityCommandType::ResourceAllocationPriorityCommandType(ResourceAllocationPriorityCommandType&& other_) OMG_NOEXCEPT  :m_priorities_ (std::move(other_.m_priorities_))
            ,
            ...
            ResourceAllocationPriorityCommandType& ResourceAllocationPriorityCommandType::operator=(ResourceAllocationPriorityCommandType&&  other_) OMG_NOEXCEPT {
                ResourceAllocationPriorityCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ResourceAllocationPriorityCommandType::swap(ResourceAllocationPriorityCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::SO::ResourceAllocation::ResourceAllocationPriorityCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                ResourceAllocationPriorityCommandType_g_tc_priorities_sequence = initialize_sequence_typecode< ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L > >((100L));

                ResourceAllocationPriorityCommandType_g_tc._data._annotations._allowedDataRepresentationMask = 5;

                ResourceAllocationPriorityCommandType_g_tc_priorities_sequence._data._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ...
                ResourceAllocationPriorityCommandType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ResourceAllocationPriorityCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ResourceAllocationPriorityCommandType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ResourceAllocationPriorityCommandType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ResourceAllocationPriorityCommandType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
