...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ResourceAllocation {
            ...
            ResourceAllocationPriorityInfo::ResourceAllocationPriorityInfo (const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& priorities,const UMAA::Common::Measurement::NumericGUID& resourceId):
            ...
            ResourceAllocationPriorityInfo::ResourceAllocationPriorityInfo(ResourceAllocationPriorityInfo&& other_) OMG_NOEXCEPT  :m_priorities_ (std::move(other_.m_priorities_))
            ,
            m_resourceId_ (std::move(other_.m_resourceId_))
            {
            } 

            ResourceAllocationPriorityInfo& ResourceAllocationPriorityInfo::operator=(ResourceAllocationPriorityInfo&&  other_) OMG_NOEXCEPT {
                ResourceAllocationPriorityInfo tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ResourceAllocationPriorityInfo::swap(ResourceAllocationPriorityInfo& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
