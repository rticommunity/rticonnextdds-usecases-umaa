...
#ifndef ResourceAllocationPriorityInfo_2029097492_hpp
#define ResourceAllocationPriorityInfo_2029097492_hpp
        ...
        namespace ResourceAllocation {
            ...
            class NDDSUSERDllExport ResourceAllocationPriorityInfo {
              public:
                ...
                ResourceAllocationPriorityInfo(const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& priorities,const UMAA::Common::Measurement::NumericGUID& resourceId);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                ResourceAllocationPriorityInfo (ResourceAllocationPriorityInfo&&) = default;
                ResourceAllocationPriorityInfo& operator=(ResourceAllocationPriorityInfo&&) = default;
                ResourceAllocationPriorityInfo& operator=(const ResourceAllocationPriorityInfo&) = default;
                ResourceAllocationPriorityInfo(const ResourceAllocationPriorityInfo&) = default;
                #else
                ResourceAllocationPriorityInfo(ResourceAllocationPriorityInfo&& other_) OMG_NOEXCEPT;  
                ResourceAllocationPriorityInfo& operator=(ResourceAllocationPriorityInfo&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(ResourceAllocationPriorityInfo& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ResourceAllocationPriorityInfo& a, ResourceAllocationPriorityInfo& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct is_topic_type< UMAA::SO::ResourceAllocation::ResourceAllocationPriorityInfo > : public ::dds::core::true_type {};
        ...
        struct topic_type_support< UMAA::SO::ResourceAllocation::ResourceAllocationPriorityInfo > {
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::SO::ResourceAllocation::ResourceAllocationPriorityInfo& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
...
#endif // ResourceAllocationPriorityInfo_2029097492_hpp
