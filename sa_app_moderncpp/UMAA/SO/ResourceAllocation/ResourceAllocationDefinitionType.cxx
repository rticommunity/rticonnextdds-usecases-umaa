...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ResourceAllocation {
            ...
            ResourceAllocationDefinitionType::ResourceAllocationDefinitionType (const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& relatedSources,const UMAA::Common::Measurement::NumericGUID& resourceId):
                m_relatedSources_( relatedSources ),
                m_resourceId_( resourceId ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ResourceAllocationDefinitionType::ResourceAllocationDefinitionType(ResourceAllocationDefinitionType&& other_) OMG_NOEXCEPT  :m_relatedSources_ (std::move(other_.m_relatedSources_))
            ,
            m_resourceId_ (std::move(other_.m_resourceId_))
            {
            } 

            ResourceAllocationDefinitionType& ResourceAllocationDefinitionType::operator=(ResourceAllocationDefinitionType&&  other_) OMG_NOEXCEPT {
                ResourceAllocationDefinitionType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ResourceAllocationDefinitionType::swap(ResourceAllocationDefinitionType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionType > {
            static DDS_TypeCode * get()
            {
                ...
                ResourceAllocationDefinitionType_g_tc_relatedSources_sequence = initialize_sequence_typecode< ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L > >((100L));

                ResourceAllocationDefinitionType_g_tc._data._annotations._allowedDataRepresentationMask = 5;

                ResourceAllocationDefinitionType_g_tc_relatedSources_sequence._data._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ...
                ResourceAllocationDefinitionType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
...
namespace dds { 
    namespace topic {
        void topic_type_support< UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionTypePlugin_new,
                UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionType >::to_cdr_buffer(
            ...
            ::dds::core::policy::DataRepresentationId representation)
        {
            ...
            RTIBool ok = ResourceAllocationDefinitionTypePlugin_serialize_to_cdr_buffer(
                NULL, 
                &length,
                &sample,
                representation);
            ...
            ok = ResourceAllocationDefinitionTypePlugin_serialize_to_cdr_buffer(
                &buffer[0], 
                &length, 
                &sample,
                representation);
        ...
        void topic_type_support< UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionType >::from_cdr_buffer(UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionType& sample, 
        const std::vector<char>& buffer)
        {

            RTIBool ok  = ResourceAllocationDefinitionTypePlugin_deserialize_from_cdr_buffer(
                &sample, 
                &buffer[0], 
                static_cast<unsigned int>(buffer.size()));
            ::rti::core::check_return_code(ok ? DDS_RETCODE_OK : DDS_RETCODE_ERROR,
            "Failed to create UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionType from cdr buffer");
        }
