...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ResourceAllocation {
            ...
            ResourceAllocationReportType::ResourceAllocationReportType (const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& controlInfoSetID):
                m_source_( source ),
                m_timeStamp_( timeStamp ),
                m_controlInfoSetID_( controlInfoSetID ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ResourceAllocationReportType::ResourceAllocationReportType(ResourceAllocationReportType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            m_timeStamp_ (std::move(other_.m_timeStamp_))
            ,
            m_controlInfoSetID_ (std::move(other_.m_controlInfoSetID_))
            {
            } 

            ResourceAllocationReportType& ResourceAllocationReportType::operator=(ResourceAllocationReportType&&  other_) OMG_NOEXCEPT {
                ResourceAllocationReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ResourceAllocationReportType::swap(ResourceAllocationReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            ResourceAllocationReportType_ControlinfoSet::ResourceAllocationReportType_ControlinfoSet (const ::dds::core::optional< UMAA::SO::ResourceAllocation::ResourceAllocationControlSession >& controlSession,const UMAA::Common::Measurement::NumericGUID& resourceId,const UMAA::Common::Measurement::NumericGUID& controlInfoSetID,const UMAA::Common::Measurement::DateTime& controlInfoTimestamp) :
                UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo(controlSession,resourceId ),
                m_controlInfoSetID_( controlInfoSetID ),
                m_controlInfoTimestamp_( controlInfoTimestamp ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ResourceAllocationReportType_ControlinfoSet::ResourceAllocationReportType_ControlinfoSet(ResourceAllocationReportType_ControlinfoSet&& other_) OMG_NOEXCEPT  : 
            UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo(std::move(other_)),
            m_controlInfoSetID_ (std::move(other_.m_controlInfoSetID_))
            ,
            m_controlInfoTimestamp_ (std::move(other_.m_controlInfoTimestamp_))
            {
            } 

            ResourceAllocationReportType_ControlinfoSet& ResourceAllocationReportType_ControlinfoSet::operator=(ResourceAllocationReportType_ControlinfoSet&&  other_) OMG_NOEXCEPT {
                ResourceAllocationReportType_ControlinfoSet tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ResourceAllocationReportType_ControlinfoSet::swap(ResourceAllocationReportType_ControlinfoSet& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
