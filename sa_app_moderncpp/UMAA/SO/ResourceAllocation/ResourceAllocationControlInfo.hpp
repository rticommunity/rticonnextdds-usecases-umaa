...
#ifndef ResourceAllocationControlInfo_616192345_hpp
#define ResourceAllocationControlInfo_616192345_hpp
        ...
        namespace ResourceAllocation {
            ...
            class NDDSUSERDllExport ResourceAllocationControlInfo {
              public:
                ...
                ResourceAllocationControlInfo(const ::dds::core::optional< UMAA::SO::ResourceAllocation::ResourceAllocationControlSession >& controlSession,const UMAA::Common::Measurement::NumericGUID& resourceId);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                ResourceAllocationControlInfo (ResourceAllocationControlInfo&&) = default;
                ResourceAllocationControlInfo& operator=(ResourceAllocationControlInfo&&) = default;
                ResourceAllocationControlInfo& operator=(const ResourceAllocationControlInfo&) = default;
                ResourceAllocationControlInfo(const ResourceAllocationControlInfo&) = default;
                #else
                ResourceAllocationControlInfo(ResourceAllocationControlInfo&& other_) OMG_NOEXCEPT;  
                ResourceAllocationControlInfo& operator=(ResourceAllocationControlInfo&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                ::dds::core::optional< UMAA::SO::ResourceAllocation::ResourceAllocationControlSession >& controlSession() OMG_NOEXCEPT {
                    return m_controlSession_;
                }

                const ::dds::core::optional< UMAA::SO::ResourceAllocation::ResourceAllocationControlSession >& controlSession() const OMG_NOEXCEPT {
                    return m_controlSession_;
                }
                ...
                void swap(ResourceAllocationControlInfo& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(ResourceAllocationControlInfo& a, ResourceAllocationControlInfo& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct is_topic_type< UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo > : public ::dds::core::true_type {};
        ...
        struct topic_type_support< UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo > {
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
...
#endif // ResourceAllocationControlInfo_616192345_hpp
