...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            */
            typedef  class ResourceAllocationDefinitionType ResourceAllocationDefinitionTypeKeyHolder;
            ...
            #define ResourceAllocationDefinitionTypePlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
            #define ResourceAllocationDefinitionTypePlugin_return_key PRESTypePluginDefaultEndpointData_returnKey
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern ResourceAllocationDefinitionType*
            ResourceAllocationDefinitionTypePluginSupport_create_key_ex(RTIBool allocate_pointers);

            NDDSUSERDllExport extern ResourceAllocationDefinitionType*
            ResourceAllocationDefinitionTypePluginSupport_create_key(void);

            NDDSUSERDllExport extern void 
            ResourceAllocationDefinitionTypePluginSupport_destroy_key_ex(
                ResourceAllocationDefinitionTypeKeyHolder *key,RTIBool deallocate_pointers);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            ResourceAllocationDefinitionTypePlugin_instance_to_key(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationDefinitionTypeKeyHolder *key, 
                const ResourceAllocationDefinitionType *instance);

            NDDSUSERDllExport extern RTIBool 
            ResourceAllocationDefinitionTypePlugin_key_to_instance(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationDefinitionType *instance, 
                const ResourceAllocationDefinitionTypeKeyHolder *key);
            ...
            ResourceAllocationDefinitionTypePlugin_new(void);

            NDDSUSERDllExport extern void
            ResourceAllocationDefinitionTypePlugin_delete(struct PRESTypePlugin *);
