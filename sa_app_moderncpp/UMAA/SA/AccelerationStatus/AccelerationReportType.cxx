...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace AccelerationStatus {
            ...
            AccelerationReportType::AccelerationReportType (const UMAA::Common::Measurement::Acceleration3D_PlatformXYZ& acceleration,const UMAA::Common::Measurement::CovarianceNEDAccelerationAccelerationType& accelerationCovariance,const UMAA::Common::Measurement::OrientationAcceleration3D& attitudeAcceleration,const UMAA::Common::Measurement::CovarianceOrientationAccelerationAccelerationType& rotationalAccelerationCovariance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_acceleration_( acceleration ),
                m_accelerationCovariance_( accelerationCovariance ),
                m_attitudeAcceleration_( attitudeAcceleration ),
                m_rotationalAccelerationCovariance_( rotationalAccelerationCovariance ),
                m_source_( source ),
            ...
            AccelerationReportType::AccelerationReportType(AccelerationReportType&& other_) OMG_NOEXCEPT  :m_acceleration_ (std::move(other_.m_acceleration_))
            ,
            m_accelerationCovariance_ (std::move(other_.m_accelerationCovariance_))
            ,
            m_attitudeAcceleration_ (std::move(other_.m_attitudeAcceleration_))
            ,
            m_rotationalAccelerationCovariance_ (std::move(other_.m_rotationalAccelerationCovariance_))
            ,
            ...
            AccelerationReportType& AccelerationReportType::operator=(AccelerationReportType&&  other_) OMG_NOEXCEPT {
                AccelerationReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AccelerationReportType::swap(AccelerationReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
