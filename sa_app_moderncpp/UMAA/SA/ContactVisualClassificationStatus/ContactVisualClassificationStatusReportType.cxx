...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace ContactVisualClassificationStatus {
            ...
            ContactVisualClassificationStatusReportType::ContactVisualClassificationStatusReportType (double confidence,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& contactID,const UMAA::Common::MaritimeEnumeration::VisualClassificationEnumType::VisualClassificationEnumType& visualClassification):
                m_confidence_( confidence ),
                m_source_( source ),
                m_timeStamp_( timeStamp ),
                m_contactID_( contactID ),
                m_visualClassification_( visualClassification ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ContactVisualClassificationStatusReportType::ContactVisualClassificationStatusReportType(ContactVisualClassificationStatusReportType&& other_) OMG_NOEXCEPT  :m_confidence_ (std::move(other_.m_confidence_))
            ,
            m_source_ (std::move(other_.m_source_))
            ,
            m_timeStamp_ (std::move(other_.m_timeStamp_))
            ,
            m_contactID_ (std::move(other_.m_contactID_))
            ,
            m_visualClassification_ (std::move(other_.m_visualClassification_))
            {
            } 

            ContactVisualClassificationStatusReportType& ContactVisualClassificationStatusReportType::operator=(ContactVisualClassificationStatusReportType&&  other_) OMG_NOEXCEPT {
                ContactVisualClassificationStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ContactVisualClassificationStatusReportType::swap(ContactVisualClassificationStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool ContactVisualClassificationStatusReportType::operator == (const ContactVisualClassificationStatusReportType& other_) const {
                if (m_confidence_ != other_.m_confidence_) {
                    return false;
                }
