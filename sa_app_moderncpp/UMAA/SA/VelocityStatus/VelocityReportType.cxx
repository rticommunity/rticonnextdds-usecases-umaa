...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace VelocityStatus {
            ...
            VelocityReportType::VelocityReportType (const UMAA::Common::Measurement::OrientationVelocity3D& attitudeRate,const ::dds::core::optional< UMAA::Common::Measurement::CovarianceOrientationType >& attitudeRateCovariance,const ::dds::core::optional< UMAA::Common::MaritimeEnumeration::VehicleSpeedModeEnumType::VehicleSpeedModeEnumType >& mode,const UMAA::Common::Measurement::Velocity3D_PlatformNED& velocity,const ::dds::core::optional< UMAA::Common::Measurement::CovarianceVelocityVelocityType >& velocityCovariance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_attitudeRate_( attitudeRate ),
                m_attitudeRateCovariance_( attitudeRateCovariance ),
                m_mode_( mode ),
                m_velocity_( velocity ),
                m_velocityCovariance_( velocityCovariance ),
                m_source_( source ),
            ...
            VelocityReportType::VelocityReportType(VelocityReportType&& other_) OMG_NOEXCEPT  :m_attitudeRate_ (std::move(other_.m_attitudeRate_))
            ,
            m_attitudeRateCovariance_ (std::move(other_.m_attitudeRateCovariance_))
            ,
            m_mode_ (std::move(other_.m_mode_))
            ,
            m_velocity_ (std::move(other_.m_velocity_))
            ,
            m_velocityCovariance_ (std::move(other_.m_velocityCovariance_))
            ,
            ...
            VelocityReportType& VelocityReportType::operator=(VelocityReportType&&  other_) OMG_NOEXCEPT {
                VelocityReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void VelocityReportType::swap(VelocityReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
