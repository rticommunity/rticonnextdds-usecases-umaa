    ...
    namespace SA {
        ...
        namespace StillImageSpecs {
            ...
            StillImageSpecsReportType::StillImageSpecsReportType (bool supportedBMP,bool supportedCGA_320x200,bool supportedCIF_1408x1152,bool supportedCIF_352x288,bool supportedCIF_704x576,bool supportedCR2,bool supportedDNG,bool supportedEGA_640x350,bool supportedGIF,bool supportedHD1080_1920x1080,bool supportedHD480_852x480,bool supportedHD720_1280x720,bool supportedHSXGA_5120x4096,bool supportedJPEG,bool supportedNEF,bool supportedPGM,bool supportedPNG,bool supportedPNM,bool supportedPPM,bool supportedQCIF_176x144,bool supportedQQVGA_160x120,bool supportedQSXGA_2560x2048,bool supportedQVGA_320x240,bool supportedQXGA_2048x1536,bool supportedSQCIF_128x96,bool supportedSVGA_800x600,bool supportedSXGA_1280x1024,bool supportedTIFF,bool supportedUXGA_1600x1200,bool supportedVGA_640x480,bool supportedWHSXGA_6400x4096,bool supportedWHUXGA_7680x4800,bool supportedWOXGA_2560x1600,bool supportedWQSXGA_3200x2048,bool supportedWQUXGA_3840x2400,bool supportedWSXGA_1600x1024,bool supportedWUXGA_1920x1200,bool supportedWVGA_852x480,bool supportedWXGA_1366x768,bool supportedXGA_1024x768,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                ...
                m_supportedCR2_( supportedCR2 ),
                m_supportedDNG_( supportedDNG ),
                m_supportedEGA_640x350_( supportedEGA_640x350 ),
                m_supportedGIF_( supportedGIF ),
                ...
                m_supportedJPEG_( supportedJPEG ),
                m_supportedNEF_( supportedNEF ),
                m_supportedPGM_( supportedPGM ),
                m_supportedPNG_( supportedPNG ),
                m_supportedPNM_( supportedPNM ),
                m_supportedPPM_( supportedPPM ),
                ...
                m_supportedTIFF_( supportedTIFF ),
            ...
            StillImageSpecsReportType::StillImageSpecsReportType(StillImageSpecsReportType&& other_) OMG_NOEXCEPT  :m_supportedBMP_ (std::move(other_.m_supportedBMP_))
            ,
            ...
            ,
            m_supportedCR2_ (std::move(other_.m_supportedCR2_))
            ,
            m_supportedDNG_ (std::move(other_.m_supportedDNG_))
            ,
            m_supportedEGA_640x350_ (std::move(other_.m_supportedEGA_640x350_))
            ,
            m_supportedGIF_ (std::move(other_.m_supportedGIF_))
            ,
            ...
            ,
            m_supportedJPEG_ (std::move(other_.m_supportedJPEG_))
            ,
            m_supportedNEF_ (std::move(other_.m_supportedNEF_))
            ,
            m_supportedPGM_ (std::move(other_.m_supportedPGM_))
            ,
            m_supportedPNG_ (std::move(other_.m_supportedPNG_))
            ,
            m_supportedPNM_ (std::move(other_.m_supportedPNM_))
            ,
            m_supportedPPM_ (std::move(other_.m_supportedPPM_))
            ,
            ...
            ,
            m_supportedTIFF_ (std::move(other_.m_supportedTIFF_))
            ,
            ...
            StillImageSpecsReportType& StillImageSpecsReportType::operator=(StillImageSpecsReportType&&  other_) OMG_NOEXCEPT {
                StillImageSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StillImageSpecsReportType::swap(StillImageSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
