...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace FeatureImageStatus {
            ...
            FeatureImageReportType::FeatureImageReportType (const ::dds::core::optional< UMAA::SA::BoundingBox::BoundingBoxType >& boundingBox,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& featureID,const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& imageID):
            ...
            FeatureImageReportType::FeatureImageReportType(FeatureImageReportType&& other_) OMG_NOEXCEPT  :m_boundingBox_ (std::move(other_.m_boundingBox_))
            ,
            ...
            FeatureImageReportType& FeatureImageReportType::operator=(FeatureImageReportType&&  other_) OMG_NOEXCEPT {
                FeatureImageReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void FeatureImageReportType::swap(FeatureImageReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
