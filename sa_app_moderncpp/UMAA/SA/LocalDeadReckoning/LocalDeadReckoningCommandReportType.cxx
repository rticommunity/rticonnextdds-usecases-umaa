...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace LocalDeadReckoning {
            ...
            LocalDeadReckoningCommandReportType::LocalDeadReckoningCommandReportType(LocalDeadReckoningCommandReportType&& other_) OMG_NOEXCEPT  :m_attitude_ (std::move(other_.m_attitude_))
            ,
            ...
            LocalDeadReckoningCommandReportType& LocalDeadReckoningCommandReportType::operator=(LocalDeadReckoningCommandReportType&&  other_) OMG_NOEXCEPT {
                LocalDeadReckoningCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void LocalDeadReckoningCommandReportType::swap(LocalDeadReckoningCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
