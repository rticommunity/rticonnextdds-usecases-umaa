...
#ifndef LocalDeadReckoningCommandType_1444791514_hpp
#define LocalDeadReckoningCommandType_1444791514_hpp
...
namespace UMAA {
    namespace SA {
        namespace LocalDeadReckoning {
            ...
            static const std::string LocalDeadReckoningCommand_TOPIC = "UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommand";

            class NDDSUSERDllExport LocalDeadReckoningCommandType {
              public:
                LocalDeadReckoningCommandType();

                LocalDeadReckoningCommandType(const UMAA::Common::Measurement::Orientation3D_PlatformXYZ& attitude,const UMAA::Common::Measurement::CovarianceOrientationType& attitudeCovariance,const UMAA::Common::Measurement::ElevationType& elevation,const UMAA::Common::Measurement::Position3D_PlatformXYZ& position,const UMAA::Common::Measurement::CovariancePositionVelocityType& xyPositionCovariance,const UMAA::Common::Measurement::CovariancePositionVelocityType& zPositionCovariance,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                LocalDeadReckoningCommandType (LocalDeadReckoningCommandType&&) = default;
                LocalDeadReckoningCommandType& operator=(LocalDeadReckoningCommandType&&) = default;
                LocalDeadReckoningCommandType& operator=(const LocalDeadReckoningCommandType&) = default;
                LocalDeadReckoningCommandType(const LocalDeadReckoningCommandType&) = default;
                #else
                LocalDeadReckoningCommandType(LocalDeadReckoningCommandType&& other_) OMG_NOEXCEPT;  
                LocalDeadReckoningCommandType& operator=(LocalDeadReckoningCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const LocalDeadReckoningCommandType& other_) const;
                bool operator != (const LocalDeadReckoningCommandType& other_) const;

                void swap(LocalDeadReckoningCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(LocalDeadReckoningCommandType& a, LocalDeadReckoningCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const LocalDeadReckoningCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType";
            }
        };

        template<>
        struct is_topic_type< UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType > {
        ...
        template <>
        struct extensibility< UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandType > {
...
#endif // LocalDeadReckoningCommandType_1444791514_hpp
