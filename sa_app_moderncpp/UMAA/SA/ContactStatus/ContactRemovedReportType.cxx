...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace ContactStatus {
            ...
            ContactRemovedReportType::ContactRemovedReportType (const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& contactID,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            ContactRemovedReportType::ContactRemovedReportType(ContactRemovedReportType&& other_) OMG_NOEXCEPT  :m_contactID_ (std::move(other_.m_contactID_))
            ,
            ...
            ContactRemovedReportType& ContactRemovedReportType::operator=(ContactRemovedReportType&&  other_) OMG_NOEXCEPT {
                ContactRemovedReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ContactRemovedReportType::swap(ContactRemovedReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
