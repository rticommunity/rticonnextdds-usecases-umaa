...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace ImageStatus {
            ...
            ImageRemovedReportType::ImageRemovedReportType (const ::rti::core::bounded_sequence< UMAA::Common::Measurement::NumericGUID, 100L >& imageID,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_imageID_( imageID ),
                m_source_( source ),
            ...
            ImageRemovedReportType::ImageRemovedReportType(ImageRemovedReportType&& other_) OMG_NOEXCEPT  :m_imageID_ (std::move(other_.m_imageID_))
            ,
            ...
            ImageRemovedReportType& ImageRemovedReportType::operator=(ImageRemovedReportType&&  other_) OMG_NOEXCEPT {
                ImageRemovedReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ImageRemovedReportType::swap(ImageRemovedReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
