...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace GlobalPoseConfig {
            ...
            GlobalPoseConfigReportType::GlobalPoseConfigReportType (double magneticVariation,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_magneticVariation_( magneticVariation ),
                m_source_( source ),
            ...
            GlobalPoseConfigReportType::GlobalPoseConfigReportType(GlobalPoseConfigReportType&& other_) OMG_NOEXCEPT  :m_magneticVariation_ (std::move(other_.m_magneticVariation_))
            ,
            ...
            GlobalPoseConfigReportType& GlobalPoseConfigReportType::operator=(GlobalPoseConfigReportType&&  other_) OMG_NOEXCEPT {
                GlobalPoseConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalPoseConfigReportType::swap(GlobalPoseConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool GlobalPoseConfigReportType::operator == (const GlobalPoseConfigReportType& other_) const {
                if (m_magneticVariation_ != other_.m_magneticVariation_) {
                    return false;
                }
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::SA::GlobalPoseConfig::GlobalPoseConfigReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member GlobalPoseConfigReportType_g_tc_members[3]=
                {
                ...
                GlobalPoseConfigReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::MagneticVariation_AliasTag_t>::get().native();
                GlobalPoseConfigReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalPoseConfigReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();

                /* Initialize the values for member annotations. */
                GlobalPoseConfigReportType_g_tc_members[0]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalPoseConfigReportType_g_tc_members[0]._annotations._defaultValue._u.double_value = 0.0;
                GlobalPoseConfigReportType_g_tc_members[0]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalPoseConfigReportType_g_tc_members[0]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                GlobalPoseConfigReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalPoseConfigReportType_g_tc_members[0]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo GlobalPoseConfigReportType_g_memberAccessInfos[3] =
                ...
                GlobalPoseConfigReportType_g_memberAccessInfos[2].bindingMemberValueOffset[0] = 
