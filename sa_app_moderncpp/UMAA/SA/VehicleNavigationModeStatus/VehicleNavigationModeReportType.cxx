...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace VehicleNavigationModeStatus {
            ...
            VehicleNavigationModeReportType::VehicleNavigationModeReportType (const std::string& mode,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_mode_( mode ),
                m_source_( source ),
            ...
            VehicleNavigationModeReportType::VehicleNavigationModeReportType(VehicleNavigationModeReportType&& other_) OMG_NOEXCEPT  :m_mode_ (std::move(other_.m_mode_))
            ,
            ...
            VehicleNavigationModeReportType& VehicleNavigationModeReportType::operator=(VehicleNavigationModeReportType&&  other_) OMG_NOEXCEPT {
                VehicleNavigationModeReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void VehicleNavigationModeReportType::swap(VehicleNavigationModeReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
