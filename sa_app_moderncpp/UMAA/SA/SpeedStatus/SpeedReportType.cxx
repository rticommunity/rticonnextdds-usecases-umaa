...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace SpeedStatus {
            ...
            SpeedReportType::SpeedReportType (const ::dds::core::optional< double >& engineRPM,const ::dds::core::optional< double >& speedOverGround,const ::dds::core::optional< double >& speedThroughAir,const ::dds::core::optional< double >& speedThroughWater,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_engineRPM_( engineRPM ),
                m_speedOverGround_( speedOverGround ),
                m_speedThroughAir_( speedThroughAir ),
                m_speedThroughWater_( speedThroughWater ),
                m_source_( source ),
            ...
            SpeedReportType::SpeedReportType(SpeedReportType&& other_) OMG_NOEXCEPT  :m_engineRPM_ (std::move(other_.m_engineRPM_))
            ,
            m_speedOverGround_ (std::move(other_.m_speedOverGround_))
            ,
            m_speedThroughAir_ (std::move(other_.m_speedThroughAir_))
            ,
            m_speedThroughWater_ (std::move(other_.m_speedThroughWater_))
            ,
            ...
            SpeedReportType& SpeedReportType::operator=(SpeedReportType&&  other_) OMG_NOEXCEPT {
                SpeedReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SpeedReportType::swap(SpeedReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool SpeedReportType::operator == (const SpeedReportType& other_) const {
                if (m_engineRPM_ != other_.m_engineRPM_) {
                    return false;
                }
                if (m_speedOverGround_ != other_.m_speedOverGround_) {
                    return false;
                }
                if (m_speedThroughAir_ != other_.m_speedThroughAir_) {
                    return false;
                }
                if (m_speedThroughWater_ != other_.m_speedThroughWater_) {
                    return false;
                }
