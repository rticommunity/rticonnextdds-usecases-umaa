...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace WindStatus {
            ...
            WindStatusReportType::WindStatusReportType (const ::dds::core::optional< double >& relativeAverageDirection,const ::dds::core::optional< double >& relativeAverageSpeed,const ::dds::core::optional< double >& relativeInstantaneousDirection,const ::dds::core::optional< double >& relativeInstantaneousSpeed,const ::dds::core::optional< double >& relativeMaximumDirection,const ::dds::core::optional< double >& relativeMaximumSpeed,const ::dds::core::optional< double >& relativeMinimumDirection,const ::dds::core::optional< double >& relativeMinimumSpeed,const ::dds::core::optional< double >& straightDeckCrossSpeed,const ::dds::core::optional< double >& straightDeckHeadSpeed,const ::dds::core::optional< double >& trueAverageDirection,const ::dds::core::optional< double >& trueAverageSpeed,const ::dds::core::optional< double >& trueInstantaneousDirection,const ::dds::core::optional< double >& trueInstantaneousSpeed,const ::dds::core::optional< double >& trueMaximumDirection,const ::dds::core::optional< double >& trueMaximumSpeed,const ::dds::core::optional< double >& trueMinimumDirection,const ::dds::core::optional< double >& trueMinimumSpeed,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_relativeAverageDirection_( relativeAverageDirection ),
                m_relativeAverageSpeed_( relativeAverageSpeed ),
                m_relativeInstantaneousDirection_( relativeInstantaneousDirection ),
                m_relativeInstantaneousSpeed_( relativeInstantaneousSpeed ),
                m_relativeMaximumDirection_( relativeMaximumDirection ),
                m_relativeMaximumSpeed_( relativeMaximumSpeed ),
                m_relativeMinimumDirection_( relativeMinimumDirection ),
                m_relativeMinimumSpeed_( relativeMinimumSpeed ),
                m_straightDeckCrossSpeed_( straightDeckCrossSpeed ),
                m_straightDeckHeadSpeed_( straightDeckHeadSpeed ),
                m_trueAverageDirection_( trueAverageDirection ),
                m_trueAverageSpeed_( trueAverageSpeed ),
                m_trueInstantaneousDirection_( trueInstantaneousDirection ),
                m_trueInstantaneousSpeed_( trueInstantaneousSpeed ),
                m_trueMaximumDirection_( trueMaximumDirection ),
                m_trueMaximumSpeed_( trueMaximumSpeed ),
                m_trueMinimumDirection_( trueMinimumDirection ),
                m_trueMinimumSpeed_( trueMinimumSpeed ),
                m_source_( source ),
            ...
            WindStatusReportType::WindStatusReportType(WindStatusReportType&& other_) OMG_NOEXCEPT  :m_relativeAverageDirection_ (std::move(other_.m_relativeAverageDirection_))
            ,
            m_relativeAverageSpeed_ (std::move(other_.m_relativeAverageSpeed_))
            ,
            m_relativeInstantaneousDirection_ (std::move(other_.m_relativeInstantaneousDirection_))
            ,
            m_relativeInstantaneousSpeed_ (std::move(other_.m_relativeInstantaneousSpeed_))
            ,
            m_relativeMaximumDirection_ (std::move(other_.m_relativeMaximumDirection_))
            ,
            m_relativeMaximumSpeed_ (std::move(other_.m_relativeMaximumSpeed_))
            ,
            m_relativeMinimumDirection_ (std::move(other_.m_relativeMinimumDirection_))
            ,
            m_relativeMinimumSpeed_ (std::move(other_.m_relativeMinimumSpeed_))
            ,
            m_straightDeckCrossSpeed_ (std::move(other_.m_straightDeckCrossSpeed_))
            ,
            m_straightDeckHeadSpeed_ (std::move(other_.m_straightDeckHeadSpeed_))
            ,
            m_trueAverageDirection_ (std::move(other_.m_trueAverageDirection_))
            ,
            m_trueAverageSpeed_ (std::move(other_.m_trueAverageSpeed_))
            ,
            m_trueInstantaneousDirection_ (std::move(other_.m_trueInstantaneousDirection_))
            ,
            m_trueInstantaneousSpeed_ (std::move(other_.m_trueInstantaneousSpeed_))
            ,
            m_trueMaximumDirection_ (std::move(other_.m_trueMaximumDirection_))
            ,
            m_trueMaximumSpeed_ (std::move(other_.m_trueMaximumSpeed_))
            ,
            m_trueMinimumDirection_ (std::move(other_.m_trueMinimumDirection_))
            ,
            m_trueMinimumSpeed_ (std::move(other_.m_trueMinimumSpeed_))
            ,
            ...
            WindStatusReportType& WindStatusReportType::operator=(WindStatusReportType&&  other_) OMG_NOEXCEPT {
                WindStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WindStatusReportType::swap(WindStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool WindStatusReportType::operator == (const WindStatusReportType& other_) const {
                if (m_relativeAverageDirection_ != other_.m_relativeAverageDirection_) {
                    return false;
                }
                if (m_relativeAverageSpeed_ != other_.m_relativeAverageSpeed_) {
                    return false;
                }
                if (m_relativeInstantaneousDirection_ != other_.m_relativeInstantaneousDirection_) {
                    return false;
                }
                if (m_relativeInstantaneousSpeed_ != other_.m_relativeInstantaneousSpeed_) {
                    return false;
                }
                if (m_relativeMaximumDirection_ != other_.m_relativeMaximumDirection_) {
                    return false;
                }
                if (m_relativeMaximumSpeed_ != other_.m_relativeMaximumSpeed_) {
                    return false;
                }
                if (m_relativeMinimumDirection_ != other_.m_relativeMinimumDirection_) {
                    return false;
                }
                if (m_relativeMinimumSpeed_ != other_.m_relativeMinimumSpeed_) {
                    return false;
                }
                if (m_straightDeckCrossSpeed_ != other_.m_straightDeckCrossSpeed_) {
                    return false;
                }
                if (m_straightDeckHeadSpeed_ != other_.m_straightDeckHeadSpeed_) {
                    return false;
                }
                if (m_trueAverageDirection_ != other_.m_trueAverageDirection_) {
                    return false;
                }
                if (m_trueAverageSpeed_ != other_.m_trueAverageSpeed_) {
                    return false;
                }
                if (m_trueInstantaneousDirection_ != other_.m_trueInstantaneousDirection_) {
                    return false;
                }
                if (m_trueInstantaneousSpeed_ != other_.m_trueInstantaneousSpeed_) {
                    return false;
                }
                if (m_trueMaximumDirection_ != other_.m_trueMaximumDirection_) {
                    return false;
                }
                if (m_trueMaximumSpeed_ != other_.m_trueMaximumSpeed_) {
                    return false;
                }
                if (m_trueMinimumDirection_ != other_.m_trueMinimumDirection_) {
                    return false;
                }
                if (m_trueMinimumSpeed_ != other_.m_trueMinimumSpeed_) {
                    return false;
                }
