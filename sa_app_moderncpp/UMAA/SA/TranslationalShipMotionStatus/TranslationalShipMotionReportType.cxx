...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace TranslationalShipMotionStatus {
            ...
            TranslationalShipMotionReportType::TranslationalShipMotionReportType (const ::dds::core::optional< double >& heave,const ::dds::core::optional< double >& surge,const ::dds::core::optional< double >& sway,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_heave_( heave ),
                m_surge_( surge ),
                m_sway_( sway ),
                m_source_( source ),
            ...
            TranslationalShipMotionReportType::TranslationalShipMotionReportType(TranslationalShipMotionReportType&& other_) OMG_NOEXCEPT  :m_heave_ (std::move(other_.m_heave_))
            ,
            m_surge_ (std::move(other_.m_surge_))
            ,
            m_sway_ (std::move(other_.m_sway_))
            ,
            ...
            TranslationalShipMotionReportType& TranslationalShipMotionReportType::operator=(TranslationalShipMotionReportType&&  other_) OMG_NOEXCEPT {
                TranslationalShipMotionReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void TranslationalShipMotionReportType::swap(TranslationalShipMotionReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool TranslationalShipMotionReportType::operator == (const TranslationalShipMotionReportType& other_) const {
                if (m_heave_ != other_.m_heave_) {
                    return false;
                }
                if (m_surge_ != other_.m_surge_) {
                    return false;
                }
                if (m_sway_ != other_.m_sway_) {
                    return false;
                }
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::SA::TranslationalShipMotionStatus::TranslationalShipMotionReportType > {
            static DDS_TypeCode * get()
            {
                ...
                TranslationalShipMotionReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                TranslationalShipMotionReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();

                /* Initialize the values for member annotations. */
                TranslationalShipMotionReportType_g_tc_members[0]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                TranslationalShipMotionReportType_g_tc_members[0]._annotations._minValue._u.double_value = -50000LL;
                TranslationalShipMotionReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                TranslationalShipMotionReportType_g_tc_members[0]._annotations._maxValue._u.double_value = 50000ULL;

                TranslationalShipMotionReportType_g_tc_members[1]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                TranslationalShipMotionReportType_g_tc_members[1]._annotations._minValue._u.double_value = -20000000LL;
                TranslationalShipMotionReportType_g_tc_members[1]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                TranslationalShipMotionReportType_g_tc_members[1]._annotations._maxValue._u.double_value = 20000000ULL;

                TranslationalShipMotionReportType_g_tc_members[2]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                TranslationalShipMotionReportType_g_tc_members[2]._annotations._minValue._u.double_value = -20000000LL;
                TranslationalShipMotionReportType_g_tc_members[2]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                TranslationalShipMotionReportType_g_tc_members[2]._annotations._maxValue._u.double_value = 20000000ULL;
