...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace ContactCOLREGSClassificationStatus {
            ...
            ContactCOLREGSClassificationStatusReportType::ContactCOLREGSClassificationStatusReportType (double confidence,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::MaritimeEnumeration::COLREGSClassificationEnumType::COLREGSClassificationEnumType& colregsClassification,const UMAA::Common::Measurement::NumericGUID& contactID):
                m_confidence_( confidence ),
                m_source_( source ),
                m_timeStamp_( timeStamp ),
                m_colregsClassification_( colregsClassification ),
                m_contactID_( contactID ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            ContactCOLREGSClassificationStatusReportType::ContactCOLREGSClassificationStatusReportType(ContactCOLREGSClassificationStatusReportType&& other_) OMG_NOEXCEPT  :m_confidence_ (std::move(other_.m_confidence_))
            ,
            m_source_ (std::move(other_.m_source_))
            ,
            m_timeStamp_ (std::move(other_.m_timeStamp_))
            ,
            m_colregsClassification_ (std::move(other_.m_colregsClassification_))
            ,
            m_contactID_ (std::move(other_.m_contactID_))
            {
            } 

            ContactCOLREGSClassificationStatusReportType& ContactCOLREGSClassificationStatusReportType::operator=(ContactCOLREGSClassificationStatusReportType&&  other_) OMG_NOEXCEPT {
                ContactCOLREGSClassificationStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ContactCOLREGSClassificationStatusReportType::swap(ContactCOLREGSClassificationStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
