...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace GlobalDeadReckoning {
            ...
            GlobalDeadReckoningCommandReportType::GlobalDeadReckoningCommandReportType(GlobalDeadReckoningCommandReportType&& other_) OMG_NOEXCEPT  :m_attitude_ (std::move(other_.m_attitude_))
            ,
            ...
            GlobalDeadReckoningCommandReportType& GlobalDeadReckoningCommandReportType::operator=(GlobalDeadReckoningCommandReportType&&  other_) OMG_NOEXCEPT {
                GlobalDeadReckoningCommandReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GlobalDeadReckoningCommandReportType::swap(GlobalDeadReckoningCommandReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
