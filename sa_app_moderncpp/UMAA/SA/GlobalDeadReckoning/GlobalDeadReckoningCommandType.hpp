...
namespace UMAA {
    namespace SA {
        namespace GlobalDeadReckoning {
            ...
            static const std::string GlobalDeadReckoningCommand_TOPIC = "UMAA::SA::GlobalDeadReckoning::GlobalDeadReckoningCommand";
            ...
            class NDDSUSERDllExport GlobalDeadReckoningCommandType {
              public:
                ...
                GlobalDeadReckoningCommandType (GlobalDeadReckoningCommandType&&) = default;
                GlobalDeadReckoningCommandType& operator=(GlobalDeadReckoningCommandType&&) = default;
                GlobalDeadReckoningCommandType& operator=(const GlobalDeadReckoningCommandType&) = default;
                GlobalDeadReckoningCommandType(const GlobalDeadReckoningCommandType&) = default;
                #else
                GlobalDeadReckoningCommandType(GlobalDeadReckoningCommandType&& other_) OMG_NOEXCEPT;  
                GlobalDeadReckoningCommandType& operator=(GlobalDeadReckoningCommandType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(GlobalDeadReckoningCommandType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GlobalDeadReckoningCommandType& a, GlobalDeadReckoningCommandType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
