...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace WaterCurrentStatus {
            ...
            WaterCurrentStatusReportType::WaterCurrentStatusReportType (double currentDrift,double currentSet,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_currentDrift_( currentDrift ),
                m_currentSet_( currentSet ),
                m_source_( source ),
            ...
            WaterCurrentStatusReportType::WaterCurrentStatusReportType(WaterCurrentStatusReportType&& other_) OMG_NOEXCEPT  :m_currentDrift_ (std::move(other_.m_currentDrift_))
            ,
            m_currentSet_ (std::move(other_.m_currentSet_))
            ,
            ...
            WaterCurrentStatusReportType& WaterCurrentStatusReportType::operator=(WaterCurrentStatusReportType&&  other_) OMG_NOEXCEPT {
                WaterCurrentStatusReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WaterCurrentStatusReportType::swap(WaterCurrentStatusReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool WaterCurrentStatusReportType::operator == (const WaterCurrentStatusReportType& other_) const {
                if (m_currentDrift_ != other_.m_currentDrift_) {
                    return false;
                }
                if (m_currentSet_ != other_.m_currentSet_) {
                    return false;
                }
