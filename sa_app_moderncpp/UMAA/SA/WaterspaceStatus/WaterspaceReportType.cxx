...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace WaterspaceStatus {
            ...
            WaterspaceReportType::WaterspaceReportType (const ::rti::core::bounded_sequence< UMAA::MM::BaseType::ZoneType, 100L >& zones,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_zones_( zones ),
                m_source_( source ),
            ...
            WaterspaceReportType::WaterspaceReportType(WaterspaceReportType&& other_) OMG_NOEXCEPT  :m_zones_ (std::move(other_.m_zones_))
            ,
            ...
            WaterspaceReportType& WaterspaceReportType::operator=(WaterspaceReportType&&  other_) OMG_NOEXCEPT {
                WaterspaceReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WaterspaceReportType::swap(WaterspaceReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
