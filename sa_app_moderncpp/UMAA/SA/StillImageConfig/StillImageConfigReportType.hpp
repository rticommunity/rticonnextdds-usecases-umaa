...
namespace UMAA {
    namespace SA {
        namespace StillImageConfig {
            ...
            static const std::string StillImageConfigReport_TOPIC = "UMAA::SA::StillImageConfig::StillImageConfigReport";

            class NDDSUSERDllExport StillImageConfigReportType {
              public:
                StillImageConfigReportType();

                StillImageConfigReportType(const UMAA::Common::MaritimeEnumeration::FrameSizeEnumType::FrameSizeEnumType& frameSize,const UMAA::SEM::SensorManagement::StillImageErrorType& stillImageError,const UMAA::Common::MaritimeEnumeration::ImageFormatEnumType::ImageFormatEnumType& supportedImageFormat,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                StillImageConfigReportType (StillImageConfigReportType&&) = default;
                StillImageConfigReportType& operator=(StillImageConfigReportType&&) = default;
                StillImageConfigReportType& operator=(const StillImageConfigReportType&) = default;
                StillImageConfigReportType(const StillImageConfigReportType&) = default;
                #else
                StillImageConfigReportType(StillImageConfigReportType&& other_) OMG_NOEXCEPT;  
                StillImageConfigReportType& operator=(StillImageConfigReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                UMAA::SEM::SensorManagement::StillImageErrorType& stillImageError() OMG_NOEXCEPT {
                    return m_stillImageError_;
                }

                const UMAA::SEM::SensorManagement::StillImageErrorType& stillImageError() const OMG_NOEXCEPT {
                    return m_stillImageError_;
                }
                ...
                UMAA::Common::MaritimeEnumeration::ImageFormatEnumType::ImageFormatEnumType& supportedImageFormat() OMG_NOEXCEPT {
                    return m_supportedImageFormat_;
                }

                const UMAA::Common::MaritimeEnumeration::ImageFormatEnumType::ImageFormatEnumType& supportedImageFormat() const OMG_NOEXCEPT {
                    return m_supportedImageFormat_;
                }
                ...
                void swap(StillImageConfigReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(StillImageConfigReportType& a, StillImageConfigReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
