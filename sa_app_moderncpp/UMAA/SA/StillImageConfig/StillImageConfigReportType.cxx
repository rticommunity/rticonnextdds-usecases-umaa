    ...
    namespace SA {
        ...
        namespace StillImageConfig {
            ...
            StillImageConfigReportType::StillImageConfigReportType (const UMAA::Common::MaritimeEnumeration::FrameSizeEnumType::FrameSizeEnumType& frameSize,const UMAA::SEM::SensorManagement::StillImageErrorType& stillImageError,const UMAA::Common::MaritimeEnumeration::ImageFormatEnumType::ImageFormatEnumType& supportedImageFormat,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                ...
                m_stillImageError_( stillImageError ),
                m_supportedImageFormat_( supportedImageFormat ),
                m_source_( source ),
            ...
            StillImageConfigReportType::StillImageConfigReportType(StillImageConfigReportType&& other_) OMG_NOEXCEPT  :m_frameSize_ (std::move(other_.m_frameSize_))
            ,
            m_stillImageError_ (std::move(other_.m_stillImageError_))
            ,
            m_supportedImageFormat_ (std::move(other_.m_supportedImageFormat_))
            ,
            ...
            StillImageConfigReportType& StillImageConfigReportType::operator=(StillImageConfigReportType&&  other_) OMG_NOEXCEPT {
                StillImageConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StillImageConfigReportType::swap(StillImageConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
