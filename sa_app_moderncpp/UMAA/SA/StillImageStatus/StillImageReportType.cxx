...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace StillImageStatus {
            ...
            StillImageReportType::StillImageReportType (bool coordinateSystem,const UMAA::Common::MaritimeEnumeration::ImageFormatEnumType::ImageFormatEnumType& imageFrame,const std::string& URI,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_coordinateSystem_( coordinateSystem ),
                m_imageFrame_( imageFrame ),
                m_URI_( URI ),
                m_source_( source ),
            ...
            StillImageReportType::StillImageReportType(StillImageReportType&& other_) OMG_NOEXCEPT  :m_coordinateSystem_ (std::move(other_.m_coordinateSystem_))
            ,
            m_imageFrame_ (std::move(other_.m_imageFrame_))
            ,
            ...
            StillImageReportType& StillImageReportType::operator=(StillImageReportType&&  other_) OMG_NOEXCEPT {
                StillImageReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StillImageReportType::swap(StillImageReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
