...
data type StillImageReportType from StillImageReportType.idl.
This example builds two applications, named StillImageReportType_publisher and
StillImageReportType_subscriber.
...
> make -f makefile_StillImageReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_StillImageReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the StillImageReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/StillImageReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/StillImageReportType_subscriber -d <domain_id> -s <sample_count>
