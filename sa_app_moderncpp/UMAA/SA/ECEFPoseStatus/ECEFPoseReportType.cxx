...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace ECEFPoseStatus {
            ...
            ECEFPoseReportType::ECEFPoseReportType (const UMAA::Common::Measurement::Orientation_PlatformECEF& attitude,double xPosition,double yPosition,double zPosition,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_attitude_( attitude ),
                m_xPosition_( xPosition ),
                m_yPosition_( yPosition ),
                m_zPosition_( zPosition ),
                m_source_( source ),
            ...
            ECEFPoseReportType::ECEFPoseReportType(ECEFPoseReportType&& other_) OMG_NOEXCEPT  :m_attitude_ (std::move(other_.m_attitude_))
            ,
            m_xPosition_ (std::move(other_.m_xPosition_))
            ,
            m_yPosition_ (std::move(other_.m_yPosition_))
            ,
            m_zPosition_ (std::move(other_.m_zPosition_))
            ,
            ...
            ECEFPoseReportType& ECEFPoseReportType::operator=(ECEFPoseReportType&&  other_) OMG_NOEXCEPT {
                ECEFPoseReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void ECEFPoseReportType::swap(ECEFPoseReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool ECEFPoseReportType::operator == (const ECEFPoseReportType& other_) const {
                ...
                if (m_xPosition_ != other_.m_xPosition_) {
                    return false;
                }
                if (m_yPosition_ != other_.m_yPosition_) {
                    return false;
                }
                if (m_zPosition_ != other_.m_zPosition_) {
                    return false;
                }
