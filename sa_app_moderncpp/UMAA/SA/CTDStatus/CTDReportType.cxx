...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace CTDStatus {
            ...
            CTDReportType::CTDReportType (double conductivity,const ::dds::core::optional< double >& density,double depth,const ::dds::core::optional< double >& salinity,const ::dds::core::optional< double >& soundVelocity,double temperature,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_conductivity_( conductivity ),
                m_density_( density ),
                m_depth_( depth ),
                m_salinity_( salinity ),
                m_soundVelocity_( soundVelocity ),
            ...
            CTDReportType::CTDReportType(CTDReportType&& other_) OMG_NOEXCEPT  :m_conductivity_ (std::move(other_.m_conductivity_))
            ,
            m_density_ (std::move(other_.m_density_))
            ,
            m_depth_ (std::move(other_.m_depth_))
            ,
            m_salinity_ (std::move(other_.m_salinity_))
            ,
            m_soundVelocity_ (std::move(other_.m_soundVelocity_))
            ,
            ...
            CTDReportType& CTDReportType::operator=(CTDReportType&&  other_) OMG_NOEXCEPT {
                CTDReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CTDReportType::swap(CTDReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool CTDReportType::operator == (const CTDReportType& other_) const {
                if (m_conductivity_ != other_.m_conductivity_) {
                    return false;
                }
                if (m_density_ != other_.m_density_) {
                    return false;
                }
                if (m_depth_ != other_.m_depth_) {
                    return false;
                }
                if (m_salinity_ != other_.m_salinity_) {
                    return false;
                }
                if (m_soundVelocity_ != other_.m_soundVelocity_) {
                    return false;
                }
