...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace CompartmentConfig {
            ...
            CompartmentConfigReportType::CompartmentConfigReportType (const std::string& name,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_name_( name ),
                m_source_( source ),
            ...
            CompartmentConfigReportType::CompartmentConfigReportType(CompartmentConfigReportType&& other_) OMG_NOEXCEPT  :m_name_ (std::move(other_.m_name_))
            ,
            ...
            CompartmentConfigReportType& CompartmentConfigReportType::operator=(CompartmentConfigReportType&&  other_) OMG_NOEXCEPT {
                CompartmentConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CompartmentConfigReportType::swap(CompartmentConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
