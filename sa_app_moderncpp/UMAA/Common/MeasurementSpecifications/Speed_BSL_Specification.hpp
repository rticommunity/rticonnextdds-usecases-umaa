        ...
        namespace MeasurementSpecifications {
            ...
            class NDDSUSERDllExport Speed_BSL_Specification {
              public:
                ...
                Speed_BSL_Specification(const ::rti::core::bounded_sequence< double, 100L >& lowerLimit,double stepSize,const ::rti::core::bounded_sequence< double, 100L >& upperLimit);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                Speed_BSL_Specification (Speed_BSL_Specification&&) = default;
                Speed_BSL_Specification& operator=(Speed_BSL_Specification&&) = default;
                Speed_BSL_Specification& operator=(const Speed_BSL_Specification&) = default;
                Speed_BSL_Specification(const Speed_BSL_Specification&) = default;
                #else
                Speed_BSL_Specification(Speed_BSL_Specification&& other_) OMG_NOEXCEPT;  
                Speed_BSL_Specification& operator=(Speed_BSL_Specification&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                ::rti::core::bounded_sequence< double, 100L >& lowerLimit() OMG_NOEXCEPT {
                    return m_lowerLimit_;
                }

                const ::rti::core::bounded_sequence< double, 100L >& lowerLimit() const OMG_NOEXCEPT {
                    return m_lowerLimit_;
                }
                ...
                ::rti::core::bounded_sequence< double, 100L >& upperLimit() OMG_NOEXCEPT {
                    return m_upperLimit_;
                }

                const ::rti::core::bounded_sequence< double, 100L >& upperLimit() const OMG_NOEXCEPT {
                    return m_upperLimit_;
                }
                ...
                void swap(Speed_BSL_Specification& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(Speed_BSL_Specification& a, Speed_BSL_Specification& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
