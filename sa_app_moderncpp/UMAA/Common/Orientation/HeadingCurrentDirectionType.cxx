...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            HeadingCurrentDirectionType::HeadingCurrentDirectionType (double headingCurrentDirection):
                m_headingCurrentDirection_( headingCurrentDirection ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            HeadingCurrentDirectionType::HeadingCurrentDirectionType(HeadingCurrentDirectionType&& other_) OMG_NOEXCEPT  :m_headingCurrentDirection_ (std::move(other_.m_headingCurrentDirection_))
            {
            } 

            HeadingCurrentDirectionType& HeadingCurrentDirectionType::operator=(HeadingCurrentDirectionType&&  other_) OMG_NOEXCEPT {
                HeadingCurrentDirectionType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void HeadingCurrentDirectionType::swap(HeadingCurrentDirectionType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool HeadingCurrentDirectionType::operator == (const HeadingCurrentDirectionType& other_) const {
                if (m_headingCurrentDirection_ != other_.m_headingCurrentDirection_) {
                    return false;
                }
                return true;
            }
