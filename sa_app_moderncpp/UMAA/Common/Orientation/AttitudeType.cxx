...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            AttitudeType::AttitudeType (const UMAA::Common::Measurement::Orientation3D& attitude):
                m_attitude_( attitude ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            AttitudeType::AttitudeType(AttitudeType&& other_) OMG_NOEXCEPT  :m_attitude_ (std::move(other_.m_attitude_))
            {
            } 

            AttitudeType& AttitudeType::operator=(AttitudeType&&  other_) OMG_NOEXCEPT {
                AttitudeType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AttitudeType::swap(AttitudeType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
