    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            namespace DirectionType_Specializations {
                ...
                DirectionType_Union::DirectionType_Union(DirectionType_Union&& other_) OMG_NOEXCEPT 
                {
                ...
                DirectionType_Union& DirectionType_Union::operator=(DirectionType_Union&&  other_) OMG_NOEXCEPT {
                    DirectionType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                DirectionType_Union::Union_::Union_(const UMAA::Common::Orientation::CourseType& CourseType_data,const UMAA::Common::Orientation::HeadingType& HeadingType_data):
                    m_CourseType_data_( CourseType_data ),
                    m_HeadingType_data_( HeadingType_data ) {
                }
                ...
                void DirectionType_Union::swap(DirectionType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const DirectionType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::Common::Orientation::DirectionType_Specializations::DirectionType_Selectors::HEADINGTYPE_SELECT):
                            {  
                                o << "HeadingType_data: " << sample.HeadingType_data() ;        } break ;
            ...
            DirectionType::DirectionType (const UMAA::Common::Orientation::DirectionType_Specializations::DirectionType_Union& DirectionType_subtypes):
                m_DirectionType_subtypes_( DirectionType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            DirectionType::DirectionType(DirectionType&& other_) OMG_NOEXCEPT  :m_DirectionType_subtypes_ (std::move(other_.m_DirectionType_subtypes_))
            {
            } 

            DirectionType& DirectionType::operator=(DirectionType&&  other_) OMG_NOEXCEPT {
                DirectionType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DirectionType::swap(DirectionType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
