...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            CourseType::CourseType (double course):
                m_course_( course ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            CourseType::CourseType(CourseType&& other_) OMG_NOEXCEPT  :m_course_ (std::move(other_.m_course_))
            {
            } 

            CourseType& CourseType::operator=(CourseType&&  other_) OMG_NOEXCEPT {
                CourseType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CourseType::swap(CourseType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
