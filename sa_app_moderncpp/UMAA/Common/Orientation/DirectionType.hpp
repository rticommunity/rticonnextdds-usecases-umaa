        ...
        namespace Orientation {
            namespace DirectionType_Specializations {
                ...
                class NDDSUSERDllExport DirectionType_Union {
                  public:
                    ...
                    DirectionType_Union (DirectionType_Union&&) = default;
                    DirectionType_Union& operator=(DirectionType_Union&&) = default;
                    DirectionType_Union& operator=(const DirectionType_Union&) = default;
                    DirectionType_Union(const DirectionType_Union&) = default;
                    #else
                    DirectionType_Union(DirectionType_Union&& other_) OMG_NOEXCEPT;  
                    DirectionType_Union& operator=(DirectionType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::Common::Orientation::DirectionType_Specializations::DirectionType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(DirectionType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::Common::Orientation::CourseType& CourseType_data,const UMAA::Common::Orientation::HeadingType& HeadingType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(DirectionType_Union& a, DirectionType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport DirectionType {
              public:
                ...
                explicit DirectionType(const UMAA::Common::Orientation::DirectionType_Specializations::DirectionType_Union& DirectionType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                DirectionType (DirectionType&&) = default;
                DirectionType& operator=(DirectionType&&) = default;
                DirectionType& operator=(const DirectionType&) = default;
                DirectionType(const DirectionType&) = default;
                #else
                DirectionType(DirectionType&& other_) OMG_NOEXCEPT;  
                DirectionType& operator=(DirectionType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::Common::Orientation::DirectionType_Specializations::DirectionType_Union& DirectionType_subtypes() OMG_NOEXCEPT {
                    return m_DirectionType_subtypes_;
                }

                const UMAA::Common::Orientation::DirectionType_Specializations::DirectionType_Union& DirectionType_subtypes() const OMG_NOEXCEPT {
                    return m_DirectionType_subtypes_;
                }
                ...
                void swap(DirectionType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(DirectionType& a, DirectionType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
