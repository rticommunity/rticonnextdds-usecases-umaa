        ...
        namespace Orientation {
            namespace OrientationType_Specializations {
                ...
                class NDDSUSERDllExport OrientationType_Union {
                  public:
                    ...
                    OrientationType_Union (OrientationType_Union&&) = default;
                    OrientationType_Union& operator=(OrientationType_Union&&) = default;
                    OrientationType_Union& operator=(const OrientationType_Union&) = default;
                    OrientationType_Union(const OrientationType_Union&) = default;
                    #else
                    OrientationType_Union(OrientationType_Union&& other_) OMG_NOEXCEPT;  
                    OrientationType_Union& operator=(OrientationType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::Common::Orientation::OrientationType_Specializations::OrientationType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(OrientationType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::Common::Orientation::DirectionType& DirectionType_data,const UMAA::Common::Orientation::AttitudeType& AttitudeType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(OrientationType_Union& a, OrientationType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport OrientationType {
              public:
                ...
                explicit OrientationType(const UMAA::Common::Orientation::OrientationType_Specializations::OrientationType_Union& OrientationType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                OrientationType (OrientationType&&) = default;
                OrientationType& operator=(OrientationType&&) = default;
                OrientationType& operator=(const OrientationType&) = default;
                OrientationType(const OrientationType&) = default;
                #else
                OrientationType(OrientationType&& other_) OMG_NOEXCEPT;  
                OrientationType& operator=(OrientationType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::Common::Orientation::OrientationType_Specializations::OrientationType_Union& OrientationType_subtypes() OMG_NOEXCEPT {
                    return m_OrientationType_subtypes_;
                }

                const UMAA::Common::Orientation::OrientationType_Specializations::OrientationType_Union& OrientationType_subtypes() const OMG_NOEXCEPT {
                    return m_OrientationType_subtypes_;
                }
                ...
                void swap(OrientationType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(OrientationType& a, OrientationType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
