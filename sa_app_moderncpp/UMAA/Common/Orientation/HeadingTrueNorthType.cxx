...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            HeadingTrueNorthType::HeadingTrueNorthType (double headingTrueNorth):
                m_headingTrueNorth_( headingTrueNorth ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            HeadingTrueNorthType::HeadingTrueNorthType(HeadingTrueNorthType&& other_) OMG_NOEXCEPT  :m_headingTrueNorth_ (std::move(other_.m_headingTrueNorth_))
            {
            } 

            HeadingTrueNorthType& HeadingTrueNorthType::operator=(HeadingTrueNorthType&&  other_) OMG_NOEXCEPT {
                HeadingTrueNorthType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void HeadingTrueNorthType::swap(HeadingTrueNorthType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool HeadingTrueNorthType::operator == (const HeadingTrueNorthType& other_) const {
                if (m_headingTrueNorth_ != other_.m_headingTrueNorth_) {
                    return false;
                }
                return true;
            }
