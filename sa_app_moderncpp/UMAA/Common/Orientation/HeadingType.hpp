        ...
        namespace Orientation {
            namespace HeadingType_Specializations {
                ...
                class NDDSUSERDllExport HeadingType_Union {
                  public:
                    ...
                    HeadingType_Union (HeadingType_Union&&) = default;
                    HeadingType_Union& operator=(HeadingType_Union&&) = default;
                    HeadingType_Union& operator=(const HeadingType_Union&) = default;
                    HeadingType_Union(const HeadingType_Union&) = default;
                    #else
                    HeadingType_Union(HeadingType_Union&& other_) OMG_NOEXCEPT;  
                    HeadingType_Union& operator=(HeadingType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::Common::Orientation::HeadingType_Specializations::HeadingType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(HeadingType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::Common::Orientation::HeadingTrueNorthType& HeadingTrueNorthType_data,const UMAA::Common::Orientation::HeadingCurrentDirectionType& HeadingCurrentDirectionType_data,const UMAA::Common::Orientation::HeadingMagneticNorthType& HeadingMagneticNorthType_data,const UMAA::Common::Orientation::HeadingWindDirectionType& HeadingWindDirectionType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(HeadingType_Union& a, HeadingType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport HeadingType {
              public:
                ...
                explicit HeadingType(const UMAA::Common::Orientation::HeadingType_Specializations::HeadingType_Union& HeadingType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                HeadingType (HeadingType&&) = default;
                HeadingType& operator=(HeadingType&&) = default;
                HeadingType& operator=(const HeadingType&) = default;
                HeadingType(const HeadingType&) = default;
                #else
                HeadingType(HeadingType&& other_) OMG_NOEXCEPT;  
                HeadingType& operator=(HeadingType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::Common::Orientation::HeadingType_Specializations::HeadingType_Union& HeadingType_subtypes() OMG_NOEXCEPT {
                    return m_HeadingType_subtypes_;
                }

                const UMAA::Common::Orientation::HeadingType_Specializations::HeadingType_Union& HeadingType_subtypes() const OMG_NOEXCEPT {
                    return m_HeadingType_subtypes_;
                }
                ...
                void swap(HeadingType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(HeadingType& a, HeadingType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
