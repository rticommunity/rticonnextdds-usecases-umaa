    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            namespace HeadingType_Specializations {
                ...
                HeadingType_Union::HeadingType_Union(HeadingType_Union&& other_) OMG_NOEXCEPT 
                {
                ...
                HeadingType_Union& HeadingType_Union::operator=(HeadingType_Union&&  other_) OMG_NOEXCEPT {
                    HeadingType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                HeadingType_Union::Union_::Union_(const UMAA::Common::Orientation::HeadingTrueNorthType& HeadingTrueNorthType_data,const UMAA::Common::Orientation::HeadingCurrentDirectionType& HeadingCurrentDirectionType_data,const UMAA::Common::Orientation::HeadingMagneticNorthType& HeadingMagneticNorthType_data,const UMAA::Common::Orientation::HeadingWindDirectionType& HeadingWindDirectionType_data):
                    m_HeadingTrueNorthType_data_( HeadingTrueNorthType_data ),
                    m_HeadingCurrentDirectionType_data_( HeadingCurrentDirectionType_data ),
                    m_HeadingMagneticNorthType_data_( HeadingMagneticNorthType_data ),
                    m_HeadingWindDirectionType_data_( HeadingWindDirectionType_data ) {
                }
                ...
                void HeadingType_Union::swap(HeadingType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const HeadingType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::Common::Orientation::HeadingType_Specializations::HeadingType_Selectors::HEADINGWINDDIRECTIONTYPE_SELECT):
                            {  
                                o << "HeadingWindDirectionType_data: " << sample.HeadingWindDirectionType_data() ;        } break ;
            ...
            HeadingType::HeadingType (const UMAA::Common::Orientation::HeadingType_Specializations::HeadingType_Union& HeadingType_subtypes):
                m_HeadingType_subtypes_( HeadingType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            HeadingType::HeadingType(HeadingType&& other_) OMG_NOEXCEPT  :m_HeadingType_subtypes_ (std::move(other_.m_HeadingType_subtypes_))
            {
            } 

            HeadingType& HeadingType::operator=(HeadingType&&  other_) OMG_NOEXCEPT {
                HeadingType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void HeadingType::swap(HeadingType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
