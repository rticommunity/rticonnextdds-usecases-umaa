...
#ifndef Engineering_Coordinate_Axes_1406803632_hpp
#define Engineering_Coordinate_Axes_1406803632_hpp
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::Common::MeasurementCoordinate::DateTime_AliasTag_t > {
        ...
        #ifndef NDDS_STANDALONE_TYPE
        template<>
        struct dynamic_type< UMAA::Common::MeasurementCoordinate::ForwardSpeed_AliasTag_t > {
            typedef ::dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::AliasType& get();
        };
        #endif
        ...
        #ifndef NDDS_STANDALONE_TYPE
        template<>
        struct dynamic_type< UMAA::Common::MeasurementCoordinate::RadarHeight_AliasTag_t > {
            typedef ::dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::AliasType& get();
        };
        #endif
        ...
        #ifndef NDDS_STANDALONE_TYPE
        template<>
        struct dynamic_type< UMAA::Common::MeasurementCoordinate::Right_AliasTag_t > {
            typedef ::dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::AliasType& get();
        };
        #endif
        ...
        #ifndef NDDS_STANDALONE_TYPE
        template<>
        struct dynamic_type< UMAA::Common::MeasurementCoordinate::RightSpeed_AliasTag_t > {
            typedef ::dds::core::xtypes::AliasType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::AliasType& get();
        };
        #endif
...
#endif // Engineering_Coordinate_Axes_1406803632_hpp
