    ...
    namespace Common {
        ...
        namespace Propulsion {
            ...
            namespace PropulsionRotationType_Specializations {
                ...
                PropulsionRotationType_Union::PropulsionRotationType_Union(PropulsionRotationType_Union&& other_) OMG_NOEXCEPT 
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(_d())){
                        case (UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Selectors::PROPULSIVEROTATIONEFFORTTYPE_SELECT):
                            {  
                                PropulsiveRotationEffortType_data( std::move(other_.PropulsiveRotationEffortType_data()));
                        } break;
                        case (UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Selectors::PROPULSIVEROTATIONANGLETYPE_SELECT):
                            {  
                                PropulsiveRotationAngleType_data( std::move(other_.PropulsiveRotationAngleType_data()));
                        } break;
                ...
                PropulsionRotationType_Union& PropulsionRotationType_Union::operator=(PropulsionRotationType_Union&&  other_) OMG_NOEXCEPT {
                    PropulsionRotationType_Union tmp(std::move(other_));
                    swap(tmp); 
                    return *this;
                }
                #endif
                ...
                PropulsionRotationType_Union::Union_::Union_(const UMAA::Common::Propulsion::PropulsiveRotationEffortType& PropulsiveRotationEffortType_data,const UMAA::Common::Propulsion::PropulsiveRotationAngleType& PropulsiveRotationAngleType_data):
                    m_PropulsiveRotationEffortType_data_( PropulsiveRotationEffortType_data ),
                    m_PropulsiveRotationAngleType_data_( PropulsiveRotationAngleType_data ) {
                }
                ...
                void PropulsionRotationType_Union::swap(PropulsionRotationType_Union& other_)  OMG_NOEXCEPT 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const PropulsionRotationType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Selectors::PROPULSIVEROTATIONANGLETYPE_SELECT):
                            {  
                                o << "PropulsiveRotationAngleType_data: " << sample.PropulsiveRotationAngleType_data() ;        } break ;
            ...
            PropulsionRotationType::PropulsionRotationType (const UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Union& PropulsionRotationType_subtypes):
                m_PropulsionRotationType_subtypes_( PropulsionRotationType_subtypes ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            PropulsionRotationType::PropulsionRotationType(PropulsionRotationType&& other_) OMG_NOEXCEPT  :m_PropulsionRotationType_subtypes_ (std::move(other_.m_PropulsionRotationType_subtypes_))
            {
            } 

            PropulsionRotationType& PropulsionRotationType::operator=(PropulsionRotationType&&  other_) OMG_NOEXCEPT {
                PropulsionRotationType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PropulsionRotationType::swap(PropulsionRotationType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
