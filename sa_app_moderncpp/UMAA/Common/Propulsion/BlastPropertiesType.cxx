...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Propulsion {
            ...
            BlastPropertiesType::BlastPropertiesType (double blastNumber,double restTime):
            ...
            BlastPropertiesType::BlastPropertiesType(BlastPropertiesType&& other_) OMG_NOEXCEPT  :m_blastNumber_ (std::move(other_.m_blastNumber_))
            ,
            m_restTime_ (std::move(other_.m_restTime_))
            {
            } 

            BlastPropertiesType& BlastPropertiesType::operator=(BlastPropertiesType&&  other_) OMG_NOEXCEPT {
                BlastPropertiesType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BlastPropertiesType::swap(BlastPropertiesType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
