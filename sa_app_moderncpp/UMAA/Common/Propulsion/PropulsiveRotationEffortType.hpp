        ...
        namespace Propulsion {
            ...
            class NDDSUSERDllExport PropulsiveRotationEffortType {
              public:
                ...
                explicit PropulsiveRotationEffortType(const UMAA::Common::Measurement::RotationalEffort& yawEffort);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                PropulsiveRotationEffortType (PropulsiveRotationEffortType&&) = default;
                PropulsiveRotationEffortType& operator=(PropulsiveRotationEffortType&&) = default;
                PropulsiveRotationEffortType& operator=(const PropulsiveRotationEffortType&) = default;
                PropulsiveRotationEffortType(const PropulsiveRotationEffortType&) = default;
                #else
                PropulsiveRotationEffortType(PropulsiveRotationEffortType&& other_) OMG_NOEXCEPT;  
                PropulsiveRotationEffortType& operator=(PropulsiveRotationEffortType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::Common::Measurement::RotationalEffort& yawEffort() OMG_NOEXCEPT {
                    return m_yawEffort_;
                }

                const UMAA::Common::Measurement::RotationalEffort& yawEffort() const OMG_NOEXCEPT {
                    return m_yawEffort_;
                }
                ...
                void swap(PropulsiveRotationEffortType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(PropulsiveRotationEffortType& a, PropulsiveRotationEffortType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
