...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Propulsion {
            ...
            PropulsiveEffortType::PropulsiveEffortType (double propulsiveEffort):
                m_propulsiveEffort_( propulsiveEffort ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            PropulsiveEffortType::PropulsiveEffortType(PropulsiveEffortType&& other_) OMG_NOEXCEPT  :m_propulsiveEffort_ (std::move(other_.m_propulsiveEffort_))
            {
            } 

            PropulsiveEffortType& PropulsiveEffortType::operator=(PropulsiveEffortType&&  other_) OMG_NOEXCEPT {
                PropulsiveEffortType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PropulsiveEffortType::swap(PropulsiveEffortType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
