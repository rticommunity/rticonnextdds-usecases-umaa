        ...
        namespace Propulsion {
            namespace PropulsionType_Specializations {
                ...
                class NDDSUSERDllExport PropulsionType_Union {
                  public:
                    ...
                    PropulsionType_Union (PropulsionType_Union&&) = default;
                    PropulsionType_Union& operator=(PropulsionType_Union&&) = default;
                    PropulsionType_Union& operator=(const PropulsionType_Union&) = default;
                    PropulsionType_Union(const PropulsionType_Union&) = default;
                    #else
                    PropulsionType_Union(PropulsionType_Union&& other_) OMG_NOEXCEPT;  
                    PropulsionType_Union& operator=(PropulsionType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::Common::Propulsion::PropulsionType_Specializations::PropulsionType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(PropulsionType_Union& other_) OMG_NOEXCEPT ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const UMAA::Common::Propulsion::PropulsiveEffortType& PropulsiveEffortType_data,const UMAA::Common::Propulsion::PropulsiveRPMType& PropulsiveRPMType_data);
                    };
                    Union_ m_u_;

                };

                inline void swap(PropulsionType_Union& a, PropulsionType_Union& b)  OMG_NOEXCEPT 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport PropulsionType {
              public:
                ...
                explicit PropulsionType(const UMAA::Common::Propulsion::PropulsionType_Specializations::PropulsionType_Union& PropulsionType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                PropulsionType (PropulsionType&&) = default;
                PropulsionType& operator=(PropulsionType&&) = default;
                PropulsionType& operator=(const PropulsionType&) = default;
                PropulsionType(const PropulsionType&) = default;
                #else
                PropulsionType(PropulsionType&& other_) OMG_NOEXCEPT;  
                PropulsionType& operator=(PropulsionType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::Common::Propulsion::PropulsionType_Specializations::PropulsionType_Union& PropulsionType_subtypes() OMG_NOEXCEPT {
                    return m_PropulsionType_subtypes_;
                }

                const UMAA::Common::Propulsion::PropulsionType_Specializations::PropulsionType_Union& PropulsionType_subtypes() const OMG_NOEXCEPT {
                    return m_PropulsionType_subtypes_;
                }
                ...
                void swap(PropulsionType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(PropulsionType& a, PropulsionType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
