...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Propulsion {
            ...
            PropulsiveRotationEffortType::PropulsiveRotationEffortType (const UMAA::Common::Measurement::RotationalEffort& yawEffort):
                m_yawEffort_( yawEffort ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            PropulsiveRotationEffortType::PropulsiveRotationEffortType(PropulsiveRotationEffortType&& other_) OMG_NOEXCEPT  :m_yawEffort_ (std::move(other_.m_yawEffort_))
            {
            } 

            PropulsiveRotationEffortType& PropulsiveRotationEffortType::operator=(PropulsiveRotationEffortType&&  other_) OMG_NOEXCEPT {
                PropulsiveRotationEffortType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PropulsiveRotationEffortType::swap(PropulsiveRotationEffortType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
