        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport DateTime_Tolerance {
              public:
                ...
                DateTime_Tolerance(const UMAA::Common::Measurement::DateTime& lowerLimit,const UMAA::Common::Measurement::DateTime& stepSize,const UMAA::Common::Measurement::DateTime& upperLimit);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                DateTime_Tolerance (DateTime_Tolerance&&) = default;
                DateTime_Tolerance& operator=(DateTime_Tolerance&&) = default;
                DateTime_Tolerance& operator=(const DateTime_Tolerance&) = default;
                DateTime_Tolerance(const DateTime_Tolerance&) = default;
                #else
                DateTime_Tolerance(DateTime_Tolerance&& other_) OMG_NOEXCEPT;  
                DateTime_Tolerance& operator=(DateTime_Tolerance&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::Common::Measurement::DateTime& lowerLimit() OMG_NOEXCEPT {
                    return m_lowerLimit_;
                }

                const UMAA::Common::Measurement::DateTime& lowerLimit() const OMG_NOEXCEPT {
                    return m_lowerLimit_;
                }
                ...
                UMAA::Common::Measurement::DateTime& stepSize() OMG_NOEXCEPT {
                    return m_stepSize_;
                }

                const UMAA::Common::Measurement::DateTime& stepSize() const OMG_NOEXCEPT {
                    return m_stepSize_;
                }
                ...
                UMAA::Common::Measurement::DateTime& upperLimit() OMG_NOEXCEPT {
                    return m_upperLimit_;
                }

                const UMAA::Common::Measurement::DateTime& upperLimit() const OMG_NOEXCEPT {
                    return m_upperLimit_;
                }
                ...
                void swap(DateTime_Tolerance& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(DateTime_Tolerance& a, DateTime_Tolerance& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
