...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            CloudCoverType_All::CloudCoverType_All (const ::rti::core::bounded_sequence< UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType, 100L >& domain,const UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& setPoint,const UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& value):
                m_domain_( domain ),
            ...
            CloudCoverType_All::CloudCoverType_All(CloudCoverType_All&& other_) OMG_NOEXCEPT  :m_domain_ (std::move(other_.m_domain_))
            ,
            ...
            CloudCoverType_All& CloudCoverType_All::operator=(CloudCoverType_All&&  other_) OMG_NOEXCEPT {
                CloudCoverType_All tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CloudCoverType_All::swap(CloudCoverType_All& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
