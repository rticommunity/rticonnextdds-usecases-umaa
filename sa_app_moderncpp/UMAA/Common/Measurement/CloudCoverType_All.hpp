        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport CloudCoverType_All {
              public:
                ...
                CloudCoverType_All(const ::rti::core::bounded_sequence< UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType, 100L >& domain,const UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& setPoint,const UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& value);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                CloudCoverType_All (CloudCoverType_All&&) = default;
                CloudCoverType_All& operator=(CloudCoverType_All&&) = default;
                CloudCoverType_All& operator=(const CloudCoverType_All&) = default;
                CloudCoverType_All(const CloudCoverType_All&) = default;
                #else
                CloudCoverType_All(CloudCoverType_All&& other_) OMG_NOEXCEPT;  
                CloudCoverType_All& operator=(CloudCoverType_All&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                ::rti::core::bounded_sequence< UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType, 100L >& domain() OMG_NOEXCEPT {
                    return m_domain_;
                }

                const ::rti::core::bounded_sequence< UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType, 100L >& domain() const OMG_NOEXCEPT {
                    return m_domain_;
                }
                ...
                UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& setPoint() OMG_NOEXCEPT {
                    return m_setPoint_;
                }

                const UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& setPoint() const OMG_NOEXCEPT {
                    return m_setPoint_;
                }
                ...
                UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& value() OMG_NOEXCEPT {
                    return m_value_;
                }

                const UMAA::Common::OrderedEnumeration::CloudCoverEnumType::CloudCoverEnumType& value() const OMG_NOEXCEPT {
                    return m_value_;
                }
                ...
                void swap(CloudCoverType_All& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(CloudCoverType_All& a, CloudCoverType_All& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
