...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Position2D_PlatformXYZ::Position2D_PlatformXYZ (double xAxis,double yAxis):
                m_xAxis_( xAxis ),
                m_yAxis_( yAxis ) {
            }
            ...
            Position2D_PlatformXYZ::Position2D_PlatformXYZ(Position2D_PlatformXYZ&& other_) OMG_NOEXCEPT  :m_xAxis_ (std::move(other_.m_xAxis_))
            ,
            m_yAxis_ (std::move(other_.m_yAxis_))
            {
            } 

            Position2D_PlatformXYZ& Position2D_PlatformXYZ::operator=(Position2D_PlatformXYZ&&  other_) OMG_NOEXCEPT {
                Position2D_PlatformXYZ tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Position2D_PlatformXYZ::swap(Position2D_PlatformXYZ& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
