...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            AltitudeMSLType::AltitudeMSLType (const UMAA::Common::Measurement::Altitude_MSL& altitudeMSL):
                m_altitudeMSL_( altitudeMSL ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            AltitudeMSLType::AltitudeMSLType(AltitudeMSLType&& other_) OMG_NOEXCEPT  :m_altitudeMSL_ (std::move(other_.m_altitudeMSL_))
            {
            } 

            AltitudeMSLType& AltitudeMSLType::operator=(AltitudeMSLType&&  other_) OMG_NOEXCEPT {
                AltitudeMSLType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AltitudeMSLType::swap(AltitudeMSLType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
