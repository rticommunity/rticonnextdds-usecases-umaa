...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Acceleration3D_PlatformXYZ::Acceleration3D_PlatformXYZ (double xAccel,double yAccel,double zAccel):
                m_xAccel_( xAccel ),
                m_yAccel_( yAccel ),
                m_zAccel_( zAccel ) {
            }
            ...
            Acceleration3D_PlatformXYZ::Acceleration3D_PlatformXYZ(Acceleration3D_PlatformXYZ&& other_) OMG_NOEXCEPT  :m_xAccel_ (std::move(other_.m_xAccel_))
            ,
            m_yAccel_ (std::move(other_.m_yAccel_))
            ,
            m_zAccel_ (std::move(other_.m_zAccel_))
            {
            } 

            Acceleration3D_PlatformXYZ& Acceleration3D_PlatformXYZ::operator=(Acceleration3D_PlatformXYZ&&  other_) OMG_NOEXCEPT {
                Acceleration3D_PlatformXYZ tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Acceleration3D_PlatformXYZ::swap(Acceleration3D_PlatformXYZ& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool Acceleration3D_PlatformXYZ::operator == (const Acceleration3D_PlatformXYZ& other_) const {
                if (m_xAccel_ != other_.m_xAccel_) {
                    return false;
                }
                if (m_yAccel_ != other_.m_yAccel_) {
                    return false;
                }
                if (m_zAccel_ != other_.m_zAccel_) {
                    return false;
                }
                return true;
            }
