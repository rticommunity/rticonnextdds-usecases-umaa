...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            OrientationAcceleration3D::OrientationAcceleration3D (double pitchAccelY,double rollAccelX,double yawAccelZ):
                m_pitchAccelY_( pitchAccelY ),
                m_rollAccelX_( rollAccelX ),
                m_yawAccelZ_( yawAccelZ ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            OrientationAcceleration3D::OrientationAcceleration3D(OrientationAcceleration3D&& other_) OMG_NOEXCEPT  :m_pitchAccelY_ (std::move(other_.m_pitchAccelY_))
            ,
            m_rollAccelX_ (std::move(other_.m_rollAccelX_))
            ,
            m_yawAccelZ_ (std::move(other_.m_yawAccelZ_))
            {
            } 

            OrientationAcceleration3D& OrientationAcceleration3D::operator=(OrientationAcceleration3D&&  other_) OMG_NOEXCEPT {
                OrientationAcceleration3D tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void OrientationAcceleration3D::swap(OrientationAcceleration3D& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool OrientationAcceleration3D::operator == (const OrientationAcceleration3D& other_) const {
                if (m_pitchAccelY_ != other_.m_pitchAccelY_) {
                    return false;
                }
                if (m_rollAccelX_ != other_.m_rollAccelX_) {
                    return false;
                }
                if (m_yawAccelZ_ != other_.m_yawAccelZ_) {
                    return false;
                }
                return true;
            }
...
namespace dds { 
    namespace topic {
        void topic_type_support< UMAA::Common::Measurement::OrientationAcceleration3D >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                UMAA::Common::Measurement::OrientationAcceleration3DPlugin_new,
                UMAA::Common::Measurement::OrientationAcceleration3DPlugin_delete);
        }

        std::vector<char>& topic_type_support< UMAA::Common::Measurement::OrientationAcceleration3D >::to_cdr_buffer(
            ...
            ::dds::core::policy::DataRepresentationId representation)
        {
            ...
            RTIBool ok = OrientationAcceleration3DPlugin_serialize_to_cdr_buffer(
                NULL, 
                &length,
                &sample,
                representation);
            ...
            ok = OrientationAcceleration3DPlugin_serialize_to_cdr_buffer(
                &buffer[0], 
                &length, 
                &sample,
                representation);
        ...
        void topic_type_support< UMAA::Common::Measurement::OrientationAcceleration3D >::from_cdr_buffer(UMAA::Common::Measurement::OrientationAcceleration3D& sample, 
        const std::vector<char>& buffer)
        {

            RTIBool ok  = OrientationAcceleration3DPlugin_deserialize_from_cdr_buffer(
                &sample, 
                &buffer[0], 
                static_cast<unsigned int>(buffer.size()));
            ::rti::core::check_return_code(ok ? DDS_RETCODE_OK : DDS_RETCODE_ERROR,
            "Failed to create UMAA::Common::Measurement::OrientationAcceleration3D from cdr buffer");
        }
