        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport Polygon {
              public:
                ...
                Polygon(const UMAA::Common::Enumeration::LineSegmentEnumType::LineSegmentEnumType& lineKind,const ::rti::core::bounded_sequence< UMAA::Common::Measurement::Position2DTime, 100L >& referencePoint);
                ...
                #else
                Polygon(Polygon&& other_) OMG_NOEXCEPT;  
                Polygon& operator=(Polygon&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                ::rti::core::bounded_sequence< UMAA::Common::Measurement::Position2DTime, 100L >& referencePoint() OMG_NOEXCEPT {
                    return m_referencePoint_;
                }

                const ::rti::core::bounded_sequence< UMAA::Common::Measurement::Position2DTime, 100L >& referencePoint() const OMG_NOEXCEPT {
                    return m_referencePoint_;
                }
                ...
                void swap(Polygon& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(Polygon& a, Polygon& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
