        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport CovarianceNEDAccelerationAccelerationType {
              public:
                ...
                CovarianceNEDAccelerationAccelerationType(double adAd,double aeAd,double aeAe,double anAd,double anAe,double anAn);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                CovarianceNEDAccelerationAccelerationType (CovarianceNEDAccelerationAccelerationType&&) = default;
                CovarianceNEDAccelerationAccelerationType& operator=(CovarianceNEDAccelerationAccelerationType&&) = default;
                CovarianceNEDAccelerationAccelerationType& operator=(const CovarianceNEDAccelerationAccelerationType&) = default;
                CovarianceNEDAccelerationAccelerationType(const CovarianceNEDAccelerationAccelerationType&) = default;
                #else
                CovarianceNEDAccelerationAccelerationType(CovarianceNEDAccelerationAccelerationType&& other_) OMG_NOEXCEPT;  
                CovarianceNEDAccelerationAccelerationType& operator=(CovarianceNEDAccelerationAccelerationType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                double& adAd() OMG_NOEXCEPT {
                    return m_adAd_;
                }

                const double& adAd() const OMG_NOEXCEPT {
                    return m_adAd_;
                }
                ...
                double& aeAd() OMG_NOEXCEPT {
                    return m_aeAd_;
                }

                const double& aeAd() const OMG_NOEXCEPT {
                    return m_aeAd_;
                }
                ...
                double& aeAe() OMG_NOEXCEPT {
                    return m_aeAe_;
                }

                const double& aeAe() const OMG_NOEXCEPT {
                    return m_aeAe_;
                }
                ...
                double& anAd() OMG_NOEXCEPT {
                    return m_anAd_;
                }

                const double& anAd() const OMG_NOEXCEPT {
                    return m_anAd_;
                }
                ...
                double& anAe() OMG_NOEXCEPT {
                    return m_anAe_;
                }

                const double& anAe() const OMG_NOEXCEPT {
                    return m_anAe_;
                }
                ...
                double& anAn() OMG_NOEXCEPT {
                    return m_anAn_;
                }

                const double& anAn() const OMG_NOEXCEPT {
                    return m_anAn_;
                }
                ...
                void swap(CovarianceNEDAccelerationAccelerationType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(CovarianceNEDAccelerationAccelerationType& a, CovarianceNEDAccelerationAccelerationType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
