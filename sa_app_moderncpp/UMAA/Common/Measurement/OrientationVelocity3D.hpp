        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport OrientationVelocity3D {
              public:
                ...
                OrientationVelocity3D(double pitchRateY,double rollRateX,double yawRateZ);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                OrientationVelocity3D (OrientationVelocity3D&&) = default;
                OrientationVelocity3D& operator=(OrientationVelocity3D&&) = default;
                OrientationVelocity3D& operator=(const OrientationVelocity3D&) = default;
                OrientationVelocity3D(const OrientationVelocity3D&) = default;
                #else
                OrientationVelocity3D(OrientationVelocity3D&& other_) OMG_NOEXCEPT;  
                OrientationVelocity3D& operator=(OrientationVelocity3D&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                double& pitchRateY() OMG_NOEXCEPT {
                    return m_pitchRateY_;
                }

                const double& pitchRateY() const OMG_NOEXCEPT {
                    return m_pitchRateY_;
                }
                ...
                double& rollRateX() OMG_NOEXCEPT {
                    return m_rollRateX_;
                }

                const double& rollRateX() const OMG_NOEXCEPT {
                    return m_rollRateX_;
                }
                ...
                double& yawRateZ() OMG_NOEXCEPT {
                    return m_yawRateZ_;
                }

                const double& yawRateZ() const OMG_NOEXCEPT {
                    return m_yawRateZ_;
                }
                ...
                void swap(OrientationVelocity3D& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(OrientationVelocity3D& a, OrientationVelocity3D& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
