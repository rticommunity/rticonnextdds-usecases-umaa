...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            OrientationVelocity3D::OrientationVelocity3D (double pitchRateY,double rollRateX,double yawRateZ):
                m_pitchRateY_( pitchRateY ),
                m_rollRateX_( rollRateX ),
                m_yawRateZ_( yawRateZ ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            OrientationVelocity3D::OrientationVelocity3D(OrientationVelocity3D&& other_) OMG_NOEXCEPT  :m_pitchRateY_ (std::move(other_.m_pitchRateY_))
            ,
            m_rollRateX_ (std::move(other_.m_rollRateX_))
            ,
            m_yawRateZ_ (std::move(other_.m_yawRateZ_))
            {
            } 

            OrientationVelocity3D& OrientationVelocity3D::operator=(OrientationVelocity3D&&  other_) OMG_NOEXCEPT {
                OrientationVelocity3D tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void OrientationVelocity3D::swap(OrientationVelocity3D& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool OrientationVelocity3D::operator == (const OrientationVelocity3D& other_) const {
                if (m_pitchRateY_ != other_.m_pitchRateY_) {
                    return false;
                }
                if (m_rollRateX_ != other_.m_rollRateX_) {
                    return false;
                }
                if (m_yawRateZ_ != other_.m_yawRateZ_) {
                    return false;
                }
                return true;
            }
