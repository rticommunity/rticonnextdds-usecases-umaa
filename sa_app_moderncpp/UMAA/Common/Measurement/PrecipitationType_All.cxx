...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            PrecipitationType_All::PrecipitationType_All (const ::rti::core::bounded_sequence< UMAA::Common::Enumeration::PrecipitationEnumType::PrecipitationEnumType, 100L >& domain,const UMAA::Common::Enumeration::PrecipitationEnumType::PrecipitationEnumType& setPoint,const UMAA::Common::Enumeration::PrecipitationEnumType::PrecipitationEnumType& value):
                m_domain_( domain ),
            ...
            PrecipitationType_All::PrecipitationType_All(PrecipitationType_All&& other_) OMG_NOEXCEPT  :m_domain_ (std::move(other_.m_domain_))
            ,
            ...
            PrecipitationType_All& PrecipitationType_All::operator=(PrecipitationType_All&&  other_) OMG_NOEXCEPT {
                PrecipitationType_All tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PrecipitationType_All::swap(PrecipitationType_All& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
