...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            WeatherSeverityType_All::WeatherSeverityType_All(WeatherSeverityType_All&& other_) OMG_NOEXCEPT  :m_domain_ (std::move(other_.m_domain_))
            ,
            ...
            WeatherSeverityType_All& WeatherSeverityType_All::operator=(WeatherSeverityType_All&&  other_) OMG_NOEXCEPT {
                WeatherSeverityType_All tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void WeatherSeverityType_All::swap(WeatherSeverityType_All& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
