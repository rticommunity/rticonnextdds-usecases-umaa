...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Orientation3D_Tolerance::Orientation3D_Tolerance (const UMAA::Common::Measurement::Orientation3D& lowerLimit,const UMAA::Common::Measurement::Orientation3D& stepSize,const UMAA::Common::Measurement::Orientation3D& upperLimit):
            ...
            Orientation3D_Tolerance::Orientation3D_Tolerance(Orientation3D_Tolerance&& other_) OMG_NOEXCEPT  :m_lowerLimit_ (std::move(other_.m_lowerLimit_))
            ,
            ...
            Orientation3D_Tolerance& Orientation3D_Tolerance::operator=(Orientation3D_Tolerance&&  other_) OMG_NOEXCEPT {
                Orientation3D_Tolerance tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Orientation3D_Tolerance::swap(Orientation3D_Tolerance& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
