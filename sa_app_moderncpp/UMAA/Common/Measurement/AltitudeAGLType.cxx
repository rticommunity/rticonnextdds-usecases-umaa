...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            AltitudeAGLType::AltitudeAGLType (const UMAA::Common::Measurement::Altitude_AGL& altitudeAGL):
                m_altitudeAGL_( altitudeAGL ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            AltitudeAGLType::AltitudeAGLType(AltitudeAGLType&& other_) OMG_NOEXCEPT  :m_altitudeAGL_ (std::move(other_.m_altitudeAGL_))
            {
            } 

            AltitudeAGLType& AltitudeAGLType::operator=(AltitudeAGLType&&  other_) OMG_NOEXCEPT {
                AltitudeAGLType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AltitudeAGLType::swap(AltitudeAGLType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
