...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Position3D_PlatformXYZ::Position3D_PlatformXYZ (double xA,double yA,double zA):
                m_xA_( xA ),
                m_yA_( yA ),
                m_zA_( zA ) {
            }
            ...
            Position3D_PlatformXYZ::Position3D_PlatformXYZ(Position3D_PlatformXYZ&& other_) OMG_NOEXCEPT  :m_xA_ (std::move(other_.m_xA_))
            ,
            m_yA_ (std::move(other_.m_yA_))
            ,
            m_zA_ (std::move(other_.m_zA_))
            {
            } 

            Position3D_PlatformXYZ& Position3D_PlatformXYZ::operator=(Position3D_PlatformXYZ&&  other_) OMG_NOEXCEPT {
                Position3D_PlatformXYZ tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Position3D_PlatformXYZ::swap(Position3D_PlatformXYZ& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool Position3D_PlatformXYZ::operator == (const Position3D_PlatformXYZ& other_) const {
                if (m_xA_ != other_.m_xA_) {
                    return false;
                }
                if (m_yA_ != other_.m_yA_) {
                    return false;
                }
                if (m_zA_ != other_.m_zA_) {
                    return false;
                }
                return true;
            }
