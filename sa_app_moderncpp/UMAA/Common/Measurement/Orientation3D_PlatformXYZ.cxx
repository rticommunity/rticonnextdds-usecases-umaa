...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Orientation3D_PlatformXYZ::Orientation3D_PlatformXYZ (double pitchY,double rollX,double yawZ):
                m_pitchY_( pitchY ),
                m_rollX_( rollX ),
                m_yawZ_( yawZ ) {
            }
            ...
            Orientation3D_PlatformXYZ::Orientation3D_PlatformXYZ(Orientation3D_PlatformXYZ&& other_) OMG_NOEXCEPT  :m_pitchY_ (std::move(other_.m_pitchY_))
            ,
            ...
            Orientation3D_PlatformXYZ& Orientation3D_PlatformXYZ::operator=(Orientation3D_PlatformXYZ&&  other_) OMG_NOEXCEPT {
                Orientation3D_PlatformXYZ tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Orientation3D_PlatformXYZ::swap(Orientation3D_PlatformXYZ& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
