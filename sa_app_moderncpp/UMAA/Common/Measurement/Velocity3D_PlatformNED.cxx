...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Velocity3D_PlatformNED::Velocity3D_PlatformNED (double downSpeed,double eastSpeed,double northSpeed):
                m_downSpeed_( downSpeed ),
                m_eastSpeed_( eastSpeed ),
                m_northSpeed_( northSpeed ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            Velocity3D_PlatformNED::Velocity3D_PlatformNED(Velocity3D_PlatformNED&& other_) OMG_NOEXCEPT  :m_downSpeed_ (std::move(other_.m_downSpeed_))
            ,
            m_eastSpeed_ (std::move(other_.m_eastSpeed_))
            ,
            m_northSpeed_ (std::move(other_.m_northSpeed_))
            {
            } 

            Velocity3D_PlatformNED& Velocity3D_PlatformNED::operator=(Velocity3D_PlatformNED&&  other_) OMG_NOEXCEPT {
                Velocity3D_PlatformNED tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Velocity3D_PlatformNED::swap(Velocity3D_PlatformNED& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool Velocity3D_PlatformNED::operator == (const Velocity3D_PlatformNED& other_) const {
                ...
                if (m_eastSpeed_ != other_.m_eastSpeed_) {
                    return false;
                }
                if (m_northSpeed_ != other_.m_northSpeed_) {
                    return false;
                }
                return true;
            }
