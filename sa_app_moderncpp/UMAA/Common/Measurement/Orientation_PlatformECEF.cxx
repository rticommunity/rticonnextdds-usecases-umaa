...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Orientation_PlatformECEF::Orientation_PlatformECEF (double pitchY,double rollX,double yawZ):
                m_pitchY_( pitchY ),
                m_rollX_( rollX ),
                m_yawZ_( yawZ ) {
            }
            ...
            Orientation_PlatformECEF::Orientation_PlatformECEF(Orientation_PlatformECEF&& other_) OMG_NOEXCEPT  :m_pitchY_ (std::move(other_.m_pitchY_))
            ,
            ...
            Orientation_PlatformECEF& Orientation_PlatformECEF::operator=(Orientation_PlatformECEF&&  other_) OMG_NOEXCEPT {
                Orientation_PlatformECEF tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Orientation_PlatformECEF::swap(Orientation_PlatformECEF& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
