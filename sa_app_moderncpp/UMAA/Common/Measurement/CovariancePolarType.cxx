...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            CovariancePolarType::CovariancePolarType (double abAb,double aiAb,double aiAi,double arAb,double arAi,double arAr):
                m_abAb_( abAb ),
                m_aiAb_( aiAb ),
                m_aiAi_( aiAi ),
                m_arAb_( arAb ),
            ...
            CovariancePolarType::CovariancePolarType(CovariancePolarType&& other_) OMG_NOEXCEPT  :m_abAb_ (std::move(other_.m_abAb_))
            ,
            m_aiAb_ (std::move(other_.m_aiAb_))
            ,
            m_aiAi_ (std::move(other_.m_aiAi_))
            ,
            m_arAb_ (std::move(other_.m_arAb_))
            ,
            m_arAi_ (std::move(other_.m_arAi_))
            ,
            m_arAr_ (std::move(other_.m_arAr_))
            {
            } 

            CovariancePolarType& CovariancePolarType::operator=(CovariancePolarType&&  other_) OMG_NOEXCEPT {
                CovariancePolarType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CovariancePolarType::swap(CovariancePolarType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool CovariancePolarType::operator == (const CovariancePolarType& other_) const {
                if (m_abAb_ != other_.m_abAb_) {
                    return false;
                }
                if (m_aiAb_ != other_.m_aiAb_) {
                    return false;
                }
                if (m_aiAi_ != other_.m_aiAi_) {
                    return false;
                }
                if (m_arAb_ != other_.m_arAb_) {
                    return false;
                }
                if (m_arAi_ != other_.m_arAi_) {
                    return false;
                }
