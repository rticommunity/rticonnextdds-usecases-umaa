        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport BuiltInTestStatusType_All {
              public:
                ...
                BuiltInTestStatusType_All (BuiltInTestStatusType_All&&) = default;
                BuiltInTestStatusType_All& operator=(BuiltInTestStatusType_All&&) = default;
                BuiltInTestStatusType_All& operator=(const BuiltInTestStatusType_All&) = default;
                BuiltInTestStatusType_All(const BuiltInTestStatusType_All&) = default;
                #else
                BuiltInTestStatusType_All(BuiltInTestStatusType_All&& other_) OMG_NOEXCEPT;  
                BuiltInTestStatusType_All& operator=(BuiltInTestStatusType_All&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                ::rti::core::bounded_sequence< UMAA::Common::Enumeration::BuiltInTestStatusEnumType::BuiltInTestStatusEnumType, 100L >& domain() OMG_NOEXCEPT {
                    return m_domain_;
                }

                const ::rti::core::bounded_sequence< UMAA::Common::Enumeration::BuiltInTestStatusEnumType::BuiltInTestStatusEnumType, 100L >& domain() const OMG_NOEXCEPT {
                    return m_domain_;
                }
                ...
                UMAA::Common::Enumeration::BuiltInTestStatusEnumType::BuiltInTestStatusEnumType& setPoint() OMG_NOEXCEPT {
                    return m_setPoint_;
                }

                const UMAA::Common::Enumeration::BuiltInTestStatusEnumType::BuiltInTestStatusEnumType& setPoint() const OMG_NOEXCEPT {
                    return m_setPoint_;
                }
                ...
                UMAA::Common::Enumeration::BuiltInTestStatusEnumType::BuiltInTestStatusEnumType& value() OMG_NOEXCEPT {
                    return m_value_;
                }

                const UMAA::Common::Enumeration::BuiltInTestStatusEnumType::BuiltInTestStatusEnumType& value() const OMG_NOEXCEPT {
                    return m_value_;
                }
                ...
                void swap(BuiltInTestStatusType_All& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BuiltInTestStatusType_All& a, BuiltInTestStatusType_All& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
