...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            GeodeticLongitude::GeodeticLongitude (double longitude):
                m_longitude_( longitude ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            GeodeticLongitude::GeodeticLongitude(GeodeticLongitude&& other_) OMG_NOEXCEPT  :m_longitude_ (std::move(other_.m_longitude_))
            {
            } 

            GeodeticLongitude& GeodeticLongitude::operator=(GeodeticLongitude&&  other_) OMG_NOEXCEPT {
                GeodeticLongitude tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GeodeticLongitude::swap(GeodeticLongitude& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
