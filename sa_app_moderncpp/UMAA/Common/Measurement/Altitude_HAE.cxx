...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Altitude_HAE::Altitude_HAE (double altitude):
                m_altitude_( altitude ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            Altitude_HAE::Altitude_HAE(Altitude_HAE&& other_) OMG_NOEXCEPT  :m_altitude_ (std::move(other_.m_altitude_))
            {
            } 

            Altitude_HAE& Altitude_HAE::operator=(Altitude_HAE&&  other_) OMG_NOEXCEPT {
                Altitude_HAE tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void Altitude_HAE::swap(Altitude_HAE& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
