...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            CovarianceOrientationType::CovarianceOrientationType (double rpRp,double rpRy,double rrRp,double rrRr,double rrRy,double ryRy):
                m_rpRp_( rpRp ),
                m_rpRy_( rpRy ),
                m_rrRp_( rrRp ),
                m_rrRr_( rrRr ),
            ...
            CovarianceOrientationType::CovarianceOrientationType(CovarianceOrientationType&& other_) OMG_NOEXCEPT  :m_rpRp_ (std::move(other_.m_rpRp_))
            ,
            m_rpRy_ (std::move(other_.m_rpRy_))
            ,
            m_rrRp_ (std::move(other_.m_rrRp_))
            ,
            m_rrRr_ (std::move(other_.m_rrRr_))
            ,
            m_rrRy_ (std::move(other_.m_rrRy_))
            ,
            m_ryRy_ (std::move(other_.m_ryRy_))
            {
            } 

            CovarianceOrientationType& CovarianceOrientationType::operator=(CovarianceOrientationType&&  other_) OMG_NOEXCEPT {
                CovarianceOrientationType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CovarianceOrientationType::swap(CovarianceOrientationType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool CovarianceOrientationType::operator == (const CovarianceOrientationType& other_) const {
                if (m_rpRp_ != other_.m_rpRp_) {
                    return false;
                }
                if (m_rpRy_ != other_.m_rpRy_) {
                    return false;
                }
                if (m_rrRp_ != other_.m_rrRp_) {
                    return false;
                }
                if (m_rrRr_ != other_.m_rrRr_) {
                    return false;
                }
                if (m_rrRy_ != other_.m_rrRy_) {
                    return false;
                }
                if (m_ryRy_ != other_.m_ryRy_) {
                    return false;
                }
                return true;
            }
