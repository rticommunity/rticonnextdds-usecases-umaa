        ...
        namespace Speed {
            namespace SpeedControlType_Specializations {
                ...
                class NDDSUSERDllExport SpeedControlType_Union {
                  public:
                    ...
                    SpeedControlType_Union (SpeedControlType_Union&&) = default;
                    SpeedControlType_Union& operator=(SpeedControlType_Union&&) = default;
                    SpeedControlType_Union& operator=(const SpeedControlType_Union&) = default;
                    SpeedControlType_Union(const SpeedControlType_Union&) = default;
                    #else
                    SpeedControlType_Union(SpeedControlType_Union&& other_) OMG_NOEXCEPT;  
                    SpeedControlType_Union& operator=(SpeedControlType_Union&&  other_) OMG_NOEXCEPT;
                    #endif
                    #endif 
                    ...
                    void _d(const UMAA::Common::Speed::SpeedControlType_Specializations::SpeedControlType_Selectors& value) {
                        m_d_ = value;
                    }
                    ...
                    void swap(SpeedControlType_Union& other_) OMG_NOEXCEPT ;
            ...
            class NDDSUSERDllExport SpeedControlType {
              public:
                ...
                explicit SpeedControlType(const UMAA::Common::Speed::SpeedControlType_Specializations::SpeedControlType_Union& SpeedControlType_subtypes);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                SpeedControlType (SpeedControlType&&) = default;
                SpeedControlType& operator=(SpeedControlType&&) = default;
                SpeedControlType& operator=(const SpeedControlType&) = default;
                SpeedControlType(const SpeedControlType&) = default;
                #else
                SpeedControlType(SpeedControlType&& other_) OMG_NOEXCEPT;  
                SpeedControlType& operator=(SpeedControlType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                UMAA::Common::Speed::SpeedControlType_Specializations::SpeedControlType_Union& SpeedControlType_subtypes() OMG_NOEXCEPT {
                    return m_SpeedControlType_subtypes_;
                }

                const UMAA::Common::Speed::SpeedControlType_Specializations::SpeedControlType_Union& SpeedControlType_subtypes() const OMG_NOEXCEPT {
                    return m_SpeedControlType_subtypes_;
                }
                ...
                void swap(SpeedControlType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(SpeedControlType& a, SpeedControlType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
