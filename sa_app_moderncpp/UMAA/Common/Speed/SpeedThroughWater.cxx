...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Speed {
            ...
            SpeedThroughWater::SpeedThroughWater (double speed):
                m_speed_( speed ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            SpeedThroughWater::SpeedThroughWater(SpeedThroughWater&& other_) OMG_NOEXCEPT  :m_speed_ (std::move(other_.m_speed_))
            {
            } 

            SpeedThroughWater& SpeedThroughWater::operator=(SpeedThroughWater&&  other_) OMG_NOEXCEPT {
                SpeedThroughWater tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void SpeedThroughWater::swap(SpeedThroughWater& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
