...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Speed {
            ...
            VehicleSpeedMode::VehicleSpeedMode (const UMAA::Common::MaritimeEnumeration::VehicleSpeedModeEnumType::VehicleSpeedModeEnumType& mode):
                m_mode_( mode ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            VehicleSpeedMode::VehicleSpeedMode(VehicleSpeedMode&& other_) OMG_NOEXCEPT  :m_mode_ (std::move(other_.m_mode_))
            {
            } 

            VehicleSpeedMode& VehicleSpeedMode::operator=(VehicleSpeedMode&&  other_) OMG_NOEXCEPT {
                VehicleSpeedMode tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void VehicleSpeedMode::swap(VehicleSpeedMode& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
