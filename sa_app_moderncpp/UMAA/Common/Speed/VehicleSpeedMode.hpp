        ...
        namespace Speed {
            ...
            class NDDSUSERDllExport VehicleSpeedMode {
              public:
                ...
                explicit VehicleSpeedMode(const UMAA::Common::MaritimeEnumeration::VehicleSpeedModeEnumType::VehicleSpeedModeEnumType& mode);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                VehicleSpeedMode (VehicleSpeedMode&&) = default;
                VehicleSpeedMode& operator=(VehicleSpeedMode&&) = default;
                VehicleSpeedMode& operator=(const VehicleSpeedMode&) = default;
                VehicleSpeedMode(const VehicleSpeedMode&) = default;
                #else
                VehicleSpeedMode(VehicleSpeedMode&& other_) OMG_NOEXCEPT;  
                VehicleSpeedMode& operator=(VehicleSpeedMode&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(VehicleSpeedMode& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(VehicleSpeedMode& a, VehicleSpeedMode& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
