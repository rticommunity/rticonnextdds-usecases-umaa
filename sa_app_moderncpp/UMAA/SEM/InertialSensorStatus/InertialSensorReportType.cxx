    ...
    namespace SEM {
        ...
        namespace InertialSensorStatus {
            ...
            InertialSensorReportType::InertialSensorReportType() :
                ...
                m_status_(UMAA::Common::MaritimeEnumeration::InertialSensorOpStatusEnumType::InertialSensorOpStatusEnumType::COURSE_GPS_ALIGNMENT)  {
                    ::rti::core::fill_array( 
                        m_source_, 
                        ::rti::topic::cdr::alias_helper< UMAA::Common::Measurement::NumericGUID::value_type >::default_value());
            }   

            InertialSensorReportType::InertialSensorReportType (const UMAA::Common::MaritimeEnumeration::InertialSensorStateEnumType::InertialSensorStateEnumType& state,const UMAA::Common::MaritimeEnumeration::InertialSensorOpStatusEnumType::InertialSensorOpStatusEnumType& status,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_state_( state ),
                m_status_( status ),
                m_source_( source ),
            ...
            InertialSensorReportType::InertialSensorReportType(InertialSensorReportType&& other_) OMG_NOEXCEPT  :m_state_ (std::move(other_.m_state_))
            ,
            ...
            InertialSensorReportType& InertialSensorReportType::operator=(InertialSensorReportType&&  other_) OMG_NOEXCEPT {
                InertialSensorReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void InertialSensorReportType::swap(InertialSensorReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::SEM::InertialSensorStatus::InertialSensorReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member InertialSensorReportType_g_tc_members[4]=
                {
                ...
                InertialSensorReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::InertialSensorStateEnumType::InertialSensorStateEnumType>::get().native();
                InertialSensorReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::MaritimeEnumeration::InertialSensorOpStatusEnumType::InertialSensorOpStatusEnumType>::get().native();
                InertialSensorReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                InertialSensorReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                InertialSensorReportType_g_tc_members[1]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                InertialSensorReportType_g_tc_members[1]._annotations._defaultValue._u.enumerated_value = 0;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo InertialSensorReportType_g_memberAccessInfos[4] =
                ...
                InertialSensorReportType_g_memberAccessInfos[3].bindingMemberValueOffset[0] = 
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< UMAA::SEM::InertialSensorStatus::InertialSensorReportType >::reset_sample(UMAA::SEM::InertialSensorStatus::InertialSensorReportType& sample) 
        {
            ...
            sample.status(UMAA::Common::MaritimeEnumeration::InertialSensorOpStatusEnumType::InertialSensorOpStatusEnumType::COURSE_GPS_ALIGNMENT);
