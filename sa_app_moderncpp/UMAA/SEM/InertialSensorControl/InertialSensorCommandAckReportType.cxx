...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace InertialSensorControl {
            ...
            InertialSensorCommandAckReportType::InertialSensorCommandAckReportType (const UMAA::Common::MaritimeEnumeration::InertialSensorStateEnumType::InertialSensorStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
                m_state_( state ),
                m_source_( source ),
            ...
            InertialSensorCommandAckReportType::InertialSensorCommandAckReportType(InertialSensorCommandAckReportType&& other_) OMG_NOEXCEPT  :m_state_ (std::move(other_.m_state_))
            ,
            ...
            InertialSensorCommandAckReportType& InertialSensorCommandAckReportType::operator=(InertialSensorCommandAckReportType&&  other_) OMG_NOEXCEPT {
                InertialSensorCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void InertialSensorCommandAckReportType::swap(InertialSensorCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
