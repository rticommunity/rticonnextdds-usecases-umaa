...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace InertialSensorControl {
            ...
            InertialSensorCommandStatusType::InertialSensorCommandStatusType(InertialSensorCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            InertialSensorCommandStatusType& InertialSensorCommandStatusType::operator=(InertialSensorCommandStatusType&&  other_) OMG_NOEXCEPT {
                InertialSensorCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void InertialSensorCommandStatusType::swap(InertialSensorCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
