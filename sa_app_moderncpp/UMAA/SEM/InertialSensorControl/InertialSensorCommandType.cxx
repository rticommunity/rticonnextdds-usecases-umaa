...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace InertialSensorControl {
            ...
            InertialSensorCommandType::InertialSensorCommandType (const UMAA::Common::MaritimeEnumeration::InertialSensorStateEnumType::InertialSensorStateEnumType& state,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_state_( state ),
                m_source_( source ),
            ...
            InertialSensorCommandType::InertialSensorCommandType(InertialSensorCommandType&& other_) OMG_NOEXCEPT  :m_state_ (std::move(other_.m_state_))
            ,
            ...
            InertialSensorCommandType& InertialSensorCommandType::operator=(InertialSensorCommandType&&  other_) OMG_NOEXCEPT {
                InertialSensorCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void InertialSensorCommandType::swap(InertialSensorCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
