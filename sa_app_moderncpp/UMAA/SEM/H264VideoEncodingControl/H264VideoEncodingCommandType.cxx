...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace H264VideoEncodingControl {
            ...
            H264VideoEncodingCommandType::H264VideoEncodingCommandType (bool gradualDecoderRefresh,int32_t groupOfPictures,const UMAA::Common::MaritimeEnumeration::H264PresetEnumType::H264PresetEnumType& preset,const UMAA::Common::MaritimeEnumeration::H264EncodingEnumType::H264EncodingEnumType& profile,bool regionOfInterest,int32_t ROI_height,double ROI_highBitRate,double ROI_lowBitRate,int32_t ROI_width,int32_t ROI_x,int32_t ROI_y,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            H264VideoEncodingCommandType::H264VideoEncodingCommandType(H264VideoEncodingCommandType&& other_) OMG_NOEXCEPT  :m_gradualDecoderRefresh_ (std::move(other_.m_gradualDecoderRefresh_))
            ,
            ...
            H264VideoEncodingCommandType& H264VideoEncodingCommandType::operator=(H264VideoEncodingCommandType&&  other_) OMG_NOEXCEPT {
                H264VideoEncodingCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void H264VideoEncodingCommandType::swap(H264VideoEncodingCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
