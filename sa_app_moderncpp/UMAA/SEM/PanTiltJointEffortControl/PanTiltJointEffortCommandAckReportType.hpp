...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointEffortControl {
            ...
            static const std::string PanTiltJointEffortCommandAckReport_TOPIC = "UMAA::SEM::PanTiltJointEffortControl::PanTiltJointEffortCommandAckReport";

            class NDDSUSERDllExport PanTiltJointEffortCommandAckReportType {
              public:
                PanTiltJointEffortCommandAckReportType();

                PanTiltJointEffortCommandAckReportType(double panEffort,double tiltEffort,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                PanTiltJointEffortCommandAckReportType (PanTiltJointEffortCommandAckReportType&&) = default;
                PanTiltJointEffortCommandAckReportType& operator=(PanTiltJointEffortCommandAckReportType&&) = default;
                PanTiltJointEffortCommandAckReportType& operator=(const PanTiltJointEffortCommandAckReportType&) = default;
                PanTiltJointEffortCommandAckReportType(const PanTiltJointEffortCommandAckReportType&) = default;
                #else
                PanTiltJointEffortCommandAckReportType(PanTiltJointEffortCommandAckReportType&& other_) OMG_NOEXCEPT;  
                PanTiltJointEffortCommandAckReportType& operator=(PanTiltJointEffortCommandAckReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(PanTiltJointEffortCommandAckReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(PanTiltJointEffortCommandAckReportType& a, PanTiltJointEffortCommandAckReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
