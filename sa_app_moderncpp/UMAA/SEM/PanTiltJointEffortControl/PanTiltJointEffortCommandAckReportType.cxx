...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace PanTiltJointEffortControl {
            ...
            PanTiltJointEffortCommandAckReportType::PanTiltJointEffortCommandAckReportType (double panEffort,double tiltEffort,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            PanTiltJointEffortCommandAckReportType::PanTiltJointEffortCommandAckReportType(PanTiltJointEffortCommandAckReportType&& other_) OMG_NOEXCEPT  :m_panEffort_ (std::move(other_.m_panEffort_))
            ,
            ...
            PanTiltJointEffortCommandAckReportType& PanTiltJointEffortCommandAckReportType::operator=(PanTiltJointEffortCommandAckReportType&&  other_) OMG_NOEXCEPT {
                PanTiltJointEffortCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PanTiltJointEffortCommandAckReportType::swap(PanTiltJointEffortCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
