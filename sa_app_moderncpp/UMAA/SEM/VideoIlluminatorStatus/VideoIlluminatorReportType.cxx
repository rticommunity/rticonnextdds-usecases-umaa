...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace VideoIlluminatorStatus {
            ...
            VideoIlluminatorReportType::VideoIlluminatorReportType (double beamWidth,int32_t level,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            VideoIlluminatorReportType::VideoIlluminatorReportType(VideoIlluminatorReportType&& other_) OMG_NOEXCEPT  :m_beamWidth_ (std::move(other_.m_beamWidth_))
            ,
            ...
            VideoIlluminatorReportType& VideoIlluminatorReportType::operator=(VideoIlluminatorReportType&&  other_) OMG_NOEXCEPT {
                VideoIlluminatorReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void VideoIlluminatorReportType::swap(VideoIlluminatorReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
