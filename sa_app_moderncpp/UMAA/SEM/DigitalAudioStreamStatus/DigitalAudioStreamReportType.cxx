...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalAudioStreamStatus {
            ...
            DigitalAudioStreamReportType::DigitalAudioStreamReportType (bool repeat,const std::string& url,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_repeat_( repeat ),
                m_url_( url ),
                m_source_( source ),
            ...
            DigitalAudioStreamReportType::DigitalAudioStreamReportType(DigitalAudioStreamReportType&& other_) OMG_NOEXCEPT  :m_repeat_ (std::move(other_.m_repeat_))
            ,
            ...
            DigitalAudioStreamReportType& DigitalAudioStreamReportType::operator=(DigitalAudioStreamReportType&&  other_) OMG_NOEXCEPT {
                DigitalAudioStreamReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DigitalAudioStreamReportType::swap(DigitalAudioStreamReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
