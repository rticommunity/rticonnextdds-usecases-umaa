...
#ifndef VideoIlluminatorCommandStatusType_2018604370_hpp
#define VideoIlluminatorCommandStatusType_2018604370_hpp
...
namespace UMAA {
    namespace SEM {
        namespace VideoIlluminatorControl {
            ...
            static const std::string VideoIlluminatorCommandStatus_TOPIC = "UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatus";

            class NDDSUSERDllExport VideoIlluminatorCommandStatusType {
              public:
                ...
                VideoIlluminatorCommandStatusType (VideoIlluminatorCommandStatusType&&) = default;
                VideoIlluminatorCommandStatusType& operator=(VideoIlluminatorCommandStatusType&&) = default;
                VideoIlluminatorCommandStatusType& operator=(const VideoIlluminatorCommandStatusType&) = default;
                VideoIlluminatorCommandStatusType(const VideoIlluminatorCommandStatusType&) = default;
                #else
                VideoIlluminatorCommandStatusType(VideoIlluminatorCommandStatusType&& other_) OMG_NOEXCEPT;  
                VideoIlluminatorCommandStatusType& operator=(VideoIlluminatorCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const VideoIlluminatorCommandStatusType& other_) const;
                bool operator != (const VideoIlluminatorCommandStatusType& other_) const;

                void swap(VideoIlluminatorCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(VideoIlluminatorCommandStatusType& a, VideoIlluminatorCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const VideoIlluminatorCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatusType > {
...
#endif // VideoIlluminatorCommandStatusType_2018604370_hpp
