...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace VideoIlluminatorControl {
            ...
            VideoIlluminatorCommandType::VideoIlluminatorCommandType (double beamWidth,int32_t level,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            VideoIlluminatorCommandType::VideoIlluminatorCommandType(VideoIlluminatorCommandType&& other_) OMG_NOEXCEPT  :m_beamWidth_ (std::move(other_.m_beamWidth_))
            ,
            ...
            VideoIlluminatorCommandType& VideoIlluminatorCommandType::operator=(VideoIlluminatorCommandType&&  other_) OMG_NOEXCEPT {
                VideoIlluminatorCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void VideoIlluminatorCommandType::swap(VideoIlluminatorCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
