...
#ifndef GPSFixCommandStatusType_471852354_hpp
#define GPSFixCommandStatusType_471852354_hpp
...
namespace UMAA {
    namespace SEM {
        namespace GPSFixControl {
            ...
            static const std::string GPSFixCommandStatus_TOPIC = "UMAA::SEM::GPSFixControl::GPSFixCommandStatus";

            class NDDSUSERDllExport GPSFixCommandStatusType {
              public:
                ...
                GPSFixCommandStatusType (GPSFixCommandStatusType&&) = default;
                GPSFixCommandStatusType& operator=(GPSFixCommandStatusType&&) = default;
                GPSFixCommandStatusType& operator=(const GPSFixCommandStatusType&) = default;
                GPSFixCommandStatusType(const GPSFixCommandStatusType&) = default;
                #else
                GPSFixCommandStatusType(GPSFixCommandStatusType&& other_) OMG_NOEXCEPT;  
                GPSFixCommandStatusType& operator=(GPSFixCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const GPSFixCommandStatusType& other_) const;
                bool operator != (const GPSFixCommandStatusType& other_) const;

                void swap(GPSFixCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GPSFixCommandStatusType& a, GPSFixCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GPSFixCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::SEM::GPSFixControl::GPSFixCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::GPSFixControl::GPSFixCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::SEM::GPSFixControl::GPSFixCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::SEM::GPSFixControl::GPSFixCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::SEM::GPSFixControl::GPSFixCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::SEM::GPSFixControl::GPSFixCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::SEM::GPSFixControl::GPSFixCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::SEM::GPSFixControl::GPSFixCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::SEM::GPSFixControl::GPSFixCommandStatusType > {
...
#endif // GPSFixCommandStatusType_471852354_hpp
