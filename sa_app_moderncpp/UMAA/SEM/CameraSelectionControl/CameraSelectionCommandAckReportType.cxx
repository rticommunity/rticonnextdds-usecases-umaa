...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace CameraSelectionControl {
            ...
            CameraSelectionCommandAckReportType::CameraSelectionCommandAckReportType (const UMAA::Common::Measurement::NumericGUID& cameraID,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::NumericGUID& muxID):
            ...
            CameraSelectionCommandAckReportType::CameraSelectionCommandAckReportType(CameraSelectionCommandAckReportType&& other_) OMG_NOEXCEPT  :m_cameraID_ (std::move(other_.m_cameraID_))
            ,
            ...
            CameraSelectionCommandAckReportType& CameraSelectionCommandAckReportType::operator=(CameraSelectionCommandAckReportType&&  other_) OMG_NOEXCEPT {
                CameraSelectionCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CameraSelectionCommandAckReportType::swap(CameraSelectionCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
