...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace CameraSelectionControl {
            ...
            CameraSelectionCommandStatusType::CameraSelectionCommandStatusType(CameraSelectionCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            CameraSelectionCommandStatusType& CameraSelectionCommandStatusType::operator=(CameraSelectionCommandStatusType&&  other_) OMG_NOEXCEPT {
                CameraSelectionCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CameraSelectionCommandStatusType::swap(CameraSelectionCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
