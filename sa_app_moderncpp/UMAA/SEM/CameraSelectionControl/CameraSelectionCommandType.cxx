...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace CameraSelectionControl {
            ...
            CameraSelectionCommandType::CameraSelectionCommandType (const UMAA::Common::Measurement::NumericGUID& cameraID,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp,const UMAA::Common::Measurement::NumericGUID& muxID):
            ...
            CameraSelectionCommandType::CameraSelectionCommandType(CameraSelectionCommandType&& other_) OMG_NOEXCEPT  :m_cameraID_ (std::move(other_.m_cameraID_))
            ,
            ...
            CameraSelectionCommandType& CameraSelectionCommandType::operator=(CameraSelectionCommandType&&  other_) OMG_NOEXCEPT {
                CameraSelectionCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CameraSelectionCommandType::swap(CameraSelectionCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
