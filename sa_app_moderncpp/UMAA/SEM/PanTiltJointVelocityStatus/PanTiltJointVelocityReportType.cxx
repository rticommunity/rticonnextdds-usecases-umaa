...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace PanTiltJointVelocityStatus {
            ...
            PanTiltJointVelocityReportType::PanTiltJointVelocityReportType (double panVelocity,double tiltVelocity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            PanTiltJointVelocityReportType::PanTiltJointVelocityReportType(PanTiltJointVelocityReportType&& other_) OMG_NOEXCEPT  :m_panVelocity_ (std::move(other_.m_panVelocity_))
            ,
            ...
            PanTiltJointVelocityReportType& PanTiltJointVelocityReportType::operator=(PanTiltJointVelocityReportType&&  other_) OMG_NOEXCEPT {
                PanTiltJointVelocityReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PanTiltJointVelocityReportType::swap(PanTiltJointVelocityReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
