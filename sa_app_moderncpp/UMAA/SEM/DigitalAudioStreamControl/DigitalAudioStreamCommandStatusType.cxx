...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalAudioStreamControl {
            ...
            DigitalAudioStreamCommandStatusType::DigitalAudioStreamCommandStatusType(DigitalAudioStreamCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            DigitalAudioStreamCommandStatusType& DigitalAudioStreamCommandStatusType::operator=(DigitalAudioStreamCommandStatusType&&  other_) OMG_NOEXCEPT {
                DigitalAudioStreamCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DigitalAudioStreamCommandStatusType::swap(DigitalAudioStreamCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
