...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace PanTiltJointVelocityControl {
            ...
            PanTiltJointVelocityCommandAckReportType::PanTiltJointVelocityCommandAckReportType (double panVelocity,double tiltVelocity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            PanTiltJointVelocityCommandAckReportType::PanTiltJointVelocityCommandAckReportType(PanTiltJointVelocityCommandAckReportType&& other_) OMG_NOEXCEPT  :m_panVelocity_ (std::move(other_.m_panVelocity_))
            ,
            ...
            PanTiltJointVelocityCommandAckReportType& PanTiltJointVelocityCommandAckReportType::operator=(PanTiltJointVelocityCommandAckReportType&&  other_) OMG_NOEXCEPT {
                PanTiltJointVelocityCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PanTiltJointVelocityCommandAckReportType::swap(PanTiltJointVelocityCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
