...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace PanTiltJointVelocityControl {
            ...
            PanTiltJointVelocityCommandType::PanTiltJointVelocityCommandType (double panVelocity,double tiltVelocity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& destination,const UMAA::Common::Measurement::NumericGUID& sessionID,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_panVelocity_( panVelocity ),
                m_tiltVelocity_( tiltVelocity ),
                m_source_( source ),
            ...
            PanTiltJointVelocityCommandType::PanTiltJointVelocityCommandType(PanTiltJointVelocityCommandType&& other_) OMG_NOEXCEPT  :m_panVelocity_ (std::move(other_.m_panVelocity_))
            ,
            m_tiltVelocity_ (std::move(other_.m_tiltVelocity_))
            ,
            ...
            PanTiltJointVelocityCommandType& PanTiltJointVelocityCommandType::operator=(PanTiltJointVelocityCommandType&&  other_) OMG_NOEXCEPT {
                PanTiltJointVelocityCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PanTiltJointVelocityCommandType::swap(PanTiltJointVelocityCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool PanTiltJointVelocityCommandType::operator == (const PanTiltJointVelocityCommandType& other_) const {
                if (m_panVelocity_ != other_.m_panVelocity_) {
                    return false;
                }
                if (m_tiltVelocity_ != other_.m_tiltVelocity_) {
                    return false;
                }
