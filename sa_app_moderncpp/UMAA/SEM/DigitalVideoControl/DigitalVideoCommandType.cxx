...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalVideoControl {
            ...
            DigitalVideoCommandType::DigitalVideoCommandType(DigitalVideoCommandType&& other_) OMG_NOEXCEPT  :m_builtInTest_ (std::move(other_.m_builtInTest_))
            ,
            ...
            DigitalVideoCommandType& DigitalVideoCommandType::operator=(DigitalVideoCommandType&&  other_) OMG_NOEXCEPT {
                DigitalVideoCommandType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DigitalVideoCommandType::swap(DigitalVideoCommandType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
