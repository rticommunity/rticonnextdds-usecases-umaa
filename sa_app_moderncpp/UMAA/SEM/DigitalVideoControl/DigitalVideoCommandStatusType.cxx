...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalVideoControl {
            ...
            DigitalVideoCommandStatusType::DigitalVideoCommandStatusType(DigitalVideoCommandStatusType&& other_) OMG_NOEXCEPT  :m_source_ (std::move(other_.m_source_))
            ,
            ...
            DigitalVideoCommandStatusType& DigitalVideoCommandStatusType::operator=(DigitalVideoCommandStatusType&&  other_) OMG_NOEXCEPT {
                DigitalVideoCommandStatusType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DigitalVideoCommandStatusType::swap(DigitalVideoCommandStatusType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
