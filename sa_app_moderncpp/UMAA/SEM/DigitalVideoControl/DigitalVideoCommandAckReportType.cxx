...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalVideoControl {
            ...
            DigitalVideoCommandAckReportType::DigitalVideoCommandAckReportType(DigitalVideoCommandAckReportType&& other_) OMG_NOEXCEPT  :m_builtInTest_ (std::move(other_.m_builtInTest_))
            ,
            ...
            DigitalVideoCommandAckReportType& DigitalVideoCommandAckReportType::operator=(DigitalVideoCommandAckReportType&&  other_) OMG_NOEXCEPT {
                DigitalVideoCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DigitalVideoCommandAckReportType::swap(DigitalVideoCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
