...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalAudioSpecs {
            ...
            DigitalAudioSpecsReportType::DigitalAudioSpecsReportType (int32_t maxAllowedBitRate,int32_t maxChannels,int32_t maxSampleRate,int32_t minAllowedBitRate,int32_t minSampleRate,bool supported10bits,bool supported12bits,bool supported14bits,bool supported16bits,bool supported20bits,bool supported24bits,bool supported32bits,bool supported40bits,bool supported48bits,bool supported56bits,bool supported64bits,bool supported8bits,bool supportedAAC_MPEG2,bool supportedAAC_MPEG4,bool supportedAIFF,bool supportedALAC,bool supportedAverage,bool supportedBest,bool supportedBetter,bool supportedDolbyDigital,bool supportedDTS,bool supportedFLAC,bool supportedGood,bool supportedLess,bool supportedLPCM_PCM,bool supportedMP2,bool supportedMP3,bool supportedPoor,bool supportedRealAudio,bool supportedSpeex,bool supportedTrueAudio,bool supportedULAW,bool supportedVORBIS,bool supportedWAV,bool supportedWMA,bool supportedWMA9_Lossless,bool supportedWorst,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_maxAllowedBitRate_( maxAllowedBitRate ),
                m_maxChannels_( maxChannels ),
                m_maxSampleRate_( maxSampleRate ),
                m_minAllowedBitRate_( minAllowedBitRate ),
                m_minSampleRate_( minSampleRate ),
                m_supported10bits_( supported10bits ),
                m_supported12bits_( supported12bits ),
                m_supported14bits_( supported14bits ),
                m_supported16bits_( supported16bits ),
                m_supported20bits_( supported20bits ),
                m_supported24bits_( supported24bits ),
                m_supported32bits_( supported32bits ),
                m_supported40bits_( supported40bits ),
                m_supported48bits_( supported48bits ),
                m_supported56bits_( supported56bits ),
                m_supported64bits_( supported64bits ),
                m_supported8bits_( supported8bits ),
                m_supportedAAC_MPEG2_( supportedAAC_MPEG2 ),
                m_supportedAAC_MPEG4_( supportedAAC_MPEG4 ),
                m_supportedAIFF_( supportedAIFF ),
                m_supportedALAC_( supportedALAC ),
                m_supportedAverage_( supportedAverage ),
                m_supportedBest_( supportedBest ),
                m_supportedBetter_( supportedBetter ),
                m_supportedDolbyDigital_( supportedDolbyDigital ),
                m_supportedDTS_( supportedDTS ),
                m_supportedFLAC_( supportedFLAC ),
                m_supportedGood_( supportedGood ),
                m_supportedLess_( supportedLess ),
                m_supportedLPCM_PCM_( supportedLPCM_PCM ),
                m_supportedMP2_( supportedMP2 ),
                m_supportedMP3_( supportedMP3 ),
                m_supportedPoor_( supportedPoor ),
                m_supportedRealAudio_( supportedRealAudio ),
                m_supportedSpeex_( supportedSpeex ),
                m_supportedTrueAudio_( supportedTrueAudio ),
                m_supportedULAW_( supportedULAW ),
                m_supportedVORBIS_( supportedVORBIS ),
                m_supportedWAV_( supportedWAV ),
                m_supportedWMA_( supportedWMA ),
                m_supportedWMA9_Lossless_( supportedWMA9_Lossless ),
                m_supportedWorst_( supportedWorst ),
                m_source_( source ),
            ...
            DigitalAudioSpecsReportType::DigitalAudioSpecsReportType(DigitalAudioSpecsReportType&& other_) OMG_NOEXCEPT  :m_maxAllowedBitRate_ (std::move(other_.m_maxAllowedBitRate_))
            ,
            m_maxChannels_ (std::move(other_.m_maxChannels_))
            ,
            m_maxSampleRate_ (std::move(other_.m_maxSampleRate_))
            ,
            m_minAllowedBitRate_ (std::move(other_.m_minAllowedBitRate_))
            ,
            m_minSampleRate_ (std::move(other_.m_minSampleRate_))
            ,
            m_supported10bits_ (std::move(other_.m_supported10bits_))
            ,
            m_supported12bits_ (std::move(other_.m_supported12bits_))
            ,
            m_supported14bits_ (std::move(other_.m_supported14bits_))
            ,
            m_supported16bits_ (std::move(other_.m_supported16bits_))
            ,
            m_supported20bits_ (std::move(other_.m_supported20bits_))
            ,
            m_supported24bits_ (std::move(other_.m_supported24bits_))
            ,
            m_supported32bits_ (std::move(other_.m_supported32bits_))
            ,
            m_supported40bits_ (std::move(other_.m_supported40bits_))
            ,
            m_supported48bits_ (std::move(other_.m_supported48bits_))
            ,
            m_supported56bits_ (std::move(other_.m_supported56bits_))
            ,
            m_supported64bits_ (std::move(other_.m_supported64bits_))
            ,
            m_supported8bits_ (std::move(other_.m_supported8bits_))
            ,
            m_supportedAAC_MPEG2_ (std::move(other_.m_supportedAAC_MPEG2_))
            ,
            m_supportedAAC_MPEG4_ (std::move(other_.m_supportedAAC_MPEG4_))
            ,
            m_supportedAIFF_ (std::move(other_.m_supportedAIFF_))
            ,
            m_supportedALAC_ (std::move(other_.m_supportedALAC_))
            ,
            m_supportedAverage_ (std::move(other_.m_supportedAverage_))
            ,
            m_supportedBest_ (std::move(other_.m_supportedBest_))
            ,
            m_supportedBetter_ (std::move(other_.m_supportedBetter_))
            ,
            m_supportedDolbyDigital_ (std::move(other_.m_supportedDolbyDigital_))
            ,
            m_supportedDTS_ (std::move(other_.m_supportedDTS_))
            ,
            m_supportedFLAC_ (std::move(other_.m_supportedFLAC_))
            ,
            m_supportedGood_ (std::move(other_.m_supportedGood_))
            ,
            m_supportedLess_ (std::move(other_.m_supportedLess_))
            ,
            m_supportedLPCM_PCM_ (std::move(other_.m_supportedLPCM_PCM_))
            ,
            m_supportedMP2_ (std::move(other_.m_supportedMP2_))
            ,
            m_supportedMP3_ (std::move(other_.m_supportedMP3_))
            ,
            m_supportedPoor_ (std::move(other_.m_supportedPoor_))
            ,
            m_supportedRealAudio_ (std::move(other_.m_supportedRealAudio_))
            ,
            m_supportedSpeex_ (std::move(other_.m_supportedSpeex_))
            ,
            m_supportedTrueAudio_ (std::move(other_.m_supportedTrueAudio_))
            ,
            m_supportedULAW_ (std::move(other_.m_supportedULAW_))
            ,
            m_supportedVORBIS_ (std::move(other_.m_supportedVORBIS_))
            ,
            m_supportedWAV_ (std::move(other_.m_supportedWAV_))
            ,
            m_supportedWMA_ (std::move(other_.m_supportedWMA_))
            ,
            m_supportedWMA9_Lossless_ (std::move(other_.m_supportedWMA9_Lossless_))
            ,
            m_supportedWorst_ (std::move(other_.m_supportedWorst_))
            ,
            ...
            DigitalAudioSpecsReportType& DigitalAudioSpecsReportType::operator=(DigitalAudioSpecsReportType&&  other_) OMG_NOEXCEPT {
                DigitalAudioSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DigitalAudioSpecsReportType::swap(DigitalAudioSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
