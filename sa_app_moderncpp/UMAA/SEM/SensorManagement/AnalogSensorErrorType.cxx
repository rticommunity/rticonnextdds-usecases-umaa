...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace SensorManagement {
            ...
            AnalogSensorErrorType::AnalogSensorErrorType (const UMAA::Common::MaritimeEnumeration::AnalogSensorErrorCodeEnumType::AnalogSensorErrorCodeEnumType& errorCode,const std::string& errorMessage):
            ...
            AnalogSensorErrorType::AnalogSensorErrorType(AnalogSensorErrorType&& other_) OMG_NOEXCEPT  :m_errorCode_ (std::move(other_.m_errorCode_))
            ,
            m_errorMessage_ (std::move(other_.m_errorMessage_))
            {
            } 

            AnalogSensorErrorType& AnalogSensorErrorType::operator=(AnalogSensorErrorType&&  other_) OMG_NOEXCEPT {
                AnalogSensorErrorType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void AnalogSensorErrorType::swap(AnalogSensorErrorType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
