...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace SensorManagement {
            ...
            StillImageErrorType::StillImageErrorType (const UMAA::Common::MaritimeEnumeration::StillImageErrorCodeEnumType::StillImageErrorCodeEnumType& errorCode,const std::string& errorMessage):
            ...
            StillImageErrorType::StillImageErrorType(StillImageErrorType&& other_) OMG_NOEXCEPT  :m_errorCode_ (std::move(other_.m_errorCode_))
            ,
            m_errorMessage_ (std::move(other_.m_errorMessage_))
            {
            } 

            StillImageErrorType& StillImageErrorType::operator=(StillImageErrorType&&  other_) OMG_NOEXCEPT {
                StillImageErrorType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void StillImageErrorType::swap(StillImageErrorType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
