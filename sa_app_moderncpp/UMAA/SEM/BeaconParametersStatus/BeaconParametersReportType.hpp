...
namespace UMAA {
    namespace SEM {
        namespace BeaconParametersStatus {
            ...
            static const std::string BeaconParametersReport_TOPIC = "UMAA::SEM::BeaconParametersStatus::BeaconParametersReport";

            class NDDSUSERDllExport BeaconParametersReportType {
              public:
                BeaconParametersReportType();

                BeaconParametersReportType(int32_t frequencyBand,bool IRLightsArmed,bool IRLightsOn,bool locatorArmed,bool locatorOn,bool multibandLocator,bool RGLightsArmed,bool RGLightsOn,int32_t transmitChannel,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                BeaconParametersReportType (BeaconParametersReportType&&) = default;
                BeaconParametersReportType& operator=(BeaconParametersReportType&&) = default;
                BeaconParametersReportType& operator=(const BeaconParametersReportType&) = default;
                BeaconParametersReportType(const BeaconParametersReportType&) = default;
                #else
                BeaconParametersReportType(BeaconParametersReportType&& other_) OMG_NOEXCEPT;  
                BeaconParametersReportType& operator=(BeaconParametersReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(BeaconParametersReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(BeaconParametersReportType& a, BeaconParametersReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
