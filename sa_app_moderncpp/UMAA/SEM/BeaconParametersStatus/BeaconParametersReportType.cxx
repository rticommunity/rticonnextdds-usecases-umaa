...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace BeaconParametersStatus {
            ...
            BeaconParametersReportType::BeaconParametersReportType (int32_t frequencyBand,bool IRLightsArmed,bool IRLightsOn,bool locatorArmed,bool locatorOn,bool multibandLocator,bool RGLightsArmed,bool RGLightsOn,int32_t transmitChannel,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
            ...
            BeaconParametersReportType::BeaconParametersReportType(BeaconParametersReportType&& other_) OMG_NOEXCEPT  :m_frequencyBand_ (std::move(other_.m_frequencyBand_))
            ,
            ...
            BeaconParametersReportType& BeaconParametersReportType::operator=(BeaconParametersReportType&&  other_) OMG_NOEXCEPT {
                BeaconParametersReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void BeaconParametersReportType::swap(BeaconParametersReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
