...
data type BeaconParametersReportType from BeaconParametersReportType.idl.
This example builds two applications, named BeaconParametersReportType_publisher and
BeaconParametersReportType_subscriber.
...
> make -f makefile_BeaconParametersReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_BeaconParametersReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the BeaconParametersReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/BeaconParametersReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/BeaconParametersReportType_subscriber -d <domain_id> -s <sample_count>
