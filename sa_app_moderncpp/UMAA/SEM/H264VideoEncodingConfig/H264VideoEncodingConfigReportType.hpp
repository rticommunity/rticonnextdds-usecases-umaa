...
namespace UMAA {
    namespace SEM {
        namespace H264VideoEncodingConfig {
            ...
            static const std::string H264VideoEncodingConfigReport_TOPIC = "UMAA::SEM::H264VideoEncodingConfig::H264VideoEncodingConfigReport";

            class NDDSUSERDllExport H264VideoEncodingConfigReportType {
              public:
                H264VideoEncodingConfigReportType();

                H264VideoEncodingConfigReportType(bool gradualDecoderRefresh,int32_t groupOfPictures,const UMAA::Common::MaritimeEnumeration::H264PresetEnumType::H264PresetEnumType& preset,const UMAA::Common::MaritimeEnumeration::H264EncodingEnumType::H264EncodingEnumType& profile,bool regionOfInterest,int32_t ROI_height,double ROI_highBitRate,double ROI_lowBitRate,int32_t ROI_width,int32_t ROI_x,int32_t ROI_y,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                H264VideoEncodingConfigReportType (H264VideoEncodingConfigReportType&&) = default;
                H264VideoEncodingConfigReportType& operator=(H264VideoEncodingConfigReportType&&) = default;
                H264VideoEncodingConfigReportType& operator=(const H264VideoEncodingConfigReportType&) = default;
                H264VideoEncodingConfigReportType(const H264VideoEncodingConfigReportType&) = default;
                #else
                H264VideoEncodingConfigReportType(H264VideoEncodingConfigReportType&& other_) OMG_NOEXCEPT;  
                H264VideoEncodingConfigReportType& operator=(H264VideoEncodingConfigReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(H264VideoEncodingConfigReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(H264VideoEncodingConfigReportType& a, H264VideoEncodingConfigReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
