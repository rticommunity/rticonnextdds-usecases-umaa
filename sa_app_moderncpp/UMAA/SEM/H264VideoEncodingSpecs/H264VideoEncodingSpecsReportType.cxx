...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace H264VideoEncodingSpecs {
            ...
            H264VideoEncodingSpecsReportType::H264VideoEncodingSpecsReportType (bool supportedBaseline,bool supportedBestQuality,bool supportedCAVLC444,bool supportedConstrainedBaseline,bool supportedConstrainedHigh,bool supportedDriveVision,bool supportedExtended,bool supportedGradualDecoderRefresh,bool supportedGroupOfPictures,bool supportedHigh,bool supportedHigh10,bool supportedHigh10Intra,bool supportedHigh422,bool supportedHigh422Intra,bool supportedHigh444Intra,bool supportedHigh444Predictive,bool supportedLevel1,bool supportedLevel11,bool supportedLevel12,bool supportedLevel13,bool supportedLevel1B,bool supportedLevel2,bool supportedLevel21,bool supportedLevel22,bool supportedLevel3,bool supportedLevel31,bool supportedLevel32,bool supportedLevel4,bool supportedLevel41,bool supportedLevel42,bool supportedLevel5,bool supportedLevel51,bool supportedLevel52,bool supportedLowLatency,bool supportedMain,bool supportedManipulation,bool supportedMultiviewHigh,bool supportedPersistentStare,bool supportedProgramSpecific1,bool supportedProgramSpecific2,bool supportedProgramSpecific3,bool supportedProgramSpecific4,bool supportedProgressiveHigh,bool supportedRegionOfInterest,bool supportedScalableBaseline,bool supportedScalableConstrainedBaseline,bool supportedScalableConstrainedHigh,bool supportedScalableHigh,bool supportedScalableHighIntra,bool supportedSlowComms,bool supportedStereoHigh,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_supportedBaseline_( supportedBaseline ),
                m_supportedBestQuality_( supportedBestQuality ),
                m_supportedCAVLC444_( supportedCAVLC444 ),
                m_supportedConstrainedBaseline_( supportedConstrainedBaseline ),
                m_supportedConstrainedHigh_( supportedConstrainedHigh ),
                m_supportedDriveVision_( supportedDriveVision ),
                m_supportedExtended_( supportedExtended ),
                m_supportedGradualDecoderRefresh_( supportedGradualDecoderRefresh ),
                m_supportedGroupOfPictures_( supportedGroupOfPictures ),
                m_supportedHigh_( supportedHigh ),
                m_supportedHigh10_( supportedHigh10 ),
                m_supportedHigh10Intra_( supportedHigh10Intra ),
                m_supportedHigh422_( supportedHigh422 ),
                m_supportedHigh422Intra_( supportedHigh422Intra ),
                m_supportedHigh444Intra_( supportedHigh444Intra ),
                m_supportedHigh444Predictive_( supportedHigh444Predictive ),
                m_supportedLevel1_( supportedLevel1 ),
                m_supportedLevel11_( supportedLevel11 ),
                m_supportedLevel12_( supportedLevel12 ),
                m_supportedLevel13_( supportedLevel13 ),
                m_supportedLevel1B_( supportedLevel1B ),
                m_supportedLevel2_( supportedLevel2 ),
                m_supportedLevel21_( supportedLevel21 ),
                m_supportedLevel22_( supportedLevel22 ),
                m_supportedLevel3_( supportedLevel3 ),
                m_supportedLevel31_( supportedLevel31 ),
                m_supportedLevel32_( supportedLevel32 ),
                m_supportedLevel4_( supportedLevel4 ),
                m_supportedLevel41_( supportedLevel41 ),
                m_supportedLevel42_( supportedLevel42 ),
                m_supportedLevel5_( supportedLevel5 ),
                m_supportedLevel51_( supportedLevel51 ),
                m_supportedLevel52_( supportedLevel52 ),
                m_supportedLowLatency_( supportedLowLatency ),
                m_supportedMain_( supportedMain ),
                m_supportedManipulation_( supportedManipulation ),
                m_supportedMultiviewHigh_( supportedMultiviewHigh ),
                m_supportedPersistentStare_( supportedPersistentStare ),
                m_supportedProgramSpecific1_( supportedProgramSpecific1 ),
                m_supportedProgramSpecific2_( supportedProgramSpecific2 ),
                m_supportedProgramSpecific3_( supportedProgramSpecific3 ),
                m_supportedProgramSpecific4_( supportedProgramSpecific4 ),
                m_supportedProgressiveHigh_( supportedProgressiveHigh ),
                m_supportedRegionOfInterest_( supportedRegionOfInterest ),
                m_supportedScalableBaseline_( supportedScalableBaseline ),
                m_supportedScalableConstrainedBaseline_( supportedScalableConstrainedBaseline ),
                m_supportedScalableConstrainedHigh_( supportedScalableConstrainedHigh ),
                m_supportedScalableHigh_( supportedScalableHigh ),
                m_supportedScalableHighIntra_( supportedScalableHighIntra ),
                m_supportedSlowComms_( supportedSlowComms ),
                m_supportedStereoHigh_( supportedStereoHigh ),
                m_source_( source ),
            ...
            H264VideoEncodingSpecsReportType::H264VideoEncodingSpecsReportType(H264VideoEncodingSpecsReportType&& other_) OMG_NOEXCEPT  :m_supportedBaseline_ (std::move(other_.m_supportedBaseline_))
            ,
            m_supportedBestQuality_ (std::move(other_.m_supportedBestQuality_))
            ,
            m_supportedCAVLC444_ (std::move(other_.m_supportedCAVLC444_))
            ,
            m_supportedConstrainedBaseline_ (std::move(other_.m_supportedConstrainedBaseline_))
            ,
            m_supportedConstrainedHigh_ (std::move(other_.m_supportedConstrainedHigh_))
            ,
            m_supportedDriveVision_ (std::move(other_.m_supportedDriveVision_))
            ,
            m_supportedExtended_ (std::move(other_.m_supportedExtended_))
            ,
            m_supportedGradualDecoderRefresh_ (std::move(other_.m_supportedGradualDecoderRefresh_))
            ,
            m_supportedGroupOfPictures_ (std::move(other_.m_supportedGroupOfPictures_))
            ,
            m_supportedHigh_ (std::move(other_.m_supportedHigh_))
            ,
            m_supportedHigh10_ (std::move(other_.m_supportedHigh10_))
            ,
            m_supportedHigh10Intra_ (std::move(other_.m_supportedHigh10Intra_))
            ,
            m_supportedHigh422_ (std::move(other_.m_supportedHigh422_))
            ,
            m_supportedHigh422Intra_ (std::move(other_.m_supportedHigh422Intra_))
            ,
            m_supportedHigh444Intra_ (std::move(other_.m_supportedHigh444Intra_))
            ,
            m_supportedHigh444Predictive_ (std::move(other_.m_supportedHigh444Predictive_))
            ,
            m_supportedLevel1_ (std::move(other_.m_supportedLevel1_))
            ,
            m_supportedLevel11_ (std::move(other_.m_supportedLevel11_))
            ,
            m_supportedLevel12_ (std::move(other_.m_supportedLevel12_))
            ,
            m_supportedLevel13_ (std::move(other_.m_supportedLevel13_))
            ,
            m_supportedLevel1B_ (std::move(other_.m_supportedLevel1B_))
            ,
            m_supportedLevel2_ (std::move(other_.m_supportedLevel2_))
            ,
            m_supportedLevel21_ (std::move(other_.m_supportedLevel21_))
            ,
            m_supportedLevel22_ (std::move(other_.m_supportedLevel22_))
            ,
            m_supportedLevel3_ (std::move(other_.m_supportedLevel3_))
            ,
            m_supportedLevel31_ (std::move(other_.m_supportedLevel31_))
            ,
            m_supportedLevel32_ (std::move(other_.m_supportedLevel32_))
            ,
            m_supportedLevel4_ (std::move(other_.m_supportedLevel4_))
            ,
            m_supportedLevel41_ (std::move(other_.m_supportedLevel41_))
            ,
            m_supportedLevel42_ (std::move(other_.m_supportedLevel42_))
            ,
            m_supportedLevel5_ (std::move(other_.m_supportedLevel5_))
            ,
            m_supportedLevel51_ (std::move(other_.m_supportedLevel51_))
            ,
            m_supportedLevel52_ (std::move(other_.m_supportedLevel52_))
            ,
            m_supportedLowLatency_ (std::move(other_.m_supportedLowLatency_))
            ,
            m_supportedMain_ (std::move(other_.m_supportedMain_))
            ,
            m_supportedManipulation_ (std::move(other_.m_supportedManipulation_))
            ,
            m_supportedMultiviewHigh_ (std::move(other_.m_supportedMultiviewHigh_))
            ,
            m_supportedPersistentStare_ (std::move(other_.m_supportedPersistentStare_))
            ,
            m_supportedProgramSpecific1_ (std::move(other_.m_supportedProgramSpecific1_))
            ,
            m_supportedProgramSpecific2_ (std::move(other_.m_supportedProgramSpecific2_))
            ,
            m_supportedProgramSpecific3_ (std::move(other_.m_supportedProgramSpecific3_))
            ,
            m_supportedProgramSpecific4_ (std::move(other_.m_supportedProgramSpecific4_))
            ,
            m_supportedProgressiveHigh_ (std::move(other_.m_supportedProgressiveHigh_))
            ,
            m_supportedRegionOfInterest_ (std::move(other_.m_supportedRegionOfInterest_))
            ,
            m_supportedScalableBaseline_ (std::move(other_.m_supportedScalableBaseline_))
            ,
            m_supportedScalableConstrainedBaseline_ (std::move(other_.m_supportedScalableConstrainedBaseline_))
            ,
            m_supportedScalableConstrainedHigh_ (std::move(other_.m_supportedScalableConstrainedHigh_))
            ,
            m_supportedScalableHigh_ (std::move(other_.m_supportedScalableHigh_))
            ,
            m_supportedScalableHighIntra_ (std::move(other_.m_supportedScalableHighIntra_))
            ,
            m_supportedSlowComms_ (std::move(other_.m_supportedSlowComms_))
            ,
            m_supportedStereoHigh_ (std::move(other_.m_supportedStereoHigh_))
            ,
            ...
            H264VideoEncodingSpecsReportType& H264VideoEncodingSpecsReportType::operator=(H264VideoEncodingSpecsReportType&&  other_) OMG_NOEXCEPT {
                H264VideoEncodingSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void H264VideoEncodingSpecsReportType::swap(H264VideoEncodingSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
