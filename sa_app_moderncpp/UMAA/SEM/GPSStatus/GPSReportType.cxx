...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace GPSStatus {
            ...
            GPSReportType::GPSReportType (const UMAA::SEM::GPSStatus::GPSClockType& clock,int32_t numberSatellitesInView,const ::rti::core::bounded_sequence< UMAA::SEM::GPSStatus::GPSSatelliteType, 100L >& satellites,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_clock_( clock ),
                m_numberSatellitesInView_( numberSatellitesInView ),
                m_satellites_( satellites ),
                m_source_( source ),
            ...
            GPSReportType::GPSReportType(GPSReportType&& other_) OMG_NOEXCEPT  :m_clock_ (std::move(other_.m_clock_))
            ,
            m_numberSatellitesInView_ (std::move(other_.m_numberSatellitesInView_))
            ,
            ...
            GPSReportType& GPSReportType::operator=(GPSReportType&&  other_) OMG_NOEXCEPT {
                GPSReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GPSReportType::swap(GPSReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< UMAA::SEM::GPSStatus::GPSReportType > {
            static DDS_TypeCode * get()
            {
                ...
                GPSReportType_g_tc_satellites_sequence = initialize_sequence_typecode< ::rti::core::bounded_sequence< UMAA::SEM::GPSStatus::GPSSatelliteType, 100L > >((100L));
                ...
                GPSReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GPSReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< UMAA::Common::Measurement::DateTime>::get().native();
                ...
                GPSReportType_g_tc_members[1]._annotations._minValue._u.long_value = -2147483648L;
                GPSReportType_g_tc_members[1]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                GPSReportType_g_tc_members[1]._annotations._maxValue._u.long_value = 2147483647L;
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< UMAA::SEM::GPSStatus::GPSReportType >::allocate_sample(UMAA::SEM::GPSStatus::GPSReportType& sample, int, int) 
        {
            ...
            ::rti::topic::allocate_sample(sample.satellites(),  100L, -1);
