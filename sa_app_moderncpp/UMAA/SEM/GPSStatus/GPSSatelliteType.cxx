...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace GPSStatus {
            ...
            GPSSatelliteType::GPSSatelliteType (const ::dds::core::optional< double >& antennaCarrierNoiseDensity,const ::dds::core::optional< double >& azimuth,const ::dds::core::optional< double >& basebandCarrierNoiseDensity,const ::dds::core::optional< double >& carrierFrequency,const ::dds::core::optional< UMAA::Common::MaritimeEnumeration::GPSConstellationEnumType::GPSConstellationEnumType >& constellationType,const ::dds::core::optional< bool >& containsAlmanacData,const ::dds::core::optional< double >& elevation,const ::dds::core::optional< bool >& ephemerisData,const ::dds::core::optional< UMAA::Common::Measurement::NumericGUID >& satelliteId,const ::dds::core::optional< bool >& usedInFix):
                m_antennaCarrierNoiseDensity_( antennaCarrierNoiseDensity ),
                m_azimuth_( azimuth ),
                m_basebandCarrierNoiseDensity_( basebandCarrierNoiseDensity ),
                m_carrierFrequency_( carrierFrequency ),
                m_constellationType_( constellationType ),
                m_containsAlmanacData_( containsAlmanacData ),
                m_elevation_( elevation ),
                m_ephemerisData_( ephemerisData ),
                m_satelliteId_( satelliteId ),
                m_usedInFix_( usedInFix ) {
            }

            #ifdef RTI_CXX11_RVALUE_REFERENCES
            #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
            GPSSatelliteType::GPSSatelliteType(GPSSatelliteType&& other_) OMG_NOEXCEPT  :m_antennaCarrierNoiseDensity_ (std::move(other_.m_antennaCarrierNoiseDensity_))
            ,
            m_azimuth_ (std::move(other_.m_azimuth_))
            ,
            m_basebandCarrierNoiseDensity_ (std::move(other_.m_basebandCarrierNoiseDensity_))
            ,
            m_carrierFrequency_ (std::move(other_.m_carrierFrequency_))
            ,
            m_constellationType_ (std::move(other_.m_constellationType_))
            ,
            m_containsAlmanacData_ (std::move(other_.m_containsAlmanacData_))
            ,
            m_elevation_ (std::move(other_.m_elevation_))
            ,
            m_ephemerisData_ (std::move(other_.m_ephemerisData_))
            ,
            m_satelliteId_ (std::move(other_.m_satelliteId_))
            ,
            m_usedInFix_ (std::move(other_.m_usedInFix_))
            {
            } 

            GPSSatelliteType& GPSSatelliteType::operator=(GPSSatelliteType&&  other_) OMG_NOEXCEPT {
                GPSSatelliteType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GPSSatelliteType::swap(GPSSatelliteType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool GPSSatelliteType::operator == (const GPSSatelliteType& other_) const {
                if (m_antennaCarrierNoiseDensity_ != other_.m_antennaCarrierNoiseDensity_) {
                    return false;
                }
                if (m_azimuth_ != other_.m_azimuth_) {
                    return false;
                }
                if (m_basebandCarrierNoiseDensity_ != other_.m_basebandCarrierNoiseDensity_) {
                    return false;
                }
                if (m_carrierFrequency_ != other_.m_carrierFrequency_) {
                    return false;
                }
