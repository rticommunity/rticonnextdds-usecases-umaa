        ...
        namespace GPSStatus {
            ...
            class NDDSUSERDllExport GPSSatelliteType {
              public:
                ...
                GPSSatelliteType(const ::dds::core::optional< double >& antennaCarrierNoiseDensity,const ::dds::core::optional< double >& azimuth,const ::dds::core::optional< double >& basebandCarrierNoiseDensity,const ::dds::core::optional< double >& carrierFrequency,const ::dds::core::optional< UMAA::Common::MaritimeEnumeration::GPSConstellationEnumType::GPSConstellationEnumType >& constellationType,const ::dds::core::optional< bool >& containsAlmanacData,const ::dds::core::optional< double >& elevation,const ::dds::core::optional< bool >& ephemerisData,const ::dds::core::optional< UMAA::Common::Measurement::NumericGUID >& satelliteId,const ::dds::core::optional< bool >& usedInFix);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                GPSSatelliteType (GPSSatelliteType&&) = default;
                GPSSatelliteType& operator=(GPSSatelliteType&&) = default;
                GPSSatelliteType& operator=(const GPSSatelliteType&) = default;
                GPSSatelliteType(const GPSSatelliteType&) = default;
                #else
                GPSSatelliteType(GPSSatelliteType&& other_) OMG_NOEXCEPT;  
                GPSSatelliteType& operator=(GPSSatelliteType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 

                ::dds::core::optional< double >& antennaCarrierNoiseDensity() OMG_NOEXCEPT {
                    return m_antennaCarrierNoiseDensity_;
                }

                const ::dds::core::optional< double >& antennaCarrierNoiseDensity() const OMG_NOEXCEPT {
                    return m_antennaCarrierNoiseDensity_;
                }
                ...
                ::dds::core::optional< double >& azimuth() OMG_NOEXCEPT {
                    return m_azimuth_;
                }

                const ::dds::core::optional< double >& azimuth() const OMG_NOEXCEPT {
                    return m_azimuth_;
                }
                ...
                ::dds::core::optional< double >& basebandCarrierNoiseDensity() OMG_NOEXCEPT {
                    return m_basebandCarrierNoiseDensity_;
                }

                const ::dds::core::optional< double >& basebandCarrierNoiseDensity() const OMG_NOEXCEPT {
                    return m_basebandCarrierNoiseDensity_;
                }
                ...
                ::dds::core::optional< double >& carrierFrequency() OMG_NOEXCEPT {
                    return m_carrierFrequency_;
                }

                const ::dds::core::optional< double >& carrierFrequency() const OMG_NOEXCEPT {
                    return m_carrierFrequency_;
                }
                ...
                ::dds::core::optional< UMAA::Common::MaritimeEnumeration::GPSConstellationEnumType::GPSConstellationEnumType >& constellationType() OMG_NOEXCEPT {
                    return m_constellationType_;
                }

                const ::dds::core::optional< UMAA::Common::MaritimeEnumeration::GPSConstellationEnumType::GPSConstellationEnumType >& constellationType() const OMG_NOEXCEPT {
                    return m_constellationType_;
                }
                ...
                ::dds::core::optional< bool >& containsAlmanacData() OMG_NOEXCEPT {
                    return m_containsAlmanacData_;
                }

                const ::dds::core::optional< bool >& containsAlmanacData() const OMG_NOEXCEPT {
                    return m_containsAlmanacData_;
                }
                ...
                ::dds::core::optional< double >& elevation() OMG_NOEXCEPT {
                    return m_elevation_;
                }

                const ::dds::core::optional< double >& elevation() const OMG_NOEXCEPT {
                    return m_elevation_;
                }
                ...
                ::dds::core::optional< bool >& ephemerisData() OMG_NOEXCEPT {
                    return m_ephemerisData_;
                }

                const ::dds::core::optional< bool >& ephemerisData() const OMG_NOEXCEPT {
                    return m_ephemerisData_;
                }
                ...
                ::dds::core::optional< UMAA::Common::Measurement::NumericGUID >& satelliteId() OMG_NOEXCEPT {
                    return m_satelliteId_;
                }

                const ::dds::core::optional< UMAA::Common::Measurement::NumericGUID >& satelliteId() const OMG_NOEXCEPT {
                    return m_satelliteId_;
                }
                ...
                ::dds::core::optional< bool >& usedInFix() OMG_NOEXCEPT {
                    return m_usedInFix_;
                }

                const ::dds::core::optional< bool >& usedInFix() const OMG_NOEXCEPT {
                    return m_usedInFix_;
                }
                ...
                void swap(GPSSatelliteType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(GPSSatelliteType& a, GPSSatelliteType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
