...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointEffortStatus {
            ...
            static const std::string PanTiltJointEffortReport_TOPIC = "UMAA::SEM::PanTiltJointEffortStatus::PanTiltJointEffortReport";

            class NDDSUSERDllExport PanTiltJointEffortReportType {
              public:
                PanTiltJointEffortReportType();

                PanTiltJointEffortReportType(double panEffort,double tiltEffort,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp);

                #ifdef RTI_CXX11_RVALUE_REFERENCES
                #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
                PanTiltJointEffortReportType (PanTiltJointEffortReportType&&) = default;
                PanTiltJointEffortReportType& operator=(PanTiltJointEffortReportType&&) = default;
                PanTiltJointEffortReportType& operator=(const PanTiltJointEffortReportType&) = default;
                PanTiltJointEffortReportType(const PanTiltJointEffortReportType&) = default;
                #else
                PanTiltJointEffortReportType(PanTiltJointEffortReportType&& other_) OMG_NOEXCEPT;  
                PanTiltJointEffortReportType& operator=(PanTiltJointEffortReportType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                void swap(PanTiltJointEffortReportType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(PanTiltJointEffortReportType& a, PanTiltJointEffortReportType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }
