...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace PanTiltJointPositionStatus {
            ...
            PanTiltJointPositionStateReportType::PanTiltJointPositionStateReportType (double pan,double tilt,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_pan_( pan ),
                m_tilt_( tilt ),
                m_source_( source ),
            ...
            PanTiltJointPositionStateReportType::PanTiltJointPositionStateReportType(PanTiltJointPositionStateReportType&& other_) OMG_NOEXCEPT  :m_pan_ (std::move(other_.m_pan_))
            ,
            ...
            PanTiltJointPositionStateReportType& PanTiltJointPositionStateReportType::operator=(PanTiltJointPositionStateReportType&&  other_) OMG_NOEXCEPT {
                PanTiltJointPositionStateReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PanTiltJointPositionStateReportType::swap(PanTiltJointPositionStateReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
