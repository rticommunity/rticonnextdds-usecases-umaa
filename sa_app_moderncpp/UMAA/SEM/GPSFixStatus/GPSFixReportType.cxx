    ...
    namespace SEM {
        ...
        namespace GPSFixStatus {
            ...
            GPSFixReportType::GPSFixReportType (const UMAA::Common::Measurement::Altitude_MSL& altitudeMSL,const UMAA::Common::MaritimeEnumeration::GPSFixEnumType::GPSFixEnumType& GPSFixCommandStatus,bool GPSLatLongValid,double magneticVariation,const UMAA::Common::Measurement::Position2DTime& position2DWithTime,double SOG,double trueCourse,const UMAA::Common::Measurement::Velocity3D_PlatformNED& velocity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_altitudeMSL_( altitudeMSL ),
                m_GPSFixCommandStatus_( GPSFixCommandStatus ),
                m_GPSLatLongValid_( GPSLatLongValid ),
                m_magneticVariation_( magneticVariation ),
                m_position2DWithTime_( position2DWithTime ),
                m_SOG_( SOG ),
                m_trueCourse_( trueCourse ),
            ...
            GPSFixReportType::GPSFixReportType(GPSFixReportType&& other_) OMG_NOEXCEPT  :m_altitudeMSL_ (std::move(other_.m_altitudeMSL_))
            ,
            m_GPSFixCommandStatus_ (std::move(other_.m_GPSFixCommandStatus_))
            ,
            m_GPSLatLongValid_ (std::move(other_.m_GPSLatLongValid_))
            ,
            m_magneticVariation_ (std::move(other_.m_magneticVariation_))
            ,
            m_position2DWithTime_ (std::move(other_.m_position2DWithTime_))
            ,
            m_SOG_ (std::move(other_.m_SOG_))
            ,
            m_trueCourse_ (std::move(other_.m_trueCourse_))
            ,
            ...
            GPSFixReportType& GPSFixReportType::operator=(GPSFixReportType&&  other_) OMG_NOEXCEPT {
                GPSFixReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void GPSFixReportType::swap(GPSFixReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool GPSFixReportType::operator == (const GPSFixReportType& other_) const {
                ...
                if (m_SOG_ != other_.m_SOG_) {
                    return false;
                }
                if (m_trueCourse_ != other_.m_trueCourse_) {
                    return false;
                }
