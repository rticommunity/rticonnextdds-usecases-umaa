...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace CameraSpecs {
            ...
            CameraSpecsReportType::CameraSpecsReportType (bool exposureModeAperture,bool exposureModeAuto,bool exposureModeManual,bool exposureModeShutter,bool focusModeAuto,bool focusModeManual,bool imageStabilization,bool imagingModeColor,bool imagingModeGreyscale,bool imagingModeInfrared,bool imagingModeLowlight,bool lightSensitivity_ISO100,bool lightSensitivity_ISO1600,bool lightSensitivity_ISO200,bool lightSensitivity_ISO3200,bool lightSensitivity_ISO400,bool lightSensitivity_ISO800,bool lightSensitivityAuto,double maxAperture,double maxFocalLength,double maxShutterSpeed,bool meteringModeAuto,bool meteringModeCenterWeighted,bool meteringModeSpot,double minAperture,double minFocalLength,double minShutterSpeed,const std::string& name,bool stateActive,bool stateOff,bool stateStandby,bool whiteBalanceAuto,bool whiteBalanceCloudy,bool whiteBalanceDaylight,bool whiteBalanceFlash,bool whiteBalanceFluorescent,bool whiteBalanceShade,bool whiteBalanceTungsten,bool zoomModeAnalog,bool zoomModeDigital,bool zoomModeMixed,bool zoomModeOff,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_exposureModeAperture_( exposureModeAperture ),
                m_exposureModeAuto_( exposureModeAuto ),
                m_exposureModeManual_( exposureModeManual ),
                m_exposureModeShutter_( exposureModeShutter ),
                m_focusModeAuto_( focusModeAuto ),
                m_focusModeManual_( focusModeManual ),
                m_imageStabilization_( imageStabilization ),
                m_imagingModeColor_( imagingModeColor ),
                m_imagingModeGreyscale_( imagingModeGreyscale ),
                m_imagingModeInfrared_( imagingModeInfrared ),
                m_imagingModeLowlight_( imagingModeLowlight ),
                m_lightSensitivity_ISO100_( lightSensitivity_ISO100 ),
                m_lightSensitivity_ISO1600_( lightSensitivity_ISO1600 ),
                m_lightSensitivity_ISO200_( lightSensitivity_ISO200 ),
                m_lightSensitivity_ISO3200_( lightSensitivity_ISO3200 ),
                m_lightSensitivity_ISO400_( lightSensitivity_ISO400 ),
                m_lightSensitivity_ISO800_( lightSensitivity_ISO800 ),
                m_lightSensitivityAuto_( lightSensitivityAuto ),
                m_maxAperture_( maxAperture ),
                m_maxFocalLength_( maxFocalLength ),
                m_maxShutterSpeed_( maxShutterSpeed ),
                m_meteringModeAuto_( meteringModeAuto ),
                m_meteringModeCenterWeighted_( meteringModeCenterWeighted ),
                m_meteringModeSpot_( meteringModeSpot ),
                m_minAperture_( minAperture ),
                m_minFocalLength_( minFocalLength ),
                m_minShutterSpeed_( minShutterSpeed ),
                m_name_( name ),
                m_stateActive_( stateActive ),
                m_stateOff_( stateOff ),
                m_stateStandby_( stateStandby ),
                m_whiteBalanceAuto_( whiteBalanceAuto ),
                m_whiteBalanceCloudy_( whiteBalanceCloudy ),
                m_whiteBalanceDaylight_( whiteBalanceDaylight ),
                m_whiteBalanceFlash_( whiteBalanceFlash ),
                m_whiteBalanceFluorescent_( whiteBalanceFluorescent ),
                m_whiteBalanceShade_( whiteBalanceShade ),
                m_whiteBalanceTungsten_( whiteBalanceTungsten ),
                m_zoomModeAnalog_( zoomModeAnalog ),
                m_zoomModeDigital_( zoomModeDigital ),
                m_zoomModeMixed_( zoomModeMixed ),
                m_zoomModeOff_( zoomModeOff ),
                m_source_( source ),
            ...
            CameraSpecsReportType::CameraSpecsReportType(CameraSpecsReportType&& other_) OMG_NOEXCEPT  :m_exposureModeAperture_ (std::move(other_.m_exposureModeAperture_))
            ,
            m_exposureModeAuto_ (std::move(other_.m_exposureModeAuto_))
            ,
            m_exposureModeManual_ (std::move(other_.m_exposureModeManual_))
            ,
            m_exposureModeShutter_ (std::move(other_.m_exposureModeShutter_))
            ,
            m_focusModeAuto_ (std::move(other_.m_focusModeAuto_))
            ,
            m_focusModeManual_ (std::move(other_.m_focusModeManual_))
            ,
            m_imageStabilization_ (std::move(other_.m_imageStabilization_))
            ,
            m_imagingModeColor_ (std::move(other_.m_imagingModeColor_))
            ,
            m_imagingModeGreyscale_ (std::move(other_.m_imagingModeGreyscale_))
            ,
            m_imagingModeInfrared_ (std::move(other_.m_imagingModeInfrared_))
            ,
            m_imagingModeLowlight_ (std::move(other_.m_imagingModeLowlight_))
            ,
            m_lightSensitivity_ISO100_ (std::move(other_.m_lightSensitivity_ISO100_))
            ,
            m_lightSensitivity_ISO1600_ (std::move(other_.m_lightSensitivity_ISO1600_))
            ,
            m_lightSensitivity_ISO200_ (std::move(other_.m_lightSensitivity_ISO200_))
            ,
            m_lightSensitivity_ISO3200_ (std::move(other_.m_lightSensitivity_ISO3200_))
            ,
            m_lightSensitivity_ISO400_ (std::move(other_.m_lightSensitivity_ISO400_))
            ,
            m_lightSensitivity_ISO800_ (std::move(other_.m_lightSensitivity_ISO800_))
            ,
            m_lightSensitivityAuto_ (std::move(other_.m_lightSensitivityAuto_))
            ,
            m_maxAperture_ (std::move(other_.m_maxAperture_))
            ,
            m_maxFocalLength_ (std::move(other_.m_maxFocalLength_))
            ,
            m_maxShutterSpeed_ (std::move(other_.m_maxShutterSpeed_))
            ,
            m_meteringModeAuto_ (std::move(other_.m_meteringModeAuto_))
            ,
            m_meteringModeCenterWeighted_ (std::move(other_.m_meteringModeCenterWeighted_))
            ,
            m_meteringModeSpot_ (std::move(other_.m_meteringModeSpot_))
            ,
            m_minAperture_ (std::move(other_.m_minAperture_))
            ,
            m_minFocalLength_ (std::move(other_.m_minFocalLength_))
            ,
            m_minShutterSpeed_ (std::move(other_.m_minShutterSpeed_))
            ,
            ...
            ,
            m_whiteBalanceAuto_ (std::move(other_.m_whiteBalanceAuto_))
            ,
            m_whiteBalanceCloudy_ (std::move(other_.m_whiteBalanceCloudy_))
            ,
            m_whiteBalanceDaylight_ (std::move(other_.m_whiteBalanceDaylight_))
            ,
            m_whiteBalanceFlash_ (std::move(other_.m_whiteBalanceFlash_))
            ,
            m_whiteBalanceFluorescent_ (std::move(other_.m_whiteBalanceFluorescent_))
            ,
            m_whiteBalanceShade_ (std::move(other_.m_whiteBalanceShade_))
            ,
            m_whiteBalanceTungsten_ (std::move(other_.m_whiteBalanceTungsten_))
            ,
            m_zoomModeAnalog_ (std::move(other_.m_zoomModeAnalog_))
            ,
            m_zoomModeDigital_ (std::move(other_.m_zoomModeDigital_))
            ,
            m_zoomModeMixed_ (std::move(other_.m_zoomModeMixed_))
            ,
            m_zoomModeOff_ (std::move(other_.m_zoomModeOff_))
            ,
            ...
            CameraSpecsReportType& CameraSpecsReportType::operator=(CameraSpecsReportType&&  other_) OMG_NOEXCEPT {
                CameraSpecsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CameraSpecsReportType::swap(CameraSpecsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
            ...
            bool CameraSpecsReportType::operator == (const CameraSpecsReportType& other_) const {
                ...
                if (m_maxAperture_ != other_.m_maxAperture_) {
                    return false;
                }
                if (m_maxFocalLength_ != other_.m_maxFocalLength_) {
                    return false;
                }
                if (m_maxShutterSpeed_ != other_.m_maxShutterSpeed_) {
                    return false;
                }
                ...
                if (m_minAperture_ != other_.m_minAperture_) {
                    return false;
                }
                if (m_minFocalLength_ != other_.m_minFocalLength_) {
                    return false;
                }
                if (m_minShutterSpeed_ != other_.m_minShutterSpeed_) {
                    return false;
                }
