...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalAudioConfig {
            ...
            DigitalAudioConfigReportType::DigitalAudioConfigReportType (const UMAA::Common::MaritimeEnumeration::BitDepthEnumType::BitDepthEnumType& bitDepth,const UMAA::Common::MaritimeEnumeration::DigitalAudioFormatEnumType::DigitalAudioFormatEnumType& digitalFormat,const UMAA::Common::MaritimeEnumeration::AudioEncodingQualityEnumType::AudioEncodingQualityEnumType& encodingQuality,int32_t maxBitRate,int32_t minBitRate,int32_t numberOfChannels,int32_t sampleRate,int32_t sensitivity,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_bitDepth_( bitDepth ),
                m_digitalFormat_( digitalFormat ),
                m_encodingQuality_( encodingQuality ),
                m_maxBitRate_( maxBitRate ),
                m_minBitRate_( minBitRate ),
                m_numberOfChannels_( numberOfChannels ),
                m_sampleRate_( sampleRate ),
                m_sensitivity_( sensitivity ),
                m_source_( source ),
            ...
            DigitalAudioConfigReportType::DigitalAudioConfigReportType(DigitalAudioConfigReportType&& other_) OMG_NOEXCEPT  :m_bitDepth_ (std::move(other_.m_bitDepth_))
            ,
            m_digitalFormat_ (std::move(other_.m_digitalFormat_))
            ,
            m_encodingQuality_ (std::move(other_.m_encodingQuality_))
            ,
            m_maxBitRate_ (std::move(other_.m_maxBitRate_))
            ,
            m_minBitRate_ (std::move(other_.m_minBitRate_))
            ,
            m_numberOfChannels_ (std::move(other_.m_numberOfChannels_))
            ,
            m_sampleRate_ (std::move(other_.m_sampleRate_))
            ,
            m_sensitivity_ (std::move(other_.m_sensitivity_))
            ,
            ...
            DigitalAudioConfigReportType& DigitalAudioConfigReportType::operator=(DigitalAudioConfigReportType&&  other_) OMG_NOEXCEPT {
                DigitalAudioConfigReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void DigitalAudioConfigReportType::swap(DigitalAudioConfigReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
