...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace CameraControl {
            ...
            CameraCommandAckReportType::CameraCommandAckReportType (const ::dds::core::optional< UMAA::Common::Measurement::BuiltInTestStatusType_All >& builtInTest,bool filtered,const UMAA::Common::Measurement::Position2D& imageCenterLocation,const UMAA::Common::Enumeration::IRPolarityEnumType::IRPolarityEnumType& mode,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::NumericGUID& sessionID):
            ...
            CameraCommandAckReportType::CameraCommandAckReportType(CameraCommandAckReportType&& other_) OMG_NOEXCEPT  :m_builtInTest_ (std::move(other_.m_builtInTest_))
            ,
            ...
            CameraCommandAckReportType& CameraCommandAckReportType::operator=(CameraCommandAckReportType&&  other_) OMG_NOEXCEPT {
                CameraCommandAckReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void CameraCommandAckReportType::swap(CameraCommandAckReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
