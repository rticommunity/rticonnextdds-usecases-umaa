...
#ifndef CameraCommandStatusType_853748046_hpp
#define CameraCommandStatusType_853748046_hpp
...
namespace UMAA {
    namespace SEM {
        namespace CameraControl {
            ...
            static const std::string CameraCommandStatus_TOPIC = "UMAA::SEM::CameraControl::CameraCommandStatus";

            class NDDSUSERDllExport CameraCommandStatusType {
              public:
                ...
                CameraCommandStatusType (CameraCommandStatusType&&) = default;
                CameraCommandStatusType& operator=(CameraCommandStatusType&&) = default;
                CameraCommandStatusType& operator=(const CameraCommandStatusType&) = default;
                CameraCommandStatusType(const CameraCommandStatusType&) = default;
                #else
                CameraCommandStatusType(CameraCommandStatusType&& other_) OMG_NOEXCEPT;  
                CameraCommandStatusType& operator=(CameraCommandStatusType&&  other_) OMG_NOEXCEPT;
                #endif
                #endif 
                ...
                bool operator == (const CameraCommandStatusType& other_) const;
                bool operator != (const CameraCommandStatusType& other_) const;

                void swap(CameraCommandStatusType& other_) OMG_NOEXCEPT ;
            ...
            inline void swap(CameraCommandStatusType& a, CameraCommandStatusType& b)  OMG_NOEXCEPT 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CameraCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< UMAA::SEM::CameraControl::CameraCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::CameraControl::CameraCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< UMAA::SEM::CameraControl::CameraCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< UMAA::SEM::CameraControl::CameraCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(UMAA::SEM::CameraControl::CameraCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(UMAA::SEM::CameraControl::CameraCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(UMAA::SEM::CameraControl::CameraCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< UMAA::SEM::CameraControl::CameraCommandStatusType > {
        ...
        template <>
        struct extensibility< UMAA::SEM::CameraControl::CameraCommandStatusType > {
...
#endif // CameraCommandStatusType_853748046_hpp
