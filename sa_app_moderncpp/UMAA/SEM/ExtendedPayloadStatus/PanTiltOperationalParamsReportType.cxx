...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace ExtendedPayloadStatus {
            ...
            PanTiltOperationalParamsReportType::PanTiltOperationalParamsReportType (const UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& panParams,const UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& tiltParams,const UMAA::Common::Measurement::NumericGUID& source,const UMAA::Common::Measurement::DateTime& timeStamp):
                m_panParams_( panParams ),
                m_tiltParams_( tiltParams ),
                m_source_( source ),
            ...
            PanTiltOperationalParamsReportType::PanTiltOperationalParamsReportType(PanTiltOperationalParamsReportType&& other_) OMG_NOEXCEPT  :m_panParams_ (std::move(other_.m_panParams_))
            ,
            m_tiltParams_ (std::move(other_.m_tiltParams_))
            ,
            ...
            PanTiltOperationalParamsReportType& PanTiltOperationalParamsReportType::operator=(PanTiltOperationalParamsReportType&&  other_) OMG_NOEXCEPT {
                PanTiltOperationalParamsReportType tmp(std::move(other_));
                swap(tmp); 
                return *this;
            }
            #endif
            ...
            void PanTiltOperationalParamsReportType::swap(PanTiltOperationalParamsReportType& other_)  OMG_NOEXCEPT 
            {
                using std::swap;
