...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthReporter {
            ...
            ResetReminderCommandReportType::ResetReminderCommandReportType (const ::UMAA::Common::Measurement::NumericGUID& reminderID_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_reminderID_(reminderID_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void ResetReminderCommandReportType::swap(ResetReminderCommandReportType& other_)  noexcept 
            {
                using std::swap;
