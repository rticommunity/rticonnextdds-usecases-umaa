        ...
        namespace HealthReporter {
            ...
            class NDDSUSERDllExport ReminderSummaryStatusType {
              public:
                ...
                ReminderSummaryStatusType(const ::rti::core::bounded_sequence< bool, 100L >& reminderExpireds_,const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& reminderIDs_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< bool, 100L >& reminderExpireds() noexcept {
                    return m_reminderExpireds_;
                }

                const ::rti::core::bounded_sequence< bool, 100L >& reminderExpireds() const noexcept {
                    return m_reminderExpireds_;
                }
                ...
                ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& reminderIDs() noexcept {
                    return m_reminderIDs_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& reminderIDs() const noexcept {
                    return m_reminderIDs_;
                }
                ...
                void swap(ReminderSummaryStatusType& other_) noexcept ;
            ...
            inline void swap(ReminderSummaryStatusType& a, ReminderSummaryStatusType& b)  noexcept 
            {
                a.swap(b);
            }
