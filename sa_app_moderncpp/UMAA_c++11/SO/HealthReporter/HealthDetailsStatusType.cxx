...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthReporter {
            ...
            HealthDetailsStatusType::HealthDetailsStatusType (const ::UMAA::Common::MaritimeEnumeration::ErrorCodeEnumType::ErrorCodeEnumType& code_,const std::string& descriptor_,const ::UMAA::Common::Measurement::DateTime& logTime_,const std::string& resourceURN_,const ::UMAA::Common::MaritimeEnumeration::ErrorConditionEnumType::ErrorConditionEnumType& severity_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& detailID_):
                m_code_(code_), 
                m_descriptor_(descriptor_), 
                m_logTime_(logTime_), 
                m_resourceURN_(resourceURN_), 
                m_severity_(severity_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_), 
                m_detailID_(detailID_) {
            }

            void HealthDetailsStatusType::swap(HealthDetailsStatusType& other_)  noexcept 
            {
                using std::swap;
