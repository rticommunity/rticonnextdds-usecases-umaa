...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthReporter {
            ...
            ResetReminderCommandType::ResetReminderCommandType (const ::UMAA::Common::Measurement::NumericGUID& reminderID_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
            ...
            void ResetReminderCommandType::swap(ResetReminderCommandType& other_)  noexcept 
            {
                using std::swap;
