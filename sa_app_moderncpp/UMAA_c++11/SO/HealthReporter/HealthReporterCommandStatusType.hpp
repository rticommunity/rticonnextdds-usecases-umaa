...
namespace UMAA {
    namespace SO {
        namespace HealthReporter {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string HealthReporterCommandStatus_TOPIC = "UMAA::SO::HealthReporter::HealthReporterCommandStatus";
            ...
            class NDDSUSERDllExport HealthReporterCommandStatusType {
              public:
                ...
                void swap(HealthReporterCommandStatusType& other_) noexcept ;
            ...
            inline void swap(HealthReporterCommandStatusType& a, HealthReporterCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
