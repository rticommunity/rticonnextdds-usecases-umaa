...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthReporter {
            ...
            HealthReporterCommandType::HealthReporterCommandType (const ::UMAA::Common::Measurement::BuiltInTestStatusType_All& builtInTest_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
            ...
            void HealthReporterCommandType::swap(HealthReporterCommandType& other_)  noexcept 
            {
                using std::swap;
