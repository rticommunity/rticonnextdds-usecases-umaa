...
namespace UMAA {
    namespace SO {
        namespace HealthReporter {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ResetReminderCommandStatus_TOPIC = "UMAA::SO::HealthReporter::ResetReminderCommandStatus";
            ...
            class NDDSUSERDllExport ResetReminderCommandStatusType {
              public:
                ...
                void swap(ResetReminderCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ResetReminderCommandStatusType& a, ResetReminderCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
