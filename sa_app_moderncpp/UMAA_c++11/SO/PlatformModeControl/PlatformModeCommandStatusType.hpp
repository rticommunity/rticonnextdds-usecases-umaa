...
namespace UMAA {
    namespace SO {
        namespace PlatformModeControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PlatformModeCommandStatus_TOPIC = "UMAA::SO::PlatformModeControl::PlatformModeCommandStatus";
            ...
            class NDDSUSERDllExport PlatformModeCommandStatusType {
              public:
                ...
                void swap(PlatformModeCommandStatusType& other_) noexcept ;
            ...
            inline void swap(PlatformModeCommandStatusType& a, PlatformModeCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
