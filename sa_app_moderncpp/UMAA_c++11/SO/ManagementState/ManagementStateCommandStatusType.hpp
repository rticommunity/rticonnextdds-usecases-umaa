...
namespace UMAA {
    namespace SO {
        namespace ManagementState {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ManagementStateCommandStatus_TOPIC = "UMAA::SO::ManagementState::ManagementStateCommandStatus";
            ...
            class NDDSUSERDllExport ManagementStateCommandStatusType {
              public:
                ...
                void swap(ManagementStateCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ManagementStateCommandStatusType& a, ManagementStateCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
