...
namespace UMAA {
    namespace SO {
        namespace ManagementState {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ManagementStateCommandReport_TOPIC = "UMAA::SO::ManagementState::ManagementStateCommandReport";
            ...
            class NDDSUSERDllExport ManagementStateCommandReportType {
              public:
                ...
                ManagementStateCommandReportType(const ::UMAA::Common::MaritimeEnumeration::CoreStateEnumType::CoreStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(ManagementStateCommandReportType& other_) noexcept ;
            ...
            inline void swap(ManagementStateCommandReportType& a, ManagementStateCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
