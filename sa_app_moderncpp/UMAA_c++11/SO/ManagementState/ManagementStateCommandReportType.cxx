...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ManagementState {
            ...
            ManagementStateCommandReportType::ManagementStateCommandReportType (const ::UMAA::Common::MaritimeEnumeration::CoreStateEnumType::CoreStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_state_(state_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void ManagementStateCommandReportType::swap(ManagementStateCommandReportType& other_)  noexcept 
            {
                using std::swap;
