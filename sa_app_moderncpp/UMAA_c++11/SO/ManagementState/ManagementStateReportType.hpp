...
namespace UMAA {
    namespace SO {
        namespace ManagementState {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ManagementStateReport_TOPIC = "UMAA::SO::ManagementState::ManagementStateReport";
            ...
            class NDDSUSERDllExport ManagementStateReportType {
              public:
                ...
                ManagementStateReportType(const ::UMAA::Common::MaritimeEnumeration::CoreStateEnumType::CoreStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(ManagementStateReportType& other_) noexcept ;
            ...
            inline void swap(ManagementStateReportType& a, ManagementStateReportType& b)  noexcept 
            {
                a.swap(b);
            }
