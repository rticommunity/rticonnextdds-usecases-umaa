...
namespace UMAA {
    namespace SO {
        namespace ManagementState {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string EmergencyStateCommandStatus_TOPIC = "UMAA::SO::ManagementState::EmergencyStateCommandStatus";
            ...
            class NDDSUSERDllExport EmergencyStateCommandStatusType {
              public:
                ...
                void swap(EmergencyStateCommandStatusType& other_) noexcept ;
            ...
            inline void swap(EmergencyStateCommandStatusType& a, EmergencyStateCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
