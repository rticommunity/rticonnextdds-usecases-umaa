...
data type TamperDetectionReportType from TamperDetectionReportType.idl.
This example builds two applications, named TamperDetectionReportType_publisher and
TamperDetectionReportType_subscriber.
...
> make -f makefile_TamperDetectionReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_TamperDetectionReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the TamperDetectionReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/TamperDetectionReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/TamperDetectionReportType_subscriber -d <domain_id> -s <sample_count>
