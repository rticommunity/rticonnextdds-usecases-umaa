...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace TamperDetectionControl {
            ...
            TamperDetectionCommandAckReportType::TamperDetectionCommandAckReportType (const ::UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumType::TamperDetectionStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_state_(state_), 
                m_source_(source_), 
