...
namespace UMAA {
    namespace SO {
        namespace TamperDetectionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string TamperDetectionCommandStatus_TOPIC = "UMAA::SO::TamperDetectionControl::TamperDetectionCommandStatus";
            ...
            class NDDSUSERDllExport TamperDetectionCommandStatusType {
              public:
                ...
                void swap(TamperDetectionCommandStatusType& other_) noexcept ;
            ...
            inline void swap(TamperDetectionCommandStatusType& a, TamperDetectionCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
