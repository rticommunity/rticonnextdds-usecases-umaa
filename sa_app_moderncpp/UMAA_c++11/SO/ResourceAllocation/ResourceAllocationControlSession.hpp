        ...
        namespace ResourceAllocation {
            ...
            class NDDSUSERDllExport ResourceAllocationControlSession {
              public:
                ...
                ResourceAllocationControlSession(const ::UMAA::Common::Measurement::NumericGUID& controllingConsumer_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& endTime_);

                ::UMAA::Common::Measurement::NumericGUID& controllingConsumer() noexcept {
                    return m_controllingConsumer_;
                }

                const ::UMAA::Common::Measurement::NumericGUID& controllingConsumer() const noexcept {
                    return m_controllingConsumer_;
                }
                ...
                void swap(ResourceAllocationControlSession& other_) noexcept ;
            ...
            inline void swap(ResourceAllocationControlSession& a, ResourceAllocationControlSession& b)  noexcept 
            {
                a.swap(b);
            }
