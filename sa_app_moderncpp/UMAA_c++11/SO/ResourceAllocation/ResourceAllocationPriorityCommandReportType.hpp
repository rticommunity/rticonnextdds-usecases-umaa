...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ResourceAllocationPriorityCommandReport_TOPIC = "UMAA::SO::ResourceAllocation::ResourceAllocationPriorityCommandReport";
            ...
            class NDDSUSERDllExport ResourceAllocationPriorityCommandReportType {
              public:
                ...
                ResourceAllocationPriorityCommandReportType(const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& priorities_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& resourceId_);
                ...
                void swap(ResourceAllocationPriorityCommandReportType& other_) noexcept ;
            ...
            inline void swap(ResourceAllocationPriorityCommandReportType& a, ResourceAllocationPriorityCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
