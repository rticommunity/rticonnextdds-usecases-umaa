...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ResourceAllocationPriorityCommandStatus_TOPIC = "UMAA::SO::ResourceAllocation::ResourceAllocationPriorityCommandStatus";
            ...
            class NDDSUSERDllExport ResourceAllocationPriorityCommandStatusType {
              public:
                ...
                void swap(ResourceAllocationPriorityCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ResourceAllocationPriorityCommandStatusType& a, ResourceAllocationPriorityCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
