...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ResourceAllocationCommandStatus_TOPIC = "UMAA::SO::ResourceAllocation::ResourceAllocationCommandStatus";
