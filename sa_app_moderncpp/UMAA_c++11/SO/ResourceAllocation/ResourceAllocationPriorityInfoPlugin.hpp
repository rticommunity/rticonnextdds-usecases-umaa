...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            */
            typedef class ResourceAllocationPriorityInfo ResourceAllocationPriorityInfoKeyHolder;
            ...
            #define ResourceAllocationPriorityInfoPlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
            #define ResourceAllocationPriorityInfoPlugin_return_key PRESTypePluginDefaultEndpointData_returnKey
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern ResourceAllocationPriorityInfo*
            ResourceAllocationPriorityInfoPluginSupport_create_key_ex(RTIBool allocate_pointers);

            NDDSUSERDllExport extern ResourceAllocationPriorityInfo*
            ResourceAllocationPriorityInfoPluginSupport_create_key(void);

            NDDSUSERDllExport extern void 
            ResourceAllocationPriorityInfoPluginSupport_destroy_key_ex(
                ResourceAllocationPriorityInfoKeyHolder *key,RTIBool deallocate_pointers);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            ResourceAllocationPriorityInfoPlugin_instance_to_key(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationPriorityInfoKeyHolder *key, 
                const ResourceAllocationPriorityInfo *instance);

            NDDSUSERDllExport extern RTIBool 
            ResourceAllocationPriorityInfoPlugin_key_to_instance(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationPriorityInfo *instance, 
                const ResourceAllocationPriorityInfoKeyHolder *key);
            ...
            ResourceAllocationPriorityInfoPlugin_new(void);

            NDDSUSERDllExport extern void
            ResourceAllocationPriorityInfoPlugin_delete(struct PRESTypePlugin *);
