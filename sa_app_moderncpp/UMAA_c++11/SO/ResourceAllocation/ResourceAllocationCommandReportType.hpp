...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ResourceAllocationCommandReport_TOPIC = "UMAA::SO::ResourceAllocation::ResourceAllocationCommandReport";
            ...
            class NDDSUSERDllExport ResourceAllocationCommandReportType {
              public:
                ...
                ResourceAllocationCommandReportType(const ::dds::core::optional< double >& duration_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& resourceId_);
                ...
                void swap(ResourceAllocationCommandReportType& other_) noexcept ;
            ...
            inline void swap(ResourceAllocationCommandReportType& a, ResourceAllocationCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
