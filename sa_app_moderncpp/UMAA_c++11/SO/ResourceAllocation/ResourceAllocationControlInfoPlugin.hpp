...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            */
            typedef class ResourceAllocationControlInfo ResourceAllocationControlInfoKeyHolder;
            ...
            #define ResourceAllocationControlInfoPlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
            #define ResourceAllocationControlInfoPlugin_return_key PRESTypePluginDefaultEndpointData_returnKey
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern ResourceAllocationControlInfo*
            ResourceAllocationControlInfoPluginSupport_create_key_ex(RTIBool allocate_pointers);

            NDDSUSERDllExport extern ResourceAllocationControlInfo*
            ResourceAllocationControlInfoPluginSupport_create_key(void);

            NDDSUSERDllExport extern void 
            ResourceAllocationControlInfoPluginSupport_destroy_key_ex(
                ResourceAllocationControlInfoKeyHolder *key,RTIBool deallocate_pointers);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            ResourceAllocationControlInfoPlugin_instance_to_key(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationControlInfoKeyHolder *key, 
                const ResourceAllocationControlInfo *instance);

            NDDSUSERDllExport extern RTIBool 
            ResourceAllocationControlInfoPlugin_key_to_instance(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationControlInfo *instance, 
                const ResourceAllocationControlInfoKeyHolder *key);
            ...
            ResourceAllocationControlInfoPlugin_new(void);

            NDDSUSERDllExport extern void
            ResourceAllocationControlInfoPlugin_delete(struct PRESTypePlugin *);
