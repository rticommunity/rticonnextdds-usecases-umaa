...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ResourceAllocation {
            ...
            ResourceAllocationConfigReportType::ResourceAllocationConfigReportType (const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& resourcesSetID_):
                m_source_(source_), 
                m_timeStamp_(timeStamp_), 
                m_resourcesSetID_(resourcesSetID_) {
            }
            ...
            ResourceAllocationConfigReportType_ResourcesSet::ResourceAllocationConfigReportType_ResourcesSet (const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& relatedSources_,const ::UMAA::Common::Measurement::NumericGUID& resourceId_,const ::UMAA::Common::Measurement::NumericGUID& resourcesSetID_,const ::UMAA::Common::Measurement::DateTime& resourcesTimestamp_) :
                ::UMAA::SO::ResourceAllocation::ResourceAllocationDefinitionType(relatedSources_, resourceId_), 
                m_resourcesSetID_(resourcesSetID_), 
                m_resourcesTimestamp_(resourcesTimestamp_) {
            }

            void ResourceAllocationConfigReportType_ResourcesSet::swap(ResourceAllocationConfigReportType_ResourcesSet& other_)  noexcept 
            {
                using std::swap;
