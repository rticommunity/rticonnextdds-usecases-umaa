...
namespace UMAA {
    namespace SO {
        namespace RenderUselessStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string RenderUselessReport_TOPIC = "UMAA::SO::RenderUselessStatus::RenderUselessReport";
            ...
            class NDDSUSERDllExport RenderUselessReportType {
              public:
                ...
                RenderUselessReportType(const std::string& errorString_,const ::UMAA::Common::MaritimeEnumeration::RenderUselessStateEnumType::RenderUselessStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                std::string& errorString() noexcept {
                ...
                ::UMAA::Common::MaritimeEnumeration::RenderUselessStateEnumType::RenderUselessStateEnumType& state() noexcept {
                    return m_state_;
                }

                const ::UMAA::Common::MaritimeEnumeration::RenderUselessStateEnumType::RenderUselessStateEnumType& state() const noexcept {
                    return m_state_;
                }
                ...
                void swap(RenderUselessReportType& other_) noexcept ;
            ...
            inline void swap(RenderUselessReportType& a, RenderUselessReportType& b)  noexcept 
            {
                a.swap(b);
            }
