...
namespace UMAA {
    namespace SO {
        namespace HealthSummaryControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string HealthSummaryCommandStatus_TOPIC = "UMAA::SO::HealthSummaryControl::HealthSummaryCommandStatus";
            ...
            class NDDSUSERDllExport HealthSummaryCommandStatusType {
              public:
                ...
                void swap(HealthSummaryCommandStatusType& other_) noexcept ;
            ...
            inline void swap(HealthSummaryCommandStatusType& a, HealthSummaryCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
