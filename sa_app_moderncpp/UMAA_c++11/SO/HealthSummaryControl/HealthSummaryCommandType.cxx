...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace HealthSummaryControl {
            ...
            HealthSummaryCommandType::HealthSummaryCommandType (const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_source_(source_), 
            ...
            void HealthSummaryCommandType::swap(HealthSummaryCommandType& other_)  noexcept 
            {
                using std::swap;
