...
data type HeartbeatPulseReportType from HeartbeatPulseReportType.idl.
This example builds two applications, named HeartbeatPulseReportType_publisher and
HeartbeatPulseReportType_subscriber.
...
> make -f makefile_HeartbeatPulseReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_HeartbeatPulseReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the HeartbeatPulseReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/HeartbeatPulseReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/HeartbeatPulseReportType_subscriber -d <domain_id> -s <sample_count>
