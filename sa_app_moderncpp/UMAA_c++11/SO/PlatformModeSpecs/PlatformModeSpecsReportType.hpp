...
namespace UMAA {
    namespace SO {
        namespace PlatformModeSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PlatformModeSpecsReport_TOPIC = "UMAA::SO::PlatformModeSpecs::PlatformModeSpecsReport";
            ...
            class NDDSUSERDllExport PlatformModeSpecsReportType {
              public:
                ...
                PlatformModeSpecsReportType(bool supportedMaintenance_,bool supportedStandardOperating_,bool supportedTraining_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                bool& supportedMaintenance() noexcept {
                    return m_supportedMaintenance_;
                }

                const bool& supportedMaintenance() const noexcept {
                    return m_supportedMaintenance_;
                }
                ...
                bool& supportedStandardOperating() noexcept {
                    return m_supportedStandardOperating_;
                }

                const bool& supportedStandardOperating() const noexcept {
                    return m_supportedStandardOperating_;
                }
                ...
                bool& supportedTraining() noexcept {
                    return m_supportedTraining_;
                }

                const bool& supportedTraining() const noexcept {
                    return m_supportedTraining_;
                }
                ...
                void swap(PlatformModeSpecsReportType& other_) noexcept ;
            ...
            inline void swap(PlatformModeSpecsReportType& a, PlatformModeSpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
