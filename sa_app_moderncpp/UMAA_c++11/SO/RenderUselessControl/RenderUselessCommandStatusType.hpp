...
namespace UMAA {
    namespace SO {
        namespace RenderUselessControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string RenderUselessCommandStatus_TOPIC = "UMAA::SO::RenderUselessControl::RenderUselessCommandStatus";
            ...
            class NDDSUSERDllExport RenderUselessCommandStatusType {
              public:
                ...
                void swap(RenderUselessCommandStatusType& other_) noexcept ;
            ...
            inline void swap(RenderUselessCommandStatusType& a, RenderUselessCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
