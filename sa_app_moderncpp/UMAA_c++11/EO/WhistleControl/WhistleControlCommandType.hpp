...
namespace UMAA {
    namespace EO {
        namespace WhistleControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string WhistleControlCommand_TOPIC = "UMAA::EO::WhistleControl::WhistleControlCommand";
            ...
            class NDDSUSERDllExport WhistleControlCommandType {
              public:
                ...
                ::dds::core::optional< ::UMAA::Common::Propulsion::WhistlePropertiesType >& whistleProperties() noexcept {
                    return m_whistleProperties_;
                }

                const ::dds::core::optional< ::UMAA::Common::Propulsion::WhistlePropertiesType >& whistleProperties() const noexcept {
                    return m_whistleProperties_;
                }
                ...
                void swap(WhistleControlCommandType& other_) noexcept ;
            ...
            inline void swap(WhistleControlCommandType& a, WhistleControlCommandType& b)  noexcept 
            {
                a.swap(b);
            }
