...
namespace UMAA {
    namespace EO {
        namespace WhistleControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string WhistleControlCommandReport_TOPIC = "UMAA::EO::WhistleControl::WhistleControlCommandReport";
            ...
            class NDDSUSERDllExport WhistleControlCommandReportType {
              public:
                ...
                WhistleControlCommandReportType(const ::UMAA::Common::Enumeration::OnOffStatusEnumType::OnOffStatusEnumType& status_,const ::dds::core::optional< ::UMAA::Common::Propulsion::WhistlePropertiesType >& whistleProperties_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(WhistleControlCommandReportType& other_) noexcept ;
            ...
            inline void swap(WhistleControlCommandReportType& a, WhistleControlCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
