...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace WhistleControl {
            ...
            void WhistleControlCommandStatusType::swap(WhistleControlCommandStatusType& other_)  noexcept 
            {
                using std::swap;
