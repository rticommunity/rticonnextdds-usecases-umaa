...
namespace UMAA {
    namespace EO {
        namespace WhistleControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string WhistleControlCommandStatus_TOPIC = "UMAA::EO::WhistleControl::WhistleControlCommandStatus";
            ...
            class NDDSUSERDllExport WhistleControlCommandStatusType {
              public:
                ...
                void swap(WhistleControlCommandStatusType& other_) noexcept ;
            ...
            inline void swap(WhistleControlCommandStatusType& a, WhistleControlCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
