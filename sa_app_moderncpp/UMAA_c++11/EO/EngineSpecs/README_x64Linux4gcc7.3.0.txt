...
data type EngineSpecsReportType from EngineSpecsReportType.idl.
This example builds two applications, named EngineSpecsReportType_publisher and
EngineSpecsReportType_subscriber.
...
> make -f makefile_EngineSpecsReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_EngineSpecsReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the EngineSpecsReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/EngineSpecsReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/EngineSpecsReportType_subscriber -d <domain_id> -s <sample_count>
