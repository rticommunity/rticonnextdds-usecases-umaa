...
namespace UMAA {
    namespace EO {
        namespace SituationalSignalSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string SituationalSignalSpecsReport_TOPIC = "UMAA::EO::SituationalSignalSpecs::SituationalSignalSpecsReport";
            ...
            class NDDSUSERDllExport SituationalSignalSpecsReportType {
              public:
                ...
                void swap(SituationalSignalSpecsReportType& other_) noexcept ;
            ...
            inline void swap(SituationalSignalSpecsReportType& a, SituationalSignalSpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
