...
namespace UMAA {
    namespace EO {
        namespace MastControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MastCommandAckReport_TOPIC = "UMAA::EO::MastControl::MastCommandAckReport";
            ...
            class NDDSUSERDllExport MastCommandAckReportType {
              public:
                ...
                MastCommandAckReportType(const ::UMAA::Common::MaritimeEnumeration::MastActionEnumType::MastActionEnumType& action_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
