...
namespace UMAA {
    namespace EO {
        namespace MastControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MastCommandStatus_TOPIC = "UMAA::EO::MastControl::MastCommandStatus";
            ...
            class NDDSUSERDllExport MastCommandStatusType {
              public:
                ...
                void swap(MastCommandStatusType& other_) noexcept ;
            ...
            inline void swap(MastCommandStatusType& a, MastCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
