...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace RudderStatus {
            ...
            RudderReportType::RudderReportType (double angle_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_angle_(angle_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void RudderReportType::swap(RudderReportType& other_)  noexcept 
            {
                using std::swap;
