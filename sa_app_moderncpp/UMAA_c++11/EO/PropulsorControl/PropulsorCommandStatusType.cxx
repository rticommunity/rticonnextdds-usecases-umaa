...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PropulsorControl {
            ...
            void PropulsorCommandStatusType::swap(PropulsorCommandStatusType& other_)  noexcept 
            {
                using std::swap;
