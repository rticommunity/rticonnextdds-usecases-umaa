...
namespace UMAA {
    namespace EO {
        namespace PropulsorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PropulsorCommandStatus_TOPIC = "UMAA::EO::PropulsorControl::PropulsorCommandStatus";
            ...
            class NDDSUSERDllExport PropulsorCommandStatusType {
              public:
                ...
                void swap(PropulsorCommandStatusType& other_) noexcept ;
            ...
            inline void swap(PropulsorCommandStatusType& a, PropulsorCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
