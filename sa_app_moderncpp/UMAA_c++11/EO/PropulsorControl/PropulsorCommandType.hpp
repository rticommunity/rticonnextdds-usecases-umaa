...
#ifndef PropulsorCommandType_1827044515_hpp
#define PropulsorCommandType_1827044515_hpp
...
namespace UMAA {
    namespace EO {
        namespace PropulsorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PropulsorCommand_TOPIC = "UMAA::EO::PropulsorControl::PropulsorCommand";
            ...
            class NDDSUSERDllExport PropulsorCommandType {
              public:
                ...
                PropulsorCommandType(const ::UMAA::Common::Propulsion::PropulsionType& propulsion_,const ::UMAA::Common::Propulsion::PropulsionRotationType& rotation_,double thrustPitch_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::EO::PropulsorControl::PropulsorCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::PropulsorControl::PropulsorCommandType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::EO::PropulsorControl::PropulsorCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::EO::PropulsorControl::PropulsorCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::EO::PropulsorControl::PropulsorCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::EO::PropulsorControl::PropulsorCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::EO::PropulsorControl::PropulsorCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::EO::PropulsorControl::PropulsorCommandType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::EO::PropulsorControl::PropulsorCommandType > {
...
#endif // PropulsorCommandType_1827044515_hpp
