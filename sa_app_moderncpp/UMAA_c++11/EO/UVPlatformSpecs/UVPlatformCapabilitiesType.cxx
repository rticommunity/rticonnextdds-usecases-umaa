    ...
    namespace EO {
        ...
        namespace UVPlatformSpecs {
            ...
            UVPlatformCapabilitiesType::UVPlatformCapabilitiesType (double cruisingSpeed_,double maxForwardSpeed_,double maxPitchRate_,double maxReverseSpeed_,const ::dds::core::optional< double >& maxTowingSpeed_,const ::dds::core::optional< double >& maxTowingTurnRate_,double maxTurnRate_,const ::dds::core::optional< double >& minTowingSpeed_,const ::dds::core::optional< double >& minTowingTurnRate_):
                ...
                m_minTowingTurnRate_(minTowingTurnRate_) {
            }

            void UVPlatformCapabilitiesType::swap(UVPlatformCapabilitiesType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool UVPlatformCapabilitiesType::operator == (const UVPlatformCapabilitiesType& other_) const {
                ...
                if (m_minTowingTurnRate_.has_value() != other_.m_minTowingTurnRate_.has_value()) {
                    return false;
                } else if (m_minTowingTurnRate_.has_value()) {
                    if (std::fabs(*m_minTowingTurnRate_ - *other_.m_minTowingTurnRate_) > std::numeric_limits< double>::epsilon()
                    && !(std::fabs(*m_minTowingTurnRate_ - *other_.m_minTowingTurnRate_) < (std::numeric_limits< double>::min)())) {
                        return false;
                    }
                }
                return true;
