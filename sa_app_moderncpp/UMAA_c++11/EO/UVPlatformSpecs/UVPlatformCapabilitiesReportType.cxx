    ...
    namespace EO {
        ...
        namespace UVPlatformSpecs {
            ...
            bool UVPlatformCapabilitiesReportType::operator == (const UVPlatformCapabilitiesReportType& other_) const {
                if (std::fabs(m_endurance_ - other_.m_endurance_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_endurance_ - other_.m_endurance_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
