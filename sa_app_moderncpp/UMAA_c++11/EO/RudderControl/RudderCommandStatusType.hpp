...
namespace UMAA {
    namespace EO {
        namespace RudderControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string RudderCommandStatus_TOPIC = "UMAA::EO::RudderControl::RudderCommandStatus";
            ...
            class NDDSUSERDllExport RudderCommandStatusType {
              public:
                ...
                void swap(RudderCommandStatusType& other_) noexcept ;
            ...
            inline void swap(RudderCommandStatusType& a, RudderCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
