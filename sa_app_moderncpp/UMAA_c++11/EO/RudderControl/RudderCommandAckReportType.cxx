...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace RudderControl {
            ...
            RudderCommandAckReportType::RudderCommandAckReportType (double angle_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_angle_(angle_), 
                m_source_(source_), 
                m_sessionID_(sessionID_) {
            }

            void RudderCommandAckReportType::swap(RudderCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
