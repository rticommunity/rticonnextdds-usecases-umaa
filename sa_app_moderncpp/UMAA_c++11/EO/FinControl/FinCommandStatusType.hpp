...
namespace UMAA {
    namespace EO {
        namespace FinControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string FinCommandStatus_TOPIC = "UMAA::EO::FinControl::FinCommandStatus";
            ...
            class NDDSUSERDllExport FinCommandStatusType {
              public:
                ...
                void swap(FinCommandStatusType& other_) noexcept ;
            ...
            inline void swap(FinCommandStatusType& a, FinCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
