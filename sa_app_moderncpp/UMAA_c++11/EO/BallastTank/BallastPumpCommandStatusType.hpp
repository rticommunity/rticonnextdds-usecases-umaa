...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BallastPumpCommandStatus_TOPIC = "UMAA::EO::BallastTank::BallastPumpCommandStatus";
