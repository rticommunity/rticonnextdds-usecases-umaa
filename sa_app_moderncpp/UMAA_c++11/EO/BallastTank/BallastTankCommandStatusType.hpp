...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BallastTankCommandStatus_TOPIC = "UMAA::EO::BallastTank::BallastTankCommandStatus";
            ...
            class NDDSUSERDllExport BallastTankCommandStatusType {
              public:
                ...
                void swap(BallastTankCommandStatusType& other_) noexcept ;
            ...
            inline void swap(BallastTankCommandStatusType& a, BallastTankCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
