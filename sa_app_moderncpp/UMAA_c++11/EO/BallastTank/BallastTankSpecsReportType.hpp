...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BallastTankSpecsReport_TOPIC = "UMAA::EO::BallastTank::BallastTankSpecsReport";
            ...
            class NDDSUSERDllExport BallastTankSpecsReportType {
              public:
                ...
                BallastTankSpecsReportType(double massCapacity_,const std::string& name_,bool trimTank_,double volumeCapacity_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
