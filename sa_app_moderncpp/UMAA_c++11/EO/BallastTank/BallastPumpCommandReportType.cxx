...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastPumpCommandReportType::BallastPumpCommandReportType (const ::UMAA::EO::BallastTank::BallastPumpFlowRateType& ballastPumpFlowRate_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_ballastPumpFlowRate_(ballastPumpFlowRate_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void BallastPumpCommandReportType::swap(BallastPumpCommandReportType& other_)  noexcept 
            {
                using std::swap;
