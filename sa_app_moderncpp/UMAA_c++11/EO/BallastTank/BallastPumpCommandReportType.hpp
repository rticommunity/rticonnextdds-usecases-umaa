...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BallastPumpCommandReport_TOPIC = "UMAA::EO::BallastTank::BallastPumpCommandReport";
            ...
            class NDDSUSERDllExport BallastPumpCommandReportType {
              public:
                ...
                BallastPumpCommandReportType(const ::UMAA::EO::BallastTank::BallastPumpFlowRateType& ballastPumpFlowRate_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(BallastPumpCommandReportType& other_) noexcept ;
            ...
            inline void swap(BallastPumpCommandReportType& a, BallastPumpCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
