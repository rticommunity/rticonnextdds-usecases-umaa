...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BallastTankReport_TOPIC = "UMAA::EO::BallastTank::BallastTankReport";
            ...
            class NDDSUSERDllExport BallastTankReportType {
              public:
                ...
                BallastTankReportType(const ::dds::core::optional< double >& level_,double lowPressureLimit_,const ::dds::core::optional< double >& mass_,double pressure_,double pressureLimit_,bool trimActive_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
