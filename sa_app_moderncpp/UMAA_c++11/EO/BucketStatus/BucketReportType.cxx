...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BucketStatus {
            ...
            BucketReportType::BucketReportType (double bucketPosition_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_bucketPosition_(bucketPosition_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void BucketReportType::swap(BucketReportType& other_)  noexcept 
            {
                using std::swap;
