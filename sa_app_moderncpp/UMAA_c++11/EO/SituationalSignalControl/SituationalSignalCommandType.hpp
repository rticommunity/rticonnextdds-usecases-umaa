...
namespace UMAA {
    namespace EO {
        namespace SituationalSignalControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string SituationalSignalCommand_TOPIC = "UMAA::EO::SituationalSignalControl::SituationalSignalCommand";
            ...
            class NDDSUSERDllExport SituationalSignalCommandType {
              public:
                ...
                void swap(SituationalSignalCommandType& other_) noexcept ;
            ...
            inline void swap(SituationalSignalCommandType& a, SituationalSignalCommandType& b)  noexcept 
            {
                a.swap(b);
            }
