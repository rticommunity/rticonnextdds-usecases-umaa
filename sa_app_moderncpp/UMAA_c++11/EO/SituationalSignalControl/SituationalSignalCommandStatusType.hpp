...
namespace UMAA {
    namespace EO {
        namespace SituationalSignalControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string SituationalSignalCommandStatus_TOPIC = "UMAA::EO::SituationalSignalControl::SituationalSignalCommandStatus";
            ...
            class NDDSUSERDllExport SituationalSignalCommandStatusType {
              public:
                ...
                void swap(SituationalSignalCommandStatusType& other_) noexcept ;
            ...
            inline void swap(SituationalSignalCommandStatusType& a, SituationalSignalCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
