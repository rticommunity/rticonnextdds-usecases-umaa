...
namespace UMAA {
    namespace EO {
        namespace MastStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MastReport_TOPIC = "UMAA::EO::MastStatus::MastReport";
            ...
            class NDDSUSERDllExport MastReportType {
              public:
                ...
                MastReportType(const ::UMAA::Common::MaritimeEnumeration::MastStateEnumType::MastStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::UMAA::Common::MaritimeEnumeration::MastStateEnumType::MastStateEnumType& state() noexcept {
                    return m_state_;
                }

                const ::UMAA::Common::MaritimeEnumeration::MastStateEnumType::MastStateEnumType& state() const noexcept {
                    return m_state_;
                }
