...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace LightControl {
            ...
            void LightCommandType::swap(LightCommandType& other_)  noexcept 
            {
                using std::swap;
