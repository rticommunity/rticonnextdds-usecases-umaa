...
namespace UMAA {
    namespace EO {
        namespace LightControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LightCommand_TOPIC = "UMAA::EO::LightControl::LightCommand";
            ...
            class NDDSUSERDllExport LightCommandType {
              public:
                ...
                LightCommandType(bool allroundLight_,bool flashingLight_,bool mastheadLight_,bool portSideLight_,bool starboardSideLight_,bool sternLight_,bool towingLight_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(LightCommandType& other_) noexcept ;
            ...
            inline void swap(LightCommandType& a, LightCommandType& b)  noexcept 
            {
                a.swap(b);
            }
