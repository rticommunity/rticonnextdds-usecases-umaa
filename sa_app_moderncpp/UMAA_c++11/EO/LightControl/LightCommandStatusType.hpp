...
namespace UMAA {
    namespace EO {
        namespace LightControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LightCommandStatus_TOPIC = "UMAA::EO::LightControl::LightCommandStatus";
            ...
            class NDDSUSERDllExport LightCommandStatusType {
              public:
                ...
                void swap(LightCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LightCommandStatusType& a, LightCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
