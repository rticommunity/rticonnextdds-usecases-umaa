...
namespace UMAA {
    namespace EO {
        namespace SituationalSignalStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string SituationalSignalReport_TOPIC = "UMAA::EO::SituationalSignalStatus::SituationalSignalReport";
            ...
            class NDDSUSERDllExport SituationalSignalReportType {
              public:
                ...
                void swap(SituationalSignalReportType& other_) noexcept ;
            ...
            inline void swap(SituationalSignalReportType& a, SituationalSignalReportType& b)  noexcept 
            {
                a.swap(b);
            }
