...
namespace UMAA {
    namespace EO {
        namespace EngineControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string EngineCommandStatus_TOPIC = "UMAA::EO::EngineControl::EngineCommandStatus";
