...
namespace UMAA {
    namespace EO {
        namespace BucketControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BucketCommandAckReport_TOPIC = "UMAA::EO::BucketControl::BucketCommandAckReport";
            ...
            class NDDSUSERDllExport BucketCommandAckReportType {
              public:
                ...
                BucketCommandAckReportType(double bucketPosition_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
                ...
                void swap(BucketCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(BucketCommandAckReportType& a, BucketCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
