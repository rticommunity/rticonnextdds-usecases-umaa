...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BucketControl {
            ...
            BucketCommandAckReportType::BucketCommandAckReportType (double bucketPosition_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_bucketPosition_(bucketPosition_), 
                m_source_(source_), 
                m_sessionID_(sessionID_) {
            }

            void BucketCommandAckReportType::swap(BucketCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
