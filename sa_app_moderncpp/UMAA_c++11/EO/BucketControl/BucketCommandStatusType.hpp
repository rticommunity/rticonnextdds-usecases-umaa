...
namespace UMAA {
    namespace EO {
        namespace BucketControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BucketCommandStatus_TOPIC = "UMAA::EO::BucketControl::BucketCommandStatus";
            ...
            class NDDSUSERDllExport BucketCommandStatusType {
              public:
                ...
                void swap(BucketCommandStatusType& other_) noexcept ;
            ...
            inline void swap(BucketCommandStatusType& a, BucketCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
