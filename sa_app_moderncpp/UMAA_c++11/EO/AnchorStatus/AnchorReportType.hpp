...
namespace UMAA {
    namespace EO {
        namespace AnchorStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string AnchorReport_TOPIC = "UMAA::EO::AnchorStatus::AnchorReport";
            ...
            class NDDSUSERDllExport AnchorReportType {
              public:
                ...
                AnchorReportType(double rodeLengthPaidOut_,const ::UMAA::Common::MaritimeEnumeration::AnchorStateEnumType::AnchorStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                ::UMAA::Common::MaritimeEnumeration::AnchorStateEnumType::AnchorStateEnumType& state() noexcept {
                    return m_state_;
                }

                const ::UMAA::Common::MaritimeEnumeration::AnchorStateEnumType::AnchorStateEnumType& state() const noexcept {
                    return m_state_;
                }
