...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace FinSpecs {
            ...
            FinSpecsReportType::FinSpecsReportType (double maxDeflectionRate_,double maxNegativeDeflection_,double maxPositiveDeflection_,double minDeflectionRate_,const std::string& name_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
            ...
            void FinSpecsReportType::swap(FinSpecsReportType& other_)  noexcept 
            {
                using std::swap;
