...
namespace UMAA {
    namespace EO {
        namespace FinSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string FinSpecsReport_TOPIC = "UMAA::EO::FinSpecs::FinSpecsReport";
            ...
            class NDDSUSERDllExport FinSpecsReportType {
              public:
                ...
                FinSpecsReportType(double maxDeflectionRate_,double maxNegativeDeflection_,double maxPositiveDeflection_,double minDeflectionRate_,const std::string& name_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(FinSpecsReportType& other_) noexcept ;
            ...
            inline void swap(FinSpecsReportType& a, FinSpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
