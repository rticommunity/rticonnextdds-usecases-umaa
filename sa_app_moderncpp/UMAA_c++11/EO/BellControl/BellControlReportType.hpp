...
namespace UMAA {
    namespace EO {
        namespace BellControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BellControlReport_TOPIC = "UMAA::EO::BellControl::BellControlReport";
            ...
            class NDDSUSERDllExport BellControlReportType {
              public:
                ...
                void swap(BellControlReportType& other_) noexcept ;
            ...
            inline void swap(BellControlReportType& a, BellControlReportType& b)  noexcept 
            {
                a.swap(b);
            }
