...
namespace UMAA {
    namespace EO {
        namespace BellControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BellControlCommandStatus_TOPIC = "UMAA::EO::BellControl::BellControlCommandStatus";
            ...
            class NDDSUSERDllExport BellControlCommandStatusType {
              public:
                ...
                void swap(BellControlCommandStatusType& other_) noexcept ;
            ...
            inline void swap(BellControlCommandStatusType& a, BellControlCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
