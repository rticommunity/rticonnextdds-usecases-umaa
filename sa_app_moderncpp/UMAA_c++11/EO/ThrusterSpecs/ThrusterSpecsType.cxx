...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace ThrusterSpecs {
            ...
            ThrusterSpecsType::ThrusterSpecsType (double maxRPM_,const ::UMAA::Common::MaritimeEnumeration::MountModeEnumType::MountModeEnumType& mountType_,const std::string& name_):
                m_maxRPM_(maxRPM_), 
                m_mountType_(mountType_), 
                m_name_(name_) {
            }

            void ThrusterSpecsType::swap(ThrusterSpecsType& other_)  noexcept 
            {
                using std::swap;
