...
namespace UMAA {
    namespace EO {
        namespace FuelTankStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string FuelTankReport_TOPIC = "UMAA::EO::FuelTankStatus::FuelTankReport";
            ...
            class NDDSUSERDllExport FuelTankReportType {
              public:
                ...
                FuelTankReportType(double fuelLevel_,bool waterInFuel_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                bool& waterInFuel() noexcept {
                    return m_waterInFuel_;
                }

                const bool& waterInFuel() const noexcept {
                    return m_waterInFuel_;
                }
