...
namespace UMAA {
    namespace EO {
        namespace RudderSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string RudderSpecsReport_TOPIC = "UMAA::EO::RudderSpecs::RudderSpecsReport";
            ...
            class NDDSUSERDllExport RudderSpecsReportType {
              public:
                ...
                RudderSpecsReportType(double maxPortAngle_,double maxStarboardAngle_,const std::string& name_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                double& maxPortAngle() noexcept {
                    return m_maxPortAngle_;
                }

                const double& maxPortAngle() const noexcept {
                    return m_maxPortAngle_;
                }
                ...
                double& maxStarboardAngle() noexcept {
                    return m_maxStarboardAngle_;
                }

                const double& maxStarboardAngle() const noexcept {
                    return m_maxStarboardAngle_;
                }
                ...
                void swap(RudderSpecsReportType& other_) noexcept ;
            ...
            inline void swap(RudderSpecsReportType& a, RudderSpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
