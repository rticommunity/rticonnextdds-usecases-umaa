...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace GeneratorSpecs {
            ...
            GeneratorSpecsReportType::GeneratorSpecsReportType (double maxCurrent_,double maxPower_,const std::string& name_,double ratedPower_,double ratedVoltage_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
