...
namespace UMAA {
    namespace EO {
        namespace GeneratorSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GeneratorSpecsReport_TOPIC = "UMAA::EO::GeneratorSpecs::GeneratorSpecsReport";
            ...
            class NDDSUSERDllExport GeneratorSpecsReportType {
              public:
                ...
                GeneratorSpecsReportType(double maxCurrent_,double maxPower_,const std::string& name_,double ratedPower_,double ratedVoltage_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
