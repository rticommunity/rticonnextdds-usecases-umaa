...
namespace UMAA {
    namespace EO {
        namespace GeneratorStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GeneratorReport_TOPIC = "UMAA::EO::GeneratorStatus::GeneratorReport";
            ...
            class NDDSUSERDllExport GeneratorReportType {
              public:
                ...
                GeneratorReportType(double current_,const ::UMAA::Common::MaritimeEnumeration::PowerPlantStateEnumType::PowerPlantStateEnumType& state_,double voltage_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
