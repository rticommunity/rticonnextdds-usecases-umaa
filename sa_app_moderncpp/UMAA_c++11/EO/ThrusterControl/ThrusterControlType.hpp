        ...
        namespace ThrusterControl {
            ...
            class NDDSUSERDllExport ThrusterControlType {
              public:
                ...
                ThrusterControlType(double effort_,const ::UMAA::Common::MaritimeEnumeration::PowerPlantStateEnumType::PowerPlantStateEnumType& state_);

                double& effort() noexcept {
                    return m_effort_;
                }

                const double& effort() const noexcept {
                    return m_effort_;
                }
                ...
                void swap(ThrusterControlType& other_) noexcept ;
            ...
            inline void swap(ThrusterControlType& a, ThrusterControlType& b)  noexcept 
            {
                a.swap(b);
            }
