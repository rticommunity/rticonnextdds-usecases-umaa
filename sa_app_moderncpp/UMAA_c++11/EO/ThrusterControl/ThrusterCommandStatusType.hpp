...
namespace UMAA {
    namespace EO {
        namespace ThrusterControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ThrusterCommandStatus_TOPIC = "UMAA::EO::ThrusterControl::ThrusterCommandStatus";
            ...
            class NDDSUSERDllExport ThrusterCommandStatusType {
              public:
                ...
                void swap(ThrusterCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ThrusterCommandStatusType& a, ThrusterCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
