...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace ThrusterControl {
            ...
            ThrusterControlType::ThrusterControlType (double effort_,const ::UMAA::Common::MaritimeEnumeration::PowerPlantStateEnumType::PowerPlantStateEnumType& state_):
                m_effort_(effort_), 
                m_state_(state_) {
            }

            void ThrusterControlType::swap(ThrusterControlType& other_)  noexcept 
            {
                using std::swap;
