...
namespace UMAA {
    namespace EO {
        namespace GongControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GongControlReport_TOPIC = "UMAA::EO::GongControl::GongControlReport";
            ...
            class NDDSUSERDllExport GongControlReportType {
              public:
                ...
                void swap(GongControlReportType& other_) noexcept ;
            ...
            inline void swap(GongControlReportType& a, GongControlReportType& b)  noexcept 
            {
                a.swap(b);
            }
