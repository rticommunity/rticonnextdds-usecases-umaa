...
namespace UMAA {
    namespace EO {
        namespace GongControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GongControlCommandReport_TOPIC = "UMAA::EO::GongControl::GongControlCommandReport";
            ...
            class NDDSUSERDllExport GongControlCommandReportType {
              public:
                ...
                GongControlCommandReportType(const ::dds::core::optional< ::UMAA::Common::Propulsion::BlastPropertiesType >& blastProperties_,const ::UMAA::Common::Enumeration::OnOffStatusEnumType::OnOffStatusEnumType& status_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(GongControlCommandReportType& other_) noexcept ;
            ...
            inline void swap(GongControlCommandReportType& a, GongControlCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
