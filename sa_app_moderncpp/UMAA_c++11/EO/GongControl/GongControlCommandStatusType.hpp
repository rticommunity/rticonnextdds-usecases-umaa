...
namespace UMAA {
    namespace EO {
        namespace GongControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GongControlCommandStatus_TOPIC = "UMAA::EO::GongControl::GongControlCommandStatus";
            ...
            class NDDSUSERDllExport GongControlCommandStatusType {
              public:
                ...
                void swap(GongControlCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GongControlCommandStatusType& a, GongControlCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
