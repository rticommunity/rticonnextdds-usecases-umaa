...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PropulsorConfig {
            ...
            PropulsorConfigReportType::PropulsorConfigReportType (const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void PropulsorConfigReportType::swap(PropulsorConfigReportType& other_)  noexcept 
            {
                using std::swap;
