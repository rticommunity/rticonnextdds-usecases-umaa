...
namespace UMAA {
    namespace EO {
        namespace PowerControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PowerCommandAckReport_TOPIC = "UMAA::EO::PowerControl::PowerCommandAckReport";
            ...
            class NDDSUSERDllExport PowerCommandAckReportType {
              public:
                ...
                PowerCommandAckReportType(const std::string& identification_,const ::UMAA::Common::MaritimeEnumeration::IgnitionStateEnumType::IgnitionStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
