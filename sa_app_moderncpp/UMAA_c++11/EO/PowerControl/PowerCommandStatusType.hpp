...
namespace UMAA {
    namespace EO {
        namespace PowerControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PowerCommandStatus_TOPIC = "UMAA::EO::PowerControl::PowerCommandStatus";
