...
namespace UMAA {
    namespace EO {
        namespace FuelTankSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string FuelTankSpecsReport_TOPIC = "UMAA::EO::FuelTankSpecs::FuelTankSpecsReport";
            ...
            class NDDSUSERDllExport FuelTankSpecsReportType {
              public:
                ...
                FuelTankSpecsReportType(double capacity_,const std::string& name_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
