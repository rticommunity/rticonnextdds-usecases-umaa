...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BilgePumpControl {
            ...
            BilgePumpCommandType::BilgePumpCommandType (const ::UMAA::Common::MaritimeEnumeration::BilgeControlEnumType::BilgeControlEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_state_(state_), 
                m_source_(source_), 
            ...
            void BilgePumpCommandType::swap(BilgePumpCommandType& other_)  noexcept 
            {
                using std::swap;
