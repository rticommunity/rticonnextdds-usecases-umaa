...
namespace UMAA {
    namespace EO {
        namespace BilgePumpControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BilgePumpCommandStatus_TOPIC = "UMAA::EO::BilgePumpControl::BilgePumpCommandStatus";
            ...
            class NDDSUSERDllExport BilgePumpCommandStatusType {
              public:
                ...
                void swap(BilgePumpCommandStatusType& other_) noexcept ;
            ...
            inline void swap(BilgePumpCommandStatusType& a, BilgePumpCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
