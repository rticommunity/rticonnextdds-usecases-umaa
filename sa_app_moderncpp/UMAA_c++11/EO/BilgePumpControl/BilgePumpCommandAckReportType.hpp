...
namespace UMAA {
    namespace EO {
        namespace BilgePumpControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BilgePumpCommandAckReport_TOPIC = "UMAA::EO::BilgePumpControl::BilgePumpCommandAckReport";
            ...
            class NDDSUSERDllExport BilgePumpCommandAckReportType {
              public:
                ...
                BilgePumpCommandAckReportType(const ::UMAA::Common::MaritimeEnumeration::BilgeControlEnumType::BilgeControlEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
                ...
                void swap(BilgePumpCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(BilgePumpCommandAckReportType& a, BilgePumpCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
