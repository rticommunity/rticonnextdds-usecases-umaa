...
namespace UMAA {
    namespace EO {
        namespace AnchorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string AnchorCommandStatus_TOPIC = "UMAA::EO::AnchorControl::AnchorCommandStatus";
            ...
            class NDDSUSERDllExport AnchorCommandStatusType {
              public:
                ...
                void swap(AnchorCommandStatusType& other_) noexcept ;
            ...
            inline void swap(AnchorCommandStatusType& a, AnchorCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
