        ...
        namespace StationkeepState {
            ...
            class NDDSUSERDllExport StationkeepingStationkeepType {
              public:
                ...
                StationkeepingStationkeepType(bool bearingToContactAchieved_,bool elevationAchieved_,bool rangeAchieved_);

                bool& bearingToContactAchieved() noexcept {
                    return m_bearingToContactAchieved_;
                }

                const bool& bearingToContactAchieved() const noexcept {
                    return m_bearingToContactAchieved_;
                }
                ...
                bool& rangeAchieved() noexcept {
                    return m_rangeAchieved_;
                }

                const bool& rangeAchieved() const noexcept {
                    return m_rangeAchieved_;
                }
                ...
                void swap(StationkeepingStationkeepType& other_) noexcept ;
            ...
            inline void swap(StationkeepingStationkeepType& a, StationkeepingStationkeepType& b)  noexcept 
            {
                a.swap(b);
            }
