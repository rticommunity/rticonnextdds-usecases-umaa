...
namespace UMAA {
    namespace MO {
        namespace LocalDriftControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalDriftCommandStatus_TOPIC = "UMAA::MO::LocalDriftControl::LocalDriftCommandStatus";
            ...
            class NDDSUSERDllExport LocalDriftCommandStatusType {
              public:
                ...
                void swap(LocalDriftCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalDriftCommandStatusType& a, LocalDriftCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
