...
namespace UMAA {
    namespace MO {
        namespace LocalDriftControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalDriftCommand_TOPIC = "UMAA::MO::LocalDriftControl::LocalDriftCommand";
            ...
            class NDDSUSERDllExport LocalDriftCommandType {
              public:
                ...
                void swap(LocalDriftCommandType& other_) noexcept ;
            ...
            inline void swap(LocalDriftCommandType& a, LocalDriftCommandType& b)  noexcept 
            {
                a.swap(b);
            }
