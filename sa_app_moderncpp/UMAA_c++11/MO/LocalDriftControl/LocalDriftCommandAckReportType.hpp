...
namespace UMAA {
    namespace MO {
        namespace LocalDriftControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalDriftCommandAckReport_TOPIC = "UMAA::MO::LocalDriftControl::LocalDriftCommandAckReport";
            ...
            class NDDSUSERDllExport LocalDriftCommandAckReportType {
              public:
                ...
                void swap(LocalDriftCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(LocalDriftCommandAckReportType& a, LocalDriftCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
