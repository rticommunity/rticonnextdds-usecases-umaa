...
namespace UMAA {
    namespace MO {
        namespace LocalWaypointControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalWaypointSpeedCommandAckReport_TOPIC = "UMAA::MO::LocalWaypointControl::LocalWaypointSpeedCommandAckReport";
            ...
            class NDDSUSERDllExport LocalWaypointSpeedCommandAckReportType {
              public:
                ...
                LocalWaypointSpeedCommandAckReportType(const ::UMAA::Common::VariableSpeedControl::VariableSpeedControlType& speed_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
                ...
                void swap(LocalWaypointSpeedCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(LocalWaypointSpeedCommandAckReportType& a, LocalWaypointSpeedCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
