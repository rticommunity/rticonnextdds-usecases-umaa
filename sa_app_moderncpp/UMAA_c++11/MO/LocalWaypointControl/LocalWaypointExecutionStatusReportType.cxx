...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalWaypointControl {
            ...
            LocalWaypointExecutionStatusReportType::LocalWaypointExecutionStatusReportType (const ::UMAA::Common::Measurement::DateTime& arrivalTime_,double crossTrackError_,double cumulativeDistance_,double distanceRemaining_,double distanceToWaypoint_,bool elevationAchieved_,bool maintainTrack_,bool speedAchieved_,const ::UMAA::Common::Measurement::DateTime& timeToWaypoint_,bool trackLineAchieved_,int32_t waypointsRemaining_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::NumericGUID& waypointID_):
            ...
            void LocalWaypointExecutionStatusReportType::swap(LocalWaypointExecutionStatusReportType& other_)  noexcept 
            {
                using std::swap;
