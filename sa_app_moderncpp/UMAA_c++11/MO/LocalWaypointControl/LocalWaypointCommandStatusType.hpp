...
namespace UMAA {
    namespace MO {
        namespace LocalWaypointControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalWaypointCommandStatus_TOPIC = "UMAA::MO::LocalWaypointControl::LocalWaypointCommandStatus";
            ...
            class NDDSUSERDllExport LocalWaypointCommandStatusType {
              public:
                ...
                void swap(LocalWaypointCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalWaypointCommandStatusType& a, LocalWaypointCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
