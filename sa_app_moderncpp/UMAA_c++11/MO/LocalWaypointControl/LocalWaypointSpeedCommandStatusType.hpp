...
namespace UMAA {
    namespace MO {
        namespace LocalWaypointControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalWaypointSpeedCommandStatus_TOPIC = "UMAA::MO::LocalWaypointControl::LocalWaypointSpeedCommandStatus";
            ...
            class NDDSUSERDllExport LocalWaypointSpeedCommandStatusType {
              public:
                ...
                void swap(LocalWaypointSpeedCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalWaypointSpeedCommandStatusType& a, LocalWaypointSpeedCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
