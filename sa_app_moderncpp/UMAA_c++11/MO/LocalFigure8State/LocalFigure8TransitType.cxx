...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalFigure8State {
            ...
            LocalFigure8TransitType::LocalFigure8TransitType (bool transitElevationAchieved_,bool transitSpeedAchieved_):
                m_transitElevationAchieved_(transitElevationAchieved_), 
                m_transitSpeedAchieved_(transitSpeedAchieved_) {
            }

            void LocalFigure8TransitType::swap(LocalFigure8TransitType& other_)  noexcept 
            {
                using std::swap;
