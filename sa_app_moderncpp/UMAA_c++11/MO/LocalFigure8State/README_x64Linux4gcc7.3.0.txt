...
data type LocalFigure8TransitType from LocalFigure8TransitType.idl.
This example builds two applications, named LocalFigure8TransitType_publisher and
LocalFigure8TransitType_subscriber.
...
> make -f makefile_LocalFigure8TransitType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_LocalFigure8TransitType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the LocalFigure8TransitType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/LocalFigure8TransitType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/LocalFigure8TransitType_subscriber -d <domain_id> -s <sample_count>
