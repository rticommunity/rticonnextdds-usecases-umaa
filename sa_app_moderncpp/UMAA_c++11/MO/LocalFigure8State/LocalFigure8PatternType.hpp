        ...
        namespace LocalFigure8State {
            ...
            class NDDSUSERDllExport LocalFigure8PatternType {
              public:
                ...
                LocalFigure8PatternType(bool elevationAchieved_,bool positionAchieved_,bool speedAchieved_);
                ...
                void swap(LocalFigure8PatternType& other_) noexcept ;
            ...
            inline void swap(LocalFigure8PatternType& a, LocalFigure8PatternType& b)  noexcept 
            {
                a.swap(b);
            }
