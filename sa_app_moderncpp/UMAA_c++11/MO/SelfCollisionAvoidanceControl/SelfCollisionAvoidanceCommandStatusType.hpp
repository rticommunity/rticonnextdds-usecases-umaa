...
namespace UMAA {
    namespace MO {
        namespace SelfCollisionAvoidanceControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string SelfCollisionAvoidanceCommandStatus_TOPIC = "UMAA::MO::SelfCollisionAvoidanceControl::SelfCollisionAvoidanceCommandStatus";
            ...
            class NDDSUSERDllExport SelfCollisionAvoidanceCommandStatusType {
              public:
                ...
                void swap(SelfCollisionAvoidanceCommandStatusType& other_) noexcept ;
            ...
            inline void swap(SelfCollisionAvoidanceCommandStatusType& a, SelfCollisionAvoidanceCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
