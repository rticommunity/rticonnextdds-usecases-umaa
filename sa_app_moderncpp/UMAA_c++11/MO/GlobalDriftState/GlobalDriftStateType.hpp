        ...
        namespace GlobalDriftState {
            namespace GlobalDriftStateType_Specializations {
                ...
                class NDDSUSERDllExport GlobalDriftStateType_Union {
                  public:
                    ...
                    void _d(::UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Selectors value) {
                    ...
                    void swap(GlobalDriftStateType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::MO::GlobalDriftState::GlobalTransitDriftType& GlobalTransitDriftType_data_,const ::UMAA::MO::GlobalDriftState::GlobalRegionDriftType& GlobalRegionDriftType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(GlobalDriftStateType_Union& a, GlobalDriftStateType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport GlobalDriftStateType {
              public:
                ...
                explicit GlobalDriftStateType(const ::UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Union& GlobalDriftStateType_subtypes_);

                ::UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Union& GlobalDriftStateType_subtypes() noexcept {
                    return m_GlobalDriftStateType_subtypes_;
                }

                const ::UMAA::MO::GlobalDriftState::GlobalDriftStateType_Specializations::GlobalDriftStateType_Union& GlobalDriftStateType_subtypes() const noexcept {
                    return m_GlobalDriftStateType_subtypes_;
                }
