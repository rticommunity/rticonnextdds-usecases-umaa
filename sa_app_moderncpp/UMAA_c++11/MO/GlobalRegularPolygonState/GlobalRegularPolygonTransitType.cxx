...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRegularPolygonState {
            ...
            GlobalRegularPolygonTransitType::GlobalRegularPolygonTransitType (bool transitElevationAchieved_,bool transitSpeedAchieved_):
                m_transitElevationAchieved_(transitElevationAchieved_), 
                m_transitSpeedAchieved_(transitSpeedAchieved_) {
            }

            void GlobalRegularPolygonTransitType::swap(GlobalRegularPolygonTransitType& other_)  noexcept 
            {
                using std::swap;
