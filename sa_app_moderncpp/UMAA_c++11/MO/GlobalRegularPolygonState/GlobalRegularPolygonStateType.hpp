        ...
        namespace GlobalRegularPolygonState {
            namespace GlobalRegularPolygonStateType_Specializations {
                ...
                class NDDSUSERDllExport GlobalRegularPolygonStateType_Union {
                  public:
                    ...
                    void _d(::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType_Specializations::GlobalRegularPolygonStateType_Selectors value) {
                    ...
                    void swap(GlobalRegularPolygonStateType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonTransitType& GlobalRegularPolygonTransitType_data_,const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonPatternType& GlobalRegularPolygonPatternType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(GlobalRegularPolygonStateType_Union& a, GlobalRegularPolygonStateType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport GlobalRegularPolygonStateType {
              public:
                ...
                explicit GlobalRegularPolygonStateType(const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType_Specializations::GlobalRegularPolygonStateType_Union& GlobalRegularPolygonStateType_subtypes_);

                ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType_Specializations::GlobalRegularPolygonStateType_Union& GlobalRegularPolygonStateType_subtypes() noexcept {
                    return m_GlobalRegularPolygonStateType_subtypes_;
                }

                const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType_Specializations::GlobalRegularPolygonStateType_Union& GlobalRegularPolygonStateType_subtypes() const noexcept {
                    return m_GlobalRegularPolygonStateType_subtypes_;
                }
                ...
                void swap(GlobalRegularPolygonStateType& other_) noexcept ;
            ...
            inline void swap(GlobalRegularPolygonStateType& a, GlobalRegularPolygonStateType& b)  noexcept 
            {
                a.swap(b);
            }
