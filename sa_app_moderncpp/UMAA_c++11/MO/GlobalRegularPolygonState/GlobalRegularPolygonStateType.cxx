    ...
    namespace MO {
        ...
        namespace GlobalRegularPolygonState {
            ...
            namespace GlobalRegularPolygonStateType_Specializations {
                ...
                GlobalRegularPolygonStateType_Union::Union_::Union_(const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonTransitType& GlobalRegularPolygonTransitType_data_,const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonPatternType& GlobalRegularPolygonPatternType_data_):
                    m_GlobalRegularPolygonTransitType_data_(GlobalRegularPolygonTransitType_data_), 
                    m_GlobalRegularPolygonPatternType_data_(GlobalRegularPolygonPatternType_data_) {
                }
                ...
                void GlobalRegularPolygonStateType_Union::swap(GlobalRegularPolygonStateType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const GlobalRegularPolygonStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType_Specializations::GlobalRegularPolygonStateType_Selectors::GLOBALREGULARPOLYGONPATTERNTYPE_SELECT):
                            {  
                                o << "GlobalRegularPolygonPatternType_data: " << sample.GlobalRegularPolygonPatternType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            GlobalRegularPolygonStateType::GlobalRegularPolygonStateType (const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType_Specializations::GlobalRegularPolygonStateType_Union& GlobalRegularPolygonStateType_subtypes_):
                m_GlobalRegularPolygonStateType_subtypes_(GlobalRegularPolygonStateType_subtypes_) {
            }

            void GlobalRegularPolygonStateType::swap(GlobalRegularPolygonStateType& other_)  noexcept 
            {
                using std::swap;
