...
namespace UMAA {
    namespace MO {
        namespace StationkeepControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string StationkeepCommand_TOPIC = "UMAA::MO::StationkeepControl::StationkeepCommand";
            ...
            class NDDSUSERDllExport StationkeepCommandType {
              public:
                ...
                StationkeepCommandType(const ::UMAA::Common::MaritimeEnumeration::BearingAngleEnumType::BearingAngleEnumType& angleType_,double bearing_,double bearingTolerance_,double closingSpeed_,const ::UMAA::Common::Measurement::NumericGUID& contactTrackID_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& endTime_,double range_,double rangeTolerance_,const ::UMAA::Common::VariableSpeedControl::VariableSpeedControlType& transitSpeed_,double transitSpeedTolerance_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(StationkeepCommandType& other_) noexcept ;
            ...
            inline void swap(StationkeepCommandType& a, StationkeepCommandType& b)  noexcept 
            {
                a.swap(b);
            }
