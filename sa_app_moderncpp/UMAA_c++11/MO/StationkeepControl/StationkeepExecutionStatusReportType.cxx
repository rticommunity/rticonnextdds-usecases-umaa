...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace StationkeepControl {
            ...
            StationkeepExecutionStatusReportType::StationkeepExecutionStatusReportType (const ::UMAA::Common::MaritimeEnumeration::BearingAngleEnumType::BearingAngleEnumType& angleType_,double bearing_,double bearingTolerance_,double closingSpeed_,bool contactLost_,const ::UMAA::Common::Measurement::NumericGUID& contactTrackID_,double range_,double rangeTolerance_,const ::UMAA::MO::StationkeepState::StationkeepStateType& stationkeepState_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& timeStationkeepCompleted_,const ::UMAA::Common::Measurement::DateTime& timeStationskeepAchieved_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_angleType_(angleType_), 
                m_bearing_(bearing_), 
                m_bearingTolerance_(bearingTolerance_), 
                m_closingSpeed_(closingSpeed_), 
                m_contactLost_(contactLost_), 
                m_contactTrackID_(contactTrackID_), 
                m_range_(range_), 
                m_rangeTolerance_(rangeTolerance_), 
                m_stationkeepState_(stationkeepState_), 
                m_timeStationkeepCompleted_(timeStationkeepCompleted_), 
                m_timeStationskeepAchieved_(timeStationskeepAchieved_), 
                m_source_(source_), 
                m_sessionID_(sessionID_) {
            }

            void StationkeepExecutionStatusReportType::swap(StationkeepExecutionStatusReportType& other_)  noexcept 
            {
                using std::swap;
