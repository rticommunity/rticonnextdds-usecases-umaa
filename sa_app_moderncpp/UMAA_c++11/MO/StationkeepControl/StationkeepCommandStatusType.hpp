...
namespace UMAA {
    namespace MO {
        namespace StationkeepControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string StationkeepCommandStatus_TOPIC = "UMAA::MO::StationkeepControl::StationkeepCommandStatus";
            ...
            class NDDSUSERDllExport StationkeepCommandStatusType {
              public:
                ...
                void swap(StationkeepCommandStatusType& other_) noexcept ;
            ...
            inline void swap(StationkeepCommandStatusType& a, StationkeepCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
