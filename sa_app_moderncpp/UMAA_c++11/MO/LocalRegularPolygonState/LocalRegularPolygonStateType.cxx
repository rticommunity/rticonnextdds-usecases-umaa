    ...
    namespace MO {
        ...
        namespace LocalRegularPolygonState {
            ...
            namespace LocalRegularPolygonStateType_Specializations {
                ...
                LocalRegularPolygonStateType_Union::Union_::Union_(const ::UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonPatternType& LocalRegularPolygonPatternType_data_,const ::UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonTransitTypeType& LocalRegularPolygonTransitTypeType_data_):
                    m_LocalRegularPolygonPatternType_data_(LocalRegularPolygonPatternType_data_), 
                    m_LocalRegularPolygonTransitTypeType_data_(LocalRegularPolygonTransitTypeType_data_) {
                }
                ...
                void LocalRegularPolygonStateType_Union::swap(LocalRegularPolygonStateType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const LocalRegularPolygonStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType_Specializations::LocalRegularPolygonStateType_Selectors::LOCALREGULARPOLYGONTRANSITTYPETYPE_SELECT):
                            {  
                                o << "LocalRegularPolygonTransitTypeType_data: " << sample.LocalRegularPolygonTransitTypeType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            LocalRegularPolygonStateType::LocalRegularPolygonStateType (const ::UMAA::MO::LocalRegularPolygonState::LocalRegularPolygonStateType_Specializations::LocalRegularPolygonStateType_Union& LocalRegularPolygonStateType_subtypes_):
                m_LocalRegularPolygonStateType_subtypes_(LocalRegularPolygonStateType_subtypes_) {
            }

            void LocalRegularPolygonStateType::swap(LocalRegularPolygonStateType& other_)  noexcept 
            {
                using std::swap;
