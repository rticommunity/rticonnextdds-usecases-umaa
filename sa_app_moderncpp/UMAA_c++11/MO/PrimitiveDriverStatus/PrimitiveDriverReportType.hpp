...
namespace UMAA {
    namespace MO {
        namespace PrimitiveDriverStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PrimitiveDriverReport_TOPIC = "UMAA::MO::PrimitiveDriverStatus::PrimitiveDriverReport";
            ...
            class NDDSUSERDllExport PrimitiveDriverReportType {
              public:
                ...
                PrimitiveDriverReportType(const ::UMAA::Common::Measurement::LinearEffort& propulsiveLinearEffort_,const ::UMAA::Common::Measurement::RotationalEffort& propulsiveRotationalEffort_,const ::UMAA::Common::Measurement::LinearEffort& resistiveLinearEffort_,const ::UMAA::Common::Measurement::RotationalEffort& resistiveRotationalEffort_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(PrimitiveDriverReportType& other_) noexcept ;
            ...
            inline void swap(PrimitiveDriverReportType& a, PrimitiveDriverReportType& b)  noexcept 
            {
                a.swap(b);
            }
