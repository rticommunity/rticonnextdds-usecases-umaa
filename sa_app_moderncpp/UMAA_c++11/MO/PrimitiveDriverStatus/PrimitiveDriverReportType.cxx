...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace PrimitiveDriverStatus {
            ...
            void PrimitiveDriverReportType::swap(PrimitiveDriverReportType& other_)  noexcept 
            {
                using std::swap;
