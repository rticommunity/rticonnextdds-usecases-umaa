        ...
        namespace LocalHoverState {
            ...
            class NDDSUSERDllExport LocalHoveringHoverType {
              public:
                ...
                LocalHoveringHoverType(bool elevationAchieved_,bool headingAchieved_,bool positionAchieved_);
                ...
                void swap(LocalHoveringHoverType& other_) noexcept ;
            ...
            inline void swap(LocalHoveringHoverType& a, LocalHoveringHoverType& b)  noexcept 
            {
                a.swap(b);
            }
