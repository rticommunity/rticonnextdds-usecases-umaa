        ...
        namespace LocalHoverState {
            namespace LocalHoverStateType_Specializations {
                ...
                class NDDSUSERDllExport LocalHoverStateType_Union {
                  public:
                    ...
                    void _d(::UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Selectors value) {
                    ...
                    void swap(LocalHoverStateType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::MO::LocalHoverState::LocalTransitHoverType& LocalTransitHoverType_data_,const ::UMAA::MO::LocalHoverState::LocalHoveringHoverType& LocalHoveringHoverType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(LocalHoverStateType_Union& a, LocalHoverStateType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport LocalHoverStateType {
              public:
                ...
                explicit LocalHoverStateType(const ::UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Union& LocalHoverStateType_subtypes_);

                ::UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Union& LocalHoverStateType_subtypes() noexcept {
                    return m_LocalHoverStateType_subtypes_;
                }

                const ::UMAA::MO::LocalHoverState::LocalHoverStateType_Specializations::LocalHoverStateType_Union& LocalHoverStateType_subtypes() const noexcept {
                    return m_LocalHoverStateType_subtypes_;
                }
                ...
                void swap(LocalHoverStateType& other_) noexcept ;
            ...
            inline void swap(LocalHoverStateType& a, LocalHoverStateType& b)  noexcept 
            {
                a.swap(b);
            }
