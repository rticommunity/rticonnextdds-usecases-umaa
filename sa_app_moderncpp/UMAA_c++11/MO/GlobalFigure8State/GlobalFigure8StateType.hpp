        ...
        namespace GlobalFigure8State {
            namespace GlobalFigure8StateType_Specializations {
                ...
                class NDDSUSERDllExport GlobalFigure8StateType_Union {
                  public:
                    ...
                    void _d(::UMAA::MO::GlobalFigure8State::GlobalFigure8StateType_Specializations::GlobalFigure8StateType_Selectors value) {
                    ...
                    void swap(GlobalFigure8StateType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::MO::GlobalFigure8State::GlobalFigure8PatternType& GlobalFigure8PatternType_data_,const ::UMAA::MO::GlobalFigure8State::GlobalFigure8TransitType& GlobalFigure8TransitType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(GlobalFigure8StateType_Union& a, GlobalFigure8StateType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport GlobalFigure8StateType {
              public:
                ...
                explicit GlobalFigure8StateType(const ::UMAA::MO::GlobalFigure8State::GlobalFigure8StateType_Specializations::GlobalFigure8StateType_Union& GlobalFigure8StateType_subtypes_);

                ::UMAA::MO::GlobalFigure8State::GlobalFigure8StateType_Specializations::GlobalFigure8StateType_Union& GlobalFigure8StateType_subtypes() noexcept {
                    return m_GlobalFigure8StateType_subtypes_;
                }

                const ::UMAA::MO::GlobalFigure8State::GlobalFigure8StateType_Specializations::GlobalFigure8StateType_Union& GlobalFigure8StateType_subtypes() const noexcept {
                    return m_GlobalFigure8StateType_subtypes_;
                }
                ...
                void swap(GlobalFigure8StateType& other_) noexcept ;
            ...
            inline void swap(GlobalFigure8StateType& a, GlobalFigure8StateType& b)  noexcept 
            {
                a.swap(b);
            }
