...
data type GlobalFigure8TransitType from GlobalFigure8TransitType.idl.
This example builds two applications, named GlobalFigure8TransitType_publisher and
GlobalFigure8TransitType_subscriber.
...
> make -f makefile_GlobalFigure8TransitType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_GlobalFigure8TransitType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the GlobalFigure8TransitType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/GlobalFigure8TransitType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/GlobalFigure8TransitType_subscriber -d <domain_id> -s <sample_count>
