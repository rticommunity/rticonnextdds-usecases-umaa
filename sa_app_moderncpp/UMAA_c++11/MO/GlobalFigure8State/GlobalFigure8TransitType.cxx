...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalFigure8State {
            ...
            GlobalFigure8TransitType::GlobalFigure8TransitType (bool transitElevationAchieved_,bool transitSpeedAchieved_):
                m_transitElevationAchieved_(transitElevationAchieved_), 
                m_transitSpeedAchieved_(transitSpeedAchieved_) {
            }

            void GlobalFigure8TransitType::swap(GlobalFigure8TransitType& other_)  noexcept 
            {
                using std::swap;
