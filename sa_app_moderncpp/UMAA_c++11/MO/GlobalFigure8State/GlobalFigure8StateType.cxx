    ...
    namespace MO {
        ...
        namespace GlobalFigure8State {
            ...
            namespace GlobalFigure8StateType_Specializations {
                ...
                GlobalFigure8StateType_Union::Union_::Union_(const ::UMAA::MO::GlobalFigure8State::GlobalFigure8PatternType& GlobalFigure8PatternType_data_,const ::UMAA::MO::GlobalFigure8State::GlobalFigure8TransitType& GlobalFigure8TransitType_data_):
                    m_GlobalFigure8PatternType_data_(GlobalFigure8PatternType_data_), 
                    m_GlobalFigure8TransitType_data_(GlobalFigure8TransitType_data_) {
                }
                ...
                void GlobalFigure8StateType_Union::swap(GlobalFigure8StateType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const GlobalFigure8StateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::GlobalFigure8State::GlobalFigure8StateType_Specializations::GlobalFigure8StateType_Selectors::GLOBALFIGURE8TRANSITTYPE_SELECT):
                            {  
                                o << "GlobalFigure8TransitType_data: " << sample.GlobalFigure8TransitType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            GlobalFigure8StateType::GlobalFigure8StateType (const ::UMAA::MO::GlobalFigure8State::GlobalFigure8StateType_Specializations::GlobalFigure8StateType_Union& GlobalFigure8StateType_subtypes_):
                m_GlobalFigure8StateType_subtypes_(GlobalFigure8StateType_subtypes_) {
            }

            void GlobalFigure8StateType::swap(GlobalFigure8StateType& other_)  noexcept 
            {
                using std::swap;
