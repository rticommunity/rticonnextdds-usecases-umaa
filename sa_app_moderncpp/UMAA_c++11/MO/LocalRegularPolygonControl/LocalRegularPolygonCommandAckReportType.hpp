...
namespace UMAA {
    namespace MO {
        namespace LocalRegularPolygonControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalRegularPolygonCommandAckReport_TOPIC = "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandAckReport";
            ...
            class NDDSUSERDllExport LocalRegularPolygonCommandAckReportType {
              public:
                ...
                void swap(LocalRegularPolygonCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(LocalRegularPolygonCommandAckReportType& a, LocalRegularPolygonCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
