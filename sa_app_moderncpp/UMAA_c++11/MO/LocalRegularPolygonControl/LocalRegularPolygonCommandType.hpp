...
namespace UMAA {
    namespace MO {
        namespace LocalRegularPolygonControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalRegularPolygonCommand_TOPIC = "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommand";
            ...
            class NDDSUSERDllExport LocalRegularPolygonCommandType {
              public:
                ...
                void swap(LocalRegularPolygonCommandType& other_) noexcept ;
            ...
            inline void swap(LocalRegularPolygonCommandType& a, LocalRegularPolygonCommandType& b)  noexcept 
            {
                a.swap(b);
            }
