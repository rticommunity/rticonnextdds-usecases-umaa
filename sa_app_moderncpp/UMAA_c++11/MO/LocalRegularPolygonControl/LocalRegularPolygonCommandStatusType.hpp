...
namespace UMAA {
    namespace MO {
        namespace LocalRegularPolygonControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalRegularPolygonCommandStatus_TOPIC = "UMAA::MO::LocalRegularPolygonControl::LocalRegularPolygonCommandStatus";
            ...
            class NDDSUSERDllExport LocalRegularPolygonCommandStatusType {
              public:
                ...
                void swap(LocalRegularPolygonCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalRegularPolygonCommandStatusType& a, LocalRegularPolygonCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
