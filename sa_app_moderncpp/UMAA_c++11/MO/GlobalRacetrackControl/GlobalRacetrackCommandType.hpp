...
namespace UMAA {
    namespace MO {
        namespace GlobalRacetrackControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalRacetrackCommand_TOPIC = "UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommand";
            ...
            class NDDSUSERDllExport GlobalRacetrackCommandType {
              public:
                ...
                void swap(GlobalRacetrackCommandType& other_) noexcept ;
            ...
            inline void swap(GlobalRacetrackCommandType& a, GlobalRacetrackCommandType& b)  noexcept 
            {
                a.swap(b);
            }
