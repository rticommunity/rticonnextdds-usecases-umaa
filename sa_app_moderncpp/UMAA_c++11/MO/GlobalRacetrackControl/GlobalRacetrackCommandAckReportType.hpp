...
namespace UMAA {
    namespace MO {
        namespace GlobalRacetrackControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalRacetrackCommandAckReport_TOPIC = "UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandAckReport";
            ...
            class NDDSUSERDllExport GlobalRacetrackCommandAckReportType {
              public:
                ...
                void swap(GlobalRacetrackCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(GlobalRacetrackCommandAckReportType& a, GlobalRacetrackCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
