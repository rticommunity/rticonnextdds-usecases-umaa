...
namespace UMAA {
    namespace MO {
        namespace GlobalRacetrackControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalRacetrackCommandStatus_TOPIC = "UMAA::MO::GlobalRacetrackControl::GlobalRacetrackCommandStatus";
            ...
            class NDDSUSERDllExport GlobalRacetrackCommandStatusType {
              public:
                ...
                void swap(GlobalRacetrackCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GlobalRacetrackCommandStatusType& a, GlobalRacetrackCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
