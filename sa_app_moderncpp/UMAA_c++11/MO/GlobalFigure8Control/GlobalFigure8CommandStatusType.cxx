...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalFigure8Control {
            ...
            void GlobalFigure8CommandStatusType::swap(GlobalFigure8CommandStatusType& other_)  noexcept 
            {
                using std::swap;
