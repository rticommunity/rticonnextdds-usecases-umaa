...
namespace UMAA {
    namespace MO {
        namespace GlobalFigure8Control {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalFigure8Command_TOPIC = "UMAA::MO::GlobalFigure8Control::GlobalFigure8Command";
            ...
            class NDDSUSERDllExport GlobalFigure8CommandType {
              public:
                ...
                void swap(GlobalFigure8CommandType& other_) noexcept ;
            ...
            inline void swap(GlobalFigure8CommandType& a, GlobalFigure8CommandType& b)  noexcept 
            {
                a.swap(b);
            }
