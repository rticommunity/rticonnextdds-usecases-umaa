...
namespace UMAA {
    namespace MO {
        namespace GlobalFigure8Control {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalFigure8CommandStatus_TOPIC = "UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandStatus";
            ...
            class NDDSUSERDllExport GlobalFigure8CommandStatusType {
              public:
                ...
                void swap(GlobalFigure8CommandStatusType& other_) noexcept ;
            ...
            inline void swap(GlobalFigure8CommandStatusType& a, GlobalFigure8CommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
