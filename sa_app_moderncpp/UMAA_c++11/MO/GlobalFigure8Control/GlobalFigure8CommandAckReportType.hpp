...
namespace UMAA {
    namespace MO {
        namespace GlobalFigure8Control {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalFigure8CommandAckReport_TOPIC = "UMAA::MO::GlobalFigure8Control::GlobalFigure8CommandAckReport";
            ...
            class NDDSUSERDllExport GlobalFigure8CommandAckReportType {
              public:
                ...
                void swap(GlobalFigure8CommandAckReportType& other_) noexcept ;
            ...
            inline void swap(GlobalFigure8CommandAckReportType& a, GlobalFigure8CommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
