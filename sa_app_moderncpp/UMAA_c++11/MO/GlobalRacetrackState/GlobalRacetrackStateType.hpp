        ...
        namespace GlobalRacetrackState {
            namespace GlobalRacetrackStateType_Specializations {
                ...
                class NDDSUSERDllExport GlobalRacetrackStateType_Union {
                  public:
                    ...
                    void _d(::UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Selectors value) {
                    ...
                    void swap(GlobalRacetrackStateType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::MO::GlobalRacetrackState::GlobalRacetrackPatternType& GlobalRacetrackPatternType_data_,const ::UMAA::MO::GlobalRacetrackState::GlobalRacetrackTransitType& GlobalRacetrackTransitType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(GlobalRacetrackStateType_Union& a, GlobalRacetrackStateType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport GlobalRacetrackStateType {
              public:
                ...
                explicit GlobalRacetrackStateType(const ::UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Union& GlobalRacetrackStateType_subtypes_);

                ::UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Union& GlobalRacetrackStateType_subtypes() noexcept {
                    return m_GlobalRacetrackStateType_subtypes_;
                }

                const ::UMAA::MO::GlobalRacetrackState::GlobalRacetrackStateType_Specializations::GlobalRacetrackStateType_Union& GlobalRacetrackStateType_subtypes() const noexcept {
                    return m_GlobalRacetrackStateType_subtypes_;
                }
                ...
                void swap(GlobalRacetrackStateType& other_) noexcept ;
            ...
            inline void swap(GlobalRacetrackStateType& a, GlobalRacetrackStateType& b)  noexcept 
            {
                a.swap(b);
            }
