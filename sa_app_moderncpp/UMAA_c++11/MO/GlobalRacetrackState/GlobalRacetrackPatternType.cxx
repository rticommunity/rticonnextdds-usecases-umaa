...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalRacetrackState {
            ...
            GlobalRacetrackPatternType::GlobalRacetrackPatternType (bool elevationAchieved_,bool positionAchieved_,bool speedAchieved_):
                m_elevationAchieved_(elevationAchieved_), 
                m_positionAchieved_(positionAchieved_), 
                m_speedAchieved_(speedAchieved_) {
            }

            void GlobalRacetrackPatternType::swap(GlobalRacetrackPatternType& other_)  noexcept 
            {
                using std::swap;
