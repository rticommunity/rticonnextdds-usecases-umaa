        ...
        namespace LocalDriftState {
            ...
            class NDDSUSERDllExport LocalTransitDriftType {
              public:
                ...
                LocalTransitDriftType(bool transitElevationAchieved_,bool transitSpeedAchieved_);
                ...
                void swap(LocalTransitDriftType& other_) noexcept ;
            ...
            inline void swap(LocalTransitDriftType& a, LocalTransitDriftType& b)  noexcept 
            {
                a.swap(b);
            }
