...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalDriftState {
            ...
            LocalRegionDriftType::LocalRegionDriftType (bool elevationAchieved_,bool positionAchieved_):
                m_elevationAchieved_(elevationAchieved_), 
                m_positionAchieved_(positionAchieved_) {
            }

            void LocalRegionDriftType::swap(LocalRegionDriftType& other_)  noexcept 
            {
                using std::swap;
