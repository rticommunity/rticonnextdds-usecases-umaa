    ...
    namespace MO {
        ...
        namespace LocalDriftState {
            ...
            namespace LocalDriftStateType_Specializations {
                ...
                LocalDriftStateType_Union::Union_::Union_(const ::UMAA::MO::LocalDriftState::LocalTransitDriftType& LocalTransitDriftType_data_,const ::UMAA::MO::LocalDriftState::LocalRegionDriftType& LocalRegionDriftType_data_):
                    m_LocalTransitDriftType_data_(LocalTransitDriftType_data_), 
                    m_LocalRegionDriftType_data_(LocalRegionDriftType_data_) {
                }
                ...
                void LocalDriftStateType_Union::swap(LocalDriftStateType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const LocalDriftStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::LocalDriftState::LocalDriftStateType_Specializations::LocalDriftStateType_Selectors::LOCALREGIONDRIFTTYPE_SELECT):
                            {  
                                o << "LocalRegionDriftType_data: " << sample.LocalRegionDriftType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            LocalDriftStateType::LocalDriftStateType (const ::UMAA::MO::LocalDriftState::LocalDriftStateType_Specializations::LocalDriftStateType_Union& LocalDriftStateType_subtypes_):
                m_LocalDriftStateType_subtypes_(LocalDriftStateType_subtypes_) {
            }

            void LocalDriftStateType::swap(LocalDriftStateType& other_)  noexcept 
            {
                using std::swap;
