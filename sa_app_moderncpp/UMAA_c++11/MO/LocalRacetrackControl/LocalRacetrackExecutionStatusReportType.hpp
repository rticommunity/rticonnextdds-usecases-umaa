...
namespace UMAA {
    namespace MO {
        namespace LocalRacetrackControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalRacetrackExecutionStatusReport_TOPIC = "UMAA::MO::LocalRacetrackControl::LocalRacetrackExecutionStatusReport";
            ...
            class NDDSUSERDllExport LocalRacetrackExecutionStatusReportType {
              public:
                ...
                LocalRacetrackExecutionStatusReportType(const ::UMAA::MO::LocalRacetrackState::LocalRacetrackStateType& localRacetrackState_,const ::UMAA::Common::Measurement::DateTime& timePatternAchieved_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& timePatternCompleted_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);

                ::UMAA::MO::LocalRacetrackState::LocalRacetrackStateType& localRacetrackState() noexcept {
                    return m_localRacetrackState_;
                }

                const ::UMAA::MO::LocalRacetrackState::LocalRacetrackStateType& localRacetrackState() const noexcept {
                    return m_localRacetrackState_;
                }
                ...
                void swap(LocalRacetrackExecutionStatusReportType& other_) noexcept ;
            ...
            inline void swap(LocalRacetrackExecutionStatusReportType& a, LocalRacetrackExecutionStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }
