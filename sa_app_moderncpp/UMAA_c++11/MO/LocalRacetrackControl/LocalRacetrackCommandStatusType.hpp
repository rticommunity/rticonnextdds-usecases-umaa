...
namespace UMAA {
    namespace MO {
        namespace LocalRacetrackControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalRacetrackCommandStatus_TOPIC = "UMAA::MO::LocalRacetrackControl::LocalRacetrackCommandStatus";
            ...
            class NDDSUSERDllExport LocalRacetrackCommandStatusType {
              public:
                ...
                void swap(LocalRacetrackCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalRacetrackCommandStatusType& a, LocalRacetrackCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
