...
namespace UMAA {
    namespace MO {
        namespace LocalRacetrackControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalRacetrackCommand_TOPIC = "UMAA::MO::LocalRacetrackControl::LocalRacetrackCommand";
            ...
            class NDDSUSERDllExport LocalRacetrackCommandType {
              public:
                ...
                void swap(LocalRacetrackCommandType& other_) noexcept ;
            ...
            inline void swap(LocalRacetrackCommandType& a, LocalRacetrackCommandType& b)  noexcept 
            {
                a.swap(b);
            }
