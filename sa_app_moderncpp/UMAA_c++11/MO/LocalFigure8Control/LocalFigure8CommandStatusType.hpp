...
namespace UMAA {
    namespace MO {
        namespace LocalFigure8Control {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalFigure8CommandStatus_TOPIC = "UMAA::MO::LocalFigure8Control::LocalFigure8CommandStatus";
            ...
            class NDDSUSERDllExport LocalFigure8CommandStatusType {
              public:
                ...
                void swap(LocalFigure8CommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalFigure8CommandStatusType& a, LocalFigure8CommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
