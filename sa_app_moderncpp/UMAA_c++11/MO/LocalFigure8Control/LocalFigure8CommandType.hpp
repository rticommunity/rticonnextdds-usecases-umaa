...
namespace UMAA {
    namespace MO {
        namespace LocalFigure8Control {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalFigure8Command_TOPIC = "UMAA::MO::LocalFigure8Control::LocalFigure8Command";
            ...
            class NDDSUSERDllExport LocalFigure8CommandType {
              public:
                ...
                void swap(LocalFigure8CommandType& other_) noexcept ;
            ...
            inline void swap(LocalFigure8CommandType& a, LocalFigure8CommandType& b)  noexcept 
            {
                a.swap(b);
            }
