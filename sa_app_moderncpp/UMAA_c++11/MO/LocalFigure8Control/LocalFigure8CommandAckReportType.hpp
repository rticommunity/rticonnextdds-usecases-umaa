...
namespace UMAA {
    namespace MO {
        namespace LocalFigure8Control {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalFigure8CommandAckReport_TOPIC = "UMAA::MO::LocalFigure8Control::LocalFigure8CommandAckReport";
            ...
            class NDDSUSERDllExport LocalFigure8CommandAckReportType {
              public:
                ...
                void swap(LocalFigure8CommandAckReportType& other_) noexcept ;
            ...
            inline void swap(LocalFigure8CommandAckReportType& a, LocalFigure8CommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
