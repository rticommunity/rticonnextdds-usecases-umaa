...
namespace UMAA {
    namespace MO {
        namespace GlobalHoverControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalHoverCommandStatus_TOPIC = "UMAA::MO::GlobalHoverControl::GlobalHoverCommandStatus";
