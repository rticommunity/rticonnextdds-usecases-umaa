...
namespace UMAA {
    namespace MO {
        namespace LocalHoverControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalHoverCommandAckReport_TOPIC = "UMAA::MO::LocalHoverControl::LocalHoverCommandAckReport";
            ...
            class NDDSUSERDllExport LocalHoverCommandAckReportType {
              public:
                ...
                void swap(LocalHoverCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(LocalHoverCommandAckReportType& a, LocalHoverCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
