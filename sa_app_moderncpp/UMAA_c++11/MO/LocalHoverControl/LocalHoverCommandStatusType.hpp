...
namespace UMAA {
    namespace MO {
        namespace LocalHoverControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalHoverCommandStatus_TOPIC = "UMAA::MO::LocalHoverControl::LocalHoverCommandStatus";
            ...
            class NDDSUSERDllExport LocalHoverCommandStatusType {
              public:
                ...
                void swap(LocalHoverCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalHoverCommandStatusType& a, LocalHoverCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
