...
namespace UMAA {
    namespace MO {
        namespace LocalHoverControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalHoverCommand_TOPIC = "UMAA::MO::LocalHoverControl::LocalHoverCommand";
            ...
            class NDDSUSERDllExport LocalHoverCommandType {
              public:
                ...
                void swap(LocalHoverCommandType& other_) noexcept ;
            ...
            inline void swap(LocalHoverCommandType& a, LocalHoverCommandType& b)  noexcept 
            {
                a.swap(b);
            }
