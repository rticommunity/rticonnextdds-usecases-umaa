...
namespace UMAA {
    namespace MO {
        namespace GlobalDriftControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalDriftCommandStatus_TOPIC = "UMAA::MO::GlobalDriftControl::GlobalDriftCommandStatus";
            ...
            class NDDSUSERDllExport GlobalDriftCommandStatusType {
              public:
                ...
                void swap(GlobalDriftCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GlobalDriftCommandStatusType& a, GlobalDriftCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
