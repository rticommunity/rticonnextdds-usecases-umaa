...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace LocalVectorControl {
            ...
            void LocalVectorCommandAckReportType::swap(LocalVectorCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
