...
namespace UMAA {
    namespace MO {
        namespace LocalVectorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalVectorCommand_TOPIC = "UMAA::MO::LocalVectorControl::LocalVectorCommand";
            ...
            class NDDSUSERDllExport LocalVectorCommandType {
              public:
                ...
                void swap(LocalVectorCommandType& other_) noexcept ;
            ...
            inline void swap(LocalVectorCommandType& a, LocalVectorCommandType& b)  noexcept 
            {
                a.swap(b);
            }
