...
namespace UMAA {
    namespace MO {
        namespace LocalVectorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalVectorCommandAckReport_TOPIC = "UMAA::MO::LocalVectorControl::LocalVectorCommandAckReport";
            ...
            class NDDSUSERDllExport LocalVectorCommandAckReportType {
              public:
                ...
                void swap(LocalVectorCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(LocalVectorCommandAckReportType& a, LocalVectorCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
