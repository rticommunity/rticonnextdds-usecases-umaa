...
namespace UMAA {
    namespace MO {
        namespace LocalVectorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalVectorCommandStatus_TOPIC = "UMAA::MO::LocalVectorControl::LocalVectorCommandStatus";
            ...
            class NDDSUSERDllExport LocalVectorCommandStatusType {
              public:
                ...
                void swap(LocalVectorCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalVectorCommandStatusType& a, LocalVectorCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
