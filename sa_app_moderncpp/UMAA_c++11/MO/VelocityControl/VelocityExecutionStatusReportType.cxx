...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace VelocityControl {
            ...
            VelocityExecutionStatusReportType::VelocityExecutionStatusReportType (bool downSpeedAchieved_,bool forwardSpeedAchieved_,bool pitchRateAchieved_,bool rightSpeedAchieved_,bool rollRateAchieved_,bool yawRateAchieved_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_downSpeedAchieved_(downSpeedAchieved_), 
                m_forwardSpeedAchieved_(forwardSpeedAchieved_), 
                m_pitchRateAchieved_(pitchRateAchieved_), 
                m_rightSpeedAchieved_(rightSpeedAchieved_), 
                m_rollRateAchieved_(rollRateAchieved_), 
                m_yawRateAchieved_(yawRateAchieved_), 
                m_source_(source_), 
                m_sessionID_(sessionID_) {
            }

            void VelocityExecutionStatusReportType::swap(VelocityExecutionStatusReportType& other_)  noexcept 
            {
                using std::swap;
