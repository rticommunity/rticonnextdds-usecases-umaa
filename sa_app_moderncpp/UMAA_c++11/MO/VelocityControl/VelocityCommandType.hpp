...
namespace UMAA {
    namespace MO {
        namespace VelocityControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VelocityCommand_TOPIC = "UMAA::MO::VelocityControl::VelocityCommand";
            ...
            class NDDSUSERDllExport VelocityCommandType {
              public:
                ...
                void swap(VelocityCommandType& other_) noexcept ;
            ...
            inline void swap(VelocityCommandType& a, VelocityCommandType& b)  noexcept 
            {
                a.swap(b);
            }
