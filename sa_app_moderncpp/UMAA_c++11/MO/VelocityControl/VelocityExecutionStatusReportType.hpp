...
namespace UMAA {
    namespace MO {
        namespace VelocityControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VelocityExecutionStatusReport_TOPIC = "UMAA::MO::VelocityControl::VelocityExecutionStatusReport";
            ...
            class NDDSUSERDllExport VelocityExecutionStatusReportType {
              public:
                ...
                VelocityExecutionStatusReportType(bool downSpeedAchieved_,bool forwardSpeedAchieved_,bool pitchRateAchieved_,bool rightSpeedAchieved_,bool rollRateAchieved_,bool yawRateAchieved_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);

                bool& downSpeedAchieved() noexcept {
                    return m_downSpeedAchieved_;
                }

                const bool& downSpeedAchieved() const noexcept {
                    return m_downSpeedAchieved_;
                }
                ...
                bool& forwardSpeedAchieved() noexcept {
                    return m_forwardSpeedAchieved_;
                }

                const bool& forwardSpeedAchieved() const noexcept {
                    return m_forwardSpeedAchieved_;
                }
                ...
                bool& pitchRateAchieved() noexcept {
                    return m_pitchRateAchieved_;
                }

                const bool& pitchRateAchieved() const noexcept {
                    return m_pitchRateAchieved_;
                }
                ...
                bool& rightSpeedAchieved() noexcept {
                    return m_rightSpeedAchieved_;
                }

                const bool& rightSpeedAchieved() const noexcept {
                    return m_rightSpeedAchieved_;
                }
                ...
                bool& rollRateAchieved() noexcept {
                    return m_rollRateAchieved_;
                }

                const bool& rollRateAchieved() const noexcept {
                    return m_rollRateAchieved_;
                }
                ...
                bool& yawRateAchieved() noexcept {
                    return m_yawRateAchieved_;
                }

                const bool& yawRateAchieved() const noexcept {
                    return m_yawRateAchieved_;
                }
                ...
                void swap(VelocityExecutionStatusReportType& other_) noexcept ;
            ...
            inline void swap(VelocityExecutionStatusReportType& a, VelocityExecutionStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }
