...
namespace UMAA {
    namespace MO {
        namespace VelocityControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VelocityCommandStatus_TOPIC = "UMAA::MO::VelocityControl::VelocityCommandStatus";
            ...
            class NDDSUSERDllExport VelocityCommandStatusType {
              public:
                ...
                void swap(VelocityCommandStatusType& other_) noexcept ;
            ...
            inline void swap(VelocityCommandStatusType& a, VelocityCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
