...
namespace UMAA {
    namespace MO {
        namespace GlobalRegularPolygonControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalRegularPolygonCommand_TOPIC = "UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommand";
            ...
            class NDDSUSERDllExport GlobalRegularPolygonCommandType {
              public:
                ...
                void swap(GlobalRegularPolygonCommandType& other_) noexcept ;
            ...
            inline void swap(GlobalRegularPolygonCommandType& a, GlobalRegularPolygonCommandType& b)  noexcept 
            {
                a.swap(b);
            }
