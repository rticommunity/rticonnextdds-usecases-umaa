...
namespace UMAA {
    namespace MO {
        namespace GlobalRegularPolygonControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalRegularPolygonCommandStatus_TOPIC = "UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonCommandStatus";
            ...
            class NDDSUSERDllExport GlobalRegularPolygonCommandStatusType {
              public:
                ...
                void swap(GlobalRegularPolygonCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GlobalRegularPolygonCommandStatusType& a, GlobalRegularPolygonCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
