...
namespace UMAA {
    namespace MO {
        namespace GlobalRegularPolygonControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalRegularPolygonExecutionStatusReport_TOPIC = "UMAA::MO::GlobalRegularPolygonControl::GlobalRegularPolygonExecutionStatusReport";
            ...
            class NDDSUSERDllExport GlobalRegularPolygonExecutionStatusReportType {
              public:
                ...
                GlobalRegularPolygonExecutionStatusReportType(const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType& globalRegularPolygonState_,const ::UMAA::Common::Measurement::DateTime& timePatternAchieved_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& timePatternCompleted_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);

                ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType& globalRegularPolygonState() noexcept {
                    return m_globalRegularPolygonState_;
                }

                const ::UMAA::MO::GlobalRegularPolygonState::GlobalRegularPolygonStateType& globalRegularPolygonState() const noexcept {
                    return m_globalRegularPolygonState_;
                }
                ...
                void swap(GlobalRegularPolygonExecutionStatusReportType& other_) noexcept ;
            ...
            inline void swap(GlobalRegularPolygonExecutionStatusReportType& a, GlobalRegularPolygonExecutionStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }
