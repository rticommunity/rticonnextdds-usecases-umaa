...
namespace UMAA {
    namespace MO {
        namespace GuardedTeleopControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GuardedTeleopCommandStatus_TOPIC = "UMAA::MO::GuardedTeleopControl::GuardedTeleopCommandStatus";
            ...
            class NDDSUSERDllExport GuardedTeleopCommandStatusType {
              public:
                ...
                void swap(GuardedTeleopCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GuardedTeleopCommandStatusType& a, GuardedTeleopCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
