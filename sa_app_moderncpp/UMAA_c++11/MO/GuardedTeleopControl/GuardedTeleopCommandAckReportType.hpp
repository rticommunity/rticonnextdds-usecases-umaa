...
namespace UMAA {
    namespace MO {
        namespace GuardedTeleopControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GuardedTeleopCommandAckReport_TOPIC = "UMAA::MO::GuardedTeleopControl::GuardedTeleopCommandAckReport";
            ...
            class NDDSUSERDllExport GuardedTeleopCommandAckReportType {
              public:
                ...
                void swap(GuardedTeleopCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(GuardedTeleopCommandAckReportType& a, GuardedTeleopCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
