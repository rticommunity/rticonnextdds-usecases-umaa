...
namespace UMAA {
    namespace MO {
        namespace GlobalVectorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalVectorCommandStatus_TOPIC = "UMAA::MO::GlobalVectorControl::GlobalVectorCommandStatus";
