...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace SelfCollisionAvoidanceStatus {
            ...
            SelfCollisionAvoidanceReportType::SelfCollisionAvoidanceReportType (const ::UMAA::Common::MaritimeEnumeration::CollisionAvoidStatusEnumType::CollisionAvoidStatusEnumType& status_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_status_(status_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void SelfCollisionAvoidanceReportType::swap(SelfCollisionAvoidanceReportType& other_)  noexcept 
            {
                using std::swap;
