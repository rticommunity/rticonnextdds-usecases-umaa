...
namespace UMAA {
    namespace MO {
        namespace SelfCollisionAvoidanceConfig {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string SelfCollisionAvoidanceConfigReport_TOPIC = "UMAA::MO::SelfCollisionAvoidanceConfig::SelfCollisionAvoidanceConfigReport";
            ...
            class NDDSUSERDllExport SelfCollisionAvoidanceConfigReportType {
              public:
                ...
                SelfCollisionAvoidanceConfigReportType(int32_t priority_,const ::UMAA::Common::MaritimeEnumeration::CollisionAvoidStateEnumType::CollisionAvoidStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(SelfCollisionAvoidanceConfigReportType& other_) noexcept ;
            ...
            inline void swap(SelfCollisionAvoidanceConfigReportType& a, SelfCollisionAvoidanceConfigReportType& b)  noexcept 
            {
                a.swap(b);
            }
