    ...
    namespace MO {
        ...
        namespace GlobalHoverState {
            ...
            namespace GlobalHoverStateType_Specializations {
                ...
                GlobalHoverStateType_Union::Union_::Union_(const ::UMAA::MO::GlobalHoverState::GlobalTransitHoverType& GlobalTransitHoverType_data_,const ::UMAA::MO::GlobalHoverState::GlobalHoveringHoverType& GlobalHoveringHoverType_data_):
                    m_GlobalTransitHoverType_data_(GlobalTransitHoverType_data_), 
                    m_GlobalHoveringHoverType_data_(GlobalHoveringHoverType_data_) {
                }
                ...
                void GlobalHoverStateType_Union::swap(GlobalHoverStateType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const GlobalHoverStateType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MO::GlobalHoverState::GlobalHoverStateType_Specializations::GlobalHoverStateType_Selectors::GLOBALHOVERINGHOVERTYPE_SELECT):
                            {  
                                o << "GlobalHoveringHoverType_data: " << sample.GlobalHoveringHoverType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            GlobalHoverStateType::GlobalHoverStateType (const ::UMAA::MO::GlobalHoverState::GlobalHoverStateType_Specializations::GlobalHoverStateType_Union& GlobalHoverStateType_subtypes_):
                m_GlobalHoverStateType_subtypes_(GlobalHoverStateType_subtypes_) {
            }
