        ...
        namespace GlobalHoverState {
            namespace GlobalHoverStateType_Specializations {
                ...
                class NDDSUSERDllExport GlobalHoverStateType_Union {
                  public:
                    ...
                    void _d(::UMAA::MO::GlobalHoverState::GlobalHoverStateType_Specializations::GlobalHoverStateType_Selectors value) {
                    ...
                    void swap(GlobalHoverStateType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::MO::GlobalHoverState::GlobalTransitHoverType& GlobalTransitHoverType_data_,const ::UMAA::MO::GlobalHoverState::GlobalHoveringHoverType& GlobalHoveringHoverType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(GlobalHoverStateType_Union& a, GlobalHoverStateType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport GlobalHoverStateType {
              public:
                ...
                explicit GlobalHoverStateType(const ::UMAA::MO::GlobalHoverState::GlobalHoverStateType_Specializations::GlobalHoverStateType_Union& GlobalHoverStateType_subtypes_);

                ::UMAA::MO::GlobalHoverState::GlobalHoverStateType_Specializations::GlobalHoverStateType_Union& GlobalHoverStateType_subtypes() noexcept {
                    return m_GlobalHoverStateType_subtypes_;
                }

                const ::UMAA::MO::GlobalHoverState::GlobalHoverStateType_Specializations::GlobalHoverStateType_Union& GlobalHoverStateType_subtypes() const noexcept {
                    return m_GlobalHoverStateType_subtypes_;
                }
