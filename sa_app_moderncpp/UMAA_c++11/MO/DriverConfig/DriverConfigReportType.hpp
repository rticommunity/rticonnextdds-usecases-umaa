...
namespace UMAA {
    namespace MO {
        namespace DriverConfig {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string DriverConfigReport_TOPIC = "UMAA::MO::DriverConfig::DriverConfigReport";
            ...
            class NDDSUSERDllExport DriverConfigReportType {
              public:
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::OrientationAcceleration3D >& maxAllowableAttitudeAcceleration() noexcept {
                    return m_maxAllowableAttitudeAcceleration_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::OrientationAcceleration3D >& maxAllowableAttitudeAcceleration() const noexcept {
                    return m_maxAllowableAttitudeAcceleration_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::ElevationType >& maxAllowableElevation() noexcept {
                    return m_maxAllowableElevation_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationType >& maxAllowableElevation() const noexcept {
                    return m_maxAllowableElevation_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Speed::SpeedControlType >& maxAllowableSpeed() noexcept {
                    return m_maxAllowableSpeed_;
                }

                const ::dds::core::optional< ::UMAA::Common::Speed::SpeedControlType >& maxAllowableSpeed() const noexcept {
                    return m_maxAllowableSpeed_;
                }
                ...
                ::dds::core::optional< double >& maxAllowableTurnRate() noexcept {
                    return m_maxAllowableTurnRate_;
                }

                const ::dds::core::optional< double >& maxAllowableTurnRate() const noexcept {
                    return m_maxAllowableTurnRate_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Capabilities::Speed_BSL_Capability >& maxElevationChangeRate() noexcept {
                    return m_maxElevationChangeRate_;
                }

                const ::dds::core::optional< ::UMAA::Common::Capabilities::Speed_BSL_Capability >& maxElevationChangeRate() const noexcept {
                    return m_maxElevationChangeRate_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::Acceleration3D_PlatformXYZ >& minAllowableAcceleration() noexcept {
                    return m_minAllowableAcceleration_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::Acceleration3D_PlatformXYZ >& minAllowableAcceleration() const noexcept {
                    return m_minAllowableAcceleration_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::OrientationAcceleration3D >& minAllowableAttitudeAcceleration() noexcept {
                    return m_minAllowableAttitudeAcceleration_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::OrientationAcceleration3D >& minAllowableAttitudeAcceleration() const noexcept {
                    return m_minAllowableAttitudeAcceleration_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::ElevationType >& minAllowableElevation() noexcept {
                    return m_minAllowableElevation_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationType >& minAllowableElevation() const noexcept {
                    return m_minAllowableElevation_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Speed::SpeedControlType >& minAllowableSpeed() noexcept {
                    return m_minAllowableSpeed_;
                }

                const ::dds::core::optional< ::UMAA::Common::Speed::SpeedControlType >& minAllowableSpeed() const noexcept {
                    return m_minAllowableSpeed_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::Acceleration3D_PlatformXYZ >& recommendedAcceleration() noexcept {
                    return m_recommendedAcceleration_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::Acceleration3D_PlatformXYZ >& recommendedAcceleration() const noexcept {
                    return m_recommendedAcceleration_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::OrientationAcceleration3D >& recommendedAttitudeAcceleration() noexcept {
                    return m_recommendedAttitudeAcceleration_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::OrientationAcceleration3D >& recommendedAttitudeAcceleration() const noexcept {
                    return m_recommendedAttitudeAcceleration_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::ElevationType >& recommendedElevation() noexcept {
                    return m_recommendedElevation_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationType >& recommendedElevation() const noexcept {
                    return m_recommendedElevation_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Capabilities::Speed_BSL_Capability >& recommendedElevationChangeRate() noexcept {
                    return m_recommendedElevationChangeRate_;
                }

                const ::dds::core::optional< ::UMAA::Common::Capabilities::Speed_BSL_Capability >& recommendedElevationChangeRate() const noexcept {
                    return m_recommendedElevationChangeRate_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Speed::SpeedControlType >& recommendedSpeed() noexcept {
                    return m_recommendedSpeed_;
                }

                const ::dds::core::optional< ::UMAA::Common::Speed::SpeedControlType >& recommendedSpeed() const noexcept {
                    return m_recommendedSpeed_;
                }
                ...
                ::dds::core::optional< double >& recommendedTurnRate() noexcept {
                    return m_recommendedTurnRate_;
                }

                const ::dds::core::optional< double >& recommendedTurnRate() const noexcept {
                    return m_recommendedTurnRate_;
                }
                ...
                void swap(DriverConfigReportType& other_) noexcept ;
            ...
            inline void swap(DriverConfigReportType& a, DriverConfigReportType& b)  noexcept 
            {
                a.swap(b);
            }
