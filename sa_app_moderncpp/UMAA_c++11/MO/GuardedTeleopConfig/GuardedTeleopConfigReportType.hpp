...
namespace UMAA {
    namespace MO {
        namespace GuardedTeleopConfig {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GuardedTeleopConfigReport_TOPIC = "UMAA::MO::GuardedTeleopConfig::GuardedTeleopConfigReport";
            ...
            class NDDSUSERDllExport GuardedTeleopConfigReportType {
              public:
                ...
                GuardedTeleopConfigReportType(const ::UMAA::Common::MaritimeEnumeration::ObstacleAvoidanceEnumType::ObstacleAvoidanceEnumType& obstacleAvoidance_,double pathTolerance_,bool stopOnPitchoverLimit_,bool stopOnRolloverLimit_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(GuardedTeleopConfigReportType& other_) noexcept ;
            ...
            inline void swap(GuardedTeleopConfigReportType& a, GuardedTeleopConfigReportType& b)  noexcept 
            {
                a.swap(b);
            }
