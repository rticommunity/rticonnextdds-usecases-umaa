...
namespace UMAA {
    namespace MO {
        namespace PrimitiveDriverControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PrimitiveDriverCommandStatus_TOPIC = "UMAA::MO::PrimitiveDriverControl::PrimitiveDriverCommandStatus";
