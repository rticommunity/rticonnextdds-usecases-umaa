...
namespace UMAA {
    namespace MO {
        namespace GlobalWaypointControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalWaypointCommandStatus_TOPIC = "UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandStatus";
