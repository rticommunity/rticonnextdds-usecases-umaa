        ...
        namespace GlobalWaypointControl {
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                try {
                    ...
                    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                        serializedSampleMaxSize = ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_get_serialized_sample_max_size(
                        ...
                        if (PRESTypePluginDefaultEndpointData_createWriterPool(
                            ...
                            ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_get_serialized_sample_max_size, epd,
            ...
            GlobalWaypointTypePlugin_copy_sample(
                ...
                const GlobalWaypointType *src)
            {
                return ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                unsigned int length)
            {
                ...
                epd.programContext.endpointPluginData = &epd;
                plugin.typeCode = (struct RTICdrTypeCode *)
                (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GlobalWaypointType >::get().native()
                ;
                pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
                GlobalWaypointType, 
                true, true, true>();
            ...
            * ------------------------------------------------------------------------ */
            ...
            { 
                ...
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_copy_sample;
                ...
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_get_serialized_sample_max_size;
                ...
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointTypePlugin_get_key_kind;
                ...
                */
                ...
                #else
                plugin->typeCode = (struct RTICdrTypeCode *) 
                &::rti::topic::dynamic_type< ::UMAA::MO::GlobalWaypointControl::GlobalWaypointType >::get().native();
                #endif
                ...
                static const char * TYPE_NAME = "UMAA::MO::GlobalWaypointControl::GlobalWaypointType";
