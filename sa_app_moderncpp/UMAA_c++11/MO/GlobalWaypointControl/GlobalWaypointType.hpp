        ...
        namespace GlobalWaypointControl {
            ...
            class NDDSUSERDllExport GlobalWaypointType {
              public:
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::Orientation3D_PlatformXYZ >& attitude() noexcept {
                    return m_attitude_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::Orientation3D_PlatformXYZ >& attitude() const noexcept {
                    return m_attitude_;
                }
                ...
                ::dds::core::optional< double >& trackTolerance() noexcept {
                    return m_trackTolerance_;
                }

                const ::dds::core::optional< double >& trackTolerance() const noexcept {
                    return m_trackTolerance_;
                }
