...
namespace UMAA {
    namespace MO {
        namespace GlobalWaypointControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalWaypointSpeedCommandStatus_TOPIC = "UMAA::MO::GlobalWaypointControl::GlobalWaypointSpeedCommandStatus";
            ...
            class NDDSUSERDllExport GlobalWaypointSpeedCommandStatusType {
              public:
                ...
                void swap(GlobalWaypointSpeedCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GlobalWaypointSpeedCommandStatusType& a, GlobalWaypointSpeedCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
