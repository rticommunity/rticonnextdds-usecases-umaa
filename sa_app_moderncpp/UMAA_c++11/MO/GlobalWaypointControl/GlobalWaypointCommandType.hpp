...
namespace UMAA {
    namespace MO {
        namespace GlobalWaypointControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalWaypointCommand_TOPIC = "UMAA::MO::GlobalWaypointControl::GlobalWaypointCommand";
            ...
            class NDDSUSERDllExport GlobalWaypointCommandType {
              public:
                ...
                GlobalWaypointCommandType(int32_t waypointCount_,const ::rti::core::bounded_sequence< ::UMAA::MO::GlobalWaypointControl::GlobalWaypointType, 100L >& waypoints_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
