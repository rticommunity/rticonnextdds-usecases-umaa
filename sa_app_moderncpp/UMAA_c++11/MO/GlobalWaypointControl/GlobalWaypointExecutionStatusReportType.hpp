...
namespace UMAA {
    namespace MO {
        namespace GlobalWaypointControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalWaypointExecutionStatusReport_TOPIC = "UMAA::MO::GlobalWaypointControl::GlobalWaypointExecutionStatusReport";
