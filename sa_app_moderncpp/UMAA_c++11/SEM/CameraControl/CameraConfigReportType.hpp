...
namespace UMAA {
    namespace SEM {
        namespace CameraControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CameraConfigReport_TOPIC = "UMAA::SEM::CameraControl::CameraConfigReport";
            ...
            class NDDSUSERDllExport CameraConfigReportType {
              public:
                ...
                ::UMAA::Common::MaritimeEnumeration::ExposureModeEnumType::ExposureModeEnumType& exposureMode() noexcept {
                    return m_exposureMode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::ExposureModeEnumType::ExposureModeEnumType& exposureMode() const noexcept {
                    return m_exposureMode_;
                }
                ...
                double& focalLength() noexcept {
                    return m_focalLength_;
                }

                const double& focalLength() const noexcept {
                    return m_focalLength_;
                }
                ...
                ::UMAA::Common::Enumeration::AutomationEnumType::AutomationEnumType& focusMode() noexcept {
                    return m_focusMode_;
                }

                const ::UMAA::Common::Enumeration::AutomationEnumType::AutomationEnumType& focusMode() const noexcept {
                    return m_focusMode_;
                }
                ...
                double& focusValue() noexcept {
                    return m_focusValue_;
                }

                const double& focusValue() const noexcept {
                    return m_focusValue_;
                }
                ...
                double& horizontalFOV() noexcept {
                    return m_horizontalFOV_;
                }

                const double& horizontalFOV() const noexcept {
                    return m_horizontalFOV_;
                }
                ...
                ::UMAA::Common::MaritimeEnumeration::ImagingModeEnumType::ImagingModeEnumType& imagingMode() noexcept {
                    return m_imagingMode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::ImagingModeEnumType::ImagingModeEnumType& imagingMode() const noexcept {
                    return m_imagingMode_;
                }
                ...
                ::UMAA::Common::MaritimeEnumeration::LightSensitivityEnumType::LightSensitivityEnumType& lightSensitivity() noexcept {
                    return m_lightSensitivity_;
                }

                const ::UMAA::Common::MaritimeEnumeration::LightSensitivityEnumType::LightSensitivityEnumType& lightSensitivity() const noexcept {
                    return m_lightSensitivity_;
                }
                ...
                double& maxZoomLevel() noexcept {
                    return m_maxZoomLevel_;
                }

                const double& maxZoomLevel() const noexcept {
                    return m_maxZoomLevel_;
                }
                ...
                ::UMAA::Common::MaritimeEnumeration::MeteringModeEnumType::MeteringModeEnumType& meteringMode() noexcept {
                    return m_meteringMode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::MeteringModeEnumType::MeteringModeEnumType& meteringMode() const noexcept {
                    return m_meteringMode_;
                }
                ...
                double& minZoomLevel() noexcept {
                    return m_minZoomLevel_;
                }

                const double& minZoomLevel() const noexcept {
                    return m_minZoomLevel_;
                }
                ...
                double& shutterSpeed() noexcept {
                    return m_shutterSpeed_;
                }

                const double& shutterSpeed() const noexcept {
                    return m_shutterSpeed_;
                }
                ...
                double& verticalFOV() noexcept {
                    return m_verticalFOV_;
                }

                const double& verticalFOV() const noexcept {
                    return m_verticalFOV_;
                }
                ...
                ::UMAA::Common::MaritimeEnumeration::WhiteBalanceEnumType::WhiteBalanceEnumType& whiteBalance() noexcept {
                    return m_whiteBalance_;
                }

                const ::UMAA::Common::MaritimeEnumeration::WhiteBalanceEnumType::WhiteBalanceEnumType& whiteBalance() const noexcept {
                    return m_whiteBalance_;
                }
                ...
                ::UMAA::Common::MaritimeEnumeration::ZoomModeEnumType::ZoomModeEnumType& zoomMode() noexcept {
                    return m_zoomMode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::ZoomModeEnumType::ZoomModeEnumType& zoomMode() const noexcept {
                    return m_zoomMode_;
                }
                ...
                void swap(CameraConfigReportType& other_) noexcept ;
            ...
            inline void swap(CameraConfigReportType& a, CameraConfigReportType& b)  noexcept 
            {
                a.swap(b);
            }
