...
namespace UMAA {
    namespace SEM {
        namespace CameraControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CameraCommandStatus_TOPIC = "UMAA::SEM::CameraControl::CameraCommandStatus";
            ...
            class NDDSUSERDllExport CameraCommandStatusType {
              public:
                ...
                void swap(CameraCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CameraCommandStatusType& a, CameraCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
