...
namespace UMAA {
    namespace SEM {
        namespace CameraControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CameraCommand_TOPIC = "UMAA::SEM::CameraControl::CameraCommand";
            ...
            class NDDSUSERDllExport CameraCommandType {
              public:
                ...
                CameraCommandType(const ::dds::core::optional< ::UMAA::Common::Measurement::BuiltInTestStatusType_All >& builtInTest_,bool filtered_,const ::UMAA::Common::Measurement::Position2D& imageCenterLocation_,const ::UMAA::Common::Enumeration::IRPolarityEnumType::IRPolarityEnumType& mode_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(CameraCommandType& other_) noexcept ;
            ...
            inline void swap(CameraCommandType& a, CameraCommandType& b)  noexcept 
            {
                a.swap(b);
            }
