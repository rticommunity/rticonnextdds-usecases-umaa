...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace CameraControl {
            ...
            void CameraCommandType::swap(CameraCommandType& other_)  noexcept 
            {
                using std::swap;
