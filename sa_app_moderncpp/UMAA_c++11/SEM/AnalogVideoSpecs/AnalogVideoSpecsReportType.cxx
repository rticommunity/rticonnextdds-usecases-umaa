...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace AnalogVideoSpecs {
            ...
            AnalogVideoSpecsReportType::AnalogVideoSpecsReportType (const ::UMAA::Common::MaritimeEnumeration::VideoFormatEnumType::VideoFormatEnumType& videoFormat_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_videoFormat_(videoFormat_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void AnalogVideoSpecsReportType::swap(AnalogVideoSpecsReportType& other_)  noexcept 
            {
                using std::swap;
