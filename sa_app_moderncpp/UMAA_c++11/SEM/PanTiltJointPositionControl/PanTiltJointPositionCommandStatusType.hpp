...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointPositionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PanTiltJointPositionCommandStatus_TOPIC = "UMAA::SEM::PanTiltJointPositionControl::PanTiltJointPositionCommandStatus";
            ...
            class NDDSUSERDllExport PanTiltJointPositionCommandStatusType {
              public:
                ...
                void swap(PanTiltJointPositionCommandStatusType& other_) noexcept ;
            ...
            inline void swap(PanTiltJointPositionCommandStatusType& a, PanTiltJointPositionCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
