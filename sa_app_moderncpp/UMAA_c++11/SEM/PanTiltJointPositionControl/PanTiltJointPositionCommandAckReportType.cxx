...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace PanTiltJointPositionControl {
            ...
            PanTiltJointPositionCommandAckReportType::PanTiltJointPositionCommandAckReportType (double pan_,double tilt_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_pan_(pan_), 
                m_tilt_(tilt_), 
                m_source_(source_), 
            ...
            void PanTiltJointPositionCommandAckReportType::swap(PanTiltJointPositionCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
