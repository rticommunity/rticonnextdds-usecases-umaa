...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointPositionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PanTiltJointPositionCommandAckReport_TOPIC = "UMAA::SEM::PanTiltJointPositionControl::PanTiltJointPositionCommandAckReport";
            ...
            class NDDSUSERDllExport PanTiltJointPositionCommandAckReportType {
              public:
                ...
                PanTiltJointPositionCommandAckReportType(double pan_,double tilt_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
                ...
                void swap(PanTiltJointPositionCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(PanTiltJointPositionCommandAckReportType& a, PanTiltJointPositionCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
