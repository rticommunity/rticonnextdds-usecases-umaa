...
data type CameraReportType from CameraReportType.idl.
This example builds two applications, named CameraReportType_publisher and
CameraReportType_subscriber.
...
> make -f makefile_CameraReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_CameraReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the CameraReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/CameraReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/CameraReportType_subscriber -d <domain_id> -s <sample_count>
