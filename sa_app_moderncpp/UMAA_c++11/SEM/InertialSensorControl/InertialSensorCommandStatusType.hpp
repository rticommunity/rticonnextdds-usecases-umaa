...
namespace UMAA {
    namespace SEM {
        namespace InertialSensorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string InertialSensorCommandStatus_TOPIC = "UMAA::SEM::InertialSensorControl::InertialSensorCommandStatus";
