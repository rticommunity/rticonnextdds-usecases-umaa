...
namespace UMAA {
    namespace SEM {
        namespace InertialSensorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string InertialSensorCommand_TOPIC = "UMAA::SEM::InertialSensorControl::InertialSensorCommand";
