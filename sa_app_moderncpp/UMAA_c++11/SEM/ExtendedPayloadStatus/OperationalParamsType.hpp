        ...
        namespace ExtendedPayloadStatus {
            ...
            class NDDSUSERDllExport OperationalParamsType {
              public:
                ...
                OperationalParamsType(double busCurrent_,double busVoltage_,double phaseCurrent_,double temp_);

                double& busCurrent() noexcept {
                    return m_busCurrent_;
                }

                const double& busCurrent() const noexcept {
                    return m_busCurrent_;
                }
                ...
                double& busVoltage() noexcept {
                    return m_busVoltage_;
                }

                const double& busVoltage() const noexcept {
                    return m_busVoltage_;
                }
                ...
                double& phaseCurrent() noexcept {
                    return m_phaseCurrent_;
                }

                const double& phaseCurrent() const noexcept {
                    return m_phaseCurrent_;
                }
                ...
                void swap(OperationalParamsType& other_) noexcept ;
            ...
            inline void swap(OperationalParamsType& a, OperationalParamsType& b)  noexcept 
            {
                a.swap(b);
            }
