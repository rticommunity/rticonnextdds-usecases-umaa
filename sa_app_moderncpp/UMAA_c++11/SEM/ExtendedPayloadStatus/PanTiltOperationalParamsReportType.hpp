...
namespace UMAA {
    namespace SEM {
        namespace ExtendedPayloadStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PanTiltOperationalParamsReport_TOPIC = "UMAA::SEM::ExtendedPayloadStatus::PanTiltOperationalParamsReport";
            ...
            class NDDSUSERDllExport PanTiltOperationalParamsReportType {
              public:
                ...
                PanTiltOperationalParamsReportType(const ::UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& panParams_,const ::UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& tiltParams_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& panParams() noexcept {
                    return m_panParams_;
                }

                const ::UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& panParams() const noexcept {
                    return m_panParams_;
                }
                ...
                ::UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& tiltParams() noexcept {
                    return m_tiltParams_;
                }

                const ::UMAA::SEM::ExtendedPayloadStatus::OperationalParamsType& tiltParams() const noexcept {
                    return m_tiltParams_;
                }
                ...
                void swap(PanTiltOperationalParamsReportType& other_) noexcept ;
            ...
            inline void swap(PanTiltOperationalParamsReportType& a, PanTiltOperationalParamsReportType& b)  noexcept 
            {
                a.swap(b);
            }
