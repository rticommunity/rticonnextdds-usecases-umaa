...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace VideoIlluminatorSpecs {
            ...
            VideoIlluminatorSpecsReportType::VideoIlluminatorSpecsReportType (bool maxBeamWidth_,const std::string& name_,bool supportedColor_,bool supportedGreyscale_,bool supportedInfrared_,bool supportedLowlight_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_maxBeamWidth_(maxBeamWidth_), 
                m_name_(name_), 
                m_supportedColor_(supportedColor_), 
                m_supportedGreyscale_(supportedGreyscale_), 
                m_supportedInfrared_(supportedInfrared_), 
                m_supportedLowlight_(supportedLowlight_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void VideoIlluminatorSpecsReportType::swap(VideoIlluminatorSpecsReportType& other_)  noexcept 
            {
                using std::swap;
