...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointVelocityStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PanTiltJointVelocityReport_TOPIC = "UMAA::SEM::PanTiltJointVelocityStatus::PanTiltJointVelocityReport";
            ...
            class NDDSUSERDllExport PanTiltJointVelocityReportType {
              public:
                ...
                PanTiltJointVelocityReportType(double panVelocity_,double tiltVelocity_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(PanTiltJointVelocityReportType& other_) noexcept ;
            ...
            inline void swap(PanTiltJointVelocityReportType& a, PanTiltJointVelocityReportType& b)  noexcept 
            {
                a.swap(b);
            }
