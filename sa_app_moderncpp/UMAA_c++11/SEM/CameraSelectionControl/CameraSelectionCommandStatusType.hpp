...
namespace UMAA {
    namespace SEM {
        namespace CameraSelectionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CameraSelectionCommandStatus_TOPIC = "UMAA::SEM::CameraSelectionControl::CameraSelectionCommandStatus";
            ...
            class NDDSUSERDllExport CameraSelectionCommandStatusType {
              public:
                ...
                void swap(CameraSelectionCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CameraSelectionCommandStatusType& a, CameraSelectionCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
