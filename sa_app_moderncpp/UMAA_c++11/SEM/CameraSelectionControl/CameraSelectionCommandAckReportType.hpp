...
namespace UMAA {
    namespace SEM {
        namespace CameraSelectionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CameraSelectionCommandAckReport_TOPIC = "UMAA::SEM::CameraSelectionControl::CameraSelectionCommandAckReport";
            ...
            class NDDSUSERDllExport CameraSelectionCommandAckReportType {
              public:
                ...
                CameraSelectionCommandAckReportType(const ::UMAA::Common::Measurement::NumericGUID& cameraID_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::NumericGUID& muxID_);
                ...
                void swap(CameraSelectionCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(CameraSelectionCommandAckReportType& a, CameraSelectionCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
