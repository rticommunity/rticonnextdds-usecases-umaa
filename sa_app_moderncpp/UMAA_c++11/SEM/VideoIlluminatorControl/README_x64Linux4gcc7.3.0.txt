...
data type VideoIlluminatorCommandType from VideoIlluminatorCommandType.idl.
This example builds two applications, named VideoIlluminatorCommandType_publisher and
VideoIlluminatorCommandType_subscriber.
...
> make -f makefile_VideoIlluminatorCommandType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_VideoIlluminatorCommandType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the VideoIlluminatorCommandType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/VideoIlluminatorCommandType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/VideoIlluminatorCommandType_subscriber -d <domain_id> -s <sample_count>
