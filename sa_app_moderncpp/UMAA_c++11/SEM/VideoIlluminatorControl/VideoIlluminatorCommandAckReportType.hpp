...
namespace UMAA {
    namespace SEM {
        namespace VideoIlluminatorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VideoIlluminatorCommandAckReport_TOPIC = "UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandAckReport";
            ...
            class NDDSUSERDllExport VideoIlluminatorCommandAckReportType {
              public:
                ...
                VideoIlluminatorCommandAckReportType(double beamWidth_,int32_t level_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
                ...
                void swap(VideoIlluminatorCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(VideoIlluminatorCommandAckReportType& a, VideoIlluminatorCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
