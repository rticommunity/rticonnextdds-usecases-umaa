...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace VideoIlluminatorControl {
            ...
            VideoIlluminatorCommandAckReportType::VideoIlluminatorCommandAckReportType (double beamWidth_,int32_t level_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
            ...
            void VideoIlluminatorCommandAckReportType::swap(VideoIlluminatorCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
