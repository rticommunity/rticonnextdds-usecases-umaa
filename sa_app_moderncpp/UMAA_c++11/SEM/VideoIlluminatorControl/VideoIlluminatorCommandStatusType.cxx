...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace VideoIlluminatorControl {
            ...
            void VideoIlluminatorCommandStatusType::swap(VideoIlluminatorCommandStatusType& other_)  noexcept 
            {
                using std::swap;
