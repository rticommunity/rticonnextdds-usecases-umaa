...
namespace UMAA {
    namespace SEM {
        namespace VideoIlluminatorControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VideoIlluminatorCommandStatus_TOPIC = "UMAA::SEM::VideoIlluminatorControl::VideoIlluminatorCommandStatus";
            ...
            class NDDSUSERDllExport VideoIlluminatorCommandStatusType {
              public:
                ...
                void swap(VideoIlluminatorCommandStatusType& other_) noexcept ;
            ...
            inline void swap(VideoIlluminatorCommandStatusType& a, VideoIlluminatorCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
