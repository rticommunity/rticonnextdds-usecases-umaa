    ...
    namespace SEM {
        ...
        namespace DigitalVideoConfig {
            ...
            bool DigitalVideoConfigReportType::operator == (const DigitalVideoConfigReportType& other_) const {
                ...
                if (std::fabs(m_commsRate_ - other_.m_commsRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_commsRate_ - other_.m_commsRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                ...
                if (std::fabs(m_frameRate_ - other_.m_frameRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_frameRate_ - other_.m_frameRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
