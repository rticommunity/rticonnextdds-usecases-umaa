...
namespace UMAA {
    namespace SEM {
        namespace H264VideoEncodingControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string H264VideoEncodingCommandAckReport_TOPIC = "UMAA::SEM::H264VideoEncodingControl::H264VideoEncodingCommandAckReport";
            ...
            class NDDSUSERDllExport H264VideoEncodingCommandAckReportType {
              public:
                ...
                void swap(H264VideoEncodingCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(H264VideoEncodingCommandAckReportType& a, H264VideoEncodingCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
