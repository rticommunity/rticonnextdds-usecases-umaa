...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace H264VideoEncodingControl {
            ...
            void H264VideoEncodingCommandStatusType::swap(H264VideoEncodingCommandStatusType& other_)  noexcept 
            {
                using std::swap;
