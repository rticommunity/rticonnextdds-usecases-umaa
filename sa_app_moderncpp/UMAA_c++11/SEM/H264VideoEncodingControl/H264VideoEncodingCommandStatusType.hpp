...
namespace UMAA {
    namespace SEM {
        namespace H264VideoEncodingControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string H264VideoEncodingCommandStatus_TOPIC = "UMAA::SEM::H264VideoEncodingControl::H264VideoEncodingCommandStatus";
            ...
            class NDDSUSERDllExport H264VideoEncodingCommandStatusType {
              public:
                ...
                void swap(H264VideoEncodingCommandStatusType& other_) noexcept ;
            ...
            inline void swap(H264VideoEncodingCommandStatusType& a, H264VideoEncodingCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
