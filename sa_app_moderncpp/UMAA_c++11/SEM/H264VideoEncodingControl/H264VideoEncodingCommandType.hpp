...
namespace UMAA {
    namespace SEM {
        namespace H264VideoEncodingControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string H264VideoEncodingCommand_TOPIC = "UMAA::SEM::H264VideoEncodingControl::H264VideoEncodingCommand";
            ...
            class NDDSUSERDllExport H264VideoEncodingCommandType {
              public:
                ...
                void swap(H264VideoEncodingCommandType& other_) noexcept ;
            ...
            inline void swap(H264VideoEncodingCommandType& a, H264VideoEncodingCommandType& b)  noexcept 
            {
                a.swap(b);
            }
