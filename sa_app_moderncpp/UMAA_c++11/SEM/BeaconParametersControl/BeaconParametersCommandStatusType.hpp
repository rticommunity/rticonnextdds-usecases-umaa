...
namespace UMAA {
    namespace SEM {
        namespace BeaconParametersControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BeaconParametersCommandStatus_TOPIC = "UMAA::SEM::BeaconParametersControl::BeaconParametersCommandStatus";
            ...
            class NDDSUSERDllExport BeaconParametersCommandStatusType {
              public:
                ...
                void swap(BeaconParametersCommandStatusType& other_) noexcept ;
            ...
            inline void swap(BeaconParametersCommandStatusType& a, BeaconParametersCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
