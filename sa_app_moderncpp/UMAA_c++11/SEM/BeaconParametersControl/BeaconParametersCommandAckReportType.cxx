...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace BeaconParametersControl {
            ...
            void BeaconParametersCommandAckReportType::swap(BeaconParametersCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
