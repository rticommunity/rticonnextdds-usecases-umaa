...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace BeaconParametersControl {
            ...
            void BeaconParametersCommandType::swap(BeaconParametersCommandType& other_)  noexcept 
            {
                using std::swap;
