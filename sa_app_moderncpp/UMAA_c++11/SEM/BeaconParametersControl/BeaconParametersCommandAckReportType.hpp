...
namespace UMAA {
    namespace SEM {
        namespace BeaconParametersControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string BeaconParametersCommandAckReport_TOPIC = "UMAA::SEM::BeaconParametersControl::BeaconParametersCommandAckReport";
            ...
            class NDDSUSERDllExport BeaconParametersCommandAckReportType {
              public:
                ...
                void swap(BeaconParametersCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(BeaconParametersCommandAckReportType& a, BeaconParametersCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
