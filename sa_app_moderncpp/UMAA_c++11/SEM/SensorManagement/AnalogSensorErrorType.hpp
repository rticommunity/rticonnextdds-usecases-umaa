        ...
        namespace SensorManagement {
            ...
            class NDDSUSERDllExport AnalogSensorErrorType {
              public:
                ...
                AnalogSensorErrorType(const ::UMAA::Common::MaritimeEnumeration::AnalogSensorErrorCodeEnumType::AnalogSensorErrorCodeEnumType& errorCode_,const std::string& errorMessage_);

                ::UMAA::Common::MaritimeEnumeration::AnalogSensorErrorCodeEnumType::AnalogSensorErrorCodeEnumType& errorCode() noexcept {
                    return m_errorCode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::AnalogSensorErrorCodeEnumType::AnalogSensorErrorCodeEnumType& errorCode() const noexcept {
                    return m_errorCode_;
                }
                ...
                void swap(AnalogSensorErrorType& other_) noexcept ;
            ...
            inline void swap(AnalogSensorErrorType& a, AnalogSensorErrorType& b)  noexcept 
            {
                a.swap(b);
            }
