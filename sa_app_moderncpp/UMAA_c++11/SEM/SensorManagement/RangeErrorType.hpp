        ...
        namespace SensorManagement {
            ...
            class NDDSUSERDllExport RangeErrorType {
              public:
                ...
                RangeErrorType(const ::UMAA::Common::MaritimeEnumeration::RangeErrorCodeEnumType::RangeErrorCodeEnumType& errorCode_,const std::string& errorMessage_);

                ::UMAA::Common::MaritimeEnumeration::RangeErrorCodeEnumType::RangeErrorCodeEnumType& errorCode() noexcept {
                    return m_errorCode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::RangeErrorCodeEnumType::RangeErrorCodeEnumType& errorCode() const noexcept {
                    return m_errorCode_;
                }
                ...
                void swap(RangeErrorType& other_) noexcept ;
            ...
            inline void swap(RangeErrorType& a, RangeErrorType& b)  noexcept 
            {
                a.swap(b);
            }
