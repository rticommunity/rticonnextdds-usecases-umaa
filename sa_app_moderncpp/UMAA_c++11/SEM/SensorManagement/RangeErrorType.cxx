...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace SensorManagement {
            ...
            RangeErrorType::RangeErrorType (const ::UMAA::Common::MaritimeEnumeration::RangeErrorCodeEnumType::RangeErrorCodeEnumType& errorCode_,const std::string& errorMessage_):
                m_errorCode_(errorCode_), 
                m_errorMessage_(errorMessage_) {
            }

            void RangeErrorType::swap(RangeErrorType& other_)  noexcept 
            {
                using std::swap;
