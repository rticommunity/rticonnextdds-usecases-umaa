    ...
    namespace SEM {
        ...
        namespace DigitalVideoSpecs {
            ...
            DigitalVideoSpecsReportType::DigitalVideoSpecsReportType (double maxBitRate_,double maxFrameRate_,double minBitRate_,double minFrameRate_,bool supportedAVI_,bool supportedCGA_320x200_,bool supportedCIF_1408x1152_,bool supportedCIF_352x288_,bool supportedCIF_704x576_,bool supportedEGA_640x350_,bool supportedH262_,bool supportedH263_,bool supportedH263PLUS_,bool supportedH264_,bool supportedHD1080_1920x1080_,bool supportedHD480_852x480_,bool supportedHD720_1280x720_,bool supportedHSXGA_5120x4096_,bool supportedMJPEG_,bool supportedMPEG4_,bool supportedQCIF_176x144_,bool supportedQQVGA_160x120_,bool supportedQSXGA_2560x2048_,bool supportedQVGA_320x240_,bool supportedQXGA_2048x1536_,bool supportedSQCIF_128x96_,bool supportedSVGA_800x600_,bool supportedSXGA_1280x1024_,bool supportedUXGA_1600x1200_,bool supportedVGA_640x480_,bool supportedWHSXGA_6400x4096_,bool supportedWHUXGA_7680x4800_,bool supportedWOXGA_2560x1600_,bool supportedWQSXGA_3200x2048_,bool supportedWQUXGA_3840x2400_,bool supportedWSXGA_1600x1024_,bool supportedWUXGA_1920x1200_,bool supportedWVGA_852x480_,bool supportedWXGA_1366x768_,bool supportedXGA_1024x768_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                ...
                m_supportedH262_(supportedH262_), 
                m_supportedH263_(supportedH263_), 
                m_supportedH263PLUS_(supportedH263PLUS_), 
                m_supportedH264_(supportedH264_), 
                ...
                m_supportedMJPEG_(supportedMJPEG_), 
                m_supportedMPEG4_(supportedMPEG4_), 
            ...
            void DigitalVideoSpecsReportType::swap(DigitalVideoSpecsReportType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool DigitalVideoSpecsReportType::operator == (const DigitalVideoSpecsReportType& other_) const {
                if (std::fabs(m_maxBitRate_ - other_.m_maxBitRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_maxBitRate_ - other_.m_maxBitRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_maxFrameRate_ - other_.m_maxFrameRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_maxFrameRate_ - other_.m_maxFrameRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_minBitRate_ - other_.m_minBitRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_minBitRate_ - other_.m_minBitRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_minFrameRate_ - other_.m_minFrameRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_minFrameRate_ - other_.m_minFrameRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
