...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointEffortControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PanTiltJointEffortCommandStatus_TOPIC = "UMAA::SEM::PanTiltJointEffortControl::PanTiltJointEffortCommandStatus";
            ...
            class NDDSUSERDllExport PanTiltJointEffortCommandStatusType {
              public:
                ...
                void swap(PanTiltJointEffortCommandStatusType& other_) noexcept ;
            ...
            inline void swap(PanTiltJointEffortCommandStatusType& a, PanTiltJointEffortCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
