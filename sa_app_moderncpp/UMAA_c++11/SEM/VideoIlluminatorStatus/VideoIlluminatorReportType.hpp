...
namespace UMAA {
    namespace SEM {
        namespace VideoIlluminatorStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VideoIlluminatorReport_TOPIC = "UMAA::SEM::VideoIlluminatorStatus::VideoIlluminatorReport";
            ...
            class NDDSUSERDllExport VideoIlluminatorReportType {
              public:
                ...
                VideoIlluminatorReportType(double beamWidth_,int32_t level_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                void swap(VideoIlluminatorReportType& other_) noexcept ;
            ...
            inline void swap(VideoIlluminatorReportType& a, VideoIlluminatorReportType& b)  noexcept 
            {
                a.swap(b);
            }
