...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace CameraSelectionSpecs {
            ...
            CameraSelectionSpecsReportType::CameraSelectionSpecsReportType (const ::UMAA::Common::Measurement::NumericGUID& muxID_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& cameraID_):
                m_muxID_(muxID_), 
                m_source_(source_), 
            ...
            void CameraSelectionSpecsReportType::swap(CameraSelectionSpecsReportType& other_)  noexcept 
            {
                using std::swap;
