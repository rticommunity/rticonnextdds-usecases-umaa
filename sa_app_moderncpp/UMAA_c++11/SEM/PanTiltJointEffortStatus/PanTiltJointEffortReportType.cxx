...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace PanTiltJointEffortStatus {
            ...
            PanTiltJointEffortReportType::PanTiltJointEffortReportType (double panEffort_,double tiltEffort_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
            ...
            void PanTiltJointEffortReportType::swap(PanTiltJointEffortReportType& other_)  noexcept 
            {
                using std::swap;
