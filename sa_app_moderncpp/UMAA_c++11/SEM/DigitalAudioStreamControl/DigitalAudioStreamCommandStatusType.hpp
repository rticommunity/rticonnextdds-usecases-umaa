...
namespace UMAA {
    namespace SEM {
        namespace DigitalAudioStreamControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string DigitalAudioStreamCommandStatus_TOPIC = "UMAA::SEM::DigitalAudioStreamControl::DigitalAudioStreamCommandStatus";
            ...
            class NDDSUSERDllExport DigitalAudioStreamCommandStatusType {
              public:
                ...
                void swap(DigitalAudioStreamCommandStatusType& other_) noexcept ;
            ...
            inline void swap(DigitalAudioStreamCommandStatusType& a, DigitalAudioStreamCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
