...
namespace UMAA {
    namespace SEM {
        namespace DigitalAudioStreamControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string DigitalAudioStreamCommandAckReport_TOPIC = "UMAA::SEM::DigitalAudioStreamControl::DigitalAudioStreamCommandAckReport";
            ...
            class NDDSUSERDllExport DigitalAudioStreamCommandAckReportType {
              public:
                ...
                DigitalAudioStreamCommandAckReportType(bool repeat_,const std::string& url_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
                ...
                void swap(DigitalAudioStreamCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(DigitalAudioStreamCommandAckReportType& a, DigitalAudioStreamCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
