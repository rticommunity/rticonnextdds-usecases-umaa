...
namespace UMAA {
    ...
    namespace SEM {
        ...
        namespace DigitalAudioStreamControl {
            ...
            DigitalAudioStreamCommandType::DigitalAudioStreamCommandType (bool repeat_,const std::string& url_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_repeat_(repeat_), 
                m_url_(url_), 
                m_source_(source_), 
            ...
            void DigitalAudioStreamCommandType::swap(DigitalAudioStreamCommandType& other_)  noexcept 
            {
                using std::swap;
