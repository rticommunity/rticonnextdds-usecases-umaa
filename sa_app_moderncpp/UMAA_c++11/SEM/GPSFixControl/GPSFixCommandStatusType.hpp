...
namespace UMAA {
    namespace SEM {
        namespace GPSFixControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GPSFixCommandStatus_TOPIC = "UMAA::SEM::GPSFixControl::GPSFixCommandStatus";
            ...
            class NDDSUSERDllExport GPSFixCommandStatusType {
              public:
                ...
                void swap(GPSFixCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GPSFixCommandStatusType& a, GPSFixCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
