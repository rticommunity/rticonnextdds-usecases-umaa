...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointVelocityControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PanTiltJointVelocityCommandStatus_TOPIC = "UMAA::SEM::PanTiltJointVelocityControl::PanTiltJointVelocityCommandStatus";
            ...
            class NDDSUSERDllExport PanTiltJointVelocityCommandStatusType {
              public:
                ...
                void swap(PanTiltJointVelocityCommandStatusType& other_) noexcept ;
            ...
            inline void swap(PanTiltJointVelocityCommandStatusType& a, PanTiltJointVelocityCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
