...
namespace UMAA {
    namespace SEM {
        namespace PanTiltJointVelocityControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PanTiltJointVelocityCommandAckReport_TOPIC = "UMAA::SEM::PanTiltJointVelocityControl::PanTiltJointVelocityCommandAckReport";
            ...
            class NDDSUSERDllExport PanTiltJointVelocityCommandAckReportType {
              public:
                ...
                PanTiltJointVelocityCommandAckReportType(double panVelocity_,double tiltVelocity_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);
                ...
                void swap(PanTiltJointVelocityCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(PanTiltJointVelocityCommandAckReportType& a, PanTiltJointVelocityCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
