...
namespace UMAA {
    namespace SEM {
        namespace DigitalVideoControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string DigitalVideoCommandAckReport_TOPIC = "UMAA::SEM::DigitalVideoControl::DigitalVideoCommandAckReport";
            ...
            class NDDSUSERDllExport DigitalVideoCommandAckReportType {
              public:
                ...
                ::UMAA::Common::MaritimeEnumeration::StreamStateEnumType::StreamStateEnumType& state() noexcept {
                    return m_state_;
                }

                const ::UMAA::Common::MaritimeEnumeration::StreamStateEnumType::StreamStateEnumType& state() const noexcept {
                    return m_state_;
                }
                ...
                void swap(DigitalVideoCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(DigitalVideoCommandAckReportType& a, DigitalVideoCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
