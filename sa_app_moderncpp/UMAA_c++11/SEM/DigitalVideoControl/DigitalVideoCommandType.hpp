...
namespace UMAA {
    namespace SEM {
        namespace DigitalVideoControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string DigitalVideoCommand_TOPIC = "UMAA::SEM::DigitalVideoControl::DigitalVideoCommand";
            ...
            class NDDSUSERDllExport DigitalVideoCommandType {
              public:
                ...
                void swap(DigitalVideoCommandType& other_) noexcept ;
            ...
            inline void swap(DigitalVideoCommandType& a, DigitalVideoCommandType& b)  noexcept 
            {
                a.swap(b);
            }
