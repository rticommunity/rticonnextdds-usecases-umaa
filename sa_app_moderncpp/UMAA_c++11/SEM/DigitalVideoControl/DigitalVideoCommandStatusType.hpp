...
namespace UMAA {
    namespace SEM {
        namespace DigitalVideoControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string DigitalVideoCommandStatus_TOPIC = "UMAA::SEM::DigitalVideoControl::DigitalVideoCommandStatus";
            ...
            class NDDSUSERDllExport DigitalVideoCommandStatusType {
              public:
                ...
                void swap(DigitalVideoCommandStatusType& other_) noexcept ;
            ...
            inline void swap(DigitalVideoCommandStatusType& a, DigitalVideoCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
