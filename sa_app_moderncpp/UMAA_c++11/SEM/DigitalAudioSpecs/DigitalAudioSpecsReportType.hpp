...
namespace UMAA {
    namespace SEM {
        namespace DigitalAudioSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string DigitalAudioSpecsReport_TOPIC = "UMAA::SEM::DigitalAudioSpecs::DigitalAudioSpecsReport";
            ...
            class NDDSUSERDllExport DigitalAudioSpecsReportType {
              public:
                ...
                int32_t& maxChannels() noexcept {
                    return m_maxChannels_;
                }

                const int32_t& maxChannels() const noexcept {
                    return m_maxChannels_;
                }
                ...
                int32_t& maxSampleRate() noexcept {
                    return m_maxSampleRate_;
                }

                const int32_t& maxSampleRate() const noexcept {
                    return m_maxSampleRate_;
                }
                ...
                int32_t& minAllowedBitRate() noexcept {
                    return m_minAllowedBitRate_;
                }

                const int32_t& minAllowedBitRate() const noexcept {
                    return m_minAllowedBitRate_;
                }
                ...
                int32_t& minSampleRate() noexcept {
                    return m_minSampleRate_;
                }

                const int32_t& minSampleRate() const noexcept {
                    return m_minSampleRate_;
                }
                ...
                bool& supported10bits() noexcept {
                    return m_supported10bits_;
                }

                const bool& supported10bits() const noexcept {
                    return m_supported10bits_;
                }
                ...
                bool& supported12bits() noexcept {
                    return m_supported12bits_;
                }

                const bool& supported12bits() const noexcept {
                    return m_supported12bits_;
                }
                ...
                bool& supported14bits() noexcept {
                    return m_supported14bits_;
                }

                const bool& supported14bits() const noexcept {
                    return m_supported14bits_;
                }
                ...
                bool& supported16bits() noexcept {
                    return m_supported16bits_;
                }

                const bool& supported16bits() const noexcept {
                    return m_supported16bits_;
                }
                ...
                bool& supported20bits() noexcept {
                    return m_supported20bits_;
                }

                const bool& supported20bits() const noexcept {
                    return m_supported20bits_;
                }
                ...
                bool& supported24bits() noexcept {
                    return m_supported24bits_;
                }

                const bool& supported24bits() const noexcept {
                    return m_supported24bits_;
                }
                ...
                bool& supported32bits() noexcept {
                    return m_supported32bits_;
                }

                const bool& supported32bits() const noexcept {
                    return m_supported32bits_;
                }
                ...
                bool& supported40bits() noexcept {
                    return m_supported40bits_;
                }

                const bool& supported40bits() const noexcept {
                    return m_supported40bits_;
                }
                ...
                bool& supported48bits() noexcept {
                    return m_supported48bits_;
                }

                const bool& supported48bits() const noexcept {
                    return m_supported48bits_;
                }
                ...
                bool& supported56bits() noexcept {
                    return m_supported56bits_;
                }

                const bool& supported56bits() const noexcept {
                    return m_supported56bits_;
                }
                ...
                bool& supported64bits() noexcept {
                    return m_supported64bits_;
                }

                const bool& supported64bits() const noexcept {
                    return m_supported64bits_;
                }
                ...
                bool& supported8bits() noexcept {
                    return m_supported8bits_;
                }

                const bool& supported8bits() const noexcept {
                    return m_supported8bits_;
                }
                ...
                bool& supportedAAC_MPEG2() noexcept {
                    return m_supportedAAC_MPEG2_;
                }

                const bool& supportedAAC_MPEG2() const noexcept {
                    return m_supportedAAC_MPEG2_;
                }
                ...
                bool& supportedAAC_MPEG4() noexcept {
                    return m_supportedAAC_MPEG4_;
                }

                const bool& supportedAAC_MPEG4() const noexcept {
                    return m_supportedAAC_MPEG4_;
                }
                ...
                bool& supportedAIFF() noexcept {
                    return m_supportedAIFF_;
                }

                const bool& supportedAIFF() const noexcept {
                    return m_supportedAIFF_;
                }
                ...
                bool& supportedALAC() noexcept {
                    return m_supportedALAC_;
                }

                const bool& supportedALAC() const noexcept {
                    return m_supportedALAC_;
                }
                ...
                bool& supportedAverage() noexcept {
                    return m_supportedAverage_;
                }

                const bool& supportedAverage() const noexcept {
                    return m_supportedAverage_;
                }
                ...
                bool& supportedBest() noexcept {
                    return m_supportedBest_;
                }

                const bool& supportedBest() const noexcept {
                    return m_supportedBest_;
                }
                ...
                bool& supportedBetter() noexcept {
                    return m_supportedBetter_;
                }

                const bool& supportedBetter() const noexcept {
                    return m_supportedBetter_;
                }
                ...
                bool& supportedDolbyDigital() noexcept {
                    return m_supportedDolbyDigital_;
                }

                const bool& supportedDolbyDigital() const noexcept {
                    return m_supportedDolbyDigital_;
                }
                ...
                bool& supportedDTS() noexcept {
                    return m_supportedDTS_;
                }

                const bool& supportedDTS() const noexcept {
                    return m_supportedDTS_;
                }
                ...
                bool& supportedFLAC() noexcept {
                    return m_supportedFLAC_;
                }

                const bool& supportedFLAC() const noexcept {
                    return m_supportedFLAC_;
                }
                ...
                bool& supportedGood() noexcept {
                    return m_supportedGood_;
                }

                const bool& supportedGood() const noexcept {
                    return m_supportedGood_;
                }
                ...
                bool& supportedLess() noexcept {
                    return m_supportedLess_;
                }

                const bool& supportedLess() const noexcept {
                    return m_supportedLess_;
                }
                ...
                bool& supportedLPCM_PCM() noexcept {
                    return m_supportedLPCM_PCM_;
                }

                const bool& supportedLPCM_PCM() const noexcept {
                    return m_supportedLPCM_PCM_;
                }
                ...
                bool& supportedMP2() noexcept {
                    return m_supportedMP2_;
                }

                const bool& supportedMP2() const noexcept {
                    return m_supportedMP2_;
                }
                ...
                bool& supportedMP3() noexcept {
                    return m_supportedMP3_;
                }

                const bool& supportedMP3() const noexcept {
                    return m_supportedMP3_;
                }
                ...
                bool& supportedPoor() noexcept {
                    return m_supportedPoor_;
                }

                const bool& supportedPoor() const noexcept {
                    return m_supportedPoor_;
                }
                ...
                bool& supportedRealAudio() noexcept {
                    return m_supportedRealAudio_;
                }

                const bool& supportedRealAudio() const noexcept {
                    return m_supportedRealAudio_;
                }
                ...
                bool& supportedSpeex() noexcept {
                    return m_supportedSpeex_;
                }

                const bool& supportedSpeex() const noexcept {
                    return m_supportedSpeex_;
                }
                ...
                bool& supportedTrueAudio() noexcept {
                    return m_supportedTrueAudio_;
                }

                const bool& supportedTrueAudio() const noexcept {
                    return m_supportedTrueAudio_;
                }
                ...
                bool& supportedULAW() noexcept {
                    return m_supportedULAW_;
                }

                const bool& supportedULAW() const noexcept {
                    return m_supportedULAW_;
                }
                ...
                bool& supportedVORBIS() noexcept {
                    return m_supportedVORBIS_;
                }

                const bool& supportedVORBIS() const noexcept {
                    return m_supportedVORBIS_;
                }
                ...
                bool& supportedWAV() noexcept {
                    return m_supportedWAV_;
                }

                const bool& supportedWAV() const noexcept {
                    return m_supportedWAV_;
                }
                ...
                bool& supportedWMA() noexcept {
                    return m_supportedWMA_;
                }

                const bool& supportedWMA() const noexcept {
                    return m_supportedWMA_;
                }
                ...
                bool& supportedWMA9_Lossless() noexcept {
                    return m_supportedWMA9_Lossless_;
                }

                const bool& supportedWMA9_Lossless() const noexcept {
                    return m_supportedWMA9_Lossless_;
                }
                ...
                bool& supportedWorst() noexcept {
                    return m_supportedWorst_;
                }

                const bool& supportedWorst() const noexcept {
                    return m_supportedWorst_;
                }
                ...
                void swap(DigitalAudioSpecsReportType& other_) noexcept ;
            ...
            inline void swap(DigitalAudioSpecsReportType& a, DigitalAudioSpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
