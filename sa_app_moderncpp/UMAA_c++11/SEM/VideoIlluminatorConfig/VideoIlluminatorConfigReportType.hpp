...
namespace UMAA {
    namespace SEM {
        namespace VideoIlluminatorConfig {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VideoIlluminatorConfigReport_TOPIC = "UMAA::SEM::VideoIlluminatorConfig::VideoIlluminatorConfigReport";
            ...
            class NDDSUSERDllExport VideoIlluminatorConfigReportType {
              public:
                ...
                VideoIlluminatorConfigReportType(const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& associatedSensorIDs_,const ::UMAA::Common::MaritimeEnumeration::ImagingModeEnumType::ImagingModeEnumType& mode_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& associatedSensorIDs() noexcept {
                    return m_associatedSensorIDs_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& associatedSensorIDs() const noexcept {
                    return m_associatedSensorIDs_;
                }
                ...
                ::UMAA::Common::MaritimeEnumeration::ImagingModeEnumType::ImagingModeEnumType& mode() noexcept {
                    return m_mode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::ImagingModeEnumType::ImagingModeEnumType& mode() const noexcept {
                    return m_mode_;
                }
                ...
                void swap(VideoIlluminatorConfigReportType& other_) noexcept ;
            ...
            inline void swap(VideoIlluminatorConfigReportType& a, VideoIlluminatorConfigReportType& b)  noexcept 
            {
                a.swap(b);
            }
