    ...
    namespace SEM {
        ...
        namespace GPSStatus {
            ...
            GPSClockType::GPSClockType (const ::dds::core::optional< int32_t >& bias_,const ::dds::core::optional< int32_t >& biasUncertianty_,const ::dds::core::optional< int32_t >& drift_,const ::dds::core::optional< int32_t >& driftUncertainty_,const ::dds::core::optional< int32_t >& elapsedRealtime_,const ::dds::core::optional< int32_t >& elapsedRealtimeUncertainty_,const ::dds::core::optional< int32_t >& fullBias_,const ::dds::core::optional< int32_t >& hardwareClockDiscontinuityCount_,const ::dds::core::optional< int32_t >& leapSecond_,const ::dds::core::optional< double >& referenceCarrierFrequency_,const ::dds::core::optional< std::string >& referenceCodeTypeFor_,const ::dds::core::optional< ::UMAA::Common::MaritimeEnumeration::GPSConstellationEnumType::GPSConstellationEnumType >& referenceConstellationType_,const ::dds::core::optional< int32_t >& time_,const ::dds::core::optional< double >& timeUncertainty_):
                ...
                m_time_(time_), 
                m_timeUncertainty_(timeUncertainty_) {
            }
            ...
            bool GPSClockType::operator == (const GPSClockType& other_) const {
                ...
                if (m_referenceCarrierFrequency_.has_value() != other_.m_referenceCarrierFrequency_.has_value()) {
                    return false;
                } else if (m_referenceCarrierFrequency_.has_value()) {
                ...
                if (m_timeUncertainty_.has_value() != other_.m_timeUncertainty_.has_value()) {
                    return false;
                } else if (m_timeUncertainty_.has_value()) {
                    if (std::fabs(*m_timeUncertainty_ - *other_.m_timeUncertainty_) > std::numeric_limits< double>::epsilon()
                    && !(std::fabs(*m_timeUncertainty_ - *other_.m_timeUncertainty_) < (std::numeric_limits< double>::min)())) {
                        return false;
                    }
                }
                return true;
