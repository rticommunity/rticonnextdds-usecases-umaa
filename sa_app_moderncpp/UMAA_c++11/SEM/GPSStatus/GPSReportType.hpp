...
namespace UMAA {
    namespace SEM {
        namespace GPSStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GPSReport_TOPIC = "UMAA::SEM::GPSStatus::GPSReport";
            ...
            class NDDSUSERDllExport GPSReportType {
              public:
                ...
                GPSReportType(const ::UMAA::SEM::GPSStatus::GPSClockType& clock_,int32_t numberSatellitesInView_,const ::rti::core::bounded_sequence< ::UMAA::SEM::GPSStatus::GPSSatelliteType, 100L >& satellites_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
                ...
                ::rti::core::bounded_sequence< ::UMAA::SEM::GPSStatus::GPSSatelliteType, 100L >& satellites() noexcept {
                    return m_satellites_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::SEM::GPSStatus::GPSSatelliteType, 100L >& satellites() const noexcept {
                    return m_satellites_;
                }
