        ...
        namespace BaseType {
            namespace ZoneType_Specializations {
                ...
                class NDDSUSERDllExport ZoneType_Union {
                  public:
                    ...
                    void _d(::UMAA::MM::BaseType::ZoneType_Specializations::ZoneType_Selectors value) {
                    ...
                    void swap(ZoneType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::MM::BaseType::PlanningZoneType& PlanningZoneType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(ZoneType_Union& a, ZoneType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport ZoneType {
              public:
                ...
                ZoneType(const ::UMAA::Common::Measurement::Polygon_Volume& zone_,const ::UMAA::Common::MaritimeEnumeration::ZoneKindEnumType::ZoneKindEnumType& zoneKind_,const ::UMAA::MM::BaseType::ZoneType_Specializations::ZoneType_Union& ZoneType_subtypes_,const ::UMAA::Common::Measurement::NumericGUID& zoneID_);
                ...
                ::UMAA::MM::BaseType::ZoneType_Specializations::ZoneType_Union& ZoneType_subtypes() noexcept {
                    return m_ZoneType_subtypes_;
                }

                const ::UMAA::MM::BaseType::ZoneType_Specializations::ZoneType_Union& ZoneType_subtypes() const noexcept {
                    return m_ZoneType_subtypes_;
                }
                ...
                void swap(ZoneType& other_) noexcept ;
            ...
            inline void swap(ZoneType& a, ZoneType& b)  noexcept 
            {
                a.swap(b);
            }
