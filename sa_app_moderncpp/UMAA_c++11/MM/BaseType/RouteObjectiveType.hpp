        ...
        namespace BaseType {
            ...
            class NDDSUSERDllExport RouteObjectiveType {
              public:
                ...
                RouteObjectiveType(const ::UMAA::Common::MaritimeEnumeration::HeightModeEnumType::HeightModeEnumType& mode_,const std::string& routeDescription_,const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::WaypointType, 100L >& waypoints_);

                ::UMAA::Common::MaritimeEnumeration::HeightModeEnumType::HeightModeEnumType& mode() noexcept {
                    return m_mode_;
                }

                const ::UMAA::Common::MaritimeEnumeration::HeightModeEnumType::HeightModeEnumType& mode() const noexcept {
                    return m_mode_;
                }
                ...
                ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::WaypointType, 100L >& waypoints() noexcept {
                    return m_waypoints_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::WaypointType, 100L >& waypoints() const noexcept {
                    return m_waypoints_;
                }
