...
data type ZoneType from ZoneType.idl.
This example builds two applications, named ZoneType_publisher and
ZoneType_subscriber.
...
> make -f makefile_ZoneType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ZoneType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the ZoneType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/ZoneType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/ZoneType_subscriber -d <domain_id> -s <sample_count>
