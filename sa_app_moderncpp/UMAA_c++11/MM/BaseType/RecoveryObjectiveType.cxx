...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            RecoveryObjectiveType::RecoveryObjectiveType (const ::UMAA::Common::Measurement::Altitude_MSL& altitude_,const ::UMAA::Common::Measurement::Altitude_AGL& altitudeAGL_,double altitudeASF_,const ::UMAA::Common::Measurement::Position2D& position_):
