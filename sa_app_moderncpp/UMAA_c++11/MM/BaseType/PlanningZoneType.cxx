...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            PlanningZoneType::PlanningZoneType (const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& endTime_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& startTime_,const ::UMAA::Common::Measurement::Polygon_Volume& zone_,const ::UMAA::Common::MaritimeEnumeration::ZoneKindEnumType::ZoneKindEnumType& zoneKind_,const std::string& zoneName_,const ::UMAA::Common::Measurement::NumericGUID& zoneID_):
                m_endTime_(endTime_), 
                m_startTime_(startTime_), 
                m_zone_(zone_), 
                m_zoneKind_(zoneKind_), 
                m_zoneName_(zoneName_), 
                m_zoneID_(zoneID_) {
            }

            void PlanningZoneType::swap(PlanningZoneType& other_)  noexcept 
            {
                using std::swap;
