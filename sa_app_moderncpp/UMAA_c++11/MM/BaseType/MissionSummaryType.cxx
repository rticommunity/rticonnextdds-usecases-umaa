...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            MissionSummaryType::MissionSummaryType (const std::string& missionDescription_,const std::string& missionName_,const ::UMAA::Common::Measurement::DateTime& startTime_,const ::UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& missionID_):
                m_missionDescription_(missionDescription_), 
                m_missionName_(missionName_), 
                m_startTime_(startTime_), 
                m_state_(state_), 
                m_missionID_(missionID_) {
            }

            void MissionSummaryType::swap(MissionSummaryType& other_)  noexcept 
            {
                using std::swap;
