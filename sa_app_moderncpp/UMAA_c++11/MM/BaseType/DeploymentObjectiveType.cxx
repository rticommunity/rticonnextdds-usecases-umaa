...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            DeploymentObjectiveType::DeploymentObjectiveType (const ::UMAA::Common::Measurement::Altitude_MSL& altitude_,const ::UMAA::Common::Measurement::Altitude_AGL& altitudeAGL_,double altitudeASF_,double heading_,const ::UMAA::Common::Measurement::Position2D& position_,double releaseDepth_,double speed_):
                m_altitude_(altitude_), 
                m_altitudeAGL_(altitudeAGL_), 
                m_altitudeASF_(altitudeASF_), 
                m_heading_(heading_), 
                m_position_(position_), 
                m_releaseDepth_(releaseDepth_), 
                m_speed_(speed_) {
            }
            ...
            bool DeploymentObjectiveType::operator == (const DeploymentObjectiveType& other_) const {
                ...
                if (std::fabs(m_releaseDepth_ - other_.m_releaseDepth_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_releaseDepth_ - other_.m_releaseDepth_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
