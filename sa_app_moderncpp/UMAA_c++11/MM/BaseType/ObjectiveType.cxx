    ...
    namespace MM {
        ...
        namespace BaseType {
            ...
            namespace ObjectiveType_Specializations {
                ...
                ObjectiveType_Union::Union_::Union_(const ::UMAA::MM::BaseType::ProductDisseminateFileObjectiveType& ProductDisseminateFileObjectiveType_data_,const ::UMAA::MM::BaseType::RecoveryObjectiveType& RecoveryObjectiveType_data_,const ::UMAA::MM::BaseType::ProductExploitationObjectiveType& ProductExploitationObjectiveType_data_,const ::UMAA::MM::BaseType::CommsLinkObjectiveType& CommsLinkObjectiveType_data_,const ::UMAA::MM::BaseType::DeploymentObjectiveType& DeploymentObjectiveType_data_,const ::UMAA::MM::BaseType::PassiveLoiterObjectiveType& PassiveLoiterObjectiveType_data_,const ::UMAA::MM::BaseType::StationkeepObjectiveType& StationkeepObjectiveType_data_,const ::UMAA::MM::BaseType::RouteObjectiveType& RouteObjectiveType_data_,const ::UMAA::MM::BaseType::ChargingObjectiveType& ChargingObjectiveType_data_,const ::UMAA::MM::BaseType::LoiterObjectiveType& LoiterObjectiveType_data_,const ::UMAA::MM::BaseType::ContingencyObjectiveType& ContingencyObjectiveType_data_):
                    m_ProductDisseminateFileObjectiveType_data_(ProductDisseminateFileObjectiveType_data_), 
                    m_RecoveryObjectiveType_data_(RecoveryObjectiveType_data_), 
                    m_ProductExploitationObjectiveType_data_(ProductExploitationObjectiveType_data_), 
                    m_CommsLinkObjectiveType_data_(CommsLinkObjectiveType_data_), 
                    m_DeploymentObjectiveType_data_(DeploymentObjectiveType_data_), 
                    m_PassiveLoiterObjectiveType_data_(PassiveLoiterObjectiveType_data_), 
                    m_StationkeepObjectiveType_data_(StationkeepObjectiveType_data_), 
                    m_RouteObjectiveType_data_(RouteObjectiveType_data_), 
                    m_ChargingObjectiveType_data_(ChargingObjectiveType_data_), 
                    m_LoiterObjectiveType_data_(LoiterObjectiveType_data_), 
                    m_ContingencyObjectiveType_data_(ContingencyObjectiveType_data_) {
                }
                ...
                void ObjectiveType_Union::swap(ObjectiveType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const ObjectiveType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::MM::BaseType::ObjectiveType_Specializations::ObjectiveType_Selectors::CONTINGENCYOBJECTIVETYPE_SELECT):
                            {  
                                o << "ContingencyObjectiveType_data: " << sample.ContingencyObjectiveType_data ();
                        } break ;
                        default:
                        {
                            /*
