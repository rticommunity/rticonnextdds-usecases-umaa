...
namespace UMAA {
    namespace MM {
        namespace ObjectiveExecutionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ObjectiveExecutionCommand_TOPIC = "UMAA::MM::ObjectiveExecutionControl::ObjectiveExecutionCommand";
            ...
            class NDDSUSERDllExport ObjectiveExecutionCommandType {
              public:
                ...
                ObjectiveExecutionCommandType(const ::UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& missionID_,const ::UMAA::Common::Measurement::NumericGUID& objectiveID_,const ::UMAA::Common::Measurement::NumericGUID& taskID_);
