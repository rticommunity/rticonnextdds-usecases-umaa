...
namespace UMAA {
    namespace MM {
        namespace ObjectiveExecutionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ObjectiveExecutionCommandStatus_TOPIC = "UMAA::MM::ObjectiveExecutionControl::ObjectiveExecutionCommandStatus";
            ...
            class NDDSUSERDllExport ObjectiveExecutionCommandStatusType {
              public:
                ...
                void swap(ObjectiveExecutionCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ObjectiveExecutionCommandStatusType& a, ObjectiveExecutionCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
