...
namespace UMAA {
    namespace MM {
        namespace MissionPlanCatalogControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MissionPlanCatalogCommandAckReport_TOPIC = "UMAA::MM::MissionPlanCatalogControl::MissionPlanCatalogCommandAckReport";
            ...
            class NDDSUSERDllExport MissionPlanCatalogCommandAckReportType {
              public:
                ...
                void swap(MissionPlanCatalogCommandAckReportType& other_) noexcept ;
            ...
            inline void swap(MissionPlanCatalogCommandAckReportType& a, MissionPlanCatalogCommandAckReportType& b)  noexcept 
            {
                a.swap(b);
            }
