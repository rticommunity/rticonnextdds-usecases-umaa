...
namespace UMAA {
    namespace MM {
        namespace MissionPlanCatalogControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MissionPlanCatalogCommandStatus_TOPIC = "UMAA::MM::MissionPlanCatalogControl::MissionPlanCatalogCommandStatus";
            ...
            class NDDSUSERDllExport MissionPlanCatalogCommandStatusType {
              public:
                ...
                void swap(MissionPlanCatalogCommandStatusType& other_) noexcept ;
            ...
            inline void swap(MissionPlanCatalogCommandStatusType& a, MissionPlanCatalogCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
