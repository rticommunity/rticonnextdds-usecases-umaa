        ...
        namespace MissionPlanAssignmentStatus {
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                try {
                    ...
                    epd = PRESTypePluginDefaultEndpointData_new(
                        ...
                        ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
                        ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePluginSupport_destroy_key);

                    if (epd == NULL) {
                        return NULL;
                    } 

                    serializedKeyMaxSize =  ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_get_serialized_key_max_size(
                    ...
                    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                        serializedSampleMaxSize = ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_get_serialized_sample_max_size(
                            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
                        ...
                        if (PRESTypePluginDefaultEndpointData_createWriterPool(
                            ...
                            ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_get_serialized_sample_max_size, epd,
            ...
            MissionPlanAssignmentReportTypePlugin_copy_sample(
                ...
                const MissionPlanAssignmentReportType *src)
            {
                return ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                unsigned int length)
            {
                ...
                epd.programContext.endpointPluginData = &epd;
                plugin.typeCode = (struct RTICdrTypeCode *)
                (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< MissionPlanAssignmentReportType >::get().native()
                ;
                pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
                MissionPlanAssignmentReportType, 
                true, true, true>();
            ...
            * ------------------------------------------------------------------------ */
            ...
            { 
                ...
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_copy_sample;
                ...
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_get_serialized_sample_max_size;
                ...
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_get_key_kind;

                plugin->getSerializedKeyMaxSizeFnc =   
                (PRESTypePluginGetSerializedKeyMaxSizeFunction)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_get_serialized_key_max_size;
                plugin->serializeKeyFnc =
                (PRESTypePluginSerializeKeyFunction)
                PRESTypePlugin_interpretedSerializeKey;
                plugin->deserializeKeyFnc =
                (PRESTypePluginDeserializeKeyFunction)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_deserialize_key;
                ...
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_serialized_sample_to_keyhash;
                ...
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_instance_to_key;
                plugin->keyToInstanceFnc =
                (PRESTypePluginKeyToInstanceFunction)
                ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportTypePlugin_key_to_instance;
                plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
                #ifdef NDDS_STANDALONE_TYPE
                plugin->typeCode = NULL; 
                #else
                plugin->typeCode = (struct RTICdrTypeCode *) 
                &::rti::topic::dynamic_type< ::UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportType >::get().native();
                #endif
                ...
                static const char * TYPE_NAME = "UMAA::MM::MissionPlanAssignmentStatus::MissionPlanAssignmentReportType";
