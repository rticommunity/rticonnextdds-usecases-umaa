...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ControlSystemID {
            ...
            ControlSystemIDCommandReportType::ControlSystemIDCommandReportType (const std::string& name_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_name_(name_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void ControlSystemIDCommandReportType::swap(ControlSystemIDCommandReportType& other_)  noexcept 
            {
                using std::swap;
