...
namespace UMAA {
    namespace MM {
        namespace ControlSystemID {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ControlSystemIDCommandStatus_TOPIC = "UMAA::MM::ControlSystemID::ControlSystemIDCommandStatus";
