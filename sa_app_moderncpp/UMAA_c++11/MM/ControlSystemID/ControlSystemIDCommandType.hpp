...
namespace UMAA {
    namespace MM {
        namespace ControlSystemID {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ControlSystemIDCommand_TOPIC = "UMAA::MM::ControlSystemID::ControlSystemIDCommand";
            ...
            class NDDSUSERDllExport ControlSystemIDCommandType {
              public:
                ...
                ControlSystemIDCommandType(const std::string& name_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
