...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ControlSystemID {
            ...
            ControlSystemIDReportType::ControlSystemIDReportType (const std::string& name_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_name_(name_), 
                m_source_(source_), 
