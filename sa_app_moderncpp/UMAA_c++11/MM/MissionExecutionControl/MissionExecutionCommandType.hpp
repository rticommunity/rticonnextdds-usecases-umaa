...
namespace UMAA {
    namespace MM {
        namespace MissionExecutionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MissionExecutionCommand_TOPIC = "UMAA::MM::MissionExecutionControl::MissionExecutionCommand";
            ...
            class NDDSUSERDllExport MissionExecutionCommandType {
              public:
                ...
                MissionExecutionCommandType(const ::UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::NumericGUID& destination_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& missionID_);
                ...
                void swap(MissionExecutionCommandType& other_) noexcept ;
            ...
            inline void swap(MissionExecutionCommandType& a, MissionExecutionCommandType& b)  noexcept 
            {
                a.swap(b);
            }
