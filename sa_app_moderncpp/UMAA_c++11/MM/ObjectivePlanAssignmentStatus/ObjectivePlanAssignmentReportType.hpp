...
namespace UMAA {
    namespace MM {
        namespace ObjectivePlanAssignmentStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ObjectivePlanAssignmentReport_TOPIC = "UMAA::MM::ObjectivePlanAssignmentStatus::ObjectivePlanAssignmentReport";
            ...
            class NDDSUSERDllExport ObjectivePlanAssignmentReportType {
              public:
                ...
                ObjectivePlanAssignmentReportType(const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& resourceIDs_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& objectiveID_,const ::UMAA::Common::Measurement::NumericGUID& taskID_);
                ...
                void swap(ObjectivePlanAssignmentReportType& other_) noexcept ;
            ...
            inline void swap(ObjectivePlanAssignmentReportType& a, ObjectivePlanAssignmentReportType& b)  noexcept 
            {
                a.swap(b);
            }
