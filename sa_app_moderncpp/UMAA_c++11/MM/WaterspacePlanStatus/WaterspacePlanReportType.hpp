...
namespace UMAA {
    namespace MM {
        namespace WaterspacePlanStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string WaterspacePlanReport_TOPIC = "UMAA::MM::WaterspacePlanStatus::WaterspacePlanReport";
            ...
            class NDDSUSERDllExport WaterspacePlanReportType {
              public:
                ...
                WaterspacePlanReportType(const std::string& waterspacePlanName_,const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::PlanningZoneType, 100L >& zones_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& waterspacePlanID_);

                std::string& waterspacePlanName() noexcept {
                    return m_waterspacePlanName_;
                }

                const std::string& waterspacePlanName() const noexcept {
                    return m_waterspacePlanName_;
                }
                ...
                ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::PlanningZoneType, 100L >& zones() noexcept {
                    return m_zones_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::PlanningZoneType, 100L >& zones() const noexcept {
                    return m_zones_;
                }
                ...
                void swap(WaterspacePlanReportType& other_) noexcept ;
            ...
            inline void swap(WaterspacePlanReportType& a, WaterspacePlanReportType& b)  noexcept 
            {
                a.swap(b);
            }
