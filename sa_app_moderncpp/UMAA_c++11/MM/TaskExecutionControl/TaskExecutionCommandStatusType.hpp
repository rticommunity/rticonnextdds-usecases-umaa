...
namespace UMAA {
    namespace MM {
        namespace TaskExecutionControl {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string TaskExecutionCommandStatus_TOPIC = "UMAA::MM::TaskExecutionControl::TaskExecutionCommandStatus";
            ...
            class NDDSUSERDllExport TaskExecutionCommandStatusType {
              public:
                ...
                void swap(TaskExecutionCommandStatusType& other_) noexcept ;
            ...
            inline void swap(TaskExecutionCommandStatusType& a, TaskExecutionCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
