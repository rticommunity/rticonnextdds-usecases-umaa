...
namespace UMAA {
    namespace MM {
        namespace ControlTransfer {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ClientControlTransferReport_TOPIC = "UMAA::MM::ControlTransfer::ClientControlTransferReport";
            ...
            class NDDSUSERDllExport ClientControlTransferReportType {
              public:
                ...
                ClientControlTransferReportType(int32_t authorityLevel_,const ::UMAA::Common::MaritimeEnumeration::HandoverResultEnumType::HandoverResultEnumType& result_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
