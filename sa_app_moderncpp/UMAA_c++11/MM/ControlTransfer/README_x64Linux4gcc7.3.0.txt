...
data type ControlSystemTransferReportType from ControlSystemTransferReportType.idl.
This example builds two applications, named ControlSystemTransferReportType_publisher and
ControlSystemTransferReportType_subscriber.
...
> make -f makefile_ControlSystemTransferReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ControlSystemTransferReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the ControlSystemTransferReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/ControlSystemTransferReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/ControlSystemTransferReportType_subscriber -d <domain_id> -s <sample_count>
