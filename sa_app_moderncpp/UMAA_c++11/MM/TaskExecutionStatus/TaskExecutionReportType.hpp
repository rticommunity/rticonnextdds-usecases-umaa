...
namespace UMAA {
    namespace MM {
        namespace TaskExecutionStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string TaskExecutionReport_TOPIC = "UMAA::MM::TaskExecutionStatus::TaskExecutionReport";
            ...
            class NDDSUSERDllExport TaskExecutionReportType {
              public:
                ...
                TaskExecutionReportType(const ::rti::core::bounded_sequence< ::UMAA::MM::TaskExecutionStatus::TaskStatusType, 100L >& taskStatuses_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< ::UMAA::MM::TaskExecutionStatus::TaskStatusType, 100L >& taskStatuses() noexcept {
                    return m_taskStatuses_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::MM::TaskExecutionStatus::TaskStatusType, 100L >& taskStatuses() const noexcept {
                    return m_taskStatuses_;
                }
                ...
                void swap(TaskExecutionReportType& other_) noexcept ;
            ...
            inline void swap(TaskExecutionReportType& a, TaskExecutionReportType& b)  noexcept 
            {
                a.swap(b);
            }
