...
#ifndef TaskStatusType_1082708537_hpp
#define TaskStatusType_1082708537_hpp
...
namespace UMAA {
    namespace MM {
        namespace TaskExecutionStatus {
            ...
            class NDDSUSERDllExport TaskStatusType {
              public:

                TaskStatusType();

                TaskStatusType(const ::UMAA::Common::Measurement::DateTime& endTime_,const ::UMAA::Common::Measurement::DateTime& startTime_,const ::UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& missionID_,const ::UMAA::Common::Measurement::NumericGUID& taskID_);
                ...
                bool operator == (const TaskStatusType& other_) const;
                bool operator != (const TaskStatusType& other_) const;

                void swap(TaskStatusType& other_) noexcept ;
            ...
            inline void swap(TaskStatusType& a, TaskStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const TaskStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::TaskExecutionStatus::TaskStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::TaskExecutionStatus::TaskStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::TaskExecutionStatus::TaskStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::TaskExecutionStatus::TaskStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::TaskExecutionStatus::TaskStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::TaskExecutionStatus::TaskStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::TaskExecutionStatus::TaskStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::TaskExecutionStatus::TaskStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::TaskExecutionStatus::TaskStatusType > {
...
#endif // TaskStatusType_1082708537_hpp
