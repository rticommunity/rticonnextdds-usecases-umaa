...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace TaskExecutionStatus {
            ...
            TaskExecutionReportType::TaskExecutionReportType (const ::rti::core::bounded_sequence< ::UMAA::MM::TaskExecutionStatus::TaskStatusType, 100L >& taskStatuses_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_taskStatuses_(taskStatuses_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void TaskExecutionReportType::swap(TaskExecutionReportType& other_)  noexcept 
            {
                using std::swap;
