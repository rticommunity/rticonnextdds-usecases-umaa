...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace TaskExecutionStatus {
            ...
            TaskStatusType::TaskStatusType (const ::UMAA::Common::Measurement::DateTime& endTime_,const ::UMAA::Common::Measurement::DateTime& startTime_,const ::UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& missionID_,const ::UMAA::Common::Measurement::NumericGUID& taskID_):
                m_endTime_(endTime_), 
            ...
            void TaskStatusType::swap(TaskStatusType& other_)  noexcept 
            {
                using std::swap;
