...
namespace UMAA {
    namespace MM {
        namespace MissionExecutionStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MissionExecutionReport_TOPIC = "UMAA::MM::MissionExecutionStatus::MissionExecutionReport";
            ...
            class NDDSUSERDllExport MissionExecutionReportType {
              public:
                ...
                MissionExecutionReportType(const ::rti::core::bounded_sequence< ::UMAA::MM::MissionExecutionStatus::MissionStatusType, 100L >& missionStatuses_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< ::UMAA::MM::MissionExecutionStatus::MissionStatusType, 100L >& missionStatuses() noexcept {
                    return m_missionStatuses_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::MM::MissionExecutionStatus::MissionStatusType, 100L >& missionStatuses() const noexcept {
                    return m_missionStatuses_;
                }
                ...
                void swap(MissionExecutionReportType& other_) noexcept ;
            ...
            inline void swap(MissionExecutionReportType& a, MissionExecutionReportType& b)  noexcept 
            {
                a.swap(b);
            }
