        ...
        namespace MissionExecutionStatus {
            ...
            class NDDSUSERDllExport MissionStatusType {
              public:
                ...
                MissionStatusType(const ::UMAA::Common::Measurement::DateTime& endTime_,const std::string& feedback_,const ::UMAA::Common::Measurement::DateTime& startTime_,const ::UMAA::Common::MaritimeEnumeration::TaskStateEnumType::TaskStateEnumType& state_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& missionID_);
                ...
                void swap(MissionStatusType& other_) noexcept ;
            ...
            inline void swap(MissionStatusType& a, MissionStatusType& b)  noexcept 
            {
                a.swap(b);
            }
