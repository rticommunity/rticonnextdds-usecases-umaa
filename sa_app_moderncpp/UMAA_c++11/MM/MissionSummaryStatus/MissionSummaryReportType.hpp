...
namespace UMAA {
    namespace MM {
        namespace MissionSummaryStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string MissionSummaryReport_TOPIC = "UMAA::MM::MissionSummaryStatus::MissionSummaryReport";
            ...
            class NDDSUSERDllExport MissionSummaryReportType {
              public:
                ...
                MissionSummaryReportType(const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::MissionSummaryType, 100L >& missionSummaries_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::MissionSummaryType, 100L >& missionSummaries() noexcept {
                    return m_missionSummaries_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::MissionSummaryType, 100L >& missionSummaries() const noexcept {
                    return m_missionSummaries_;
                }
                ...
                void swap(MissionSummaryReportType& other_) noexcept ;
            ...
            inline void swap(MissionSummaryReportType& a, MissionSummaryReportType& b)  noexcept 
            {
                a.swap(b);
            }
