...
namespace UMAA {
    namespace MM {
        namespace TaskPlanAssignmentStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string TaskPlanAssignmentReport_TOPIC = "UMAA::MM::TaskPlanAssignmentStatus::TaskPlanAssignmentReport";
            ...
            class NDDSUSERDllExport TaskPlanAssignmentReportType {
              public:
                ...
                TaskPlanAssignmentReportType(const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& resourceIDs_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& taskID_);
