...
namespace UMAA {
    namespace MM {
        namespace CommsLostPolicy {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CommsLostPolicyCommandReport_TOPIC = "UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandReport";
            ...
            class NDDSUSERDllExport CommsLostPolicyCommandReportType {
              public:
                ...
                void swap(CommsLostPolicyCommandReportType& other_) noexcept ;
            ...
            inline void swap(CommsLostPolicyCommandReportType& a, CommsLostPolicyCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
