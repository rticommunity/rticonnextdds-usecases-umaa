...
namespace UMAA {
    namespace MM {
        namespace CommsLostPolicy {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CommsLostPolicyCommand_TOPIC = "UMAA::MM::CommsLostPolicy::CommsLostPolicyCommand";
            ...
            class NDDSUSERDllExport CommsLostPolicyCommandType {
              public:
                ...
                void swap(CommsLostPolicyCommandType& other_) noexcept ;
            ...
            inline void swap(CommsLostPolicyCommandType& a, CommsLostPolicyCommandType& b)  noexcept 
            {
                a.swap(b);
            }
