...
namespace UMAA {
    namespace MM {
        namespace CommsLostPolicy {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CommsLostPolicyCommandStatus_TOPIC = "UMAA::MM::CommsLostPolicy::CommsLostPolicyCommandStatus";
            ...
            class NDDSUSERDllExport CommsLostPolicyCommandStatusType {
              public:
                ...
                void swap(CommsLostPolicyCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CommsLostPolicyCommandStatusType& a, CommsLostPolicyCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
