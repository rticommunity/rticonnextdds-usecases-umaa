...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace CommsLostPolicy {
            ...
            CommsLostPolicySpecsReportType::CommsLostPolicySpecsReportType (bool continueMission_,bool moveToPose_,bool retroTraverse_,bool stop_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_continueMission_(continueMission_), 
                m_moveToPose_(moveToPose_), 
            ...
            void CommsLostPolicySpecsReportType::swap(CommsLostPolicySpecsReportType& other_)  noexcept 
            {
                using std::swap;
