...
namespace UMAA {
    namespace MM {
        namespace CommsLostPolicy {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CommsLostPolicyReport_TOPIC = "UMAA::MM::CommsLostPolicy::CommsLostPolicyReport";
            ...
            class NDDSUSERDllExport CommsLostPolicyReportType {
              public:
                ...
                CommsLostPolicyReportType(const ::UMAA::Common::MaritimeEnumeration::LostCommsStatusEnumType::LostCommsStatusEnumType& status_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::UMAA::Common::MaritimeEnumeration::LostCommsStatusEnumType::LostCommsStatusEnumType& status() noexcept {
                    return m_status_;
                }

                const ::UMAA::Common::MaritimeEnumeration::LostCommsStatusEnumType::LostCommsStatusEnumType& status() const noexcept {
                    return m_status_;
                }
                ...
                void swap(CommsLostPolicyReportType& other_) noexcept ;
            ...
            inline void swap(CommsLostPolicyReportType& a, CommsLostPolicyReportType& b)  noexcept 
            {
                a.swap(b);
            }
