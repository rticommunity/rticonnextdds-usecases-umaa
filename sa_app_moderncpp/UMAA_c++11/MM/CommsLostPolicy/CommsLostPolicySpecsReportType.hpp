...
namespace UMAA {
    namespace MM {
        namespace CommsLostPolicy {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CommsLostPolicySpecsReport_TOPIC = "UMAA::MM::CommsLostPolicy::CommsLostPolicySpecsReport";
            ...
            class NDDSUSERDllExport CommsLostPolicySpecsReportType {
              public:
                ...
                CommsLostPolicySpecsReportType(bool continueMission_,bool moveToPose_,bool retroTraverse_,bool stop_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                bool& continueMission() noexcept {
                    return m_continueMission_;
                }

                const bool& continueMission() const noexcept {
                    return m_continueMission_;
                }
                ...
                bool& moveToPose() noexcept {
                    return m_moveToPose_;
                }

                const bool& moveToPose() const noexcept {
                    return m_moveToPose_;
                }
                ...
                bool& retroTraverse() noexcept {
                    return m_retroTraverse_;
                }

                const bool& retroTraverse() const noexcept {
                    return m_retroTraverse_;
                }
                ...
                const bool& stop() const noexcept {
                    return m_stop_;
                }
                ...
                void swap(CommsLostPolicySpecsReportType& other_) noexcept ;
            ...
            inline void swap(CommsLostPolicySpecsReportType& a, CommsLostPolicySpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
