...
namespace UMAA {
    namespace SA {
        namespace WaterCurrentStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string WaterCurrentStatusReport_TOPIC = "UMAA::SA::WaterCurrentStatus::WaterCurrentStatusReport";
            ...
            class NDDSUSERDllExport WaterCurrentStatusReportType {
              public:
                ...
                WaterCurrentStatusReportType(double currentDrift_,double currentSet_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                double& currentDrift() noexcept {
                    return m_currentDrift_;
                }

                const double& currentDrift() const noexcept {
                    return m_currentDrift_;
                }
                ...
                double& currentSet() noexcept {
                    return m_currentSet_;
                }

                const double& currentSet() const noexcept {
                    return m_currentSet_;
                }
                ...
                void swap(WaterCurrentStatusReportType& other_) noexcept ;
            ...
            inline void swap(WaterCurrentStatusReportType& a, WaterCurrentStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }
