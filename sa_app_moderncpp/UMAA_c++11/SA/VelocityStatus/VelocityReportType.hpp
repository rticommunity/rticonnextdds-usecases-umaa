...
namespace UMAA {
    namespace SA {
        namespace VelocityStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string VelocityReport_TOPIC = "UMAA::SA::VelocityStatus::VelocityReport";
            ...
            class NDDSUSERDllExport VelocityReportType {
              public:
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceOrientationType >& attitudeRateCovariance() noexcept {
                    return m_attitudeRateCovariance_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceOrientationType >& attitudeRateCovariance() const noexcept {
                    return m_attitudeRateCovariance_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::MaritimeEnumeration::VehicleSpeedModeEnumType::VehicleSpeedModeEnumType >& mode() noexcept {
                    return m_mode_;
                }

                const ::dds::core::optional< ::UMAA::Common::MaritimeEnumeration::VehicleSpeedModeEnumType::VehicleSpeedModeEnumType >& mode() const noexcept {
                    return m_mode_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceVelocityVelocityType >& velocityCovariance() noexcept {
                    return m_velocityCovariance_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceVelocityVelocityType >& velocityCovariance() const noexcept {
                    return m_velocityCovariance_;
                }
