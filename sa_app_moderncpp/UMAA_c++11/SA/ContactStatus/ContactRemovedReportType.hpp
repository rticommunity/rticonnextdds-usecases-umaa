...
namespace UMAA {
    namespace SA {
        namespace ContactStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ContactRemovedReport_TOPIC = "UMAA::SA::ContactStatus::ContactRemovedReport";
            ...
            class NDDSUSERDllExport ContactRemovedReportType {
              public:
                ...
                ContactRemovedReportType(const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& contactID_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& contactID() noexcept {
                    return m_contactID_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& contactID() const noexcept {
                    return m_contactID_;
                }
                ...
                void swap(ContactRemovedReportType& other_) noexcept ;
            ...
            inline void swap(ContactRemovedReportType& a, ContactRemovedReportType& b)  noexcept 
            {
                a.swap(b);
            }
