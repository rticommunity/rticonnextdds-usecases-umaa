...
namespace UMAA {
    namespace SA {
        namespace GlobalDeadReckoning {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalDeadReckoningCommandStatus_TOPIC = "UMAA::SA::GlobalDeadReckoning::GlobalDeadReckoningCommandStatus";
            ...
            class NDDSUSERDllExport GlobalDeadReckoningCommandStatusType {
              public:
                ...
                void swap(GlobalDeadReckoningCommandStatusType& other_) noexcept ;
            ...
            inline void swap(GlobalDeadReckoningCommandStatusType& a, GlobalDeadReckoningCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
