...
namespace UMAA {
    namespace SA {
        namespace GlobalDeadReckoning {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string GlobalDeadReckoningCommandReport_TOPIC = "UMAA::SA::GlobalDeadReckoning::GlobalDeadReckoningCommandReport";
            ...
            class NDDSUSERDllExport GlobalDeadReckoningCommandReportType {
              public:
                ...
                void swap(GlobalDeadReckoningCommandReportType& other_) noexcept ;
            ...
            inline void swap(GlobalDeadReckoningCommandReportType& a, GlobalDeadReckoningCommandReportType& b)  noexcept 
            {
                a.swap(b);
            }
