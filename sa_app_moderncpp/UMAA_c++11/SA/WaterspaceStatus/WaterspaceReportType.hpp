...
namespace UMAA {
    namespace SA {
        namespace WaterspaceStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string WaterspaceReport_TOPIC = "UMAA::SA::WaterspaceStatus::WaterspaceReport";
            ...
            class NDDSUSERDllExport WaterspaceReportType {
              public:
                ...
                WaterspaceReportType(const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::ZoneType, 100L >& zones_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::ZoneType, 100L >& zones() noexcept {
                    return m_zones_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::ZoneType, 100L >& zones() const noexcept {
                    return m_zones_;
                }
                ...
                void swap(WaterspaceReportType& other_) noexcept ;
            ...
            inline void swap(WaterspaceReportType& a, WaterspaceReportType& b)  noexcept 
            {
                a.swap(b);
            }
