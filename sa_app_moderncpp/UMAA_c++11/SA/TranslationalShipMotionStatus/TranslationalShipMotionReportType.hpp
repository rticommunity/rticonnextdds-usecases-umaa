...
namespace UMAA {
    namespace SA {
        namespace TranslationalShipMotionStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string TranslationalShipMotionReport_TOPIC = "UMAA::SA::TranslationalShipMotionStatus::TranslationalShipMotionReport";
            ...
            class NDDSUSERDllExport TranslationalShipMotionReportType {
              public:
                ...
                TranslationalShipMotionReportType(const ::dds::core::optional< double >& heave_,const ::dds::core::optional< double >& surge_,const ::dds::core::optional< double >& sway_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);
