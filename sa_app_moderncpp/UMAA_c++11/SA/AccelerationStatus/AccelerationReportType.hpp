...
namespace UMAA {
    namespace SA {
        namespace AccelerationStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string AccelerationReport_TOPIC = "UMAA::SA::AccelerationStatus::AccelerationReport";
            ...
            class NDDSUSERDllExport AccelerationReportType {
              public:
                ...
                AccelerationReportType(const ::UMAA::Common::Measurement::Acceleration3D_PlatformXYZ& acceleration_,const ::UMAA::Common::Measurement::CovarianceNEDAccelerationAccelerationType& accelerationCovariance_,const ::UMAA::Common::Measurement::OrientationAcceleration3D& attitudeAcceleration_,const ::UMAA::Common::Measurement::CovarianceOrientationAccelerationAccelerationType& rotationalAccelerationCovariance_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::UMAA::Common::Measurement::Acceleration3D_PlatformXYZ& acceleration() noexcept {
                    return m_acceleration_;
                }

                const ::UMAA::Common::Measurement::Acceleration3D_PlatformXYZ& acceleration() const noexcept {
                    return m_acceleration_;
                }
                ...
                ::UMAA::Common::Measurement::CovarianceNEDAccelerationAccelerationType& accelerationCovariance() noexcept {
                    return m_accelerationCovariance_;
                }

                const ::UMAA::Common::Measurement::CovarianceNEDAccelerationAccelerationType& accelerationCovariance() const noexcept {
                    return m_accelerationCovariance_;
                }
                ...
                ::UMAA::Common::Measurement::OrientationAcceleration3D& attitudeAcceleration() noexcept {
                    return m_attitudeAcceleration_;
                }

                const ::UMAA::Common::Measurement::OrientationAcceleration3D& attitudeAcceleration() const noexcept {
                    return m_attitudeAcceleration_;
                }
                ...
                ::UMAA::Common::Measurement::CovarianceOrientationAccelerationAccelerationType& rotationalAccelerationCovariance() noexcept {
                    return m_rotationalAccelerationCovariance_;
                }

                const ::UMAA::Common::Measurement::CovarianceOrientationAccelerationAccelerationType& rotationalAccelerationCovariance() const noexcept {
                    return m_rotationalAccelerationCovariance_;
                }
