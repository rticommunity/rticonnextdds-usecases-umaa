        ...
        namespace PathReporterSpecs {
            ...
            class NDDSUSERDllExport PathReporterType {
              public:
                ...
                PathReporterType(double maxDistance_,int32_t maxPoints_,double maxTgtResolution_,double maxTime_,double minTgtResolution_,const ::UMAA::Common::MaritimeEnumeration::PathWayEnumType::PathWayEnumType& pathType_);
                ...
                ::UMAA::Common::MaritimeEnumeration::PathWayEnumType::PathWayEnumType& pathType() noexcept {
                    return m_pathType_;
                }

                const ::UMAA::Common::MaritimeEnumeration::PathWayEnumType::PathWayEnumType& pathType() const noexcept {
                    return m_pathType_;
                }
