...
namespace UMAA {
    namespace SA {
        namespace PathReporterSpecs {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string PathReporterSpecsReport_TOPIC = "UMAA::SA::PathReporterSpecs::PathReporterSpecsReport";
            ...
            class NDDSUSERDllExport PathReporterSpecsReportType {
              public:
                ...
                PathReporterSpecsReportType(const ::rti::core::bounded_sequence< ::UMAA::SA::PathReporterSpecs::PathReporterType, 100L >& pathReporters_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::rti::core::bounded_sequence< ::UMAA::SA::PathReporterSpecs::PathReporterType, 100L >& pathReporters() noexcept {
                    return m_pathReporters_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::SA::PathReporterSpecs::PathReporterType, 100L >& pathReporters() const noexcept {
                    return m_pathReporters_;
                }
