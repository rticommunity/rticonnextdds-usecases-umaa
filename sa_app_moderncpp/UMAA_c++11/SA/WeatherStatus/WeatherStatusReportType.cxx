...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace WeatherStatus {
            ...
            void WeatherStatusReportType::swap(WeatherStatusReportType& other_)  noexcept 
            {
                using std::swap;
