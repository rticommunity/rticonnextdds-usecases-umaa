...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace BoundingBox {
            ...
            BoundingBoxType::BoundingBoxType (int32_t lowerRight_x_,int32_t lowerRight_y_,int32_t upperLeft_x_,int32_t upperLeft_y_):
                m_lowerRight_x_(lowerRight_x_), 
                m_lowerRight_y_(lowerRight_y_), 
                m_upperLeft_x_(upperLeft_x_), 
                m_upperLeft_y_(upperLeft_y_) {
            }

            void BoundingBoxType::swap(BoundingBoxType& other_)  noexcept 
            {
                using std::swap;
