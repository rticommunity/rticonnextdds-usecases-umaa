        ...
        namespace BoundingBox {
            ...
            class NDDSUSERDllExport BoundingBoxType {
              public:
                ...
                BoundingBoxType(int32_t lowerRight_x_,int32_t lowerRight_y_,int32_t upperLeft_x_,int32_t upperLeft_y_);

                int32_t& lowerRight_x() noexcept {
                    return m_lowerRight_x_;
                }

                const int32_t& lowerRight_x() const noexcept {
                    return m_lowerRight_x_;
                }
                ...
                int32_t& lowerRight_y() noexcept {
                    return m_lowerRight_y_;
                }

                const int32_t& lowerRight_y() const noexcept {
                    return m_lowerRight_y_;
                }
                ...
                int32_t& upperLeft_x() noexcept {
                    return m_upperLeft_x_;
                }

                const int32_t& upperLeft_x() const noexcept {
                    return m_upperLeft_x_;
                }
                ...
                int32_t& upperLeft_y() noexcept {
                    return m_upperLeft_y_;
                }

                const int32_t& upperLeft_y() const noexcept {
                    return m_upperLeft_y_;
                }
                ...
                void swap(BoundingBoxType& other_) noexcept ;
            ...
            inline void swap(BoundingBoxType& a, BoundingBoxType& b)  noexcept 
            {
                a.swap(b);
            }
