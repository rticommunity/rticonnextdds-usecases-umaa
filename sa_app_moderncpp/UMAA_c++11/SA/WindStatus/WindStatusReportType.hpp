...
namespace UMAA {
    namespace SA {
        namespace WindStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string WindStatusReport_TOPIC = "UMAA::SA::WindStatus::WindStatusReport";
            ...
            class NDDSUSERDllExport WindStatusReportType {
              public:
                ...
                void swap(WindStatusReportType& other_) noexcept ;
            ...
            inline void swap(WindStatusReportType& a, WindStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }
