...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace FeatureImageStatus {
            ...
            FeatureImageRemovedReportType::FeatureImageRemovedReportType (const ::rti::core::bounded_sequence< ::UMAA::SA::FeatureImagePair::FeatureImagePairType, 100L >& featureImagePair_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_featureImagePair_(featureImagePair_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void FeatureImageRemovedReportType::swap(FeatureImageRemovedReportType& other_)  noexcept 
            {
                using std::swap;
