...
namespace UMAA {
    namespace SA {
        namespace FeatureImageStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string FeatureImageReport_TOPIC = "UMAA::SA::FeatureImageStatus::FeatureImageReport";
            ...
            class NDDSUSERDllExport FeatureImageReportType {
              public:
                ...
                ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& featureID() noexcept {
                    return m_featureID_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::NumericGUID, 100L >& featureID() const noexcept {
                    return m_featureID_;
                }
                ...
                void swap(FeatureImageReportType& other_) noexcept ;
            ...
            inline void swap(FeatureImageReportType& a, FeatureImageReportType& b)  noexcept 
            {
                a.swap(b);
            }
