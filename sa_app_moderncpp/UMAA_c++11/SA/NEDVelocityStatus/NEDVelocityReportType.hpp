...
namespace UMAA {
    namespace SA {
        namespace NEDVelocityStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string NEDVelocityReport_TOPIC = "UMAA::SA::NEDVelocityStatus::NEDVelocityReport";
            ...
            class NDDSUSERDllExport NEDVelocityReportType {
              public:
                ...
                NEDVelocityReportType(const ::dds::core::optional< ::UMAA::Common::Measurement::OrientationVelocity3D >& attitudeRate_,const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceOrientationType >& attitudeRateRMS_,const ::UMAA::Common::Measurement::Velocity3D_PlatformNED& velocity_,const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceVelocityVelocityType >& velocityRMS_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                ::dds::core::optional< ::UMAA::Common::Measurement::OrientationVelocity3D >& attitudeRate() noexcept {
                    return m_attitudeRate_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::OrientationVelocity3D >& attitudeRate() const noexcept {
                    return m_attitudeRate_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceOrientationType >& attitudeRateRMS() noexcept {
                    return m_attitudeRateRMS_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceOrientationType >& attitudeRateRMS() const noexcept {
                    return m_attitudeRateRMS_;
                }
                ...
                ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceVelocityVelocityType >& velocityRMS() noexcept {
                    return m_velocityRMS_;
                }

                const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceVelocityVelocityType >& velocityRMS() const noexcept {
                    return m_velocityRMS_;
                }
                ...
                void swap(NEDVelocityReportType& other_) noexcept ;
            ...
            inline void swap(NEDVelocityReportType& a, NEDVelocityReportType& b)  noexcept 
            {
                a.swap(b);
            }
