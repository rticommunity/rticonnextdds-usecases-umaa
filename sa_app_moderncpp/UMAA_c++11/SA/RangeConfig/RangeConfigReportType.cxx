    ...
    namespace SA {
        ...
        namespace RangeConfig {
            ...
            RangeConfigReportType::RangeConfigReportType (double horizontalFOVStartAngle_,double horizontalFOVStopAngle_,double maxRange_,double minRange_,const ::UMAA::SEM::SensorManagement::RangeErrorType& rangeError_,const ::UMAA::Common::Enumeration::PowerStatusEnumType::PowerStatusEnumType& status_,double updateRate_,double verticalFOVStartAngle_,double verticalFOVStopAngle_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_horizontalFOVStartAngle_(horizontalFOVStartAngle_), 
                m_horizontalFOVStopAngle_(horizontalFOVStopAngle_), 
                m_maxRange_(maxRange_), 
                m_minRange_(minRange_), 
                m_rangeError_(rangeError_), 
                m_status_(status_), 
                m_updateRate_(updateRate_), 
                m_verticalFOVStartAngle_(verticalFOVStartAngle_), 
                m_verticalFOVStopAngle_(verticalFOVStopAngle_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void RangeConfigReportType::swap(RangeConfigReportType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool RangeConfigReportType::operator == (const RangeConfigReportType& other_) const {
                if (std::fabs(m_horizontalFOVStartAngle_ - other_.m_horizontalFOVStartAngle_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_horizontalFOVStartAngle_ - other_.m_horizontalFOVStartAngle_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_horizontalFOVStopAngle_ - other_.m_horizontalFOVStopAngle_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_horizontalFOVStopAngle_ - other_.m_horizontalFOVStopAngle_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                ...
                if (std::fabs(m_updateRate_ - other_.m_updateRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_updateRate_ - other_.m_updateRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_verticalFOVStartAngle_ - other_.m_verticalFOVStartAngle_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_verticalFOVStartAngle_ - other_.m_verticalFOVStartAngle_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_verticalFOVStopAngle_ - other_.m_verticalFOVStopAngle_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_verticalFOVStopAngle_ - other_.m_verticalFOVStopAngle_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
