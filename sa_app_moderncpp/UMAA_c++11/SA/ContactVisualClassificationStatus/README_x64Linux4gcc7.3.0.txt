...
data type ContactVisualClassificationStatusReportType from ContactVisualClassificationStatusReportType.idl.
This example builds two applications, named ContactVisualClassificationStatusReportType_publisher and
ContactVisualClassificationStatusReportType_subscriber.
...
> make -f makefile_ContactVisualClassificationStatusReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ContactVisualClassificationStatusReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the ContactVisualClassificationStatusReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/ContactVisualClassificationStatusReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/ContactVisualClassificationStatusReportType_subscriber -d <domain_id> -s <sample_count>
