...
namespace UMAA {
    namespace SA {
        namespace ContactVisualClassificationStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string ContactVisualClassificationStatusReport_TOPIC = "UMAA::SA::ContactVisualClassificationStatus::ContactVisualClassificationStatusReport";
            ...
            class NDDSUSERDllExport ContactVisualClassificationStatusReportType {
              public:
                ...
                ContactVisualClassificationStatusReportType(double confidence_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::Measurement::NumericGUID& contactID_,const ::UMAA::Common::MaritimeEnumeration::VisualClassificationEnumType::VisualClassificationEnumType& visualClassification_);
                ...
                ::UMAA::Common::MaritimeEnumeration::VisualClassificationEnumType::VisualClassificationEnumType& visualClassification() noexcept {
                    return m_visualClassification_;
                }

                const ::UMAA::Common::MaritimeEnumeration::VisualClassificationEnumType::VisualClassificationEnumType& visualClassification() const noexcept {
                    return m_visualClassification_;
                }
                ...
                void swap(ContactVisualClassificationStatusReportType& other_) noexcept ;
            ...
            inline void swap(ContactVisualClassificationStatusReportType& a, ContactVisualClassificationStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }
