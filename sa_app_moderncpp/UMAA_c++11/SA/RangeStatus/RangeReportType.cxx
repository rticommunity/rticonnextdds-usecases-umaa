...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace RangeStatus {
            ...
            RangeReportType::RangeReportType (const ::UMAA::Common::MaritimeEnumeration::CoordinateSystemEnumType::CoordinateSystemEnumType& coordinateSystem_,const ::rti::core::bounded_sequence< ::UMAA::SA::RangeStatus::RangeDataPointType, 100L >& dataPoints_,const std::string& errorMessage_,const ::UMAA::Common::MaritimeEnumeration::RangeErrorCodeEnumType::RangeErrorCodeEnumType& rangeErrorCode_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_):
                m_coordinateSystem_(coordinateSystem_), 
                m_dataPoints_(dataPoints_), 
                m_errorMessage_(errorMessage_), 
                m_rangeErrorCode_(rangeErrorCode_), 
                m_source_(source_), 
                m_timeStamp_(timeStamp_) {
            }

            void RangeReportType::swap(RangeReportType& other_)  noexcept 
            {
                using std::swap;
