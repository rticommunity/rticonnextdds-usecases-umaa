...
data type FeatureImagePairType from FeatureImagePairType.idl.
This example builds two applications, named FeatureImagePairType_publisher and
FeatureImagePairType_subscriber.
...
> make -f makefile_FeatureImagePairType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_FeatureImagePairType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the FeatureImagePairType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/FeatureImagePairType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/FeatureImagePairType_subscriber -d <domain_id> -s <sample_count>
