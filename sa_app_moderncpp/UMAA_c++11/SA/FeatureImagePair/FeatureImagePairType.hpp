        ...
        namespace FeatureImagePair {
            ...
            class NDDSUSERDllExport FeatureImagePairType {
              public:
                ...
                FeatureImagePairType(const ::UMAA::Common::Measurement::NumericGUID& featureID_,const ::UMAA::Common::Measurement::NumericGUID& imageID_);
                ...
                void swap(FeatureImagePairType& other_) noexcept ;
            ...
            inline void swap(FeatureImagePairType& a, FeatureImagePairType& b)  noexcept 
            {
                a.swap(b);
            }
