...
namespace UMAA {
    namespace SA {
        namespace LocalDeadReckoning {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalDeadReckoningCommandStatus_TOPIC = "UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommandStatus";
            ...
            class NDDSUSERDllExport LocalDeadReckoningCommandStatusType {
              public:
                ...
                void swap(LocalDeadReckoningCommandStatusType& other_) noexcept ;
            ...
            inline void swap(LocalDeadReckoningCommandStatusType& a, LocalDeadReckoningCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
