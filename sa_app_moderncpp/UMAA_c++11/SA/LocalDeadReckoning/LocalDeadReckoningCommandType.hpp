...
namespace UMAA {
    namespace SA {
        namespace LocalDeadReckoning {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string LocalDeadReckoningCommand_TOPIC = "UMAA::SA::LocalDeadReckoning::LocalDeadReckoningCommand";
            ...
            class NDDSUSERDllExport LocalDeadReckoningCommandType {
              public:
                ...
                void swap(LocalDeadReckoningCommandType& other_) noexcept ;
            ...
            inline void swap(LocalDeadReckoningCommandType& a, LocalDeadReckoningCommandType& b)  noexcept 
            {
                a.swap(b);
            }
