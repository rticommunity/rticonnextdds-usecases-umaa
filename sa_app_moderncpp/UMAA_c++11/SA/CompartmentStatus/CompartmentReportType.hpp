...
namespace UMAA {
    namespace SA {
        namespace CompartmentStatus {
            ...
            RTI_CONSTEXPR_OR_CONST_STRING std::string CompartmentReport_TOPIC = "UMAA::SA::CompartmentStatus::CompartmentReport";
            ...
            class NDDSUSERDllExport CompartmentReportType {
              public:
                ...
                CompartmentReportType(bool floodDetected_,double humidity_,bool leakDetected_,double temperature_,const ::UMAA::Common::Measurement::NumericGUID& source_,const ::UMAA::Common::Measurement::DateTime& timeStamp_);

                bool& floodDetected() noexcept {
                    return m_floodDetected_;
                }

                const bool& floodDetected() const noexcept {
                    return m_floodDetected_;
                }
                ...
                double& humidity() noexcept {
                    return m_humidity_;
                }

                const double& humidity() const noexcept {
                    return m_humidity_;
                }
                ...
                bool& leakDetected() noexcept {
                    return m_leakDetected_;
                }

                const bool& leakDetected() const noexcept {
                    return m_leakDetected_;
                }
