        ...
        namespace Orientation {
            ...
            class NDDSUSERDllExport HeadingCurrentDirectionType {
              public:
                ...
                explicit HeadingCurrentDirectionType(double headingCurrentDirection_);

                double& headingCurrentDirection() noexcept {
                    return m_headingCurrentDirection_;
                }

                const double& headingCurrentDirection() const noexcept {
                    return m_headingCurrentDirection_;
                }
                ...
                void swap(HeadingCurrentDirectionType& other_) noexcept ;
            ...
            inline void swap(HeadingCurrentDirectionType& a, HeadingCurrentDirectionType& b)  noexcept 
            {
                a.swap(b);
            }
