    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            namespace OrientationType_Specializations {
                ...
                OrientationType_Union::Union_::Union_(const ::UMAA::Common::Orientation::DirectionType& DirectionType_data_,const ::UMAA::Common::Orientation::AttitudeType& AttitudeType_data_):
                    m_DirectionType_data_(DirectionType_data_), 
                    m_AttitudeType_data_(AttitudeType_data_) {
                }
                ...
                void OrientationType_Union::swap(OrientationType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const OrientationType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::Common::Orientation::OrientationType_Specializations::OrientationType_Selectors::ATTITUDETYPE_SELECT):
                            {  
                                o << "AttitudeType_data: " << sample.AttitudeType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            OrientationType::OrientationType (const ::UMAA::Common::Orientation::OrientationType_Specializations::OrientationType_Union& OrientationType_subtypes_):
                m_OrientationType_subtypes_(OrientationType_subtypes_) {
            }

            void OrientationType::swap(OrientationType& other_)  noexcept 
            {
                using std::swap;
