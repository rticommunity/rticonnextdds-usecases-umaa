        ...
        namespace Orientation {
            ...
            class NDDSUSERDllExport AttitudeType {
              public:
                ...
                explicit AttitudeType(const ::UMAA::Common::Measurement::Orientation3D& attitude_);
                ...
                void swap(AttitudeType& other_) noexcept ;
            ...
            inline void swap(AttitudeType& a, AttitudeType& b)  noexcept 
            {
                a.swap(b);
            }
