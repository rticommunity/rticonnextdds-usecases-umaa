        ...
        namespace Orientation {
            ...
            class NDDSUSERDllExport HeadingTrueNorthType {
              public:
                ...
                explicit HeadingTrueNorthType(double headingTrueNorth_);

                double& headingTrueNorth() noexcept {
                    return m_headingTrueNorth_;
                }

                const double& headingTrueNorth() const noexcept {
                    return m_headingTrueNorth_;
                }
                ...
                void swap(HeadingTrueNorthType& other_) noexcept ;
            ...
            inline void swap(HeadingTrueNorthType& a, HeadingTrueNorthType& b)  noexcept 
            {
                a.swap(b);
            }
