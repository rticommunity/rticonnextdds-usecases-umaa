...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Orientation {
            ...
            HeadingMagneticNorthType::HeadingMagneticNorthType (double headingMagneticNorth_):
                m_headingMagneticNorth_(headingMagneticNorth_) {
            }

            void HeadingMagneticNorthType::swap(HeadingMagneticNorthType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool HeadingMagneticNorthType::operator == (const HeadingMagneticNorthType& other_) const {
                if (std::fabs(m_headingMagneticNorth_ - other_.m_headingMagneticNorth_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_headingMagneticNorth_ - other_.m_headingMagneticNorth_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                return true;
            }
