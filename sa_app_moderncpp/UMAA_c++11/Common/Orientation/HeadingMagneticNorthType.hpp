        ...
        namespace Orientation {
            ...
            class NDDSUSERDllExport HeadingMagneticNorthType {
              public:
                ...
                explicit HeadingMagneticNorthType(double headingMagneticNorth_);

                double& headingMagneticNorth() noexcept {
                    return m_headingMagneticNorth_;
                }

                const double& headingMagneticNorth() const noexcept {
                    return m_headingMagneticNorth_;
                }
                ...
                void swap(HeadingMagneticNorthType& other_) noexcept ;
            ...
            inline void swap(HeadingMagneticNorthType& a, HeadingMagneticNorthType& b)  noexcept 
            {
                a.swap(b);
            }
