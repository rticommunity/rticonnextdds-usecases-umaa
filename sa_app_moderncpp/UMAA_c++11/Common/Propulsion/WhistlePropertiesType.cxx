...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Propulsion {
            ...
            WhistlePropertiesType::WhistlePropertiesType (double restTime_,double whistleNumber_,const ::UMAA::Common::MaritimeEnumeration::BlastKindEnumType::BlastKindEnumType& whistleType_):
                m_restTime_(restTime_), 
                m_whistleNumber_(whistleNumber_), 
                m_whistleType_(whistleType_) {
            }

            void WhistlePropertiesType::swap(WhistlePropertiesType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool WhistlePropertiesType::operator == (const WhistlePropertiesType& other_) const {
                ...
                if (std::fabs(m_whistleNumber_ - other_.m_whistleNumber_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_whistleNumber_ - other_.m_whistleNumber_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
