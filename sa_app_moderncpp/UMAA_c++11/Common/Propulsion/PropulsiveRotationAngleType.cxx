...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Propulsion {
            ...
            PropulsiveRotationAngleType::PropulsiveRotationAngleType (double thrustYaw_):
                m_thrustYaw_(thrustYaw_) {
            }

            void PropulsiveRotationAngleType::swap(PropulsiveRotationAngleType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool PropulsiveRotationAngleType::operator == (const PropulsiveRotationAngleType& other_) const {
                if (std::fabs(m_thrustYaw_ - other_.m_thrustYaw_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_thrustYaw_ - other_.m_thrustYaw_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                return true;
            }
