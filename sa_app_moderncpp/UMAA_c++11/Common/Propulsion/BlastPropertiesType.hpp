        ...
        namespace Propulsion {
            ...
            class NDDSUSERDllExport BlastPropertiesType {
              public:
                ...
                BlastPropertiesType(double blastNumber_,double restTime_);

                double& blastNumber() noexcept {
                    return m_blastNumber_;
                }

                const double& blastNumber() const noexcept {
                    return m_blastNumber_;
                }
                ...
                void swap(BlastPropertiesType& other_) noexcept ;
            ...
            inline void swap(BlastPropertiesType& a, BlastPropertiesType& b)  noexcept 
            {
                a.swap(b);
            }
