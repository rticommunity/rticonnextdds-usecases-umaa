    ...
    namespace Common {
        ...
        namespace Propulsion {
            ...
            namespace PropulsionType_Specializations {
                ...
                PropulsionType_Union::Union_::Union_(const ::UMAA::Common::Propulsion::PropulsiveEffortType& PropulsiveEffortType_data_,const ::UMAA::Common::Propulsion::PropulsiveRPMType& PropulsiveRPMType_data_):
                    m_PropulsiveEffortType_data_(PropulsiveEffortType_data_), 
                    m_PropulsiveRPMType_data_(PropulsiveRPMType_data_) {
                }
                ...
                void PropulsionType_Union::swap(PropulsionType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const PropulsionType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::Common::Propulsion::PropulsionType_Specializations::PropulsionType_Selectors::PROPULSIVERPMTYPE_SELECT):
                            {  
                                o << "PropulsiveRPMType_data: " << sample.PropulsiveRPMType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            PropulsionType::PropulsionType (const ::UMAA::Common::Propulsion::PropulsionType_Specializations::PropulsionType_Union& PropulsionType_subtypes_):
                m_PropulsionType_subtypes_(PropulsionType_subtypes_) {
            }
