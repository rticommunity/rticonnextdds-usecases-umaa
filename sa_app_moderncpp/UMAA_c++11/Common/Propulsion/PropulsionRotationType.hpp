        ...
        namespace Propulsion {
            namespace PropulsionRotationType_Specializations {
                ...
                class NDDSUSERDllExport PropulsionRotationType_Union {
                  public:
                    ...
                    void _d(::UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Selectors value) {
                    ...
                    void swap(PropulsionRotationType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::Common::Propulsion::PropulsiveRotationEffortType& PropulsiveRotationEffortType_data_,const ::UMAA::Common::Propulsion::PropulsiveRotationAngleType& PropulsiveRotationAngleType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(PropulsionRotationType_Union& a, PropulsionRotationType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport PropulsionRotationType {
              public:
                ...
                explicit PropulsionRotationType(const ::UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Union& PropulsionRotationType_subtypes_);

                ::UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Union& PropulsionRotationType_subtypes() noexcept {
                    return m_PropulsionRotationType_subtypes_;
                }

                const ::UMAA::Common::Propulsion::PropulsionRotationType_Specializations::PropulsionRotationType_Union& PropulsionRotationType_subtypes() const noexcept {
                    return m_PropulsionRotationType_subtypes_;
                }
                ...
                void swap(PropulsionRotationType& other_) noexcept ;
            ...
            inline void swap(PropulsionRotationType& a, PropulsionRotationType& b)  noexcept 
            {
                a.swap(b);
            }
