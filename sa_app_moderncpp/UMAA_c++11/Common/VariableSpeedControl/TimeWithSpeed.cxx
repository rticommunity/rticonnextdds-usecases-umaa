...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace VariableSpeedControl {
            ...
            TimeWithSpeed::TimeWithSpeed (const ::dds::core::optional< ::UMAA::Common::Speed::SpeedControlType >& recommendedSpeed_,const ::UMAA::Common::TimeWindow::TimeWindowType& timeWindow_):
                m_recommendedSpeed_(recommendedSpeed_), 
                m_timeWindow_(timeWindow_) {
            }

            void TimeWithSpeed::swap(TimeWithSpeed& other_)  noexcept 
            {
                using std::swap;
