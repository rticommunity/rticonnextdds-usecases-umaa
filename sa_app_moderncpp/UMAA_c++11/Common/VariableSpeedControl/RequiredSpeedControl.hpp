        ...
        namespace VariableSpeedControl {
            ...
            class NDDSUSERDllExport RequiredSpeedControl {
              public:
                ...
                explicit RequiredSpeedControl(const ::UMAA::Common::Speed::SpeedControlType& requiredSpeedControl_);

                ::UMAA::Common::Speed::SpeedControlType& requiredSpeedControl() noexcept {
                    return m_requiredSpeedControl_;
                }

                const ::UMAA::Common::Speed::SpeedControlType& requiredSpeedControl() const noexcept {
                    return m_requiredSpeedControl_;
                }
                ...
                void swap(RequiredSpeedControl& other_) noexcept ;
            ...
            inline void swap(RequiredSpeedControl& a, RequiredSpeedControl& b)  noexcept 
            {
                a.swap(b);
            }
