        ...
        namespace VariableSpeedControl {
            namespace VariableSpeedControlType_Specializations {
                ...
                class NDDSUSERDllExport VariableSpeedControlType_Union {
                  public:
                    ...
                    void _d(::UMAA::Common::VariableSpeedControl::VariableSpeedControlType_Specializations::VariableSpeedControlType_Selectors value) {
                    ...
                    void swap(VariableSpeedControlType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::Common::VariableSpeedControl::TimeWithSpeed& TimeWithSpeed_data_,const ::UMAA::Common::VariableSpeedControl::RecommendedSpeedControl& RecommendedSpeedControl_data_,const ::UMAA::Common::VariableSpeedControl::RequiredSpeedControl& RequiredSpeedControl_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(VariableSpeedControlType_Union& a, VariableSpeedControlType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport VariableSpeedControlType {
              public:
                ...
                explicit VariableSpeedControlType(const ::UMAA::Common::VariableSpeedControl::VariableSpeedControlType_Specializations::VariableSpeedControlType_Union& VariableSpeedControlType_subtypes_);

                ::UMAA::Common::VariableSpeedControl::VariableSpeedControlType_Specializations::VariableSpeedControlType_Union& VariableSpeedControlType_subtypes() noexcept {
                    return m_VariableSpeedControlType_subtypes_;
                }

                const ::UMAA::Common::VariableSpeedControl::VariableSpeedControlType_Specializations::VariableSpeedControlType_Union& VariableSpeedControlType_subtypes() const noexcept {
                    return m_VariableSpeedControlType_subtypes_;
                }
                ...
                void swap(VariableSpeedControlType& other_) noexcept ;
            ...
            inline void swap(VariableSpeedControlType& a, VariableSpeedControlType& b)  noexcept 
            {
                a.swap(b);
            }
