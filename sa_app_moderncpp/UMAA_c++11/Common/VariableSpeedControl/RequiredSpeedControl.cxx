...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace VariableSpeedControl {
            ...
            RequiredSpeedControl::RequiredSpeedControl (const ::UMAA::Common::Speed::SpeedControlType& requiredSpeedControl_):
                m_requiredSpeedControl_(requiredSpeedControl_) {
            }

            void RequiredSpeedControl::swap(RequiredSpeedControl& other_)  noexcept 
            {
                using std::swap;
