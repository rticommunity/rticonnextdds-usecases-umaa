...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace TimeWindow {
            ...
            TimeWindowType::TimeWindowType (const ::UMAA::Common::Measurement::DateTime& end_,const ::UMAA::Common::Measurement::DateTime& start_):
                m_end_(end_), 
                m_start_(start_) {
            }

            void TimeWindowType::swap(TimeWindowType& other_)  noexcept 
            {
                using std::swap;
