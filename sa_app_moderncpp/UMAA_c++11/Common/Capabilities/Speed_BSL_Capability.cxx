...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Capabilities {
            ...
            Speed_BSL_Capability::Speed_BSL_Capability (double speed_,const ::UMAA::Common::MeasurementSpecifications::Speed_BSL_Specification& speedDomain_,const ::UMAA::Common::Requirements::Speed_BSL_Requirement& speedSetPoint_):
                m_speed_(speed_), 
                m_speedDomain_(speedDomain_), 
                m_speedSetPoint_(speedSetPoint_) {
            }

            void Speed_BSL_Capability::swap(Speed_BSL_Capability& other_)  noexcept 
            {
                using std::swap;
