        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport Velocity3D_PlatformXYZ {
              public:
                ...
                Velocity3D_PlatformXYZ(double downSpeed_,double forwardSpeed_,double rightSpeed_);
                ...
                double& forwardSpeed() noexcept {
                    return m_forwardSpeed_;
                }

                const double& forwardSpeed() const noexcept {
                    return m_forwardSpeed_;
                }
                ...
                double& rightSpeed() noexcept {
                    return m_rightSpeed_;
                }

                const double& rightSpeed() const noexcept {
                    return m_rightSpeed_;
                }
                ...
                void swap(Velocity3D_PlatformXYZ& other_) noexcept ;
            ...
            inline void swap(Velocity3D_PlatformXYZ& a, Velocity3D_PlatformXYZ& b)  noexcept 
            {
                a.swap(b);
            }
