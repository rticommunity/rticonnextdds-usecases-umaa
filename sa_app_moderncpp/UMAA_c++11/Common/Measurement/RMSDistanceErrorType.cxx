...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            RMSDistanceErrorType::RMSDistanceErrorType (double distanceError_):
                m_distanceError_(distanceError_) {
            }

            void RMSDistanceErrorType::swap(RMSDistanceErrorType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool RMSDistanceErrorType::operator == (const RMSDistanceErrorType& other_) const {
                if (std::fabs(m_distanceError_ - other_.m_distanceError_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_distanceError_ - other_.m_distanceError_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                return true;
            }
