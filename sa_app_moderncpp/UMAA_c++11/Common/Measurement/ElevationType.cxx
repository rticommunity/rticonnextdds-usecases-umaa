    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            namespace ElevationType_Specializations {
                ...
                ElevationType_Union::Union_::Union_(const ::UMAA::Common::Measurement::AltitudeAGLType& AltitudeAGLType_data_,const ::UMAA::Common::Measurement::AltitudeMSLType& AltitudeMSLType_data_,const ::UMAA::Common::Measurement::AltitudeASFType& AltitudeASFType_data_,const ::UMAA::Common::Measurement::DepthType& DepthType_data_):
                    m_AltitudeAGLType_data_(AltitudeAGLType_data_), 
                    m_AltitudeMSLType_data_(AltitudeMSLType_data_), 
                    m_AltitudeASFType_data_(AltitudeASFType_data_), 
                    m_DepthType_data_(DepthType_data_) {
                }
                ...
                void ElevationType_Union::swap(ElevationType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const ElevationType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::Common::Measurement::ElevationType_Specializations::ElevationType_Selectors::DEPTHTYPE_SELECT):
                            {  
                                o << "DepthType_data: " << sample.DepthType_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            ElevationType::ElevationType (const ::UMAA::Common::Measurement::ElevationType_Specializations::ElevationType_Union& ElevationType_subtypes_):
                m_ElevationType_subtypes_(ElevationType_subtypes_) {
            }

            void ElevationType::swap(ElevationType& other_)  noexcept 
            {
                using std::swap;
