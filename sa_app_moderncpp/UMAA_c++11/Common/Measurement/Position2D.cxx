...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Position2D::Position2D (const ::UMAA::Common::Measurement::GeodeticLatitude& geodeticLatitude_,const ::UMAA::Common::Measurement::GeodeticLongitude& geodeticLongitude_):
                m_geodeticLatitude_(geodeticLatitude_), 
                m_geodeticLongitude_(geodeticLongitude_) {
            }

            void Position2D::swap(Position2D& other_)  noexcept 
            {
                using std::swap;
