        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport Position2DTime {
              public:
                ...
                Position2DTime(const ::UMAA::Common::Measurement::Position2D& geodeticPosition_,const ::dds::core::optional< double >& timeAtPosition_);
                ...
                ::dds::core::optional< double >& timeAtPosition() noexcept {
                    return m_timeAtPosition_;
                }

                const ::dds::core::optional< double >& timeAtPosition() const noexcept {
                    return m_timeAtPosition_;
                }
                ...
                void swap(Position2DTime& other_) noexcept ;
            ...
            inline void swap(Position2DTime& a, Position2DTime& b)  noexcept 
            {
                a.swap(b);
            }
