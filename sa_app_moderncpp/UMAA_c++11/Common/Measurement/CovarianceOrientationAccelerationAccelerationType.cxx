...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            CovarianceOrientationAccelerationAccelerationType::CovarianceOrientationAccelerationAccelerationType (double apAp_,double apAy_,double arAp_,double arAr_,double arAy_,double ayAy_):
                m_apAp_(apAp_), 
                m_apAy_(apAy_), 
                m_arAp_(arAp_), 
                m_arAr_(arAr_), 
            ...
            void CovarianceOrientationAccelerationAccelerationType::swap(CovarianceOrientationAccelerationAccelerationType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool CovarianceOrientationAccelerationAccelerationType::operator == (const CovarianceOrientationAccelerationAccelerationType& other_) const {
                if (std::fabs(m_apAp_ - other_.m_apAp_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_apAp_ - other_.m_apAp_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_apAy_ - other_.m_apAy_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_apAy_ - other_.m_apAy_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_arAp_ - other_.m_arAp_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_arAp_ - other_.m_arAp_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                ...
                if (std::fabs(m_arAy_ - other_.m_arAy_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_arAy_ - other_.m_arAy_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
