...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            CovariancePositionPositionType::CovariancePositionPositionType (const ::dds::core::optional< double >& pdPd_,const ::dds::core::optional< double >& pePd_,double pePe_,const ::dds::core::optional< double >& pnPd_,double pnPe_,double pnPn_):
                m_pdPd_(pdPd_), 
                m_pePd_(pePd_), 
                m_pePe_(pePe_), 
                m_pnPd_(pnPd_), 
            ...
            void CovariancePositionPositionType::swap(CovariancePositionPositionType& other_)  noexcept 
            {
                using std::swap;
