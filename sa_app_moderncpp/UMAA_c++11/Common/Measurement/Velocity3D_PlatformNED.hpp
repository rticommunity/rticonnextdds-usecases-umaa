        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport Velocity3D_PlatformNED {
              public:
                ...
                Velocity3D_PlatformNED(double downSpeed_,double eastSpeed_,double northSpeed_);
                ...
                void swap(Velocity3D_PlatformNED& other_) noexcept ;
            ...
            inline void swap(Velocity3D_PlatformNED& a, Velocity3D_PlatformNED& b)  noexcept 
            {
                a.swap(b);
            }
