        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport WeatherSeverityType_All {
              public:
                ...
                ::rti::core::bounded_sequence< ::UMAA::Common::OrderedEnumeration::WeatherSeverityEnumType::WeatherSeverityEnumType, 100L >& domain() noexcept {
                    return m_domain_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::Common::OrderedEnumeration::WeatherSeverityEnumType::WeatherSeverityEnumType, 100L >& domain() const noexcept {
                    return m_domain_;
                }
                ...
                ::UMAA::Common::OrderedEnumeration::WeatherSeverityEnumType::WeatherSeverityEnumType& setPoint() noexcept {
                    return m_setPoint_;
                }

                const ::UMAA::Common::OrderedEnumeration::WeatherSeverityEnumType::WeatherSeverityEnumType& setPoint() const noexcept {
                    return m_setPoint_;
                }
                ...
                ::UMAA::Common::OrderedEnumeration::WeatherSeverityEnumType::WeatherSeverityEnumType& value() noexcept {
                    return m_value_;
                }

                const ::UMAA::Common::OrderedEnumeration::WeatherSeverityEnumType::WeatherSeverityEnumType& value() const noexcept {
                    return m_value_;
                }
                ...
                void swap(WeatherSeverityType_All& other_) noexcept ;
            ...
            inline void swap(WeatherSeverityType_All& a, WeatherSeverityType_All& b)  noexcept 
            {
                a.swap(b);
            }
