        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport Position2D {
              public:
                ...
                Position2D(const ::UMAA::Common::Measurement::GeodeticLatitude& geodeticLatitude_,const ::UMAA::Common::Measurement::GeodeticLongitude& geodeticLongitude_);

                ::UMAA::Common::Measurement::GeodeticLatitude& geodeticLatitude() noexcept {
                    return m_geodeticLatitude_;
                }

                const ::UMAA::Common::Measurement::GeodeticLatitude& geodeticLatitude() const noexcept {
                    return m_geodeticLatitude_;
                }
                ...
                ::UMAA::Common::Measurement::GeodeticLongitude& geodeticLongitude() noexcept {
                    return m_geodeticLongitude_;
                }

                const ::UMAA::Common::Measurement::GeodeticLongitude& geodeticLongitude() const noexcept {
                    return m_geodeticLongitude_;
                }
                ...
                void swap(Position2D& other_) noexcept ;
            ...
            inline void swap(Position2D& a, Position2D& b)  noexcept 
            {
                a.swap(b);
            }
