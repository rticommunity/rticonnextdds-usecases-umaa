        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport RMSDistanceErrorType {
              public:
                ...
                explicit RMSDistanceErrorType(double distanceError_);

                double& distanceError() noexcept {
                    return m_distanceError_;
                }

                const double& distanceError() const noexcept {
                    return m_distanceError_;
                }
                ...
                void swap(RMSDistanceErrorType& other_) noexcept ;
            ...
            inline void swap(RMSDistanceErrorType& a, RMSDistanceErrorType& b)  noexcept 
            {
                a.swap(b);
            }
