        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport GeodeticLongitude {
              public:
                ...
                explicit GeodeticLongitude(double longitude_);
                ...
                void swap(GeodeticLongitude& other_) noexcept ;
            ...
            inline void swap(GeodeticLongitude& a, GeodeticLongitude& b)  noexcept 
            {
                a.swap(b);
            }
