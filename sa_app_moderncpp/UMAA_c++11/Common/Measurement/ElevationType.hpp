        ...
        namespace Measurement {
            namespace ElevationType_Specializations {
                ...
                class NDDSUSERDllExport ElevationType_Union {
                  public:
                    ...
                    void _d(::UMAA::Common::Measurement::ElevationType_Specializations::ElevationType_Selectors value) {
                    ...
                    void swap(ElevationType_Union& other_) noexcept ;
                  ...
                  private:
                    ...
                    struct NDDSUSERDllExport Union_ {
                        ...
                        Union_();
                        Union_(const ::UMAA::Common::Measurement::AltitudeAGLType& AltitudeAGLType_data_,const ::UMAA::Common::Measurement::AltitudeMSLType& AltitudeMSLType_data_,const ::UMAA::Common::Measurement::AltitudeASFType& AltitudeASFType_data_,const ::UMAA::Common::Measurement::DepthType& DepthType_data_);
                    };
                    Union_ m_u_;

                };

                inline void swap(ElevationType_Union& a, ElevationType_Union& b)  noexcept 
                {
                    a.swap(b);
                }
            ...
            class NDDSUSERDllExport ElevationType {
              public:
                ...
                explicit ElevationType(const ::UMAA::Common::Measurement::ElevationType_Specializations::ElevationType_Union& ElevationType_subtypes_);

                ::UMAA::Common::Measurement::ElevationType_Specializations::ElevationType_Union& ElevationType_subtypes() noexcept {
                    return m_ElevationType_subtypes_;
                }

                const ::UMAA::Common::Measurement::ElevationType_Specializations::ElevationType_Union& ElevationType_subtypes() const noexcept {
                    return m_ElevationType_subtypes_;
                }
                ...
                void swap(ElevationType& other_) noexcept ;
            ...
            inline void swap(ElevationType& a, ElevationType& b)  noexcept 
            {
                a.swap(b);
            }
