        ...
        namespace Measurement {
            ...
            class NDDSUSERDllExport Position3D_PlatformXYZ {
              public:
                ...
                Position3D_PlatformXYZ(double xA_,double yA_,double zA_);

                double& xA() noexcept {
                    return m_xA_;
                }

                const double& xA() const noexcept {
                    return m_xA_;
                }
                ...
                const double& yA() const noexcept {
                    return m_yA_;
                }
                ...
                const double& zA() const noexcept {
                    return m_zA_;
                }
                ...
                void swap(Position3D_PlatformXYZ& other_) noexcept ;
            ...
            inline void swap(Position3D_PlatformXYZ& a, Position3D_PlatformXYZ& b)  noexcept 
            {
                a.swap(b);
            }
