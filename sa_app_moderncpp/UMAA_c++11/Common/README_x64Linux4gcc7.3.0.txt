...
data type CommonDataType from CommonDataType.idl.
This example builds two applications, named CommonDataType_publisher and
CommonDataType_subscriber.
...
> make -f makefile_CommonDataType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_CommonDataType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the CommonDataType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/CommonDataType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/CommonDataType_subscriber -d <domain_id> -s <sample_count>
