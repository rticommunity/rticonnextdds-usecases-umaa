...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Requirements {
            ...
            Speed_BSL_Requirement::Speed_BSL_Requirement (double speed_,const ::UMAA::Common::MeasurementTolerances::Speed_BSL_Tolerance& speedTolerance_):
                m_speed_(speed_), 
                m_speedTolerance_(speedTolerance_) {
            }

            void Speed_BSL_Requirement::swap(Speed_BSL_Requirement& other_)  noexcept 
            {
                using std::swap;
