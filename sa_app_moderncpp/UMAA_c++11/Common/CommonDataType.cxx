...
namespace UMAA {
    ...
    namespace Common {
        ...
        CommonDataType::CommonDataType (const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_):
            m_commandStatusReason_(commandStatusReason_), 
            m_logMessage_(logMessage_) {
        }

        void CommonDataType::swap(CommonDataType& other_)  noexcept 
        {
            using std::swap;
