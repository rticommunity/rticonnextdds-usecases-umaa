    ...
    namespace Common {
        ...
        class NDDSUSERDllExport CommonDataType {
          public:
            ...
            CommonDataType(const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumType::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
            ...
            void swap(CommonDataType& other_) noexcept ;
        ...
        inline void swap(CommonDataType& a, CommonDataType& b)  noexcept 
        {
            a.swap(b);
        }
