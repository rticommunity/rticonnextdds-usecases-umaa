    ...
    namespace Common {
        ...
        namespace Speed {
            ...
            namespace SpeedControlType_Specializations {
                ...
                SpeedControlType_Union::Union_::Union_(const ::UMAA::Common::Speed::SpeedOverGround& SpeedOverGround_data_,const ::UMAA::Common::Speed::SpeedThroughWater& SpeedThroughWater_data_,const ::UMAA::Common::Speed::VehicleSpeedMode& VehicleSpeedMode_data_,const ::UMAA::Common::Speed::EngineRPM& EngineRPM_data_,const ::UMAA::Common::Speed::SpeedThroughAir& SpeedThroughAir_data_):
                    m_SpeedOverGround_data_(SpeedOverGround_data_), 
                    m_SpeedThroughWater_data_(SpeedThroughWater_data_), 
                    m_VehicleSpeedMode_data_(VehicleSpeedMode_data_), 
                    m_EngineRPM_data_(EngineRPM_data_), 
                    m_SpeedThroughAir_data_(SpeedThroughAir_data_) {
                }
                ...
                void SpeedControlType_Union::swap(SpeedControlType_Union& other_)  noexcept 
                {
                    using std::swap;
                ...
                std::ostream& operator << (std::ostream& o,const SpeedControlType_Union& sample)
                {
                    ...
                    switch(::rti::topic::cdr::integer_case(sample._d())){
                        ...
                        case (UMAA::Common::Speed::SpeedControlType_Specializations::SpeedControlType_Selectors::SPEEDTHROUGHAIR_SELECT):
                            {  
                                o << "SpeedThroughAir_data: " << sample.SpeedThroughAir_data ();
                        } break ;
                        default:
                        {
                            /*
            ...
            SpeedControlType::SpeedControlType (const ::UMAA::Common::Speed::SpeedControlType_Specializations::SpeedControlType_Union& SpeedControlType_subtypes_):
                m_SpeedControlType_subtypes_(SpeedControlType_subtypes_) {
            }

            void SpeedControlType::swap(SpeedControlType& other_)  noexcept 
            {
                using std::swap;
