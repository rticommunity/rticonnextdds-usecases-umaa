...
/* ----------------------------------------------------------------------------
*  Type UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_finalize_ex" */
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_finalize_w_params(sample,dealloc_params);
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_data(
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_copy(dst,(const UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    if (sample->waterspacePlanName==NULL) {
        RTICdrType_printString(
            NULL,"waterspacePlanName", indent_level + 1);
    } else {
        RTICdrType_printString(
            sample->waterspacePlanName,"waterspacePlanName", indent_level + 1);    
    }

    if (UMAA_MM_BaseType_PlanningZoneTypeSeq_get_contiguous_bufferI(&sample->zones) != NULL) {
        RTICdrType_printArray(
            UMAA_MM_BaseType_PlanningZoneTypeSeq_get_contiguous_bufferI(&sample->zones), 
            (RTICdrUnsignedLong) UMAA_MM_BaseType_PlanningZoneTypeSeq_get_length(&sample->zones),
            sizeof(UMAA_MM_BaseType_PlanningZoneType),
            (RTICdrTypePrintFunction)UMAA_MM_BaseType_PlanningZoneTypePluginSupport_print_data,
            "zones", indent_level + 1);
    } else {
        RTICdrType_printPointerArray(
            UMAA_MM_BaseType_PlanningZoneTypeSeq_get_discontiguous_bufferI(&sample->zones), 
            (RTICdrUnsignedLong) UMAA_MM_BaseType_PlanningZoneTypeSeq_get_length(&sample->zones),
            (RTICdrTypePrintFunction)UMAA_MM_BaseType_PlanningZoneTypePluginSupport_print_data,
            "zones", indent_level + 1);
    }
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType *key = NULL;

    key = new (std::nothrow) UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypeKeyHolder();

    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_finalize_ex(key,deallocate_pointers);
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_key(
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_finalize_optional_members(
    ...
    const UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType *src)
{
    ...
    return UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_get_typecode();
    pd.programs = UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType *sample)
{
    return UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypeKeyHolder *dst, 
    const UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType *dst, const
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType * sample = NULL;
    sample = (UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_new(void) 
{ 
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_finalize_optional_members;
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_key_kind;
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportType_get_typecode();
    #endif
    ...
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MM_WaterspacePlanStatus_WaterspacePlanReportTypePlugin_delete(struct PRESTypePlugin *plugin)
{
