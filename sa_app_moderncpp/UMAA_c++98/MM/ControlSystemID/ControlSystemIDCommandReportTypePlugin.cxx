...
/* ----------------------------------------------------------------------------
*  Type UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_finalize_ex" */
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_finalize_w_params(sample,dealloc_params);
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_data(
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_copy(dst,(const UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType*) src);
}
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType *key = NULL;

    key = new (std::nothrow) UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypeKeyHolder();

    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_finalize_ex(key,deallocate_pointers);
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_key(
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_finalize_optional_members(
    ...
    const UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType *src)
{
    ...
    return UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_get_typecode();
    pd.programs = UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType *sample)
{
    return UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypeKeyHolder *dst, 
    const UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType *dst, const
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType * sample = NULL;
    sample = (UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_new(void) 
{ 
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_finalize_optional_members;
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_key_kind;
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MM_ControlSystemID_ControlSystemIDCommandReportType_get_typecode();
    #endif
    ...
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MM_ControlSystemID_ControlSystemIDCommandReportTypePlugin_delete(struct PRESTypePlugin *plugin)
{
