...
/* ----------------------------------------------------------------------------
*  Type UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_finalize_ex" */
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_finalize_w_params(sample,dealloc_params);
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_data(
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_copy(dst,(const UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType*) src);
}
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType *key = NULL;

    key = new (std::nothrow) UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypeKeyHolder();

    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_finalize_ex(key,deallocate_pointers);
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_key(
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_finalize_optional_members(
    ...
    const UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType *src)
{
    ...
    return UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_get_typecode();
    pd.programs = UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType *sample)
{
    return UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypeKeyHolder *dst, 
    const UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType *dst, const
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType * sample = NULL;
    sample = (UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_new(void) 
{ 
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_finalize_optional_members;
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_key_kind;
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusType_get_typecode();
    #endif
    ...
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MM_MissionExecutionControl_MissionExecutionCommandStatusTypePlugin_delete(struct PRESTypePlugin *plugin)
{
