...
data type TaskStatusType from TaskStatusType.idl.
This example builds two applications, named TaskStatusType_publisher and
TaskStatusType_subscriber.
...
> make -f makefile_TaskStatusType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_TaskStatusType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the TaskStatusType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/TaskStatusType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/TaskStatusType_subscriber -d <domain_id> -s <sample_count>
