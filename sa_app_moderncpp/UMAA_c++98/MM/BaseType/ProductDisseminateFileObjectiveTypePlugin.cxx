...
/* ----------------------------------------------------------------------------
*  Type UMAA_MM_BaseType_ProductDisseminateFileObjectiveType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MM_BaseType_ProductDisseminateFileObjectiveType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_finalize_ex" */
...
UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_finalize_w_params(sample,dealloc_params);
...
UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_destroy_data(
    ...
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_copy(dst,(const UMAA_MM_BaseType_ProductDisseminateFileObjectiveType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    UMAA_Common_Measurement_NumericGUIDPluginSupport_print_data(
        (const UMAA_Common_Measurement_NumericGUID*) &sample->destinationID, "destinationID", indent_level + 1);

    if (sample->sourceURI==NULL) {
        RTICdrType_printString(
            NULL,"sourceURI", indent_level + 1);
    } else {
        RTICdrType_printString(
            sample->sourceURI,"sourceURI", indent_level + 1);    
    }
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_finalize_optional_members(
    ...
    const UMAA_MM_BaseType_ProductDisseminateFileObjectiveType *src)
{
    ...
    return UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_get_typecode();
    pd.programs = UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MM_BaseType_ProductDisseminateFileObjectiveType *sample)
{
    return UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_new(void) 
{ 
    ...
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_finalize_optional_members;
    ...
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MM_BaseType_ProductDisseminateFileObjectiveType_get_typecode();
    #endif
    ...
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MM_BaseType_ProductDisseminateFileObjectiveTypePlugin_delete(struct PRESTypePlugin *plugin)
{
