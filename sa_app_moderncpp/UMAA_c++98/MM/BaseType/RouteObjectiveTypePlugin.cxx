...
/* ----------------------------------------------------------------------------
*  Type UMAA_MM_BaseType_RouteObjectiveType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MM_BaseType_RouteObjectiveType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MM_BaseType_RouteObjectiveType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MM_BaseType_RouteObjectiveType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MM_BaseType_RouteObjectiveType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MM_BaseType_RouteObjectiveType_finalize_ex" */
...
UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MM_BaseType_RouteObjectiveType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MM_BaseType_RouteObjectiveType_finalize_w_params(sample,dealloc_params);
...
UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MM_BaseType_RouteObjectiveType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_destroy_data(
    ...
    UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MM_BaseType_RouteObjectiveType_copy(dst,(const UMAA_MM_BaseType_RouteObjectiveType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    if (sample->routeDescription==NULL) {
        RTICdrType_printString(
            NULL,"routeDescription", indent_level + 1);
    } else {
        RTICdrType_printString(
            sample->routeDescription,"routeDescription", indent_level + 1);    
    }

    if (UMAA_MM_BaseType_WaypointTypeSeq_get_contiguous_bufferI(&sample->waypoints) != NULL) {
        RTICdrType_printArray(
            UMAA_MM_BaseType_WaypointTypeSeq_get_contiguous_bufferI(&sample->waypoints), 
            (RTICdrUnsignedLong) UMAA_MM_BaseType_WaypointTypeSeq_get_length(&sample->waypoints),
        ...
        RTICdrType_printPointerArray(
            UMAA_MM_BaseType_WaypointTypeSeq_get_discontiguous_bufferI(&sample->waypoints), 
            (RTICdrUnsignedLong) UMAA_MM_BaseType_WaypointTypeSeq_get_length(&sample->waypoints),
            (RTICdrTypePrintFunction)UMAA_MM_BaseType_WaypointTypePluginSupport_print_data,
            "waypoints", indent_level + 1);
    }
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MM_BaseType_RouteObjectiveType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MM_BaseType_RouteObjectiveTypePlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MM_BaseType_RouteObjectiveTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MM_BaseType_RouteObjectiveTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MM_BaseType_RouteObjectiveType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MM_BaseType_RouteObjectiveTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_BaseType_RouteObjectiveType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MM_BaseType_RouteObjectiveType_finalize_optional_members(
    ...
    const UMAA_MM_BaseType_RouteObjectiveType *src)
{
    ...
    return UMAA_MM_BaseType_RouteObjectiveTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MM_BaseType_RouteObjectiveType_get_typecode();
    pd.programs = UMAA_MM_BaseType_RouteObjectiveTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MM_BaseType_RouteObjectiveTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MM_BaseType_RouteObjectiveType *sample)
{
    return UMAA_MM_BaseType_RouteObjectiveTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MM_BaseType_RouteObjectiveTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MM_BaseType_RouteObjectiveTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MM_BaseType_RouteObjectiveType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MM_BaseType_RouteObjectiveTypePlugin_new(void) 
{ 
    ...
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_finalize_optional_members;
    ...
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MM_BaseType_RouteObjectiveType_get_typecode();
    #endif
    ...
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MM_BaseType_RouteObjectiveTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MM_BaseType_RouteObjectiveTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MM_BaseType_RouteObjectiveTypePlugin_delete(struct PRESTypePlugin *plugin)
{
