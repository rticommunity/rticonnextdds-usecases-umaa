...
data type TaskExecutionCommandType from TaskExecutionCommandType.idl.
This example builds two applications, named TaskExecutionCommandType_publisher and
TaskExecutionCommandType_subscriber.
...
> make -f makefile_TaskExecutionCommandType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_TaskExecutionCommandType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the TaskExecutionCommandType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/TaskExecutionCommandType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/TaskExecutionCommandType_subscriber -d <domain_id> -s <sample_count>
