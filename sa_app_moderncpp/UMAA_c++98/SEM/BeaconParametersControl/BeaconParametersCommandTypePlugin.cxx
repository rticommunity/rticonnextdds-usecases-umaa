...
/* ----------------------------------------------------------------------------
*  Type UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType
* -------------------------------------------------------------------------- */
...
{
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_finalize_ex" */
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_finalize_w_params(sample,dealloc_params);
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_data_ex(
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_finalize_ex(sample,deallocate_pointers);
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_data(
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_copy(dst,(const UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType*) src);
}
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType *key = NULL;

    key = new (std::nothrow) UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypeKeyHolder();

    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_finalize_ex(key,deallocate_pointers);
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_key(
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_finalize_optional_members(
    ...
    const UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType *src)
{
    ...
    return UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_get_typecode();
    pd.programs = UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType *sample)
{
    return UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypeKeyHolder *dst, 
    const UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType *dst, const
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType * sample = NULL;
    sample = (UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_new(void) 
{ 
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_finalize_optional_members;
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_key_kind;
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_SEM_BeaconParametersControl_BeaconParametersCommandType_get_typecode();
    #endif
    ...
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_SEM_BeaconParametersControl_BeaconParametersCommandTypePlugin_delete(struct PRESTypePlugin *plugin)
{
