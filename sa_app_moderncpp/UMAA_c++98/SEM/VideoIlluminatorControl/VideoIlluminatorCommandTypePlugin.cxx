...
/* ----------------------------------------------------------------------------
*  Type UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType
* -------------------------------------------------------------------------- */
...
{
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_finalize_ex" */
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_finalize_w_params(sample,dealloc_params);
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_data_ex(
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_finalize_ex(sample,deallocate_pointers);
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_data(
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_copy(dst,(const UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType*) src);
}
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType *key = NULL;

    key = new (std::nothrow) UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypeKeyHolder();

    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_finalize_ex(key,deallocate_pointers);
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_key(
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_finalize_optional_members(
    ...
    const UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType *src)
{
    ...
    return UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_get_typecode();
    pd.programs = UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType *sample)
{
    return UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypeKeyHolder *dst, 
    const UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType *dst, const
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType * sample = NULL;
    sample = (UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_new(void) 
{ 
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_finalize_optional_members;
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_key_kind;
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandType_get_typecode();
    #endif
    ...
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_SEM_VideoIlluminatorControl_VideoIlluminatorCommandTypePlugin_delete(struct PRESTypePlugin *plugin)
{
