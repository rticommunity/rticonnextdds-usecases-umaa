...
data type H264VideoEncodingCommandType from H264VideoEncodingCommandType.idl.
This example builds two applications, named H264VideoEncodingCommandType_publisher and
H264VideoEncodingCommandType_subscriber.
...
> make -f makefile_H264VideoEncodingCommandType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_H264VideoEncodingCommandType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the H264VideoEncodingCommandType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/H264VideoEncodingCommandType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/H264VideoEncodingCommandType_subscriber -d <domain_id> -s <sample_count>
