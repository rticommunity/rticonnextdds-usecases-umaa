...
data type PanTiltJointVelocityReportType from PanTiltJointVelocityReportType.idl.
This example builds two applications, named PanTiltJointVelocityReportType_publisher and
PanTiltJointVelocityReportType_subscriber.
...
> make -f makefile_PanTiltJointVelocityReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_PanTiltJointVelocityReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the PanTiltJointVelocityReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/PanTiltJointVelocityReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/PanTiltJointVelocityReportType_subscriber -d <domain_id> -s <sample_count>
