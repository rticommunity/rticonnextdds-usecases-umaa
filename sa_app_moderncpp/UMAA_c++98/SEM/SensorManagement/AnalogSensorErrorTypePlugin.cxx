...
/* ----------------------------------------------------------------------------
*  Type UMAA_SEM_SensorManagement_AnalogSensorErrorType
* -------------------------------------------------------------------------- */
...
{
    UMAA_SEM_SensorManagement_AnalogSensorErrorType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_SEM_SensorManagement_AnalogSensorErrorType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_SEM_SensorManagement_AnalogSensorErrorType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_SEM_SensorManagement_AnalogSensorErrorType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_SEM_SensorManagement_AnalogSensorErrorType_finalize_ex" */
...
UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_SEM_SensorManagement_AnalogSensorErrorType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_SEM_SensorManagement_AnalogSensorErrorType_finalize_w_params(sample,dealloc_params);
...
UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_destroy_data_ex(
    ...
    UMAA_SEM_SensorManagement_AnalogSensorErrorType_finalize_ex(sample,deallocate_pointers);
...
UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_destroy_data(
    ...
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_SEM_SensorManagement_AnalogSensorErrorType_copy(dst,(const UMAA_SEM_SensorManagement_AnalogSensorErrorType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    UMAA_Common_MaritimeEnumeration_AnalogSensorErrorCodeEnumType_AnalogSensorErrorCodeEnumTypePluginSupport_print_data(
        (const UMAA_Common_MaritimeEnumeration_AnalogSensorErrorCodeEnumType_AnalogSensorErrorCodeEnumType*) &sample->errorCode, "errorCode", indent_level + 1);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_SEM_SensorManagement_AnalogSensorErrorType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_SEM_SensorManagement_AnalogSensorErrorType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_SensorManagement_AnalogSensorErrorType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_SEM_SensorManagement_AnalogSensorErrorType_finalize_optional_members(
    ...
    const UMAA_SEM_SensorManagement_AnalogSensorErrorType *src)
{
    ...
    return UMAA_SEM_SensorManagement_AnalogSensorErrorTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_SEM_SensorManagement_AnalogSensorErrorType_get_typecode();
    pd.programs = UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_SEM_SensorManagement_AnalogSensorErrorType *sample)
{
    return UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SEM_SensorManagement_AnalogSensorErrorType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_new(void) 
{ 
    ...
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_finalize_optional_members;
    ...
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_SEM_SensorManagement_AnalogSensorErrorType_get_typecode();
    #endif
    ...
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_SEM_SensorManagement_AnalogSensorErrorTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_SEM_SensorManagement_AnalogSensorErrorTypePlugin_delete(struct PRESTypePlugin *plugin)
{
