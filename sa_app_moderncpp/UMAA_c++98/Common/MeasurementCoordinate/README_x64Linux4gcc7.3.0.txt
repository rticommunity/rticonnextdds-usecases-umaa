...
data type  from Geographic_Coordinate_Axes.idl.
This example builds two applications, named Geographic_Coordinate_Axes_publisher and
Geographic_Coordinate_Axes_subscriber.
...
> make -f makefile_Geographic_Coordinate_Axes_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_Geographic_Coordinate_Axes_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the Geographic_Coordinate_Axes_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/Geographic_Coordinate_Axes_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/Geographic_Coordinate_Axes_subscriber -d <domain_id> -s <sample_count>
