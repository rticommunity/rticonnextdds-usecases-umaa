...
void UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_SelectorsPluginSupport_print_data(
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printEnum((RTICdrEnum *)sample, "UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Selectors", indent_level + 1);
}
...
/* ----------------------------------------------------------------------------
*  Type UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union
* -------------------------------------------------------------------------- */
...
{
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_finalize_ex" */
...
UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_destroy_data_w_params(
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_finalize_w_params(sample,dealloc_params);
...
UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_destroy_data_ex(
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_finalize_ex(sample,deallocate_pointers);
...
UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_destroy_data(
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_copy(dst,(const UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_SelectorsPluginSupport_print_data(
        (const UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Selectors*) &sample->_d, "_d", indent_level + 1);
        ...
        case (UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Selectors_ALTITUDEAGLTYPE_SELECT):
            {
                UMAA_Common_Measurement_AltitudeAGLTypePluginSupport_print_data(
                    (const UMAA_Common_Measurement_AltitudeAGLType*) &sample->_u.AltitudeAGLType_data, "_u.AltitudeAGLType_data", indent_level + 1);

        } break ;
        case (UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Selectors_ALTITUDEMSLTYPE_SELECT):
            {
                UMAA_Common_Measurement_AltitudeMSLTypePluginSupport_print_data(
                    (const UMAA_Common_Measurement_AltitudeMSLType*) &sample->_u.AltitudeMSLType_data, "_u.AltitudeMSLType_data", indent_level + 1);

        } break ;
        case (UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Selectors_ALTITUDEASFTYPE_SELECT):
            {
                UMAA_Common_Measurement_AltitudeASFTypePluginSupport_print_data(
                    (const UMAA_Common_Measurement_AltitudeASFType*) &sample->_u.AltitudeASFType_data, "_u.AltitudeASFType_data", indent_level + 1);
        ...
        case (UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Selectors_DEPTHTYPE_SELECT):
            {
                UMAA_Common_Measurement_DepthTypePluginSupport_print_data(
                    (const UMAA_Common_Measurement_DepthType*) &sample->_u.DepthType_data, "_u.DepthType_data", indent_level + 1);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_get_serialized_sample_max_size, epd,
...
UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_return_sample(
    ...
    void *handle)
{
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_finalize_optional_members(
    ...
    const UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union *src)
{
    ...
    return UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_get_typecode();
    pd.programs = UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union *sample)
{
    return UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_new(void) 
{ 
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_finalize_optional_members;
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union_get_typecode();
    #endif
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 

/* ----------------------------------------------------------------------------
*  Type UMAA_Common_Measurement_ElevationType
* -------------------------------------------------------------------------- */
...
UMAA_Common_Measurement_ElevationTypePluginSupport_create_data_w_params(
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    UMAA_Common_Measurement_ElevationType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_Common_Measurement_ElevationType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_Common_Measurement_ElevationType_initialize_w_params(sample,alloc_params)) {
        struct DDS_TypeDeallocationParams_t deallocParams =
        DDS_TYPE_DEALLOCATION_PARAMS_DEFAULT;
        deallocParams.delete_pointers = alloc_params->allocate_pointers;
        deallocParams.delete_optional_members = alloc_params->allocate_pointers;
        ...
        /* coverity[uninit_use_in_call : FALSE] */
        /* coverity[overwrite_var : FALSE] */
        UMAA_Common_Measurement_ElevationType_finalize_w_params(sample, &deallocParams);
        /* Coverity reports a possible leaked_storage on the sample members when 
        freeing sample. It is a false positive since all the members' memory 
        is freed in the call "UMAA_Common_Measurement_ElevationType_finalize_ex" */
        /* coverity[leaked_storage : FALSE] */
        delete  sample;
        sample=NULL;
    }
...
UMAA_Common_Measurement_ElevationTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_Common_Measurement_ElevationType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
        new fails. But if new fails then sample == null and the method will
        return before reach this point. */
        /* Coverity reports a possible overwrite_var on the members of the sample.
...
{
    return UMAA_Common_Measurement_ElevationTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_Common_Measurement_ElevationTypePluginSupport_destroy_data_w_params(
    ...
    const struct DDS_TypeDeallocationParams_t * dealloc_params) {
    UMAA_Common_Measurement_ElevationType_finalize_w_params(sample,dealloc_params);
...
UMAA_Common_Measurement_ElevationTypePluginSupport_destroy_data_ex(
    ...
    UMAA_Common_Measurement_ElevationType_finalize_ex(sample,deallocate_pointers);
...
UMAA_Common_Measurement_ElevationTypePluginSupport_destroy_data(
    ...
    UMAA_Common_Measurement_ElevationTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_Common_Measurement_ElevationType_copy(dst,(const UMAA_Common_Measurement_ElevationType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_UnionPluginSupport_print_data(
        (const UMAA_Common_Measurement_ElevationType_Specializations_ElevationType_Union*) &sample->ElevationType_subtypes, "ElevationType_subtypes", indent_level + 1);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        UMAA_Common_Measurement_ElevationType_get_typecode(),
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    if (programs == NULL) {
        PRESTypePluginDefaultParticipantData_delete(
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        endpoint_info,
        (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
        UMAA_Common_Measurement_ElevationTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_Common_Measurement_ElevationTypePluginSupport_destroy_data,
        NULL , NULL );
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_Common_Measurement_ElevationTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            endpoint_info,
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
            UMAA_Common_Measurement_ElevationTypePlugin_get_serialized_sample_max_size, epd,
            (PRESTypePluginGetSerializedSampleSizeFunction)
            PRESTypePlugin_interpretedGetSerializedSampleSize,
            epd) == RTI_FALSE) {
            PRESTypePluginDefaultEndpointData_delete(epd);
...
UMAA_Common_Measurement_ElevationTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_Common_Measurement_ElevationType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_Common_Measurement_ElevationTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_Common_Measurement_ElevationType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_Common_Measurement_ElevationType_finalize_optional_members(
        sample, deletePointers);
}
...
{
    if (endpoint_data) {} /* To avoid warnings */
    return UMAA_Common_Measurement_ElevationTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    plugin.typeCode = (struct RTICdrTypeCode *)
    UMAA_Common_Measurement_ElevationType_get_typecode();
    pd.programs = UMAA_Common_Measurement_ElevationTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_Common_Measurement_ElevationTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_Common_Measurement_ElevationType *sample)
{
    return UMAA_Common_Measurement_ElevationTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
        DDS_AUTO_DATA_REPRESENTATION);
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_Common_Measurement_ElevationTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
        return DDS_RETCODE_ERROR;
...
RTIBool UMAA_Common_Measurement_ElevationTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_Common_Measurement_ElevationType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_Common_Measurement_ElevationTypePlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_finalize_optional_members;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode = NULL; 
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_Common_Measurement_ElevationType_get_typecode();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPP_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_Common_Measurement_ElevationTypePlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    plugin->endpointTypeName = UMAA_Common_Measurement_ElevationTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_Common_Measurement_ElevationTypePlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
