...
extern "C"{
    ...
    #define UMAA_Common_Measurement_PrecipitationType_AllPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 

    #define UMAA_Common_Measurement_PrecipitationType_AllPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
    #define UMAA_Common_Measurement_PrecipitationType_AllPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer

    #define UMAA_Common_Measurement_PrecipitationType_AllPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
    #define UMAA_Common_Measurement_PrecipitationType_AllPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

    /* --------------------------------------------------------------------------------------
    Support functions:
    * -------------------------------------------------------------------------------------- */

    NDDSUSERDllExport extern UMAA_Common_Measurement_PrecipitationType_All*
    ...
    UMAA_Common_Measurement_PrecipitationType_AllPluginSupport_copy_data(
        UMAA_Common_Measurement_PrecipitationType_All *out,
        const UMAA_Common_Measurement_PrecipitationType_All *in);
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern RTIBool 
    UMAA_Common_Measurement_PrecipitationType_AllPlugin_deserialize_key(
        PRESTypePluginEndpointData endpoint_data,
        UMAA_Common_Measurement_PrecipitationType_All ** sample,
        RTIBool * drop_sample,
    ...
    UMAA_Common_Measurement_PrecipitationType_AllPlugin_new(void);

    NDDSUSERDllExport extern void
    UMAA_Common_Measurement_PrecipitationType_AllPlugin_delete(struct PRESTypePlugin *);
