...
data type WeatherSeverityType_All from WeatherSeverityType_All.idl.
This example builds two applications, named WeatherSeverityType_All_publisher and
WeatherSeverityType_All_subscriber.
...
> make -f makefile_WeatherSeverityType_All_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_WeatherSeverityType_All_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the WeatherSeverityType_All_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/WeatherSeverityType_All_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/WeatherSeverityType_All_subscriber -d <domain_id> -s <sample_count>
