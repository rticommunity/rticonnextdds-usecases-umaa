...
data type Speed_BSL_Requirement from Speed_BSL_Requirement.idl.
This example builds two applications, named Speed_BSL_Requirement_publisher and
Speed_BSL_Requirement_subscriber.
...
> make -f makefile_Speed_BSL_Requirement_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_Speed_BSL_Requirement_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the Speed_BSL_Requirement_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/Speed_BSL_Requirement_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/Speed_BSL_Requirement_subscriber -d <domain_id> -s <sample_count>
