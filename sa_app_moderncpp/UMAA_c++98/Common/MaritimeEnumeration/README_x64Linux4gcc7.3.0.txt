...
data type  from EnumerationSets.idl.
This example builds two applications, named EnumerationSets_publisher and
EnumerationSets_subscriber.
...
> make -f makefile_EnumerationSets_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_EnumerationSets_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the EnumerationSets_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/EnumerationSets_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/EnumerationSets_subscriber -d <domain_id> -s <sample_count>
