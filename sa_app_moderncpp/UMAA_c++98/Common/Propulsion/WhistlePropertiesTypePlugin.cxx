...
/* ----------------------------------------------------------------------------
*  Type UMAA_Common_Propulsion_WhistlePropertiesType
* -------------------------------------------------------------------------- */
...
{
    UMAA_Common_Propulsion_WhistlePropertiesType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_Common_Propulsion_WhistlePropertiesType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_Common_Propulsion_WhistlePropertiesType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_Common_Propulsion_WhistlePropertiesType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_Common_Propulsion_WhistlePropertiesType_finalize_ex" */
...
UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_Common_Propulsion_WhistlePropertiesType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_Common_Propulsion_WhistlePropertiesType_finalize_w_params(sample,dealloc_params);
...
UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_destroy_data_ex(
    ...
    UMAA_Common_Propulsion_WhistlePropertiesType_finalize_ex(sample,deallocate_pointers);
...
UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_destroy_data(
    ...
    UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_Common_Propulsion_WhistlePropertiesType_copy(dst,(const UMAA_Common_Propulsion_WhistlePropertiesType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printDouble(
        &sample->whistleNumber, "whistleNumber", indent_level + 1);    

    UMAA_Common_MaritimeEnumeration_BlastKindEnumType_BlastKindEnumTypePluginSupport_print_data(
        (const UMAA_Common_MaritimeEnumeration_BlastKindEnumType_BlastKindEnumType*) &sample->whistleType, "whistleType", indent_level + 1);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_Common_Propulsion_WhistlePropertiesType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_Common_Propulsion_WhistlePropertiesType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_Common_Propulsion_WhistlePropertiesType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_Common_Propulsion_WhistlePropertiesType_finalize_optional_members(
    ...
    const UMAA_Common_Propulsion_WhistlePropertiesType *src)
{
    ...
    return UMAA_Common_Propulsion_WhistlePropertiesTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_Common_Propulsion_WhistlePropertiesType_get_typecode();
    pd.programs = UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_Common_Propulsion_WhistlePropertiesType *sample)
{
    return UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_Common_Propulsion_WhistlePropertiesType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_new(void) 
{ 
    ...
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_finalize_optional_members;
    ...
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_Common_Propulsion_WhistlePropertiesType_get_typecode();
    #endif
    ...
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_Common_Propulsion_WhistlePropertiesTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_Common_Propulsion_WhistlePropertiesTypePlugin_delete(struct PRESTypePlugin *plugin)
{
