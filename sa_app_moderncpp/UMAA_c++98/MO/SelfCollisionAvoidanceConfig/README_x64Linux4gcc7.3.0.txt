...
data type SelfCollisionAvoidanceConfigReportType from SelfCollisionAvoidanceConfigReportType.idl.
This example builds two applications, named SelfCollisionAvoidanceConfigReportType_publisher and
SelfCollisionAvoidanceConfigReportType_subscriber.
...
> make -f makefile_SelfCollisionAvoidanceConfigReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_SelfCollisionAvoidanceConfigReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the SelfCollisionAvoidanceConfigReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/SelfCollisionAvoidanceConfigReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/SelfCollisionAvoidanceConfigReportType_subscriber -d <domain_id> -s <sample_count>
