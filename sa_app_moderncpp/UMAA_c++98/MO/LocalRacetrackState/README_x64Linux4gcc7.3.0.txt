...
data type LocalRacetrackTransitType from LocalRacetrackTransitType.idl.
This example builds two applications, named LocalRacetrackTransitType_publisher and
LocalRacetrackTransitType_subscriber.
...
> make -f makefile_LocalRacetrackTransitType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_LocalRacetrackTransitType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the LocalRacetrackTransitType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/LocalRacetrackTransitType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/LocalRacetrackTransitType_subscriber -d <domain_id> -s <sample_count>
