...
/* ----------------------------------------------------------------------------
*  Type UMAA_MO_StationkeepState_StationkeepingStationkeepType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MO_StationkeepState_StationkeepingStationkeepType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MO_StationkeepState_StationkeepingStationkeepType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MO_StationkeepState_StationkeepingStationkeepType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MO_StationkeepState_StationkeepingStationkeepType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MO_StationkeepState_StationkeepingStationkeepType_finalize_ex" */
...
UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MO_StationkeepState_StationkeepingStationkeepType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MO_StationkeepState_StationkeepingStationkeepType_finalize_w_params(sample,dealloc_params);
...
UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MO_StationkeepState_StationkeepingStationkeepType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_destroy_data(
    ...
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MO_StationkeepState_StationkeepingStationkeepType_copy(dst,(const UMAA_MO_StationkeepState_StationkeepingStationkeepType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printBoolean(
        &sample->bearingToContactAchieved, "bearingToContactAchieved", indent_level + 1);    

    RTICdrType_printBoolean(
        &sample->elevationAchieved, "elevationAchieved", indent_level + 1);    

    RTICdrType_printBoolean(
        &sample->rangeAchieved, "rangeAchieved", indent_level + 1);    
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MO_StationkeepState_StationkeepingStationkeepType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MO_StationkeepState_StationkeepingStationkeepType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_StationkeepState_StationkeepingStationkeepType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MO_StationkeepState_StationkeepingStationkeepType_finalize_optional_members(
    ...
    const UMAA_MO_StationkeepState_StationkeepingStationkeepType *src)
{
    ...
    return UMAA_MO_StationkeepState_StationkeepingStationkeepTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MO_StationkeepState_StationkeepingStationkeepType_get_typecode();
    pd.programs = UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MO_StationkeepState_StationkeepingStationkeepType *sample)
{
    return UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_StationkeepState_StationkeepingStationkeepType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_new(void) 
{ 
    ...
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_finalize_optional_members;
    ...
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MO_StationkeepState_StationkeepingStationkeepType_get_typecode();
    #endif
    ...
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MO_StationkeepState_StationkeepingStationkeepTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MO_StationkeepState_StationkeepingStationkeepTypePlugin_delete(struct PRESTypePlugin *plugin)
{
