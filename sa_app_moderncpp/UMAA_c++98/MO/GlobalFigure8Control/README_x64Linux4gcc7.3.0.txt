...
data type GlobalFigure8ExecutionStatusReportType from GlobalFigure8ExecutionStatusReportType.idl.
This example builds two applications, named GlobalFigure8ExecutionStatusReportType_publisher and
GlobalFigure8ExecutionStatusReportType_subscriber.
...
> make -f makefile_GlobalFigure8ExecutionStatusReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_GlobalFigure8ExecutionStatusReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the GlobalFigure8ExecutionStatusReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/GlobalFigure8ExecutionStatusReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/GlobalFigure8ExecutionStatusReportType_subscriber -d <domain_id> -s <sample_count>
