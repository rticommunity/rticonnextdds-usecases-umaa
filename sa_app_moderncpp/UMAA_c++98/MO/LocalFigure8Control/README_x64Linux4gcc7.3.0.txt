...
data type LocalFigure8ExecutionStatusReportType from LocalFigure8ExecutionStatusReportType.idl.
This example builds two applications, named LocalFigure8ExecutionStatusReportType_publisher and
LocalFigure8ExecutionStatusReportType_subscriber.
...
> make -f makefile_LocalFigure8ExecutionStatusReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_LocalFigure8ExecutionStatusReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the LocalFigure8ExecutionStatusReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/LocalFigure8ExecutionStatusReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/LocalFigure8ExecutionStatusReportType_subscriber -d <domain_id> -s <sample_count>
