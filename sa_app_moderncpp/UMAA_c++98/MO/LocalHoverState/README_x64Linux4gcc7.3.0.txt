...
data type LocalTransitHoverType from LocalTransitHoverType.idl.
This example builds two applications, named LocalTransitHoverType_publisher and
LocalTransitHoverType_subscriber.
...
> make -f makefile_LocalTransitHoverType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_LocalTransitHoverType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the LocalTransitHoverType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/LocalTransitHoverType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/LocalTransitHoverType_subscriber -d <domain_id> -s <sample_count>
