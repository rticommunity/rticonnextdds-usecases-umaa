...
data type SelfCollisionAvoidanceReportType from SelfCollisionAvoidanceReportType.idl.
This example builds two applications, named SelfCollisionAvoidanceReportType_publisher and
SelfCollisionAvoidanceReportType_subscriber.
...
> make -f makefile_SelfCollisionAvoidanceReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_SelfCollisionAvoidanceReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the SelfCollisionAvoidanceReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/SelfCollisionAvoidanceReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/SelfCollisionAvoidanceReportType_subscriber -d <domain_id> -s <sample_count>
