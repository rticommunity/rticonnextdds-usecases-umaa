...
data type GlobalRegularPolygonExecutionStatusReportType from GlobalRegularPolygonExecutionStatusReportType.idl.
This example builds two applications, named GlobalRegularPolygonExecutionStatusReportType_publisher and
GlobalRegularPolygonExecutionStatusReportType_subscriber.
...
> make -f makefile_GlobalRegularPolygonExecutionStatusReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_GlobalRegularPolygonExecutionStatusReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the GlobalRegularPolygonExecutionStatusReportType_publisher.cxx
file where it says:
...
Run /home/rti/rti_connext_dds-7.2.0/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/GlobalRegularPolygonExecutionStatusReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/GlobalRegularPolygonExecutionStatusReportType_subscriber -d <domain_id> -s <sample_count>
