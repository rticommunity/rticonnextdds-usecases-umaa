...
data type DriverConfigReportType from DriverConfigReportType.idl.
This example builds two applications, named DriverConfigReportType_publisher and
DriverConfigReportType_subscriber.
...
> make -f makefile_DriverConfigReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_DriverConfigReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the DriverConfigReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/DriverConfigReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/DriverConfigReportType_subscriber -d <domain_id> -s <sample_count>
