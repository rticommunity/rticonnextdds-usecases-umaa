...
/* ----------------------------------------------------------------------------
*  Type UMAA_MO_VelocityControl_VelocityCommandStatusType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MO_VelocityControl_VelocityCommandStatusType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MO_VelocityControl_VelocityCommandStatusType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MO_VelocityControl_VelocityCommandStatusType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MO_VelocityControl_VelocityCommandStatusType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MO_VelocityControl_VelocityCommandStatusType_finalize_ex" */
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MO_VelocityControl_VelocityCommandStatusType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusType_finalize_w_params(sample,dealloc_params);
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_data(
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MO_VelocityControl_VelocityCommandStatusType_copy(dst,(const UMAA_MO_VelocityControl_VelocityCommandStatusType*) src);
}
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_MO_VelocityControl_VelocityCommandStatusType *key = NULL;

    key = new (std::nothrow) UMAA_MO_VelocityControl_VelocityCommandStatusTypeKeyHolder();

    UMAA_MO_VelocityControl_VelocityCommandStatusType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_MO_VelocityControl_VelocityCommandStatusType_finalize_ex(key,deallocate_pointers);
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_key(
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MO_VelocityControl_VelocityCommandStatusType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MO_VelocityControl_VelocityCommandStatusType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_VelocityControl_VelocityCommandStatusType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MO_VelocityControl_VelocityCommandStatusType_finalize_optional_members(
    ...
    const UMAA_MO_VelocityControl_VelocityCommandStatusType *src)
{
    ...
    return UMAA_MO_VelocityControl_VelocityCommandStatusTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusType_get_typecode();
    pd.programs = UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MO_VelocityControl_VelocityCommandStatusType *sample)
{
    return UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_VelocityControl_VelocityCommandStatusType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_VelocityControl_VelocityCommandStatusTypeKeyHolder *dst, 
    const UMAA_MO_VelocityControl_VelocityCommandStatusType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_VelocityControl_VelocityCommandStatusType *dst, const
    UMAA_MO_VelocityControl_VelocityCommandStatusTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_MO_VelocityControl_VelocityCommandStatusType * sample = NULL;
    sample = (UMAA_MO_VelocityControl_VelocityCommandStatusType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_new(void) 
{ 
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_finalize_optional_members;
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_key_kind;
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MO_VelocityControl_VelocityCommandStatusType_get_typecode();
    #endif
    ...
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MO_VelocityControl_VelocityCommandStatusTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MO_VelocityControl_VelocityCommandStatusTypePlugin_delete(struct PRESTypePlugin *plugin)
{
