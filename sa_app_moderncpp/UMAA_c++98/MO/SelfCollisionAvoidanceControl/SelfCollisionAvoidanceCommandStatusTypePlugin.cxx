...
/* ----------------------------------------------------------------------------
*  Type UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType
* -------------------------------------------------------------------------- */
...
{
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_finalize_ex" */
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_finalize_w_params(sample,dealloc_params);
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_data_ex(
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_finalize_ex(sample,deallocate_pointers);
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_data(
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_copy(dst,(const UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType*) src);
}
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType *key = NULL;

    key = new (std::nothrow) UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypeKeyHolder();

    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_finalize_ex(key,deallocate_pointers);
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_key(
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_finalize_optional_members(
    ...
    const UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType *src)
{
    ...
    return UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_get_typecode();
    pd.programs = UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType *sample)
{
    return UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypeKeyHolder *dst, 
    const UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType *dst, const
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType * sample = NULL;
    sample = (UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_new(void) 
{ 
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_finalize_optional_members;
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_key_kind;
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusType_get_typecode();
    #endif
    ...
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_MO_SelfCollisionAvoidanceControl_SelfCollisionAvoidanceCommandStatusTypePlugin_delete(struct PRESTypePlugin *plugin)
{
