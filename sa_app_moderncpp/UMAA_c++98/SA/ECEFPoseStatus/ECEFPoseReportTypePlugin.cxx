...
/* ----------------------------------------------------------------------------
*  Type UMAA_SA_ECEFPoseStatus_ECEFPoseReportType
* -------------------------------------------------------------------------- */
...
{
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_SA_ECEFPoseStatus_ECEFPoseReportType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_finalize_ex" */
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_finalize_w_params(sample,dealloc_params);
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_data_ex(
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_finalize_ex(sample,deallocate_pointers);
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_data(
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_copy(dst,(const UMAA_SA_ECEFPoseStatus_ECEFPoseReportType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    UMAA_Common_Measurement_Orientation_PlatformECEFPluginSupport_print_data(
        (const UMAA_Common_Measurement_Orientation_PlatformECEF*) &sample->attitude, "attitude", indent_level + 1);

    RTICdrType_printDouble(
        &sample->xPosition, "xPosition", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->yPosition, "yPosition", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->zPosition, "zPosition", indent_level + 1);    
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType *key = NULL;

    key = new (std::nothrow) UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypeKeyHolder();

    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_finalize_ex(key,deallocate_pointers);
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_key(
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_finalize_optional_members(
    ...
    const UMAA_SA_ECEFPoseStatus_ECEFPoseReportType *src)
{
    ...
    return UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_get_typecode();
    pd.programs = UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_SA_ECEFPoseStatus_ECEFPoseReportType *sample)
{
    return UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypeKeyHolder *dst, 
    const UMAA_SA_ECEFPoseStatus_ECEFPoseReportType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType *dst, const
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportType * sample = NULL;
    sample = (UMAA_SA_ECEFPoseStatus_ECEFPoseReportType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_new(void) 
{ 
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_finalize_optional_members;
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_key_kind;
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_SA_ECEFPoseStatus_ECEFPoseReportType_get_typecode();
    #endif
    ...
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_SA_ECEFPoseStatus_ECEFPoseReportTypePlugin_delete(struct PRESTypePlugin *plugin)
{
