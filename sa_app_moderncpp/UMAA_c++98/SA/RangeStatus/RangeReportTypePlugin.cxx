...
/* ----------------------------------------------------------------------------
*  Type UMAA_SA_RangeStatus_RangeReportType
* -------------------------------------------------------------------------- */
...
{
    UMAA_SA_RangeStatus_RangeReportType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_SA_RangeStatus_RangeReportType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_SA_RangeStatus_RangeReportType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_SA_RangeStatus_RangeReportType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_SA_RangeStatus_RangeReportType_finalize_ex" */
...
UMAA_SA_RangeStatus_RangeReportTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_SA_RangeStatus_RangeReportType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_SA_RangeStatus_RangeReportTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_SA_RangeStatus_RangeReportType_finalize_w_params(sample,dealloc_params);
...
UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_data_ex(
    ...
    UMAA_SA_RangeStatus_RangeReportType_finalize_ex(sample,deallocate_pointers);
...
UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_data(
    ...
    UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_SA_RangeStatus_RangeReportType_copy(dst,(const UMAA_SA_RangeStatus_RangeReportType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    UMAA_Common_MaritimeEnumeration_CoordinateSystemEnumType_CoordinateSystemEnumTypePluginSupport_print_data(
        (const UMAA_Common_MaritimeEnumeration_CoordinateSystemEnumType_CoordinateSystemEnumType*) &sample->coordinateSystem, "coordinateSystem", indent_level + 1);

    if (UMAA_SA_RangeStatus_RangeDataPointTypeSeq_get_contiguous_bufferI(&sample->dataPoints) != NULL) {
        RTICdrType_printArray(
            UMAA_SA_RangeStatus_RangeDataPointTypeSeq_get_contiguous_bufferI(&sample->dataPoints), 
            (RTICdrUnsignedLong) UMAA_SA_RangeStatus_RangeDataPointTypeSeq_get_length(&sample->dataPoints),
            sizeof(UMAA_SA_RangeStatus_RangeDataPointType),
            (RTICdrTypePrintFunction)UMAA_SA_RangeStatus_RangeDataPointTypePluginSupport_print_data,
            "dataPoints", indent_level + 1);
    } else {
        RTICdrType_printPointerArray(
            UMAA_SA_RangeStatus_RangeDataPointTypeSeq_get_discontiguous_bufferI(&sample->dataPoints), 
            (RTICdrUnsignedLong) UMAA_SA_RangeStatus_RangeDataPointTypeSeq_get_length(&sample->dataPoints),
            (RTICdrTypePrintFunction)UMAA_SA_RangeStatus_RangeDataPointTypePluginSupport_print_data,
            "dataPoints", indent_level + 1);
    }
    ...
    UMAA_Common_MaritimeEnumeration_RangeErrorCodeEnumType_RangeErrorCodeEnumTypePluginSupport_print_data(
        (const UMAA_Common_MaritimeEnumeration_RangeErrorCodeEnumType_RangeErrorCodeEnumType*) &sample->rangeErrorCode, "rangeErrorCode", indent_level + 1);
...
UMAA_SA_RangeStatus_RangeReportTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_SA_RangeStatus_RangeReportType *key = NULL;

    key = new (std::nothrow) UMAA_SA_RangeStatus_RangeReportTypeKeyHolder();

    UMAA_SA_RangeStatus_RangeReportType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_SA_RangeStatus_RangeReportTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_SA_RangeStatus_RangeReportType_finalize_ex(key,deallocate_pointers);
...
UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_key(
    ...
    UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_SA_RangeStatus_RangeReportType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_SA_RangeStatus_RangeReportTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_SA_RangeStatus_RangeReportTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_SA_RangeStatus_RangeReportTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_SA_RangeStatus_RangeReportTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_SA_RangeStatus_RangeReportTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_SA_RangeStatus_RangeReportTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_SA_RangeStatus_RangeReportTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_SA_RangeStatus_RangeReportTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_SA_RangeStatus_RangeReportType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_SA_RangeStatus_RangeReportTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_RangeStatus_RangeReportType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_SA_RangeStatus_RangeReportType_finalize_optional_members(
    ...
    const UMAA_SA_RangeStatus_RangeReportType *src)
{
    ...
    return UMAA_SA_RangeStatus_RangeReportTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_SA_RangeStatus_RangeReportType_get_typecode();
    pd.programs = UMAA_SA_RangeStatus_RangeReportTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_SA_RangeStatus_RangeReportTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_SA_RangeStatus_RangeReportType *sample)
{
    return UMAA_SA_RangeStatus_RangeReportTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_SA_RangeStatus_RangeReportTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_SA_RangeStatus_RangeReportTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_RangeStatus_RangeReportType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_SA_RangeStatus_RangeReportTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_RangeStatus_RangeReportTypeKeyHolder *dst, 
    const UMAA_SA_RangeStatus_RangeReportType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_SA_RangeStatus_RangeReportTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SA_RangeStatus_RangeReportType *dst, const
    UMAA_SA_RangeStatus_RangeReportTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_SA_RangeStatus_RangeReportType * sample = NULL;
    sample = (UMAA_SA_RangeStatus_RangeReportType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_SA_RangeStatus_RangeReportTypePlugin_new(void) 
{ 
    ...
    UMAA_SA_RangeStatus_RangeReportTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_SA_RangeStatus_RangeReportTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_SA_RangeStatus_RangeReportTypePlugin_finalize_optional_members;
    ...
    UMAA_SA_RangeStatus_RangeReportTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_SA_RangeStatus_RangeReportTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_SA_RangeStatus_RangeReportTypePlugin_get_key_kind;
    ...
    UMAA_SA_RangeStatus_RangeReportTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_SA_RangeStatus_RangeReportTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_SA_RangeStatus_RangeReportType_get_typecode();
    #endif
    ...
    UMAA_SA_RangeStatus_RangeReportTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_SA_RangeStatus_RangeReportTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_SA_RangeStatus_RangeReportTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_SA_RangeStatus_RangeReportTypePlugin_delete(struct PRESTypePlugin *plugin)
{
