...
/* ----------------------------------------------------------------------------
*  Type UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType
* -------------------------------------------------------------------------- */
...
{
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_finalize_ex" */
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_finalize_w_params(sample,dealloc_params);
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_data_ex(
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_finalize_ex(sample,deallocate_pointers);
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_data(
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_copy(dst,(const UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType*) src);
}
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType *key = NULL;

    key = new (std::nothrow) UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypeKeyHolder();

    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_finalize_ex(key,deallocate_pointers);
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_key(
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_finalize_optional_members(
    ...
    const UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType *src)
{
    ...
    return UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_get_typecode();
    pd.programs = UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType *sample)
{
    return UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypeKeyHolder *dst, 
    const UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType *dst, const
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType * sample = NULL;
    sample = (UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_new(void) 
{ 
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_finalize_optional_members;
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_key_kind;
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusType_get_typecode();
    #endif
    ...
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_SO_HealthSummaryControl_HealthSummaryCommandStatusTypePlugin_delete(struct PRESTypePlugin *plugin)
{
