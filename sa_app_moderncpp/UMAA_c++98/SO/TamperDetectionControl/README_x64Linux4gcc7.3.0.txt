...
data type TamperDetectionCommandType from TamperDetectionCommandType.idl.
This example builds two applications, named TamperDetectionCommandType_publisher and
TamperDetectionCommandType_subscriber.
...
> make -f makefile_TamperDetectionCommandType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_TamperDetectionCommandType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the TamperDetectionCommandType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/TamperDetectionCommandType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/TamperDetectionCommandType_subscriber -d <domain_id> -s <sample_count>
