...
data type HealthSummaryReportType from HealthSummaryReportType.idl.
This example builds two applications, named HealthSummaryReportType_publisher and
HealthSummaryReportType_subscriber.
...
> make -f makefile_HealthSummaryReportType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_HealthSummaryReportType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the HealthSummaryReportType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/HealthSummaryReportType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/HealthSummaryReportType_subscriber -d <domain_id> -s <sample_count>
