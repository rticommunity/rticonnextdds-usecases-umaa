...
data type SituationalSignalCommandType from SituationalSignalCommandType.idl.
This example builds two applications, named SituationalSignalCommandType_publisher and
SituationalSignalCommandType_subscriber.
...
> make -f makefile_SituationalSignalCommandType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_SituationalSignalCommandType_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the SituationalSignalCommandType_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/SituationalSignalCommandType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/SituationalSignalCommandType_subscriber -d <domain_id> -s <sample_count>
