...
/* ----------------------------------------------------------------------------
*  Type UMAA_EO_LightControl_LightCommandAckReportType
* -------------------------------------------------------------------------- */
...
{
    UMAA_EO_LightControl_LightCommandAckReportType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_EO_LightControl_LightCommandAckReportType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_EO_LightControl_LightCommandAckReportType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_EO_LightControl_LightCommandAckReportType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_EO_LightControl_LightCommandAckReportType_finalize_ex" */
...
UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_EO_LightControl_LightCommandAckReportType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_EO_LightControl_LightCommandAckReportType_finalize_w_params(sample,dealloc_params);
...
UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_data_ex(
    ...
    UMAA_EO_LightControl_LightCommandAckReportType_finalize_ex(sample,deallocate_pointers);
...
UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_data(
    ...
    UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_EO_LightControl_LightCommandAckReportType_copy(dst,(const UMAA_EO_LightControl_LightCommandAckReportType*) src);
}
...
UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_EO_LightControl_LightCommandAckReportType *key = NULL;

    key = new (std::nothrow) UMAA_EO_LightControl_LightCommandAckReportTypeKeyHolder();

    UMAA_EO_LightControl_LightCommandAckReportType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_EO_LightControl_LightCommandAckReportType_finalize_ex(key,deallocate_pointers);
...
UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_key(
    ...
    UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_EO_LightControl_LightCommandAckReportType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_EO_LightControl_LightCommandAckReportTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_EO_LightControl_LightCommandAckReportType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_EO_LightControl_LightCommandAckReportTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_LightControl_LightCommandAckReportType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_EO_LightControl_LightCommandAckReportType_finalize_optional_members(
    ...
    const UMAA_EO_LightControl_LightCommandAckReportType *src)
{
    ...
    return UMAA_EO_LightControl_LightCommandAckReportTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_EO_LightControl_LightCommandAckReportType_get_typecode();
    pd.programs = UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_EO_LightControl_LightCommandAckReportTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_EO_LightControl_LightCommandAckReportType *sample)
{
    return UMAA_EO_LightControl_LightCommandAckReportTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_EO_LightControl_LightCommandAckReportTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_EO_LightControl_LightCommandAckReportTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_LightControl_LightCommandAckReportType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_EO_LightControl_LightCommandAckReportTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_LightControl_LightCommandAckReportTypeKeyHolder *dst, 
    const UMAA_EO_LightControl_LightCommandAckReportType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_EO_LightControl_LightCommandAckReportTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_LightControl_LightCommandAckReportType *dst, const
    UMAA_EO_LightControl_LightCommandAckReportTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_EO_LightControl_LightCommandAckReportType * sample = NULL;
    sample = (UMAA_EO_LightControl_LightCommandAckReportType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_EO_LightControl_LightCommandAckReportTypePlugin_new(void) 
{ 
    ...
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_finalize_optional_members;
    ...
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_key_kind;
    ...
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_EO_LightControl_LightCommandAckReportType_get_typecode();
    #endif
    ...
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_EO_LightControl_LightCommandAckReportTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_EO_LightControl_LightCommandAckReportTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_EO_LightControl_LightCommandAckReportTypePlugin_delete(struct PRESTypePlugin *plugin)
{
