...
/* ----------------------------------------------------------------------------
*  Type UMAA_EO_EngineStatus_EngineReportType
* -------------------------------------------------------------------------- */
...
{
    UMAA_EO_EngineStatus_EngineReportType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_EO_EngineStatus_EngineReportType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_EO_EngineStatus_EngineReportType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_EO_EngineStatus_EngineReportType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_EO_EngineStatus_EngineReportType_finalize_ex" */
...
UMAA_EO_EngineStatus_EngineReportTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_EO_EngineStatus_EngineReportType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_EO_EngineStatus_EngineReportTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_EO_EngineStatus_EngineReportType_finalize_w_params(sample,dealloc_params);
...
UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_data_ex(
    ...
    UMAA_EO_EngineStatus_EngineReportType_finalize_ex(sample,deallocate_pointers);
...
UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_data(
    ...
    UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_EO_EngineStatus_EngineReportType_copy(dst,(const UMAA_EO_EngineStatus_EngineReportType*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printDouble(
        &sample->coolantLevel, "coolantLevel", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->coolantPressure, "coolantPressure", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->coolantTemp, "coolantTemp", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->engineTemp, "engineTemp", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->exhaustTemp, "exhaustTemp", indent_level + 1);    

    RTICdrType_printBoolean(
        sample->glowPlugIndicator, "glowPlugIndicator", indent_level + 1);    

    UMAA_Common_Enumeration_OnOffStatusEnumType_OnOffStatusEnumTypePluginSupport_print_data(
        (const UMAA_Common_Enumeration_OnOffStatusEnumType_OnOffStatusEnumType*) sample->glowPlugState, "glowPlugState", indent_level + 1);

    RTICdrType_printDouble(
        sample->glowPlugTemp, "glowPlugTemp", indent_level + 1);    

    RTICdrType_printDouble(
        sample->glowPlugTimeRemaining, "glowPlugTimeRemaining", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->hours, "hours", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->manifoldAirTemp, "manifoldAirTemp", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->manifoldPressure, "manifoldPressure", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->oilLevel, "oilLevel", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->oilPressure, "oilPressure", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->oilTemp, "oilTemp", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->percentOilPressure, "percentOilPressure", indent_level + 1);    
...
UMAA_EO_EngineStatus_EngineReportTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    UMAA_EO_EngineStatus_EngineReportType *key = NULL;

    key = new (std::nothrow) UMAA_EO_EngineStatus_EngineReportTypeKeyHolder();

    UMAA_EO_EngineStatus_EngineReportType_initialize_ex(key,allocate_pointers, RTI_TRUE);
...
{
    return  UMAA_EO_EngineStatus_EngineReportTypePluginSupport_create_key_ex(RTI_TRUE);
}
...
{
    UMAA_EO_EngineStatus_EngineReportType_finalize_ex(key,deallocate_pointers);
...
UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_key(
    ...
    UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_EO_EngineStatus_EngineReportType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_EO_EngineStatus_EngineReportTypePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_data,
        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
        UMAA_EO_EngineStatus_EngineReportTypePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        UMAA_EO_EngineStatus_EngineReportTypePluginSupport_destroy_key);
    ...
    serializedKeyMaxSize =  UMAA_EO_EngineStatus_EngineReportTypePlugin_get_serialized_key_max_size(
        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
    serializedKeyMaxSizeV2 =  UMAA_EO_EngineStatus_EngineReportTypePlugin_get_serialized_key_max_size_for_keyhash(
        epd,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_EO_EngineStatus_EngineReportTypePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_EO_EngineStatus_EngineReportTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_EO_EngineStatus_EngineReportTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_EO_EngineStatus_EngineReportType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_EO_EngineStatus_EngineReportTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_EngineStatus_EngineReportType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_EO_EngineStatus_EngineReportType_finalize_optional_members(
    ...
    const UMAA_EO_EngineStatus_EngineReportType *src)
{
    ...
    return UMAA_EO_EngineStatus_EngineReportTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_EO_EngineStatus_EngineReportType_get_typecode();
    pd.programs = UMAA_EO_EngineStatus_EngineReportTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_EO_EngineStatus_EngineReportTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_EO_EngineStatus_EngineReportType *sample)
{
    return UMAA_EO_EngineStatus_EngineReportTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_EO_EngineStatus_EngineReportTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_EO_EngineStatus_EngineReportTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_EngineStatus_EngineReportType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
UMAA_EO_EngineStatus_EngineReportTypePlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_EngineStatus_EngineReportTypeKeyHolder *dst, 
    const UMAA_EO_EngineStatus_EngineReportType *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
...
UMAA_EO_EngineStatus_EngineReportTypePlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_EngineStatus_EngineReportType *dst, const
    UMAA_EO_EngineStatus_EngineReportTypeKeyHolder *src)
{
    if (endpoint_data) {} /* To avoid warnings */   
    if (!UMAA_Common_Measurement_NumericGUID_copy(
        &dst->source,
...
{   
    UMAA_EO_EngineStatus_EngineReportType * sample = NULL;
    sample = (UMAA_EO_EngineStatus_EngineReportType *)
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_EO_EngineStatus_EngineReportTypePlugin_new(void) 
{ 
    ...
    UMAA_EO_EngineStatus_EngineReportTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_EO_EngineStatus_EngineReportTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_EO_EngineStatus_EngineReportTypePlugin_finalize_optional_members;
    ...
    UMAA_EO_EngineStatus_EngineReportTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_EO_EngineStatus_EngineReportTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_EO_EngineStatus_EngineReportTypePlugin_get_key_kind;
    ...
    UMAA_EO_EngineStatus_EngineReportTypePlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    UMAA_EO_EngineStatus_EngineReportTypePlugin_return_key;
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_EO_EngineStatus_EngineReportType_get_typecode();
    #endif
    ...
    UMAA_EO_EngineStatus_EngineReportTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_EO_EngineStatus_EngineReportTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_EO_EngineStatus_EngineReportTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_EO_EngineStatus_EngineReportTypePlugin_delete(struct PRESTypePlugin *plugin)
{
