...
/* ----------------------------------------------------------------------------
*  Type UMAA_EO_ThrusterSpecs_ThrusterSpecsType
* -------------------------------------------------------------------------- */
...
{
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType *sample = NULL;
    ...
    sample = new (std::nothrow) UMAA_EO_ThrusterSpecs_ThrusterSpecsType();
    if (sample == NULL) {
        return NULL;
    }

    if (!UMAA_EO_ThrusterSpecs_ThrusterSpecsType_initialize_w_params(sample,alloc_params)) {
        ...
        UMAA_EO_ThrusterSpecs_ThrusterSpecsType_finalize_w_params(sample, &deallocParams);
        ...
        is freed in the call "UMAA_EO_ThrusterSpecs_ThrusterSpecsType_finalize_ex" */
...
UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!UMAA_EO_ThrusterSpecs_ThrusterSpecsType_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        /* Coverity reports a possible uninit_use_in_call that will happen if the
...
{
    return UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_create_data_ex(RTI_TRUE);
}
...
UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_destroy_data_w_params(
    ...
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType_finalize_w_params(sample,dealloc_params);
...
UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_destroy_data_ex(
    ...
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType_finalize_ex(sample,deallocate_pointers);
...
UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_destroy_data(
    ...
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return UMAA_EO_ThrusterSpecs_ThrusterSpecsType_copy(dst,(const UMAA_EO_ThrusterSpecs_ThrusterSpecsType*) src);
}
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        UMAA_EO_ThrusterSpecs_ThrusterSpecsType_get_typecode(),
        &programProperty,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_get_serialized_sample_max_size, epd,
...
UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_return_sample(
    ...
    void *handle)
{
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType_finalize_optional_members(sample, RTI_TRUE);

    PRESTypePluginDefaultEndpointData_returnSample(
        endpoint_data, sample, handle);
}

void UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_finalize_optional_members(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType* sample,
    RTIBool deletePointers)
{
    RTIOsapiUtility_unusedParameter(endpoint_data);
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType_finalize_optional_members(
    ...
    const UMAA_EO_ThrusterSpecs_ThrusterSpecsType *src)
{
    ...
    return UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType_get_typecode();
    pd.programs = UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_serialize_to_cdr_buffer(
    ...
    const UMAA_EO_ThrusterSpecs_ThrusterSpecsType *sample)
{
    return UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    UMAA_EO_ThrusterSpecs_ThrusterSpecsType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_new(void) 
{ 
    ...
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_finalize_optional_members;
    ...
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)UMAA_EO_ThrusterSpecs_ThrusterSpecsType_get_typecode();
    #endif
    ...
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_return_buffer;
    ...
    plugin->endpointTypeName = UMAA_EO_ThrusterSpecs_ThrusterSpecsTypeTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
UMAA_EO_ThrusterSpecs_ThrusterSpecsTypePlugin_delete(struct PRESTypePlugin *plugin)
{
