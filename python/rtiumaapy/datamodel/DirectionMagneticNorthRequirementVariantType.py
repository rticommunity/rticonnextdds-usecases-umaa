...
from DirectionMagneticNorthRequirement import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Orientation::DirectionMagneticNorthRequirementVariantType"), idl.xtypes_compliance(0x0000018C), ])
