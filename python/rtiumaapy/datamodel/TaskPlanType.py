...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::TaskPlanType"), idl.xtypes_compliance(0x0000018C), ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::TaskPlanTypeObjectivesSetElement"), idl.xtypes_compliance(0x0000018C), ],
