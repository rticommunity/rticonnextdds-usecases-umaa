...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::TaskPlanType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'name': [idl.bound(1023)],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::TaskPlanTypeObjectivesSetElement"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'setID': [idl.key, ],
        'elementID': [idl.key, ],
    }
