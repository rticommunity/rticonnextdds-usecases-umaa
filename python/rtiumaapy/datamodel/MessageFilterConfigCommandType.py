...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::CO::MessageFilterConfig::MessageFilterConfigCommandType"), idl.xtypes_compliance(0x0000018C), ],
