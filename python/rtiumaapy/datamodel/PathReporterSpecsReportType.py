...
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/SA/PathReporterSpecs/'))
from PathReporterType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SA::PathReporterSpecs::PathReporterSpecsReportType"), idl.xtypes_compliance(0x0000018C), ],
