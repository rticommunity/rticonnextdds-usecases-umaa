...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::ConditionalReport::ConditionalReportType"), idl.xtypes_compliance(0x0000018C), ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::ConditionalReport::ConditionalReportTypeConditionalsSetElement"), idl.xtypes_compliance(0x0000018C), ],
