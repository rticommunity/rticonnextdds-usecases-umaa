...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::ConditionalReport::ConditionalReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
    }
)
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::ConditionalReport::ConditionalReportTypeConditionalsSetElement"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'setID': [idl.key, ],
        'elementID': [idl.key, ],
    }
