...
from ObjectiveDetailedStatusType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorExecutionStatusReportType"), idl.xtypes_compliance(0x0000018C), ],
