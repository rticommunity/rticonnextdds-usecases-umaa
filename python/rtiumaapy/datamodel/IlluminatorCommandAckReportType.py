...
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/SEM/IlluminatorControl/'))
from IlluminatorCommandType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SEM::IlluminatorControl::IlluminatorCommandAckReportType"), idl.xtypes_compliance(0x0000018C), ],
