...
@idl.union(
    type_annotations = [idl.type_name("UMAA::Common::Orientation::DirectionVariantTypeUnion"), idl.xtypes_compliance(0x0000068C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Orientation::DirectionVariantType"), idl.xtypes_compliance(0x0000068C), ])
