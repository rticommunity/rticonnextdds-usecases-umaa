...
from AltitudeMSLToleranceType import *
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/Common/Measurement/'))
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Measurement::AltitudeMSLRequirementType"), idl.xtypes_compliance(0x0000068C), ])
