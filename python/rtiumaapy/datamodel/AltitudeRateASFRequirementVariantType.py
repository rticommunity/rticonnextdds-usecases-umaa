...
from AltitudeRateASFRequirementType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Measurement::AltitudeRateASFRequirementVariantType"), idl.xtypes_compliance(0x0000068C), ])
