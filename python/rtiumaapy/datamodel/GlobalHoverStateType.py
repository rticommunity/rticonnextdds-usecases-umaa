...
@idl.union(
    type_annotations = [idl.type_name("UMAA::MO::GlobalHoverState::GlobalHoverStateTypeUnion"), idl.xtypes_compliance(0x0000018C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MO::GlobalHoverState::GlobalHoverStateType"), idl.xtypes_compliance(0x0000018C), ])
