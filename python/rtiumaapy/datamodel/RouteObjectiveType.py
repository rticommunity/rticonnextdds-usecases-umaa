...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::RouteObjectiveType"), idl.xtypes_compliance(0x0000018C), ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::RouteObjectiveTypeWaypointsListElement"), idl.xtypes_compliance(0x0000018C), ],
