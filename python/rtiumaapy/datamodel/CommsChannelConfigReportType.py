...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::CO::CommsChannelConfig::CommsChannelConfigReportType"), idl.xtypes_compliance(0x0000018C), ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::CO::CommsChannelConfig::CommsChannelConfigReportTypeMessageConfigsSetElement"), idl.xtypes_compliance(0x0000018C), ],
