...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
        'sessionID': [idl.key, ],
        'destination': [idl.key, ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandTypeWaypointsListElement"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'listID': [idl.key, ],
        'elementID': [idl.key, ],
    }
