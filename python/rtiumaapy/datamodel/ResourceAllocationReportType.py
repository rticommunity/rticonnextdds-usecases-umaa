...
from ResourceAllocationControlInfo import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SO::ResourceAllocation::ResourceAllocationReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
