...
from DirectionTurnRateRequirementType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Orientation::DirectionTurnRateRequirementVariantType"), idl.xtypes_compliance(0x0000068C), ])
