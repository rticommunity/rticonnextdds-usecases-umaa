...
@idl.union(
    type_annotations = [idl.type_name("UMAA::Common::Speed::SpeedRequirementVariantTypeUnion"), idl.xtypes_compliance(0x0000068C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Speed::SpeedRequirementVariantType"), idl.xtypes_compliance(0x0000068C), ])
