...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::RouteObjectiveDetailedStatusType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::RouteObjectiveDetailedStatusTypeWaypointDetailedStatusSetElement"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'setID': [idl.key, ],
        'elementID': [idl.key, ],
    }
