...
from DirectionWindRequirement import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Orientation::DirectionWindRequirementVariantType"), idl.xtypes_compliance(0x0000018C), ])
