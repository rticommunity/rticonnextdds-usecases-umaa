...
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/SO/EmitterPresetConfig/'))
from EmitterPresetConfigCommandType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SO::EmitterPresetConfig::EmitterPresetConfigAckReportType"), idl.xtypes_compliance(0x0000018C), ],
