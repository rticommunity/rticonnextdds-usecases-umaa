...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SA::ContactReport::ContactReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
    }
)
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SA::ContactReport::ContactReportTypeContactsSetElement"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'setID': [idl.key, ],
        'elementID': [idl.key, ],
    }
