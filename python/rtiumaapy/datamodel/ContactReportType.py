...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SA::ContactReport::ContactReportType"), idl.xtypes_compliance(0x0000018C), ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SA::ContactReport::ContactReportTypeContactsSetElement"), idl.xtypes_compliance(0x0000018C), ],
