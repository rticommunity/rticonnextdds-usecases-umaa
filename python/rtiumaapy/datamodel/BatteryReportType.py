...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::EO::BatteryStatus::BatteryReportType"), idl.xtypes_compliance(0x0000018C), ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::EO::BatteryStatus::BatteryReportTypeCellsListElement"), idl.xtypes_compliance(0x0000018C), ],
