...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::EO::BatteryStatus::BatteryReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
    }
)
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::EO::BatteryStatus::BatteryReportTypeCellsListElement"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'listID': [idl.key, ],
        'elementID': [idl.key, ],
    }
