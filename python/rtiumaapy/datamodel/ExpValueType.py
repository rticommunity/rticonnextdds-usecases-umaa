...
@idl.union(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::ExpValueTypeUnion"), idl.xtypes_compliance(0x0000018C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::BaseType::ExpValueType"), idl.xtypes_compliance(0x0000018C), ])
