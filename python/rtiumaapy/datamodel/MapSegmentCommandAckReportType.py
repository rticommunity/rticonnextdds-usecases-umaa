...
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/SEM/MapSegmentControl/'))
from MapSegmentCommandType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SEM::MapSegmentControl::MapSegmentCommandAckReportType"), idl.xtypes_compliance(0x0000018C), ],
