...
from AltitudeGeodeticToleranceType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Measurement::AltitudeGeodeticRequirementType"), idl.xtypes_compliance(0x0000018C), ])
