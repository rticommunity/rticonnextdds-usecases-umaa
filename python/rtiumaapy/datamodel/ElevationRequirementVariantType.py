...
@idl.union(
    type_annotations = [idl.type_name("UMAA::Common::Measurement::ElevationRequirementVariantTypeUnion"), idl.xtypes_compliance(0x0000018C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Measurement::ElevationRequirementVariantType"), idl.xtypes_compliance(0x0000018C), ])
