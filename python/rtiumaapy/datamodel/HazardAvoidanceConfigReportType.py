...
from ContactHazardAvoidanceType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MO::HazardAvoidanceConfig::HazardAvoidanceConfigReportType"), idl.xtypes_compliance(0x0000018C), ],
