...
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/MO/FreeFloatControl/'))
from FreeFloatCommandType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MO::FreeFloatControl::FreeFloatCommandAckReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
        'sessionID': [idl.key, ],
    }
