...
@idl.union(
    type_annotations = [idl.type_name("UMAA::Common::Propulsion::PropulsionTypeUnion"), idl.xtypes_compliance(0x0000068C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Propulsion::PropulsionType"), idl.xtypes_compliance(0x0000068C), ])
