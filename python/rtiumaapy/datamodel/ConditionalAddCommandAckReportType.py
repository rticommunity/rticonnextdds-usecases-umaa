...
from ConditionalAddCommandType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::MM::ConditionalControl::ConditionalAddCommandAckReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
        'sessionID': [idl.key, ],
    }
