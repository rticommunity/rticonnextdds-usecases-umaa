...
from RollXNEDTolerance import *
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/Common/Orientation/'))
from RollXNEDType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Orientation::RollXNEDRequirement"), idl.xtypes_compliance(0x0000018C), ])
