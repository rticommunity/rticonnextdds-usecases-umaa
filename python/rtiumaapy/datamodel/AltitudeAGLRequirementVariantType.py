...
from AltitudeAGLRequirementType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::Common::Measurement::AltitudeAGLRequirementVariantType"), idl.xtypes_compliance(0x0000068C), ])
