...
@idl.union(
    type_annotations = [idl.type_name("UMAA::CO::Filter::MessageFilterTypeUnion"), idl.xtypes_compliance(0x0000018C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::CO::Filter::MessageFilterType"), idl.xtypes_compliance(0x0000018C), ])
