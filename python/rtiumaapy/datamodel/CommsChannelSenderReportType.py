...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::CO::CommsChannelStatus::CommsChannelSenderReportType"), idl.xtypes_compliance(0x0000018C), ],
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::CO::CommsChannelStatus::CommsChannelSenderReportTypeQueuedMessagesListElement"), idl.xtypes_compliance(0x0000018C), ],
