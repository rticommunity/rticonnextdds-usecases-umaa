...
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/EO/FinsControl/'))
from FinsCommandType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::EO::FinsControl::FinsCommandAckReportType"), idl.xtypes_compliance(0x0000018C), ],
