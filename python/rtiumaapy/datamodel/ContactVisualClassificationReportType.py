...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SA::ContactVisualClassificationStatus::ContactVisualClassificationReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
        'contactID': [idl.key, ],
        'visualClassification': [idl.key, ],
    }
)
