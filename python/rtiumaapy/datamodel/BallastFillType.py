...
@idl.union(
    type_annotations = [idl.type_name("UMAA::EO::BallastTank::BallastFillTypeUnion"), idl.xtypes_compliance(0x0000068C), ])
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::EO::BallastTank::BallastFillType"), idl.xtypes_compliance(0x0000068C), ])
