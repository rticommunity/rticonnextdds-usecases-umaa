...
sys.path.pop()
sys.path.append(os.path.join(os.path.dirname(__file__), 'UMAA/SO/ClearDataControl/'))
from ClearDataCommandType import *
sys.path.pop()
...
@idl.struct(
    type_annotations = [idl.type_name("UMAA::SO::ClearDataControl::ClearDataCommandAckReportType"), idl.xtypes_compliance(0x0000068C), ],
    member_annotations = {
        'source': [idl.key, ],
        'sessionID': [idl.key, ],
    }
