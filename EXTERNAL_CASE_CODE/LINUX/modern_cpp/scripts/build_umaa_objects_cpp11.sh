...
cd $UMAA_HOME
echo "$(date)"
$UMAA_HOME/scripts/gen_idl_cpp11.sh UMAA/Common
$UMAA_HOME/scripts/gen_idl_cpp11.sh BasicTypes
find ./UMAA -maxdepth 2 -mindepth 2  -type d -exec $UMAA_HOME/scripts/gen_idl_cpp11.sh {} \;
