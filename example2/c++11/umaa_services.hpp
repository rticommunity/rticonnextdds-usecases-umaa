...
{
public:
  GlobalVectorControlServiceProvider(std::shared_ptr<DDSUMAAParticipant> &dp) : DDSUMAAControlService(dp,
...
{
public:
  GlobalVectorControlServiceConsumer(std::shared_ptr<DDSUMAAParticipant> &dp) : DDSUMAAControlService(dp,
