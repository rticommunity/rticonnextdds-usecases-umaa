...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PowerControl {
            ...
            PowerCommandAckReportType::PowerCommandAckReportType (const ::UMAA::EO::PowerControl::PowerCommandType& command_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_command_(command_), 
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::PowerControl::PowerCommandAckReportType > {
            static DDS_TypeCode * get()
            {
                ...
                PowerCommandAckReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::EO::PowerControl::PowerCommandType>::get().native();
                PowerCommandAckReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                PowerCommandAckReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
