...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace PowerControl {
            ...
            PowerCommandType::PowerCommandType (const ::UMAA::Common::IdentifierType& resourceID_,const ::UMAA::Common::MaritimeEnumeration::PowerStateEnumModule::PowerStateEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::IdentifierType& destination_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::PowerControl::PowerCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                PowerCommandType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                PowerCommandType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::PowerStateEnumModule::PowerStateEnumType>::get().native();
                PowerCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                PowerCommandType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                PowerCommandType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
