...
#ifndef PropulsorsCommandStatusType_1801749195_hpp
#define PropulsorsCommandStatusType_1801749195_hpp
...
namespace UMAA {
    namespace EO {
        namespace PropulsorsControl {
            ...
            static const std::string PropulsorsCommandStatusTypeTopic = "UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType";

            class NDDSUSERDllExport PropulsorsCommandStatusType {
              public:

                PropulsorsCommandStatusType();

                PropulsorsCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const PropulsorsCommandStatusType& other_) const;
                bool operator != (const PropulsorsCommandStatusType& other_) const;

                void swap(PropulsorsCommandStatusType& other_) noexcept ;
            ...
            inline void swap(PropulsorsCommandStatusType& a, PropulsorsCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const PropulsorsCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::EO::PropulsorsControl::PropulsorsCommandStatusType > {
...
#endif // PropulsorsCommandStatusType_1801749195_hpp
