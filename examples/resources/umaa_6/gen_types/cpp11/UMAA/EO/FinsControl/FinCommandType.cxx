...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace FinsControl {
            ...
            FinCommandType::FinCommandType (double deflection_,const ::dds::core::optional< double >& deflectionRate_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::IdentifierType& destination_):
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct native_type_code< ::UMAA::EO::FinsControl::FinCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"UMAA::EO::FinsControl::FinCommandType", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                FinCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                FinCommandType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                FinCommandType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                FinCommandType_g_tc_members[1]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                FinCommandType_g_tc_members[1]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                FinCommandType_g_tc_members[1]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                ::UMAA::EO::FinsControl::FinCommandType *sample;
                ...
                {
                    size_t candidateTypeSize = sizeof(::UMAA::EO::FinsControl::FinCommandType);
                ...
                interpreter::get_aggregation_value_pointer< ::UMAA::EO::FinsControl::FinCommandType >;
        ...
        const ::dds::core::xtypes::StructType& dynamic_type< ::UMAA::EO::FinsControl::FinCommandType >::get()
        {
            return static_cast<const ::dds::core::xtypes::StructType&>(
                ::rti::core::native_conversions::cast_from_native< ::dds::core::xtypes::DynamicType >(
                    *(native_type_code< ::UMAA::EO::FinsControl::FinCommandType >::get())));
        }
    }
}
...
namespace dds { 
    namespace topic {
        void topic_type_support< ::UMAA::EO::FinsControl::FinCommandType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                ::UMAA::EO::FinsControl::FinCommandTypePlugin_new,
                ::UMAA::EO::FinsControl::FinCommandTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< ::UMAA::EO::FinsControl::FinCommandType >::to_cdr_buffer(
            std::vector<char>& buffer, 
            const ::UMAA::EO::FinsControl::FinCommandType& sample,
        ...
        void topic_type_support< ::UMAA::EO::FinsControl::FinCommandType >::from_cdr_buffer(::UMAA::EO::FinsControl::FinCommandType& sample, 
        const std::vector<char>& buffer)
        {
            ...
            "Failed to create ::UMAA::EO::FinsControl::FinCommandType from cdr buffer");
        }

        void topic_type_support< ::UMAA::EO::FinsControl::FinCommandType >::reset_sample(::UMAA::EO::FinsControl::FinCommandType& sample) 
        {
        ...
        void topic_type_support< ::UMAA::EO::FinsControl::FinCommandType >::allocate_sample(::UMAA::EO::FinsControl::FinCommandType& sample, int, int) 
        {
