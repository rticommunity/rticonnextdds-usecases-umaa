...
#ifndef FinsCommandStatusType_853033016_hpp
#define FinsCommandStatusType_853033016_hpp
...
namespace UMAA {
    namespace EO {
        namespace FinsControl {
            ...
            static const std::string FinsCommandStatusTypeTopic = "UMAA::EO::FinsControl::FinsCommandStatusType";

            class NDDSUSERDllExport FinsCommandStatusType {
              public:
                ...
                bool operator == (const FinsCommandStatusType& other_) const;
                bool operator != (const FinsCommandStatusType& other_) const;

                void swap(FinsCommandStatusType& other_) noexcept ;
            ...
            inline void swap(FinsCommandStatusType& a, FinsCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const FinsCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::EO::FinsControl::FinsCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::EO::FinsControl::FinsCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::EO::FinsControl::FinsCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::EO::FinsControl::FinsCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::EO::FinsControl::FinsCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::EO::FinsControl::FinsCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::EO::FinsControl::FinsCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::EO::FinsControl::FinsCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::EO::FinsControl::FinsCommandStatusType > {
...
#endif // FinsCommandStatusType_853033016_hpp
