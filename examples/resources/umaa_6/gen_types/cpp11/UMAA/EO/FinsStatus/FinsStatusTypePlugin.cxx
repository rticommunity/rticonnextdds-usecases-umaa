    ...
    namespace EO {
        namespace FinsStatus {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FinsStatusType *sample = new FinsStatusType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FinsStatusTypePlugin_copy_sample(
                ...
                const FinsStatusType *src)
            {
                return ::UMAA::EO::FinsStatus::FinsStatusTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FinsStatusType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FinsStatusTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FinsStatusType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
