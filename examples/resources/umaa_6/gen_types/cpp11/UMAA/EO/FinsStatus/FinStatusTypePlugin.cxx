    ...
    namespace EO {
        namespace FinsStatus {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FinStatusType *sample = new FinStatusType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FinStatusTypePlugin_copy_sample(
                ...
                const FinStatusType *src)
            {
                return ::UMAA::EO::FinsStatus::FinStatusTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FinStatusType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FinStatusTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FinStatusType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
