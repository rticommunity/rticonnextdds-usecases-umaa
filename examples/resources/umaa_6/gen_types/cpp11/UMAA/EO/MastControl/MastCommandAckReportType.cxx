...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace MastControl {
            ...
            MastCommandAckReportType::MastCommandAckReportType (const ::UMAA::EO::MastControl::MastCommandType& command_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_command_(command_), 
            ...
            void MastCommandAckReportType::swap(MastCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::MastControl::MastCommandAckReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member MastCommandAckReportType_g_tc_members[4]=
                {
                ...
                MastCommandAckReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::EO::MastControl::MastCommandType>::get().native();
                MastCommandAckReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                MastCommandAckReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                MastCommandAckReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo MastCommandAckReportType_g_memberAccessInfos[4] =
                ...
                MastCommandAckReportType_g_memberAccessInfos[3].bindingMemberValueOffset[0] = 
