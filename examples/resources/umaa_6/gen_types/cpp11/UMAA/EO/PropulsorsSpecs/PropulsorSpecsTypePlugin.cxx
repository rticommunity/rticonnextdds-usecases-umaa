    ...
    namespace EO {
        namespace PropulsorsSpecs {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PropulsorSpecsType *sample = new PropulsorSpecsType();
            ...
            PropulsorSpecsTypePluginSupport_copy_data(
                PropulsorSpecsType *dst,
                const PropulsorSpecsType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PropulsorSpecsTypePlugin_copy_sample(
                ...
                const PropulsorSpecsType *src)
            {
                return ::UMAA::EO::PropulsorsSpecs::PropulsorSpecsTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PropulsorSpecsType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PropulsorSpecsTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PropulsorSpecsType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
