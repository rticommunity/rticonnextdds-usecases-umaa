...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace FuelTankStatus {
            ...
            FuelTankReportType::FuelTankReportType (double fuelLevel_,const ::dds::core::optional< bool >& waterInFuel_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::FuelTankStatus::FuelTankReportType > {
            static DDS_TypeCode * get()
            {
                ...
                FuelTankReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::VolumePercent_AliasTag_t>::get().native();
                ...
                FuelTankReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                FuelTankReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                FuelTankReportType_g_tc_members[0]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                FuelTankReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                FuelTankReportType_g_tc_members[0]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< ::UMAA::EO::FuelTankStatus::FuelTankReportType >::reset_sample(::UMAA::EO::FuelTankStatus::FuelTankReportType& sample) 
        {
            ...
            ::rti::topic::reset_sample(sample.waterInFuel());
