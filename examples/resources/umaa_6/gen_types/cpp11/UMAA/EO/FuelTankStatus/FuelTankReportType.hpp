...
#ifndef FuelTankReportType_1872762609_hpp
#define FuelTankReportType_1872762609_hpp
...
namespace UMAA {
    namespace EO {
        namespace FuelTankStatus {
            ...
            static const std::string FuelTankReportTypeTopic = "UMAA::EO::FuelTankStatus::FuelTankReportType";
            ...
            class NDDSUSERDllExport FuelTankReportType {
              public:
                ...
                FuelTankReportType(double fuelLevel_,const ::dds::core::optional< bool >& waterInFuel_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_);

                double& fuelLevel() noexcept {
                    return m_fuelLevel_;
                }

                const double& fuelLevel() const noexcept {
                    return m_fuelLevel_;
                }
                ...
                ::dds::core::optional< bool >& waterInFuel() noexcept {
                    return m_waterInFuel_;
                }

                const ::dds::core::optional< bool >& waterInFuel() const noexcept {
                    return m_waterInFuel_;
                }

                void waterInFuel(const ::dds::core::optional< bool >& value) {

                    m_waterInFuel_ = value;
                }

                void waterInFuel(::dds::core::optional< bool >&& value) {
                    m_waterInFuel_ = std::move(value);
                }
                ...
                void swap(FuelTankReportType& other_) noexcept ;

              private:

                double m_fuelLevel_;
                ::dds::core::optional< bool > m_waterInFuel_;
                ::UMAA::Common::Measurement::DateTime m_timeStamp_;
                ::UMAA::Common::IdentifierType m_source_;

            };

            inline void swap(FuelTankReportType& a, FuelTankReportType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // FuelTankReportType_1872762609_hpp
