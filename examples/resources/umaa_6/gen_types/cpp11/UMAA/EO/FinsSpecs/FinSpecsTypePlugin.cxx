    ...
    namespace EO {
        namespace FinsSpecs {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FinSpecsType *sample = new FinSpecsType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FinSpecsTypePlugin_copy_sample(
                ...
                const FinSpecsType *src)
            {
                return ::UMAA::EO::FinsSpecs::FinSpecsTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FinSpecsType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FinSpecsTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FinSpecsType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
