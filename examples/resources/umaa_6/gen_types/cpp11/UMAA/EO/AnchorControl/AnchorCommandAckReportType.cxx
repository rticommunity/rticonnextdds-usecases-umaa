...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace AnchorControl {
            ...
            AnchorCommandAckReportType::AnchorCommandAckReportType (const ::UMAA::EO::AnchorControl::AnchorCommandType& command_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_command_(command_), 
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::AnchorControl::AnchorCommandAckReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member AnchorCommandAckReportType_g_tc_members[4]=
                {
                ...
                AnchorCommandAckReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::EO::AnchorControl::AnchorCommandType>::get().native();
                AnchorCommandAckReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                AnchorCommandAckReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                AnchorCommandAckReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo AnchorCommandAckReportType_g_memberAccessInfos[4] =
                ...
                AnchorCommandAckReportType_g_memberAccessInfos[3].bindingMemberValueOffset[0] = 
