...
#ifndef FuelTankSpecsReportType_731842073_hpp
#define FuelTankSpecsReportType_731842073_hpp
...
namespace UMAA {
    namespace EO {
        namespace FuelTankSpecs {
            ...
            static const std::string FuelTankSpecsReportTypeTopic = "UMAA::EO::FuelTankSpecs::FuelTankSpecsReportType";
            ...
            class NDDSUSERDllExport FuelTankSpecsReportType {
              public:
                ...
                FuelTankSpecsReportType(double capacity_,const std::string& name_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_);

                double& capacity() noexcept {
                    return m_capacity_;
                }

                const double& capacity() const noexcept {
                    return m_capacity_;
                }
                ...
                void swap(FuelTankSpecsReportType& other_) noexcept ;
            ...
            inline void swap(FuelTankSpecsReportType& a, FuelTankSpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // FuelTankSpecsReportType_731842073_hpp
