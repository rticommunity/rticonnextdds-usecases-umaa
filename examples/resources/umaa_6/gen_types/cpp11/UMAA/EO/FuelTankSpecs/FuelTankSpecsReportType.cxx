...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace FuelTankSpecs {
            ...
            FuelTankSpecsReportType::FuelTankSpecsReportType (double capacity_,const std::string& name_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
            ...
            void FuelTankSpecsReportType::swap(FuelTankSpecsReportType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool FuelTankSpecsReportType::operator == (const FuelTankSpecsReportType& other_) const {
                if (std::fabs(m_capacity_ - other_.m_capacity_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_capacity_ - other_.m_capacity_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::FuelTankSpecs::FuelTankSpecsReportType > {
            static DDS_TypeCode * get()
            {
                ...
                FuelTankSpecsReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::VolumeCubicMeter_AliasTag_t>::get().native();
                ...
                FuelTankSpecsReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                FuelTankSpecsReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                FuelTankSpecsReportType_g_tc_members[0]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                FuelTankSpecsReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                FuelTankSpecsReportType_g_tc_members[0]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
