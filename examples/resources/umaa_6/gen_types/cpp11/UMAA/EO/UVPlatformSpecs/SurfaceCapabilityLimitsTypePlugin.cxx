...
namespace UMAA {
    namespace EO {
        namespace UVPlatformSpecs {
            ...
            /* ----------------------------------------------------------------------------
            *  Type SurfaceCapabilityLimitsType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    SurfaceCapabilityLimitsType *sample = new SurfaceCapabilityLimitsType();
            ...
            SurfaceCapabilityLimitsTypePluginSupport_copy_data(
                SurfaceCapabilityLimitsType *dst,
                const SurfaceCapabilityLimitsType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            SurfaceCapabilityLimitsTypePlugin_copy_sample(
                ...
                const SurfaceCapabilityLimitsType *src)
            {
                return ::UMAA::EO::UVPlatformSpecs::SurfaceCapabilityLimitsTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SurfaceCapabilityLimitsType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool SurfaceCapabilityLimitsTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SurfaceCapabilityLimitsType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
