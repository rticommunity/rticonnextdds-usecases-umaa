...
namespace UMAA {
    namespace EO {
        namespace UVPlatformSpecs {
            ...
            /* ----------------------------------------------------------------------------
            *  Type UnderwaterCapabilityLimitsType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    UnderwaterCapabilityLimitsType *sample = new UnderwaterCapabilityLimitsType();
            ...
            UnderwaterCapabilityLimitsTypePluginSupport_copy_data(
                UnderwaterCapabilityLimitsType *dst,
                const UnderwaterCapabilityLimitsType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            UnderwaterCapabilityLimitsTypePlugin_copy_sample(
                ...
                const UnderwaterCapabilityLimitsType *src)
            {
                return ::UMAA::EO::UVPlatformSpecs::UnderwaterCapabilityLimitsTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< UnderwaterCapabilityLimitsType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool UnderwaterCapabilityLimitsTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                UnderwaterCapabilityLimitsType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
