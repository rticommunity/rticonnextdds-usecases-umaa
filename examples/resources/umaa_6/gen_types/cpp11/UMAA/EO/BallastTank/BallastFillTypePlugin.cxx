    ...
    namespace EO {
        namespace BallastTank {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void BallastFillTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "BallastFillTypeEnum", indent_level + 1);
            }
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BallastFillTypeUnion *sample = new BallastFillTypeUnion();
            ...
            BallastFillTypeUnionPluginSupport_copy_data(
                BallastFillTypeUnion *dst,
                const BallastFillTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BallastFillTypeUnionPlugin_copy_sample(
                ...
                const BallastFillTypeUnion *src)
            {
                return ::UMAA::EO::BallastTank::BallastFillTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BallastFillTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BallastFillTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BallastFillTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
