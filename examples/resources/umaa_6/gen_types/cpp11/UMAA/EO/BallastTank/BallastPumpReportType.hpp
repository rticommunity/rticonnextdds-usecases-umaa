...
#ifndef BallastPumpReportType_2086669680_hpp
#define BallastPumpReportType_2086669680_hpp
...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            static const std::string BallastPumpReportTypeTopic = "UMAA::EO::BallastTank::BallastPumpReportType";
            ...
            class NDDSUSERDllExport BallastPumpReportType {
              public:
                ...
                BallastPumpReportType(const ::dds::core::optional< double >& massFillRate_,const ::UMAA::Common::MaritimeEnumeration::PumpStateEnumModule::PumpStateEnumType& state_,const ::dds::core::optional< double >& volumeFlowRate_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_);
                ...
                ::UMAA::Common::MaritimeEnumeration::PumpStateEnumModule::PumpStateEnumType& state() noexcept {
                    return m_state_;
                }

                const ::UMAA::Common::MaritimeEnumeration::PumpStateEnumModule::PumpStateEnumType& state() const noexcept {
                    return m_state_;
                }

                void state(const ::UMAA::Common::MaritimeEnumeration::PumpStateEnumModule::PumpStateEnumType& value) {

                    m_state_ = value;
                }

                void state(::UMAA::Common::MaritimeEnumeration::PumpStateEnumModule::PumpStateEnumType&& value) {
              ...
              private:
                ...
                ::UMAA::Common::MaritimeEnumeration::PumpStateEnumModule::PumpStateEnumType m_state_;
...
#endif // BallastPumpReportType_2086669680_hpp
