...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace BallastTank {
            ...
            BallastPumpSpecsReportType::BallastPumpSpecsReportType (double maxMassEmptyRate_,double maxMassFillRate_,double maxVolumeEmptyRate_,double maxVolumeFillRate_,double minMassEmptyRate_,double minMassFillRate_,double minVolumeEmptyRate_,double minVolumeFillRate_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
                m_maxMassEmptyRate_(maxMassEmptyRate_), 
                m_maxMassFillRate_(maxMassFillRate_), 
                m_maxVolumeEmptyRate_(maxVolumeEmptyRate_), 
                m_maxVolumeFillRate_(maxVolumeFillRate_), 
                m_minMassEmptyRate_(minMassEmptyRate_), 
                m_minMassFillRate_(minMassFillRate_), 
                m_minVolumeEmptyRate_(minVolumeEmptyRate_), 
                m_minVolumeFillRate_(minVolumeFillRate_), 
                m_timeStamp_(timeStamp_), 
                m_source_(source_) {
            }

            void BallastPumpSpecsReportType::swap(BallastPumpSpecsReportType& other_)  noexcept 
            {
                using std::swap;
            ...
            bool BallastPumpSpecsReportType::operator == (const BallastPumpSpecsReportType& other_) const {
                if (std::fabs(m_maxMassEmptyRate_ - other_.m_maxMassEmptyRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_maxMassEmptyRate_ - other_.m_maxMassEmptyRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_maxMassFillRate_ - other_.m_maxMassFillRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_maxMassFillRate_ - other_.m_maxMassFillRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_maxVolumeEmptyRate_ - other_.m_maxVolumeEmptyRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_maxVolumeEmptyRate_ - other_.m_maxVolumeEmptyRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_maxVolumeFillRate_ - other_.m_maxVolumeFillRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_maxVolumeFillRate_ - other_.m_maxVolumeFillRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_minMassEmptyRate_ - other_.m_minMassEmptyRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_minMassEmptyRate_ - other_.m_minMassEmptyRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_minMassFillRate_ - other_.m_minMassFillRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_minMassFillRate_ - other_.m_minMassFillRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_minVolumeEmptyRate_ - other_.m_minVolumeEmptyRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_minVolumeEmptyRate_ - other_.m_minVolumeEmptyRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
                if (std::fabs(m_minVolumeFillRate_ - other_.m_minVolumeFillRate_) > std::numeric_limits< double>::epsilon()
                && !(std::fabs(m_minVolumeFillRate_ - other_.m_minVolumeFillRate_) < (std::numeric_limits< double>::min)())) {
                    return false;
                }
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::BallastTank::BallastPumpSpecsReportType > {
            static DDS_TypeCode * get()
            {
                ...
                BallastPumpSpecsReportType_g_tc_members[8]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                BallastPumpSpecsReportType_g_tc_members[9]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
