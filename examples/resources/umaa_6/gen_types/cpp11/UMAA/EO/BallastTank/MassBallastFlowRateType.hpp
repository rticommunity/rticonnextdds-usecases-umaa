...
#ifndef MassBallastFlowRateType_1018645838_hpp
#define MassBallastFlowRateType_1018645838_hpp
        ...
        namespace BallastTank {
            ...
            class NDDSUSERDllExport MassBallastFlowRateType {
              public:
                ...
                explicit MassBallastFlowRateType(double massBallastFlowRate_);

                double& massBallastFlowRate() noexcept {
                    return m_massBallastFlowRate_;
                }

                const double& massBallastFlowRate() const noexcept {
                    return m_massBallastFlowRate_;
                }
                ...
                void swap(MassBallastFlowRateType& other_) noexcept ;
            ...
            inline void swap(MassBallastFlowRateType& a, MassBallastFlowRateType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // MassBallastFlowRateType_1018645838_hpp
