...
#ifndef BallastTankReportType_1638599017_hpp
#define BallastTankReportType_1638599017_hpp
...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            static const std::string BallastTankReportTypeTopic = "UMAA::EO::BallastTank::BallastTankReportType";
            ...
            class NDDSUSERDllExport BallastTankReportType {
              public:
                ...
                BallastTankReportType(const ::dds::core::optional< double >& level_,double lowPressureLimit_,const ::dds::core::optional< double >& mass_,double pressure_,double pressureLimit_,bool trimActive_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_);

                ::dds::core::optional< double >& level() noexcept {
                    return m_level_;
                }

                const ::dds::core::optional< double >& level() const noexcept {
                    return m_level_;
                }
                ...
                double& lowPressureLimit() noexcept {
                    return m_lowPressureLimit_;
                }

                const double& lowPressureLimit() const noexcept {
                    return m_lowPressureLimit_;
                }
                ...
                ::dds::core::optional< double >& mass() noexcept {
                    return m_mass_;
                }

                const ::dds::core::optional< double >& mass() const noexcept {
                    return m_mass_;
                }
                ...
                const double& pressure() const noexcept {
                    return m_pressure_;
                }
                ...
                double& pressureLimit() noexcept {
                    return m_pressureLimit_;
                }

                const double& pressureLimit() const noexcept {
                    return m_pressureLimit_;
                }
                ...
                bool& trimActive() noexcept {
                    return m_trimActive_;
                }

                const bool& trimActive() const noexcept {
                    return m_trimActive_;
                }
                ...
                void swap(BallastTankReportType& other_) noexcept ;
            ...
            inline void swap(BallastTankReportType& a, BallastTankReportType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // BallastTankReportType_1638599017_hpp
