...
#ifndef BallastTankSpecsReportType_1206348744_hpp
#define BallastTankSpecsReportType_1206348744_hpp
...
namespace UMAA {
    namespace EO {
        namespace BallastTank {
            ...
            static const std::string BallastTankSpecsReportTypeTopic = "UMAA::EO::BallastTank::BallastTankSpecsReportType";
            ...
            class NDDSUSERDllExport BallastTankSpecsReportType {
              public:
                ...
                BallastTankSpecsReportType(double massCapacity_,const std::string& name_,bool trimTank_,double volumeCapacity_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_);

                double& massCapacity() noexcept {
                    return m_massCapacity_;
                }

                const double& massCapacity() const noexcept {
                    return m_massCapacity_;
                }
                ...
                bool& trimTank() noexcept {
                    return m_trimTank_;
                }

                const bool& trimTank() const noexcept {
                    return m_trimTank_;
                }
                ...
                double& volumeCapacity() noexcept {
                    return m_volumeCapacity_;
                }

                const double& volumeCapacity() const noexcept {
                    return m_volumeCapacity_;
                }
                ...
                void swap(BallastTankSpecsReportType& other_) noexcept ;
            ...
            inline void swap(BallastTankSpecsReportType& a, BallastTankSpecsReportType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // BallastTankSpecsReportType_1206348744_hpp
