    ...
    namespace EO {
        ...
        namespace AnchorStatus {
            ...
            AnchorReportType::AnchorReportType() :
                ...
                m_state_(UMAA::Common::MaritimeEnumeration::AnchorStateEnumModule::AnchorStateEnumType::DEPLOYED)  {

            }   

            AnchorReportType::AnchorReportType (double rodeLengthPaidOut_,const ::UMAA::Common::MaritimeEnumeration::AnchorStateEnumModule::AnchorStateEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::AnchorStatus::AnchorReportType > {
            static DDS_TypeCode * get()
            {
                ...
                AnchorReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::AnchorStateEnumModule::AnchorStateEnumType>::get().native();
                AnchorReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                AnchorReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                AnchorReportType_g_tc_members[0]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                AnchorReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorReportType_g_tc_members[0]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< ::UMAA::EO::AnchorStatus::AnchorReportType >::reset_sample(::UMAA::EO::AnchorStatus::AnchorReportType& sample) 
        {
            ...
            sample.state(UMAA::Common::MaritimeEnumeration::AnchorStateEnumModule::AnchorStateEnumType::DEPLOYED);
