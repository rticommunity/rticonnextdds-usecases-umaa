    ...
    namespace EO {
        ...
        namespace PowerStatus {
            ...
            PowerReportType::PowerReportType() :
                m_state_(UMAA::Common::MaritimeEnumeration::PowerStateEnumModule::PowerStateEnumType::EMERGENCY_POWER)  {

            }   

            PowerReportType::PowerReportType (const ::UMAA::Common::MaritimeEnumeration::PowerStateEnumModule::PowerStateEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::IdentifierType& resourceID_):
                m_state_(state_), 
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::PowerStatus::PowerReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member PowerReportType_g_tc_members[4]=
                {
                ...
                PowerReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::PowerStateEnumModule::PowerStateEnumType>::get().native();
                PowerReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                PowerReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                PowerReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();

                /* Initialize the values for member annotations. */
                PowerReportType_g_tc_members[0]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                PowerReportType_g_tc_members[0]._annotations._defaultValue._u.enumerated_value = 0;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo PowerReportType_g_memberAccessInfos[4] =
...
namespace dds { 
    namespace topic {
        ...
        {
            sample.state(UMAA::Common::MaritimeEnumeration::PowerStateEnumModule::PowerStateEnumType::EMERGENCY_POWER);
