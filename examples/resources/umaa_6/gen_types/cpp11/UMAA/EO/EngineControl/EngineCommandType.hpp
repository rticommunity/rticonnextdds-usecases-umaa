...
#ifndef EngineCommandType_1679865178_hpp
#define EngineCommandType_1679865178_hpp
...
namespace UMAA {
    namespace EO {
        namespace EngineControl {
            ...
            static const std::string EngineCommandTypeTopic = "UMAA::EO::EngineControl::EngineCommandType";
            ...
            class NDDSUSERDllExport EngineCommandType {
              public:
                ...
                ::dds::core::optional< ::UMAA::Common::Enumeration::OnOffStatusEnumModule::OnOffStatusEnumType >& plugState() noexcept {
                    return m_plugState_;
                }

                const ::dds::core::optional< ::UMAA::Common::Enumeration::OnOffStatusEnumModule::OnOffStatusEnumType >& plugState() const noexcept {
                    return m_plugState_;
                }

                void plugState(const ::dds::core::optional< ::UMAA::Common::Enumeration::OnOffStatusEnumModule::OnOffStatusEnumType >& value) {

                    m_plugState_ = value;
                }

                void plugState(::dds::core::optional< ::UMAA::Common::Enumeration::OnOffStatusEnumModule::OnOffStatusEnumType >&& value) {
                    m_plugState_ = std::move(value);
                }
                ::dds::core::optional< ::UMAA::Common::Propulsion::PropulsionType >& propulsion() noexcept {
                    return m_propulsion_;
                }

                const ::dds::core::optional< ::UMAA::Common::Propulsion::PropulsionType >& propulsion() const noexcept {
                    return m_propulsion_;
                }

                void propulsion(const ::dds::core::optional< ::UMAA::Common::Propulsion::PropulsionType >& value) {

                    m_propulsion_ = value;
                }

                void propulsion(::dds::core::optional< ::UMAA::Common::Propulsion::PropulsionType >&& value) {
                    m_propulsion_ = std::move(value);
                }
                ::UMAA::Common::MaritimeEnumeration::IgnitionControlEnumModule::IgnitionControlEnumType& state() noexcept {
                    return m_state_;
                }

                const ::UMAA::Common::MaritimeEnumeration::IgnitionControlEnumModule::IgnitionControlEnumType& state() const noexcept {
                    return m_state_;
                }

                void state(const ::UMAA::Common::MaritimeEnumeration::IgnitionControlEnumModule::IgnitionControlEnumType& value) {

                    m_state_ = value;
                }

                void state(::UMAA::Common::MaritimeEnumeration::IgnitionControlEnumModule::IgnitionControlEnumType&& value) {
                ...
                void swap(EngineCommandType& other_) noexcept ;

              private:

                ::dds::core::optional< ::UMAA::Common::Enumeration::OnOffStatusEnumModule::OnOffStatusEnumType > m_plugState_;
                ::dds::core::optional< ::UMAA::Common::Propulsion::PropulsionType > m_propulsion_;
                ::UMAA::Common::MaritimeEnumeration::IgnitionControlEnumModule::IgnitionControlEnumType m_state_;
            ...
            inline void swap(EngineCommandType& a, EngineCommandType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // EngineCommandType_1679865178_hpp
