    ...
    namespace EO {
        namespace PropulsorsStatus {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PropulsorStatusType *sample = new PropulsorStatusType();
            ...
            PropulsorStatusTypePluginSupport_copy_data(
                PropulsorStatusType *dst,
                const PropulsorStatusType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PropulsorStatusTypePlugin_copy_sample(
                ...
                const PropulsorStatusType *src)
            {
                return ::UMAA::EO::PropulsorsStatus::PropulsorStatusTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PropulsorStatusType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PropulsorStatusTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PropulsorStatusType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
