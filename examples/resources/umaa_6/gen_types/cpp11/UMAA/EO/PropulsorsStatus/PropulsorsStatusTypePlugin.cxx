    ...
    namespace EO {
        namespace PropulsorsStatus {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PropulsorsStatusType *sample = new PropulsorsStatusType();
            ...
            PropulsorsStatusTypePluginSupport_copy_data(
                PropulsorsStatusType *dst,
                const PropulsorsStatusType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PropulsorsStatusTypePlugin_copy_sample(
                ...
                const PropulsorsStatusType *src)
            {
                return ::UMAA::EO::PropulsorsStatus::PropulsorsStatusTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PropulsorsStatusType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PropulsorsStatusTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PropulsorsStatusType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
