...
namespace UMAA {
    ...
    namespace EO {
        ...
        namespace AnchorSpecs {
            ...
            {
                using std::swap;
                swap(m_anchorDescription_, other_.m_anchorDescription_);
                ...
                swap(m_rodeType_, other_.m_rodeType_);
            ...
            bool AnchorSpecsReportType::operator == (const AnchorSpecsReportType& other_) const {
                if (m_anchorDescription_ != other_.m_anchorDescription_) {
                    return false;
                }
                ...
                if (m_rodeType_ != other_.m_rodeType_) {
                    return false;
                }
            ...
            std::ostream& operator << (std::ostream& o,const AnchorSpecsReportType& sample)
            {
                ...
                o <<"[";
                o << "anchorDescription: " << sample.anchorDescription ()<<", ";
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::EO::AnchorSpecs::AnchorSpecsReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member AnchorSpecsReportType_g_tc_members[12]=
                {

                    {
                        (char *)"anchorDescription",/* Member name */
                        {
                            0,/* Representation ID */
                ...
                AnchorSpecsReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::PrimitiveConstrained::StringShortDescription_AliasTag_t>::get().native();
                AnchorSpecsReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::Mass_AliasTag_t>::get().native();
                AnchorSpecsReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::PrimitiveConstrained::Ratio_AliasTag_t>::get().native();
                AnchorSpecsReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::AnchorKindEnumModule::AnchorKindEnumType>::get().native();
                AnchorSpecsReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::AnchorLocationEnumModule::AnchorLocationEnumType>::get().native();
                AnchorSpecsReportType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::Mass_AliasTag_t>::get().native();
                ...
                AnchorSpecsReportType_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::Distance_AliasTag_t>::get().native();
                AnchorSpecsReportType_g_tc_members[8]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::AnchorRodeEnumModule::AnchorRodeEnumType>::get().native();
                AnchorSpecsReportType_g_tc_members[9]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::Force_AliasTag_t>::get().native();
                AnchorSpecsReportType_g_tc_members[10]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                AnchorSpecsReportType_g_tc_members[11]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();

                /* Initialize the values for member annotations. */
                AnchorSpecsReportType_g_tc_members[0]._annotations._defaultValue._d = RTI_XCDR_TK_STRING;
                AnchorSpecsReportType_g_tc_members[0]._annotations._defaultValue._u.string_value = (DDS_Char *) "";
                ...
                AnchorSpecsReportType_g_tc_members[2]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[2]._annotations._defaultValue._u.double_value = 0.0;
                AnchorSpecsReportType_g_tc_members[2]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[2]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                AnchorSpecsReportType_g_tc_members[2]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[2]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
                ...
                AnchorSpecsReportType_g_tc_members[4]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                AnchorSpecsReportType_g_tc_members[4]._annotations._defaultValue._u.enumerated_value = 0;
                ...
                AnchorSpecsReportType_g_tc_members[5]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                AnchorSpecsReportType_g_tc_members[5]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[5]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
                ...
                AnchorSpecsReportType_g_tc_members[6]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                AnchorSpecsReportType_g_tc_members[6]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[6]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
                ...
                AnchorSpecsReportType_g_tc_members[7]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                AnchorSpecsReportType_g_tc_members[7]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[7]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
                AnchorSpecsReportType_g_tc_members[8]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                AnchorSpecsReportType_g_tc_members[8]._annotations._defaultValue._u.enumerated_value = 0;
                AnchorSpecsReportType_g_tc_members[9]._annotations._defaultValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[9]._annotations._defaultValue._u.double_value = 0.0;
                AnchorSpecsReportType_g_tc_members[9]._annotations._minValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[9]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                AnchorSpecsReportType_g_tc_members[9]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                AnchorSpecsReportType_g_tc_members[9]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo AnchorSpecsReportType_g_memberAccessInfos[12] =
                ...
                (RTIXCdrUnsignedLong) ((char *)&sample->anchorDescription() - (char *)sample);
                ...
                (RTIXCdrUnsignedLong) ((char *)&sample->rodeType() - (char *)sample);
                ...
                AnchorSpecsReportType_g_memberAccessInfos[10].bindingMemberValueOffset[0] = 
                (RTIXCdrUnsignedLong) ((char *)&sample->timeStamp() - (char *)sample);

                AnchorSpecsReportType_g_memberAccessInfos[11].bindingMemberValueOffset[0] = 
...
namespace dds { 
    namespace topic {
        ...
        {
            sample.anchorDescription("");
            sample.anchorHoldingPower(0.0);
            sample.anchorHoldingPowerRatio(0.0);
            sample.anchorKind(UMAA::Common::MaritimeEnumeration::AnchorKindEnumModule::AnchorKindEnumType::COMMERCIAL_STOCKLESS);
            sample.anchorLocation(UMAA::Common::MaritimeEnumeration::AnchorLocationEnumModule::AnchorLocationEnumType::BOWER);
            sample.anchorSize(0.0);
            sample.rodeLength(0.0);
            sample.rodeSize(0.0);
            sample.rodeType(UMAA::Common::MaritimeEnumeration::AnchorRodeEnumModule::AnchorRodeEnumType::CHAIN);
        ...
        {
            ::rti::topic::allocate_sample(sample.anchorDescription(),  -1, 1023L);
            ::rti::topic::allocate_sample(sample.anchorKind(),  -1, -1);
            ::rti::topic::allocate_sample(sample.anchorLocation(),  -1, -1);
            ::rti::topic::allocate_sample(sample.rodeType(),  -1, -1);
