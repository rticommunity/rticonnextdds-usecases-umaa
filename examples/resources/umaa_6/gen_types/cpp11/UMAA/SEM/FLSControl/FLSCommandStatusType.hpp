...
#ifndef FLSCommandStatusType_299964175_hpp
#define FLSCommandStatusType_299964175_hpp
        ...
        namespace FLSControl {
            ...
            class NDDSUSERDllExport FLSCommandStatusType {
              public:
                ...
                bool operator == (const FLSCommandStatusType& other_) const;
                bool operator != (const FLSCommandStatusType& other_) const;

                void swap(FLSCommandStatusType& other_) noexcept ;
            ...
            inline void swap(FLSCommandStatusType& a, FLSCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const FLSCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SEM::FLSControl::FLSCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::FLSControl::FLSCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SEM::FLSControl::FLSCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SEM::FLSControl::FLSCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SEM::FLSControl::FLSCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SEM::FLSControl::FLSCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SEM::FLSControl::FLSCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SEM::FLSControl::FLSCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SEM::FLSControl::FLSCommandStatusType > {
...
#endif // FLSCommandStatusType_299964175_hpp
