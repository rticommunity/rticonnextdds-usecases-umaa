...
#ifndef InertialSensorCommandStatusType_1460255058_hpp
#define InertialSensorCommandStatusType_1460255058_hpp
...
namespace UMAA {
    namespace SEM {
        namespace InertialSensorControl {
            ...
            static const std::string InertialSensorCommandStatusTypeTopic = "UMAA::SEM::InertialSensorControl::InertialSensorCommandStatusType";
            ...
            class NDDSUSERDllExport InertialSensorCommandStatusType {
              public:
                ...
                InertialSensorCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                void swap(InertialSensorCommandStatusType& other_) noexcept ;
            ...
            inline void swap(InertialSensorCommandStatusType& a, InertialSensorCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // InertialSensorCommandStatusType_1460255058_hpp
