    ...
    namespace SEM {
        ...
        namespace InertialSensorControl {
            ...
            InertialSensorCommandType::InertialSensorCommandType() :
                m_state_(UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType::BEST_ALIGN)  {

            }   

            InertialSensorCommandType::InertialSensorCommandType (const ::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::IdentifierType& destination_):
                m_state_(state_), 
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SEM::InertialSensorControl::InertialSensorCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                InertialSensorCommandType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType>::get().native();
                InertialSensorCommandType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                InertialSensorCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                InertialSensorCommandType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
...
namespace dds { 
    namespace topic {
        ...
        {
            sample.state(UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType::BEST_ALIGN);
