...
#ifndef InertialSensorCommandType_749508381_hpp
#define InertialSensorCommandType_749508381_hpp
...
namespace UMAA {
    namespace SEM {
        namespace InertialSensorControl {
            ...
            static const std::string InertialSensorCommandTypeTopic = "UMAA::SEM::InertialSensorControl::InertialSensorCommandType";
            ...
            class NDDSUSERDllExport InertialSensorCommandType {
              public:
                ...
                InertialSensorCommandType(const ::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::IdentifierType& destination_);

                ::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType& state() noexcept {
                    return m_state_;
                }

                const ::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType& state() const noexcept {
                    return m_state_;
                }

                void state(const ::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType& value) {

                    m_state_ = value;
                }

                void state(::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType&& value) {
                ...
                void swap(InertialSensorCommandType& other_) noexcept ;

              private:

                ::UMAA::Common::MaritimeEnumeration::InertialSensorCmdEnumModule::InertialSensorCmdEnumType m_state_;
            ...
            inline void swap(InertialSensorCommandType& a, InertialSensorCommandType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // InertialSensorCommandType_749508381_hpp
