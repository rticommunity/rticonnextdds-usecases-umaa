...
#ifndef SASConfigCommandStatusType_1147189774_hpp
#define SASConfigCommandStatusType_1147189774_hpp
...
namespace UMAA {
    namespace SEM {
        namespace SASConfig {
            ...
            static const std::string SASConfigCommandStatusTypeTopic = "UMAA::SEM::SASConfig::SASConfigCommandStatusType";

            class NDDSUSERDllExport SASConfigCommandStatusType {
              public:

                SASConfigCommandStatusType();

                SASConfigCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const SASConfigCommandStatusType& other_) const;
                bool operator != (const SASConfigCommandStatusType& other_) const;

                void swap(SASConfigCommandStatusType& other_) noexcept ;
            ...
            inline void swap(SASConfigCommandStatusType& a, SASConfigCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const SASConfigCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SEM::SASConfig::SASConfigCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::SASConfig::SASConfigCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SEM::SASConfig::SASConfigCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SEM::SASConfig::SASConfigCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SEM::SASConfig::SASConfigCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SEM::SASConfig::SASConfigCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SEM::SASConfig::SASConfigCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SEM::SASConfig::SASConfigCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SEM::SASConfig::SASConfigCommandStatusType > {
...
#endif // SASConfigCommandStatusType_1147189774_hpp
