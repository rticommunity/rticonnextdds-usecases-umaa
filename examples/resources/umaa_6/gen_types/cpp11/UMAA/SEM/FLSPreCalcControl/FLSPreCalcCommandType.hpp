...
#ifndef FLSPreCalcCommandType_249660928_hpp
#define FLSPreCalcCommandType_249660928_hpp
...
namespace UMAA {
    namespace SEM {
        namespace FLSPreCalcControl {
            ...
            static const std::string FLSPreCalcCommandTypeTopic = "UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType";

            class NDDSUSERDllExport FLSPreCalcCommandType {
              public:

                FLSPreCalcCommandType();

                FLSPreCalcCommandType(const ::dds::core::optional< ::UMAA::SEM::BaseType::FLSAdditionalConfigType >& additionalConfig_,const ::UMAA::Common::MaritimeEnumeration::FLSConfigModeEnumModule::FLSConfigModeEnumType& configMode_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::IdentifierType& destination_);
                ...
                bool operator == (const FLSPreCalcCommandType& other_) const;
                bool operator != (const FLSPreCalcCommandType& other_) const;

                void swap(FLSPreCalcCommandType& other_) noexcept ;
            ...
            inline void swap(FLSPreCalcCommandType& a, FLSPreCalcCommandType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const FLSPreCalcCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandType > {
...
#endif // FLSPreCalcCommandType_249660928_hpp
