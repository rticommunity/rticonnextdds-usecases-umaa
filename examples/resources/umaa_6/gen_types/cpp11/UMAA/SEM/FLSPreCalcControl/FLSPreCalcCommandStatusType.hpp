...
#ifndef FLSPreCalcCommandStatusType_1686745825_hpp
#define FLSPreCalcCommandStatusType_1686745825_hpp
...
namespace UMAA {
    namespace SEM {
        namespace FLSPreCalcControl {
            ...
            static const std::string FLSPreCalcCommandStatusTypeTopic = "UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType";

            class NDDSUSERDllExport FLSPreCalcCommandStatusType {
              public:
                ...
                bool operator == (const FLSPreCalcCommandStatusType& other_) const;
                bool operator != (const FLSPreCalcCommandStatusType& other_) const;

                void swap(FLSPreCalcCommandStatusType& other_) noexcept ;
            ...
            inline void swap(FLSPreCalcCommandStatusType& a, FLSPreCalcCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const FLSPreCalcCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SEM::FLSPreCalcControl::FLSPreCalcCommandStatusType > {
...
#endif // FLSPreCalcCommandStatusType_1686745825_hpp
