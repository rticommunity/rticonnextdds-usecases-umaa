    ...
    namespace SEM {
        namespace IlluminatorSpecs {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BeamWidthSpecsType *sample = new BeamWidthSpecsType();
            ...
            BeamWidthSpecsTypePluginSupport_copy_data(
                BeamWidthSpecsType *dst,
                const BeamWidthSpecsType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BeamWidthSpecsTypePlugin_copy_sample(
                ...
                const BeamWidthSpecsType *src)
            {
                return ::UMAA::SEM::IlluminatorSpecs::BeamWidthSpecsTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BeamWidthSpecsType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BeamWidthSpecsTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BeamWidthSpecsType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
