...
namespace UMAA {
    namespace SEM {
        namespace BaseType {
            ...
            /* ----------------------------------------------------------------------------
            *  Type FLSConfigSearchBottomType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FLSConfigSearchBottomType *sample = new FLSConfigSearchBottomType();
            ...
            FLSConfigSearchBottomTypePluginSupport_copy_data(
                FLSConfigSearchBottomType *dst,
                const FLSConfigSearchBottomType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FLSConfigSearchBottomTypePlugin_copy_sample(
                ...
                const FLSConfigSearchBottomType *src)
            {
                return ::UMAA::SEM::BaseType::FLSConfigSearchBottomTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FLSConfigSearchBottomType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FLSConfigSearchBottomTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FLSConfigSearchBottomType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
