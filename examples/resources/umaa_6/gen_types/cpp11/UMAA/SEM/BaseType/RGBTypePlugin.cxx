        ...
        namespace BaseType {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            RGBTypePlugin_copy_sample(
                ...
                const RGBType *src)
            {
                return ::UMAA::SEM::BaseType::RGBTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< RGBType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool RGBTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RGBType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
