    ...
    namespace SEM {
        namespace BaseType {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void FLSAdditionalConfigTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "FLSAdditionalConfigTypeEnum", indent_level + 1);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type FLSAdditionalConfigTypeUnion
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FLSAdditionalConfigTypeUnion *sample = new FLSAdditionalConfigTypeUnion();
            ...
            FLSAdditionalConfigTypeUnionPluginSupport_copy_data(
                FLSAdditionalConfigTypeUnion *dst,
                const FLSAdditionalConfigTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FLSAdditionalConfigTypeUnionPlugin_copy_sample(
                ...
                const FLSAdditionalConfigTypeUnion *src)
            {
                return ::UMAA::SEM::BaseType::FLSAdditionalConfigTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FLSAdditionalConfigTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FLSAdditionalConfigTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FLSAdditionalConfigTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FLSAdditionalConfigType *sample = new FLSAdditionalConfigType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            FLSAdditionalConfigTypePluginSupport_copy_data(
                FLSAdditionalConfigType *dst,
                const FLSAdditionalConfigType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FLSAdditionalConfigTypePlugin_copy_sample(
                ...
                const FLSAdditionalConfigType *src)
            {
                return ::UMAA::SEM::BaseType::FLSAdditionalConfigTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FLSAdditionalConfigType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FLSAdditionalConfigTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FLSAdditionalConfigType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
