    ...
    namespace SEM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FLSConfigTestType *sample = new FLSConfigTestType();
            ...
            FLSConfigTestTypePluginSupport_copy_data(
                FLSConfigTestType *dst,
                const FLSConfigTestType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FLSConfigTestTypePlugin_copy_sample(
                ...
                const FLSConfigTestType *src)
            {
                return ::UMAA::SEM::BaseType::FLSConfigTestTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FLSConfigTestType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FLSConfigTestTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FLSConfigTestType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
