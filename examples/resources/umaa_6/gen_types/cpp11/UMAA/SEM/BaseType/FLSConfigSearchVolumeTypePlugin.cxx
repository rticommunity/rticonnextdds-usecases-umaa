...
namespace UMAA {
    namespace SEM {
        namespace BaseType {
            ...
            /* ----------------------------------------------------------------------------
            *  Type FLSConfigSearchVolumeType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FLSConfigSearchVolumeType *sample = new FLSConfigSearchVolumeType();
            ...
            FLSConfigSearchVolumeTypePluginSupport_copy_data(
                FLSConfigSearchVolumeType *dst,
                const FLSConfigSearchVolumeType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FLSConfigSearchVolumeTypePlugin_copy_sample(
                ...
                const FLSConfigSearchVolumeType *src)
            {
                return ::UMAA::SEM::BaseType::FLSConfigSearchVolumeTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FLSConfigSearchVolumeType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FLSConfigSearchVolumeTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FLSConfigSearchVolumeType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
