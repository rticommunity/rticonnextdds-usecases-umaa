...
#ifndef SASCommandStatusType_1978559367_hpp
#define SASCommandStatusType_1978559367_hpp
...
namespace UMAA {
    namespace SEM {
        namespace SASControl {
            ...
            static const std::string SASCommandStatusTypeTopic = "UMAA::SEM::SASControl::SASCommandStatusType";

            class NDDSUSERDllExport SASCommandStatusType {
              public:

                SASCommandStatusType();

                SASCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const SASCommandStatusType& other_) const;
                bool operator != (const SASCommandStatusType& other_) const;

                void swap(SASCommandStatusType& other_) noexcept ;
            ...
            inline void swap(SASCommandStatusType& a, SASCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const SASCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SEM::SASControl::SASCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SEM::SASControl::SASCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SEM::SASControl::SASCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SEM::SASControl::SASCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SEM::SASControl::SASCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SEM::SASControl::SASCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SEM::SASControl::SASCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SEM::SASControl::SASCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SEM::SASControl::SASCommandStatusType > {
...
#endif // SASCommandStatusType_1978559367_hpp
