...
namespace UMAA {
    namespace Common {
        namespace Speed {
            ...
            /* ----------------------------------------------------------------------------
            *  Type EngineRPMSpeedRequirement
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    EngineRPMSpeedRequirement *sample = new EngineRPMSpeedRequirement();
            ...
            EngineRPMSpeedRequirementPluginSupport_copy_data(
                EngineRPMSpeedRequirement *dst,
                const EngineRPMSpeedRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            EngineRPMSpeedRequirementPlugin_copy_sample(
                ...
                const EngineRPMSpeedRequirement *src)
            {
                return ::UMAA::Common::Speed::EngineRPMSpeedRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EngineRPMSpeedRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool EngineRPMSpeedRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                EngineRPMSpeedRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
