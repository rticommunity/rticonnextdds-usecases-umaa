    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GroundSpeedTolerance *sample = new GroundSpeedTolerance();
            ...
            GroundSpeedTolerancePluginSupport_copy_data(
                GroundSpeedTolerance *dst,
                const GroundSpeedTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GroundSpeedTolerancePlugin_copy_sample(
                ...
                const GroundSpeedTolerance *src)
            {
                return ::UMAA::Common::Speed::GroundSpeedTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GroundSpeedTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GroundSpeedTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GroundSpeedTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
