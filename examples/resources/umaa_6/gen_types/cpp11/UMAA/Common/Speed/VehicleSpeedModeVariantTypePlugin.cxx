...
namespace UMAA {
    namespace Common {
        namespace Speed {
            ...
            /* ----------------------------------------------------------------------------
            *  Type VehicleSpeedModeVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    VehicleSpeedModeVariantType *sample = new VehicleSpeedModeVariantType();
            ...
            VehicleSpeedModeVariantTypePluginSupport_copy_data(
                VehicleSpeedModeVariantType *dst,
                const VehicleSpeedModeVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            VehicleSpeedModeVariantTypePlugin_copy_sample(
                ...
                const VehicleSpeedModeVariantType *src)
            {
                return ::UMAA::Common::Speed::VehicleSpeedModeVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< VehicleSpeedModeVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool VehicleSpeedModeVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                VehicleSpeedModeVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
