    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    RequiredSpeedVariantType *sample = new RequiredSpeedVariantType();
            ...
            RequiredSpeedVariantTypePluginSupport_copy_data(
                RequiredSpeedVariantType *dst,
                const RequiredSpeedVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            RequiredSpeedVariantTypePlugin_copy_sample(
                ...
                const RequiredSpeedVariantType *src)
            {
                return ::UMAA::Common::Speed::RequiredSpeedVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< RequiredSpeedVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool RequiredSpeedVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RequiredSpeedVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
