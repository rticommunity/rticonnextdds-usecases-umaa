    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GroundSpeedRequirement *sample = new GroundSpeedRequirement();
            ...
            GroundSpeedRequirementPluginSupport_copy_data(
                GroundSpeedRequirement *dst,
                const GroundSpeedRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GroundSpeedRequirementPlugin_copy_sample(
                ...
                const GroundSpeedRequirement *src)
            {
                return ::UMAA::Common::Speed::GroundSpeedRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GroundSpeedRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GroundSpeedRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GroundSpeedRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
