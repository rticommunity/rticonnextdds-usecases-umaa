    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AirSpeedVariantType *sample = new AirSpeedVariantType();
            ...
            AirSpeedVariantTypePluginSupport_copy_data(
                AirSpeedVariantType *dst,
                const AirSpeedVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AirSpeedVariantTypePlugin_copy_sample(
                ...
                const AirSpeedVariantType *src)
            {
                return ::UMAA::Common::Speed::AirSpeedVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AirSpeedVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AirSpeedVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AirSpeedVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
