...
namespace UMAA {
    namespace Common {
        namespace Speed {
            ...
            /* ----------------------------------------------------------------------------
            *  Type EngineRPMSpeedRequirementVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    EngineRPMSpeedRequirementVariantType *sample = new EngineRPMSpeedRequirementVariantType();
            ...
            EngineRPMSpeedRequirementVariantTypePluginSupport_copy_data(
                EngineRPMSpeedRequirementVariantType *dst,
                const EngineRPMSpeedRequirementVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            EngineRPMSpeedRequirementVariantTypePlugin_copy_sample(
                ...
                const EngineRPMSpeedRequirementVariantType *src)
            {
                return ::UMAA::Common::Speed::EngineRPMSpeedRequirementVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EngineRPMSpeedRequirementVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool EngineRPMSpeedRequirementVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                EngineRPMSpeedRequirementVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
