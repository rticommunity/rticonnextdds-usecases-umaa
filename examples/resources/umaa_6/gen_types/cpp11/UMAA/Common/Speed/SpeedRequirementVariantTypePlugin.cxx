    ...
    namespace Common {
        namespace Speed {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void SpeedRequirementVariantTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "SpeedRequirementVariantTypeEnum", indent_level + 1);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type SpeedRequirementVariantTypeUnion
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    SpeedRequirementVariantTypeUnion *sample = new SpeedRequirementVariantTypeUnion();
            ...
            SpeedRequirementVariantTypeUnionPluginSupport_copy_data(
                SpeedRequirementVariantTypeUnion *dst,
                const SpeedRequirementVariantTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            SpeedRequirementVariantTypeUnionPlugin_copy_sample(
                ...
                const SpeedRequirementVariantTypeUnion *src)
            {
                return ::UMAA::Common::Speed::SpeedRequirementVariantTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SpeedRequirementVariantTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool SpeedRequirementVariantTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SpeedRequirementVariantTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type SpeedRequirementVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    SpeedRequirementVariantType *sample = new SpeedRequirementVariantType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            SpeedRequirementVariantTypePluginSupport_copy_data(
                SpeedRequirementVariantType *dst,
                const SpeedRequirementVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            SpeedRequirementVariantTypePlugin_copy_sample(
                ...
                const SpeedRequirementVariantType *src)
            {
                return ::UMAA::Common::Speed::SpeedRequirementVariantTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SpeedRequirementVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool SpeedRequirementVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SpeedRequirementVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
