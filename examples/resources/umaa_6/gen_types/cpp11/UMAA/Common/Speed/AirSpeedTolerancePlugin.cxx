    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AirSpeedTolerance *sample = new AirSpeedTolerance();
            ...
            AirSpeedTolerancePluginSupport_copy_data(
                AirSpeedTolerance *dst,
                const AirSpeedTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AirSpeedTolerancePlugin_copy_sample(
                ...
                const AirSpeedTolerance *src)
            {
                return ::UMAA::Common::Speed::AirSpeedTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AirSpeedTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AirSpeedTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AirSpeedTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
