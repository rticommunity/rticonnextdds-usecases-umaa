    ...
    namespace Common {
        namespace Speed {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void SpeedVariantTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "SpeedVariantTypeEnum", indent_level + 1);
            }
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    SpeedVariantTypeUnion *sample = new SpeedVariantTypeUnion();
            ...
            SpeedVariantTypeUnionPluginSupport_copy_data(
                SpeedVariantTypeUnion *dst,
                const SpeedVariantTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            SpeedVariantTypeUnionPlugin_copy_sample(
                ...
                const SpeedVariantTypeUnion *src)
            {
                return ::UMAA::Common::Speed::SpeedVariantTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SpeedVariantTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool SpeedVariantTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SpeedVariantTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    SpeedVariantType *sample = new SpeedVariantType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            SpeedVariantTypePluginSupport_copy_data(
                SpeedVariantType *dst,
                const SpeedVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            SpeedVariantTypePlugin_copy_sample(
                ...
                const SpeedVariantType *src)
            {
                return ::UMAA::Common::Speed::SpeedVariantTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SpeedVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool SpeedVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SpeedVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
