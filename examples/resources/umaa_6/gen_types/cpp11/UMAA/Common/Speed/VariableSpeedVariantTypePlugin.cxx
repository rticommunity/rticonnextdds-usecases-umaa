    ...
    namespace Common {
        namespace Speed {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void VariableSpeedVariantTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "VariableSpeedVariantTypeEnum", indent_level + 1);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type VariableSpeedVariantTypeUnion
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    VariableSpeedVariantTypeUnion *sample = new VariableSpeedVariantTypeUnion();
            ...
            VariableSpeedVariantTypeUnionPluginSupport_copy_data(
                VariableSpeedVariantTypeUnion *dst,
                const VariableSpeedVariantTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            VariableSpeedVariantTypeUnionPlugin_copy_sample(
                ...
                const VariableSpeedVariantTypeUnion *src)
            {
                return ::UMAA::Common::Speed::VariableSpeedVariantTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< VariableSpeedVariantTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool VariableSpeedVariantTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                VariableSpeedVariantTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    VariableSpeedVariantType *sample = new VariableSpeedVariantType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            VariableSpeedVariantTypePluginSupport_copy_data(
                VariableSpeedVariantType *dst,
                const VariableSpeedVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            VariableSpeedVariantTypePlugin_copy_sample(
                ...
                const VariableSpeedVariantType *src)
            {
                return ::UMAA::Common::Speed::VariableSpeedVariantTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< VariableSpeedVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool VariableSpeedVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                VariableSpeedVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
