    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AirSpeedRequirement *sample = new AirSpeedRequirement();
            ...
            AirSpeedRequirementPluginSupport_copy_data(
                AirSpeedRequirement *dst,
                const AirSpeedRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AirSpeedRequirementPlugin_copy_sample(
                ...
                const AirSpeedRequirement *src)
            {
                return ::UMAA::Common::Speed::AirSpeedRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AirSpeedRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AirSpeedRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AirSpeedRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
