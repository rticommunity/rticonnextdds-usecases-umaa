...
namespace UMAA {
    namespace Common {
        namespace Speed {
            ...
            /* ----------------------------------------------------------------------------
            *  Type GroundSpeedRequirementVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GroundSpeedRequirementVariantType *sample = new GroundSpeedRequirementVariantType();
            ...
            GroundSpeedRequirementVariantTypePluginSupport_copy_data(
                GroundSpeedRequirementVariantType *dst,
                const GroundSpeedRequirementVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GroundSpeedRequirementVariantTypePlugin_copy_sample(
                ...
                const GroundSpeedRequirementVariantType *src)
            {
                return ::UMAA::Common::Speed::GroundSpeedRequirementVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GroundSpeedRequirementVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GroundSpeedRequirementVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GroundSpeedRequirementVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
