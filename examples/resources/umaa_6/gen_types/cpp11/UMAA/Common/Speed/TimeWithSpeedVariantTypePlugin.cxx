    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    TimeWithSpeedVariantType *sample = new TimeWithSpeedVariantType();
            ...
            TimeWithSpeedVariantTypePluginSupport_copy_data(
                TimeWithSpeedVariantType *dst,
                const TimeWithSpeedVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            TimeWithSpeedVariantTypePlugin_copy_sample(
                ...
                const TimeWithSpeedVariantType *src)
            {
                return ::UMAA::Common::Speed::TimeWithSpeedVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< TimeWithSpeedVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool TimeWithSpeedVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                TimeWithSpeedVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
