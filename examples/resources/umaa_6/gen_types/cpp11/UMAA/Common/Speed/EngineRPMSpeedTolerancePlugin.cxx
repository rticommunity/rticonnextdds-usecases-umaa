    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    EngineRPMSpeedTolerance *sample = new EngineRPMSpeedTolerance();
            ...
            EngineRPMSpeedTolerancePluginSupport_copy_data(
                EngineRPMSpeedTolerance *dst,
                const EngineRPMSpeedTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            EngineRPMSpeedTolerancePlugin_copy_sample(
                ...
                const EngineRPMSpeedTolerance *src)
            {
                return ::UMAA::Common::Speed::EngineRPMSpeedTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EngineRPMSpeedTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool EngineRPMSpeedTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                EngineRPMSpeedTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
