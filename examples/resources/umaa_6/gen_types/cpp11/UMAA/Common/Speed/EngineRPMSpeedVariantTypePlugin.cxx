...
namespace UMAA {
    namespace Common {
        namespace Speed {
            ...
            /* ----------------------------------------------------------------------------
            *  Type EngineRPMSpeedVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    EngineRPMSpeedVariantType *sample = new EngineRPMSpeedVariantType();
            ...
            EngineRPMSpeedVariantTypePluginSupport_copy_data(
                EngineRPMSpeedVariantType *dst,
                const EngineRPMSpeedVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            EngineRPMSpeedVariantTypePlugin_copy_sample(
                ...
                const EngineRPMSpeedVariantType *src)
            {
                return ::UMAA::Common::Speed::EngineRPMSpeedVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EngineRPMSpeedVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool EngineRPMSpeedVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                EngineRPMSpeedVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
