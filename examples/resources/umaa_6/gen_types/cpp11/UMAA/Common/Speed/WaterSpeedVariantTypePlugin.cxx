    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    WaterSpeedVariantType *sample = new WaterSpeedVariantType();
            ...
            WaterSpeedVariantTypePluginSupport_copy_data(
                WaterSpeedVariantType *dst,
                const WaterSpeedVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            WaterSpeedVariantTypePlugin_copy_sample(
                ...
                const WaterSpeedVariantType *src)
            {
                return ::UMAA::Common::Speed::WaterSpeedVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< WaterSpeedVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool WaterSpeedVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                WaterSpeedVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
