    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    WaterSpeedTolerance *sample = new WaterSpeedTolerance();
            ...
            WaterSpeedTolerancePluginSupport_copy_data(
                WaterSpeedTolerance *dst,
                const WaterSpeedTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            WaterSpeedTolerancePlugin_copy_sample(
                ...
                const WaterSpeedTolerance *src)
            {
                return ::UMAA::Common::Speed::WaterSpeedTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< WaterSpeedTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool WaterSpeedTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                WaterSpeedTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
