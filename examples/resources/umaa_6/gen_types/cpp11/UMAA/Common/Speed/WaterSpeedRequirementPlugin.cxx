    ...
    namespace Common {
        namespace Speed {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    WaterSpeedRequirement *sample = new WaterSpeedRequirement();
            ...
            WaterSpeedRequirementPluginSupport_copy_data(
                WaterSpeedRequirement *dst,
                const WaterSpeedRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            WaterSpeedRequirementPlugin_copy_sample(
                ...
                const WaterSpeedRequirement *src)
            {
                return ::UMAA::Common::Speed::WaterSpeedRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< WaterSpeedRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool WaterSpeedRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                WaterSpeedRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
