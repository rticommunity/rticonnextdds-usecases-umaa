...
namespace UMAA {
    namespace Common {
        namespace Angle {
            ...
            /* ----------------------------------------------------------------------------
            *  Type PropellerPitchAnglePropulsorToleranceType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PropellerPitchAnglePropulsorToleranceType *sample = new PropellerPitchAnglePropulsorToleranceType();
            ...
            PropellerPitchAnglePropulsorToleranceTypePluginSupport_copy_data(
                PropellerPitchAnglePropulsorToleranceType *dst,
                const PropellerPitchAnglePropulsorToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PropellerPitchAnglePropulsorToleranceTypePlugin_copy_sample(
                ...
                const PropellerPitchAnglePropulsorToleranceType *src)
            {
                return ::UMAA::Common::Angle::PropellerPitchAnglePropulsorToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PropellerPitchAnglePropulsorToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PropellerPitchAnglePropulsorToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PropellerPitchAnglePropulsorToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
