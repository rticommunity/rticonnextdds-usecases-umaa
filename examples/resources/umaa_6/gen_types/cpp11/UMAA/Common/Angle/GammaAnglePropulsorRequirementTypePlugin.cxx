...
namespace UMAA {
    namespace Common {
        namespace Angle {
            ...
            /* ----------------------------------------------------------------------------
            *  Type GammaAnglePropulsorRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GammaAnglePropulsorRequirementType *sample = new GammaAnglePropulsorRequirementType();
            ...
            GammaAnglePropulsorRequirementTypePluginSupport_copy_data(
                GammaAnglePropulsorRequirementType *dst,
                const GammaAnglePropulsorRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GammaAnglePropulsorRequirementTypePlugin_copy_sample(
                ...
                const GammaAnglePropulsorRequirementType *src)
            {
                return ::UMAA::Common::Angle::GammaAnglePropulsorRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GammaAnglePropulsorRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GammaAnglePropulsorRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GammaAnglePropulsorRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
