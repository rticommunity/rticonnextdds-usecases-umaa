...
namespace UMAA {
    namespace Common {
        namespace Angle {
            ...
            /* ----------------------------------------------------------------------------
            *  Type PropellerPitchAnglePropulsorRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PropellerPitchAnglePropulsorRequirementType *sample = new PropellerPitchAnglePropulsorRequirementType();
            ...
            PropellerPitchAnglePropulsorRequirementTypePluginSupport_copy_data(
                PropellerPitchAnglePropulsorRequirementType *dst,
                const PropellerPitchAnglePropulsorRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PropellerPitchAnglePropulsorRequirementTypePlugin_copy_sample(
                ...
                const PropellerPitchAnglePropulsorRequirementType *src)
            {
                return ::UMAA::Common::Angle::PropellerPitchAnglePropulsorRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PropellerPitchAnglePropulsorRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PropellerPitchAnglePropulsorRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PropellerPitchAnglePropulsorRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
