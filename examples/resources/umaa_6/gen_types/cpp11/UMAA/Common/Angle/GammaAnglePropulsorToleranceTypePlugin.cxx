...
namespace UMAA {
    namespace Common {
        namespace Angle {
            ...
            /* ----------------------------------------------------------------------------
            *  Type GammaAnglePropulsorToleranceType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GammaAnglePropulsorToleranceType *sample = new GammaAnglePropulsorToleranceType();
            ...
            GammaAnglePropulsorToleranceTypePluginSupport_copy_data(
                GammaAnglePropulsorToleranceType *dst,
                const GammaAnglePropulsorToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GammaAnglePropulsorToleranceTypePlugin_copy_sample(
                ...
                const GammaAnglePropulsorToleranceType *src)
            {
                return ::UMAA::Common::Angle::GammaAnglePropulsorToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GammaAnglePropulsorToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GammaAnglePropulsorToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GammaAnglePropulsorToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
