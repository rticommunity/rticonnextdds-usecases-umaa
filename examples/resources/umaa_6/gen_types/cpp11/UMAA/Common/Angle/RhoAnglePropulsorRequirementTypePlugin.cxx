...
namespace UMAA {
    namespace Common {
        namespace Angle {
            ...
            /* ----------------------------------------------------------------------------
            *  Type RhoAnglePropulsorRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    RhoAnglePropulsorRequirementType *sample = new RhoAnglePropulsorRequirementType();
            ...
            RhoAnglePropulsorRequirementTypePluginSupport_copy_data(
                RhoAnglePropulsorRequirementType *dst,
                const RhoAnglePropulsorRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            RhoAnglePropulsorRequirementTypePlugin_copy_sample(
                ...
                const RhoAnglePropulsorRequirementType *src)
            {
                return ::UMAA::Common::Angle::RhoAnglePropulsorRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< RhoAnglePropulsorRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool RhoAnglePropulsorRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RhoAnglePropulsorRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
