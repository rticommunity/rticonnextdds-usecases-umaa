    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    YawZNEDTolerance *sample = new YawZNEDTolerance();
            ...
            YawZNEDTolerancePluginSupport_copy_data(
                YawZNEDTolerance *dst,
                const YawZNEDTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            YawZNEDTolerancePlugin_copy_sample(
                ...
                const YawZNEDTolerance *src)
            {
                return ::UMAA::Common::Orientation::YawZNEDTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< YawZNEDTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool YawZNEDTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                YawZNEDTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
