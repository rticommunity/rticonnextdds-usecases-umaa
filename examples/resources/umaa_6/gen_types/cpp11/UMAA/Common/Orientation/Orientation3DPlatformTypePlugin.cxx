...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type Orientation3DPlatformType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    Orientation3DPlatformType *sample = new Orientation3DPlatformType();
            ...
            Orientation3DPlatformTypePluginSupport_copy_data(
                Orientation3DPlatformType *dst,
                const Orientation3DPlatformType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            Orientation3DPlatformTypePlugin_copy_sample(
                ...
                const Orientation3DPlatformType *src)
            {
                return ::UMAA::Common::Orientation::Orientation3DPlatformTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Orientation3DPlatformType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool Orientation3DPlatformTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Orientation3DPlatformType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
