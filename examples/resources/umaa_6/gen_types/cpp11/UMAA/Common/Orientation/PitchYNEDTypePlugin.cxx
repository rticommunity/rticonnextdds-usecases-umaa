    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PitchYNEDType *sample = new PitchYNEDType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PitchYNEDTypePlugin_copy_sample(
                ...
                const PitchYNEDType *src)
            {
                return ::UMAA::Common::Orientation::PitchYNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PitchYNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PitchYNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PitchYNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
