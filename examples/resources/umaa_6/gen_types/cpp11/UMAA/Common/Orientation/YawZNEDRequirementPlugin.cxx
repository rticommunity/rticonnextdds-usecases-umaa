    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    YawZNEDRequirement *sample = new YawZNEDRequirement();
            ...
            YawZNEDRequirementPluginSupport_copy_data(
                YawZNEDRequirement *dst,
                const YawZNEDRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            YawZNEDRequirementPlugin_copy_sample(
                ...
                const YawZNEDRequirement *src)
            {
                return ::UMAA::Common::Orientation::YawZNEDRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< YawZNEDRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool YawZNEDRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                YawZNEDRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
