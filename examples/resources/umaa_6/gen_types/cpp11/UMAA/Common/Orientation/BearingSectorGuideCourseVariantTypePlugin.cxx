...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type BearingSectorGuideCourseVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BearingSectorGuideCourseVariantType *sample = new BearingSectorGuideCourseVariantType();
            ...
            BearingSectorGuideCourseVariantTypePluginSupport_copy_data(
                BearingSectorGuideCourseVariantType *dst,
                const BearingSectorGuideCourseVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BearingSectorGuideCourseVariantTypePlugin_copy_sample(
                ...
                const BearingSectorGuideCourseVariantType *src)
            {
                return ::UMAA::Common::Orientation::BearingSectorGuideCourseVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BearingSectorGuideCourseVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BearingSectorGuideCourseVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BearingSectorGuideCourseVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
