...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type BearingSectorMagneticNorthVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BearingSectorMagneticNorthVariantType *sample = new BearingSectorMagneticNorthVariantType();
            ...
            BearingSectorMagneticNorthVariantTypePluginSupport_copy_data(
                BearingSectorMagneticNorthVariantType *dst,
                const BearingSectorMagneticNorthVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BearingSectorMagneticNorthVariantTypePlugin_copy_sample(
                ...
                const BearingSectorMagneticNorthVariantType *src)
            {
                return ::UMAA::Common::Orientation::BearingSectorMagneticNorthVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BearingSectorMagneticNorthVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BearingSectorMagneticNorthVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BearingSectorMagneticNorthVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
