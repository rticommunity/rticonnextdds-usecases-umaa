...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionCurrentRequirement
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionCurrentRequirement *sample = new DirectionCurrentRequirement();
            ...
            DirectionCurrentRequirementPluginSupport_copy_data(
                DirectionCurrentRequirement *dst,
                const DirectionCurrentRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionCurrentRequirementPlugin_copy_sample(
                ...
                const DirectionCurrentRequirement *src)
            {
                return ::UMAA::Common::Orientation::DirectionCurrentRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionCurrentRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionCurrentRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionCurrentRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
