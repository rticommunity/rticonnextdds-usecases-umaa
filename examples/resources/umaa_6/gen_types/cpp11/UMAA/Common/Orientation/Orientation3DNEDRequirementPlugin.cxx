...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type Orientation3DNEDRequirement
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    Orientation3DNEDRequirement *sample = new Orientation3DNEDRequirement();
            ...
            Orientation3DNEDRequirementPluginSupport_copy_data(
                Orientation3DNEDRequirement *dst,
                const Orientation3DNEDRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            Orientation3DNEDRequirementPlugin_copy_sample(
                ...
                const Orientation3DNEDRequirement *src)
            {
                return ::UMAA::Common::Orientation::Orientation3DNEDRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Orientation3DNEDRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool Orientation3DNEDRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Orientation3DNEDRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
