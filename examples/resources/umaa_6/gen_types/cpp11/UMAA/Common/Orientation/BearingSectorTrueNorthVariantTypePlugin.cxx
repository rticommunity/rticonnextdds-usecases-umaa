...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type BearingSectorTrueNorthVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BearingSectorTrueNorthVariantType *sample = new BearingSectorTrueNorthVariantType();
            ...
            BearingSectorTrueNorthVariantTypePluginSupport_copy_data(
                BearingSectorTrueNorthVariantType *dst,
                const BearingSectorTrueNorthVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BearingSectorTrueNorthVariantTypePlugin_copy_sample(
                ...
                const BearingSectorTrueNorthVariantType *src)
            {
                return ::UMAA::Common::Orientation::BearingSectorTrueNorthVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BearingSectorTrueNorthVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BearingSectorTrueNorthVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BearingSectorTrueNorthVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
