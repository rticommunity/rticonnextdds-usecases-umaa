    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PitchYNEDTolerance *sample = new PitchYNEDTolerance();
            ...
            PitchYNEDTolerancePluginSupport_copy_data(
                PitchYNEDTolerance *dst,
                const PitchYNEDTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PitchYNEDTolerancePlugin_copy_sample(
                ...
                const PitchYNEDTolerance *src)
            {
                return ::UMAA::Common::Orientation::PitchYNEDTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PitchYNEDTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PitchYNEDTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PitchYNEDTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
