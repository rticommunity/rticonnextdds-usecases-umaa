...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionMagneticNorthVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionMagneticNorthVariantType *sample = new DirectionMagneticNorthVariantType();
            ...
            DirectionMagneticNorthVariantTypePluginSupport_copy_data(
                DirectionMagneticNorthVariantType *dst,
                const DirectionMagneticNorthVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionMagneticNorthVariantTypePlugin_copy_sample(
                ...
                const DirectionMagneticNorthVariantType *src)
            {
                return ::UMAA::Common::Orientation::DirectionMagneticNorthVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionMagneticNorthVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionMagneticNorthVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionMagneticNorthVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
