    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    RollXNEDType *sample = new RollXNEDType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            RollXNEDTypePlugin_copy_sample(
                ...
                const RollXNEDType *src)
            {
                return ::UMAA::Common::Orientation::RollXNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< RollXNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool RollXNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RollXNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
