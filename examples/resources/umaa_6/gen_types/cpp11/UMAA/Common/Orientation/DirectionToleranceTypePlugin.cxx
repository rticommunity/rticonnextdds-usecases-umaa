    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionToleranceType *sample = new DirectionToleranceType();
            ...
            DirectionToleranceTypePluginSupport_copy_data(
                DirectionToleranceType *dst,
                const DirectionToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionToleranceTypePlugin_copy_sample(
                ...
                const DirectionToleranceType *src)
            {
                return ::UMAA::Common::Orientation::DirectionToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
