...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionTrueNorthVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionTrueNorthVariantType *sample = new DirectionTrueNorthVariantType();
            ...
            DirectionTrueNorthVariantTypePluginSupport_copy_data(
                DirectionTrueNorthVariantType *dst,
                const DirectionTrueNorthVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionTrueNorthVariantTypePlugin_copy_sample(
                ...
                const DirectionTrueNorthVariantType *src)
            {
                return ::UMAA::Common::Orientation::DirectionTrueNorthVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionTrueNorthVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionTrueNorthVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionTrueNorthVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
