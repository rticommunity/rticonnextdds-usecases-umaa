...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionTurnRateRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionTurnRateRequirementType *sample = new DirectionTurnRateRequirementType();
            ...
            DirectionTurnRateRequirementTypePluginSupport_copy_data(
                DirectionTurnRateRequirementType *dst,
                const DirectionTurnRateRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionTurnRateRequirementTypePlugin_copy_sample(
                ...
                const DirectionTurnRateRequirementType *src)
            {
                return ::UMAA::Common::Orientation::DirectionTurnRateRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionTurnRateRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionTurnRateRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionTurnRateRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
