    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    RollXNEDTolerance *sample = new RollXNEDTolerance();
            ...
            RollXNEDTolerancePluginSupport_copy_data(
                RollXNEDTolerance *dst,
                const RollXNEDTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            RollXNEDTolerancePlugin_copy_sample(
                ...
                const RollXNEDTolerance *src)
            {
                return ::UMAA::Common::Orientation::RollXNEDTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< RollXNEDTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool RollXNEDTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RollXNEDTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
