    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    YawZNEDType *sample = new YawZNEDType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            YawZNEDTypePlugin_copy_sample(
                ...
                const YawZNEDType *src)
            {
                return ::UMAA::Common::Orientation::YawZNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< YawZNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool YawZNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                YawZNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
