...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionCurrentVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionCurrentVariantType *sample = new DirectionCurrentVariantType();
            ...
            DirectionCurrentVariantTypePluginSupport_copy_data(
                DirectionCurrentVariantType *dst,
                const DirectionCurrentVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionCurrentVariantTypePlugin_copy_sample(
                ...
                const DirectionCurrentVariantType *src)
            {
                return ::UMAA::Common::Orientation::DirectionCurrentVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionCurrentVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionCurrentVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionCurrentVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
