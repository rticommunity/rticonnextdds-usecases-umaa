...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionTurnRateToleranceType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionTurnRateToleranceType *sample = new DirectionTurnRateToleranceType();
            ...
            DirectionTurnRateToleranceTypePluginSupport_copy_data(
                DirectionTurnRateToleranceType *dst,
                const DirectionTurnRateToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionTurnRateToleranceTypePlugin_copy_sample(
                ...
                const DirectionTurnRateToleranceType *src)
            {
                return ::UMAA::Common::Orientation::DirectionTurnRateToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionTurnRateToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionTurnRateToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionTurnRateToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
