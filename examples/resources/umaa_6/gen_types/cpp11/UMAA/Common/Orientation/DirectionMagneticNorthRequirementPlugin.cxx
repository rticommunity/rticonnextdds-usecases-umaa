...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionMagneticNorthRequirement
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionMagneticNorthRequirement *sample = new DirectionMagneticNorthRequirement();
            ...
            DirectionMagneticNorthRequirementPluginSupport_copy_data(
                DirectionMagneticNorthRequirement *dst,
                const DirectionMagneticNorthRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionMagneticNorthRequirementPlugin_copy_sample(
                ...
                const DirectionMagneticNorthRequirement *src)
            {
                return ::UMAA::Common::Orientation::DirectionMagneticNorthRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionMagneticNorthRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionMagneticNorthRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionMagneticNorthRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
