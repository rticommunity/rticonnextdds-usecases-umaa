    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    MagneticDeviationType *sample = new MagneticDeviationType();
            ...
            MagneticDeviationTypePluginSupport_copy_data(
                MagneticDeviationType *dst,
                const MagneticDeviationType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            MagneticDeviationTypePlugin_copy_sample(
                ...
                const MagneticDeviationType *src)
            {
                return ::UMAA::Common::Orientation::MagneticDeviationTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< MagneticDeviationType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool MagneticDeviationTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                MagneticDeviationType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
