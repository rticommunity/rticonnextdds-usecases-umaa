...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionTrueNorthRequirementVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionTrueNorthRequirementVariantType *sample = new DirectionTrueNorthRequirementVariantType();
            ...
            DirectionTrueNorthRequirementVariantTypePluginSupport_copy_data(
                DirectionTrueNorthRequirementVariantType *dst,
                const DirectionTrueNorthRequirementVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionTrueNorthRequirementVariantTypePlugin_copy_sample(
                ...
                const DirectionTrueNorthRequirementVariantType *src)
            {
                return ::UMAA::Common::Orientation::DirectionTrueNorthRequirementVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionTrueNorthRequirementVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionTrueNorthRequirementVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionTrueNorthRequirementVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
