    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    RollXNEDRequirement *sample = new RollXNEDRequirement();
            ...
            RollXNEDRequirementPluginSupport_copy_data(
                RollXNEDRequirement *dst,
                const RollXNEDRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            RollXNEDRequirementPlugin_copy_sample(
                ...
                const RollXNEDRequirement *src)
            {
                return ::UMAA::Common::Orientation::RollXNEDRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< RollXNEDRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool RollXNEDRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RollXNEDRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
