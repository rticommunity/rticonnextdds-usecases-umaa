    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionWindVariantType *sample = new DirectionWindVariantType();
            ...
            DirectionWindVariantTypePluginSupport_copy_data(
                DirectionWindVariantType *dst,
                const DirectionWindVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionWindVariantTypePlugin_copy_sample(
                ...
                const DirectionWindVariantType *src)
            {
                return ::UMAA::Common::Orientation::DirectionWindVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionWindVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionWindVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionWindVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
