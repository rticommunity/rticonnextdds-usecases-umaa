    ...
    namespace Common {
        namespace Orientation {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void DirectionVariantTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "DirectionVariantTypeEnum", indent_level + 1);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type DirectionVariantTypeUnion
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionVariantTypeUnion *sample = new DirectionVariantTypeUnion();
            ...
            DirectionVariantTypeUnionPluginSupport_copy_data(
                DirectionVariantTypeUnion *dst,
                const DirectionVariantTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionVariantTypeUnionPlugin_copy_sample(
                ...
                const DirectionVariantTypeUnion *src)
            {
                return ::UMAA::Common::Orientation::DirectionVariantTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionVariantTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionVariantTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionVariantTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionVariantType *sample = new DirectionVariantType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            DirectionVariantTypePluginSupport_copy_data(
                DirectionVariantType *dst,
                const DirectionVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionVariantTypePlugin_copy_sample(
                ...
                const DirectionVariantType *src)
            {
                return ::UMAA::Common::Orientation::DirectionVariantTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
