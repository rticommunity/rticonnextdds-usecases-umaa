...
namespace UMAA {
    namespace Common {
        namespace Orientation {
            ...
            /* ----------------------------------------------------------------------------
            *  Type OrientationAcceleration3DPlatformXYZ
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    OrientationAcceleration3DPlatformXYZ *sample = new OrientationAcceleration3DPlatformXYZ();
            ...
            OrientationAcceleration3DPlatformXYZPluginSupport_copy_data(
                OrientationAcceleration3DPlatformXYZ *dst,
                const OrientationAcceleration3DPlatformXYZ *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            OrientationAcceleration3DPlatformXYZPlugin_copy_sample(
                ...
                const OrientationAcceleration3DPlatformXYZ *src)
            {
                return ::UMAA::Common::Orientation::OrientationAcceleration3DPlatformXYZPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< OrientationAcceleration3DPlatformXYZ >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool OrientationAcceleration3DPlatformXYZPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                OrientationAcceleration3DPlatformXYZ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
