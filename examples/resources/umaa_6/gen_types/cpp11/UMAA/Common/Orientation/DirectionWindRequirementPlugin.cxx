    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DirectionWindRequirement *sample = new DirectionWindRequirement();
            ...
            DirectionWindRequirementPluginSupport_copy_data(
                DirectionWindRequirement *dst,
                const DirectionWindRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DirectionWindRequirementPlugin_copy_sample(
                ...
                const DirectionWindRequirement *src)
            {
                return ::UMAA::Common::Orientation::DirectionWindRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DirectionWindRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DirectionWindRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DirectionWindRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
