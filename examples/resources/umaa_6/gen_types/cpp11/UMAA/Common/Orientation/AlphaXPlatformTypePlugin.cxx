    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AlphaXPlatformType *sample = new AlphaXPlatformType();
            ...
            AlphaXPlatformTypePluginSupport_copy_data(
                AlphaXPlatformType *dst,
                const AlphaXPlatformType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AlphaXPlatformTypePlugin_copy_sample(
                ...
                const AlphaXPlatformType *src)
            {
                return ::UMAA::Common::Orientation::AlphaXPlatformTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AlphaXPlatformType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AlphaXPlatformTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AlphaXPlatformType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
