    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PitchYNEDRequirement *sample = new PitchYNEDRequirement();
            ...
            PitchYNEDRequirementPluginSupport_copy_data(
                PitchYNEDRequirement *dst,
                const PitchYNEDRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PitchYNEDRequirementPlugin_copy_sample(
                ...
                const PitchYNEDRequirement *src)
            {
                return ::UMAA::Common::Orientation::PitchYNEDRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PitchYNEDRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PitchYNEDRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PitchYNEDRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
