    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GammaZPlatformType *sample = new GammaZPlatformType();
            ...
            GammaZPlatformTypePluginSupport_copy_data(
                GammaZPlatformType *dst,
                const GammaZPlatformType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GammaZPlatformTypePlugin_copy_sample(
                ...
                const GammaZPlatformType *src)
            {
                return ::UMAA::Common::Orientation::GammaZPlatformTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GammaZPlatformType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GammaZPlatformTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GammaZPlatformType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
