    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BetaYPlatformType *sample = new BetaYPlatformType();
            ...
            BetaYPlatformTypePluginSupport_copy_data(
                BetaYPlatformType *dst,
                const BetaYPlatformType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BetaYPlatformTypePlugin_copy_sample(
                ...
                const BetaYPlatformType *src)
            {
                return ::UMAA::Common::Orientation::BetaYPlatformTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BetaYPlatformType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BetaYPlatformTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BetaYPlatformType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
