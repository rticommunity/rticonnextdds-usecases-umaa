    ...
    namespace Common {
        namespace Orientation {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    Orientation3DNEDType *sample = new Orientation3DNEDType();
            ...
            Orientation3DNEDTypePluginSupport_copy_data(
                Orientation3DNEDType *dst,
                const Orientation3DNEDType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            Orientation3DNEDTypePlugin_copy_sample(
                ...
                const Orientation3DNEDType *src)
            {
                return ::UMAA::Common::Orientation::Orientation3DNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Orientation3DNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool Orientation3DNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Orientation3DNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
