    ...
    namespace Common {
        namespace Orientation {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void BearingSectorVariantTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "BearingSectorVariantTypeEnum", indent_level + 1);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type BearingSectorVariantTypeUnion
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BearingSectorVariantTypeUnion *sample = new BearingSectorVariantTypeUnion();
            ...
            BearingSectorVariantTypeUnionPluginSupport_copy_data(
                BearingSectorVariantTypeUnion *dst,
                const BearingSectorVariantTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BearingSectorVariantTypeUnionPlugin_copy_sample(
                ...
                const BearingSectorVariantTypeUnion *src)
            {
                return ::UMAA::Common::Orientation::BearingSectorVariantTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BearingSectorVariantTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BearingSectorVariantTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BearingSectorVariantTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    BearingSectorVariantType *sample = new BearingSectorVariantType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            BearingSectorVariantTypePluginSupport_copy_data(
                BearingSectorVariantType *dst,
                const BearingSectorVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            BearingSectorVariantTypePlugin_copy_sample(
                ...
                const BearingSectorVariantType *src)
            {
                return ::UMAA::Common::Orientation::BearingSectorVariantTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< BearingSectorVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BearingSectorVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BearingSectorVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
