    ...
    namespace Common {
        namespace Time {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DateTimeToleranceType *sample = new DateTimeToleranceType();
            ...
            DateTimeToleranceTypePluginSupport_copy_data(
                DateTimeToleranceType *dst,
                const DateTimeToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DateTimeToleranceTypePlugin_copy_sample(
                ...
                const DateTimeToleranceType *src)
            {
                return ::UMAA::Common::Time::DateTimeToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DateTimeToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DateTimeToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DateTimeToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
