    ...
    namespace Common {
        namespace Time {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DateTimeRequirementType *sample = new DateTimeRequirementType();
            ...
            DateTimeRequirementTypePluginSupport_copy_data(
                DateTimeRequirementType *dst,
                const DateTimeRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DateTimeRequirementTypePlugin_copy_sample(
                ...
                const DateTimeRequirementType *src)
            {
                return ::UMAA::Common::Time::DateTimeRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DateTimeRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DateTimeRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DateTimeRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
