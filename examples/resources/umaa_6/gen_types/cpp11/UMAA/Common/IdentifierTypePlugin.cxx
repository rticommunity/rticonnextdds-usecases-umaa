...
namespace UMAA {
    namespace Common {
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            try {
                IdentifierType *sample = new IdentifierType();
        ...
        * ---------------------------------------------------------------------------- */
        ...
        IdentifierTypePlugin_copy_sample(
            ...
            const IdentifierType *src)
        {
            return ::UMAA::Common::IdentifierTypePluginSupport_copy_data(dst,src);
        }
            ...
            ::dds::core::policy::DataRepresentationId representation)
        {
            ...
            try{
                ...
                try {
                    ...
                    (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< IdentifierType >::get().native()
                    ;
                } catch (...) {
                    return RTI_FALSE;
                }
        ...
        * -------------------------------------------------------------------------------------- */
        ...
        RTIBool IdentifierTypePlugin_deserialize_key(
            PRESTypePluginEndpointData endpoint_data,
            IdentifierType **sample, 
            RTIBool * drop_sample,
            struct RTICdrStream *cdrStream,
