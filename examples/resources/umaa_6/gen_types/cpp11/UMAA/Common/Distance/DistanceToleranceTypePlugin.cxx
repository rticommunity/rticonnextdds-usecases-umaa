    ...
    namespace Common {
        namespace Distance {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DistanceToleranceType *sample = new DistanceToleranceType();
            ...
            DistanceToleranceTypePluginSupport_copy_data(
                DistanceToleranceType *dst,
                const DistanceToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DistanceToleranceTypePlugin_copy_sample(
                ...
                const DistanceToleranceType *src)
            {
                return ::UMAA::Common::Distance::DistanceToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DistanceToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DistanceToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DistanceToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
