    ...
    namespace Common {
        namespace Distance {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DistanceRequirementType *sample = new DistanceRequirementType();
            ...
            DistanceRequirementTypePluginSupport_copy_data(
                DistanceRequirementType *dst,
                const DistanceRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DistanceRequirementTypePlugin_copy_sample(
                ...
                const DistanceRequirementType *src)
            {
                return ::UMAA::Common::Distance::DistanceRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DistanceRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DistanceRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DistanceRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
