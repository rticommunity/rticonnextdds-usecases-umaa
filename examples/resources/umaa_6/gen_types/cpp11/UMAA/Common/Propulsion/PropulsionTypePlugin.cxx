    ...
    namespace Common {
        namespace Propulsion {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void PropulsionTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "PropulsionTypeEnum", indent_level + 1);
            }
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PropulsionTypeUnion *sample = new PropulsionTypeUnion();
            ...
            PropulsionTypeUnionPluginSupport_copy_data(
                PropulsionTypeUnion *dst,
                const PropulsionTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PropulsionTypeUnionPlugin_copy_sample(
                ...
                const PropulsionTypeUnion *src)
            {
                return ::UMAA::Common::Propulsion::PropulsionTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PropulsionTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PropulsionTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PropulsionTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
