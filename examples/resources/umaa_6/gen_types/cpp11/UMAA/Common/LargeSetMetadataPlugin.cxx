...
namespace UMAA {
    namespace Common {
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            try {
                LargeSetMetadata *sample = new LargeSetMetadata();
        ...
        LargeSetMetadataPluginSupport_copy_data(
            LargeSetMetadata *dst,
            const LargeSetMetadata *src)
        {
            try {
                *dst = *src;
            } catch (...) {
        ...
        * ---------------------------------------------------------------------------- */
            ...
            RTICdrTypeCode *type_code)
        {
            try {
                ...
                programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
                    ...
                    (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< LargeSetMetadata >::get().native()
                    ,
                    &programProperty,
            ...
            void *containerPluginContext)
        {
            try {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    LargeSetMetadataPluginSupport_create_data,
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = ::UMAA::Common::LargeSetMetadataPlugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        ::UMAA::Common::LargeSetMetadataPlugin_get_serialized_sample_max_size, epd,
        ...
        LargeSetMetadataPlugin_copy_sample(
            ...
            const LargeSetMetadata *src)
        {
            return ::UMAA::Common::LargeSetMetadataPluginSupport_copy_data(dst,src);
        }
            ...
            ::dds::core::policy::DataRepresentationId representation)
        {
            ...
            try{
                ...
                try {
                    ...
                    (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< LargeSetMetadata >::get().native()
                    ;
                } catch (...) {
                    return RTI_FALSE;
                }
        ...
        * -------------------------------------------------------------------------------------- */
        ...
        RTIBool LargeSetMetadataPlugin_deserialize_key(
            PRESTypePluginEndpointData endpoint_data,
            LargeSetMetadata **sample, 
            RTIBool * drop_sample,
            struct RTICdrStream *cdrStream,
        ...
        * ------------------------------------------------------------------------ */
        struct PRESTypePlugin *LargeSetMetadataPlugin_new(void) 
        { 
            ...
            ::UMAA::Common::LargeSetMetadataPlugin_on_participant_attached;
            plugin->onParticipantDetached =
            (PRESTypePluginOnParticipantDetachedCallback)
            ::UMAA::Common::LargeSetMetadataPlugin_on_participant_detached;
            plugin->onEndpointAttached =
            (PRESTypePluginOnEndpointAttachedCallback)
            ::UMAA::Common::LargeSetMetadataPlugin_on_endpoint_attached;
            plugin->onEndpointDetached =
            (PRESTypePluginOnEndpointDetachedCallback)
            ::UMAA::Common::LargeSetMetadataPlugin_on_endpoint_detached;

            plugin->copySampleFnc =
            (PRESTypePluginCopySampleFunction)
            ::UMAA::Common::LargeSetMetadataPlugin_copy_sample;
            plugin->createSampleFnc =
            (PRESTypePluginCreateSampleFunction)
            LargeSetMetadataPlugin_create_sample;
            plugin->destroySampleFnc =
            (PRESTypePluginDestroySampleFunction)
            LargeSetMetadataPlugin_destroy_sample;
            ...
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
            ::UMAA::Common::LargeSetMetadataPlugin_get_serialized_sample_max_size;
            ...
            LargeSetMetadataPlugin_get_sample;
            plugin->returnSampleFnc =
            (PRESTypePluginReturnSampleFunction)
            LargeSetMetadataPlugin_return_sample;
            plugin->getKeyKindFnc =
            (PRESTypePluginGetKeyKindFunction)
            ::UMAA::Common::LargeSetMetadataPlugin_get_key_kind;
            ...
            */
            ...
            try {
                plugin->typeCode = (struct RTICdrTypeCode *)
                &::rti::topic::dynamic_type< ::UMAA::Common::LargeSetMetadata >::get().native();
            } catch (...) {
                ::UMAA::Common::LargeSetMetadataPlugin_delete(plugin);
                return NULL;
            }
            #endif
            ...
            LargeSetMetadataPlugin_get_buffer;
            plugin->returnBuffer = 
            (PRESTypePluginReturnBufferFunction)
            LargeSetMetadataPlugin_return_buffer;
            ...
            static const char * TYPE_NAME = "UMAA::Common::LargeSetMetadata";
        ...
        void
        LargeSetMetadataPlugin_delete(struct PRESTypePlugin *plugin)
        {
