...
namespace UMAA {
    namespace Common {
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            try {
                LargeListMetadata *sample = new LargeListMetadata();
        ...
        LargeListMetadataPluginSupport_copy_data(
            LargeListMetadata *dst,
            const LargeListMetadata *src)
        {
            try {
                *dst = *src;
            } catch (...) {
        ...
        * ---------------------------------------------------------------------------- */
            ...
            RTICdrTypeCode *type_code)
        {
            try {
                ...
                programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
                    ...
                    (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< LargeListMetadata >::get().native()
                    ,
                    &programProperty,
            ...
            void *containerPluginContext)
        {
            try {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    LargeListMetadataPluginSupport_create_data,
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = ::UMAA::Common::LargeListMetadataPlugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        ::UMAA::Common::LargeListMetadataPlugin_get_serialized_sample_max_size, epd,
        ...
        LargeListMetadataPlugin_copy_sample(
            ...
            const LargeListMetadata *src)
        {
            return ::UMAA::Common::LargeListMetadataPluginSupport_copy_data(dst,src);
        }
            ...
            ::dds::core::policy::DataRepresentationId representation)
        {
            ...
            try{
                ...
                try {
                    ...
                    (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< LargeListMetadata >::get().native()
                    ;
                } catch (...) {
                    return RTI_FALSE;
                }
        ...
        * -------------------------------------------------------------------------------------- */
        ...
        RTIBool LargeListMetadataPlugin_deserialize_key(
            PRESTypePluginEndpointData endpoint_data,
            LargeListMetadata **sample, 
            RTIBool * drop_sample,
            struct RTICdrStream *cdrStream,
        ...
        * ------------------------------------------------------------------------ */
        struct PRESTypePlugin *LargeListMetadataPlugin_new(void) 
        { 
            ...
            ::UMAA::Common::LargeListMetadataPlugin_on_participant_attached;
            plugin->onParticipantDetached =
            (PRESTypePluginOnParticipantDetachedCallback)
            ::UMAA::Common::LargeListMetadataPlugin_on_participant_detached;
            plugin->onEndpointAttached =
            (PRESTypePluginOnEndpointAttachedCallback)
            ::UMAA::Common::LargeListMetadataPlugin_on_endpoint_attached;
            plugin->onEndpointDetached =
            (PRESTypePluginOnEndpointDetachedCallback)
            ::UMAA::Common::LargeListMetadataPlugin_on_endpoint_detached;

            plugin->copySampleFnc =
            (PRESTypePluginCopySampleFunction)
            ::UMAA::Common::LargeListMetadataPlugin_copy_sample;
            plugin->createSampleFnc =
            (PRESTypePluginCreateSampleFunction)
            LargeListMetadataPlugin_create_sample;
            plugin->destroySampleFnc =
            (PRESTypePluginDestroySampleFunction)
            LargeListMetadataPlugin_destroy_sample;
            ...
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
            ::UMAA::Common::LargeListMetadataPlugin_get_serialized_sample_max_size;
            ...
            LargeListMetadataPlugin_get_sample;
            plugin->returnSampleFnc =
            (PRESTypePluginReturnSampleFunction)
            LargeListMetadataPlugin_return_sample;
            plugin->getKeyKindFnc =
            (PRESTypePluginGetKeyKindFunction)
            ::UMAA::Common::LargeListMetadataPlugin_get_key_kind;
            ...
            */
            ...
            try {
                plugin->typeCode = (struct RTICdrTypeCode *)
                &::rti::topic::dynamic_type< ::UMAA::Common::LargeListMetadata >::get().native();
            } catch (...) {
                ::UMAA::Common::LargeListMetadataPlugin_delete(plugin);
                return NULL;
            }
            #endif
            ...
            LargeListMetadataPlugin_get_buffer;
            plugin->returnBuffer = 
            (PRESTypePluginReturnBufferFunction)
            LargeListMetadataPlugin_return_buffer;
            ...
            static const char * TYPE_NAME = "UMAA::Common::LargeListMetadata";
        ...
        void
        LargeListMetadataPlugin_delete(struct PRESTypePlugin *plugin)
        {
