    ...
    namespace Common {
        namespace Position {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GeoPosition2DTolerance *sample = new GeoPosition2DTolerance();
            ...
            GeoPosition2DTolerancePluginSupport_copy_data(
                GeoPosition2DTolerance *dst,
                const GeoPosition2DTolerance *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GeoPosition2DTolerancePlugin_copy_sample(
                ...
                const GeoPosition2DTolerance *src)
            {
                return ::UMAA::Common::Position::GeoPosition2DTolerancePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GeoPosition2DTolerance >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GeoPosition2DTolerancePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GeoPosition2DTolerance **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
