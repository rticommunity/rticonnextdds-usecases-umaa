    ...
    namespace Common {
        namespace Position {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GeoPosition2DRequirement *sample = new GeoPosition2DRequirement();
            ...
            GeoPosition2DRequirementPluginSupport_copy_data(
                GeoPosition2DRequirement *dst,
                const GeoPosition2DRequirement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GeoPosition2DRequirementPlugin_copy_sample(
                ...
                const GeoPosition2DRequirement *src)
            {
                return ::UMAA::Common::Position::GeoPosition2DRequirementPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GeoPosition2DRequirement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GeoPosition2DRequirementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GeoPosition2DRequirement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
