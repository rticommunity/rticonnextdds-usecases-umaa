        ...
        namespace Environment {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PoseTypePlugin_copy_sample(
                ...
                const PoseType *src)
            {
                return ::UMAA::Common::Environment::PoseTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PoseType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PoseTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PoseType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
