    ...
    namespace Common {
        namespace Environment {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DepthSpeedPairType *sample = new DepthSpeedPairType();
            ...
            DepthSpeedPairTypePluginSupport_copy_data(
                DepthSpeedPairType *dst,
                const DepthSpeedPairType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DepthSpeedPairTypePlugin_copy_sample(
                ...
                const DepthSpeedPairType *src)
            {
                return ::UMAA::Common::Environment::DepthSpeedPairTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DepthSpeedPairType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DepthSpeedPairTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DepthSpeedPairType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
