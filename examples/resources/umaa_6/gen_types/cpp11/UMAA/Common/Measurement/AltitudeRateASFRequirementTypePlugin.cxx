...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeRateASFRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeRateASFRequirementType *sample = new AltitudeRateASFRequirementType();
            ...
            AltitudeRateASFRequirementTypePluginSupport_copy_data(
                AltitudeRateASFRequirementType *dst,
                const AltitudeRateASFRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeRateASFRequirementTypePlugin_copy_sample(
                ...
                const AltitudeRateASFRequirementType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeRateASFRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeRateASFRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeRateASFRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeRateASFRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
