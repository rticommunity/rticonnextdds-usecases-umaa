    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GeoPosition3DWGS84 *sample = new GeoPosition3DWGS84();
            ...
            GeoPosition3DWGS84PluginSupport_copy_data(
                GeoPosition3DWGS84 *dst,
                const GeoPosition3DWGS84 *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GeoPosition3DWGS84Plugin_copy_sample(
                ...
                const GeoPosition3DWGS84 *src)
            {
                return ::UMAA::Common::Measurement::GeoPosition3DWGS84PluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GeoPosition3DWGS84 >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GeoPosition3DWGS84Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GeoPosition3DWGS84 **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
