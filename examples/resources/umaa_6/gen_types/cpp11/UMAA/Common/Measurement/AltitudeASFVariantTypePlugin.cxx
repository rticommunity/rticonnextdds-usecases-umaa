    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeASFVariantType *sample = new AltitudeASFVariantType();
            ...
            AltitudeASFVariantTypePluginSupport_copy_data(
                AltitudeASFVariantType *dst,
                const AltitudeASFVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeASFVariantTypePlugin_copy_sample(
                ...
                const AltitudeASFVariantType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeASFVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeASFVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeASFVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeASFVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
