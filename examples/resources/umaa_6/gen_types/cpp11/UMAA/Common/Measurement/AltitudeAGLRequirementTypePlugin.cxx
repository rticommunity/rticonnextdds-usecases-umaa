...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeAGLRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeAGLRequirementType *sample = new AltitudeAGLRequirementType();
            ...
            AltitudeAGLRequirementTypePluginSupport_copy_data(
                AltitudeAGLRequirementType *dst,
                const AltitudeAGLRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeAGLRequirementTypePlugin_copy_sample(
                ...
                const AltitudeAGLRequirementType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeAGLRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeAGLRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeAGLRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeAGLRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
