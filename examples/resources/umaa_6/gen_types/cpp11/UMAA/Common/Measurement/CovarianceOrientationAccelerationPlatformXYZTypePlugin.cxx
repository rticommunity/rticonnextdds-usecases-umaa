...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CovarianceOrientationAccelerationPlatformXYZType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CovarianceOrientationAccelerationPlatformXYZType *sample = new CovarianceOrientationAccelerationPlatformXYZType();
            ...
            CovarianceOrientationAccelerationPlatformXYZTypePluginSupport_copy_data(
                CovarianceOrientationAccelerationPlatformXYZType *dst,
                const CovarianceOrientationAccelerationPlatformXYZType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CovarianceOrientationAccelerationPlatformXYZTypePlugin_copy_sample(
                ...
                const CovarianceOrientationAccelerationPlatformXYZType *src)
            {
                return ::UMAA::Common::Measurement::CovarianceOrientationAccelerationPlatformXYZTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CovarianceOrientationAccelerationPlatformXYZType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CovarianceOrientationAccelerationPlatformXYZTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CovarianceOrientationAccelerationPlatformXYZType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
