...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CovariancePositionVelocityNEDType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CovariancePositionVelocityNEDType *sample = new CovariancePositionVelocityNEDType();
            ...
            CovariancePositionVelocityNEDTypePluginSupport_copy_data(
                CovariancePositionVelocityNEDType *dst,
                const CovariancePositionVelocityNEDType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CovariancePositionVelocityNEDTypePlugin_copy_sample(
                ...
                const CovariancePositionVelocityNEDType *src)
            {
                return ::UMAA::Common::Measurement::CovariancePositionVelocityNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CovariancePositionVelocityNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CovariancePositionVelocityNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CovariancePositionVelocityNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
