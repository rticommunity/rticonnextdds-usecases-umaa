...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CovarianceAccelerationPlatformXYZType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CovarianceAccelerationPlatformXYZType *sample = new CovarianceAccelerationPlatformXYZType();
            ...
            CovarianceAccelerationPlatformXYZTypePluginSupport_copy_data(
                CovarianceAccelerationPlatformXYZType *dst,
                const CovarianceAccelerationPlatformXYZType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CovarianceAccelerationPlatformXYZTypePlugin_copy_sample(
                ...
                const CovarianceAccelerationPlatformXYZType *src)
            {
                return ::UMAA::Common::Measurement::CovarianceAccelerationPlatformXYZTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CovarianceAccelerationPlatformXYZType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CovarianceAccelerationPlatformXYZTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CovarianceAccelerationPlatformXYZType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
