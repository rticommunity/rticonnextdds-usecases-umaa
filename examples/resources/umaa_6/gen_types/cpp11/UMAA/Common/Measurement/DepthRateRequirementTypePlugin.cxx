    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DepthRateRequirementType *sample = new DepthRateRequirementType();
            ...
            DepthRateRequirementTypePluginSupport_copy_data(
                DepthRateRequirementType *dst,
                const DepthRateRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DepthRateRequirementTypePlugin_copy_sample(
                ...
                const DepthRateRequirementType *src)
            {
                return ::UMAA::Common::Measurement::DepthRateRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DepthRateRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DepthRateRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DepthRateRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
