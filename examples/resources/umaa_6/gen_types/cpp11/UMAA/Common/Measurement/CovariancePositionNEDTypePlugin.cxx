...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CovariancePositionNEDType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CovariancePositionNEDType *sample = new CovariancePositionNEDType();
            ...
            CovariancePositionNEDTypePluginSupport_copy_data(
                CovariancePositionNEDType *dst,
                const CovariancePositionNEDType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CovariancePositionNEDTypePlugin_copy_sample(
                ...
                const CovariancePositionNEDType *src)
            {
                return ::UMAA::Common::Measurement::CovariancePositionNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CovariancePositionNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CovariancePositionNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CovariancePositionNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
