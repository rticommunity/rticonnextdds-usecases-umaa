    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeAGLToleranceType *sample = new AltitudeAGLToleranceType();
            ...
            AltitudeAGLToleranceTypePluginSupport_copy_data(
                AltitudeAGLToleranceType *dst,
                const AltitudeAGLToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeAGLToleranceTypePlugin_copy_sample(
                ...
                const AltitudeAGLToleranceType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeAGLToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeAGLToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeAGLToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeAGLToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
