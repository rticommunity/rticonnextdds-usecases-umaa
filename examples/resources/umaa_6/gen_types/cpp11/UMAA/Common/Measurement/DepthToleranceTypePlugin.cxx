    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DepthToleranceType *sample = new DepthToleranceType();
            ...
            DepthToleranceTypePluginSupport_copy_data(
                DepthToleranceType *dst,
                const DepthToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DepthToleranceTypePlugin_copy_sample(
                ...
                const DepthToleranceType *src)
            {
                return ::UMAA::Common::Measurement::DepthToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DepthToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DepthToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DepthToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
