...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            LevelType::LevelType (double level_):
                m_level_(level_) {
            }

            void LevelType::swap(LevelType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::Common::Measurement::LevelType > {
            static DDS_TypeCode * get()
            {
                ...
                LevelType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::VolumePercent_AliasTag_t>::get().native();
                ...
                LevelType_g_tc_members[0]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                LevelType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                LevelType_g_tc_members[0]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
