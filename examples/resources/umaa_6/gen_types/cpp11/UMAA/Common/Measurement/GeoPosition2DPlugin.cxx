    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GeoPosition2D *sample = new GeoPosition2D();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GeoPosition2DPlugin_copy_sample(
                ...
                const GeoPosition2D *src)
            {
                return ::UMAA::Common::Measurement::GeoPosition2DPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GeoPosition2D >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GeoPosition2DPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GeoPosition2D **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
