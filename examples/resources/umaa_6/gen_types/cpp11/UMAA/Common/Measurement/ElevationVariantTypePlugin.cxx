    ...
    namespace Common {
        namespace Measurement {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void ElevationVariantTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "ElevationVariantTypeEnum", indent_level + 1);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type ElevationVariantTypeUnion
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ElevationVariantTypeUnion *sample = new ElevationVariantTypeUnion();
            ...
            ElevationVariantTypeUnionPluginSupport_copy_data(
                ElevationVariantTypeUnion *dst,
                const ElevationVariantTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ElevationVariantTypeUnionPlugin_copy_sample(
                ...
                const ElevationVariantTypeUnion *src)
            {
                return ::UMAA::Common::Measurement::ElevationVariantTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ElevationVariantTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ElevationVariantTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ElevationVariantTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ElevationVariantType *sample = new ElevationVariantType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            ElevationVariantTypePluginSupport_copy_data(
                ElevationVariantType *dst,
                const ElevationVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ElevationVariantTypePlugin_copy_sample(
                ...
                const ElevationVariantType *src)
            {
                return ::UMAA::Common::Measurement::ElevationVariantTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ElevationVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ElevationVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ElevationVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
