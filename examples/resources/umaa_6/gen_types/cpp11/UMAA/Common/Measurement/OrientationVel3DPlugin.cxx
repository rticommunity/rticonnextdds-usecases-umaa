    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    OrientationVel3D *sample = new OrientationVel3D();
            ...
            OrientationVel3DPluginSupport_copy_data(
                OrientationVel3D *dst,
                const OrientationVel3D *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            OrientationVel3DPlugin_copy_sample(
                ...
                const OrientationVel3D *src)
            {
                return ::UMAA::Common::Measurement::OrientationVel3DPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< OrientationVel3D >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool OrientationVel3DPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                OrientationVel3D **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
