...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeRateASFToleranceType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeRateASFToleranceType *sample = new AltitudeRateASFToleranceType();
            ...
            AltitudeRateASFToleranceTypePluginSupport_copy_data(
                AltitudeRateASFToleranceType *dst,
                const AltitudeRateASFToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeRateASFToleranceTypePlugin_copy_sample(
                ...
                const AltitudeRateASFToleranceType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeRateASFToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeRateASFToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeRateASFToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeRateASFToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
