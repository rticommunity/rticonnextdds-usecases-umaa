    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeMSLVariantType *sample = new AltitudeMSLVariantType();
            ...
            AltitudeMSLVariantTypePluginSupport_copy_data(
                AltitudeMSLVariantType *dst,
                const AltitudeMSLVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeMSLVariantTypePlugin_copy_sample(
                ...
                const AltitudeMSLVariantType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeMSLVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeMSLVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeMSLVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeMSLVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
