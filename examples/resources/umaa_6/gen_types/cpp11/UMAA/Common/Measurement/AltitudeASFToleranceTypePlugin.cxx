    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeASFToleranceType *sample = new AltitudeASFToleranceType();
            ...
            AltitudeASFToleranceTypePluginSupport_copy_data(
                AltitudeASFToleranceType *dst,
                const AltitudeASFToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeASFToleranceTypePlugin_copy_sample(
                ...
                const AltitudeASFToleranceType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeASFToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeASFToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeASFToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeASFToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
