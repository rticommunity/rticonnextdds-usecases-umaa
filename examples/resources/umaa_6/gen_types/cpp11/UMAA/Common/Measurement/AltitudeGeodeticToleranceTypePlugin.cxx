...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeGeodeticToleranceType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeGeodeticToleranceType *sample = new AltitudeGeodeticToleranceType();
            ...
            AltitudeGeodeticToleranceTypePluginSupport_copy_data(
                AltitudeGeodeticToleranceType *dst,
                const AltitudeGeodeticToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeGeodeticToleranceTypePlugin_copy_sample(
                ...
                const AltitudeGeodeticToleranceType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeGeodeticToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeGeodeticToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeGeodeticToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeGeodeticToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
