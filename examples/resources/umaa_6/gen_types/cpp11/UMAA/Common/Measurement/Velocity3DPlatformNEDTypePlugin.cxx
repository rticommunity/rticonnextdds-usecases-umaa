...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type Velocity3DPlatformNEDType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    Velocity3DPlatformNEDType *sample = new Velocity3DPlatformNEDType();
            ...
            Velocity3DPlatformNEDTypePluginSupport_copy_data(
                Velocity3DPlatformNEDType *dst,
                const Velocity3DPlatformNEDType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            Velocity3DPlatformNEDTypePlugin_copy_sample(
                ...
                const Velocity3DPlatformNEDType *src)
            {
                return ::UMAA::Common::Measurement::Velocity3DPlatformNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Velocity3DPlatformNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool Velocity3DPlatformNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Velocity3DPlatformNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
