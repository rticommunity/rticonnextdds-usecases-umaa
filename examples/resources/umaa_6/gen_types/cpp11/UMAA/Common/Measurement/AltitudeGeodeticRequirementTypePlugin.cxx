...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeGeodeticRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeGeodeticRequirementType *sample = new AltitudeGeodeticRequirementType();
            ...
            AltitudeGeodeticRequirementTypePluginSupport_copy_data(
                AltitudeGeodeticRequirementType *dst,
                const AltitudeGeodeticRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeGeodeticRequirementTypePlugin_copy_sample(
                ...
                const AltitudeGeodeticRequirementType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeGeodeticRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeGeodeticRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeGeodeticRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeGeodeticRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
