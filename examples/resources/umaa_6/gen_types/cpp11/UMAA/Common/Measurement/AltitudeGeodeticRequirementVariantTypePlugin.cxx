...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeGeodeticRequirementVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeGeodeticRequirementVariantType *sample = new AltitudeGeodeticRequirementVariantType();
            ...
            AltitudeGeodeticRequirementVariantTypePluginSupport_copy_data(
                AltitudeGeodeticRequirementVariantType *dst,
                const AltitudeGeodeticRequirementVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeGeodeticRequirementVariantTypePlugin_copy_sample(
                ...
                const AltitudeGeodeticRequirementVariantType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeGeodeticRequirementVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeGeodeticRequirementVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeGeodeticRequirementVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeGeodeticRequirementVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
