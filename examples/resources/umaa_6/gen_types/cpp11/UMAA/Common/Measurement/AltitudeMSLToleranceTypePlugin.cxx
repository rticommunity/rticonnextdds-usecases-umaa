    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeMSLToleranceType *sample = new AltitudeMSLToleranceType();
            ...
            AltitudeMSLToleranceTypePluginSupport_copy_data(
                AltitudeMSLToleranceType *dst,
                const AltitudeMSLToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeMSLToleranceTypePlugin_copy_sample(
                ...
                const AltitudeMSLToleranceType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeMSLToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeMSLToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeMSLToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeMSLToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
