    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DepthVariantType *sample = new DepthVariantType();
            ...
            DepthVariantTypePluginSupport_copy_data(
                DepthVariantType *dst,
                const DepthVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DepthVariantTypePlugin_copy_sample(
                ...
                const DepthVariantType *src)
            {
                return ::UMAA::Common::Measurement::DepthVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DepthVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DepthVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DepthVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
