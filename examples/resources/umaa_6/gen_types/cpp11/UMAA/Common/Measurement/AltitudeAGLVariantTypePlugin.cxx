    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeAGLVariantType *sample = new AltitudeAGLVariantType();
            ...
            AltitudeAGLVariantTypePluginSupport_copy_data(
                AltitudeAGLVariantType *dst,
                const AltitudeAGLVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeAGLVariantTypePlugin_copy_sample(
                ...
                const AltitudeAGLVariantType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeAGLVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeAGLVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeAGLVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeAGLVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
