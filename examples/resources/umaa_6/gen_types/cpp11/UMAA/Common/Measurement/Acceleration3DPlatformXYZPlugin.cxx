...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type Acceleration3DPlatformXYZ
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    Acceleration3DPlatformXYZ *sample = new Acceleration3DPlatformXYZ();
            ...
            Acceleration3DPlatformXYZPluginSupport_copy_data(
                Acceleration3DPlatformXYZ *dst,
                const Acceleration3DPlatformXYZ *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            Acceleration3DPlatformXYZPlugin_copy_sample(
                ...
                const Acceleration3DPlatformXYZ *src)
            {
                return ::UMAA::Common::Measurement::Acceleration3DPlatformXYZPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Acceleration3DPlatformXYZ >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool Acceleration3DPlatformXYZPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Acceleration3DPlatformXYZ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
