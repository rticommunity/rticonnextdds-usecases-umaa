...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeMSLRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeMSLRequirementType *sample = new AltitudeMSLRequirementType();
            ...
            AltitudeMSLRequirementTypePluginSupport_copy_data(
                AltitudeMSLRequirementType *dst,
                const AltitudeMSLRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeMSLRequirementTypePlugin_copy_sample(
                ...
                const AltitudeMSLRequirementType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeMSLRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeMSLRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeMSLRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeMSLRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
