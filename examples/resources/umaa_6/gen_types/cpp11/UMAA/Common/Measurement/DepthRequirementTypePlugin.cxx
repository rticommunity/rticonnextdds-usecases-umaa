    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DepthRequirementType *sample = new DepthRequirementType();
            ...
            DepthRequirementTypePluginSupport_copy_data(
                DepthRequirementType *dst,
                const DepthRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DepthRequirementTypePlugin_copy_sample(
                ...
                const DepthRequirementType *src)
            {
                return ::UMAA::Common::Measurement::DepthRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DepthRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DepthRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DepthRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
