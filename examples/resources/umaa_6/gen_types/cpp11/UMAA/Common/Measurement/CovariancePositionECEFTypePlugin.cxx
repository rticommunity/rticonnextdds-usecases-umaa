...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CovariancePositionECEFType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CovariancePositionECEFType *sample = new CovariancePositionECEFType();
            ...
            CovariancePositionECEFTypePluginSupport_copy_data(
                CovariancePositionECEFType *dst,
                const CovariancePositionECEFType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CovariancePositionECEFTypePlugin_copy_sample(
                ...
                const CovariancePositionECEFType *src)
            {
                return ::UMAA::Common::Measurement::CovariancePositionECEFTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CovariancePositionECEFType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CovariancePositionECEFTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CovariancePositionECEFType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
