    ...
    namespace Common {
        namespace Measurement {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    Position3DBodyXYZ *sample = new Position3DBodyXYZ();
            ...
            Position3DBodyXYZPluginSupport_copy_data(
                Position3DBodyXYZ *dst,
                const Position3DBodyXYZ *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            Position3DBodyXYZPlugin_copy_sample(
                ...
                const Position3DBodyXYZ *src)
            {
                return ::UMAA::Common::Measurement::Position3DBodyXYZPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Position3DBodyXYZ >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool Position3DBodyXYZPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Position3DBodyXYZ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
