...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CovarianceOrientationVelocityNEDType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CovarianceOrientationVelocityNEDType *sample = new CovarianceOrientationVelocityNEDType();
            ...
            CovarianceOrientationVelocityNEDTypePluginSupport_copy_data(
                CovarianceOrientationVelocityNEDType *dst,
                const CovarianceOrientationVelocityNEDType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CovarianceOrientationVelocityNEDTypePlugin_copy_sample(
                ...
                const CovarianceOrientationVelocityNEDType *src)
            {
                return ::UMAA::Common::Measurement::CovarianceOrientationVelocityNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CovarianceOrientationVelocityNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CovarianceOrientationVelocityNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CovarianceOrientationVelocityNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
