...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CovarianceOrientationNEDType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CovarianceOrientationNEDType *sample = new CovarianceOrientationNEDType();
            ...
            CovarianceOrientationNEDTypePluginSupport_copy_data(
                CovarianceOrientationNEDType *dst,
                const CovarianceOrientationNEDType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CovarianceOrientationNEDTypePlugin_copy_sample(
                ...
                const CovarianceOrientationNEDType *src)
            {
                return ::UMAA::Common::Measurement::CovarianceOrientationNEDTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CovarianceOrientationNEDType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CovarianceOrientationNEDTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CovarianceOrientationNEDType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
