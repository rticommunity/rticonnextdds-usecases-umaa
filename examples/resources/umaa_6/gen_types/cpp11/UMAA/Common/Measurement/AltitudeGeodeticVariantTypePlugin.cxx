...
namespace UMAA {
    namespace Common {
        namespace Measurement {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AltitudeGeodeticVariantType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AltitudeGeodeticVariantType *sample = new AltitudeGeodeticVariantType();
            ...
            AltitudeGeodeticVariantTypePluginSupport_copy_data(
                AltitudeGeodeticVariantType *dst,
                const AltitudeGeodeticVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AltitudeGeodeticVariantTypePlugin_copy_sample(
                ...
                const AltitudeGeodeticVariantType *src)
            {
                return ::UMAA::Common::Measurement::AltitudeGeodeticVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AltitudeGeodeticVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AltitudeGeodeticVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AltitudeGeodeticVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
