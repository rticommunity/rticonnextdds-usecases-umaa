...
namespace UMAA {
    ...
    namespace Common {
        ...
        namespace Measurement {
            ...
            Polygon::Polygon (const ::UMAA::Common::Enumeration::LineSegmentEnumModule::LineSegmentEnumType& lineKind_,const ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::GeoPosition2D, 128L >& referencePoint_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::Common::Measurement::Polygon > {
            static DDS_TypeCode * get()
            {
                ...
                Polygon_g_tc_referencePoint_sequence = initialize_sequence_typecode< ::rti::core::bounded_sequence< ::UMAA::Common::Measurement::GeoPosition2D, 128L > >((128L));

                Polygon_g_tc._data._annotations._allowedDataRepresentationMask = 5;

                Polygon_g_tc_referencePoint_sequence._data._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::GeoPosition2D>::get().native();
                Polygon_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Enumeration::LineSegmentEnumModule::LineSegmentEnumType>::get().native();
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< ::UMAA::Common::Measurement::Polygon >::allocate_sample(::UMAA::Common::Measurement::Polygon& sample, int, int) 
        {
            ...
            ::rti::topic::allocate_sample(sample.referencePoint(),  128L, -1);
        }
    }
}  
