...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ControlSystemID {
            ...
            ClientIDReportType::ClientIDReportType (const std::string& name_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
                m_name_(name_), 
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct native_type_code< ::UMAA::SO::ControlSystemID::ClientIDReportType > {
            static DDS_TypeCode * get()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"UMAA::SO::ControlSystemID::ClientIDReportType", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                ClientIDReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                ClientIDReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                ::UMAA::SO::ControlSystemID::ClientIDReportType *sample;
                ...
                RTIXCdrHeap_allocateStruct(
                    &sample, 
                    ::UMAA::SO::ControlSystemID::ClientIDReportType);
                if (sample == NULL) {
                    return NULL;
                }
                ...
                {
                    size_t candidateTypeSize = sizeof(::UMAA::SO::ControlSystemID::ClientIDReportType);
                ...
                interpreter::get_aggregation_value_pointer< ::UMAA::SO::ControlSystemID::ClientIDReportType >;
        ...
        const ::dds::core::xtypes::StructType& dynamic_type< ::UMAA::SO::ControlSystemID::ClientIDReportType >::get()
        {
            return static_cast<const ::dds::core::xtypes::StructType&>(
                ::rti::core::native_conversions::cast_from_native< ::dds::core::xtypes::DynamicType >(
                    *(native_type_code< ::UMAA::SO::ControlSystemID::ClientIDReportType >::get())));
        }
    }
}
...
namespace dds { 
    namespace topic {
        void topic_type_support< ::UMAA::SO::ControlSystemID::ClientIDReportType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                ::UMAA::SO::ControlSystemID::ClientIDReportTypePlugin_new,
                ::UMAA::SO::ControlSystemID::ClientIDReportTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< ::UMAA::SO::ControlSystemID::ClientIDReportType >::to_cdr_buffer(
            std::vector<char>& buffer, 
            const ::UMAA::SO::ControlSystemID::ClientIDReportType& sample,
        ...
        void topic_type_support< ::UMAA::SO::ControlSystemID::ClientIDReportType >::from_cdr_buffer(::UMAA::SO::ControlSystemID::ClientIDReportType& sample, 
        const std::vector<char>& buffer)
        {
            ...
            "Failed to create ::UMAA::SO::ControlSystemID::ClientIDReportType from cdr buffer");
        }

        void topic_type_support< ::UMAA::SO::ControlSystemID::ClientIDReportType >::reset_sample(::UMAA::SO::ControlSystemID::ClientIDReportType& sample) 
        {
            sample.name("");
        ...
        void topic_type_support< ::UMAA::SO::ControlSystemID::ClientIDReportType >::allocate_sample(::UMAA::SO::ControlSystemID::ClientIDReportType& sample, int, int) 
        {
