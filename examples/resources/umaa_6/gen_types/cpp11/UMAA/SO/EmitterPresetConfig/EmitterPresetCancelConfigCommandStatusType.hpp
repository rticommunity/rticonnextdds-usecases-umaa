...
#ifndef EmitterPresetCancelConfigCommandStatusType_1327259323_hpp
#define EmitterPresetCancelConfigCommandStatusType_1327259323_hpp
...
namespace UMAA {
    namespace SO {
        namespace EmitterPresetConfig {
            ...
            static const std::string EmitterPresetCancelConfigCommandStatusTypeTopic = "UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType";

            class NDDSUSERDllExport EmitterPresetCancelConfigCommandStatusType {
              public:
                ...
                bool operator == (const EmitterPresetCancelConfigCommandStatusType& other_) const;
                bool operator != (const EmitterPresetCancelConfigCommandStatusType& other_) const;

                void swap(EmitterPresetCancelConfigCommandStatusType& other_) noexcept ;
            ...
            inline void swap(EmitterPresetCancelConfigCommandStatusType& a, EmitterPresetCancelConfigCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const EmitterPresetCancelConfigCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SO::EmitterPresetConfig::EmitterPresetCancelConfigCommandStatusType > {
...
#endif // EmitterPresetCancelConfigCommandStatusType_1327259323_hpp
