...
#ifndef EmitterCommandType_1706803149_hpp
#define EmitterCommandType_1706803149_hpp
...
namespace UMAA {
    namespace SO {
        namespace EmitterControl {
            ...
            static const std::string EmitterCommandTypeTopic = "UMAA::SO::EmitterControl::EmitterCommandType";

            class NDDSUSERDllExport EmitterCommandType {
              public:

                EmitterCommandType();

                EmitterCommandType(const ::UMAA::Common::Measurement::NumericGUID& emitterID_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& endTime_,const ::UMAA::Common::MaritimeEnumeration::EmitterStateEnumModule::EmitterStateEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::IdentifierType& destination_);
                ...
                bool operator == (const EmitterCommandType& other_) const;
                bool operator != (const EmitterCommandType& other_) const;

                void swap(EmitterCommandType& other_) noexcept ;
            ...
            inline void swap(EmitterCommandType& a, EmitterCommandType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const EmitterCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SO::EmitterControl::EmitterCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SO::EmitterControl::EmitterCommandType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SO::EmitterControl::EmitterCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SO::EmitterControl::EmitterCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SO::EmitterControl::EmitterCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SO::EmitterControl::EmitterCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SO::EmitterControl::EmitterCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SO::EmitterControl::EmitterCommandType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SO::EmitterControl::EmitterCommandType > {
...
#endif // EmitterCommandType_1706803149_hpp
