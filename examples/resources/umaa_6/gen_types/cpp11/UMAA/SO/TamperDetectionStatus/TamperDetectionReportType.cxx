...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace TamperDetectionStatus {
            ...
            TamperDetectionReportType::TamperDetectionReportType (const std::string& descriptor_,bool electricalTamper_,bool hardwareTamper_,bool networkInstrusion_,bool otherTamper_,const ::UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumModule::TamperDetectionStateEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SO::TamperDetectionStatus::TamperDetectionReportType > {
            static DDS_TypeCode * get()
            {
                ...
                TamperDetectionReportType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumModule::TamperDetectionStateEnumType>::get().native();
                TamperDetectionReportType_g_tc_members[6]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                TamperDetectionReportType_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
