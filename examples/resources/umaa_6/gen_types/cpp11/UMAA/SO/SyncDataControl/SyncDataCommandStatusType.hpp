...
#ifndef SyncDataCommandStatusType_566333803_hpp
#define SyncDataCommandStatusType_566333803_hpp
...
namespace UMAA {
    namespace SO {
        namespace SyncDataControl {
            ...
            static const std::string SyncDataCommandStatusTypeTopic = "UMAA::SO::SyncDataControl::SyncDataCommandStatusType";

            class NDDSUSERDllExport SyncDataCommandStatusType {
              public:

                SyncDataCommandStatusType();

                SyncDataCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const SyncDataCommandStatusType& other_) const;
                bool operator != (const SyncDataCommandStatusType& other_) const;

                void swap(SyncDataCommandStatusType& other_) noexcept ;
            ...
            inline void swap(SyncDataCommandStatusType& a, SyncDataCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const SyncDataCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SO::SyncDataControl::SyncDataCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SO::SyncDataControl::SyncDataCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SO::SyncDataControl::SyncDataCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SO::SyncDataControl::SyncDataCommandStatusType > {
            NDDSUSERDllExport 
            ...
            static std::vector<char>& to_cdr_buffer(
                ...
                const ::UMAA::SO::SyncDataControl::SyncDataCommandStatusType& sample,
                ::dds::core::policy::DataRepresentationId representation 
                = ::dds::core::policy::DataRepresentation::auto_id());

            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SO::SyncDataControl::SyncDataCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SO::SyncDataControl::SyncDataCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SO::SyncDataControl::SyncDataCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SO::SyncDataControl::SyncDataCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SO::SyncDataControl::SyncDataCommandStatusType > {
...
#endif // SyncDataCommandStatusType_566333803_hpp
