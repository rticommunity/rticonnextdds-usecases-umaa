        ...
        namespace ResourceIdentification {
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                try {
                    ...
                    epd = PRESTypePluginDefaultEndpointData_new(
                        ...
                        ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
                        ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePluginSupport_destroy_key);

                    if (epd == NULL) {
                        return NULL;
                    } 

                    serializedKeyMaxSize =  ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_get_serialized_key_max_size(
                    ...
                    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                        serializedSampleMaxSize = ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_get_serialized_sample_max_size(
                            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
                        ...
                        if (PRESTypePluginDefaultEndpointData_createWriterPool(
                            ...
                            ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_get_serialized_sample_max_size, epd,
            ...
            VehicleIDReportTypePlugin_copy_sample(
                ...
                const VehicleIDReportType *src)
            {
                return ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            { 
                ...
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_copy_sample;
                ...
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_get_serialized_sample_max_size;
                ...
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_get_key_kind;

                plugin->getSerializedKeyMaxSizeFnc =   
                (PRESTypePluginGetSerializedKeyMaxSizeFunction)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_get_serialized_key_max_size;
                plugin->serializeKeyFnc =
                (PRESTypePluginSerializeKeyFunction)
                PRESTypePlugin_interpretedSerializeKey;
                plugin->deserializeKeyFnc =
                (PRESTypePluginDeserializeKeyFunction)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_deserialize_key;
                ...
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_serialized_sample_to_keyhash;
                ...
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_instance_to_key;
                plugin->keyToInstanceFnc =
                (PRESTypePluginKeyToInstanceFunction)
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_key_to_instance;
                ...
                try {
                    plugin->typeCode = (struct RTICdrTypeCode *)
                    &::rti::topic::dynamic_type< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >::get().native();
                } catch (...) {
                    ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_delete(plugin);
                    return NULL;
                }
                #endif
                ...
                static const char * TYPE_NAME = "UMAA::SO::ResourceIdentification::VehicleIDReportType";
