    ...
    namespace SO {
        ...
        namespace ResourceIdentification {
            ...
            VehicleIDReportType::VehicleIDReportType() :
                m_domain_(UMAA::Common::MaritimeEnumeration::DomainEnumModule::DomainEnumType::AIR) ,
            ...
            VehicleIDReportType::VehicleIDReportType (const ::UMAA::Common::MaritimeEnumeration::DomainEnumModule::DomainEnumType& domain_,bool isControlTransferCapable_,const std::string& make_,const std::string& model_,const std::string& name_,const std::string& protocol_,const std::string& type_,const ::UMAA::Common::IdentifierType& vehicleNumber_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
                m_domain_(domain_), 
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct native_type_code< ::UMAA::SO::ResourceIdentification::VehicleIDReportType > {
            static DDS_TypeCode * get()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"UMAA::SO::ResourceIdentification::VehicleIDReportType", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                VehicleIDReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::DomainEnumModule::DomainEnumType>::get().native();
                ...
                VehicleIDReportType_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                VehicleIDReportType_g_tc_members[8]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                VehicleIDReportType_g_tc_members[9]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                ::UMAA::SO::ResourceIdentification::VehicleIDReportType *sample;
                ...
                RTIXCdrHeap_allocateStruct(
                    &sample, 
                    ::UMAA::SO::ResourceIdentification::VehicleIDReportType);
                if (sample == NULL) {
                    return NULL;
                }
                ...
                {
                    size_t candidateTypeSize = sizeof(::UMAA::SO::ResourceIdentification::VehicleIDReportType);
                ...
                interpreter::get_aggregation_value_pointer< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >;
        ...
        const ::dds::core::xtypes::StructType& dynamic_type< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >::get()
        {
            return static_cast<const ::dds::core::xtypes::StructType&>(
                ::rti::core::native_conversions::cast_from_native< ::dds::core::xtypes::DynamicType >(
                    *(native_type_code< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >::get())));
        }
    }
}
...
namespace dds { 
    namespace topic {
        void topic_type_support< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_new,
                ::UMAA::SO::ResourceIdentification::VehicleIDReportTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >::to_cdr_buffer(
            std::vector<char>& buffer, 
            const ::UMAA::SO::ResourceIdentification::VehicleIDReportType& sample,
        ...
        void topic_type_support< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >::from_cdr_buffer(::UMAA::SO::ResourceIdentification::VehicleIDReportType& sample, 
        const std::vector<char>& buffer)
        {
            ...
            "Failed to create ::UMAA::SO::ResourceIdentification::VehicleIDReportType from cdr buffer");
        }

        void topic_type_support< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >::reset_sample(::UMAA::SO::ResourceIdentification::VehicleIDReportType& sample) 
        {
            sample.domain(UMAA::Common::MaritimeEnumeration::DomainEnumModule::DomainEnumType::AIR);
        ...
        void topic_type_support< ::UMAA::SO::ResourceIdentification::VehicleIDReportType >::allocate_sample(::UMAA::SO::ResourceIdentification::VehicleIDReportType& sample, int, int) 
        {
