...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace ResourceIdentification {
            ...
            SubsystemIDReportType::SubsystemIDReportType (bool isControlTransferCapable_,const std::string& name_,const std::string& type_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct native_type_code< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType > {
            static DDS_TypeCode * get()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"UMAA::SO::ResourceIdentification::SubsystemIDReportType", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                SubsystemIDReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                SubsystemIDReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                ::UMAA::SO::ResourceIdentification::SubsystemIDReportType *sample;
                ...
                RTIXCdrHeap_allocateStruct(
                    &sample, 
                    ::UMAA::SO::ResourceIdentification::SubsystemIDReportType);
                if (sample == NULL) {
                    return NULL;
                }
                ...
                {
                    size_t candidateTypeSize = sizeof(::UMAA::SO::ResourceIdentification::SubsystemIDReportType);
                ...
                interpreter::get_aggregation_value_pointer< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >;
        ...
        const ::dds::core::xtypes::StructType& dynamic_type< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >::get()
        {
            return static_cast<const ::dds::core::xtypes::StructType&>(
                ::rti::core::native_conversions::cast_from_native< ::dds::core::xtypes::DynamicType >(
                    *(native_type_code< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >::get())));
        }
    }
}
...
namespace dds { 
    namespace topic {
        void topic_type_support< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >:: register_type(
            ...
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                ::UMAA::SO::ResourceIdentification::SubsystemIDReportTypePlugin_new,
                ::UMAA::SO::ResourceIdentification::SubsystemIDReportTypePlugin_delete);
        }

        std::vector<char>& topic_type_support< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >::to_cdr_buffer(
            std::vector<char>& buffer, 
            const ::UMAA::SO::ResourceIdentification::SubsystemIDReportType& sample,
        ...
        void topic_type_support< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >::from_cdr_buffer(::UMAA::SO::ResourceIdentification::SubsystemIDReportType& sample, 
        const std::vector<char>& buffer)
        {
            ...
            "Failed to create ::UMAA::SO::ResourceIdentification::SubsystemIDReportType from cdr buffer");
        }

        void topic_type_support< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >::reset_sample(::UMAA::SO::ResourceIdentification::SubsystemIDReportType& sample) 
        {
        ...
        void topic_type_support< ::UMAA::SO::ResourceIdentification::SubsystemIDReportType >::allocate_sample(::UMAA::SO::ResourceIdentification::SubsystemIDReportType& sample, int, int) 
        {
