...
#ifndef BITCommandStatusType_1509319597_hpp
#define BITCommandStatusType_1509319597_hpp
...
namespace UMAA {
    namespace SO {
        namespace BITControl {
            ...
            static const std::string BITCommandStatusTypeTopic = "UMAA::SO::BITControl::BITCommandStatusType";

            class NDDSUSERDllExport BITCommandStatusType {
              public:

                BITCommandStatusType();

                BITCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const BITCommandStatusType& other_) const;
                bool operator != (const BITCommandStatusType& other_) const;

                void swap(BITCommandStatusType& other_) noexcept ;
            ...
            inline void swap(BITCommandStatusType& a, BITCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BITCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SO::BITControl::BITCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SO::BITControl::BITCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SO::BITControl::BITCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SO::BITControl::BITCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SO::BITControl::BITCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SO::BITControl::BITCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SO::BITControl::BITCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SO::BITControl::BITCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SO::BITControl::BITCommandStatusType > {
...
#endif // BITCommandStatusType_1509319597_hpp
