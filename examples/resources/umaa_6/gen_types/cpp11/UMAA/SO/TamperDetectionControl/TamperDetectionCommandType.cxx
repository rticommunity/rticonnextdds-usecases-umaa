    ...
    namespace SO {
        ...
        namespace TamperDetectionControl {
            ...
            TamperDetectionCommandType::TamperDetectionCommandType() :
                m_state_(UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumModule::TamperDetectionStateEnumType::ALWAYS_ENABLED_OR_CLEAR)  {

            }   

            TamperDetectionCommandType::TamperDetectionCommandType (const ::UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumModule::TamperDetectionStateEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::IdentifierType& destination_):
                m_state_(state_), 
            ...
            void TamperDetectionCommandType::swap(TamperDetectionCommandType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SO::TamperDetectionControl::TamperDetectionCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                TamperDetectionCommandType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumModule::TamperDetectionStateEnumType>::get().native();
                TamperDetectionCommandType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                TamperDetectionCommandType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                TamperDetectionCommandType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
...
namespace dds { 
    namespace topic {
        ...
        {
            sample.state(UMAA::Common::MaritimeEnumeration::TamperDetectionStateEnumModule::TamperDetectionStateEnumType::ALWAYS_ENABLED_OR_CLEAR);
