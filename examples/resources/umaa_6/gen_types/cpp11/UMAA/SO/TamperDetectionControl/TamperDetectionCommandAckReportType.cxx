...
namespace UMAA {
    ...
    namespace SO {
        ...
        namespace TamperDetectionControl {
            ...
            TamperDetectionCommandAckReportType::TamperDetectionCommandAckReportType (const ::UMAA::SO::TamperDetectionControl::TamperDetectionCommandType& command_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_command_(command_), 
            ...
            void TamperDetectionCommandAckReportType::swap(TamperDetectionCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SO::TamperDetectionControl::TamperDetectionCommandAckReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member TamperDetectionCommandAckReportType_g_tc_members[4]=
                {
                ...
                TamperDetectionCommandAckReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::SO::TamperDetectionControl::TamperDetectionCommandType>::get().native();
                TamperDetectionCommandAckReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                TamperDetectionCommandAckReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                TamperDetectionCommandAckReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo TamperDetectionCommandAckReportType_g_memberAccessInfos[4] =
                ...
                TamperDetectionCommandAckReportType_g_memberAccessInfos[3].bindingMemberValueOffset[0] = 
