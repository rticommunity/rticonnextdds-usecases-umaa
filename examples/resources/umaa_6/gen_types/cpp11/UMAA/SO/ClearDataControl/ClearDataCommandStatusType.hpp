...
#ifndef ClearDataCommandStatusType_1173804095_hpp
#define ClearDataCommandStatusType_1173804095_hpp
...
namespace UMAA {
    namespace SO {
        namespace ClearDataControl {
            ...
            static const std::string ClearDataCommandStatusTypeTopic = "UMAA::SO::ClearDataControl::ClearDataCommandStatusType";

            class NDDSUSERDllExport ClearDataCommandStatusType {
              public:

                ClearDataCommandStatusType();

                ClearDataCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const ClearDataCommandStatusType& other_) const;
                bool operator != (const ClearDataCommandStatusType& other_) const;

                void swap(ClearDataCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ClearDataCommandStatusType& a, ClearDataCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ClearDataCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SO::ClearDataControl::ClearDataCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SO::ClearDataControl::ClearDataCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SO::ClearDataControl::ClearDataCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SO::ClearDataControl::ClearDataCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SO::ClearDataControl::ClearDataCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SO::ClearDataControl::ClearDataCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SO::ClearDataControl::ClearDataCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SO::ClearDataControl::ClearDataCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SO::ClearDataControl::ClearDataCommandStatusType > {
...
#endif // ClearDataCommandStatusType_1173804095_hpp
