...
#ifndef ResourceAllocationReportType_1351313008_hpp
#define ResourceAllocationReportType_1351313008_hpp
...
namespace UMAA {
    namespace SO {
        namespace ResourceAllocation {
            ...
            static const std::string ResourceAllocationReportTypeTopic = "UMAA::SO::ResourceAllocation::ResourceAllocationReportType";

            #if (defined(RTI_WIN32) || defined (RTI_WINCE)) && defined(NDDS_USER_DLL_EXPORT)
            // On Windows, dll-export template instantiations of standard types used by
            // other dll-exported types
            template class NDDSUSERDllExport std::allocator< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo >;
            template class NDDSUSERDllExport std::vector< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo >;
            #endif
            class NDDSUSERDllExport ResourceAllocationReportType {
              public:
                ...
                ResourceAllocationReportType(const ::rti::core::bounded_sequence< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo, 256L >& controlInfo_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_);

                ::rti::core::bounded_sequence< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo, 256L >& controlInfo() noexcept {
                    return m_controlInfo_;
                }

                const ::rti::core::bounded_sequence< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo, 256L >& controlInfo() const noexcept {
                    return m_controlInfo_;
                }

                void controlInfo(const ::rti::core::bounded_sequence< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo, 256L >& value) {

                    m_controlInfo_ = value;
                }

                void controlInfo(::rti::core::bounded_sequence< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo, 256L >&& value) {
                    m_controlInfo_ = std::move(value);
                }
              ...
              private:
                ...
                ::rti::core::bounded_sequence< ::UMAA::SO::ResourceAllocation::ResourceAllocationControlInfo, 256L > m_controlInfo_;
...
#endif // ResourceAllocationReportType_1351313008_hpp
