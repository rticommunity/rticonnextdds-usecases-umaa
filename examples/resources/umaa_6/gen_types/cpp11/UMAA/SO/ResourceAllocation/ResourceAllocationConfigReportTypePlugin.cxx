    ...
    namespace SO {
        namespace ResourceAllocation {
            ...
            * ------------------------------------------------------------------------ */
            ...
            { 
                ...
                try {
                    ...
                    ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypePlugin_delete(plugin);
                    return NULL;
                }
                #endif
            ...
            /* ----------------------------------------------------------------------------
            *  Type ResourceAllocationConfigReportTypeResourcesSetElement
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ResourceAllocationConfigReportTypeResourcesSetElement *sample = new ResourceAllocationConfigReportTypeResourcesSetElement();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_copy_data(
                ResourceAllocationConfigReportTypeResourcesSetElement *dst,
                const ResourceAllocationConfigReportTypeResourcesSetElement *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            {
                return ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_create_data();
            }
            ...
            {
                ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_destroy_data(key);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                RTICdrTypeCode *type_code)
            {
                try {
                    ...
                    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
                        DDS_TypeCodeFactory_get_instance(),
                        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ResourceAllocationConfigReportTypeResourcesSetElement >::get().native()
                        ,
                        &programProperty,
                        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
                ...
                void *containerPluginContext)
            {
                try {
                    ...
                    epd = PRESTypePluginDefaultEndpointData_new(
                        ...
                        endpoint_info,
                        (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
                        ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_create_data,
                        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                        ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_destroy_data,
                        (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
                        ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
                        ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_destroy_key);

                    if (epd == NULL) {
                        return NULL;
                    } 

                    serializedKeyMaxSize =  ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_serialized_key_max_size(
                        epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
                    serializedKeyMaxSizeV2 = ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_serialized_key_max_size_for_keyhash(
                        epd,
                        RTI_CDR_ENCAPSULATION_ID_CDR2_BE,
                        0);
                    ...
                    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                        serializedSampleMaxSize = ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_serialized_sample_max_size(
                            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
                        PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
                        ...
                        if (PRESTypePluginDefaultEndpointData_createWriterPool(
                            ...
                            endpoint_info,
                            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                            ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_serialized_sample_max_size, epd,
                            (PRESTypePluginGetSerializedSampleSizeFunction)
                            PRESTypePlugin_interpretedGetSerializedSampleSize,
                            epd) == RTI_FALSE) {
                            PRESTypePluginDefaultEndpointData_delete(epd);
            ...
            ResourceAllocationConfigReportTypeResourcesSetElementPlugin_copy_sample(
                ...
                const ResourceAllocationConfigReportTypeResourcesSetElement *src)
            {
                return ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ResourceAllocationConfigReportTypeResourcesSetElement >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ResourceAllocationConfigReportTypeResourcesSetElementPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationConfigReportTypeResourcesSetElement **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            ResourceAllocationConfigReportTypeResourcesSetElementPlugin_instance_to_key(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationConfigReportTypeResourcesSetElementKeyHolder *dst, 
                const ResourceAllocationConfigReportTypeResourcesSetElement *src)
            {
                try {
                    if (endpoint_data) {} /* To avoid warnings */   
            ...
            ResourceAllocationConfigReportTypeResourcesSetElementPlugin_key_to_instance(
                PRESTypePluginEndpointData endpoint_data,
                ResourceAllocationConfigReportTypeResourcesSetElement *dst, const
                ResourceAllocationConfigReportTypeResourcesSetElementKeyHolder *src)
            {
                try {
                    if (endpoint_data) {} /* To avoid warnings */   
                    dst->setID() = src->setID();
            ...
            ResourceAllocationConfigReportTypeResourcesSetElementPlugin_serialized_sample_to_keyhash(
                ...
                void *endpoint_plugin_qos)
            {
                ResourceAllocationConfigReportTypeResourcesSetElement * sample = NULL;
                sample = (ResourceAllocationConfigReportTypeResourcesSetElement *)
                PRESTypePluginDefaultEndpointData_getTempSample(endpoint_data);
                if (sample == NULL) {
                    return RTI_FALSE;
                }
            ...
            * Plug-in Installation Methods
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *ResourceAllocationConfigReportTypeResourcesSetElementPlugin_new(void) 
            { 
                struct PRESTypePlugin *plugin = NULL;
                const struct PRESTypePluginVersion PLUGIN_VERSION = 
                PRES_TYPE_PLUGIN_VERSION_2_0;
                ...
                plugin->onParticipantAttached =
                (PRESTypePluginOnParticipantAttachedCallback)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_destroy_sample;
                ...
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                PRESTypePlugin_interpretedGetSerializedSampleMinSize;
                plugin->getDeserializedSampleMaxSizeFnc = NULL; 
                plugin->getSampleFnc =
                (PRESTypePluginGetSampleFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_sample;
                plugin->returnSampleFnc =
                (PRESTypePluginReturnSampleFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_return_sample;
                plugin->getKeyKindFnc =
                (PRESTypePluginGetKeyKindFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_key_kind;

                plugin->getSerializedKeyMaxSizeFnc =   
                (PRESTypePluginGetSerializedKeyMaxSizeFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_serialized_key_max_size;
                plugin->serializeKeyFnc =
                (PRESTypePluginSerializeKeyFunction)
                PRESTypePlugin_interpretedSerializeKey;
                plugin->deserializeKeyFnc =
                (PRESTypePluginDeserializeKeyFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_deserialize_key;
                plugin->deserializeKeySampleFnc =
                (PRESTypePluginDeserializeKeySampleFunction)
                PRESTypePlugin_interpretedDeserializeKey;
                ...
                plugin->serializedSampleToKeyHashFnc = 
                (PRESTypePluginSerializedSampleToKeyHashFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_serialized_sample_to_keyhash;

                plugin->getKeyFnc =
                (PRESTypePluginGetKeyFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_key;
                plugin->returnKeyFnc =
                (PRESTypePluginReturnKeyFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_return_key;

                plugin->instanceToKeyFnc =
                (PRESTypePluginInstanceToKeyFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_instance_to_key;
                plugin->keyToInstanceFnc =
                (PRESTypePluginKeyToInstanceFunction)
                ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_key_to_instance;
                plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
                #ifdef NDDS_STANDALONE_TYPE
                plugin->typeCode = NULL; 
                #else
                try {
                    plugin->typeCode = (struct RTICdrTypeCode *)
                    &::rti::topic::dynamic_type< ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElement >::get().native();
                } catch (...) {
                    ::UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElementPlugin_delete(plugin);
                    return NULL;
                }
                #endif
                plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
                ...
                plugin->getBuffer = 
                (PRESTypePluginGetBufferFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                ResourceAllocationConfigReportTypeResourcesSetElementPlugin_return_buffer;
                plugin->getBufferWithParams = NULL;
                plugin->returnBufferWithParams = NULL;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                ...
                static const char * TYPE_NAME = "UMAA::SO::ResourceAllocation::ResourceAllocationConfigReportTypeResourcesSetElement";
                plugin->endpointTypeName = TYPE_NAME;
                plugin->isMetpType = RTI_FALSE;
                return plugin;
            }
            ...
            void
            ResourceAllocationConfigReportTypeResourcesSetElementPlugin_delete(struct PRESTypePlugin *plugin)
            {
                RTIOsapiHeap_freeStructure(plugin);
            } 
        } /* namespace ResourceAllocation  */
