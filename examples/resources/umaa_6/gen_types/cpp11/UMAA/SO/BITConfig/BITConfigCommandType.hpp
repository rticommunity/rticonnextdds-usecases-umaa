...
#ifndef BITConfigCommandType_121455216_hpp
#define BITConfigCommandType_121455216_hpp
        ...
        namespace BITConfig {
            ...
            class NDDSUSERDllExport BITConfigCommandType {
              public:
                ...
                bool operator == (const BITConfigCommandType& other_) const;
                bool operator != (const BITConfigCommandType& other_) const;

                void swap(BITConfigCommandType& other_) noexcept ;
            ...
            inline void swap(BITConfigCommandType& a, BITConfigCommandType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BITConfigCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SO::BITConfig::BITConfigCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SO::BITConfig::BITConfigCommandType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SO::BITConfig::BITConfigCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SO::BITConfig::BITConfigCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SO::BITConfig::BITConfigCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SO::BITConfig::BITConfigCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SO::BITConfig::BITConfigCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SO::BITConfig::BITConfigCommandType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SO::BITConfig::BITConfigCommandType > {
...
#endif // BITConfigCommandType_121455216_hpp
