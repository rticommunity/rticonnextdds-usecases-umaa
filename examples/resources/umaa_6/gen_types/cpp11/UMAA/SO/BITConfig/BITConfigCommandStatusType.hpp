...
#ifndef BITConfigCommandStatusType_344454204_hpp
#define BITConfigCommandStatusType_344454204_hpp
...
namespace UMAA {
    namespace SO {
        namespace BITConfig {
            ...
            static const std::string BITConfigCommandStatusTypeTopic = "UMAA::SO::BITConfig::BITConfigCommandStatusType";

            class NDDSUSERDllExport BITConfigCommandStatusType {
              public:

                BITConfigCommandStatusType();

                BITConfigCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const BITConfigCommandStatusType& other_) const;
                bool operator != (const BITConfigCommandStatusType& other_) const;

                void swap(BITConfigCommandStatusType& other_) noexcept ;
            ...
            inline void swap(BITConfigCommandStatusType& a, BITConfigCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const BITConfigCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SO::BITConfig::BITConfigCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SO::BITConfig::BITConfigCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SO::BITConfig::BITConfigCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SO::BITConfig::BITConfigCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SO::BITConfig::BITConfigCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SO::BITConfig::BITConfigCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SO::BITConfig::BITConfigCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SO::BITConfig::BITConfigCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SO::BITConfig::BITConfigCommandStatusType > {
...
#endif // BITConfigCommandStatusType_344454204_hpp
