...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace AccelerationStatus {
            ...
            AccelerationReportType::AccelerationReportType (const ::UMAA::Common::Measurement::Acceleration3DPlatformXYZ& acceleration_,const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceAccelerationPlatformXYZType >& accelerationCovariance_,const ::dds::core::optional< ::UMAA::Common::Orientation::OrientationAcceleration3DPlatformXYZ >& rotationalAcceleration_,const ::dds::core::optional< ::UMAA::Common::Measurement::CovarianceOrientationAccelerationPlatformXYZType >& rotationalAccelerationCovariance_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
                m_acceleration_(acceleration_), 
                m_accelerationCovariance_(accelerationCovariance_), 
                m_rotationalAcceleration_(rotationalAcceleration_), 
            ...
            void AccelerationReportType::swap(AccelerationReportType& other_)  noexcept 
            {
                ...
                swap(m_rotationalAcceleration_, other_.m_rotationalAcceleration_);
            ...
            bool AccelerationReportType::operator == (const AccelerationReportType& other_) const {
                ...
                if (m_rotationalAcceleration_ != other_.m_rotationalAcceleration_) {
                    return false;
                }
            ...
            std::ostream& operator << (std::ostream& o,const AccelerationReportType& sample)
            {
                ...
                o << "rotationalAcceleration: " << sample.rotationalAcceleration ()<<", ";
        ...
        struct native_type_code< ::UMAA::SA::AccelerationStatus::AccelerationReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member AccelerationReportType_g_tc_members[6]=
                {
                    ...
                    {
                        (char *)"rotationalAcceleration",/* Member name */
                        {
                            2,/* Representation ID */
                            DDS_BOOLEAN_FALSE,/* Is a pointer? */
                            -1, /* Bitfield bits */
                ...
                AccelerationReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::Acceleration3DPlatformXYZ>::get().native();
                AccelerationReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::CovarianceAccelerationPlatformXYZType>::get().native();
                AccelerationReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Orientation::OrientationAcceleration3DPlatformXYZ>::get().native();
                AccelerationReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::CovarianceOrientationAccelerationPlatformXYZType>::get().native();
                AccelerationReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                AccelerationReportType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                (RTIXCdrUnsignedLong) ((char *)&sample->rotationalAcceleration() - (char *)sample);
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< ::UMAA::SA::AccelerationStatus::AccelerationReportType >::reset_sample(::UMAA::SA::AccelerationStatus::AccelerationReportType& sample) 
        {
            ...
            ::rti::topic::reset_sample(sample.rotationalAcceleration());
