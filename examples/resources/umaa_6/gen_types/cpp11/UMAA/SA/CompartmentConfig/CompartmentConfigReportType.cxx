...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace CompartmentConfig {
            ...
            CompartmentConfigReportType::CompartmentConfigReportType (const std::string& name_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
                m_name_(name_), 
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SA::CompartmentConfig::CompartmentConfigReportType > {
            static DDS_TypeCode * get()
            {
                ...
                CompartmentConfigReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                CompartmentConfigReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
