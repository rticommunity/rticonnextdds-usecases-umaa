    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SA::VelocityStatus::VelocityReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member VelocityReportType_g_tc_members[6]=
                {
                ...
                VelocityReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::OrientationVel3D>::get().native();
                VelocityReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::CovarianceOrientationVelocityNEDType>::get().native();
                VelocityReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::Velocity3DPlatformNEDType>::get().native();
                VelocityReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::CovarianceVelocityNEDType>::get().native();
                VelocityReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                VelocityReportType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo VelocityReportType_g_memberAccessInfos[6] =
