...
#ifndef ContactFilterCancelConfigCommandStatusType_640335895_hpp
#define ContactFilterCancelConfigCommandStatusType_640335895_hpp
...
namespace UMAA {
    namespace SA {
        namespace ContactFilterConfig {
            ...
            static const std::string ContactFilterCancelConfigCommandStatusTypeTopic = "UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType";

            class NDDSUSERDllExport ContactFilterCancelConfigCommandStatusType {
              public:
                ...
                bool operator == (const ContactFilterCancelConfigCommandStatusType& other_) const;
                bool operator != (const ContactFilterCancelConfigCommandStatusType& other_) const;

                void swap(ContactFilterCancelConfigCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ContactFilterCancelConfigCommandStatusType& a, ContactFilterCancelConfigCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ContactFilterCancelConfigCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::SA::ContactFilterConfig::ContactFilterCancelConfigCommandStatusType > {
...
#endif // ContactFilterCancelConfigCommandStatusType_640335895_hpp
