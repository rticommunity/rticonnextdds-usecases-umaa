    ...
    namespace SA {
        namespace PassiveContactReport {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PassiveContactType *sample = new PassiveContactType();
            ...
            PassiveContactTypePluginSupport_copy_data(
                PassiveContactType *dst,
                const PassiveContactType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PassiveContactTypePlugin_copy_sample(
                ...
                const PassiveContactType *src)
            {
                return ::UMAA::SA::PassiveContactReport::PassiveContactTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PassiveContactType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PassiveContactTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PassiveContactType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
