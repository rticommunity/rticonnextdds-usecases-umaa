    ...
    namespace SA {
        ...
        namespace PathReporterSpecs {
            ...
            PathReporterType::PathReporterType() :
                ...
                m_pathType_(UMAA::Common::MaritimeEnumeration::PathWayEnumModule::PathWayEnumType::HISTORICAL_GLOBAL)  {

            }   

            PathReporterType::PathReporterType (double maxDistance_,int32_t maxPoints_,double maxTgtResolution_,double maxTime_,double minTgtResolution_,const ::UMAA::Common::MaritimeEnumeration::PathWayEnumModule::PathWayEnumType& pathType_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SA::PathReporterSpecs::PathReporterType > {
            static DDS_TypeCode * get()
            {
                ...
                PathReporterType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DurationSeconds_AliasTag_t>::get().native();
                ...
                PathReporterType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::PathWayEnumModule::PathWayEnumType>::get().native();
                ...
                PathReporterType_g_tc_members[0]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                PathReporterType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                PathReporterType_g_tc_members[0]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
                ...
                PathReporterType_g_tc_members[1]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                PathReporterType_g_tc_members[1]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                PathReporterType_g_tc_members[1]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
                ...
                PathReporterType_g_tc_members[2]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                PathReporterType_g_tc_members[2]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                PathReporterType_g_tc_members[2]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
                ...
                PathReporterType_g_tc_members[3]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                PathReporterType_g_tc_members[3]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                PathReporterType_g_tc_members[3]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
                ...
                PathReporterType_g_tc_members[4]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                PathReporterType_g_tc_members[4]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                PathReporterType_g_tc_members[4]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< ::UMAA::SA::PathReporterSpecs::PathReporterType >::reset_sample(::UMAA::SA::PathReporterSpecs::PathReporterType& sample) 
        {
            ...
            sample.pathType(UMAA::Common::MaritimeEnumeration::PathWayEnumModule::PathWayEnumType::HISTORICAL_GLOBAL);
        }
