...
namespace UMAA {
    ...
    namespace SA {
        ...
        namespace PathReporterSpecs {
            ...
            PathReporterSpecsReportType::PathReporterSpecsReportType (const ::rti::core::bounded_sequence< ::UMAA::SA::PathReporterSpecs::PathReporterType, 4L >& pathReporters_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
                m_pathReporters_(pathReporters_), 
                m_timeStamp_(timeStamp_), 
                m_source_(source_) {
            }

            void PathReporterSpecsReportType::swap(PathReporterSpecsReportType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::SA::PathReporterSpecs::PathReporterSpecsReportType > {
            static DDS_TypeCode * get()
            {
                ...
                PathReporterSpecsReportType_g_tc_pathReporters_sequence = initialize_sequence_typecode< ::rti::core::bounded_sequence< ::UMAA::SA::PathReporterSpecs::PathReporterType, 4L > >((4L));
                ...
                PathReporterSpecsReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                PathReporterSpecsReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
...
namespace dds { 
    namespace topic {
        ...
        {
            ::rti::topic::allocate_sample(sample.pathReporters(),  4L, -1);
