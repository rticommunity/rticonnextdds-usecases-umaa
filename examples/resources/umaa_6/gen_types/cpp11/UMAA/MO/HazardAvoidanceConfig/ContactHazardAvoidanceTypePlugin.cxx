...
namespace UMAA {
    namespace MO {
        namespace HazardAvoidanceConfig {
            ...
            /* ----------------------------------------------------------------------------
            *  Type ContactHazardAvoidanceType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ContactHazardAvoidanceType *sample = new ContactHazardAvoidanceType();
            ...
            ContactHazardAvoidanceTypePluginSupport_copy_data(
                ContactHazardAvoidanceType *dst,
                const ContactHazardAvoidanceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ContactHazardAvoidanceTypePlugin_copy_sample(
                ...
                const ContactHazardAvoidanceType *src)
            {
                return ::UMAA::MO::HazardAvoidanceConfig::ContactHazardAvoidanceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ContactHazardAvoidanceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ContactHazardAvoidanceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ContactHazardAvoidanceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
