    ...
    namespace MO {
        namespace HazardAvoidanceConfig {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    COLREGSConfigurationType *sample = new COLREGSConfigurationType();
            ...
            COLREGSConfigurationTypePluginSupport_copy_data(
                COLREGSConfigurationType *dst,
                const COLREGSConfigurationType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            COLREGSConfigurationTypePlugin_copy_sample(
                ...
                const COLREGSConfigurationType *src)
            {
                return ::UMAA::MO::HazardAvoidanceConfig::COLREGSConfigurationTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< COLREGSConfigurationType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool COLREGSConfigurationTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                COLREGSConfigurationType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
