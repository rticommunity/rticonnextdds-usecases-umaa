...
#ifndef FreeFloatCommandStatusType_834201590_hpp
#define FreeFloatCommandStatusType_834201590_hpp
...
namespace UMAA {
    namespace MO {
        namespace FreeFloatControl {
            ...
            static const std::string FreeFloatCommandStatusTypeTopic = "UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType";

            class NDDSUSERDllExport FreeFloatCommandStatusType {
              public:

                FreeFloatCommandStatusType();

                FreeFloatCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const FreeFloatCommandStatusType& other_) const;
                bool operator != (const FreeFloatCommandStatusType& other_) const;

                void swap(FreeFloatCommandStatusType& other_) noexcept ;
            ...
            inline void swap(FreeFloatCommandStatusType& a, FreeFloatCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const FreeFloatCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MO::FreeFloatControl::FreeFloatCommandStatusType > {
...
#endif // FreeFloatCommandStatusType_834201590_hpp
