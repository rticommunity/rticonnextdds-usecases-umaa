...
#ifndef GlobalHoverExecutionStatusReportType_1291058113_hpp
#define GlobalHoverExecutionStatusReportType_1291058113_hpp
        ...
        namespace GlobalHoverControl {
            ...
            class NDDSUSERDllExport GlobalHoverExecutionStatusReportType {
              public:
                ...
                bool operator == (const GlobalHoverExecutionStatusReportType& other_) const;
                bool operator != (const GlobalHoverExecutionStatusReportType& other_) const;

                void swap(GlobalHoverExecutionStatusReportType& other_) noexcept ;
            ...
            inline void swap(GlobalHoverExecutionStatusReportType& a, GlobalHoverExecutionStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const GlobalHoverExecutionStatusReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MO::GlobalHoverControl::GlobalHoverExecutionStatusReportType > {
...
#endif // GlobalHoverExecutionStatusReportType_1291058113_hpp
