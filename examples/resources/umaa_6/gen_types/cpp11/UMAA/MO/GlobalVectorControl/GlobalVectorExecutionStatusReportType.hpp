...
#ifndef GlobalVectorExecutionStatusReportType_707232702_hpp
#define GlobalVectorExecutionStatusReportType_707232702_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalVectorControl {
            ...
            static const std::string GlobalVectorExecutionStatusReportTypeTopic = "UMAA::MO::GlobalVectorControl::GlobalVectorExecutionStatusReportType";
            ...
            class NDDSUSERDllExport GlobalVectorExecutionStatusReportType {
              public:
                ...
                GlobalVectorExecutionStatusReportType(bool directionAchieved_,bool elevationAchieved_,bool speedAchieved_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);

                bool& directionAchieved() noexcept {
                    return m_directionAchieved_;
                }

                const bool& directionAchieved() const noexcept {
                    return m_directionAchieved_;
                }

                void directionAchieved(bool value) {

                    m_directionAchieved_ = value;
                }
...
#endif // GlobalVectorExecutionStatusReportType_707232702_hpp
