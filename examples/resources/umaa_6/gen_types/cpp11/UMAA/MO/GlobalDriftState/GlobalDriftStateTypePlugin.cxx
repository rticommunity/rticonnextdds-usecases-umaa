    ...
    namespace MO {
        namespace GlobalDriftState {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void GlobalDriftStateTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "GlobalDriftStateTypeEnum", indent_level + 1);
            }
            ...
            * ------------------------------------------------------------------------ */
            ...
            /* ----------------------------------------------------------------------------
            *  Type GlobalDriftStateTypeUnion
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    GlobalDriftStateTypeUnion *sample = new GlobalDriftStateTypeUnion();
            ...
            GlobalDriftStateTypeUnionPluginSupport_copy_data(
                GlobalDriftStateTypeUnion *dst,
                const GlobalDriftStateTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            GlobalDriftStateTypeUnionPlugin_copy_sample(
                ...
                const GlobalDriftStateTypeUnion *src)
            {
                return ::UMAA::MO::GlobalDriftState::GlobalDriftStateTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< GlobalDriftStateTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool GlobalDriftStateTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GlobalDriftStateTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
