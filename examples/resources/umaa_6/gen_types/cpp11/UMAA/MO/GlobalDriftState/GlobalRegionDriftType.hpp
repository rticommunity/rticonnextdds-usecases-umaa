...
#ifndef GlobalRegionDriftType_953231361_hpp
#define GlobalRegionDriftType_953231361_hpp
        ...
        namespace GlobalDriftState {
            ...
            class NDDSUSERDllExport GlobalRegionDriftType {
              public:
                ...
                GlobalRegionDriftType(bool driftRadiusAchieved_,bool elevationAchieved_);

                bool& driftRadiusAchieved() noexcept {
                    return m_driftRadiusAchieved_;
                }

                const bool& driftRadiusAchieved() const noexcept {
                    return m_driftRadiusAchieved_;
                }

                void driftRadiusAchieved(bool value) {

                    m_driftRadiusAchieved_ = value;
                }
                ...
                void swap(GlobalRegionDriftType& other_) noexcept ;

              private:

                bool m_driftRadiusAchieved_;
                bool m_elevationAchieved_;

            };

            inline void swap(GlobalRegionDriftType& a, GlobalRegionDriftType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // GlobalRegionDriftType_953231361_hpp
