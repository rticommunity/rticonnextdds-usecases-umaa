    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverCommandType > {
            static DDS_TypeCode * get()
            {
                ...
                PrimitiveDriverCommandType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                PrimitiveDriverCommandType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                PrimitiveDriverCommandType_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
