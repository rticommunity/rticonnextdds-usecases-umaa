...
#ifndef PrimitiveDriverExecutionStatusReportType_623024333_hpp
#define PrimitiveDriverExecutionStatusReportType_623024333_hpp
...
namespace UMAA {
    namespace MO {
        namespace PrimitiveDriverControl {
            ...
            static const std::string PrimitiveDriverExecutionStatusReportTypeTopic = "UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType";

            class NDDSUSERDllExport PrimitiveDriverExecutionStatusReportType {
              public:
                ...
                bool operator == (const PrimitiveDriverExecutionStatusReportType& other_) const;
                bool operator != (const PrimitiveDriverExecutionStatusReportType& other_) const;

                void swap(PrimitiveDriverExecutionStatusReportType& other_) noexcept ;
            ...
            inline void swap(PrimitiveDriverExecutionStatusReportType& a, PrimitiveDriverExecutionStatusReportType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const PrimitiveDriverExecutionStatusReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MO::PrimitiveDriverControl::PrimitiveDriverExecutionStatusReportType > {
...
#endif // PrimitiveDriverExecutionStatusReportType_623024333_hpp
