...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalWaypointControl {
            ...
            void GlobalWaypointCommandStatusType::swap(GlobalWaypointCommandStatusType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandStatusType > {
            static DDS_TypeCode * get()
            {
                ...
                GlobalWaypointCommandStatusType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                GlobalWaypointCommandStatusType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                GlobalWaypointCommandStatusType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                GlobalWaypointCommandStatusType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType>::get().native();
                GlobalWaypointCommandStatusType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType>::get().native();
                GlobalWaypointCommandStatusType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&GlobalWaypointCommandStatusType_g_tc_logMessage_string;

                /* Initialize the values for member annotations. */
                GlobalWaypointCommandStatusType_g_tc_members[3]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                GlobalWaypointCommandStatusType_g_tc_members[3]._annotations._defaultValue._u.enumerated_value = 0;
                GlobalWaypointCommandStatusType_g_tc_members[4]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                GlobalWaypointCommandStatusType_g_tc_members[4]._annotations._defaultValue._u.enumerated_value = 0;
                GlobalWaypointCommandStatusType_g_tc_members[5]._annotations._defaultValue._d = RTI_XCDR_TK_STRING;
                GlobalWaypointCommandStatusType_g_tc_members[5]._annotations._defaultValue._u.string_value = (DDS_Char *) "";
