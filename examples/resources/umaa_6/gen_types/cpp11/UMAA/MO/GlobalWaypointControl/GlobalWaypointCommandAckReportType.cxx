...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalWaypointControl {
            ...
            GlobalWaypointCommandAckReportType::GlobalWaypointCommandAckReportType (const ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType& command_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_command_(command_), 
            ...
            void GlobalWaypointCommandAckReportType::swap(GlobalWaypointCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandAckReportType > {
            static DDS_TypeCode * get()
            {
                ...
                GlobalWaypointCommandAckReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType>::get().native();
                GlobalWaypointCommandAckReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                GlobalWaypointCommandAckReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
