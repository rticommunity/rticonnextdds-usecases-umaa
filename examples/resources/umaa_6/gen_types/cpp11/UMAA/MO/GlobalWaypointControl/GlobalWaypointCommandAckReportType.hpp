...
#ifndef GlobalWaypointCommandAckReportType_1358667414_hpp
#define GlobalWaypointCommandAckReportType_1358667414_hpp
...
namespace UMAA {
    namespace MO {
        namespace GlobalWaypointControl {
            ...
            static const std::string GlobalWaypointCommandAckReportTypeTopic = "UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandAckReportType";
            ...
            class NDDSUSERDllExport GlobalWaypointCommandAckReportType {
              public:
                ...
                GlobalWaypointCommandAckReportType(const ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType& command_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_);

                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType& command() noexcept {
                    return m_command_;
                }

                const ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType& command() const noexcept {
                    return m_command_;
                }

                void command(const ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType& value) {

                    m_command_ = value;
                }

                void command(::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType&& value) {
              ...
              private:
                ...
                ::UMAA::MO::GlobalWaypointControl::GlobalWaypointCommandType m_command_;
...
#endif // GlobalWaypointCommandAckReportType_1358667414_hpp
