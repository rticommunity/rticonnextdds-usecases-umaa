...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalDriftControl {
            ...
            GlobalDriftCommandAckReportType::GlobalDriftCommandAckReportType (const ::UMAA::MO::GlobalDriftControl::GlobalDriftCommandType& command_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
                m_command_(command_), 
            ...
            void GlobalDriftCommandAckReportType::swap(GlobalDriftCommandAckReportType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::MO::GlobalDriftControl::GlobalDriftCommandAckReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member GlobalDriftCommandAckReportType_g_tc_members[4]=
                {
                ...
                GlobalDriftCommandAckReportType_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::MO::GlobalDriftControl::GlobalDriftCommandType>::get().native();
                GlobalDriftCommandAckReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                GlobalDriftCommandAckReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                GlobalDriftCommandAckReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo GlobalDriftCommandAckReportType_g_memberAccessInfos[4] =
