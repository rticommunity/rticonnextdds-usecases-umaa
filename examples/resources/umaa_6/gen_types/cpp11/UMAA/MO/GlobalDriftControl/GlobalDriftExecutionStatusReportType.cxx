...
namespace UMAA {
    ...
    namespace MO {
        ...
        namespace GlobalDriftControl {
            ...
            GlobalDriftExecutionStatusReportType::GlobalDriftExecutionStatusReportType (double distanceFromReference_,const ::UMAA::MO::GlobalDriftState::GlobalDriftStateType& globalDriftState_,const ::UMAA::Common::Measurement::DateTime& timeDriftAchieved_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& timeDriftCompleted_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::MO::GlobalDriftControl::GlobalDriftExecutionStatusReportType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member GlobalDriftExecutionStatusReportType_g_tc_members[7]=
                {
                ...
                GlobalDriftExecutionStatusReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                GlobalDriftExecutionStatusReportType_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                GlobalDriftExecutionStatusReportType_g_tc_members[6]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::NumericGUID_AliasTag_t>::get().native();
                ...
                GlobalDriftExecutionStatusReportType_g_tc_members[0]._annotations._minValue._u.double_value = RTIXCdrDouble_MIN;
                GlobalDriftExecutionStatusReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_DOUBLE;
                GlobalDriftExecutionStatusReportType_g_tc_members[0]._annotations._maxValue._u.double_value = RTIXCdrDouble_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo GlobalDriftExecutionStatusReportType_g_memberAccessInfos[7] =
                ...
                GlobalDriftExecutionStatusReportType_g_memberAccessInfos[6].bindingMemberValueOffset[0] = 
