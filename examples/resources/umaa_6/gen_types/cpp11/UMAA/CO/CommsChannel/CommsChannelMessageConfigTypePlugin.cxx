...
namespace UMAA {
    namespace CO {
        namespace CommsChannel {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CommsChannelMessageConfigType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CommsChannelMessageConfigType *sample = new CommsChannelMessageConfigType();
            ...
            CommsChannelMessageConfigTypePluginSupport_copy_data(
                CommsChannelMessageConfigType *dst,
                const CommsChannelMessageConfigType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CommsChannelMessageConfigTypePlugin_copy_sample(
                ...
                const CommsChannelMessageConfigType *src)
            {
                return ::UMAA::CO::CommsChannel::CommsChannelMessageConfigTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CommsChannelMessageConfigType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CommsChannelMessageConfigTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CommsChannelMessageConfigType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
