...
namespace UMAA {
    namespace CO {
        namespace CommsChannel {
            ...
            /* ----------------------------------------------------------------------------
            *  Type CommsChannelSenderStatisticsType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CommsChannelSenderStatisticsType *sample = new CommsChannelSenderStatisticsType();
            ...
            CommsChannelSenderStatisticsTypePluginSupport_copy_data(
                CommsChannelSenderStatisticsType *dst,
                const CommsChannelSenderStatisticsType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CommsChannelSenderStatisticsTypePlugin_copy_sample(
                ...
                const CommsChannelSenderStatisticsType *src)
            {
                return ::UMAA::CO::CommsChannel::CommsChannelSenderStatisticsTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CommsChannelSenderStatisticsType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CommsChannelSenderStatisticsTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CommsChannelSenderStatisticsType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
