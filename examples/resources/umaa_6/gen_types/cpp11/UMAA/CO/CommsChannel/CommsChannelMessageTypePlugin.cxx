    ...
    namespace CO {
        namespace CommsChannel {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    CommsChannelMessageType *sample = new CommsChannelMessageType();
            ...
            CommsChannelMessageTypePluginSupport_copy_data(
                CommsChannelMessageType *dst,
                const CommsChannelMessageType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CommsChannelMessageTypePlugin_copy_sample(
                ...
                const CommsChannelMessageType *src)
            {
                return ::UMAA::CO::CommsChannel::CommsChannelMessageTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CommsChannelMessageType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool CommsChannelMessageTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CommsChannelMessageType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
