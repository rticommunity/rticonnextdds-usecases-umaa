...
#ifndef CommsChannelAddMessageCancelConfigCommandStatusType_1074989048_hpp
#define CommsChannelAddMessageCancelConfigCommandStatusType_1074989048_hpp
...
namespace UMAA {
    namespace CO {
        namespace CommsChannelConfig {
            ...
            static const std::string CommsChannelAddMessageCancelConfigCommandStatusTypeTopic = "UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType";

            class NDDSUSERDllExport CommsChannelAddMessageCancelConfigCommandStatusType {
              public:
                ...
                bool operator == (const CommsChannelAddMessageCancelConfigCommandStatusType& other_) const;
                bool operator != (const CommsChannelAddMessageCancelConfigCommandStatusType& other_) const;

                void swap(CommsChannelAddMessageCancelConfigCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CommsChannelAddMessageCancelConfigCommandStatusType& a, CommsChannelAddMessageCancelConfigCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CommsChannelAddMessageCancelConfigCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::CO::CommsChannelConfig::CommsChannelAddMessageCancelConfigCommandStatusType > {
...
#endif // CommsChannelAddMessageCancelConfigCommandStatusType_1074989048_hpp
