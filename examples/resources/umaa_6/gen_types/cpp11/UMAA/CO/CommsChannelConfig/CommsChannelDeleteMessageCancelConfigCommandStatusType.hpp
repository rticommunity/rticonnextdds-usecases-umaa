...
#ifndef CommsChannelDeleteMessageCancelConfigCommandStatusType_878942212_hpp
#define CommsChannelDeleteMessageCancelConfigCommandStatusType_878942212_hpp
...
namespace UMAA {
    namespace CO {
        namespace CommsChannelConfig {
            ...
            static const std::string CommsChannelDeleteMessageCancelConfigCommandStatusTypeTopic = "UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType";

            class NDDSUSERDllExport CommsChannelDeleteMessageCancelConfigCommandStatusType {
              public:
                ...
                bool operator == (const CommsChannelDeleteMessageCancelConfigCommandStatusType& other_) const;
                bool operator != (const CommsChannelDeleteMessageCancelConfigCommandStatusType& other_) const;

                void swap(CommsChannelDeleteMessageCancelConfigCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CommsChannelDeleteMessageCancelConfigCommandStatusType& a, CommsChannelDeleteMessageCancelConfigCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CommsChannelDeleteMessageCancelConfigCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::CO::CommsChannelConfig::CommsChannelDeleteMessageCancelConfigCommandStatusType > {
...
#endif // CommsChannelDeleteMessageCancelConfigCommandStatusType_878942212_hpp
