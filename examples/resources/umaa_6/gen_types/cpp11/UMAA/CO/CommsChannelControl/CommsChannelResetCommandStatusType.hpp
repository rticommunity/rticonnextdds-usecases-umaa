...
#ifndef CommsChannelResetCommandStatusType_1233687003_hpp
#define CommsChannelResetCommandStatusType_1233687003_hpp
...
namespace UMAA {
    namespace CO {
        namespace CommsChannelControl {
            ...
            static const std::string CommsChannelResetCommandStatusTypeTopic = "UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType";

            class NDDSUSERDllExport CommsChannelResetCommandStatusType {
              public:
                ...
                bool operator == (const CommsChannelResetCommandStatusType& other_) const;
                bool operator != (const CommsChannelResetCommandStatusType& other_) const;

                void swap(CommsChannelResetCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CommsChannelResetCommandStatusType& a, CommsChannelResetCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CommsChannelResetCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::CO::CommsChannelControl::CommsChannelResetCommandStatusType > {
...
#endif // CommsChannelResetCommandStatusType_1233687003_hpp
