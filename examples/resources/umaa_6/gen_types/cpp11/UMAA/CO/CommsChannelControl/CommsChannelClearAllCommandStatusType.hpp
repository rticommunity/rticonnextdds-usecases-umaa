...
#ifndef CommsChannelClearAllCommandStatusType_320269261_hpp
#define CommsChannelClearAllCommandStatusType_320269261_hpp
...
namespace UMAA {
    namespace CO {
        namespace CommsChannelControl {
            ...
            static const std::string CommsChannelClearAllCommandStatusTypeTopic = "UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType";

            class NDDSUSERDllExport CommsChannelClearAllCommandStatusType {
              public:
                ...
                bool operator == (const CommsChannelClearAllCommandStatusType& other_) const;
                bool operator != (const CommsChannelClearAllCommandStatusType& other_) const;

                void swap(CommsChannelClearAllCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CommsChannelClearAllCommandStatusType& a, CommsChannelClearAllCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CommsChannelClearAllCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::CO::CommsChannelControl::CommsChannelClearAllCommandStatusType > {
...
#endif // CommsChannelClearAllCommandStatusType_320269261_hpp
