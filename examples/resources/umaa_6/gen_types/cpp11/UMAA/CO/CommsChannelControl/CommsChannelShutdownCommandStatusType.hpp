...
#ifndef CommsChannelShutdownCommandStatusType_1046087887_hpp
#define CommsChannelShutdownCommandStatusType_1046087887_hpp
...
namespace UMAA {
    namespace CO {
        namespace CommsChannelControl {
            ...
            static const std::string CommsChannelShutdownCommandStatusTypeTopic = "UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType";

            class NDDSUSERDllExport CommsChannelShutdownCommandStatusType {
              public:

                CommsChannelShutdownCommandStatusType();

                CommsChannelShutdownCommandStatusType(const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& sessionID_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusEnumModule::CommandStatusEnumType& commandStatus_,const ::UMAA::Common::MaritimeEnumeration::CommandStatusReasonEnumModule::CommandStatusReasonEnumType& commandStatusReason_,const std::string& logMessage_);
                ...
                bool operator == (const CommsChannelShutdownCommandStatusType& other_) const;
                bool operator != (const CommsChannelShutdownCommandStatusType& other_) const;

                void swap(CommsChannelShutdownCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CommsChannelShutdownCommandStatusType& a, CommsChannelShutdownCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CommsChannelShutdownCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::CO::CommsChannelControl::CommsChannelShutdownCommandStatusType > {
...
#endif // CommsChannelShutdownCommandStatusType_1046087887_hpp
