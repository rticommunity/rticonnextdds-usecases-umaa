...
#ifndef CommsChannelClearMessageCommandStatusType_1526139927_hpp
#define CommsChannelClearMessageCommandStatusType_1526139927_hpp
...
namespace UMAA {
    namespace CO {
        namespace CommsChannelControl {
            ...
            static const std::string CommsChannelClearMessageCommandStatusTypeTopic = "UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType";

            class NDDSUSERDllExport CommsChannelClearMessageCommandStatusType {
              public:
                ...
                bool operator == (const CommsChannelClearMessageCommandStatusType& other_) const;
                bool operator != (const CommsChannelClearMessageCommandStatusType& other_) const;

                void swap(CommsChannelClearMessageCommandStatusType& other_) noexcept ;
            ...
            inline void swap(CommsChannelClearMessageCommandStatusType& a, CommsChannelClearMessageCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const CommsChannelClearMessageCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::CO::CommsChannelControl::CommsChannelClearMessageCommandStatusType > {
...
#endif // CommsChannelClearMessageCommandStatusType_1526139927_hpp
