    ...
    namespace CO {
        namespace Filter {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AllFilterType *sample = new AllFilterType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AllFilterTypePlugin_copy_sample(
                ...
                const AllFilterType *src)
            {
                return ::UMAA::CO::Filter::AllFilterTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AllFilterType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AllFilterTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AllFilterType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
