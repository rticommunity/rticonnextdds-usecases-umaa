...
namespace UMAA {
    namespace CO {
        namespace Filter {
            ...
            /* ----------------------------------------------------------------------------
            *  Type DecimateStructureFilterType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    DecimateStructureFilterType *sample = new DecimateStructureFilterType();
            ...
            DecimateStructureFilterTypePluginSupport_copy_data(
                DecimateStructureFilterType *dst,
                const DecimateStructureFilterType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DecimateStructureFilterTypePlugin_copy_sample(
                ...
                const DecimateStructureFilterType *src)
            {
                return ::UMAA::CO::Filter::DecimateStructureFilterTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< DecimateStructureFilterType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool DecimateStructureFilterTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DecimateStructureFilterType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
