...
namespace UMAA {
    namespace CO {
        namespace Filter {
            ...
            /* ----------------------------------------------------------------------------
            *  Type SendOnlyIfChangedFilterType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    SendOnlyIfChangedFilterType *sample = new SendOnlyIfChangedFilterType();
            ...
            SendOnlyIfChangedFilterTypePluginSupport_copy_data(
                SendOnlyIfChangedFilterType *dst,
                const SendOnlyIfChangedFilterType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            SendOnlyIfChangedFilterTypePlugin_copy_sample(
                ...
                const SendOnlyIfChangedFilterType *src)
            {
                return ::UMAA::CO::Filter::SendOnlyIfChangedFilterTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SendOnlyIfChangedFilterType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool SendOnlyIfChangedFilterTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SendOnlyIfChangedFilterType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
