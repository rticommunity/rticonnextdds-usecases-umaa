    ...
    namespace CO {
        namespace Filter {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void MessageFilterTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "MessageFilterTypeEnum", indent_level + 1);
            }
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    MessageFilterTypeUnion *sample = new MessageFilterTypeUnion();
            ...
            MessageFilterTypeUnionPluginSupport_copy_data(
                MessageFilterTypeUnion *dst,
                const MessageFilterTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            MessageFilterTypeUnionPlugin_copy_sample(
                ...
                const MessageFilterTypeUnion *src)
            {
                return ::UMAA::CO::Filter::MessageFilterTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< MessageFilterTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool MessageFilterTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                MessageFilterTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    MessageFilterType *sample = new MessageFilterType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            MessageFilterTypePluginSupport_copy_data(
                MessageFilterType *dst,
                const MessageFilterType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            MessageFilterTypePlugin_copy_sample(
                ...
                const MessageFilterType *src)
            {
                return ::UMAA::CO::Filter::MessageFilterTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< MessageFilterType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool MessageFilterTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                MessageFilterType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
