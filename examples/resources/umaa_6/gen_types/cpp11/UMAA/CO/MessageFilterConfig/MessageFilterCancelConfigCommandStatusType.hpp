...
#ifndef MessageFilterCancelConfigCommandStatusType_1537924688_hpp
#define MessageFilterCancelConfigCommandStatusType_1537924688_hpp
...
namespace UMAA {
    namespace CO {
        namespace MessageFilterConfig {
            ...
            static const std::string MessageFilterCancelConfigCommandStatusTypeTopic = "UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType";

            class NDDSUSERDllExport MessageFilterCancelConfigCommandStatusType {
              public:
                ...
                bool operator == (const MessageFilterCancelConfigCommandStatusType& other_) const;
                bool operator != (const MessageFilterCancelConfigCommandStatusType& other_) const;

                void swap(MessageFilterCancelConfigCommandStatusType& other_) noexcept ;
            ...
            inline void swap(MessageFilterCancelConfigCommandStatusType& a, MessageFilterCancelConfigCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const MessageFilterCancelConfigCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::CO::MessageFilterConfig::MessageFilterCancelConfigCommandStatusType > {
...
#endif // MessageFilterCancelConfigCommandStatusType_1537924688_hpp
