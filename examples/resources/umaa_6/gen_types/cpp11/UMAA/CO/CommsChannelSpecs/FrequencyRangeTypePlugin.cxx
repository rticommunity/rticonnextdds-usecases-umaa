    ...
    namespace CO {
        namespace CommsChannelSpecs {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    FrequencyRangeType *sample = new FrequencyRangeType();
            ...
            FrequencyRangeTypePluginSupport_copy_data(
                FrequencyRangeType *dst,
                const FrequencyRangeType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            FrequencyRangeTypePlugin_copy_sample(
                ...
                const FrequencyRangeType *src)
            {
                return ::UMAA::CO::CommsChannelSpecs::FrequencyRangeTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FrequencyRangeType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool FrequencyRangeTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                FrequencyRangeType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
