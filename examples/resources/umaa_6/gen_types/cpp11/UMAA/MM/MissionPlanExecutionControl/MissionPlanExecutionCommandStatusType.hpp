...
#ifndef MissionPlanExecutionCommandStatusType_1461891434_hpp
#define MissionPlanExecutionCommandStatusType_1461891434_hpp
...
namespace UMAA {
    namespace MM {
        namespace MissionPlanExecutionControl {
            ...
            static const std::string MissionPlanExecutionCommandStatusTypeTopic = "UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType";

            class NDDSUSERDllExport MissionPlanExecutionCommandStatusType {
              public:
                ...
                bool operator == (const MissionPlanExecutionCommandStatusType& other_) const;
                bool operator != (const MissionPlanExecutionCommandStatusType& other_) const;

                void swap(MissionPlanExecutionCommandStatusType& other_) noexcept ;
            ...
            inline void swap(MissionPlanExecutionCommandStatusType& a, MissionPlanExecutionCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const MissionPlanExecutionCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::MissionPlanExecutionControl::MissionPlanExecutionCommandStatusType > {
...
#endif // MissionPlanExecutionCommandStatusType_1461891434_hpp
