...
#ifndef TaskPlanAssignmentCommandStatusType_420081755_hpp
#define TaskPlanAssignmentCommandStatusType_420081755_hpp
...
namespace UMAA {
    namespace MM {
        namespace TaskPlanAssignmentControl {
            ...
            static const std::string TaskPlanAssignmentCommandStatusTypeTopic = "UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType";

            class NDDSUSERDllExport TaskPlanAssignmentCommandStatusType {
              public:
                ...
                bool operator == (const TaskPlanAssignmentCommandStatusType& other_) const;
                bool operator != (const TaskPlanAssignmentCommandStatusType& other_) const;

                void swap(TaskPlanAssignmentCommandStatusType& other_) noexcept ;
            ...
            inline void swap(TaskPlanAssignmentCommandStatusType& a, TaskPlanAssignmentCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const TaskPlanAssignmentCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::TaskPlanAssignmentControl::TaskPlanAssignmentCommandStatusType > {
...
#endif // TaskPlanAssignmentCommandStatusType_420081755_hpp
