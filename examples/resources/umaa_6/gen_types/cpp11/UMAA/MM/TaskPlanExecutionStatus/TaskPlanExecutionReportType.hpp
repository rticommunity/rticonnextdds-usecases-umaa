...
#ifndef TaskPlanExecutionReportType_1039935746_hpp
#define TaskPlanExecutionReportType_1039935746_hpp
...
namespace UMAA {
    namespace MM {
        namespace TaskPlanExecutionStatus {
            ...
            static const std::string TaskPlanExecutionReportTypeTopic = "UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType";

            class NDDSUSERDllExport TaskPlanExecutionReportType {
              public:

                TaskPlanExecutionReportType();

                TaskPlanExecutionReportType(const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& endTime_,const std::string& feedback_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& startTime_,const ::UMAA::Common::MaritimeEnumeration::TaskStateEnumModule::TaskStateEnumType& state_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_,const ::UMAA::Common::Measurement::NumericGUID& missionID_,const ::UMAA::Common::Measurement::NumericGUID& taskID_);
                ...
                bool operator == (const TaskPlanExecutionReportType& other_) const;
                bool operator != (const TaskPlanExecutionReportType& other_) const;

                void swap(TaskPlanExecutionReportType& other_) noexcept ;
            ...
            inline void swap(TaskPlanExecutionReportType& a, TaskPlanExecutionReportType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const TaskPlanExecutionReportType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::TaskPlanExecutionStatus::TaskPlanExecutionReportType > {
...
#endif // TaskPlanExecutionReportType_1039935746_hpp
