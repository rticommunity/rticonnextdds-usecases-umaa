...
#ifndef ConditionalDeleteCommandStatusType_461509722_hpp
#define ConditionalDeleteCommandStatusType_461509722_hpp
...
namespace UMAA {
    namespace MM {
        namespace ConditionalControl {
            ...
            static const std::string ConditionalDeleteCommandStatusTypeTopic = "UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType";

            class NDDSUSERDllExport ConditionalDeleteCommandStatusType {
              public:
                ...
                bool operator == (const ConditionalDeleteCommandStatusType& other_) const;
                bool operator != (const ConditionalDeleteCommandStatusType& other_) const;

                void swap(ConditionalDeleteCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ConditionalDeleteCommandStatusType& a, ConditionalDeleteCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ConditionalDeleteCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType > {
...
#endif // ConditionalDeleteCommandStatusType_461509722_hpp
