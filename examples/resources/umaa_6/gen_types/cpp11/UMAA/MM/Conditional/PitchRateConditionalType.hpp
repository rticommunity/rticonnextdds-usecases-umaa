...
#ifndef PitchRateConditionalType_311891907_hpp
#define PitchRateConditionalType_311891907_hpp
...
namespace UMAA {
    namespace MM {
        namespace Conditional {
            ...
            static const std::string PitchRateConditionalTypeTopic = "UMAA::MM::Conditional::PitchRateConditionalType";

            class NDDSUSERDllExport PitchRateConditionalType {
              public:

                PitchRateConditionalType();

                PitchRateConditionalType(const ::UMAA::Common::MaritimeEnumeration::ConditionalOperatorEnumModule::ConditionalOperatorEnumType& conditionalOp_,double pitchRate_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const PitchRateConditionalType& other_) const;
                bool operator != (const PitchRateConditionalType& other_) const;

                void swap(PitchRateConditionalType& other_) noexcept ;
            ...
            inline void swap(PitchRateConditionalType& a, PitchRateConditionalType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const PitchRateConditionalType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::Conditional::PitchRateConditionalType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::Conditional::PitchRateConditionalType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::Conditional::PitchRateConditionalType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::Conditional::PitchRateConditionalType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::Conditional::PitchRateConditionalType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::Conditional::PitchRateConditionalType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::Conditional::PitchRateConditionalType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::Conditional::PitchRateConditionalType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::Conditional::PitchRateConditionalType > {
...
#endif // PitchRateConditionalType_311891907_hpp
