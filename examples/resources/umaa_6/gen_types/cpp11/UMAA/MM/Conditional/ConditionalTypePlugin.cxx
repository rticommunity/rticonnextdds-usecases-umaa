    ...
    namespace MM {
        namespace Conditional {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ConditionalType *sample = new ConditionalType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ConditionalTypePlugin_copy_sample(
                ...
                const ConditionalType *src)
            {
                return ::UMAA::MM::Conditional::ConditionalTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ConditionalType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ConditionalTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ConditionalType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
