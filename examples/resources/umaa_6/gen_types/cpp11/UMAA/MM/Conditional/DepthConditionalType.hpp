...
#ifndef DepthConditionalType_68105261_hpp
#define DepthConditionalType_68105261_hpp
...
namespace UMAA {
    namespace MM {
        namespace Conditional {
            ...
            static const std::string DepthConditionalTypeTopic = "UMAA::MM::Conditional::DepthConditionalType";

            class NDDSUSERDllExport DepthConditionalType {
              public:

                DepthConditionalType();

                DepthConditionalType(const ::UMAA::Common::MaritimeEnumeration::ConditionalOperatorEnumModule::ConditionalOperatorEnumType& conditionalOp_,double depth_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const DepthConditionalType& other_) const;
                bool operator != (const DepthConditionalType& other_) const;

                void swap(DepthConditionalType& other_) noexcept ;
            ...
            inline void swap(DepthConditionalType& a, DepthConditionalType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const DepthConditionalType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::Conditional::DepthConditionalType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::Conditional::DepthConditionalType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::Conditional::DepthConditionalType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::Conditional::DepthConditionalType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::Conditional::DepthConditionalType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::Conditional::DepthConditionalType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::Conditional::DepthConditionalType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::Conditional::DepthConditionalType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::Conditional::DepthConditionalType > {
...
#endif // DepthConditionalType_68105261_hpp
