...
#ifndef RollRateConditionalType_930519448_hpp
#define RollRateConditionalType_930519448_hpp
...
namespace UMAA {
    namespace MM {
        namespace Conditional {
            ...
            static const std::string RollRateConditionalTypeTopic = "UMAA::MM::Conditional::RollRateConditionalType";

            class NDDSUSERDllExport RollRateConditionalType {
              public:

                RollRateConditionalType();

                RollRateConditionalType(const ::UMAA::Common::MaritimeEnumeration::ConditionalOperatorEnumModule::ConditionalOperatorEnumType& conditionalOp_,double rollRate_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const RollRateConditionalType& other_) const;
                bool operator != (const RollRateConditionalType& other_) const;

                void swap(RollRateConditionalType& other_) noexcept ;
            ...
            inline void swap(RollRateConditionalType& a, RollRateConditionalType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const RollRateConditionalType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::Conditional::RollRateConditionalType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::Conditional::RollRateConditionalType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::Conditional::RollRateConditionalType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::Conditional::RollRateConditionalType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::Conditional::RollRateConditionalType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::Conditional::RollRateConditionalType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::Conditional::RollRateConditionalType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::Conditional::RollRateConditionalType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::Conditional::RollRateConditionalType > {
...
#endif // RollRateConditionalType_930519448_hpp
