...
#ifndef TimeConditionalType_1771945828_hpp
#define TimeConditionalType_1771945828_hpp
        ...
        namespace Conditional {
            ...
            class NDDSUSERDllExport TimeConditionalType {
              public:
                ...
                bool operator == (const TimeConditionalType& other_) const;
                bool operator != (const TimeConditionalType& other_) const;

                void swap(TimeConditionalType& other_) noexcept ;
            ...
            inline void swap(TimeConditionalType& a, TimeConditionalType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const TimeConditionalType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::Conditional::TimeConditionalType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::Conditional::TimeConditionalType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::Conditional::TimeConditionalType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::Conditional::TimeConditionalType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::Conditional::TimeConditionalType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::Conditional::TimeConditionalType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::Conditional::TimeConditionalType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::Conditional::TimeConditionalType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::Conditional::TimeConditionalType > {
...
#endif // TimeConditionalType_1771945828_hpp
