...
#ifndef DepthRateConditionalType_1554630212_hpp
#define DepthRateConditionalType_1554630212_hpp
...
namespace UMAA {
    namespace MM {
        namespace Conditional {
            ...
            static const std::string DepthRateConditionalTypeTopic = "UMAA::MM::Conditional::DepthRateConditionalType";

            class NDDSUSERDllExport DepthRateConditionalType {
              public:

                DepthRateConditionalType();

                DepthRateConditionalType(const ::UMAA::Common::MaritimeEnumeration::ConditionalOperatorEnumModule::ConditionalOperatorEnumType& conditionalOp_,double depthRate_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const DepthRateConditionalType& other_) const;
                bool operator != (const DepthRateConditionalType& other_) const;

                void swap(DepthRateConditionalType& other_) noexcept ;
            ...
            inline void swap(DepthRateConditionalType& a, DepthRateConditionalType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const DepthRateConditionalType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::Conditional::DepthRateConditionalType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::Conditional::DepthRateConditionalType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::Conditional::DepthRateConditionalType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::Conditional::DepthRateConditionalType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::Conditional::DepthRateConditionalType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::Conditional::DepthRateConditionalType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::Conditional::DepthRateConditionalType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::Conditional::DepthRateConditionalType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::Conditional::DepthRateConditionalType > {
...
#endif // DepthRateConditionalType_1554630212_hpp
