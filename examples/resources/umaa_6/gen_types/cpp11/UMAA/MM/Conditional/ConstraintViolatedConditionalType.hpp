...
#ifndef ConstraintViolatedConditionalType_1048388755_hpp
#define ConstraintViolatedConditionalType_1048388755_hpp
...
namespace UMAA {
    namespace MM {
        namespace Conditional {
            ...
            static const std::string ConstraintViolatedConditionalTypeTopic = "UMAA::MM::Conditional::ConstraintViolatedConditionalType";

            class NDDSUSERDllExport ConstraintViolatedConditionalType {
              public:

                ConstraintViolatedConditionalType();

                ConstraintViolatedConditionalType(const ::UMAA::Common::Measurement::NumericGUID& constraintConditionalID_,const ::dds::core::optional< double >& duration_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const ConstraintViolatedConditionalType& other_) const;
                bool operator != (const ConstraintViolatedConditionalType& other_) const;

                void swap(ConstraintViolatedConditionalType& other_) noexcept ;
            ...
            inline void swap(ConstraintViolatedConditionalType& a, ConstraintViolatedConditionalType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ConstraintViolatedConditionalType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::Conditional::ConstraintViolatedConditionalType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::Conditional::ConstraintViolatedConditionalType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::Conditional::ConstraintViolatedConditionalType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::Conditional::ConstraintViolatedConditionalType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::Conditional::ConstraintViolatedConditionalType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::Conditional::ConstraintViolatedConditionalType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::Conditional::ConstraintViolatedConditionalType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::Conditional::ConstraintViolatedConditionalType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::Conditional::ConstraintViolatedConditionalType > {
...
#endif // ConstraintViolatedConditionalType_1048388755_hpp
