...
#ifndef SpeedConditionalType_720677440_hpp
#define SpeedConditionalType_720677440_hpp
...
namespace UMAA {
    namespace MM {
        namespace Conditional {
            ...
            static const std::string SpeedConditionalTypeTopic = "UMAA::MM::Conditional::SpeedConditionalType";

            class NDDSUSERDllExport SpeedConditionalType {
              public:

                SpeedConditionalType();

                SpeedConditionalType(const ::UMAA::Common::MaritimeEnumeration::ConditionalOperatorEnumModule::ConditionalOperatorEnumType& conditionalOp_,double speed_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const SpeedConditionalType& other_) const;
                bool operator != (const SpeedConditionalType& other_) const;

                void swap(SpeedConditionalType& other_) noexcept ;
            ...
            inline void swap(SpeedConditionalType& a, SpeedConditionalType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const SpeedConditionalType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::Conditional::SpeedConditionalType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::Conditional::SpeedConditionalType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::Conditional::SpeedConditionalType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::Conditional::SpeedConditionalType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::Conditional::SpeedConditionalType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::Conditional::SpeedConditionalType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::Conditional::SpeedConditionalType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::Conditional::SpeedConditionalType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::Conditional::SpeedConditionalType > {
...
#endif // SpeedConditionalType_720677440_hpp
