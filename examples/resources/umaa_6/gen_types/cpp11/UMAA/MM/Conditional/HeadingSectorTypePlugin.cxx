    ...
    namespace MM {
        namespace Conditional {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    HeadingSectorType *sample = new HeadingSectorType();
            ...
            HeadingSectorTypePluginSupport_copy_data(
                HeadingSectorType *dst,
                const HeadingSectorType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            HeadingSectorTypePlugin_copy_sample(
                ...
                const HeadingSectorType *src)
            {
                return ::UMAA::MM::Conditional::HeadingSectorTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< HeadingSectorType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool HeadingSectorTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                HeadingSectorType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
