...
#ifndef OperationalModeCommandStatusType_1168846479_hpp
#define OperationalModeCommandStatusType_1168846479_hpp
...
namespace UMAA {
    namespace MM {
        namespace OperationalModeControl {
            ...
            static const std::string OperationalModeCommandStatusTypeTopic = "UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType";

            class NDDSUSERDllExport OperationalModeCommandStatusType {
              public:
                ...
                bool operator == (const OperationalModeCommandStatusType& other_) const;
                bool operator != (const OperationalModeCommandStatusType& other_) const;

                void swap(OperationalModeCommandStatusType& other_) noexcept ;
            ...
            inline void swap(OperationalModeCommandStatusType& a, OperationalModeCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const OperationalModeCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::OperationalModeControl::OperationalModeCommandStatusType > {
...
#endif // OperationalModeCommandStatusType_1168846479_hpp
