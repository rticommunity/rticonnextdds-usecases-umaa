...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AnnulusSectorToleranceType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AnnulusSectorToleranceType *sample = new AnnulusSectorToleranceType();
            ...
            AnnulusSectorToleranceTypePluginSupport_copy_data(
                AnnulusSectorToleranceType *dst,
                const AnnulusSectorToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AnnulusSectorToleranceTypePlugin_copy_sample(
                ...
                const AnnulusSectorToleranceType *src)
            {
                return ::UMAA::MM::BaseType::AnnulusSectorToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AnnulusSectorToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AnnulusSectorToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AnnulusSectorToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
