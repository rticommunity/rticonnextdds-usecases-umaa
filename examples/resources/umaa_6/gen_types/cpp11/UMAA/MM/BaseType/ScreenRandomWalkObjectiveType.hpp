...
#ifndef ScreenRandomWalkObjectiveType_655830695_hpp
#define ScreenRandomWalkObjectiveType_655830695_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string ScreenRandomWalkObjectiveTypeTopic = "UMAA::MM::BaseType::ScreenRandomWalkObjectiveType";

            class NDDSUSERDllExport ScreenRandomWalkObjectiveType {
              public:

                ScreenRandomWalkObjectiveType();

                ScreenRandomWalkObjectiveType(const ::UMAA::MM::BaseType::AnnulusSectorRequirementType& area_,const ::dds::core::optional< double >& duration_,const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationRequirementVariantType >& elevation_,const ::UMAA::Common::Measurement::NumericGUID& guideID_,const ::UMAA::Common::Speed::SpeedVariantType& maxSpeed_,double maxTimeOnCourse_,const ::UMAA::Common::Speed::SpeedVariantType& minSpeed_,double minTimeOnCourse_,const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationVariantType >& transitElevation_,const ::UMAA::Common::Speed::SpeedVariantType& transitSpeed_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const ScreenRandomWalkObjectiveType& other_) const;
                bool operator != (const ScreenRandomWalkObjectiveType& other_) const;

                void swap(ScreenRandomWalkObjectiveType& other_) noexcept ;
            ...
            inline void swap(ScreenRandomWalkObjectiveType& a, ScreenRandomWalkObjectiveType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ScreenRandomWalkObjectiveType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::ScreenRandomWalkObjectiveType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveType > {
...
#endif // ScreenRandomWalkObjectiveType_655830695_hpp
