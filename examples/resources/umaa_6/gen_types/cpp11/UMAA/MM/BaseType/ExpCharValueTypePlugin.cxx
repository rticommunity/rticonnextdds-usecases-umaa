    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpCharValueType *sample = new ExpCharValueType();
            ...
            ExpCharValueTypePluginSupport_copy_data(
                ExpCharValueType *dst,
                const ExpCharValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpCharValueTypePlugin_copy_sample(
                ...
                const ExpCharValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpCharValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpCharValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpCharValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpCharValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
