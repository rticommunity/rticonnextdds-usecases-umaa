    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpDateTimeValueType *sample = new ExpDateTimeValueType();
            ...
            ExpDateTimeValueTypePluginSupport_copy_data(
                ExpDateTimeValueType *dst,
                const ExpDateTimeValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpDateTimeValueTypePlugin_copy_sample(
                ...
                const ExpDateTimeValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpDateTimeValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpDateTimeValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpDateTimeValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpDateTimeValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
