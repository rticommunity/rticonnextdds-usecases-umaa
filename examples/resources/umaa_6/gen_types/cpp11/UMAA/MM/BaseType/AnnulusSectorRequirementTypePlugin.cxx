...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            /* ----------------------------------------------------------------------------
            *  Type AnnulusSectorRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    AnnulusSectorRequirementType *sample = new AnnulusSectorRequirementType();
            ...
            AnnulusSectorRequirementTypePluginSupport_copy_data(
                AnnulusSectorRequirementType *dst,
                const AnnulusSectorRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            AnnulusSectorRequirementTypePlugin_copy_sample(
                ...
                const AnnulusSectorRequirementType *src)
            {
                return ::UMAA::MM::BaseType::AnnulusSectorRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< AnnulusSectorRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool AnnulusSectorRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AnnulusSectorRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
