...
#ifndef RecoveryObjectiveType_933869106_hpp
#define RecoveryObjectiveType_933869106_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string RecoveryObjectiveTypeTopic = "UMAA::MM::BaseType::RecoveryObjectiveType";
            ...
            class NDDSUSERDllExport RecoveryObjectiveType {
              public:
                ...
                RecoveryObjectiveType(const ::UMAA::Common::Measurement::ElevationVariantType& elevation_,const ::UMAA::Common::Position::GeoPosition2DRequirement& position_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                void swap(RecoveryObjectiveType& other_) noexcept ;
            ...
            inline void swap(RecoveryObjectiveType& a, RecoveryObjectiveType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // RecoveryObjectiveType_933869106_hpp
