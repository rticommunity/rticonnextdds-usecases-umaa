...
#ifndef VectorObjectiveType_660133475_hpp
#define VectorObjectiveType_660133475_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string VectorObjectiveTypeTopic = "UMAA::MM::BaseType::VectorObjectiveType";

            class NDDSUSERDllExport VectorObjectiveType {
              public:

                VectorObjectiveType();

                VectorObjectiveType(const ::dds::core::optional< ::UMAA::Common::Orientation::PitchYNEDType >& depthChangePitch_,const ::UMAA::Common::Orientation::DirectionRequirementVariantType& direction_,const ::UMAA::Common::MaritimeEnumeration::DirectionModeEnumModule::DirectionModeEnumType& directionMode_,const ::dds::core::optional< double >& duration_,const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationRequirementVariantType >& elevation_,const ::UMAA::Common::Speed::SpeedRequirementVariantType& speed_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);

                ::dds::core::optional< ::UMAA::Common::Orientation::PitchYNEDType >& depthChangePitch() noexcept {
                    return m_depthChangePitch_;
                }

                const ::dds::core::optional< ::UMAA::Common::Orientation::PitchYNEDType >& depthChangePitch() const noexcept {
                    return m_depthChangePitch_;
                }

                void depthChangePitch(const ::dds::core::optional< ::UMAA::Common::Orientation::PitchYNEDType >& value) {

                    m_depthChangePitch_ = value;
                }

                void depthChangePitch(::dds::core::optional< ::UMAA::Common::Orientation::PitchYNEDType >&& value) {
                ...
                bool operator == (const VectorObjectiveType& other_) const;
                bool operator != (const VectorObjectiveType& other_) const;

                void swap(VectorObjectiveType& other_) noexcept ;

              private:

                ::dds::core::optional< ::UMAA::Common::Orientation::PitchYNEDType > m_depthChangePitch_;
            ...
            inline void swap(VectorObjectiveType& a, VectorObjectiveType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const VectorObjectiveType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::VectorObjectiveType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::VectorObjectiveType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::VectorObjectiveType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::VectorObjectiveType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::VectorObjectiveType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::VectorObjectiveType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::VectorObjectiveType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::VectorObjectiveType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::VectorObjectiveType > {
...
#endif // VectorObjectiveType_660133475_hpp
