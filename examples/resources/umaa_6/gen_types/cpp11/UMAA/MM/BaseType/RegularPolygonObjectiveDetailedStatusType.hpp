...
#ifndef RegularPolygonObjectiveDetailedStatusType_966849943_hpp
#define RegularPolygonObjectiveDetailedStatusType_966849943_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string RegularPolygonObjectiveDetailedStatusTypeTopic = "UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType";

            class NDDSUSERDllExport RegularPolygonObjectiveDetailedStatusType {
              public:

                RegularPolygonObjectiveDetailedStatusType();

                RegularPolygonObjectiveDetailedStatusType(bool isCrossTrackLimitAchieved_,bool isInPattern_,bool isSpeedAchieved_,const ::UMAA::Common::Measurement::GeoPosition2D& referencePosition_,const ::UMAA::Common::Measurement::DateTime& timePatternAchieved_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& timePatternCompleted_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const RegularPolygonObjectiveDetailedStatusType& other_) const;
                bool operator != (const RegularPolygonObjectiveDetailedStatusType& other_) const;

                void swap(RegularPolygonObjectiveDetailedStatusType& other_) noexcept ;
            ...
            inline void swap(RegularPolygonObjectiveDetailedStatusType& a, RegularPolygonObjectiveDetailedStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const RegularPolygonObjectiveDetailedStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::RegularPolygonObjectiveDetailedStatusType > {
...
#endif // RegularPolygonObjectiveDetailedStatusType_966849943_hpp
