    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PolygonVariantType *sample = new PolygonVariantType();
            ...
            PolygonVariantTypePluginSupport_copy_data(
                PolygonVariantType *dst,
                const PolygonVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PolygonVariantTypePlugin_copy_sample(
                ...
                const PolygonVariantType *src)
            {
                return ::UMAA::MM::BaseType::PolygonVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PolygonVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PolygonVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PolygonVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
