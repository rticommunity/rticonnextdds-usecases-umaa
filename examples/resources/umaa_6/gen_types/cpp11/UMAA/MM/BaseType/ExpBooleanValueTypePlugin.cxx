    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpBooleanValueType *sample = new ExpBooleanValueType();
            ...
            ExpBooleanValueTypePluginSupport_copy_data(
                ExpBooleanValueType *dst,
                const ExpBooleanValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpBooleanValueTypePlugin_copy_sample(
                ...
                const ExpBooleanValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpBooleanValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpBooleanValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpBooleanValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpBooleanValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
