...
#ifndef AreaRandomWalkObjectiveDetailedStatusType_2112639627_hpp
#define AreaRandomWalkObjectiveDetailedStatusType_2112639627_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string AreaRandomWalkObjectiveDetailedStatusTypeTopic = "UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType";

            class NDDSUSERDllExport AreaRandomWalkObjectiveDetailedStatusType {
              public:

                AreaRandomWalkObjectiveDetailedStatusType();

                AreaRandomWalkObjectiveDetailedStatusType(bool isAreaAchieved_,bool isInPattern_,const ::UMAA::Common::Measurement::DateTime& timePatternAchieved_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& timePatternCompleted_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const AreaRandomWalkObjectiveDetailedStatusType& other_) const;
                bool operator != (const AreaRandomWalkObjectiveDetailedStatusType& other_) const;

                void swap(AreaRandomWalkObjectiveDetailedStatusType& other_) noexcept ;
            ...
            inline void swap(AreaRandomWalkObjectiveDetailedStatusType& a, AreaRandomWalkObjectiveDetailedStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const AreaRandomWalkObjectiveDetailedStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::AreaRandomWalkObjectiveDetailedStatusType > {
...
#endif // AreaRandomWalkObjectiveDetailedStatusType_2112639627_hpp
