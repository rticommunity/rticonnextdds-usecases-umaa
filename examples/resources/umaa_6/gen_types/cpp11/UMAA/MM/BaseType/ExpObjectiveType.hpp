...
#ifndef ExpObjectiveType_624395999_hpp
#define ExpObjectiveType_624395999_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string ExpObjectiveTypeTopic = "UMAA::MM::BaseType::ExpObjectiveType";
            ...
            #endif
            class NDDSUSERDllExport ExpObjectiveType {
              public:

                ExpObjectiveType();

                ExpObjectiveType(const std::string& expObjectiveDescription_,const ::rti::core::bounded_sequence< ::UMAA::MM::BaseType::KeyValueType, 170L >& keyValues_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);

                std::string& expObjectiveDescription() noexcept {
                    return m_expObjectiveDescription_;
                }

                const std::string& expObjectiveDescription() const noexcept {
                    return m_expObjectiveDescription_;
                }

                void expObjectiveDescription(const std::string& value) {

                    m_expObjectiveDescription_ = value;
                }

                void expObjectiveDescription(std::string&& value) {
                    m_expObjectiveDescription_ = std::move(value);
                }
                ...
                bool operator == (const ExpObjectiveType& other_) const;
                bool operator != (const ExpObjectiveType& other_) const;

                void swap(ExpObjectiveType& other_) noexcept ;

              private:

                std::string m_expObjectiveDescription_;
            ...
            inline void swap(ExpObjectiveType& a, ExpObjectiveType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ExpObjectiveType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::ExpObjectiveType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::ExpObjectiveType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::ExpObjectiveType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::ExpObjectiveType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::ExpObjectiveType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::ExpObjectiveType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::ExpObjectiveType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::ExpObjectiveType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::ExpObjectiveType > {
...
#endif // ExpObjectiveType_624395999_hpp
