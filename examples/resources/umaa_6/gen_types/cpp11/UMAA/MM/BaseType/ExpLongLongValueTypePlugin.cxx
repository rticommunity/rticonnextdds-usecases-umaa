    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpLongLongValueType *sample = new ExpLongLongValueType();
            ...
            ExpLongLongValueTypePluginSupport_copy_data(
                ExpLongLongValueType *dst,
                const ExpLongLongValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpLongLongValueTypePlugin_copy_sample(
                ...
                const ExpLongLongValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpLongLongValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpLongLongValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpLongLongValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpLongLongValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
