    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpDoubleValueType *sample = new ExpDoubleValueType();
            ...
            ExpDoubleValueTypePluginSupport_copy_data(
                ExpDoubleValueType *dst,
                const ExpDoubleValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpDoubleValueTypePlugin_copy_sample(
                ...
                const ExpDoubleValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpDoubleValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpDoubleValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpDoubleValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpDoubleValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
