...
#ifndef WaypointType_968560084_hpp
#define WaypointType_968560084_hpp
        ...
        namespace BaseType {
            ...
            class NDDSUSERDllExport WaypointType {
              public:
                ...
                WaypointType(const ::dds::core::optional< ::UMAA::Common::Orientation::Orientation3DNEDRequirement >& attitude_,const ::UMAA::Common::Distance::DistanceRequirementType& captureRadius_,const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationRequirementVariantType >& elevation_,const ::dds::core::optional< std::string >& name_,const ::UMAA::Common::Measurement::GeoPosition2D& position_,const ::dds::core::optional< ::UMAA::Common::Speed::SpeedVariantType >& speed_,const ::dds::core::optional< ::UMAA::Common::Distance::DistanceRequirementType >& trackTolerance_,const ::UMAA::Common::Measurement::NumericGUID& waypointID_);
                ...
                ::UMAA::Common::Distance::DistanceRequirementType& captureRadius() noexcept {
                    return m_captureRadius_;
                }

                const ::UMAA::Common::Distance::DistanceRequirementType& captureRadius() const noexcept {
                    return m_captureRadius_;
                }

                void captureRadius(const ::UMAA::Common::Distance::DistanceRequirementType& value) {

                    m_captureRadius_ = value;
                }

                void captureRadius(::UMAA::Common::Distance::DistanceRequirementType&& value) {
                    m_captureRadius_ = std::move(value);
                }
              ...
              private:
                ...
                ::UMAA::Common::Distance::DistanceRequirementType m_captureRadius_;
...
#endif // WaypointType_968560084_hpp
