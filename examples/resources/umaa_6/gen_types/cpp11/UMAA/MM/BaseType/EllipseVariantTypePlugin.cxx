    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    EllipseVariantType *sample = new EllipseVariantType();
            ...
            EllipseVariantTypePluginSupport_copy_data(
                EllipseVariantType *dst,
                const EllipseVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            EllipseVariantTypePlugin_copy_sample(
                ...
                const EllipseVariantType *src)
            {
                return ::UMAA::MM::BaseType::EllipseVariantTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EllipseVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool EllipseVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                EllipseVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
