...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            /* ----------------------------------------------------------------------------
            *  Type PolygonAreaRequirementType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PolygonAreaRequirementType *sample = new PolygonAreaRequirementType();
            ...
            PolygonAreaRequirementTypePluginSupport_copy_data(
                PolygonAreaRequirementType *dst,
                const PolygonAreaRequirementType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PolygonAreaRequirementTypePlugin_copy_sample(
                ...
                const PolygonAreaRequirementType *src)
            {
                return ::UMAA::MM::BaseType::PolygonAreaRequirementTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PolygonAreaRequirementType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PolygonAreaRequirementTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PolygonAreaRequirementType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
