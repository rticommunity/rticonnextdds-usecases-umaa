...
#ifndef Figure8ObjectiveDetailedStatusType_1196933017_hpp
#define Figure8ObjectiveDetailedStatusType_1196933017_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string Figure8ObjectiveDetailedStatusTypeTopic = "UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType";

            class NDDSUSERDllExport Figure8ObjectiveDetailedStatusType {
              public:
                ...
                bool operator == (const Figure8ObjectiveDetailedStatusType& other_) const;
                bool operator != (const Figure8ObjectiveDetailedStatusType& other_) const;

                void swap(Figure8ObjectiveDetailedStatusType& other_) noexcept ;
            ...
            inline void swap(Figure8ObjectiveDetailedStatusType& a, Figure8ObjectiveDetailedStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const Figure8ObjectiveDetailedStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::Figure8ObjectiveDetailedStatusType > {
...
#endif // Figure8ObjectiveDetailedStatusType_1196933017_hpp
