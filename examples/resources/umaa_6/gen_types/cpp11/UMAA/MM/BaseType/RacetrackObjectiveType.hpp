...
#ifndef RacetrackObjectiveType_1109209021_hpp
#define RacetrackObjectiveType_1109209021_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string RacetrackObjectiveTypeTopic = "UMAA::MM::BaseType::RacetrackObjectiveType";

            class NDDSUSERDllExport RacetrackObjectiveType {
              public:

                RacetrackObjectiveType();

                RacetrackObjectiveType(const ::dds::core::optional< double >& duration_,const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationRequirementVariantType >& elevation_,double length_,const ::dds::core::optional< double >& loops_,const ::UMAA::Common::Orientation::DirectionVariantType& orientation_,const ::dds::core::optional< ::UMAA::Common::Measurement::GeoPosition2D >& position_,double radius_,const ::UMAA::Common::Speed::SpeedRequirementVariantType& speed_,const ::UMAA::Common::Distance::DistanceRequirementType& trackTolerance_,const ::dds::core::optional< ::UMAA::Common::Measurement::ElevationVariantType >& transitElevation_,const ::UMAA::Common::Speed::SpeedVariantType& transitSpeed_,const ::UMAA::Common::MaritimeEnumeration::WaterTurnDirectionEnumModule::WaterTurnDirectionEnumType& turnDirection_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const RacetrackObjectiveType& other_) const;
                bool operator != (const RacetrackObjectiveType& other_) const;

                void swap(RacetrackObjectiveType& other_) noexcept ;
            ...
            inline void swap(RacetrackObjectiveType& a, RacetrackObjectiveType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const RacetrackObjectiveType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::RacetrackObjectiveType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::RacetrackObjectiveType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::RacetrackObjectiveType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::RacetrackObjectiveType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::RacetrackObjectiveType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::RacetrackObjectiveType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::RacetrackObjectiveType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::RacetrackObjectiveType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::RacetrackObjectiveType > {
...
#endif // RacetrackObjectiveType_1109209021_hpp
