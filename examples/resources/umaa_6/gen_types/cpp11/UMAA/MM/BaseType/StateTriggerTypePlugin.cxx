    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    StateTriggerType *sample = new StateTriggerType();
            ...
            StateTriggerTypePluginSupport_copy_data(
                StateTriggerType *dst,
                const StateTriggerType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            StateTriggerTypePlugin_copy_sample(
                ...
                const StateTriggerType *src)
            {
                return ::UMAA::MM::BaseType::StateTriggerTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< StateTriggerType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool StateTriggerTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                StateTriggerType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
