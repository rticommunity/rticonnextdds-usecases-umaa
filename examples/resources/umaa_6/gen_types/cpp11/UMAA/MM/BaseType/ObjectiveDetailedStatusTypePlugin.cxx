...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            /* ----------------------------------------------------------------------------
            *  Type ObjectiveDetailedStatusType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ObjectiveDetailedStatusType *sample = new ObjectiveDetailedStatusType();
            ...
            ObjectiveDetailedStatusTypePluginSupport_copy_data(
                ObjectiveDetailedStatusType *dst,
                const ObjectiveDetailedStatusType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ObjectiveDetailedStatusTypePlugin_copy_sample(
                ...
                const ObjectiveDetailedStatusType *src)
            {
                return ::UMAA::MM::BaseType::ObjectiveDetailedStatusTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ObjectiveDetailedStatusType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ObjectiveDetailedStatusTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ObjectiveDetailedStatusType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
