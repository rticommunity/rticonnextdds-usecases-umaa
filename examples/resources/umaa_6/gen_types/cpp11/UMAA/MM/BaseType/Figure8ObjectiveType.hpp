...
#ifndef Figure8ObjectiveType_778661166_hpp
#define Figure8ObjectiveType_778661166_hpp
        ...
        namespace BaseType {
            ...
            class NDDSUSERDllExport Figure8ObjectiveType {
              public:
                ...
                bool operator == (const Figure8ObjectiveType& other_) const;
                bool operator != (const Figure8ObjectiveType& other_) const;

                void swap(Figure8ObjectiveType& other_) noexcept ;
            ...
            inline void swap(Figure8ObjectiveType& a, Figure8ObjectiveType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const Figure8ObjectiveType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::Figure8ObjectiveType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::Figure8ObjectiveType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::Figure8ObjectiveType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::Figure8ObjectiveType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::Figure8ObjectiveType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::Figure8ObjectiveType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::Figure8ObjectiveType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::Figure8ObjectiveType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::Figure8ObjectiveType > {
...
#endif // Figure8ObjectiveType_778661166_hpp
