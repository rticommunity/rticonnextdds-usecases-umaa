    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpBinaryValueType *sample = new ExpBinaryValueType();
            ...
            ExpBinaryValueTypePluginSupport_copy_data(
                ExpBinaryValueType *dst,
                const ExpBinaryValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpBinaryValueTypePlugin_copy_sample(
                ...
                const ExpBinaryValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpBinaryValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpBinaryValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpBinaryValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpBinaryValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
