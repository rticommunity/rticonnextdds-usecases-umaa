    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    PolygonAreaToleranceType *sample = new PolygonAreaToleranceType();
            ...
            PolygonAreaToleranceTypePluginSupport_copy_data(
                PolygonAreaToleranceType *dst,
                const PolygonAreaToleranceType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            PolygonAreaToleranceTypePlugin_copy_sample(
                ...
                const PolygonAreaToleranceType *src)
            {
                return ::UMAA::MM::BaseType::PolygonAreaToleranceTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PolygonAreaToleranceType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool PolygonAreaToleranceTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PolygonAreaToleranceType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
