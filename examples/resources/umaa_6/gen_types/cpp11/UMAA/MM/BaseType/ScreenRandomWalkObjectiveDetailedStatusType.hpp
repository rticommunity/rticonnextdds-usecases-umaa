...
#ifndef ScreenRandomWalkObjectiveDetailedStatusType_1691452064_hpp
#define ScreenRandomWalkObjectiveDetailedStatusType_1691452064_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string ScreenRandomWalkObjectiveDetailedStatusTypeTopic = "UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType";

            class NDDSUSERDllExport ScreenRandomWalkObjectiveDetailedStatusType {
              public:

                ScreenRandomWalkObjectiveDetailedStatusType();

                ScreenRandomWalkObjectiveDetailedStatusType(bool isAreaAchieved_,bool isInPattern_,const ::UMAA::Common::Measurement::DateTime& timePatternAchieved_,const ::dds::core::optional< ::UMAA::Common::Measurement::DateTime >& timePatternCompleted_,const ::UMAA::Common::Measurement::DateTime& specializationReferenceTimestamp_,const ::UMAA::Common::Measurement::NumericGUID& specializationReferenceID_);
                ...
                bool operator == (const ScreenRandomWalkObjectiveDetailedStatusType& other_) const;
                bool operator != (const ScreenRandomWalkObjectiveDetailedStatusType& other_) const;

                void swap(ScreenRandomWalkObjectiveDetailedStatusType& other_) noexcept ;
            ...
            inline void swap(ScreenRandomWalkObjectiveDetailedStatusType& a, ScreenRandomWalkObjectiveDetailedStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ScreenRandomWalkObjectiveDetailedStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::BaseType::ScreenRandomWalkObjectiveDetailedStatusType > {
...
#endif // ScreenRandomWalkObjectiveDetailedStatusType_1691452064_hpp
