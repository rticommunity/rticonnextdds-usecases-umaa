    ...
    namespace MM {
        namespace BaseType {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            void ShapeVariantTypeEnumPluginSupport_print_data(
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printEnum((RTICdrEnum *)sample, "ShapeVariantTypeEnum", indent_level + 1);
            }
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ShapeVariantTypeUnion *sample = new ShapeVariantTypeUnion();
            ...
            ShapeVariantTypeUnionPluginSupport_copy_data(
                ShapeVariantTypeUnion *dst,
                const ShapeVariantTypeUnion *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ShapeVariantTypeUnionPlugin_copy_sample(
                ...
                const ShapeVariantTypeUnion *src)
            {
                return ::UMAA::MM::BaseType::ShapeVariantTypeUnionPluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ShapeVariantTypeUnion >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ShapeVariantTypeUnionPlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ShapeVariantTypeUnion **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ShapeVariantType *sample = new ShapeVariantType();
                    ::rti::topic::allocate_sample(*sample);
                    return sample;
                } catch (...) {
                    return NULL;
            ...
            ShapeVariantTypePluginSupport_copy_data(
                ShapeVariantType *dst,
                const ShapeVariantType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ShapeVariantTypePlugin_copy_sample(
                ...
                const ShapeVariantType *src)
            {
                return ::UMAA::MM::BaseType::ShapeVariantTypePluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        plugin.typeCode = (struct RTICdrTypeCode *)
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ShapeVariantType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ShapeVariantTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ShapeVariantType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
