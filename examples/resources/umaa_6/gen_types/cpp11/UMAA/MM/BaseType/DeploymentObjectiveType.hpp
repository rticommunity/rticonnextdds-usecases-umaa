...
#ifndef DeploymentObjectiveType_1526296806_hpp
#define DeploymentObjectiveType_1526296806_hpp
...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            static const std::string DeploymentObjectiveTypeTopic = "UMAA::MM::BaseType::DeploymentObjectiveType";
            ...
            class NDDSUSERDllExport DeploymentObjectiveType {
              public:
                ...
                ::UMAA::Common::Orientation::DirectionRequirementVariantType& heading() noexcept {
                    return m_heading_;
                }

                const ::UMAA::Common::Orientation::DirectionRequirementVariantType& heading() const noexcept {
                    return m_heading_;
                }

                void heading(const ::UMAA::Common::Orientation::DirectionRequirementVariantType& value) {

                    m_heading_ = value;
                }

                void heading(::UMAA::Common::Orientation::DirectionRequirementVariantType&& value) {
                ...
                void swap(DeploymentObjectiveType& other_) noexcept ;

              private:

                ::UMAA::Common::Measurement::ElevationVariantType m_elevation_;
                ::UMAA::Common::Orientation::DirectionRequirementVariantType m_heading_;
            ...
            inline void swap(DeploymentObjectiveType& a, DeploymentObjectiveType& b)  noexcept 
            {
                a.swap(b);
            }
...
#endif // DeploymentObjectiveType_1526296806_hpp
