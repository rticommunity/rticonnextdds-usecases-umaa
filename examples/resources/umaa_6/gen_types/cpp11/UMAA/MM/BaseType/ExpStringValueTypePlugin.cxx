    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpStringValueType *sample = new ExpStringValueType();
            ...
            ExpStringValueTypePluginSupport_copy_data(
                ExpStringValueType *dst,
                const ExpStringValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpStringValueTypePlugin_copy_sample(
                ...
                const ExpStringValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpStringValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpStringValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpStringValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpStringValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
