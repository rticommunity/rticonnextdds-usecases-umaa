    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    KeyValueType *sample = new KeyValueType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            KeyValueTypePlugin_copy_sample(
                ...
                const KeyValueType *src)
            {
                return ::UMAA::MM::BaseType::KeyValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< KeyValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool KeyValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                KeyValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
