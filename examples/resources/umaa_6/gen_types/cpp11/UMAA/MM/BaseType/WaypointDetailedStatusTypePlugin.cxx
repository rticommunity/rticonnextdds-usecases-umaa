...
namespace UMAA {
    namespace MM {
        namespace BaseType {
            ...
            /* ----------------------------------------------------------------------------
            *  Type WaypointDetailedStatusType
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    WaypointDetailedStatusType *sample = new WaypointDetailedStatusType();
            ...
            WaypointDetailedStatusTypePluginSupport_copy_data(
                WaypointDetailedStatusType *dst,
                const WaypointDetailedStatusType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            WaypointDetailedStatusTypePlugin_copy_sample(
                ...
                const WaypointDetailedStatusType *src)
            {
                return ::UMAA::MM::BaseType::WaypointDetailedStatusTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< WaypointDetailedStatusType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool WaypointDetailedStatusTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                WaypointDetailedStatusType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
