    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpByteValueType *sample = new ExpByteValueType();
            ...
            ExpByteValueTypePluginSupport_copy_data(
                ExpByteValueType *dst,
                const ExpByteValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpByteValueTypePlugin_copy_sample(
                ...
                const ExpByteValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpByteValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpByteValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpByteValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpByteValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
