    ...
    namespace MM {
        namespace BaseType {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ExpIntegerValueType *sample = new ExpIntegerValueType();
            ...
            ExpIntegerValueTypePluginSupport_copy_data(
                ExpIntegerValueType *dst,
                const ExpIntegerValueType *src)
            {
                try {
                    *dst = *src;
                } catch (...) {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ExpIntegerValueTypePlugin_copy_sample(
                ...
                const ExpIntegerValueType *src)
            {
                return ::UMAA::MM::BaseType::ExpIntegerValueTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ExpIntegerValueType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ExpIntegerValueTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ExpIntegerValueType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
