...
#ifndef MissionPlanObjectiveDeleteCommandStatusType_1409835094_hpp
#define MissionPlanObjectiveDeleteCommandStatusType_1409835094_hpp
...
namespace UMAA {
    namespace MM {
        namespace MissionPlanObjectiveControl {
            ...
            static const std::string MissionPlanObjectiveDeleteCommandStatusTypeTopic = "UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType";

            class NDDSUSERDllExport MissionPlanObjectiveDeleteCommandStatusType {
              public:
                ...
                bool operator == (const MissionPlanObjectiveDeleteCommandStatusType& other_) const;
                bool operator != (const MissionPlanObjectiveDeleteCommandStatusType& other_) const;

                void swap(MissionPlanObjectiveDeleteCommandStatusType& other_) noexcept ;
            ...
            inline void swap(MissionPlanObjectiveDeleteCommandStatusType& a, MissionPlanObjectiveDeleteCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const MissionPlanObjectiveDeleteCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveDeleteCommandStatusType > {
...
#endif // MissionPlanObjectiveDeleteCommandStatusType_1409835094_hpp
