...
#ifndef MissionPlanObjectiveAddCommandType_459657723_hpp
#define MissionPlanObjectiveAddCommandType_459657723_hpp
        ...
        namespace MissionPlanObjectiveControl {
            ...
            class NDDSUSERDllExport MissionPlanObjectiveAddCommandType {
              public:
                ...
                bool operator == (const MissionPlanObjectiveAddCommandType& other_) const;
                bool operator != (const MissionPlanObjectiveAddCommandType& other_) const;

                void swap(MissionPlanObjectiveAddCommandType& other_) noexcept ;
            ...
            inline void swap(MissionPlanObjectiveAddCommandType& a, MissionPlanObjectiveAddCommandType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const MissionPlanObjectiveAddCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::MissionPlanObjectiveControl::MissionPlanObjectiveAddCommandType > {
...
#endif // MissionPlanObjectiveAddCommandType_459657723_hpp
