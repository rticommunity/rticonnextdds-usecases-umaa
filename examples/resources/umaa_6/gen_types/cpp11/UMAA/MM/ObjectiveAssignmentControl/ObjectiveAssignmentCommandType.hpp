...
#ifndef ObjectiveAssignmentCommandType_506297533_hpp
#define ObjectiveAssignmentCommandType_506297533_hpp
...
namespace UMAA {
    namespace MM {
        namespace ObjectiveAssignmentControl {
            ...
            static const std::string ObjectiveAssignmentCommandTypeTopic = "UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType";
            ...
            class NDDSUSERDllExport ObjectiveAssignmentCommandType {
              public:
                ...
                bool operator == (const ObjectiveAssignmentCommandType& other_) const;
                bool operator != (const ObjectiveAssignmentCommandType& other_) const;

                void swap(ObjectiveAssignmentCommandType& other_) noexcept ;
            ...
            inline void swap(ObjectiveAssignmentCommandType& a, ObjectiveAssignmentCommandType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ObjectiveAssignmentCommandType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandType > {
...
#endif // ObjectiveAssignmentCommandType_506297533_hpp
