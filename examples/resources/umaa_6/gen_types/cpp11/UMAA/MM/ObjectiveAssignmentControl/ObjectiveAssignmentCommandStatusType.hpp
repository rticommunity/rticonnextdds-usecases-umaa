...
#ifndef ObjectiveAssignmentCommandStatusType_131023423_hpp
#define ObjectiveAssignmentCommandStatusType_131023423_hpp
...
namespace UMAA {
    namespace MM {
        namespace ObjectiveAssignmentControl {
            ...
            static const std::string ObjectiveAssignmentCommandStatusTypeTopic = "UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType";

            class NDDSUSERDllExport ObjectiveAssignmentCommandStatusType {
              public:
                ...
                bool operator == (const ObjectiveAssignmentCommandStatusType& other_) const;
                bool operator != (const ObjectiveAssignmentCommandStatusType& other_) const;

                void swap(ObjectiveAssignmentCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ObjectiveAssignmentCommandStatusType& a, ObjectiveAssignmentCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ObjectiveAssignmentCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::ObjectiveAssignmentControl::ObjectiveAssignmentCommandStatusType > {
...
#endif // ObjectiveAssignmentCommandStatusType_131023423_hpp
