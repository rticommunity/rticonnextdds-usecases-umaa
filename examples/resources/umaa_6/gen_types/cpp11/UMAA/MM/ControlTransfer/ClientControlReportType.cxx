...
namespace UMAA {
    ...
    namespace MM {
        ...
        namespace ControlTransfer {
            ...
            ClientControlReportType::ClientControlReportType (int32_t authorityLevel_,const ::UMAA::Common::IdentifierType& clientID_,const ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType& status_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::MM::ControlTransfer::ClientControlReportType > {
            static DDS_TypeCode * get()
            {
                ...
                ClientControlReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ClientControlReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType>::get().native();
                ClientControlReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                ClientControlReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                ClientControlReportType_g_tc_members[0]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                ClientControlReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                ClientControlReportType_g_tc_members[0]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
