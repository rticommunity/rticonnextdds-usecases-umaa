...
#ifndef ControlSystemControlReportType_226880066_hpp
#define ControlSystemControlReportType_226880066_hpp
...
namespace UMAA {
    namespace MM {
        namespace ControlTransfer {
            ...
            static const std::string ControlSystemControlReportTypeTopic = "UMAA::MM::ControlTransfer::ControlSystemControlReportType";
            ...
            class NDDSUSERDllExport ControlSystemControlReportType {
              public:
                ...
                ::UMAA::Common::IdentifierType& controlSystemID() noexcept {
                    return m_controlSystemID_;
                }

                const ::UMAA::Common::IdentifierType& controlSystemID() const noexcept {
                    return m_controlSystemID_;
                }

                void controlSystemID(const ::UMAA::Common::IdentifierType& value) {

                    m_controlSystemID_ = value;
                }

                void controlSystemID(::UMAA::Common::IdentifierType&& value) {
                    m_controlSystemID_ = std::move(value);
                }
                ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType& status() noexcept {
                    return m_status_;
                }

                const ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType& status() const noexcept {
                    return m_status_;
                }

                void status(const ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType& value) {

                    m_status_ = value;
                }

                void status(::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType&& value) {
              ...
              private:
                ...
                ::UMAA::Common::IdentifierType m_controlSystemID_;
                ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType m_status_;
...
#endif // ControlSystemControlReportType_226880066_hpp
