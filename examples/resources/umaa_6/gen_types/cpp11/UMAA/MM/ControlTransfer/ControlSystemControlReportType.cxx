    ...
    namespace MM {
        ...
        namespace ControlTransfer {
            ...
            ControlSystemControlReportType::ControlSystemControlReportType() :
                m_authorityLevel_ (0) ,
                m_status_(UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType::ALLOCATED)  {

            }   

            ControlSystemControlReportType::ControlSystemControlReportType (int32_t authorityLevel_,const ::UMAA::Common::IdentifierType& controlSystemID_,const ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType& status_,const ::UMAA::Common::Measurement::DateTime& timeStamp_,const ::UMAA::Common::IdentifierType& source_):
                m_authorityLevel_(authorityLevel_), 
                m_controlSystemID_(controlSystemID_), 
                m_status_(status_), 
                m_timeStamp_(timeStamp_), 
                m_source_(source_) {
            }

            void ControlSystemControlReportType::swap(ControlSystemControlReportType& other_)  noexcept 
            {
                using std::swap;
    ...
    namespace topic {
        ...
        struct native_type_code< ::UMAA::MM::ControlTransfer::ControlSystemControlReportType > {
            static DDS_TypeCode * get()
            {
                ...
                ControlSystemControlReportType_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ControlSystemControlReportType_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType>::get().native();
                ControlSystemControlReportType_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::Measurement::DateTime>::get().native();
                ControlSystemControlReportType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< ::UMAA::Common::IdentifierType>::get().native();
                ...
                ControlSystemControlReportType_g_tc_members[0]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                ControlSystemControlReportType_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                ControlSystemControlReportType_g_tc_members[0]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< ::UMAA::MM::ControlTransfer::ControlSystemControlReportType >::reset_sample(::UMAA::MM::ControlTransfer::ControlSystemControlReportType& sample) 
        {
            ...
            sample.status(UMAA::Common::Enumeration::ResourceAllocationStatusEnumModule::ResourceAllocationStatusEnumType::ALLOCATED);
