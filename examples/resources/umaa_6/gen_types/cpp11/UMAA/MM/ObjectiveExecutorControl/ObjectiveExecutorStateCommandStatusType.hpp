...
#ifndef ObjectiveExecutorStateCommandStatusType_2000783147_hpp
#define ObjectiveExecutorStateCommandStatusType_2000783147_hpp
...
namespace UMAA {
    namespace MM {
        namespace ObjectiveExecutorControl {
            ...
            static const std::string ObjectiveExecutorStateCommandStatusTypeTopic = "UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType";

            class NDDSUSERDllExport ObjectiveExecutorStateCommandStatusType {
              public:
                ...
                bool operator == (const ObjectiveExecutorStateCommandStatusType& other_) const;
                bool operator != (const ObjectiveExecutorStateCommandStatusType& other_) const;

                void swap(ObjectiveExecutorStateCommandStatusType& other_) noexcept ;
            ...
            inline void swap(ObjectiveExecutorStateCommandStatusType& a, ObjectiveExecutorStateCommandStatusType& b)  noexcept 
            {
                a.swap(b);
            }

            NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const ObjectiveExecutorStateCommandStatusType& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< ::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType > {
            NDDSUSERDllExport static std::string value() {
                return "UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType";
            }
        };

        template<>
        struct is_topic_type< ::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< ::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType > {
            NDDSUSERDllExport 
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType& sample);

            NDDSUSERDllExport 
            static void allocate_sample(::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        template<>
        struct dynamic_type< ::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };

        template <>
        struct extensibility< ::UMAA::MM::ObjectiveExecutorControl::ObjectiveExecutorStateCommandStatusType > {
...
#endif // ObjectiveExecutorStateCommandStatusType_2000783147_hpp
