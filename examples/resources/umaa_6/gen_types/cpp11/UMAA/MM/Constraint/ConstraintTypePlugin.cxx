    ...
    namespace MM {
        namespace Constraint {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                try {
                    ConstraintType *sample = new ConstraintType();
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ConstraintTypePlugin_copy_sample(
                ...
                const ConstraintType *src)
            {
                return ::UMAA::MM::Constraint::ConstraintTypePluginSupport_copy_data(dst,src);
            }
                ...
                ::dds::core::policy::DataRepresentationId representation)
            {
                ...
                try{
                    ...
                    try {
                        ...
                        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< ConstraintType >::get().native()
                        ;
                    } catch (...) {
                        return RTI_FALSE;
                    }
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool ConstraintTypePlugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ConstraintType **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *cdrStream,
