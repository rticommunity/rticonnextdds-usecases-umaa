...
def publisher_main(file):
    ...
    dds.DomainParticipant.register_idl_type(UMAA_MO_GlobalVectorControl_GlobalVectorCommandType, get_type_name(UMAA_MO_GlobalVectorControl_GlobalVectorCommandType))
    dds.DomainParticipant.register_idl_type(UMAA_MO_GlobalVectorControl_GlobalVectorCommandAckReportType, get_type_name(UMAA_MO_GlobalVectorControl_GlobalVectorCommandAckReportType))
    dds.DomainParticipant.register_idl_type(UMAA_MO_GlobalVectorControl_GlobalVectorCommandStatusType, get_type_name(UMAA_MO_GlobalVectorControl_GlobalVectorCommandStatusType))
    dds.DomainParticipant.register_idl_type(UMAA_MO_GlobalVectorControl_GlobalVectorExecutionStatusReportType, get_type_name(UMAA_MO_GlobalVectorControl_GlobalVectorExecutionStatusReportType))
    ...
    participant = qos_provider.create_participant_from_config("umaa_components_lib::globalvector")

    # Lookup the Writers
    globalvector_command_w = dds.DataWriter(participant.find_datawriter("pub::GlobalVectorCommandType"))
